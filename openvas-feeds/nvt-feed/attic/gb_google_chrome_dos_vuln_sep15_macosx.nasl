...
if(description)
{
  ...
  script_name("Google Chrome Denial of Service Vulnerability (Sep 2015) - Mac OS X");

  script_tag(name:"summary", value:"Google Chrome is prone to a denial of service (DoS) vulnerability.

  This VT has been deprecated and replaced by the VT 'Google Chrome Multiple Vulnerabilities-01 Oct15 (Mac OS X)' (OID: 1.3.6.1.4.1.25623.1.0.805995).");
