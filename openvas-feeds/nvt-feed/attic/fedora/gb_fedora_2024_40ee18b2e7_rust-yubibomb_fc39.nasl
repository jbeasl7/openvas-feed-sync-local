...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887186");
  ...
  script_name("Fedora: Security Advisory for rust-yubibomb (FEDORA-2024-40ee18b2e7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-40ee18b2e7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SVMKBTRBS3YPUKLA364ZJKSVYSTI3QNX");
...
laptop&#39,s USB port? Now you can!");
  ...
  script_tag(name:"affected", value:"'rust-yubibomb' package(s) on Fedora 39.");
