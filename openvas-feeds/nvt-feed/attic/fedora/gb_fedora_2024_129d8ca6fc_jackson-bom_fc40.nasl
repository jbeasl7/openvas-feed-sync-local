...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886156");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:19:50 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for jackson-bom (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CKK3ED46QXBBQHA7HY4CYFAWJ47675PM");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"affected", value:"'jackson-bom' package(s) on Fedora 40.");
