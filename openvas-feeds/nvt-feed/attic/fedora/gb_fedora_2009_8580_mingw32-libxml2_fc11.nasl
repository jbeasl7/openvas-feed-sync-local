...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64700");
...
su -c 'yum update mingw32-libxml2' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-8580");
  script_tag(name:"summary", value:"The remote host is missing an update to mingw32-libxml2
