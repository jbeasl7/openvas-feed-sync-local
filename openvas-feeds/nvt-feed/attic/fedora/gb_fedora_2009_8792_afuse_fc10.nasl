...
su -c 'yum update afuse' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-8792");
  script_tag(name:"summary", value:"The remote host is missing an update to afuse
