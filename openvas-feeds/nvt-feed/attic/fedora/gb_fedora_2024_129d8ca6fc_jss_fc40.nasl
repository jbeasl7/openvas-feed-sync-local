...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886050");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:17:44 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for jss (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TE5UFYWVEYKKWHYIBPCGLRBUCZYRHXWN");
...
This only works with gcj. Other JREs require that JCE providers be signed.");
  ...
  script_tag(name:"affected", value:"'jss' package(s) on Fedora 40.");
