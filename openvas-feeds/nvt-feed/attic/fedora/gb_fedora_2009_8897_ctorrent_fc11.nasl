...
su -c 'yum update ctorrent' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-8897");
  script_tag(name:"summary", value:"The remote host is missing an update to ctorrent
