...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64850");
...
Update to PostgreSQL 8.3.8, for various fixes including three security issues.
...
su -c 'yum update postgresql' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-9473");
