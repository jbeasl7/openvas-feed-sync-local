...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885995");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:16:35 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for jansi-native (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LCBTF5ZSHXH6LLXBKPO7QO7WIWOSSTTX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jansi-native'
...
when output is being sent to output devices which cannot support ANSI sequences.");
  ...
  script_tag(name:"affected", value:"'jansi-native' package(s) on Fedora 40.");
