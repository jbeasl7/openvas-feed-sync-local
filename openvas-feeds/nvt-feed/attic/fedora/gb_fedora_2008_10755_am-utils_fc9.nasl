...
su -c 'yum update am-utils' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2008-10755");
  script_tag(name:"summary", value:"The remote host is missing an update to am-utils
