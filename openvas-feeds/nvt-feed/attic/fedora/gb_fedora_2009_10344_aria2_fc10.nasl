...
Fixes CVE-2009-3575, A buffer overflow vulnerability
...
su -c 'yum update aria2' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-10344");
