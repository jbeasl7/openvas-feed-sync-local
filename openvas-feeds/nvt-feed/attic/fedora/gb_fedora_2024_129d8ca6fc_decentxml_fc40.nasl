...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886201");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:20:49 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for decentxml (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PPF2LSW2SECPFAGOEIG276OVMS4AU6DU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'decentxml'
  package(s) announced via the FEDORA-2024-129d8ca6fc advisory.
Note: This VT has been deprecated as a duplicate.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"XML parser optimized for round-tripping and code reuse with main
features being:
  ...
  * XML 1.1 compatible");
  ...
  script_tag(name:"affected", value:"'decentxml' package(s) on Fedora 40.");
