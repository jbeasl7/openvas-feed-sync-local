...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64087");
  ...
  script_tag(name:"insight", value:"This package lays base for libpcap, a packet capture and filtering
...
su -c 'yum update wireshark' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-5382");
