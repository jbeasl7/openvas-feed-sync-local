...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63660");
...
upstream. Changes are high that this update can be superseded by a beta3 or a
...
su -c 'yum update lcms' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2910");
