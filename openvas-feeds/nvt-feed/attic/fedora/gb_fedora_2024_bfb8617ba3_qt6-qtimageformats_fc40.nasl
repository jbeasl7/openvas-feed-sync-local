...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886897");
  ...
  script_name("Fedora: Security Advisory for qt6-qtimageformats (FEDORA-2024-bfb8617ba3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-bfb8617ba3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GSA4IDQ5WPTJ456RNZUA63IBZTRUM5S5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qt6-qtimageformats'
  package(s) announced via the FEDORA-2024-bfb8617ba3 advisory.
Note: This VT has been deprecated as a duplicate.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The core Qt Gui library by default supports reading and writing image
...
MNG, TGA, TIFF, WBMP.");
  ...
  script_tag(name:"affected", value:"'qt6-qtimageformats' package(s) on Fedora 40.");
