...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886908");
  ...
  script_tag(name:"creation_date", value:"2024-06-07 06:34:27 +0000 (Fri, 07 Jun 2024)");
  script_name("Fedora: Security Advisory for qt5-qtimageformats (FEDORA-2024-2e27372d4c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2e27372d4c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BGQAAGO4BMG62RWPKGKTQ772LSFVFDT2");
...
MNG, TGA, TIFF, WBMP.");
  ...
  script_tag(name:"affected", value:"'qt5-qtimageformats' package(s) on Fedora 40.");
