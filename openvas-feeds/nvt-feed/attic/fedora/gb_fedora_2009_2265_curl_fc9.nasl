...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63495");
  ...
  script_tag(name:"insight", value:"Update to curl-7.19.4 fixes CVE-2009-0037.
...
su -c 'yum update curl' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2265");
