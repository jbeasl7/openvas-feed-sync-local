...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886035");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:17:27 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for xalan-j2 (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A5LBYKOHOQPODQ7TCIUXRAQM54RSVACX");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"insight", value:"Xalan is an XSLT processor for transforming XML documents into HTML,
text, or other XML document types. It implements the W3C Recommendations
for XSL Transformations (XSLT) and the XML Path Language (XPath). It can
be used from the command line, in an applet or a servlet, or as a module
in other program.");

  script_tag(name:"affected", value:"'xalan-j2' package(s) on Fedora 40.");
