...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885800");
  ...
  script_name("Fedora: Security Advisory for mingw-qt5-qtmultimedia (FEDORA-2024-a8cdce27ac)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a8cdce27ac");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/SBLQNM3QAFKHPE5UP25AFY3QXTO4VEQW");
...
Fedora Windows cross-compiler.");
  ...
  script_tag(name:"affected", value:"'mingw-qt5-qtmultimedia' package(s) on Fedora 39.");
