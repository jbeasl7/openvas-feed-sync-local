...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887018");
  ...
  script_name("Fedora: Security Advisory for gammaray (FEDORA-2024-2e27372d4c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2e27372d4c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4J4TJRXNMQJZG3S27DIWXDY3ISCBUOIG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gammaray'
  package(s) announced via the FEDORA-2024-2e27372d4c advisory.
Note: This VT has been deprecated as a duplicate.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A tool to poke around in a Qt-application and also to manipulate
...
GammaRay can introspect Qt 6 and Qt 5 applications.");
  ...
  script_tag(name:"affected", value:"'gammaray' package(s) on Fedora 40.");
