...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885909");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:14:49 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for tagsoup (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LHNF4MTYOBMTW2OIZTL46KPXBKO6T747");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tagsoup'
  package(s) announced via the FEDORA-2024-129d8ca6fc advisory.
Note: This VT has been deprecated as a duplicate.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"TagSoup is a SAX-compliant parser written in Java that, instead of
...
applied to even the worst HTML.");
  ...
  script_tag(name:"affected", value:"'tagsoup' package(s) on Fedora 40.");
