...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887325");
  ...
  script_name("Fedora: Security Advisory for bind (FEDORA-2024-8af1780fdf)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-8af1780fdf");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JBKHGWP6MCID3Y4IWPUY2YUUEY6CPXE7");
...
(Domain Name System) protocols");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on Fedora 40.");
