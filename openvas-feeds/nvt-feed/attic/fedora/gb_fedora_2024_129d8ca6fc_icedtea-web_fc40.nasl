...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885964");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:15:58 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for icedtea-web (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ELO5OHYLE3SSGD2EVQFBHR5XMCLLPIXA");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"insight", value:"The IcedTea-Web project provides a free software implementation of Java
Web Start, originally based on the NetX, project.

IcedTea&#39, s NetX currently supports verification of signed jars, trusted
...
many extended security features, an own policy editor and much more.");
  ...
  script_tag(name:"affected", value:"'icedtea-web' package(s) on Fedora 40.");
