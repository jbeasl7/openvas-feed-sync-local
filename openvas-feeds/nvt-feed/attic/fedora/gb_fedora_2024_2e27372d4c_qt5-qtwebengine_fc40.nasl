...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886930");
  ...
  script_name("Fedora: Security Advisory for qt5-qtwebengine (FEDORA-2024-2e27372d4c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2e27372d4c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4WC2B23XOH5LBXVNJCNXW725LMAXR6UU");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"affected", value:"'qt5-qtwebengine' package(s) on Fedora 40.");
