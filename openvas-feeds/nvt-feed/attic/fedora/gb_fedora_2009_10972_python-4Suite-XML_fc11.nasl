...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66193");
...
su -c 'yum update python-4Suite-XML' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-10972");
  script_tag(name:"summary", value:"The remote host is missing an update to python-4Suite-XML
