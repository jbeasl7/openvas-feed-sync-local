...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886705");
  ...
  script_name("Fedora: Security Advisory for loupe (FEDORA-2024-ce2936b568)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-ce2936b568");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YAK544CKAZVSXZF6M77O2CBVNMXMY6ZD");
...
Features:
  ...
  script_tag(name:"affected", value:"'loupe' package(s) on Fedora 40.");
