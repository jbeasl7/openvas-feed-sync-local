...
su -c 'yum update rubygem-actionmailer' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-10484");
  script_tag(name:"summary", value:"The remote host is missing an update to rubygem-actionmailer
