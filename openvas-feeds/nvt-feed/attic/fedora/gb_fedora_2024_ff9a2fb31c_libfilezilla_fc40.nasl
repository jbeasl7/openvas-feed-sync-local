...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886605");
  ...
  script_name("Fedora: Security Advisory for libfilezilla (FEDORA-2024-ff9a2fb31c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-ff9a2fb31c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LZPAQVYRHTMO54YJYPBDSPDHQKOPTVSP");
...
functionality to build high-performing, platform-independent programs.");
  ...
  script_tag(name:"affected", value:"'libfilezilla' package(s) on Fedora 40.");
