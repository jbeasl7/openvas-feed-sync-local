...
su -c 'yum update rubygem-activesupport' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-9799");
  script_tag(name:"summary", value:"The remote host is missing an update to rubygem-activesupport
