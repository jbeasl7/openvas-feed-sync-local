...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64298");
  ...
  script_tag(name:"insight", value:"Update to upstream version 1.3.7
...
su -c 'yum update apr-util' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-5969");
