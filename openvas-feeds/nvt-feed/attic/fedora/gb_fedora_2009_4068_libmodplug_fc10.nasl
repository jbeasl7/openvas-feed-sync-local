...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63921");
  ...
  script_tag(name:"insight", value:"Update to 0.8.7");
  script_tag(name:"solution", value:"Apply the appropriate updates.

This update can be installed with the yum update program.  Use
su -c 'yum update libmodplug' at the command line.");

  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-4068");
