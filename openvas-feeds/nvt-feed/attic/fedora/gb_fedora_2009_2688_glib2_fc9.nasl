...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63725");
  ...
  script_tag(name:"insight", value:"GLib is the low-level core library that forms the basis
...
su -c 'yum update glib2' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2688");
