...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886494");
  ...
  script_name("Fedora: Security Advisory for wildcard (FEDORA-2024-ce2936b568)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-ce2936b568");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YI6PA7C352KZZLXRLKSOWYR5M2VL6AE7");
...
expressions.");
  ...
  script_tag(name:"affected", value:"'wildcard' package(s) on Fedora 40.");
