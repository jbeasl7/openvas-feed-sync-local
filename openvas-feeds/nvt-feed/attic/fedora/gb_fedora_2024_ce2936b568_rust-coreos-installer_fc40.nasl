...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886853");
  ...
  script_name("Fedora: Security Advisory for rust-coreos-installer (FEDORA-2024-ce2936b568)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-ce2936b568");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3WFIPSLGNZ7HALLYHJ24JKFQFU7L62BA");
...
machines (or, occasionally, to virtual machines).");
  ...
  script_tag(name:"affected", value:"'rust-coreos-installer' package(s) on Fedora 40.");
