...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886341");
  ...
  script_tag(name:"creation_date", value:"2024-03-29 02:11:21 +0000 (Fri, 29 Mar 2024)");
  script_name("Fedora: Security Advisory for ghc-base64 (FEDORA-2024-7d83cbccb6)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-7d83cbccb6");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MU32YTZKJHGBKNEZ7EO774ZXBPEF42AA");
...
(additional support for RFC 7049 standards).");
  ...
  script_tag(name:"affected", value:"'ghc-base64' package(s) on Fedora 40.");
