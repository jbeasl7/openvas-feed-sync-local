...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66127");
...
su -c 'yum update sahana' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-10718");
  script_tag(name:"summary", value:"The remote host is missing an update to sahana
