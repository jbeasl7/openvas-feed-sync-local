...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887088");
  ...
  script_tag(name:"creation_date", value:"2024-06-07 06:35:51 +0000 (Fri, 07 Jun 2024)");
  script_name("Fedora: Security Advisory for qt6-qtspeech (FEDORA-2024-bfb8617ba3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-bfb8617ba3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2UIAQAIPPLBFBNFZQ65XGBPM2ZASYKCD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qt6-qtspeech'
  package(s) announced via the FEDORA-2024-bfb8617ba3 advisory.
Note: This VT has been deprecated as a duplicate.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The module enables a Qt application to support accessibility features
...
the RS-232 pinouts.");
  ...
  script_tag(name:"affected", value:"'qt6-qtspeech' package(s) on Fedora 40.");
