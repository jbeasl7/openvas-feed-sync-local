...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886366");
  ...
  script_name("Fedora: Security Advisory for gitit (FEDORA-2024-b458482d48)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-b458482d48");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2ZJY5YJXW3VY3PPZ5HBYSZ7EZEV3MGCH");
...
any happstack application");
  ...
  script_tag(name:"affected", value:"'gitit' package(s) on Fedora 39.");
