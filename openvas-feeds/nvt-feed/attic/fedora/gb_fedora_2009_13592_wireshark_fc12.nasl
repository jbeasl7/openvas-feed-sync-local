...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66578");
...
ChangeLog:
  ...
  * Fri Dec 18 2009 Radek Vokal  - 1.2.5-2
  ...
  - fixes security vulnaribilities
...
su -c 'yum update wireshark' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-13592");
