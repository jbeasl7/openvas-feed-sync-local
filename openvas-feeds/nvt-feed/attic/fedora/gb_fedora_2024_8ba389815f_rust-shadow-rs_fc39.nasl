...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885744");
  ...
  script_tag(name:"creation_date", value:"2024-02-20 02:04:23 +0000 (Tue, 20 Feb 2024)");
  script_name("Fedora: Security Advisory for rust-shadow-rs (FEDORA-2024-8ba389815f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-8ba389815f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NMAFFT4YFEZ5IRWM4HUKV5NJSQXVNZPI");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"affected", value:"'rust-shadow-rs' package(s) on Fedora 39.");
