...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885920");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:15:02 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for java-11-openjdk-portable (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/INT6CUDP2TUJVMD3UPZTU6VONZAADV77");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"affected", value:"'java-11-openjdk-portable' package(s) on Fedora 40.");
