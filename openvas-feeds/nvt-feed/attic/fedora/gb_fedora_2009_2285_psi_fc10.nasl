...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63488");
  ...
  script_tag(name:"insight", value:"This is a bugfix-only update to version 0.12.1    New in 0.12.1   - Bugfix for
...
su -c 'yum update psi' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-2285");
