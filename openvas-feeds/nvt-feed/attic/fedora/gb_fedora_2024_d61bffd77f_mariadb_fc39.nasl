...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887242");
  ...
  script_tag(name:"creation_date", value:"2024-06-18 04:08:14 +0000 (Tue, 18 Jun 2024)");
  script_name("Fedora: Security Advisory for mariadb (FEDORA-2024-d61bffd77f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-d61bffd77f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3PWHOEXNGQUJOJ2JNEFGVADE7K2277Q4");
