...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64240");
  ...
  script_tag(name:"insight", value:"Libpng should be installed if you need to manipulate PNG format image
files.
...
su -c 'yum update libpng' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-6531");
