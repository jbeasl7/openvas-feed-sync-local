...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886381");
  ...
  script_name("Fedora: Security Advisory for ghc-isocline (FEDORA-2024-b458482d48)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-b458482d48");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/F3JQW4QKFXH5WMI5XUXM4ZHJ7APSICPF");
...
(The Isocline library is included whole and there are no runtime dependencies).");
  ...
  script_tag(name:"affected", value:"'ghc-isocline' package(s) on Fedora 39.");
