...
su -c 'yum update nss-util' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-12968");
  script_tag(name:"summary", value:"The remote host is missing an update to nss-util
