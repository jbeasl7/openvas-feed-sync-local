...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886881");
  ...
  script_name("Fedora: Security Advisory for libipuz (FEDORA-2024-e4717532c4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-e4717532c4");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BXEFSO4BFM74SZFX5DBC6JIM4GC5CTW4");
