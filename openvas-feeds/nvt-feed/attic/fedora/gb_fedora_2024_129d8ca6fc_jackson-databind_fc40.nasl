...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886095");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:18:37 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for jackson-databind (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M7F2Z5QFZETSLPWPXUV5UJRR5T7CFL6B");
...
Jackson Annotations for configuration.");
  ...
  script_tag(name:"affected", value:"'jackson-databind' package(s) on Fedora 40.");
