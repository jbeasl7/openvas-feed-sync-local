...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63377");
  ...
  script_tag(name:"insight", value:"Gnumeric is a spreadsheet program for the GNOME GUI desktop
environment.
...
su -c 'yum update gnumeric' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-1295");
