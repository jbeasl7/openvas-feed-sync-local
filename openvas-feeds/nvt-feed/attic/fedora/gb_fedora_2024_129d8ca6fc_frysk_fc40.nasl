...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886072");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:18:10 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for frysk (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HHKIOW33SVMDVATBWD4N4BOD5BELFPCR");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"insight", value:"Frysk is an execution-analysis technology implemented using native
...
system.");
  ...
  script_tag(name:"affected", value:"'frysk' package(s) on Fedora 40.");
