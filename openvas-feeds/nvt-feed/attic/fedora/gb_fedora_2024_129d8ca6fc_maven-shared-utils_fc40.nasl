...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886077");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:18:16 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for maven-shared-utils (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7642MZJL4O4SYL3DYQFMVVFZZ2DF6Q54");
...
a lot of unused code.");
  ...
  script_tag(name:"affected", value:"'maven-shared-utils' package(s) on Fedora 40.");
