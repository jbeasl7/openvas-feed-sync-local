...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885791");
  ...
  script_tag(name:"creation_date", value:"2024-02-24 02:04:42 +0000 (Sat, 24 Feb 2024)");
  script_name("Fedora: Security Advisory for mingw-qt5-qtlocation (FEDORA-2024-a8cdce27ac)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a8cdce27ac");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/Z63CHHATTG3QTQ4R2J27CFVPCMKSWAUW");
...
Fedora Windows cross-compiler.");
  ...
  script_tag(name:"affected", value:"'mingw-qt5-qtlocation' package(s) on Fedora 39.");
