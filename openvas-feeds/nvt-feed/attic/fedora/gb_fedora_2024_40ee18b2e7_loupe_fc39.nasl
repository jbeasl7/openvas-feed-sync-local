...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887031");
  ...
  script_name("Fedora: Security Advisory for loupe (FEDORA-2024-40ee18b2e7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-40ee18b2e7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UDZYNYDDBUJ3HA5EZDFFWCZ7M6MO2F5Q");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'loupe'
  package(s) announced via the FEDORA-2024-40ee18b2e7 advisory.
Note: This VT has been deprecated as a duplicate.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An image viewer application written with GTK 4, Libadwaita and Rust.
...
Features:
  ...
  script_tag(name:"affected", value:"'loupe' package(s) on Fedora 39.");
