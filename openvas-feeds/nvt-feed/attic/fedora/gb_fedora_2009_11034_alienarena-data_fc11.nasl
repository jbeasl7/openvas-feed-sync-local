...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66201");
  ...
  script_tag(name:"insight", value:"Data files (audio, maps, etc) for Alien Arena 2009.
...
su -c 'yum update alienarena-data' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-11034");
  script_tag(name:"summary", value:"The remote host is missing an update to alienarena-data
