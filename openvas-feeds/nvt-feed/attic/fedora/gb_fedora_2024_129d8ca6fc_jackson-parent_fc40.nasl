...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886147");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:19:40 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for jackson-parent (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VA6RDHYIA4QYSU2IAZ2TMSEDXJ4H4H2Y");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"affected", value:"'jackson-parent' package(s) on Fedora 40.");
