...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885969");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:16:03 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for subversion (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/LJYTXXPEIQB52WCPBY3YQGX4GWEUIDTQ");
...
compelling replacement for CVS.");
  ...
  script_tag(name:"affected", value:"'subversion' package(s) on Fedora 40.");
