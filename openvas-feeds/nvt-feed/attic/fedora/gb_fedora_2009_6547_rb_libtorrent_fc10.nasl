...
if(description)
{
  ...
  script_tag(name:"insight", value:"Its main goals are to be very efficient (in terms of CPU and memory usage) as
...
su -c 'yum update rb_libtorrent' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-6547");
