...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886191");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:20:36 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for jsoup (FEDORA-2024-129d8ca6fc)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-129d8ca6fc");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/W7K55FEC6IHRQDNPNGPAOFBCC74FQO5Q");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"insight", value:"jsoup is a Java library for working with real-world HTML. It provides a very
...
tree.");
  ...
  script_tag(name:"affected", value:"'jsoup' package(s) on Fedora 40.");
