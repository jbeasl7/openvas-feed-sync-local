...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885787");
  ...
  script_name("Fedora: Security Advisory for mingw-qt5-qtdeclarative (FEDORA-2024-a8cdce27ac)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a8cdce27ac");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PJGUD7RILUK66OYW7CQGUBXXRLKZGFGZ");
...
Fedora Windows cross-compiler.");
  ...
  script_tag(name:"affected", value:"'mingw-qt5-qtdeclarative' package(s) on Fedora 39.");
