...
ChangeLog:
  ...
  * Wed Dec 16 2009 Tom Lane  8.3.9-1
  ...
  - Update to PostgreSQL 8.3.9, for various fixes including two security issues
...
su -c 'yum update postgresql' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-13363");
