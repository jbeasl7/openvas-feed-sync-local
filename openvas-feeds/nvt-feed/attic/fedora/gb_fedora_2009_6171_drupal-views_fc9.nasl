...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64227");
  ...
  script_tag(name:"insight", value:"* Advisory ID: DRUPAL-SA-CONTRIB-2009-037 [0]
...
su -c 'yum update drupal-views' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-6171");
