...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64233");
...
su -c 'yum update mingw32-libpng' at the command line.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FEDORA-2009-6400");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/35233");
  script_tag(name:"summary", value:"The remote host is missing an update to mingw32-libpng
