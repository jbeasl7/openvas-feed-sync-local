...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886927");
  ...
  script_name("Fedora: Security Advisory for qt5-qtmultimedia (FEDORA-2024-2e27372d4c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2e27372d4c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EVZ6LX5YJIMRJGGLJ34OAIG5UG6GGM4H");
...
the use of available devices like cameras and radios.");
  ...
  script_tag(name:"affected", value:"'qt5-qtmultimedia' package(s) on Fedora 40.");
