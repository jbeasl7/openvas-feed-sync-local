...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885680");
  ...
  script_tag(name:"creation_date", value:"2024-02-10 02:03:14 +0000 (Sat, 10 Feb 2024)");
  script_name("Fedora: Security Advisory for rust-event-manager (FEDORA-2024-04877592b7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-04877592b7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/MB666KOSDCMTIFKFYONAYLMTW6QOLRII");
...
Note: This VT has been deprecated as a duplicate.");
  ...
  script_tag(name:"affected", value:"'rust-event-manager' package(s) on Fedora 39.");
