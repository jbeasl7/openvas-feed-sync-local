...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.1139.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1139-1)");
  ...
  Note: This VT has been deprecated as a duplicate. The replacement VT has OID 1.3.6.1.4.1.25623.1.0.856047.");
...
- CVE-2023-43490: Incorrect calculation in microcode keying mechanism
 ...
 local access.");
  ...
  script_tag(name:"affected", value:"'ucode-intel' package(s) on openSUSE Leap 15.5.");
