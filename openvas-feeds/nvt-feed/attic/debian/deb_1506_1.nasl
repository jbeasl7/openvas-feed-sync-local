...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60441");
  ...
  This VT has been deprecated and merged into the VT 'Debian: Security Advisory (DSA-1506)' (OID: 1.3.6.1.4.1.25623.1.0.60615).");
