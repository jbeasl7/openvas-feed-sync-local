...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57580");
  ...
  script_name("Debian: Security Advisory (DSA-1209-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1209-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1209");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trac' package(s) announced via the DSA-1209-1 advisory.

  This VT has been deprecated and merged into the VT 'Debian: Security Advisory (DSA-1209)' (OID: 1.3.6.1.4.1.25623.1.0.57582).");
