...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53736");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20191-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5949");
  script_tag(name:"insight", value:"Several cross site scripting vulnerabilities have been found in
...
affected since it doesn't contain a squirrelmail package");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update to squirrelmail announced via advisory DSA 191-1.

  This VT has been deprecated and merged into the VT 'Debian: Security Advisory (DSA-191)' (OID: 1.3.6.1.4.1.25623.1.0.53764).");
