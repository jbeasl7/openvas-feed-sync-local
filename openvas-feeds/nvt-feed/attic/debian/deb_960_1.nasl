...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56218");
...
version 2.1-5sarge1.
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20960-1");
  ...
  This VT has been deprecated and merged into the VT 'Debian: Security Advisory (DSA-960)' (OID: 1.3.6.1.4.1.25623.1.0.56219).");
