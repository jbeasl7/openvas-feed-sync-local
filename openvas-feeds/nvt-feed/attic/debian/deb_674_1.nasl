...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53502");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20674-1");
  script_tag(name:"insight", value:"Two security related problems have been discovered in mailman,
...
version 2.1.5-6.");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update to mailman announced via advisory DSA 674-1.

  This VT has been deprecated and merged into the VT 'Debian: Security Advisory (DSA-674)' (OID: 1.3.6.1.4.1.25623.1.0.53505).");
