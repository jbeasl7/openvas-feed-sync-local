...
if(description)
{
  ...
  This VT has been deprecated and split into multiple VTs based on vendor advisories:

  - Trend Micro Maximum Security < 12.0 Build 1226 Multiple Vulnerabilities (tmka-20066)
  (OID: 1.3.6.1.4.1.25623.1.0.118643)

  - Trend Micro Maximum Security <= 12.0 Build 1191 Driver Vulnerability (tmka-20207)
  (OID: 1.3.6.1.4.1.25623.1.0.118642)

  - Trend Micro Maximum Security < 12.0 Build 1226 Multiple Privilege Escalation Vulnerabilities
  (tmka-20339) (OID: 1.3.6.1.4.1.25623.1.0.118641).");
