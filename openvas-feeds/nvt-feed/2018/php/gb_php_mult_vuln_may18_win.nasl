...
if(description)
{
  ...
  script_name("PHP < 5.6.36, 7.x < 7.0.30, 7.1.x < 7.1.17, 7.2.x < 7.2.5 Multiple Vulnerabilities (May 2018) - Windows");
  ...
  prior to 7.1.17 and 7.2.x prior to 7.2.5 on Windows.");
