...
if(description)
{
  ...
  script_name("PHP < 5.6.33, 7.x < 7.0.27, 7.1.x < 7.1.13, 7.2.x < 7.2.1 Multiple Vulnerabilities - Windows");
  ...
  - CVE-2018-5712: Input validation error on the PHAR 404 error page via the URI of a request for a
  .phar file.

  - CVE-2018-5711: Integer signedness error in gd_gif_in.c in the GD Graphics Library (aka
  libgd).");

  script_tag(name:"impact", value:"Successfully exploiting these issues allows attacker to execute
  ...
  attacks and will also lead to a denial of service and exhausting the server resources.");

  script_tag(name:"affected", value:"PHP prior to version 5.6.33, 7.0.x prior to 7.0.27, 7.1.x
  prior to 7.1.13 and 7.2.x prior to 7.2.1.");

  script_tag(name:"solution", value:"Update to version 5.6.33, 7.0.27, 7.1.13, 7.2.1 or later.");
...
if (version_is_less(version: version, test_version: "5.6.33")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.6.33", install_path: location);
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.2.0", test_version_up: "7.2.1")) {
