...
if(description)
{
  ...
  script_name("PHP < 5.6.35, 7.x < 7.0.29, 7.1.x < 7.1.16, 7.2.x < 7.2.4 Security Bypass Vulnerability (May 2018) - Windows");
  ...
  to 7.1.16 and 7.2.x prior to 7.2.4 on Windows.");
