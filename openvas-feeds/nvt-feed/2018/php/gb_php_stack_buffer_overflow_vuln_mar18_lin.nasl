...
if(description)
{
  ...
  script_name("PHP 5.x < 5.6.34, 7.x < 7.0.28, 7.1.x < 7.1.15, 7.2.x < 7.2.3 Stack Buffer Overflow Vulnerability (Mar 2018) - Linux");
  ...
  prior to 7.1.15 and 7.2.x prior to 7.2.3 on Linux.");
