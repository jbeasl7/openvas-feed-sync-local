...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Security Advisories (MFSA2018-18, MFSA2018-21) - Windows");
  ...
  script_tag(name:"solution", value:"Update to Mozilla Firefox ESR version 60.2 or later. Please see the references for more information.");
