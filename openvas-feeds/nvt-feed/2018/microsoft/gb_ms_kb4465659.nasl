...
if(description)
{
  ...
  script_name("Microsoft Windows Security Bypass and Latest Servicing Stack Updates-Defense in Depth (KB4465659)");
  ...
  script_tag(name:"affected", value:"- Microsoft Windows 10 version 1607 for 32-bit/x64
