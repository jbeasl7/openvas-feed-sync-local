...
if(description)
{
  ...
  script_name("OpenEMR < 5.0.1-1 SQLi Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw exists due to insufficient validation of input data
  passed via 'newlistname' parameter to 'interface\super\edit_list.php' script.");

  script_tag(name:"impact", value:"Successful exploitation will allow an authenticated attacker to
  execute arbitrary SQL commands on affected system.");

  script_tag(name:"affected", value:"OpenEMR versions prior to 5.0.1.1.");

  script_tag(name:"solution", value:"Upgrade to version 5.0.1.1 or later. Please see the
...
if (version_is_less(version: version, test_version: "5.0.1-1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.0.1-1", install_path: location);
