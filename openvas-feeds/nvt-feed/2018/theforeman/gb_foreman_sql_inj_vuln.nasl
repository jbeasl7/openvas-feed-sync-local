...
if (description)
{
  ...
  script_name("Foreman 1.9 < 1.16.1 Multiple Vulnerabilities");
  ...
  - One of the parameters passed when saving widget positions on the dashboard is not properly
  escaped leading to possibility of SQL injection. Due to the nature of the query, exploitation is
  limited to possible information disclosure and does not allow modifications to the database. The
  vulnerable endpoint is only available to authenticated users.

  - CVE-2018-1097: Users with limited permissions for powering oVirt/RHV hosts on and off may
  discover the username and password used to connect to the compute resource.");

  script_tag(name:"affected", value:"Foreman version 1.9 through 1.16.0.");
