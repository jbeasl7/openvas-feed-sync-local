...
if (description)
{
  ...
  script_tag(name:"insight", value:"It was found that Foreman form helper does not authorize
  options for associated objects. Unauthorized user can see names of such objects if their count is
  less than 6.");
...
if (version_is_less(version: version, test_version: "1.14.0")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.14.0", install_path: location);
