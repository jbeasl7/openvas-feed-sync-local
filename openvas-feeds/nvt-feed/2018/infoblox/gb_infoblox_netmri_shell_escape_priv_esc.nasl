...
if( description )
{
  ...
  script_tag(name:"summary", value:"The administrative shell of Infoblox NetMRI is prone to shell
  escape and privilege escalation vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An authenticated user can escape the management shell and
  subsequently escalate to root via insecure file ownership and sudo permissions.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to gain complete
  control over the target system.");

  script_tag(name:"affected", value:"Infoblox NetMRI version 7.1.2 through 7.1.4. Other versions
