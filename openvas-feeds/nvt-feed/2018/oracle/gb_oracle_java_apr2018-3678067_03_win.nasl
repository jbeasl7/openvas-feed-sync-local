...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-11-22 19:40:00 +0000 (Wed, 22 Nov 2023)");
  ...
  script_tag(name:"summary", value:"Oracle Java SE is prone to a remote unspecified security vulnerability.");
...
if((vers =~ "^10" && version_is_less(version:vers, test_version:"10.0.1")) ||
