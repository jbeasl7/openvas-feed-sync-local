...
if(description)
{
  ...
  script_name("Oracle MySQL Security Update (cpujul2018 - 02) - Windows");
  ...
  5.6.40 and earlier, 5.7.22 and earlier.");
...
if(version_in_range(version:vers, test_version:"5.5", test_version2:"5.5.60") ||
   version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.40") ||
