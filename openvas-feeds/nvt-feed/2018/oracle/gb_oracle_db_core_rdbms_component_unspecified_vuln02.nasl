...
if(description)
{
  ...
  script_tag(name:"summary", value:"Oracle Database Server is prone to multiple unspecified security
  vulnerabilities.");
  ...
  script_tag(name:"affected", value:"Oracle Database Server versions 11.2.0.4 and 12.2.0.1 on
  Windows.");
  ...
  script_xref(name:"URL", value:"https://www.oracle.com/security-alerts/cpujan2018.html");
  script_xref(name:"URL", value:"https://www.oracle.com/security-alerts/alert-cve-2018-3110.html");
  script_xref(name:"URL", value:"https://web.archive.org/web/20181020003513/https://blogs.oracle.com/oraclesecurity/security-alert-cve-2018-3110-released");
  script_xref(name:"URL", value:"https://web.archive.org/web/20200227132722/http://www.securityfocus.com/bid/102547");
