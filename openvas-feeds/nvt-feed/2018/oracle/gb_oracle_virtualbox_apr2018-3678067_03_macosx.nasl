...
if(description)
{
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions prior to 5.1.36 and 5.2.x prior to
  5.2.10 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 5.2.10, 5.1.36 or later.");
...
if(vers =~ "^5\.2" && (version_is_less(version:vers, test_version:"5.2.10"))) {
  fix = "5.2.10";
}

else if(version_is_less(version:vers, test_version:"5.1.36")) {
  fix = "5.1.36";
}
