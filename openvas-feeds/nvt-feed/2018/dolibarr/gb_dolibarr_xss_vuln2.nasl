...
if (description)
{
  ...
  script_tag(name:"insight", value:"Cross Site Scripting (XSS) exists in product details that can
  result in execution of javascript code. The payload is saved with no interference from the
  detector. When visiting the page later, the payload executes.");

  script_tag(name:"affected", value:"Dolibarr version 6.0.2 and prior.");
