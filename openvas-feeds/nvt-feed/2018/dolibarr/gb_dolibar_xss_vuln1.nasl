...
if (description)
{
  ...
  script_tag(name:"insight", value:"The test_sql_and_script_inject function in htdocs/main.inc.php
  in Dolibarr blocks some event attributes but neither onclick nor onscroll, which allows XSS.");
