...
if(description)
{
  ...
  script_name("Wireshark Security Updates (wnpa-sec-2018-34_wnpa-sec-2018-41) - Mac OS X");
  ...
  2.4.7, 2.2.0 to 2.2.15 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 2.6.2, 2.4.8, 2.2.16. Please see the references for more information.");
...
if(version_in_range(version:vers, test_version:"2.6.0", test_version2:"2.6.1")) {
  fix = "2.6.2";
}

else if(version_in_range(version:vers, test_version:"2.4.0", test_version2:"2.4.7")) {
  fix = "2.4.8";
}

else if(version_in_range(version:vers, test_version:"2.2.0", test_version2:"2.2.15")) {
  fix = "2.2.16";
}
