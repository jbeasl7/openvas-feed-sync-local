...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to version 2.6.5 or later. Please see the references for more information.");
...
if(version_in_range(version:vers, test_version:"2.6.0", test_version2:"2.6.4")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.6.5", install_path:path);
