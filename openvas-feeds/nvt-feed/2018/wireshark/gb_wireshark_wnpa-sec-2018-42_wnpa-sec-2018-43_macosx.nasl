...
if(description)
{
  ...
  script_name("Wireshark Security Updates (wnpa-sec-2018-42_wnpa-sec-2018-43) - Mac OS X");
  ...
  to 2.4.7 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 2.6.2, 2.4.8. Please see the references for more information.");
