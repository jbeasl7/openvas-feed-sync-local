...
if(description)
{
  ...
  script_cve_id("CVE-2017-7830", "CVE-2018-4088", "CVE-2018-4096", "CVE-2018-4147");
  ...
  script_tag(name:"severity_date", value:"2019-01-17 14:00:43 +0000 (Thu, 17 Jan 2019)");
  ...
  script_tag(name:"insight", value:"Multiple flaws exist due to multiple memory corruption
  issues.");
  ...
  script_tag(name:"affected", value:"Apple iTunes prior to version 12.7.3.");
...
if(version_is_less(version:version, test_version:"12.7.3")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"12.7.3", install_path:location);
