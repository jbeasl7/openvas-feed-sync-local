...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-01-23 13:54:15 +0000 (Tue, 23 Jan 2018)");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.5", ver:"5.5.59-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.21-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.21-0ubuntu0.17.10.1", rls:"UBUNTU17.10"))) {
    report += res;
  }
