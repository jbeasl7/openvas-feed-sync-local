...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for prosody (openSUSE-SU-2018:1627-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1627-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-06/msg00017.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"prosody", rpm:"prosody~0.9.13~2.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"prosody-debuginfo", rpm:"prosody-debuginfo~0.9.13~2.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"prosody-debugsource", rpm:"prosody-debugsource~0.9.13~2.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
