...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for cgit (openSUSE-SU-2018:2308-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2308-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-08/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cgit'
  package(s) announced via the openSUSE-SU-2018:2308-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"cgit", rpm:"cgit~1.2.1~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cgit-debuginfo", rpm:"cgit-debuginfo~1.2.1~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cgit-debugsource", rpm:"cgit-debugsource~1.2.1~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
