...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for enigmail (openSUSE-SU-2018:1393-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1393-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-05/msg00096.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"enigmail", rpm:"enigmail~2.0.5~15.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
