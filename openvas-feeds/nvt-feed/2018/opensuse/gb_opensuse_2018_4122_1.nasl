...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2018:4122-1");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~71.0.3578.98~lp150.2.33.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromedriver-debuginfo", rpm:"chromedriver-debuginfo~71.0.3578.98~lp150.2.33.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~71.0.3578.98~lp150.2.33.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-debuginfo", rpm:"chromium-debuginfo~71.0.3578.98~lp150.2.33.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-debugsource", rpm:"chromium-debugsource~71.0.3578.98~lp150.2.33.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
