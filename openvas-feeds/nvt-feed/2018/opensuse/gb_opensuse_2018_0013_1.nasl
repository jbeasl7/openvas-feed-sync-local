...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for kernel-firmware (openSUSE-SU-2018:0013-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:0013-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-01/msg00009.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"kernel-firmware", rpm:"kernel-firmware~20170530~14.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-amd", rpm:"ucode-amd~20170530~14.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
