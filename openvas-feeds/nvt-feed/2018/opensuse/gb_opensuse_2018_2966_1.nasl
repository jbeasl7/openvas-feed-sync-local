...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for zsh (openSUSE-SU-2018:2966-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2966-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-10/msg00001.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"zsh", rpm:"zsh~5.6.2~9.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zsh-debuginfo", rpm:"zsh-debuginfo~5.6.2~9.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zsh-debugsource", rpm:"zsh-debugsource~5.6.2~9.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zsh-htmldoc", rpm:"zsh-htmldoc~5.6.2~9.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
