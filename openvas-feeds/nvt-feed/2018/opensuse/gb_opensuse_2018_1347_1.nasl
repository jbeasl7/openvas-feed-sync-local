...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for enigmail (openSUSE-SU-2018:1347-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1347-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-05/msg00085.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'enigmail'
  package(s) announced via the openSUSE-SU-2018:1347-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"enigmail", rpm:"enigmail~2.0.4~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
