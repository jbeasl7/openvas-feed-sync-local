...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for matrix-synapse (openSUSE-SU-2018:1767-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1767-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-06/msg00038.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'matrix-synapse'
  package(s) announced via the openSUSE-SU-2018:1767-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"python2-matrix-synapse", rpm:"python2-matrix-synapse~0.28.1~lp150.2.4.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-matrix-synapse", rpm:"python3-matrix-synapse~0.28.1~lp150.2.4.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
