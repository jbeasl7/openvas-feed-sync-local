...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for qutebrowser (openSUSE-SU-2018:2120-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2120-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-07/msg00037.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qutebrowser'
  package(s) announced via the openSUSE-SU-2018:2120-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"qutebrowser", rpm:"qutebrowser~1.4.1~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
