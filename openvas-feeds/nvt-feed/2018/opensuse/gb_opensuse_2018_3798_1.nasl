...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for apache-pdfbox (openSUSE-SU-2018:3798-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:3798-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-11/msg00021.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-pdfbox'
  package(s) announced via the openSUSE-SU-2018:3798-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"apache-pdfbox", rpm:"apache-pdfbox~1.8.12~lp150.4.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache-pdfbox-javadoc", rpm:"apache-pdfbox-javadoc~1.8.12~lp150.4.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
