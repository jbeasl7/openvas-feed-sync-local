...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for testing (openSUSE-SU-2018:1340-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1340-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-05/msg00082.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'testing'
  package(s) announced via the openSUSE-SU-2018:1340-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"update-test-security", rpm:"update-test-security~5.1~lp150.3.4.2", rls:"openSUSELeap15.0"))) {
    report += res;
  }
