...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for apache-pdfbox (openSUSE-SU-2018:3384-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:3384-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-10/msg00061.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"apache-pdfbox", rpm:"apache-pdfbox~1.8.12~4.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache-pdfbox-javadoc", rpm:"apache-pdfbox-javadoc~1.8.12~4.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
