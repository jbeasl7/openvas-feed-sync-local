...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for Security (openSUSE-SU-2018:2399-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2399-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-08/msg00058.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20180807~28.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-blob", rpm:"ucode-intel-blob~20180807~28.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debuginfo", rpm:"ucode-intel-debuginfo~20180807~28.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debugsource", rpm:"ucode-intel-debugsource~20180807~28.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
