...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for cinnamon (openSUSE-SU-2018:2125-1)");
  ...
  * deskletManager: Initialise some variables and remove the variables
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2125-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-07/msg00042.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"cinnamon", rpm:"cinnamon~3.4.6~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cinnamon-debuginfo", rpm:"cinnamon-debuginfo~3.4.6~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cinnamon-debugsource", rpm:"cinnamon-debugsource~3.4.6~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cinnamon-gschemas", rpm:"cinnamon-gschemas~3.4.6~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cinnamon-gschemas-branding-upstream", rpm:"cinnamon-gschemas-branding-upstream~3.4.6~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
