...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python-dulwich (openSUSE-SU-2018:2213-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2213-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-08/msg00014.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"python-dulwich", rpm:"python-dulwich~0.18.5~11.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-dulwich-debuginfo", rpm:"python-dulwich-debuginfo~0.18.5~11.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-dulwich-debugsource", rpm:"python-dulwich-debugsource~0.18.5~11.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
