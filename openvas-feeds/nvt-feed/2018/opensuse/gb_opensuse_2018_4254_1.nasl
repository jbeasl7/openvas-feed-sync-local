...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for ovmf (openSUSE-SU-2018:4254-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:4254-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-12/msg00059.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ovmf'
  package(s) announced via the openSUSE-SU-2018:4254-1 advisory.");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"ovmf", rpm:"ovmf~2017+git1492060560.b6d11d7c46~13.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovmf-tools", rpm:"ovmf-tools~2017+git1492060560.b6d11d7c46~13.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-ia32", rpm:"qemu-ovmf-ia32~2017+git1492060560.b6d11d7c46~13.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86_64", rpm:"qemu-ovmf-x86_64~2017+git1492060560.b6d11d7c46~13.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86_64-debug", rpm:"qemu-ovmf-x86_64-debug~2017+git1492060560.b6d11d7c46~13.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
