...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for librelp (openSUSE-SU-2018:0829-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:0829-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-03/msg00064.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"librelp-debugsource", rpm:"librelp-debugsource~1.2.12~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"librelp-devel", rpm:"librelp-devel~1.2.12~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"librelp0", rpm:"librelp0~1.2.12~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"librelp0-debuginfo", rpm:"librelp0-debuginfo~1.2.12~2.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
