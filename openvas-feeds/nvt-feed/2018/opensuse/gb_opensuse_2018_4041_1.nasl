...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for rubygem-activejob-5_1 (openSUSE-SU-2018:4041-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:4041-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-12/msg00013.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-activejob-5_1'
  package(s) announced via the openSUSE-SU-2018:4041-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-activejob-5_1", rpm:"ruby2.5-rubygem-activejob-5_1~5.1.4~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"uby2.5-rubygem-activejob-doc-5_1", rpm:"uby2.5-rubygem-activejob-doc-5_1~5.1.4~lp150.2.3.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
