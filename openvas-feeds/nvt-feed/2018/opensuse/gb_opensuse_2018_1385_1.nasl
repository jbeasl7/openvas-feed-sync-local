...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for opencv (openSUSE-SU-2018:1385-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:1385-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-05/msg00094.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"libopencv-qt56_3", rpm:"libopencv-qt56_3~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopencv-qt56_3-debuginfo", rpm:"libopencv-qt56_3-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopencv3_1", rpm:"libopencv3_1~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopencv3_1-debuginfo", rpm:"libopencv3_1-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv", rpm:"opencv~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-debuginfo", rpm:"opencv-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-debugsource", rpm:"opencv-debugsource~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-devel", rpm:"opencv-devel~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-doc", rpm:"opencv-doc~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-qt5", rpm:"opencv-qt5~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-qt5-debuginfo", rpm:"opencv-qt5-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-qt5-debugsource", rpm:"opencv-qt5-debugsource~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-qt5-devel", rpm:"opencv-qt5-devel~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencv-qt5-doc", rpm:"opencv-qt5-doc~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-opencv", rpm:"python-opencv~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-opencv-debuginfo", rpm:"python-opencv-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-opencv-qt5", rpm:"python-opencv-qt5~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-opencv-qt5-debuginfo", rpm:"python-opencv-qt5-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-opencv", rpm:"python3-opencv~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-opencv-debuginfo", rpm:"python3-opencv-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-opencv-qt5", rpm:"python3-opencv-qt5~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-opencv-qt5-debuginfo", rpm:"python3-opencv-qt5-debuginfo~3.1.0~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
