...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for mercurial (openSUSE-SU-2018:3517-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:3517-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-10/msg00077.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mercurial'
  package(s) announced via the openSUSE-SU-2018:3517-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"mercurial", rpm:"mercurial~4.5.2~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mercurial-debuginfo", rpm:"mercurial-debuginfo~4.5.2~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mercurial-debugsource", rpm:"mercurial-debugsource~4.5.2~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mercurial-lang", rpm:"mercurial-lang~4.5.2~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
