...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python-paramiko (openSUSE-SU-2018:0799-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:0799-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-03/msg00057.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"python-paramiko", rpm:"python-paramiko~2.0.8~4.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
