...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for obs-service-refresh_patches (openSUSE-SU-2018:2801-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2018:2801-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2018-09/msg00045.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"obs-service-refresh_patches", rpm:"obs-service-refresh_patches~0.3.9+git.1537184752.d624424~9.3.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
