...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10949");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_name("QuiXplorer < 2.3.1 Directory Traversal Vulnerability");
  ...
  script_tag(name:"summary", value:"QuiXplorer is prone to a directory traversal vulnerability.");
