...
if(description)
{
  ...
  script_name("IlohaMail < 0.7.9 Contacts Deletion Vulnerability");
  ...
  script_tag(name:"summary", value:"IlohaMail contains a flaw that enables an authenticated user to
  delete contacts belonging to any user provided the DB-based backend is used to store contacts. The
  flaw arises because ownership of 'delete_item' is not checked when deleting entries in
