...
if(description)
{
  ...
  script_name("Bay Networks Accelar 1200 Switch Default Credentials (Telnet)");
  ...
  script_tag(name:"summary", value:"The Bay Networks Accelar 1200 switch has default credentials
  set.");
...
if( p && "yes" >< p )
  ...
  clist = default_credentials_get_list( vendor:"accelar" );
