...
if(description)
{
  ...
  script_name("Mambo Site Server index.php mos_change_template XSS Vulnerability - Active Check");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20210121161644/http://www.securityfocus.com/bid/9890");

  script_tag(name:"summary", value:"An attacker may use the installed version of Mambo Site Server
  to perform a cross-site scripting (XSS) attack on this host.");

  script_tag(name:"vuldetect", value:"Sends a crafted HTTP GET request and checks the response.");

  script_tag(name:"solution", value:"Update to version 4.5 (1.0.4) or later.");
...
if (res =~ "^HTTP/1\.[01] 200" && '<form action="/index.php?mos_change_template=<script>foo</script>' >< res) {
