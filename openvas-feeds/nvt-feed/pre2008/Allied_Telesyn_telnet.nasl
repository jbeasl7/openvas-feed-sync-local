...
if(description)
{
  ...
  script_name("Allied Telesyn Router/Switch Default Credentials (Telnet)");
  ...
  script_tag(name:"summary", value:"The Allied Telesyn Router/Switch has default credentials set.");
  ...
  These credentials could also be potentially used to gain other sensitive information about the
...
if( p && "yes" >< p )
  ...
  clist = default_credentials_get_list( vendor:"allied" );
