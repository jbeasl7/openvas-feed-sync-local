...
if(description)
{
  ...
  script_tag(name:"summary", value:"Telnet based detection of Lantronix Devices.");
...
port   = telnet_get_port( default:9999 ); # Most devices are running on 9999 but there are a few like MSS on 23/tcp
...
if( egrep( string:banner, pattern:"^Lantronix .* Version ", icase:FALSE ) ||
    # nb: Both are covered in a separate Detection-VT
