...
if(description)
{
  ...
  script_name("Adobe Acrobat <= 9.5.2 Help Page XSS Vulnerability - Mac OS X");
...
if(version_is_less_equal(version:vers, test_version:"9.5.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"Upgrade to latest version according to the information provided by the developer", install_path:path);
