...
if (description)
{
  ...
  script_name("Apache Wicket XSS Vulnerability (Mar 2013)");
  ...
  script_tag(name:"summary", value:"Apache Wicket is prone to a cross-site scripting (XSS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to JavaScript statements can break out of
  a '<script>' tag in the rendered response.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to inject
  arbitrary web script or HTML.");

  script_tag(name:"affected", value:"Apache Wicket versions 1.4.x prior to 1.4.22, 1.5.x prior to
  1.5.10 and 6.x prior to 6.4.0.");

  script_tag(name:"solution", value:"Update to version 1.4.22, 1.5.10, 6.4.0 or later.");

  script_xref(name:"URL", value:"https://wicket.apache.org/news/2013/03/03/cve-2012-5636.html");
  script_xref(name:"URL", value:"https://web.archive.org/web/20210124114227/http://www.securityfocus.com/bid/101644");
...
if (version_in_range(version: version, test_version: "1.4.0", test_version2: "1.4.21")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.4.22", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "1.5.0", test_version2: "1.5.9")) {
