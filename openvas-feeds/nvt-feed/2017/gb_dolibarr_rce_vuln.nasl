...
if (description)
{
  ...
  script_name("Dolibarr < 5.0.4 RCE Vulnerability");
  ...
  script_tag(name:"summary", value:"Dolibarr allows low-privilege users to upload files of
  dangerous types, which can result in arbitrary code execution within the context of the
