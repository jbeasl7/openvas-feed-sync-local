...
if (description)
{
  ...
  script_name("OTRS 4.x < 4.0.27, 5.x < 5.0.24, 6.x < 6.0.2 RCE Vulnerability (Dec 2017)");
  ...
  script_tag(name:"insight", value:"An attacker who is logged into OTRS as an agent can manipulate
  form parameters and execute arbitrary shell commands with the permissions of the OTRS or web
  server user.");

  script_tag(name:"affected", value:"OTRS version 4.x through 4.0.26, 5.x through 5.0.24 and 6.x
  through 6.0.1.");
