...
if(description)
{
  ...
  script_name("Oracle VirtualBox Security Bypass Vulnerability - 01 (Apr 2017) - Mac OS X");
  ...
  script_tag(name:"solution", value:"Update to version 5.0.34, 5.1.16 or later.");
