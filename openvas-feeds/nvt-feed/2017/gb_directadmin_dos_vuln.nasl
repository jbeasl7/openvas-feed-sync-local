...
if (description)
{
  ...
  script_tag(name:"summary", value:"DirectAdmin is prone to a denial of service (DoS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An attacker can send a username and password in the login screen
DirectAdmin with an overly long password which results in a denial of service condition.");
