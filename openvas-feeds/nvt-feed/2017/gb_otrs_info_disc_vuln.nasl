...
if (description)
{
  ...
  script_name("OTRS 3.3.x < 3.3.19 Information Disclosure Vulnerability");
  ...
  special URLs from OTRS which can lead to the disclosure of any configuration information,
  including database credentials.");

  script_tag(name:"affected", value:"OTRS version 3.3.x through 3.3.18.");

  script_tag(name:"solution", value:"Update to version 3.3.19 or later.");
...
if (version_in_range(version: version, test_version: "3.3.0", test_version2: "3.3.18")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.3.19", install_path: location);
