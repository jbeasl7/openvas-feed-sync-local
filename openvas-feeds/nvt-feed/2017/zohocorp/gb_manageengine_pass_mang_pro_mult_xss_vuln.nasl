...
if (description)
{
  ...
  script_name("ManageEngine Password Manager Pro Multiple XSS Vulnerabilities (Dec 2017)");

  script_tag(name:"summary", value:"ManageEngine Password Manager Pro is prone to multiple
  ...
  script_dependencies("gb_manageengine_pass_mang_pro_http_detect.nasl");
