...
if(description)
{
  ...
  script_name("VMware Workstation Player Multiple Code Execution Vulnerabilities (Feb 2017) - Windows");

  script_tag(name:"summary", value:"VMware Workstation Player is prone to multiple code execution vulnerabilities.");
