...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw is due to an improper validation of web requests passed
  via POST request.");
  ...
  script_tag(name:"affected", value:"DiskBoss Enterprise versions 7.0 through 7.5.12.");
...
if(version_in_range(version:version, test_version: "7.0.0", test_version2:"7.5.12")) {
