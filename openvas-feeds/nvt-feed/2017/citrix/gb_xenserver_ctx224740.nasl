...
if (description)
{
  ...
  - CVE-2017-10920, CVE-2017-10921, CVE-2017-10922: Grant table operations mishandle reference counts.

  - CVE-2017-10918: Stale P1M mappings due to insufficient error checking.

  - CVE-2017-10912: Page transfer may allow PV guest to elevate privilege.

  - CVE-2017-10913, CVE-2017-10914: Races in the grant table unmap code.

  - CVE-2017-10915: x85: Insufficient reference counts during shadow emulation.

  - CVE-2017-10917: NULL pointer deref in event channel poll.

  - CVE-2017-10911: blkif responses leak backend stack data.");
