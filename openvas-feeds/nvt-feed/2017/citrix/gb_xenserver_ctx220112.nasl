...
if (description)
{
  ...
  - CVE-2017-5572: Authenticated read-only administrator can corrupt host database

  - CVE-2017-5573: Authenticated read-only administrator can cancel tasks of other administrators

  - CVE-2015-5300, CVE-2015-7704, CVE-2015-7705: NTP updates.
