...
if(description)
{
  ...
  script_name("Wireshark Multiple DoS Vulnerabilities-01 (Apr 2017) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 2.2.1 or
  later.");
...
if(vers == "2.2.0") {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.2.1", install_path:path);
