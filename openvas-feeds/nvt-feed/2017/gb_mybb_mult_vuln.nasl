...
if(description)
{
  ...
  script_name("MyBB < 1.8.13 Multiple Vulnerabilities");
  ...
  script_tag(name:"impact", value:"The remote attacker might be able to execute arbitrary code,
  conduct xss attacks or bypass HTML filters.");

  script_tag(name:"affected", value:"MyBB version 1.8.12 and prior.");

  script_tag(name:"solution", value:"Update to version 1.8.13 and prior.");
