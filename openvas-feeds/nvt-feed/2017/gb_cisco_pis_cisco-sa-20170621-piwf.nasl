...
if (description)
{
  ...
  script_name("Cisco Prime Infrastructure Web Framework Code Cross-Site Scripting Vulnerability (cisco-sa-20170621-piwf)");
...
context of the affected site or allow the attacker to access sensitive browser-based information.");
  ...
  script_tag(name:"severity_date", value:"2017-07-07 15:01:00 +0000 (Fri, 07 Jul 2017)");
