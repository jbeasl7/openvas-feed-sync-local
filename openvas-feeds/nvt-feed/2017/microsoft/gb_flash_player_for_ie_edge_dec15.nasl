...
if(description)
{
  ...
  - Microsoft Windows 8.1 for x32/x64
...
if(version_is_less(version:vers, test_version:"20.0.0.267")) {
  report = report_fixed_ver(file_checked:path, file_version:vers, vulnerable_range:"Less than 20.0.0.267");
