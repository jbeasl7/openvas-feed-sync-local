...
if(description)
{
  ...
  script_name("Microsoft Security Essentials Multiple RCE Vulnerabilities");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft Security Updates released for Microsoft Malware
  Protection Engine (MPE) dated 12/06/2017");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple flaws exist when the Microsoft
  Malware Protection Engine (MPE) does not properly scan a specially crafted file,
...
if(version_is_less(version:mpe_version, test_version:"1.1.14405.2"))
{
  report = report_fixed_ver(installed_version: mpe_version, fixed_version: "1.1.14405.2");
