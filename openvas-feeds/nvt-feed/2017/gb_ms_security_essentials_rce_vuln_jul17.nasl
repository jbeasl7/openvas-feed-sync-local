...
if(!version = get_kb_item("microsoft/security_essentials/mpe_version"))
  exit(0);

if(version_is_less(version:version, test_version:"1.1.13903.0")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"1.1.13903.0");
