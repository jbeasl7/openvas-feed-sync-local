...
if (description)
{
  ...
  script_tag(name:"summary", value:"SugarCRM is prone to a signature validation vulnerability in
  php-saml.");

  script_tag(name:"insight", value:"The onelogin/php-saml third party library which ships as part of
  the SugarCRM application is  potentially vulnerable to Response Wrapping attacks resulting in a
  malicious user gaining unauthorized access to the system. This issue impacts environments where
  SAML authentication is configured and enabled supporting EncryptedAssertion.");
