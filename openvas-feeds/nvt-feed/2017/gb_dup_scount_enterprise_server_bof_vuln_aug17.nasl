...
if(description)
{
  ...
  be exploited to cause a buffer overflow via an overly long string passed to server.");
  ...
  script_mandatory_keys("dup_scout/enterprise/detected");
...
# nb: Installed 9.0.28, 9.9.14, 10.0.18 ; all are vulnerable
if(version_is_less_equal(version:version, test_version:"10.0.18")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"10.2");
