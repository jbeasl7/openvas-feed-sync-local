...
if( description )
{
  ...
  script_name("Red Hat JBoss Enterprise Application Platform (EAP) End of Life (EOL) Detection - Linux");
  ...
  script_mandatory_keys("redhat/jboss/eap/detected", "Host/runs_unixoide");
...
if( ret = product_reached_eol( cpe: CPE, version: version ) ) {
  report = eol_build_message( name: "Red Hat JBoss Enterprise Application Platform (EAP)",
                              cpe: CPE,
                              version: version,
