...
if (description)
{
  ...
  script_name("MODX CMS 2.x - 2.6.4 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"In MODX Revolution, the 'key' and 'name' parameters in the
  System Settings module are vulnerable to XSS. A malicious payload sent to connectors/index.php
  will be triggered by every user, when they visit this module.");

  script_tag(name:"affected", value:"MODX CMS version 2.x through 2.6.4.");
...
if (version_in_range(version: version, test_version: "2.0", test_version2: "2.6.4")) {
