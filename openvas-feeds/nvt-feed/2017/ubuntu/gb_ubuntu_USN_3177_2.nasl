...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat6-java", ver:"6.0.35-1ubuntu3.10", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat6", ver:"6.0.35-1ubuntu3.10", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat7-java", ver:"7.0.52-1ubuntu0.9", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat7", ver:"7.0.52-1ubuntu0.9", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
