...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-22 13:27:42 +0000 (Tue, 22 Aug 2017)");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.5", ver:"5.5.57-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.19-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.19-0ubuntu0.17.04.1", rls:"UBUNTU17.04"))) {
    report += res;
  }
