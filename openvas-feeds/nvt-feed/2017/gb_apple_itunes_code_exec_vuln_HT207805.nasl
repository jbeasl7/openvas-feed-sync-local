...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw is due to multiple memory corruption issues.");

  script_tag(name:"impact", value:"Successful exploitation will lead to arbitrary code
  execution.");

  script_tag(name:"affected", value:"Apple iTunes versions before 12.6.1 on Windows.");

  script_tag(name:"solution", value:"Update to version 12.6.1 or later.");
...
if(version_is_less(version:version, test_version:"12.6.1.25")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"12.6.1.25", install_path:location);
