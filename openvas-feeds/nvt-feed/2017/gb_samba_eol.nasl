...
if(description)
{
  ...
  script_name("Samba End of Life (EOL) Detection");
  ...
  script_tag(name:"summary", value:"The Samba version on the remote host has reached the end of life
  (EOL) and should not be used anymore.");

  script_tag(name:"vuldetect", value:"Checks if an EOL version is present on the target host.");

  script_tag(name:"impact", value:"An EOL version of Samba is not receiving any security updates
  ...
  script_tag(name:"solution", value:"Update the Samba version on the remote host to a still
  supported version.");
...
if( ret = product_reached_eol( cpe:CPE, version:vers ) ) {
  report = eol_build_message( name:"Samba",
                              cpe:CPE,
                              version:vers,
                              location:loc,
