...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python-pycrypto (openSUSE-SU-2017:0156-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2017:0156-1");
  script_tag(name:"solution_type", value:"VendorFix");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone Networks GmbH");
  script_family("SuSE Local Security Checks");
  script_dependencies("gather-package-list.nasl");
  script_mandatory_keys("ssh/login/opensuse", "ssh/login/rpms", re:"ssh/login/release=openSUSE13\.2");
  exit(0);
}
...
if(release == "openSUSE13.2")
{
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-pycrypto", rpm:"python-pycrypto~2.6.1~3.3.1", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python-pycrypto-debuginfo", rpm:"python-pycrypto-debuginfo~2.6.1~3.3.1", rls:"openSUSE13.2"))) {
    report += res;
  }
