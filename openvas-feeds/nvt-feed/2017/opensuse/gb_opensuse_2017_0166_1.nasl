...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for icoutils (openSUSE-SU-2017:0166-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2017:0166-1");
...
if(release == "openSUSELeap42.1") {
  if(!isnull(res = isrpmvuln(pkg:"icoutils", rpm:"icoutils~0.31.1~7.1", rls:"openSUSELeap42.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icoutils-debuginfo", rpm:"icoutils-debuginfo~0.31.1~7.1", rls:"openSUSELeap42.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icoutils-debugsource", rpm:"icoutils-debugsource~0.31.1~7.1", rls:"openSUSELeap42.1"))) {
    report += res;
  }
