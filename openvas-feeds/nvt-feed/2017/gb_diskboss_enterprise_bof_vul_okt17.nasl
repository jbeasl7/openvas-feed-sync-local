...
if(description)
{
  ...
  script_name("DiskBoss Enterprise Server 8.x <= 8.4.16 Local Buffer Overflow Vulnerability - Windows");
  ...
  script_tag(name:"summary", value:"DiskBoss Enterprise is prone to a local buffer overflow
  vulnerability.");
  ...
  script_tag(name:"affected", value:"DiskBoss Enterprise versions 8.0 through 8.4.16.");
...
if(version_in_range(version:version, test_version: "8.0.0", test_version2:"8.4.16")){
