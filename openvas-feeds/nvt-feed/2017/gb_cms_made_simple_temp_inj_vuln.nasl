...
if (description)
{
  ...
  script_name("CMS Made Simple 2.1.6 Template Injection Vulnerability");
  ...
  script_tag(name:"insight", value:"There is a server-side template injection vulnerability in
  CMS Made Simple via the cntnt01detailtemplate parameter.");
