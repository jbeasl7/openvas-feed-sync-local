...
if(description)
{
  ...
  script_name("OpenSSL End of Life (EOL) Detection - Linux");
  ...
  script_xref(name:"URL", value:"https://openssl-library.org/policies/releasestrat/index.html");
...
if( ret = product_reached_eol( cpe:CPE, version:vers ) ) {
  report = eol_build_message( name:"OpenSSL",
                              cpe:CPE,
                              version:vers,
                              location:path,
