...
if (description)
{
  ...
  script_dependencies("gb_riverbed_steelhead_ssh_detect.nasl",
                      "gb_riverbed_steelhead_http_detect.nasl");
  script_mandatory_keys("riverbed/steelhead/detected");

  script_tag(name:"summary", value:"Riverbed SteelHead VCX is prone to an authenticated arbitrary
  file read vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Riverbed Steelhead VCX version 9.6.0a.");
