...
if (description)
{
  ...
  script_name("Splunk Enterprise DoS Vulnerability (SP-CAAAPW8)");
  ...
  script_tag(name:"summary", value:"Splunk Enterprise is prone to a denial of service (DoS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Splunk Web in Splunk Enterprise allows remote authenticated
  users to cause a denial of service (daemon crash) via a crafted GET request.");
