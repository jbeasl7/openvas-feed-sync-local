...
if(description)
{
  ...
  script_name("Oracle VirtualBox Security Bypass Vulnerability - 01 (Apr 2017) - Windows");

  script_tag(name:"summary", value:"Oracle VirtualBox is prone to a security bypass vulnerability.");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions prior to 5.0.34
  and prior to 5.1.16 on Windows.");

  script_tag(name:"solution", value:"Update to version 5.0.34 or 5.1.16 or later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"http://www.oracle.com/technetwork/security-advisory/cpuapr2017-3236618.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/97698");
...
if(vers =~ "^5\.0") {
  if(version_is_less(version:vers, test_version:"5.0.34")) {
    fix = "5.0.34";
    VULN = TRUE;
  }
}
  ...
  if(version_is_less(version:vers, test_version:"5.1.16")) {
    fix = "5.1.16";
    VULN = TRUE;
  }
}
