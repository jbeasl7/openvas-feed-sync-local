...
if(description)
{
  ...
  script_cve_id("CVE-2016-4692", "CVE-2016-4743", "CVE-2016-7586", "CVE-2016-7587",
                ...
                "CVE-2016-7610", "CVE-2016-7611", "CVE-2016-7632", "CVE-2016-7635",
                "CVE-2016-7639", "CVE-2016-7640", "CVE-2016-7641", "CVE-2016-7642",
                "CVE-2016-7645", "CVE-2016-7646", "CVE-2016-7648", "CVE-2016-7649",
  ...
  script_name("Apple iTunes Multiple Vulnerabilities (Feb 2017) - Windows");
  ...
  script_tag(name:"affected", value:"Apple iTunes versions before 12.5.4 on Windows.");

  script_tag(name:"solution", value:"Update to version 12.5.4 or later.");
...
if(version_is_less(version:version, test_version:"12.5.4.42")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"12.5.4.42", install_path:location);
