...
if(description)
{
  ...
  script_name("phpMyAdmin Multiple Security Vulnerabilities - 03 (Dec 2016) - Windows");
  ...
  script_tag(name:"affected", value:"phpMyAdmin versions 4.4.x prior to 4.4.15.9 and 4.6.x prior to
  4.6.5.");

  script_tag(name:"solution", value:"Update to version 4.4.15.9, 4.6.5 or later.");
