...
if(description)
{
  ...
  script_name("PostgreSQL End of Life (EOL) Detection - Windows");
  ...
  script_tag(name:"summary", value:"The PostgreSQL version on the remote host has reached the End of
  Life (EOL) and should not be used anymore.");

  script_tag(name:"vuldetect", value:"Checks if an EOL version is present on the target host.");

  script_tag(name:"impact", value:"An EOL version of PostgreSQL is not receiving any security
  ...
  script_tag(name:"solution", value:"Update the PostgreSQL version on the remote host to a still
  supported version.");
...
if( ret = product_reached_eol( cpe:CPE, version:version ) ) {
  report = eol_build_message( name:"PostgreSQL",
                              cpe:CPE,
                              version:version,
                              location:location,
