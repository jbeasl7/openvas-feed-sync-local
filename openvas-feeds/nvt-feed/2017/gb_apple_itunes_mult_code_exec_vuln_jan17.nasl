...
if(description)
{
  ...
  script_name("Apple iTunes Multiple Code Execution Vulnerabilities (Jan 2017) - Windows");

  script_tag(name:"summary", value:"Apple iTunes is prone to multiple code execution
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple flaws are due to multiple memory corruption and
  initialization errors.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to execute
  arbitrary code. Failed exploit attempts may result in a denial of service (DoS) condition.");

  script_tag(name:"affected", value:"Apple iTunes prior to version 12.5.5 on Windows.");

  script_tag(name:"solution", value:"Update to version 12.5.5 or later.");
...
if(version_is_less(version:version, test_version:"12.5.5")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"12.5.5", install_path:location);
