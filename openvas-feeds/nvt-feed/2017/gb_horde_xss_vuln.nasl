...
if(description)
{
  ...
  script_name("Horde Groupware <= 5.2.22 Multiple Vulnerabilities");
  ...
  - CVE-2017-16906, CVE-2017-16907: Multiple cross-site scripting (XSS)

  - SQL Injection (SQLi) via the group parameter to /services/prefs.php or the homePostalCode
  parameter to /turba/search.php.");
