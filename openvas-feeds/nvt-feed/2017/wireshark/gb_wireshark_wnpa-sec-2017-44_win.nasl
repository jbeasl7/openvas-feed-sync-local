...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to version 2.4.2, 2.2.10,
  2.0.16.");
...
if(vers =~ "^2\.[024]") {
  if(version_in_range(version:vers, test_version:"2.4.0", test_version2:"2.4.1")) {
    fix = "2.4.2";
  }

  else if(version_in_range(version:vers, test_version:"2.2.0", test_version2:"2.2.9")) {
    fix = "2.2.10";
  }

  else if(version_in_range(version:vers, test_version:"2.0.0", test_version2:"2.0.15")) {
    fix = "2.0.16";
  }
