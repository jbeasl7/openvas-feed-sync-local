...
if(description)
{
  ...
  script_dependencies("gb_avm_fritz_box_http_detect.nasl", "gb_avm_fritz_box_sip_detect.nasl",
                      "gb_avm_fritz_box_upnp_detect.nasl", "gb_avm_fritz_box_ftp_detect.nasl");
