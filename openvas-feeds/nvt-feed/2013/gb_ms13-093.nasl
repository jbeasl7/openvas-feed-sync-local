...
if(description)
{
  ...
  script_name("Microsoft Windows Ancillary Function Driver Information Disclosure Vulnerability (2875783)");
...
crafted application.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/63545");
