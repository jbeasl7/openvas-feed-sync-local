...
if(description)
{
  ...
  script_tag(name:"summary", value:"Apple Mac OS X is prone to an authentication bypass vulnerability.");
...
validation.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/62812");
