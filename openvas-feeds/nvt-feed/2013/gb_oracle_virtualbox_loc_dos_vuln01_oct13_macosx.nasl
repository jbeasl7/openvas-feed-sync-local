...
if(description)
{
  ...
  script_name("Oracle VirtualBox Local Denial of Service Vulnerability-01 (Oct 2013) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox version 3.2.18 and before, 4.0.20 and before, 4.1.28
