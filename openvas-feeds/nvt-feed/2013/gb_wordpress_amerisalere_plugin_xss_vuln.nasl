...
if(description)
{
  ...
  script_name("WordPress Amerisale-Re Plugin XSS Vulnerability");

  script_tag(name:"summary", value:"The WordPress plugin 'Amerisale-Re' is prone to a cross-site scripting (XSS) vulnerability.");
