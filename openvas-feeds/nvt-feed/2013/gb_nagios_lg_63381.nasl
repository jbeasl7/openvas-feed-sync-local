...
if (description)
{
  ...
  script_name("Nagios Looking Glass <= 1.1.0 beta 2 LFI Vulnerability - Active Check");
  ...
  script_dependencies("gb_nagios_http_detect.nasl", "no404.nasl", "webmirror.nasl",
                      "DDI_Directory_Scanner.nasl");
  script_require_ports("Services/www", 80);
  script_mandatory_keys("nagios/http/detected");

  script_tag(name:"impact", value:"An attacker can exploit this issue to obtain potentially
  ...
  script_tag(name:"insight", value:"The application fails to adequately validate user-supplied
  input.");
  ...
  script_tag(name:"summary", value:"Nagios Looking Glass is prone to a local file include (LFI)
  vulnerability.");

  script_tag(name:"affected", value:"Nagios Looking Glass versions 1.1.0 beta 2 and prior.");
