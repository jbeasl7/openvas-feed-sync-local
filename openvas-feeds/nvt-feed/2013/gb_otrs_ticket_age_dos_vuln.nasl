...
if (description)
{
  ...
  script_name("OTRS < 3.0.0-beta7 Ticket Age Remote DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"An error exists in AgentTicketSearch.pm which fails to
  restrict the ticket ages that are within the scope of a search.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote authenticated users
  to cause a denial of service condition.");

  script_tag(name:"affected", value:"OTRS prior to version 3.0.0-beta7.");

  script_tag(name:"solution", value:"Update to version 3.0.0-beta7 or later.");
...
if (version_is_less(version: version, test_version: "3.0.0.beta7")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.0.0.beta7", install_path: location);
