...
if(description)
{
  ...
  script_name("Firebird Relational Database CNCT Group Number Buffer Overflow Vulnerability - Windows, Active Check");

  script_category(ACT_DENIAL);

  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Buffer overflow");
  script_dependencies("firebird_detect.nasl", "os_detection.nasl");
  script_require_ports("Services/gds_db", 3050);
  script_mandatory_keys("firebird/db/detected", "Host/runs_windows");

  script_tag(name:"summary", value:"Firebird server is prone to a buffer overflow vulnerability.");

  script_tag(name:"vuldetect", value:"Sends multiple crafted GDS packets and checks if the service
  is still responding.");

  script_tag(name:"insight", value:"The flaw exists with a group number extracted from the CNCT
  ...
  script_tag(name:"solution", value:"Update to version 2.1.5 Update 1, 2.5.2 Update 1, 2.5.3, 2.1.6
  or later.");

  script_xref(name:"URL", value:"http://secunia.com/advisories/52506");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/58393");
