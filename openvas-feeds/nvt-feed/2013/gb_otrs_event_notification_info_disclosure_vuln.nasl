...
if (description)
{
  ...
  script_name("OTRS < 3.0.0-beta6 Event Notification Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"An error exists in the application which adds
  email-notification-ext articles to tickets during processing of event-based notifications.");
  ...
  script_tag(name:"affected", value:"OTRS versions prior to 3.0.0-beta6.");

  script_tag(name:"solution", value:"Update to version 3.0.0-beta6 or later.");
...
if (version_is_less(version: version, test_version: "3.0.0.beta6")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.0.0.beta6", install_path: location);
