...
if (description)
{
  ...
  to bypass intended security restriction and obtain sensitive information.");
...
if (version_in_range(version: version, test_version: "3.0.0", test_version2: "3.0.20")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.0.21", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "3.1.0", test_version2: "3.1.16")) {
