...
if(description)
{
  ...
  script_name("Microsoft Windows Client/Server Run-time Subsystem Privilege Escalation Vulnerability (2820917)");
  script_xref(name:"URL", value:"http://support.microsoft.com/kb/2820917");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/58886");
