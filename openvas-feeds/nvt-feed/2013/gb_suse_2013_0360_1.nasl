...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2013:0360-1");
  script_name("openSUSE: Security Advisory for flash-player (openSUSE-SU-2013:0360-1)");
  ...
  * APSB13-08, CVE-2013-0504, CVE-2013-0643, CVE-2013-0648
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2013-02/msg00026.html");
...
if(release == "openSUSE11.4") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.273~51.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.273~51.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.273~51.1", rls:"openSUSE11.4"))) {
    report += res;
  }
