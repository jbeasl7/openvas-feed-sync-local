...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://dariusfreamon.wordpress.com/2013/10/30/grandstream-gxp-voip-phones-default-credentials/");

  script_tag(name:"summary", value:"The remote Grandstream GXP VOIP Phone is using known default
  credentials.");

  script_tag(name:"vuldetect", value:"Tries to login via HTTP using known default credentials.");

  script_tag(name:"insight", value:"This issue may be exploited by a remote attacker to gain access
