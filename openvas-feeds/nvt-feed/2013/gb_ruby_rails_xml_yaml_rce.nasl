...
if(description)
{
  ...
  script_name("Ruby on Rails XML Processor YAML Deserialization RCE Vulnerability (Jan 2013)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/57187");
  ...
  script_tag(name:"solution", value:"Update to version 2.3.15, 3.0.19, 3.1.10, 3.2.11 or later.");
