...
if (description)
{
  ...
  script_tag(name:"insight", value:"An error exists in DB.pm and LDAP.pm which grants ticket
  access on the basis of single-digit substrings of the CustomerID value.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote authenticated users
  to bypass intended access restrictions in opportunistic circumstances by visiting a ticket.");

  script_tag(name:"affected", value:"OTRS prior to version 2.4.4.");
