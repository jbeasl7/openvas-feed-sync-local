...
if(description)
{
  ...
  script_name("PHP < 5.3.22, 5.4.x < 5.4.12 SOAP Parser Multiple Information Disclosure Vulnerabilities");
  ...
  script_tag(name:"summary", value:"PHP is prone to multiple information disclosure
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Errors exist in the way the SOAP parser processes certain SOAP
  objects (due to allowed expansion of XML external entities during SOAP WSDL files parsing).");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to obtain
  sensitive information.");

  script_tag(name:"affected", value:"PHP version prior to 5.3.22 and 5.4.x prior to 5.4.12.");

  script_tag(name:"solution", value:"Update to version 5.3.22, 5.4.12 or later.");
...
if (version_is_less(version: version, test_version: "5.3.22")) {
