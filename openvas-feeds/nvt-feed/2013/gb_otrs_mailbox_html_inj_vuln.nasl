...
if (description)
{
  ...
  script_name("OTRS Mailbox HTML Injection Vulnerability (OSA-2007-01)");
  ...
  script_tag(name:"insight", value:"An error exists in application's agent mailbox view which
  fails to properly sanitize user-supplied input before using it.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to inject
  script code into the OTRS webinterface.");

  script_tag(name:"affected", value:"OTRS versions 2.x through 2.0.4.");
