...
if (description)
{
  ...
  script_tag(name:"summary", value:"Open Ticket Request System (OTRS) is prone to a data
  ...
  to corrupt data in TicketCounter.log file by creating tickets.");

  script_tag(name:"affected", value:"OTRS prior to version 2.4.8.");
