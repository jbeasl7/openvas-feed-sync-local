...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2024-02-15 20:18:02 +0000 (Thu, 15 Feb 2024)");
...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"inkscape", ver:"0.47.0-2ubuntu2.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"inkscape", ver:"0.48.2-0ubuntu1.1", rls:"UBUNTU11.10"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"inkscape", ver:"0.48.3.1-1ubuntu1.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"inkscape", ver:"0.48.3.1-1ubuntu6.1", rls:"UBUNTU12.10"))) {
    report += res;
  }
