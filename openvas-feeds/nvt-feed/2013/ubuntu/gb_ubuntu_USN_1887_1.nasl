...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2024-01-25 02:13:29 +0000 (Thu, 25 Jan 2024)");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-swift", ver:"1.4.8-0ubuntu2.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-swift", ver:"1.7.4-0ubuntu2.2", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-swift", ver:"1.8.0-0ubuntu1.2", rls:"UBUNTU13.04"))) {
    report += res;
  }
