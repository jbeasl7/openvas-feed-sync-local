...
if (description)
{
  ...
  script_name("OTRS < 2.3.2 Restriction Bypass Vulnerability");
  ...
  script_tag(name:"insight", value:"An error exists in Kernel/System/Web/Request.pm which creates
  a directory under /tmp/ with 1274 permissions.");

  script_tag(name:"impact", value:"Successful exploitation will allow local users to bypass
  intended access restrictions via standard filesystem operations.");

  script_tag(name:"affected", value:"OTRS prior to version 2.3.2.");
