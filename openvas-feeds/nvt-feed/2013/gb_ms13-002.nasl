...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/57116");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/57122");
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2013/ms13-002");
  ...
  script_dependencies("smb_reg_service_pack.nasl", "gb_ms_groove_server_detect_win.nasl", "gb_ms_expression_web_detect.nasl",
                      "secpod_office_products_version_900032.nasl", "gb_microsoft_sharepoint_smb_login_detect.nasl");
...
shrPtSrvVer = get_kb_item("microsoft/sharepoint/server/smb-login/version");
