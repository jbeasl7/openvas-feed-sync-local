...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2013:0295-1");
  script_name("openSUSE: Security Advisory for flash-player (openSUSE-SU-2013:0295-1)");
  ...
  * APSB13-05, CVE-2013-1372, CVE-2013-0645, CVE-2013-1373,
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2013-02/msg00009.html");
...
if(release == "openSUSE12.1") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.270~50.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.270~50.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.270~50.1", rls:"openSUSE12.1"))) {
    report += res;
  }
