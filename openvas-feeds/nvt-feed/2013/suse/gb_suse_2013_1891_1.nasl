...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for ca-certificates-mozilla (openSUSE-SU-2013:1891-1)");
  ...
  * changed: TWCA_Root_Certification_Authority:2.1.1.crt
  ...
  script_xref(name:"openSUSE-SU", value:"2013:1891-1");
...
if(release == "openSUSE12.3") {
  if(!isnull(res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~1.95~3.4.1", rls:"openSUSE12.3"))) {
    report += res;
  }
...
if(release == "openSUSE12.2") {
  if(!isnull(res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~1.95~8.12.1", rls:"openSUSE12.2"))) {
    report += res;
  }
...
if(release == "openSUSE13.1") {
  if(!isnull(res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~1.95~3.4.1", rls:"openSUSE13.1"))) {
    report += res;
  }
