...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.5 <= 5.5.30 / 5.6 <= 5.6.10 Security Update (cpuapr2013) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/59227");
