...
if(description)
{
  ...
  script_name("Oracle MySQL Server <= 5.1.67 / 5.5 <= 5.5.29 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.1.67 and prior and 5.5 through 5.5.29.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/59196");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/59210");
