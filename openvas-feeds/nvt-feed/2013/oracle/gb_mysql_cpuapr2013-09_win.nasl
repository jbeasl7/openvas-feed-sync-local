...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.5 <= 5.5.29 / 5.6 <= 5.6.11 Security Update (cpuapr2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.5 through 5.5.29 and 5.6 through 5.6.10.");
