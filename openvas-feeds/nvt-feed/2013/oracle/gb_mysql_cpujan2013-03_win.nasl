...
if (description)
{
  ...
  script_name("Oracle MySQL Server 5.5 <= 5.5.28 Security Update (cpujan2013) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.5 through 5.5.28.");
