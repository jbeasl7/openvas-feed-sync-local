...
if (description)
{
  ...
  script_name("OTRS < 2.2.5 S/MIME OpenSSL Cryptographic Entropy Weakness");
  ...
  script_tag(name:"summary", value:"Open Ticket Request System (OTRS) is prone to a cryptographic
  entropy weakness.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An error exists in S/MIME feature which does not properly
  configure the RANDFILE environment variable for OpenSSL.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to decrypt
  e-mail messages that had lower than intended entropy available for cryptographic operations.");

  script_tag(name:"affected", value:"OTRS prior to version 2.2.5.");
