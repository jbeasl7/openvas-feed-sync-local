...
if (description)
{
  ...
  script_name("OTRS < 3.0.0-beta2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"An error exists in the rich text editor component which fails
  to validate user supplied input.");
...
if (version_is_less(version: version, test_version: "3.0.0.beta2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.0.0.beta2", install_path: location);
