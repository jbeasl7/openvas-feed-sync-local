...
if (description)
{
  ...
  script_name("OTRS Email Body XSS Vulnerability (OSA-2012-03)");
  ...
  script_tag(name:"affected", value:"OTRS versions 2.4.x prior to 2.4.15, 3.0.x prior to 3.0.17
  and 3.1.x prior to 3.1.11.");

  script_tag(name:"solution", value:"Update to version 2.4.15, 3.0.17, 3.1.11 or later.");
...
if (version_in_range(version: version, test_version: "2.4.0", test_version2: "2.4.14")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.4.15", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "3.0.0", test_version2: "3.0.16")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "3.0.17", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "3.1.0", test_version2: "3.1.10")) {
