...
if (description)
{
  ...
  script_name("OTRS < 2.4.0-beta2 Restriction Bypass Vulnerability");
  ...
  to bypass intended access restrictions by selecting the ticket from the watched-tickets list.");

  script_tag(name:"affected", value:"OTRS prior to version 2.4.0-beta2.");
...
if (version_is_less(version: version, test_version: "2.4.0.beta2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.4.0.beta2", install_path: location);
