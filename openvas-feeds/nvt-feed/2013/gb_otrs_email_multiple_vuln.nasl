...
if (description)
{
  ...
  - CVE-2008-7280: Error in Kernel/System/EmailParser.pm in PostmasterPOP3.pl which does not
  properly handle e-mail messages containing malformed UTF-8 characters

  - CVE-2008-7281: Error in otrs-email.pm, which sends e-mails containing a Bcc header field that
  lists the Blind Carbon Copy recipients");
