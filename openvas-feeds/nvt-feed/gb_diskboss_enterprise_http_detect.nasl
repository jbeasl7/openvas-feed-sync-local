...
if(description)
{
  ...
  script_name("DiskBoss Enterprise Detection (HTTP)");
  ...
  script_xref(name:"URL", value:"https://www.diskboss.com");

  script_tag(name:"summary", value:"HTTP based detection of DiskBoss Enterprise.");
...
if(">DiskBoss Enterprise" >< res &&
  ...
  set_kb_item(name:"diskboss/enterprise/detected", value:TRUE);
  set_kb_item(name:"diskboss/enterprise/http/detected", value:TRUE);

  cpe = build_cpe(value:version, exp:"([0-9.]+)", base:"cpe:/a:dboss:diskboss_enterprise:");
  if(!cpe)
