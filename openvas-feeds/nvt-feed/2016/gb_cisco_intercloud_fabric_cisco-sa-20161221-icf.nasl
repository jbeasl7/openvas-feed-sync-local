...
if (description)
{
  ...
  script_name("Cisco Intercloud Fabric Database Static Credentials Vulnerability (cisco-sa-20161221-icf)");
  ...
  script_tag(name:"summary", value:"A vulnerability in Cisco Intercloud Fabric for Business and
  ...
  script_tag(name:"insight", value:"The vulnerability occurs because the database account uses
  static credentials.
  ...
  script_tag(name:"impact", value:"An attacker could exploit this vulnerability by using these
  credentials to connect to the database. The contents of the database can then be examined or
  modified.");

  script_tag(name:"affected", value:"Cisco Intercloud Fabric versions 2.2.1, 2.3.1 and 3.1.1.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20161221-icf");
