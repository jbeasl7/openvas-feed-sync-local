...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.7 <= 5.7.11 Security Update (cpuapr2016v3, cpujul2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.7 through 5.7.11.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91910");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/86484");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/86506");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/86493");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/86433");
...
if(version_in_range(version:vers, test_version:"5.7", test_version2:"5.7.11")) {
