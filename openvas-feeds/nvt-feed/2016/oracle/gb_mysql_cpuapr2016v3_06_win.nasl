...
if(description)
{
  ...
  script_name("Oracle MySQL Server <= 5.5.47 / 5.6 <= 5.6.28 / 5.7 <= 5.7.10 Security Update (cpuapr2016v3) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.5.47 and prior, 5.6 through 5.6.28 and 5.7 through 5.7.10.");
...
if(version_is_less_equal(version:vers, test_version:"5.5.47") ||
   version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.28") ||
