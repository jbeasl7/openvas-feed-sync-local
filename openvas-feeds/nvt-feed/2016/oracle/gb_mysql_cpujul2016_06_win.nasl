...
if(description)
{
  ...
  script_name("Oracle MySQL Server <= 5.5.48 / 5.6 <= 5.6.29 / 5.7 <= 5.7.10 Security Update (cpujul2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.5.48 and prior, 5.6 through 5.6.29 and 5.7 through 5.7.10.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91999");
