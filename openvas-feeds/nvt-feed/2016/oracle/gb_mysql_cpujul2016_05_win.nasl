...
if(description)
{
  ...
  script_name("Oracle MySQL Server <= 5.5.48 / 5.6 <= 5.6.29 / 5.7 <= 5.7.11 Security Update (cpujul2016) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91987");
