...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.6 <= 5.6.30 / 5.7 <= 5.7.12 Security Update (cpujul2016) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91980");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91949");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91992");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91943");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91969");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/89757");
