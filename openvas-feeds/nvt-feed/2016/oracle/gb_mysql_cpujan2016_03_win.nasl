...
if(description)
{
  ...
  script_name("Oracle MySQL Server <= 5.5.31 / 5.6 <= 5.6.11 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.5.31 and prior and 5.6 through 5.6.11.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/81136");
...
if(version_is_less_equal(version:vers, test_version:"5.5.31") ||
   version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.11")) {
