...
if(description)
{
  ...
  script_name("Oracle: Security Advisory (ELSA-2016-0373)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2016-0373");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2016-0373.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the ELSA-2016-0373 advisory.");
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.7.0~1.0.1.el5_11", rls:"OracleLinux5"))) {
    report += res;
  }
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.7.0~1.0.1.el6_7", rls:"OracleLinux6"))) {
    report += res;
  }
...
if(release == "OracleLinux7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.7.0~1.0.1.el7_2", rls:"OracleLinux7"))) {
    report += res;
  }
