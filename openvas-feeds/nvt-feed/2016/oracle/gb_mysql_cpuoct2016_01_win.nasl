...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.6 <= 5.6.32 / 5.7 <= 5.7.14 Security Update (cpuoct2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.6 through 5.6.32 and 5.7 through 5.7.14.");
...
if(version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.32") ||
