...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.6 <= 5.6.33 / 5.7 <= 5.7.15 Security Update (cpuoct2016) - Linux");
...
if(version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.33") ||
