...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.7.9 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 5.7.9.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/81211");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/81203");
