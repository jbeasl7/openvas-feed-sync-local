...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.6 <= 5.6.29 / 5.7 <= 5.7.11 Security Update (cpuapr2016v3) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.6 through 5.6.29 and 5.7 through 5.7.11.");
...
if(version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.29") ||
