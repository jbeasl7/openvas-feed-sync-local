...
if(description)
{
  ...
  script_name("Oracle MySQL Server 5.6 <= 5.6.26 Security Update (cpujan2016) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.6 through 5.6.26.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/81253");
...
if(version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.26")) {
