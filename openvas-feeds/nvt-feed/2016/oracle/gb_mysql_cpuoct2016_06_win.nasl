...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-08-04 20:00:00 +0000 (Thu, 04 Aug 2022)");
  script_tag(name:"creation_date", value:"2016-10-19 15:51:27 +0530 (Wed, 19 Oct 2016)");
  script_name("Oracle MySQL Server 5.6 <= 5.6.31 / 5.7 <= 5.7.13 Security Update (cpuoct2016) - Windows");
