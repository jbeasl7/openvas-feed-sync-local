...
if(description)
{
  ...
  script_name("PHP < 5.4.45, 5.5.x < 5.5.29, 5.6.x < 5.6.13 RCE Vulnerability (Mar 2016) - Linux");
  ...
  script_tag(name:"insight", value:"The flaw is due to 'SoapClient __call' method in
  'ext/soap/soap.c' script does not properly manage headers.");
