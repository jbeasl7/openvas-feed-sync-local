...
if(description)
{
  ...
  script_name("PHP 5.3.x < 5.3.29, 5.4.x < 5.4.30, 5.5.x < 5.5.14, 5.6.0alpha1 < 5.6.0 Heap Based Buffer Overflow Vulnerability - Linux");
  ...
  5.5.x prior to 5.5.14 and 5.6.x prior to 5.6.0 on Linux.");
