...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2025-01-27 21:55:53 +0000 (Mon, 27 Jan 2025)");

  script_name("Debian: Security Advisory (DSA-3728-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3728-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3728-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3728");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-3728-1 advisory.");
