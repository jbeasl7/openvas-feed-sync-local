...
if(description)
{
  ...
  script_name("Palo Alto PAN-OS HTTP Header Evasion Vulnerability (PAN-SA-2016-0006)");

  script_xref(name:"URL", value:"https://security.paloaltonetworks.com/PAN-SA-2016-0006");
