...
if(description)
{
  ...
  script_name("PHP 7.0.0 Double Free Vulnerability (Jul 2016) - Windows");
  ...
  script_tag(name:"insight", value:"The flaw is due to double free vulnerability in the format
  printer.");

  script_tag(name:"impact", value:"Successfully exploiting this issue allow remote attackers to
  have an unspecified impact.");

  script_tag(name:"affected", value:"PHP version 7.0.0 only.");
