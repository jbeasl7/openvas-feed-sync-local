...
if(description)
{
  ...
  script_name("Sync Breeze Enterprise Server Buffer Overflow Vulnerability (Nov 2016)");
  ...
  script_tag(name:"affected", value:"Sync Breeze Enterprise version 9.1.16 and earlier.");
  ...
  script_dependencies("gb_sync_breeze_enterprise_http_detect.nasl", "os_detection.nasl");
  script_mandatory_keys("flexsense/syncbreeze/detected", "Host/runs_windows");
...
if(version_is_less_equal(version:version, test_version:"9.1.16")) {
