...
if(description)
{
  ...
  script_name("Wireshark Multiple Denial-of-Service Vulnerabilities-01 (Jan 2016) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 2.0.1 or
  later.");
...
if(version_is_equal(version:vers, test_version:"2.0.0")) {
