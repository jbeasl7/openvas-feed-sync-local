...
if(description)
{
  ...
  script_name("Wireshark Multiple Denial of Service Vulnerabilities-01 (Aug 2016) - Mac OS X");
  ...
  script_tag(name:"solution", value:"Update to version 2.0.5 or
  later.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/92174");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/92172");
