...
if(description)
{
  ...
  script_name("Wireshark Multiple Denial of Service Vulnerabilities-04 (Aug 2016) - Mac OS X");
  ...
  script_tag(name:"solution", value:"Update to version 2.0.4 or
  1.12.12 or later.");
...
else if(version_in_range(version:vers, test_version:"2.0", test_version2:"2.0.3")) {
  fix = "2.0.4";
  VULN = TRUE ;
}
