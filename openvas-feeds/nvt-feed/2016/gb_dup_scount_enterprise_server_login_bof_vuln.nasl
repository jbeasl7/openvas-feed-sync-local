...
if(description)
{
  ...
  script_name("Dup Scout Enterprise Server <= 9.1.14 'Login' Buffer Overflow Vulnerability");
  ...
  script_dependencies("gb_dup_scount_enterprise_http_detect.nasl", "os_detection.nasl");
  script_mandatory_keys("dup_scout/enterprise/detected", "Host/runs_windows");
...
if(version_is_less_equal(version:version, test_version:"9.1.14")) {
