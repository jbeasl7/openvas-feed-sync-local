...
if(description)
{
  ...
  script_cve_id("CVE-2016-2554", "CVE-2016-4342");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("PHP < 5.5.32, 5.6.x < 5.6.18, 7.x < 7.0.3 Multiple Vulnerabilities (Jul 2016) - Linux");
  ...
  - CVE-2016-2554: Stack-based buffer overflow in ext/phar/tar.c

  - CVE-2016-4342: ext/phar/phar_object.c mishandles zero-length uncompressed data");
  ...
  prior to 7.0.3 on Linux.");

  script_tag(name:"solution", value:"Update to version 5.5.32, 5.6.18, 7.0.3 or later.");

  script_xref(name:"URL", value:"http://www.php.net/ChangeLog-7.php");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/89154");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/83353");
