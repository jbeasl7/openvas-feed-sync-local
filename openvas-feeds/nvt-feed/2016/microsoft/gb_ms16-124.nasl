...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/93354");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/93355");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/93356");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/93357");
...
if(hotfix_check_sp(winVista:3, winVistax64:3, win2008x64:3, win2008:3) > 0) {
  ...
  if(kerVer && version_is_less(version:kerVer, test_version:"6.1.7601.23564")) {
    VULN = TRUE;
  }
}
  ...
  ## Presently GDR information is not available.
  if(kerVer && version_is_less(version:kerVer, test_version:"6.2.9200.22001")) {
     VULN = TRUE;
  }
}

else if(hotfix_check_sp(win8_1:1, win8_1x64:1, win2012R2:1) > 0) {
  if(kerVer && version_is_less(version:kerVer, test_version:"6.3.9600.18505")) {
    VULN = TRUE;
  }
}

if(hotfix_check_sp(win10:1, win10x64:1) > 0) {
  if(kerVer && version_is_less(version:kerVer, test_version:"10.0.10240.17146")) {
    Vulnerable_range = "Less than 10.0.10240.17146";
    VULN = TRUE;
  }
