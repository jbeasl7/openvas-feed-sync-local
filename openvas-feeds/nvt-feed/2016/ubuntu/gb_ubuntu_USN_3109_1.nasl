...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-12-15 17:55:27 +0000 (Thu, 15 Dec 2016)");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.5", ver:"5.5.53-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.5", ver:"5.5.53-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.16-0ubuntu0.16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mysql-server-5.7", ver:"5.7.16-0ubuntu0.16.10.1", rls:"UBUNTU16.10"))) {
    report += res;
  }
