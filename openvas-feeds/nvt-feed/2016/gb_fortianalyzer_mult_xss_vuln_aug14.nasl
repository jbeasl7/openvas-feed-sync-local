...
if (description)
{
  ...
  script_cve_id("CVE-2016-3193", "CVE-2016-3195");

  script_tag(name:"qod_type", value:"package");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Fortinet FortiAnalyzer Multiple XSS Vulnerabilities (FG-IR-16-015, FG-IR-16-017)");
  ...
  - CVE-2016-3193: A vulnerability in FortiAnalyzer address added page could allow malicious script
  being injected in the input field.

  - CVE-2016-3195: A client side XSS vulnerability could allow malicious script being injected in
  the Web-UI.");
  ...
  script_xref(name:"Advisory-ID", value:"FG-IR-16-015");
