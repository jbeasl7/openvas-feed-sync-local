...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2025-01-23 17:54:57 +0000 (Thu, 23 Jan 2025)");
  script_tag(name:"creation_date", value:"2016-10-27 18:42:25 +0530 (Thu, 27 Oct 2016)");
  script_name("Adobe Flash Player Security Update (APSB16-36) - Linux");
  ...
  script_tag(name:"solution", value:"Update to version 11.2.202.643 or later.");
...
if(version_is_less(version:vers, test_version:"11.2.202.643")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"11.2.202.643", install_path:path);
