...
if(description)
{
  ...
  script_name("Oracle VirtualBox Unspecified Vulnerability-01 (Apr 2016) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions prior to 5.0.18
  on Mac OS X.");
...
if(version_in_range(version:vers, test_version:"5.0.0", test_version2:"5.0.17")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"5.0.18", install_path:path);
