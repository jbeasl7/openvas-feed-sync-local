...
if (description)
{
  ...
  script_tag(name:"severity_vector", value:"CVSS:3.0/AV:N/AC:H/PR:L/UI:N/S:U/C:L/I:L/A:L");
  ...
  script_name("Foreman 1.7.x < 1.11.3 Privilege Escalation Vulnerability");
  ...
  organization, if users know other organization id and have unlimited filters they can
  access/modify other organization data. They just have to set the id as API parameter.");

  script_tag(name:"affected", value:"Foreman version 1.7.x prior to 1.11.3.");

  script_tag(name:"solution", value:"Update to version 1.11.3 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "1.7.0", test_version_up: "1.11.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.11.3", install_path: location);
