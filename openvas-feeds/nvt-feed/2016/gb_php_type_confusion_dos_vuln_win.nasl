...
if(description)
{
  ...
  script_name("PHP < 5.6.7 DoS Vulnerability - Windows");
  ...
  script_tag(name:"affected", value:"PHP prior to version 5.6.7 on Windows.");

  script_tag(name:"solution", value:"Update to version 5.6.7 or later.");
...
if (version_is_less(version: version, test_version: "5.6.7")) {
