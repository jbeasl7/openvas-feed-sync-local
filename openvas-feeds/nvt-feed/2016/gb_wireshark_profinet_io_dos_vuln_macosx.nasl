...
if(version_in_range(version:vers, test_version:"2.2.0", test_version2:"2.2.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.2.2", install_path:path);
