...
if(description)
{
  ...
  script_name("Wireshark Multiple DoS Vulnerabilities (Nov 2016) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 2.0.8, 2.2.2 or later.");
...
if(version_in_range(version:vers, test_version:"2.0.0", test_version2:"2.0.7")) {
  fix = "2.0.8";
  VULN = TRUE;
}

else if(version_in_range(version:vers, test_version:"2.2.0", test_version2:"2.2.1")) {
  fix = "2.2.2";
  VULN = TRUE;
}
