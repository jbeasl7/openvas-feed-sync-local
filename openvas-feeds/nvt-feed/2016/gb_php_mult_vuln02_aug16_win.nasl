...
if(description)
{
  ...
  script_cve_id("CVE-2016-5770", "CVE-2016-5771");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("PHP < 5.5.37, 5.6.x < 5.6.23 Multiple Vulnerabilities (Aug 2016) - Windows");
  ...
  - The 'spl_array.c' in the SPL extension improperly interacts with the unserialize implementation
  and garbage collection.

  - Integer overflow in the 'SplFileObject::fread' function in 'spl_directory.c' in the SPL
  extension.");

  script_tag(name:"impact", value:"Successfully exploiting these issues allow remote attackers to
  cause a denial of service (use-after-free and application crash) or possibly execute arbitrary
  code or possibly have unspecified other impact via a large integer argument.");

  script_tag(name:"affected", value:"PHP prior to version 5.5.37 and 5.6.x prior to 5.6.23 on
  Windows.");

  script_tag(name:"solution", value:"Update to version 5.5.37, 5.6.23 or later.");
