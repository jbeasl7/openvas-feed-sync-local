...
if (description)
{
  ...
  script_name("Foreman 1.6.x < 1.12.2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Label parameter of all form helpers was not escaped allowing
  ...
  script_tag(name:"affected", value:"Foreman versions 1.6.x through 1.12.1.");
