...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-01-20 05:22:46 +0000 (Wed, 20 Jan 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-638");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-638.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssh' package(s) announced via the ALAS-2016-638 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An information leak flaw was found in the way the OpenSSH client roaming feature was implemented. A malicious server could potentially use this flaw to leak portions of memory (possibly including private SSH keys) of a successfully authenticated OpenSSH client.
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pam_ssh_agent_auth", rpm:"pam_ssh_agent_auth~0.9.3~9.23.59.amzn1", rls:"AMAZON"))) {
    report += res;
  }
