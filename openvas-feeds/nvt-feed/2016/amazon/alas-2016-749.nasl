...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-749");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the ALAS-2016-749 advisory.");
