...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-01-20 05:22:48 +0000 (Wed, 20 Jan 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-642");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-642.html");
  script_xref(name:"URL", value:"http://perception-point.io/2016/01/14/analysis-and-exploitation-of-a-linux-kernel-vulnerability-cve-2016-0728/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel' package(s) announced via the ALAS-2016-642 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Perception Point Research identified a use-after-free vulnerability, representing a local privilege escalation vulnerability in the Linux kernel. Their post contains a detailed analysis of the bug.
