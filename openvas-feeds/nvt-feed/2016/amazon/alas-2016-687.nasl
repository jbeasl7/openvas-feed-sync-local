...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-687");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-687.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang' package(s) announced via the ALAS-2016-687 advisory.");
