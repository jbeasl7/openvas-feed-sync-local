...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-662");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-662.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql94, postgresql93, postgresql92' package(s) announced via the ALAS-2016-662 advisory.");
  ...
  script_tag(name:"affected", value:"'postgresql94, postgresql93, postgresql92' package(s) on Amazon Linux.");
