...
if(description)
{
  ...
  script_cve_id("CVE-2010-5325", "CVE-2015-8560");
  script_tag(name:"creation_date", value:"2016-05-09 11:11:55 +0000 (Mon, 09 May 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-690");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-690.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'foomatic' package(s) announced via the ALAS-2016-690 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that foomatic-rip failed to remove all shell special characters from inputs used to construct command lines for external programs run by the filter. An attacker could possibly use this flaw to execute arbitrary commands. (CVE-2015-8560)
...
It was discovered that the unhtmlify() function of foomatic-rip did not correctly calculate buffer sizes, possibly leading to a heap-based memory corruption. A malicious attacker could exploit this flaw to cause foomatic-rip to crash or, possibly, execute arbitrary code. (CVE-2010-5325)");
  ...
  script_tag(name:"affected", value:"'foomatic' package(s) on Amazon Linux.");
