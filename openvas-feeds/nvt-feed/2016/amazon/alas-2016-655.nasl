...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-08 05:12:17 +0000 (Tue, 08 Mar 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-655");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-655.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nginx' package(s) announced via the ALAS-2016-655 advisory.");
