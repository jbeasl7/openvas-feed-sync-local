...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-666");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-666.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sos' package(s) announced via the ALAS-2016-666 advisory.");
  ...
  script_tag(name:"affected", value:"'sos' package(s) on Amazon Linux.");
