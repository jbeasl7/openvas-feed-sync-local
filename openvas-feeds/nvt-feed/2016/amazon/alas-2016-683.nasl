...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-05-09 11:11:49 +0000 (Mon, 09 May 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-683");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-683.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh2' package(s) announced via the ALAS-2016-683 advisory.");
  ...
  script_tag(name:"affected", value:"'libssh2' package(s) on Amazon Linux.");
