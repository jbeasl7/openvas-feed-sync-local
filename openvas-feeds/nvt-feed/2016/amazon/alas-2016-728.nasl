...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-10-26 12:38:18 +0000 (Wed, 26 Oct 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-728");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-728.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php55, php56' package(s) announced via the ALAS-2016-728 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A stack consumption vulnerability in GD in PHP allows remote attackers to cause a denial of service via a crafted imagefilltoborder call. (CVE-2015-8874)
...
(Updated on 2016-08-17: CVE-2016-5385 was fixed in this release but was not previously part of this errata)");
  ...
  script_tag(name:"affected", value:"'php55, php56' package(s) on Amazon Linux.");
