...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-709");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-709.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'subversion' package(s) announced via the ALAS-2016-709 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mod24_dav_svn", rpm:"mod24_dav_svn~1.9.4~2.54.amzn1", rls:"AMAZON"))) {
    report += res;
  }
