...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-05-09 11:12:00 +0000 (Mon, 09 May 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-695");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-695.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the ALAS-2016-695 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A vulnerability was discovered that allows a man-in-the-middle attacker to use a padding oracle attack to decrypt traffic on a connection using an AES CBC cipher with a server supporting AES-NI. (CVE-2016-2107, Important)
...
An issue was discovered in the BIO functions, such as d2i_CMS_bio(), where a short invalid encoding in ASN.1 data can cause allocation of large amounts of memory, potentially resulting in a denial of service. (CVE-2016-2109, Low)");
