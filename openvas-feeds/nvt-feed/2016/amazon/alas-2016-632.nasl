...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-01-20 05:22:41 +0000 (Wed, 20 Jan 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-632");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-632.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby19, ruby20, ruby21, ruby22' package(s) announced via the ALAS-2016-632 advisory.");
  ...
  script_tag(name:"affected", value:"'ruby19, ruby20, ruby21, ruby22' package(s) on Amazon Linux.");
