...
if(description)
{
  ...
  script_cve_id("CVE-2016-7141", "CVE-2016-7167");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-742");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-742.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the ALAS-2016-742 advisory.");
