...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-712");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-712.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libksba' package(s) announced via the ALAS-2016-712 advisory.");
...
Out-of-bounds read in _ksba_ber_parse_tl (CVE-2016-4579)");
  ...
  script_tag(name:"affected", value:"'libksba' package(s) on Amazon Linux.");
