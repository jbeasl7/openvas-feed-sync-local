...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-02-11 05:16:44 +0000 (Thu, 11 Feb 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-645");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-645.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss' package(s) announced via the ALAS-2016-645 advisory.");
