...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-659");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-659.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpcbind' package(s) announced via the ALAS-2016-659 advisory.");
  ...
  script_tag(name:"affected", value:"'rpcbind' package(s) on Amazon Linux.");
