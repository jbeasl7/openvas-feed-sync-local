...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-10-26 12:38:15 +0000 (Wed, 26 Oct 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-722");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-722.html");
  script_xref(name:"URL", value:"https://httpoxy.org/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat6, tomcat7, tomcat8' package(s) announced via the ALAS-2016-722 advisory.");
  ...
  script_tag(name:"affected", value:"'tomcat6, tomcat7, tomcat8' package(s) on Amazon Linux.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat6", rpm:"tomcat6~6.0.45~1.5.amzn1", rls:"AMAZON"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat7", rpm:"tomcat7~7.0.69~1.17.amzn1", rls:"AMAZON"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat8", rpm:"tomcat8~8.0.35~1.61.amzn1", rls:"AMAZON"))) {
    report += res;
  }
