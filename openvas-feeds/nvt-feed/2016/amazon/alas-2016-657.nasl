...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-11 05:09:11 +0000 (Fri, 11 Mar 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-657");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-657.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat7' package(s) announced via the ALAS-2016-657 advisory.");
