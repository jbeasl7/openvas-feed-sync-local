...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-05-09 11:12:03 +0000 (Mon, 09 May 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-698");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-698.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php56, php55' package(s) announced via the ALAS-2016-698 advisory.");
...
Negative size parameter in memcpy (CVE-2016-4073)");
  ...
  script_tag(name:"affected", value:"'php56, php55' package(s) on Amazon Linux.");
