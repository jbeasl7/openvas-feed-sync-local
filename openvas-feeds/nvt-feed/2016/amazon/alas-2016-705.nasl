...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-705");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-705.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jq' package(s) announced via the ALAS-2016-705 advisory.");
  ...
  script_tag(name:"affected", value:"'jq' package(s) on Amazon Linux.");
