...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-757");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-757.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel' package(s) announced via the ALAS-2016-757 advisory.");
