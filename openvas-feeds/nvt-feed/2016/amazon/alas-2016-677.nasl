...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-31 05:02:10 +0000 (Thu, 31 Mar 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-677");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-677.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk, java-1.7.0-openjdk' package(s) announced via the ALAS-2016-677 advisory.");
  ...
  script_tag(name:"affected", value:"'java-1.8.0-openjdk, java-1.7.0-openjdk' package(s) on Amazon Linux.");
