...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-10-26 12:38:29 +0000 (Wed, 26 Oct 2016)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2016-758");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2016-758.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the ALAS-2016-758 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2016-2848 bind: assertion failure triggered by a packet with malformed options
