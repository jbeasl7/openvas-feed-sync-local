...
if(description)
{
  ...
  script_name("Oracle MySQL Multiple Unspecified Vulnerabilities - 15 (Jun 2016) - Linux");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/64864");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/64885");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/64897");
...
if(vers =~ "^5\.6" && version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.14")) {
  report = report_fixed_ver(installed_version:vers, vulnerable_range:"5.6 - 5.6.14");
