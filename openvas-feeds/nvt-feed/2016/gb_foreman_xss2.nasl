...
if (description)
{
  ...
  script_name("Foreman 1.8.x < 1.12.2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Network interface identifiers stored for hosts may contain
  HTML or JavaScript that allows a stored XSS vulnerability when later viewing the host edit
  form.");

  script_tag(name:"affected", value:"Foreman versions 1.8.x through 1.12.1.");
...
if (version_in_range(version: version, test_version: "1.8.0", test_version2: "1.12.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.12.2", install_path: location);
