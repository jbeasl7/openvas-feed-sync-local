...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Security Advisories (MFSA2016-92, MFSA2016-92) - Mac OS X");

  script_tag(name:"summary", value:"Mozilla Firefox ESR is prone to a denial of service (DoS) vulnerability.");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox ESR versions before 45.5.1.");
