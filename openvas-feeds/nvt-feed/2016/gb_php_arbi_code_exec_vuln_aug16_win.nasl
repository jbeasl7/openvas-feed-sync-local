...
if(description)
{
  ...
  script_name("PHP 7.x < 7.0.6 Arbitrary Code Execution Vulnerability (Aug 2016) - Windows");
  ...
  script_tag(name:"insight", value:"The flaw is due to the double free vulnerability in the
  'SplDoublyLinkedList::offsetSet' function in 'ext/spl/spl_dllist.c' script.");
