...
if (description)
{
  ...
  script_name("Foreman < 1.11.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"A provisioning template containing inspect will expose
  ...
  script_tag(name:"affected", value:"Foreman versions prior to 1.11.1.");
