...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for openssh (openSUSE-SU-2016:0145-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2016:0145-1");
...
if(release == "openSUSE13.1")
{
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssh", rpm:"openssh~6.2p2~3.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-askpass-gnome", rpm:"openssh-askpass-gnome~6.2p2~3.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-askpass-gnome-debuginfo", rpm:"openssh-askpass-gnome-debuginfo~6.2p2~3.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-debuginfo", rpm:"openssh-debuginfo~6.2p2~3.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-debugsource", rpm:"openssh-debugsource~6.2p2~3.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }
