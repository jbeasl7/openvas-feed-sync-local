...
if(description)
{
  ...
  script_name("Panda Antivirus Pro <= 16.1.2 Privilege Escalation Vulnerability");
  ...
  script_tag(name:"summary", value:"Panda Antivirus Pro is prone to a privilege escalation
  vulnerability.");
  ...
  script_tag(name:"affected", value:"Panda Antivirus Pro version 16.1.2 and prior.");
