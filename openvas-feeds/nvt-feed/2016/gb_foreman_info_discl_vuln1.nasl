...
if (description)
{
  ...
  script_name("Foreman 1.10.x < 1.11.4, 1.12.0 Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"Foreman is prone to an information disclosure
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Non-admin users with the view_hosts permission containing a
  filter are able to access API routes beneath 'hosts' such as GET
  /api/v2/hosts/secrethost/interfaces without the filter being taken into account. This allows users
  to access network interface details (including BMC login details) for any host.");

  script_tag(name:"affected", value:"Foreman version 1.10.x prior to 1.11.4 and 1.12.0 only.");

  script_tag(name:"solution", value:"Update to version 1.11.4, 1.12.1 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "1.10.0", test_version_up: "1.11.4")) {
