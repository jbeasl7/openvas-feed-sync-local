...
if(description)
{
  ...
  script_name("PHP 7.x < 7.0.6 Arbitrary Code Execution Vulnerability (Aug 2016) - Linux");
  ...
  script_tag(name:"affected", value:"PHP versions 7.x prior to 7.0.6 on Linux.");
