...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-05-16 20:05:12 +0000 (Mon, 16 May 2016)");

  script_cve_id("CVE-2015-4598", "CVE-2015-4643", "CVE-2015-4644");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("PHP < 5.4.42, 5.5.x < 5.5.26, 5.6.x < 5.6.10 Multiple Vulnerabilities (Aug 2016) - Linux");
  ...
  script_tag(name:"affected", value:"PHP prior to version 5.4.42, 5.5.x prior to 5.5.26 and 5.6.x
  prior to 5.6.10 on Linux.");

  script_tag(name:"solution", value:"Update to version 5.4.42, 5.5.26, 5.6.10 or later.");
...
if (version_is_less(version: version, test_version: "5.4.42")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.4.42", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "5.5.0", test_version_up: "5.5.26")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.5.26", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "5.6.0", test_version_up: "5.6.10")) {
