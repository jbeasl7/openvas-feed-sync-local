...
if(description)
{
  ...
  script_dependencies("gb_7zip_detect_win.nasl", "lsc_options.nasl");
  ...
  script_tag(name:"summary", value:"SMB login and WMI file search based detection of 7zip
  Portable.");
...
fileList = powershell_wmi_file_search_version_query( file_name:"7zFM", file_extension:"exe" );
...
foreach filePath( keys( fileList ) ) {
  ...
  location = ereg_replace( string:filePath, pattern:"\\7zFM\.exe$", replace:"", icase:TRUE );
