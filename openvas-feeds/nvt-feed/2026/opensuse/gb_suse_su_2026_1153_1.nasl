...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.1153.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:1153-1)");
...
- CVE-2006-10003: off-by-one heap buffer overflow in `st_serial_stack` (bsc#1259902).");
  ...
  script_tag(name:"affected", value:"'perl-XML-Parser' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-XML-Parser", rpm:"perl-XML-Parser~2.44~150000.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
