...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0439.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0439-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apptainer", rpm:"apptainer~1.4.5~150600.4.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apptainer-leap", rpm:"apptainer-leap~1.4.5~150600.4.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apptainer-sle15_6", rpm:"apptainer-sle15_6~1.4.5~150600.4.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsquashfuse0", rpm:"libsquashfuse0~0.5.0~150600.3.2.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squashfuse", rpm:"squashfuse~0.5.0~150600.3.2.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squashfuse-devel", rpm:"squashfuse-devel~0.5.0~150600.3.2.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squashfuse-tools", rpm:"squashfuse-tools~0.5.0~150600.3.2.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
