...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0153.1");
  ...
  script_tag(name:"creation_date", value:"2026-01-21 04:23:31 +0000 (Wed, 21 Jan 2026)");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0153-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0153-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260153-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256340");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-January/023791.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaThunderbird' package(s) announced via the SUSE-SU-2026:0153-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird", rpm:"MozillaThunderbird~140.7.0~150200.8.251.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-common", rpm:"MozillaThunderbird-translations-common~140.7.0~150200.8.251.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-other", rpm:"MozillaThunderbird-translations-other~140.7.0~150200.8.251.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
