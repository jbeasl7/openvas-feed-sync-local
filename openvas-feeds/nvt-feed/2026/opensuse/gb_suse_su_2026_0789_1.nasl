...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0789.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0789-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl", rpm:"go1.24-openssl~1.24.13~150600.13.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-doc", rpm:"go1.24-openssl-doc~1.24.13~150600.13.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-race", rpm:"go1.24-openssl-race~1.24.13~150600.13.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
