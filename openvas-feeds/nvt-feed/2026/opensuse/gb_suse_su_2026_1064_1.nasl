...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.1064.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:1064-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-tornado6", rpm:"python311-tornado6~6.3.2~150400.9.15.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
