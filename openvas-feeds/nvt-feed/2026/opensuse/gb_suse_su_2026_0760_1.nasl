...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0760.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0760-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0760-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260760-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256818");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1257692");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-March/024556.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.25-openssl' package(s) announced via the SUSE-SU-2026:0760-1 advisory.");
 ...
 * go#77425 crypto/tls: CL 737700 broke session resumption on macOS");
  ...
  script_tag(name:"affected", value:"'go1.25-openssl' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.25-openssl", rpm:"go1.25-openssl~1.25.7~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-openssl-doc", rpm:"go1.25-openssl-doc~1.25.7~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-openssl-race", rpm:"go1.25-openssl-race~1.25.7~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
