...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0252.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0252-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-pyasn1", rpm:"python311-pyasn1~0.5.0~150400.12.10.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
