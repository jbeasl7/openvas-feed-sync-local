...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0295.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0295-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"corepack22", rpm:"corepack22~22.22.0~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs22", rpm:"nodejs22~22.22.0~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs22-devel", rpm:"nodejs22-devel~22.22.0~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs22-docs", rpm:"nodejs22-docs~22.22.0~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm22", rpm:"npm22~22.22.0~150600.13.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
