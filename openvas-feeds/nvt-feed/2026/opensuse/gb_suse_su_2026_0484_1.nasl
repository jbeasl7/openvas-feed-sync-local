...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0484.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0484-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmunge2", rpm:"libmunge2~0.5.15~150600.25.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmunge2-32bit", rpm:"libmunge2-32bit~0.5.15~150600.25.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"munge", rpm:"munge~0.5.15~150600.25.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"munge-devel", rpm:"munge-devel~0.5.15~150600.25.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"munge-devel-32bit", rpm:"munge-devel-32bit~0.5.15~150600.25.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
