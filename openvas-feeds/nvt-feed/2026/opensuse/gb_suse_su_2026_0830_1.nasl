...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0830.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0830-1)");
...
- CVE-2026-28364: missing bounds validation in readblock() can lead to arbitrary code execution (bsc#1258992).");
  ...
  script_tag(name:"affected", value:"'ocaml' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ocaml", rpm:"ocaml~4.14.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ocaml-compiler-libs", rpm:"ocaml-compiler-libs~4.14.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ocaml-compiler-libs-devel", rpm:"ocaml-compiler-libs-devel~4.14.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ocaml-ocamldoc", rpm:"ocaml-ocamldoc~4.14.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ocaml-runtime", rpm:"ocaml-runtime~4.14.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ocaml-source", rpm:"ocaml-source~4.14.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
