...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.1325.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:1325-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav", rpm:"clamav~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-devel", rpm:"clamav-devel~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-docs-html", rpm:"clamav-docs-html~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-milter", rpm:"clamav-milter~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libclamav12", rpm:"libclamav12~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libclammspack0", rpm:"libclammspack0~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfreshclam4", rpm:"libfreshclam4~1.5.2~150600.18.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
