...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0434.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0434-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dirmngr", rpm:"dirmngr~2.4.4~150600.3.15.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gpg2", rpm:"gpg2~2.4.4~150600.3.15.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gpg2-lang", rpm:"gpg2-lang~2.4.4~150600.3.15.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gpg2-tpm", rpm:"gpg2-tpm~2.4.4~150600.3.15.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
