...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.1163.1");
  ...
  script_tag(name:"creation_date", value:"2026-04-03 04:47:47 +0000 (Fri, 03 Apr 2026)");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:1163-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:1163-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20261163-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1260083");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045255.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaThunderbird' package(s) announced via the SUSE-SU-2026:1163-1 advisory.");
...
- CVE-2025-59375: ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird", rpm:"MozillaThunderbird~140.9.0~150200.8.263.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-common", rpm:"MozillaThunderbird-translations-common~140.9.0~150200.8.263.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaThunderbird-translations-other", rpm:"MozillaThunderbird-translations-other~140.9.0~150200.8.263.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
