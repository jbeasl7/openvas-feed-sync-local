...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2026.0574.1");
  script_cve_id("CVE-2025-4476", "CVE-2026-0716", "CVE-2026-1761");
  script_tag(name:"creation_date", value:"2026-02-20 04:35:41 +0000 (Fri, 20 Feb 2026)");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2026:0574-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoup-2_4-1", rpm:"libsoup-2_4-1~2.74.3~150600.4.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-2_4-1-32bit", rpm:"libsoup-2_4-1-32bit~2.74.3~150600.4.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup2-devel", rpm:"libsoup2-devel~2.74.3~150600.4.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup2-devel-32bit", rpm:"libsoup2-devel-32bit~2.74.3~150600.4.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup2-lang", rpm:"libsoup2-lang~2.74.3~150600.4.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"typelib-1_0-Soup-2_4", rpm:"typelib-1_0-Soup-2_4~2.74.3~150600.4.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
