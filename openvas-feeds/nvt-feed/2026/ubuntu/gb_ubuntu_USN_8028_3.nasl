...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8028.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-8028-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8028-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8028-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi-realtime, linux-realtime' package(s) announced via the USN-8028-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - TCM ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-raspi-realtime, linux-realtime' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-2037-raspi-realtime", ver:"6.8.0-2037.38", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.1-1041-realtime", ver:"6.8.1-1041.42", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"6.8.1-1041.42", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-realtime", ver:"6.8.0-2037.38", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-realtime-6.8", ver:"6.8.0-2037.38", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.8.1-1041.42", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.8.1", ver:"6.8.1-1041.42", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
