...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8101.1");
  script_cve_id("CVE-2026-25749", "CVE-2026-26269", "CVE-2026-28417", "CVE-2026-28418", "CVE-2026-28419", "CVE-2026-28420", "CVE-2026-28421", "CVE-2026-28422");
  ...
  script_name("Ubuntu: Security Advisory (USN-8101-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8101-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8101-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim' package(s) announced via the USN-8101-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Rahul Hoysala discovered that Vim did not correctly handle certain tag
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:7.4.052-1ubuntu3.1+esm23", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:7.4.1689-3ubuntu1.5+esm29", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:8.0.1453-1ubuntu1.13+esm14", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:8.1.2269-1ubuntu5.32+esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:8.2.3995-1ubuntu2.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:9.1.0016-1ubuntu7.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:9.1.0967-1ubuntu6.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
