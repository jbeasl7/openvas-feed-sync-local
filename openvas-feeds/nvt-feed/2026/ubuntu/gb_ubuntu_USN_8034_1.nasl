...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8034.1");
  ...
  script_tag(name:"severity_date", value:"2026-02-26 17:12:15 +0000 (Thu, 26 Feb 2026)");

  script_name("Ubuntu: Security Advisory (USN-8034-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8034-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8034-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-nvidia-tegra, linux-nvidia-tegra-5.15' package(s) announced via the USN-8034-1 advisory.");
...
CVE-2025-40109, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-nvidia-tegra, linux-nvidia-tegra-5.15' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1052-nvidia-tegra", ver:"5.15.0-1052.52~20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1052-nvidia-tegra-rt", ver:"5.15.0-1052.52~20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra", ver:"5.15.0.1052.52~20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-5.15", ver:"5.15.0.1052.52~20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-rt", ver:"5.15.0.1052.52~20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-rt-5.15", ver:"5.15.0.1052.52~20.04.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1052-nvidia-tegra", ver:"5.15.0-1052.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1052-nvidia-tegra-rt", ver:"5.15.0-1052.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra", ver:"5.15.0.1052.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-5.15", ver:"5.15.0.1052.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-rt", ver:"5.15.0.1052.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-rt-5.15", ver:"5.15.0.1052.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
