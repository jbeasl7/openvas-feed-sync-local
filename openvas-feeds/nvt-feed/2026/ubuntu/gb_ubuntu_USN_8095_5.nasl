...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8095.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-8095-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8095-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8095-5");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi, linux-raspi-realtime' package(s) announced via the USN-8095-5 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1050-raspi", ver:"6.8.0-1050.54", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-2040-raspi-realtime", ver:"6.8.0-2040.41", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.8.0-1050.54", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-6.8", ver:"6.8.0-1050.54", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-realtime", ver:"6.8.0-2040.41", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-realtime-6.8", ver:"6.8.0-2040.41", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
