...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8031.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-8031-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8031-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8031-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp, linux-gke' package(s) announced via the USN-8031-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - TCM ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gcp, linux-gke' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1043-gke", ver:"6.8.0-1043.48", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1043-gke-64k", ver:"6.8.0-1043.48", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1047-gcp", ver:"6.8.0-1047.50", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1047-gcp-64k", ver:"6.8.0-1047.50", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-6.8", ver:"6.8.0-1047.50", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-6.8", ver:"6.8.0-1047.50", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-lts-24.04", ver:"6.8.0-1047.50", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-lts-24.04", ver:"6.8.0-1047.50", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"6.8.0-1043.48", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-6.8", ver:"6.8.0-1043.48", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-64k", ver:"6.8.0-1043.48", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-64k-6.8", ver:"6.8.0-1043.48", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
