...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.7964.1");
  ...
  script_tag(name:"severity_date", value:"2025-12-18 16:10:34 +0000 (Thu, 18 Dec 2025)");

  script_name("Ubuntu: Security Advisory (USN-7964-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7964-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7964-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'git' package(s) announced via the USN-7964-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Git did not properly sanitize URLs when asking for
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.7.4-0ubuntu1.10+esm13", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.17.1-1ubuntu0.18+esm6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
