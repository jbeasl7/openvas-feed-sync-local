...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8003.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8003-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8003-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8003-1");
  script_xref(name:"URL", value:"https://openjdk.org/groups/vulnerability/advisories/2026-01-20");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-21-crac' package(s) announced via the USN-8003-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the RMI component of CRaC JDK 21 would establish
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'openjdk-21-crac' package(s) on Ubuntu 25.10.");
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-demo", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-doc", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-jdk", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-jdk-headless", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-jre", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-jre-headless", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-jre-zero", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-source", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-21-crac-testsupport", ver:"21.0.10+7-0ubuntu1~25.10", rls:"UBUNTU25.10"))) {
    report += res;
  }
