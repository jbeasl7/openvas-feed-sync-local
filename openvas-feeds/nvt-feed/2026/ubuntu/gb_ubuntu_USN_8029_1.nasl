...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8029.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8029-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8029-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8029-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-raspi, linux-realtime' package(s) announced via the USN-8029-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Multipath ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux, linux-raspi, linux-realtime' package(s) on Ubuntu 25.10.");
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1006-realtime", ver:"6.17.0-1006.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1008-raspi", ver:"6.17.0-1008.8", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-14-generic", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-14-generic-64k", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-6.17", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k-6.17", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.17.0-1008.8", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-6.17", ver:"6.17.0-1008.8", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.17.0-1006.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.17", ver:"6.17.0-1006.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual-6.17", ver:"6.17.0-14.14", rls:"UBUNTU25.10"))) {
    report += res;
  }
