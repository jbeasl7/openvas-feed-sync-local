...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8096.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-8096-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8096-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8096-5");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-nvidia-tegra-igx' package(s) announced via the USN-8096-5 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - MAC80211 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-nvidia-tegra-igx' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1044-nvidia-tegra-igx", ver:"5.15.0-1044.44", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1044-nvidia-tegra-igx-rt", ver:"5.15.0-1044.44", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx", ver:"5.15.0.1044.46", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-5.15", ver:"5.15.0.1044.46", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-rt", ver:"5.15.0.1044.46", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-rt-5.15", ver:"5.15.0.1044.46", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
