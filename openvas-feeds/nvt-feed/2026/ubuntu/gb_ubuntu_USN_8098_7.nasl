...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8098.7");
  ...
  script_name("Ubuntu: Security Advisory (USN-8098-7)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8098-7");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8098-7");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-8098-7 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1160-azure", ver:"5.4.0-1160.166", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-5.4", ver:"5.4.0.1160.153", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-20.04", ver:"5.4.0.1160.153", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
