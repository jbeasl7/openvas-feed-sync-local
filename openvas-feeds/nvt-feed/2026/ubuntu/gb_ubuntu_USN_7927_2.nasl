...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.7927.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7927-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7927-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7927-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2136906");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-urllib3' package(s) announced via the USN-7927-2 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"2.0.7-1ubuntu0.5", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"2.3.0-2ubuntu0.4", rls:"UBUNTU25.04"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-urllib3", ver:"2.3.0-3ubuntu0.3", rls:"UBUNTU25.10"))) {
    report += res;
  }
