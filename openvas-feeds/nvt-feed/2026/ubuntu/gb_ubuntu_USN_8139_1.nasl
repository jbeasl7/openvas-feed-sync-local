...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8139.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8139-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8139-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8139-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust-cargo-c' package(s) announced via the USN-8139-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that tar-rs embedded in cargo-c incorrectly handled
...
the extraction root, and possibly escalate privileges.");
  ...
  script_tag(name:"affected", value:"'rust-cargo-c' package(s) on Ubuntu 25.10.");
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cargo-c", ver:"0.10.11-1ubuntu1.1", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"librust-cargo-c-dev", ver:"0.10.11-1ubuntu1.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
