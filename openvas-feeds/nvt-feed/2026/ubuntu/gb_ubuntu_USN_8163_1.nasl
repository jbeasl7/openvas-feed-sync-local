...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8163.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8163-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8163-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8163-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fips' package(s) announced via the USN-8163-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1109-azure-fips", ver:"5.15.0-1109.118+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips", ver:"5.15.0.1109.94", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips-5.15", ver:"5.15.0.1109.94", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
