...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8095.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-8095-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8095-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8095-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-realtime, linux-realtime-6.8' package(s) announced via the USN-8095-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - GFS2 file ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-realtime, linux-realtime-6.8' package(s) on Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.1-1045-realtime", ver:"6.8.1-1045.46~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.8.1", ver:"6.8.1-1045.46~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-hwe-22.04", ver:"6.8.1-1045.46~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.1-1045-realtime", ver:"6.8.1-1045.46", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"6.8.1-1045.46", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.8.1-1045.46", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.8.1", ver:"6.8.1-1045.46", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
