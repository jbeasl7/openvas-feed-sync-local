...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.7966.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7966-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7966-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7966-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'telegraf' package(s) announced via the USN-7966-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7966-1 fixed vulnerabilities in Snowflake. This update provides the
...
possibly use the issue to cause a denial of service. (CVE-2022-29222)");
  ...
  script_tag(name:"affected", value:"'telegraf' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"telegraf", ver:"1.21.4+ds1-0ubuntu2+esm2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
