...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8170.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8170-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8170-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8170-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'corosync' package(s) announced via the USN-8170-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Corosync incorrectly handled the membership commit
...
Corosync to crash, resulting in a denial of service. (CVE-2026-35092)");
  ...
  script_tag(name:"affected", value:"'corosync' package(s) on Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"corosync", ver:"3.1.6-1ubuntu1.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"corosync", ver:"3.1.7-1ubuntu3.2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"corosync", ver:"3.1.9-2ubuntu1.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
