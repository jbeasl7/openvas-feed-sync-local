...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8089.1");
  script_cve_id("CVE-2022-27664", "CVE-2022-41723", "CVE-2023-3978", "CVE-2025-22872", "CVE-2025-47911", "CVE-2025-58190");
  ...
  script_name("Ubuntu: Security Advisory (USN-8089-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8089-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8089-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-golang-x-net' package(s) announced via the USN-8089-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Bahruz Jabiyev, Tommaso Innocenti, Anthony Gavazzi, Steven Sprecher, and
...
possibly use this to cause a denial of service. (CVE-2025-58190)");
  ...
  script_tag(name:"affected", value:"'golang-golang-x-net' package(s) on Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"golang-golang-x-net-dev", ver:"1:0.0+git20211209.491a49a+dfsg-1ubuntu0.1~esm2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"golang-golang-x-net-dev", ver:"1:0.21.0+dfsg-1ubuntu0.1~esm2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
