...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8030-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8030-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8030-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp' package(s) announced via the USN-8030-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Multipath ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gcp' package(s) on Ubuntu 25.10.");
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1007-gcp", ver:"6.17.0-1007.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1007-gcp-64k", ver:"6.17.0-1007.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.17.0-1007.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-6.17", ver:"6.17.0-1007.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.17.0-1007.7", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-6.17", ver:"6.17.0-1007.7", rls:"UBUNTU25.10"))) {
    report += res;
  }
