...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8033.7");
  ...
  script_name("Ubuntu: Security Advisory (USN-8033-7)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8033-7");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8033-7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg-5.15, linux-xilinx-zynqmp' package(s) announced via the USN-8033-7 advisory.");
...
CVE-2025-40109, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-intel-iotg-5.15, linux-xilinx-zynqmp' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1095-intel-iotg", ver:"5.15.0-1095.101~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1095.101~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1095.101~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg-5.15", ver:"5.15.0.1095.101~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1064-xilinx-zynqmp", ver:"5.15.0-1064.68", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"5.15.0.1064.67", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp-5.15", ver:"5.15.0.1064.67", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
