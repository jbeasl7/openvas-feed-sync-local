...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8052.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-8052-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8052-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8052-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-xilinx' package(s) announced via the USN-8052-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - TCM ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-xilinx' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1023-xilinx", ver:"6.8.0-1023.24", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx", ver:"6.8.0.1023.24", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-6.8", ver:"6.8.0.1023.24", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"6.8.0.1023.24", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
