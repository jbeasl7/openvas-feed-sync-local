...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.7960.1");
  script_cve_id("CVE-2025-59830", "CVE-2025-61770", "CVE-2025-61771", "CVE-2025-61772", "CVE-2025-61780", "CVE-2025-61919");
  ...
  script_name("Ubuntu: Security Advisory (USN-7960-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7960-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7960-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-rack' package(s) announced via the USN-7960-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Rack incorrectly handled certain query parameters.
...
and Ubuntu 25.10. (CVE-2025-61919)");
  ...
  script_tag(name:"affected", value:"'ruby-rack' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.6.4-3ubuntu0.2+esm9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.6.4-4ubuntu0.2+esm9", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.0.7-2ubuntu0.1+esm8", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.1.4-5ubuntu1.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"2.2.7-1ubuntu0.5", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"3.1.16-0.1ubuntu0.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
