...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8126-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8126-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8126-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-6.8' package(s) announced via the USN-8126-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - VMware ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1051-azure", ver:"6.8.0-1051.57~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.8.0-1051.57~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.8", ver:"6.8.0-1051.57~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
