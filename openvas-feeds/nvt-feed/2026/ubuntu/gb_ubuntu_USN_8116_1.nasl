...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8116.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8116-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8116-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8116-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iot-realtime' package(s) announced via the USN-8116-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Key management,
 - Simplified Mandatory ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-intel-iot-realtime' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1094-intel-iot-realtime", ver:"5.15.0-1094.96", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"5.15.0.1094.98", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime-5.15", ver:"5.15.0.1094.98", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
