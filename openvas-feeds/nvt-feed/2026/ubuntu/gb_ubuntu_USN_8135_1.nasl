...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8135.1");
  script_cve_id("CVE-2021-25287", "CVE-2021-25288", "CVE-2021-25290", "CVE-2021-28675", "CVE-2021-28676", "CVE-2021-28677", "CVE-2023-44271", "CVE-2023-50447");
  ...
  script_name("Ubuntu: Security Advisory (USN-8135-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8135-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8135-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pillow' package(s) announced via the USN-8135-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Pillow did not correctly handle reading J2K files,
...
(CVE-2023-50447)");
  ...
  script_tag(name:"affected", value:"'pillow' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-pil", ver:"2.3.0-1ubuntu3.4+esm5", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-pil", ver:"2.3.0-1ubuntu3.4+esm5", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-pil", ver:"3.1.2-0ubuntu1.6+esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-pil", ver:"3.1.2-0ubuntu1.6+esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-pil", ver:"5.1.0-1ubuntu0.8+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-pil", ver:"5.1.0-1ubuntu0.8+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
