...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8048-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8048-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8048-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.17' package(s) announced via the USN-8048-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Multipath ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-oem-6.17' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1011-oem", ver:"6.17.0-1011.11", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-6.17", ver:"6.17.0-1011.11", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
