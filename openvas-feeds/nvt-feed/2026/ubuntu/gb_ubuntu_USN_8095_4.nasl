...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8095.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-8095-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8095-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8095-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-6.8' package(s) announced via the USN-8095-4 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - GFS2 file ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws-6.8' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1050-aws", ver:"6.8.0-1050.53~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1050-aws-64k", ver:"6.8.0-1050.53~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.8.0-1050.53~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-6.8", ver:"6.8.0-1050.53~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k", ver:"6.8.0-1050.53~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k-6.8", ver:"6.8.0-1050.53~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
