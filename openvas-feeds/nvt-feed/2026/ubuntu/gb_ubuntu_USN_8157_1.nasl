...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8157.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8157-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8157-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8157-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the USN-8157-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Squid incorrectly handled certain ICP traffic. In
...
small amounts of sensitive information.");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"5.9-0ubuntu0.22.04.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"6.14-0ubuntu0.24.04.2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"6.14-0ubuntu0.25.10.2", rls:"UBUNTU25.10"))) {
    report += res;
  }
