...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8165-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8165-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8165-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fips' package(s) announced via the USN-8165-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure-fips' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1052-azure-fips", ver:"6.8.0-1052.58+fips1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips", ver:"6.8.0-1052.58+fips1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips-6.8", ver:"6.8.0-1052.58+fips1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
