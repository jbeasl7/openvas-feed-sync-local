...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8090.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-8090-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8090-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8090-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssh' package(s) announced via the USN-8090-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-8090-1 fixed vulnerabilities in OpenSSH. This update provides the
...
could possibly use this issue to execute arbitrary code. (CVE-2025-61985)");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-client", ver:"1:8.2p1-4ubuntu0.13+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:8.2p1-4ubuntu0.13+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
