...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8028.7");
  ...
  script_name("Ubuntu: Security Advisory (USN-8028-7)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8028-7");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8028-7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-nvidia-lowlatency' package(s) announced via the USN-8028-7 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - TCM ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-nvidia-lowlatency' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1046-nvidia-lowlatency", ver:"6.8.0-1046.49.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1046-nvidia-lowlatency-64k", ver:"6.8.0-1046.49.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-lowlatency", ver:"6.8.0-1046.49.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-lowlatency-6.8", ver:"6.8.0-1046.49.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-lowlatency-64k", ver:"6.8.0-1046.49.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-lowlatency-64k-6.8", ver:"6.8.0-1046.49.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
