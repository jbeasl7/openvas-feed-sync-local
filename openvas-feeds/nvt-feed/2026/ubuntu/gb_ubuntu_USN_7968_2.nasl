...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.7968.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7968-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7968-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7968-2");
  script_xref(name:"URL", value:"https://bugs.launchpad.net/bugs/2142766");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-7968-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7968-1 fixed vulnerabilities in Apache HTTP Server. The update
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.52-1ubuntu4.19", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.58-1ubuntu8.11", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.64-1ubuntu3.3", rls:"UBUNTU25.10"))) {
    report += res;
  }
