...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8037.1");
  script_cve_id("CVE-2025-30187", "CVE-2025-30193", "CVE-2025-8671");
  ...
  script_name("Ubuntu: Security Advisory (USN-8037-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8037-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8037-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsdist' package(s) announced via the USN-8037-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that HTTP/2, which is used/vendored by DNSdist, did not
...
could possibly use this cause a denial of service. (CVE-2025-30187)");
  ...
  script_tag(name:"affected", value:"'dnsdist' package(s) on Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsdist", ver:"1.6.1-1ubuntu0.1~esm2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsdist", ver:"1.8.3-2ubuntu0.1~esm1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsdist", ver:"1.9.10-1ubuntu0.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
