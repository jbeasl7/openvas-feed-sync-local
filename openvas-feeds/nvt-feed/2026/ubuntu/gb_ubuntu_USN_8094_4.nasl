...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8094.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-8094-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8094-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8094-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-6.17' package(s) announced via the USN-8094-4 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-azure-6.17' package(s) on Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1010-azure", ver:"6.17.0-1010.10~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.17.0-1010.10~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.17", ver:"6.17.0-1010.10~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1010-azure", ver:"6.17.0-1010.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.17.0-1010.10", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.17", ver:"6.17.0-1010.10", rls:"UBUNTU25.10"))) {
    report += res;
  }
