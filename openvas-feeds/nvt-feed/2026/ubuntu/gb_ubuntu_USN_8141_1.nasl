...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8141-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8141-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8141-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi' package(s) announced via the USN-8141-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - NTFS3 file system,
 - OCFS2 file system,
 - OrangeFS ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1097-raspi", ver:"5.15.0-1097.100", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.15.0.1097.95", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-5.15", ver:"5.15.0.1097.95", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-nolpae", ver:"5.15.0.1097.95", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
