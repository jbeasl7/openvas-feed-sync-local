...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8138.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-8138-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8138-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8138-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust-tar' package(s) announced via the USN-8138-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-8138-1 fixed a vulnerability in tar-rs. This update provides the
...
Original advisory details:
 ...
 and possibly escalate privileges.");
  ...
  script_tag(name:"affected", value:"'rust-tar' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"librust-tar-dev", ver:"0.4.26-1ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
