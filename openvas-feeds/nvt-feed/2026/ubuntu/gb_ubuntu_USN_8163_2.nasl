...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8163-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8163-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8163-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-8163-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Network ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1109-azure", ver:"5.15.0-1109.118", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-5.15", ver:"5.15.0.1109.107", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-22.04", ver:"5.15.0.1109.107", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
