...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8094.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-8094-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8094-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8094-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp-6.17, linux-realtime' package(s) announced via the USN-8094-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gcp-6.17, linux-realtime' package(s) on Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1009-gcp", ver:"6.17.0-1009.9~24.04.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1009-gcp-64k", ver:"6.17.0-1009.9~24.04.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.17.0-1009.9~24.04.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-6.17", ver:"6.17.0-1009.9~24.04.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.17.0-1009.9~24.04.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-6.17", ver:"6.17.0-1009.9~24.04.3", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.17.0-1008-realtime", ver:"6.17.0-1008.9", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.17.0-1008.9", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.17", ver:"6.17.0-1008.9", rls:"UBUNTU25.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-hwe-24.04", ver:"6.17.0-1008.9", rls:"UBUNTU25.10"))) {
    report += res;
  }
