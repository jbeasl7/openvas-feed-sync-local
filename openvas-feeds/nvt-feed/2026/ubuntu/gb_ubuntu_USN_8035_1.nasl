...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8035.1");
  script_cve_id("CVE-2025-66293", "CVE-2026-22695", "CVE-2026-22801", "CVE-2026-25646");
  ...
  script_name("Ubuntu: Security Advisory (USN-8035-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8035-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8035-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpng1.6' package(s) announced via the USN-8035-1 advisory.");
...
cause libpng to crash, resulting in a denial of service. (CVE-2026-25646)");
  ...
  script_tag(name:"affected", value:"'libpng1.6' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.20-2ubuntu0.1~esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.34-1ubuntu0.18.04.2+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpng16-16", ver:"1.6.37-2ubuntu0.1~esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
