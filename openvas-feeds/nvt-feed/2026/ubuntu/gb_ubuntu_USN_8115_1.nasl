...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8115.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-8115-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8115-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8115-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pyopenssl' package(s) announced via the USN-8115-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that pyOpenSSL incorrectly handled exceptions in the
...
issue only affected Ubuntu 24.04 LTS and Ubuntu 25.10. (CVE-2026-27459)");
  ...
  script_tag(name:"affected", value:"'pyopenssl' package(s) on Ubuntu 22.04, Ubuntu 24.04, Ubuntu 25.10.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-openssl", ver:"21.0.0-1ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-openssl", ver:"23.2.0-1ubuntu0.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-openssl", ver:"25.0.0-1ubuntu0.1", rls:"UBUNTU25.10"))) {
    report += res;
  }
