...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-8125-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8125-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8125-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2143853");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-8125-1 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1051-azure", ver:"6.8.0-1051.57", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.8", ver:"6.8.0-1051.57", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-24.04", ver:"6.8.0-1051.57", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
