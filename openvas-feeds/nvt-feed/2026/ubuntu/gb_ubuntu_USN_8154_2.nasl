...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8154.2");
  script_cve_id("CVE-2026-33033", "CVE-2026-4277", "CVE-2026-4292");
  ...
  script_name("Ubuntu: Security Advisory (USN-8154-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8154-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8154-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django' package(s) announced via the USN-8154-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-8154-1 fixed vulnerabilities in Django. This update provides the
corresponding updates for CVE-2026-33033 and CVE-2026-4292 in Ubuntu 14.04
LTS and Ubuntu 16.04 LTS, and CVE-2026-4277 in Ubuntu 16.04 LTS.
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django", ver:"1.6.11-0ubuntu1.3+esm11", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django", ver:"1.8.7-1ubuntu5.15+esm12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-django", ver:"1.8.7-1ubuntu5.15+esm12", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
