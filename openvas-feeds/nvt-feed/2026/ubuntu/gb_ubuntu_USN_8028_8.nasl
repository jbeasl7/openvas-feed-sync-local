...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8028.8");
  ...
  script_name("Ubuntu: Security Advisory (USN-8028-8)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8028-8");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8028-8");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm, linux-ibm-6.8' package(s) announced via the USN-8028-8 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - TCM ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-ibm, linux-ibm-6.8' package(s) on Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1044-ibm", ver:"6.8.0-1044.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-6.8", ver:"6.8.0-1044.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1044-ibm", ver:"6.8.0-1044.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"6.8.0-1044.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-6.8", ver:"6.8.0-1044.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-classic", ver:"6.8.0-1044.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-lts-24.04", ver:"6.8.0-1044.44", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
