...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2026.8089.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-8089-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-8089-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-8089-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-golang-x-net-dev' package(s) announced via the USN-8089-2 advisory.");
...
Original advisory details:
 ...
 possibly use this to cause a denial of service. (CVE-2025-58190)");
  ...
  script_tag(name:"affected", value:"'golang-golang-x-net-dev' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"golang-go.net-dev", ver:"1:0.0+git20160110.4fd4a9f-1ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"golang-golang-x-net-dev", ver:"1:0.0+git20160110.4fd4a9f-1ubuntu0.1~esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"golang-go.net-dev", ver:"1:0.0+git20170629.c81e7f2+dfsg-2ubuntu0.1~esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"golang-golang-x-net-dev", ver:"1:0.0+git20170629.c81e7f2+dfsg-2ubuntu0.1~esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"golang-go.net-dev", ver:"1:0.0+git20190811.74dc4d7+dfsg-1ubuntu0.1~esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"golang-golang-x-net-dev", ver:"1:0.0+git20190811.74dc4d7+dfsg-1ubuntu0.1~esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
