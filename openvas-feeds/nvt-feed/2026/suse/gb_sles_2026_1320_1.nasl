...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.1320.1");
  script_cve_id("CVE-2026-27140", "CVE-2026-27143", "CVE-2026-27144", "CVE-2026-32280", "CVE-2026-32281", "CVE-2026-32282", "CVE-2026-32283", "CVE-2026-32288", "CVE-2026-32289", "CVE-2026-33810");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:1320-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:1320-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20261320-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1261662");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045527.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.26' package(s) announced via the SUSE-SU-2026:1320-1 advisory.");
...
- CVE-2026-33810: crypto/x509: excluded DNS constraints not properly applied to wildcard domains (bsc#1261662).");
  ...
  script_tag(name:"affected", value:"'go1.26' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.26", rpm:"go1.26~1.26.2~150000.1.9.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-doc", rpm:"go1.26-doc~1.26.2~150000.1.9.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-race", rpm:"go1.26-race~1.26.2~150000.1.9.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.26", rpm:"go1.26~1.26.2~150000.1.9.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-doc", rpm:"go1.26-doc~1.26.2~150000.1.9.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-race", rpm:"go1.26-race~1.26.2~150000.1.9.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.26", rpm:"go1.26~1.26.2~150000.1.9.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-doc", rpm:"go1.26-doc~1.26.2~150000.1.9.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-race", rpm:"go1.26-race~1.26.2~150000.1.9.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
