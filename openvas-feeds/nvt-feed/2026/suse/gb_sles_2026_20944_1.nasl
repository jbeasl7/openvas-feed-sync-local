...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20944.1");
  script_cve_id("CVE-2025-40214", "CVE-2025-40258", "CVE-2025-40297", "CVE-2025-68284", "CVE-2025-68285", "CVE-2025-68813", "CVE-2025-71085");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20944-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20944-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620944-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045208.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 3 for SUSE Linux Enterprise 16)' package(s) announced via the SUSE-SU-2026:20944-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the SUSE Linux Enterprise Kernel 6.12.0-160000.8.1 fixes various security issues
...
- CVE-2025-71085: ipv6: BUG() in pskb_expand_head() as part of calipso_skbuff_setattr() (bsc#1256624).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 3 for SUSE Linux Enterprise 16)' package(s) on SUSE Linux Enterprise Server 16.0, SUSE Linux Enterprise Server for SAP Applications 16.0.");
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-6_12_0-160000_8-default", rpm:"kernel-livepatch-6_12_0-160000_8-default~3~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }
