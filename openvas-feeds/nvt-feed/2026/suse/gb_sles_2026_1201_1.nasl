...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.1201.1");
  script_cve_id("CVE-2026-24484", "CVE-2026-28494", "CVE-2026-28686", "CVE-2026-28687", "CVE-2026-28688", "CVE-2026-28689", "CVE-2026-28690", "CVE-2026-28691", "CVE-2026-28692", "CVE-2026-28693", "CVE-2026-30883", "CVE-2026-30937", "CVE-2026-31853", "CVE-2026-33535", "CVE-2026-33536");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:1201-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:1201-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20261201-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045303.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ImageMagick' package(s) announced via the SUSE-SU-2026:1201-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-config-6-SUSE", rpm:"ImageMagick-config-6-SUSE~6.8.8.1~71.236.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-config-6-upstream", rpm:"ImageMagick-config-6-upstream~6.8.8.1~71.236.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ImageMagick-devel", rpm:"ImageMagick-devel~6.8.8.1~71.236.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libMagick++-devel", rpm:"libMagick++-devel~6.8.8.1~71.236.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libMagickCore-6_Q16-1", rpm:"libMagickCore-6_Q16-1~6.8.8.1~71.236.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libMagickWand-6_Q16-1", rpm:"libMagickWand-6_Q16-1~6.8.8.1~71.236.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
