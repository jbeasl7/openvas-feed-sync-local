...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0385.1");
  ...
  script_tag(name:"severity_date", value:"2025-10-28 20:30:52 +0000 (Tue, 28 Oct 2025)");

  script_name("SUSE: Security Advisory (SUSE-SU-2026:0385-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0385-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260385-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024056.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2026:0385-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-docs", rpm:"kernel-docs~3.0.101~108.180.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
