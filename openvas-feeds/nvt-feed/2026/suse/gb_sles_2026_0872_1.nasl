...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0872.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0872-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0872-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260872-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-March/024677.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox' package(s) announced via the SUSE-SU-2026:0872-1 advisory.");
...
- CVE-2021-42380: Additional fix for use-after-realloc in awk (bsc#1192869).");
  ...
  script_tag(name:"affected", value:"'busybox' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox", rpm:"busybox~1.35.0~150400.3.14.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"busybox-static", rpm:"busybox-static~1.35.0~150400.3.14.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
