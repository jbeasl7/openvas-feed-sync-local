...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20629.1");
  script_cve_id("CVE-2025-47912", "CVE-2025-58183", "CVE-2025-58185", "CVE-2025-58186", "CVE-2025-58187", "CVE-2025-58188", "CVE-2025-58189", "CVE-2025-61723", "CVE-2025-61724", "CVE-2025-61725", "CVE-2025-61726", "CVE-2025-61727", "CVE-2025-61728", "CVE-2025-61729", "CVE-2025-61730", "CVE-2025-61731", "CVE-2025-61732", "CVE-2025-68119", "CVE-2025-68121");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20629-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20629-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620629-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-March/024646.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.24-openssl' package(s) announced via the SUSE-SU-2026:20629-1 advisory.");
...
- CVE-2025-68119: cmd/go: unexpected code execution when invoking toolchain. (bsc#1256820)");
  ...
  script_tag(name:"affected", value:"'go1.24-openssl' package(s) on SUSE Linux Enterprise Server 16.0, SUSE Linux Enterprise Server for SAP Applications 16.0.");
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl", rpm:"go1.24-openssl~1.24.13~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-doc", rpm:"go1.24-openssl-doc~1.24.13~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-race", rpm:"go1.24-openssl-race~1.24.13~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }
