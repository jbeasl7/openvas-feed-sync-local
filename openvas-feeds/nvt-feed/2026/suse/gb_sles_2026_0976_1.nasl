...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0976.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0976-1)");
...
- go1.26.0 (released 2026-02-10) is a major release of Go.
 ...
 go1.26 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'go1.26-openssl' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl", rpm:"go1.26-openssl~1.26.1~150600.13.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl-doc", rpm:"go1.26-openssl-doc~1.26.1~150600.13.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl-race", rpm:"go1.26-openssl-race~1.26.1~150600.13.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
