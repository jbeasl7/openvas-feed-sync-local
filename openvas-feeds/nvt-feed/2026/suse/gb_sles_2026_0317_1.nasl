...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0317-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0317-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260317-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206451");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207315");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254392");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254601");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254651");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254681");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254684");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254685");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254786");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254910");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254911");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254922");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254979");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255107");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255532");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255561");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255596");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255635");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255745");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255747");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255761");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255881");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255916");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255919");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255920");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255946");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1255998");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256088");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256101");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256103");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256106");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256111");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256112");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256128");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256144");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256145");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256149");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256150");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256164");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256165");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256166");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256198");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256214");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256215");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256216");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256218");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256239");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256294");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256309");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256352");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256359");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256363");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256381");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-January/023979.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2026:0317-1 advisory.");
...
- arch/idle: Change arch_cpu_idle() behavior: always ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cluster-md-kmp-default", rpm:"cluster-md-kmp-default~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"dlm-kmp-default", rpm:"dlm-kmp-default~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gfs2-kmp-default", rpm:"gfs2-kmp-default~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-64kb", rpm:"kernel-64kb~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-64kb-devel", rpm:"kernel-64kb-devel~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default", rpm:"kernel-default~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-base", rpm:"kernel-default-base~5.14.21~150500.55.133.1.150500.6.65.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-devel", rpm:"kernel-default-devel~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-devel", rpm:"kernel-devel~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-docs", rpm:"kernel-docs~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-macros", rpm:"kernel-macros~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-obs-build", rpm:"kernel-obs-build~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-source", rpm:"kernel-source~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-syms", rpm:"kernel-syms~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-zfcpdump", rpm:"kernel-zfcpdump~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ocfs2-kmp-default", rpm:"ocfs2-kmp-default~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"reiserfs-kmp-default", rpm:"reiserfs-kmp-default~5.14.21~150500.55.133.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
