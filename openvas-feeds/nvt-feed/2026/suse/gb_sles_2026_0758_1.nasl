...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0758.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0758-1)");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox", rpm:"busybox~1.37.0~150500.10.17.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"busybox-static", rpm:"busybox-static~1.37.0~150500.10.17.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"busybox", rpm:"busybox~1.37.0~150500.10.17.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"busybox-static", rpm:"busybox-static~1.37.0~150500.10.17.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
