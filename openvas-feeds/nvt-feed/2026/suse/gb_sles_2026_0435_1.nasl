...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0435.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0435-1)");
...
- CVE-2026-21637: Route callback exceptions through error handlers (bsc#1256576)");
  ...
  script_tag(name:"affected", value:"'nodejs20' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs20", rpm:"nodejs20~20.20.0~150600.3.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20-devel", rpm:"nodejs20-devel~20.20.0~150600.3.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20-docs", rpm:"nodejs20-docs~20.20.0~150600.3.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm20", rpm:"npm20~20.20.0~150600.3.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
