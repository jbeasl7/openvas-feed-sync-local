...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0741.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0741-1)");
...
- post-process-pe: add tests ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~16.1~150300.4.31.3", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~16.1~150300.4.31.3", rls:"SLES15.0SP5"))) {
    report += res;
  }
