...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0760.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0760-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.25-openssl", rpm:"go1.25-openssl~1.25.7~150600.13.12.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-openssl-doc", rpm:"go1.25-openssl-doc~1.25.7~150600.13.12.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-openssl-race", rpm:"go1.25-openssl-race~1.25.7~150600.13.12.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
