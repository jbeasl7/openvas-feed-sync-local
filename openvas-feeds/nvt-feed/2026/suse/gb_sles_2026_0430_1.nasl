...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0430.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0430-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0430-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260430-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256902");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024118.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-pyasn1' package(s) announced via the SUSE-SU-2026:0430-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-pyasn1", rpm:"python3-pyasn1~0.4.2~150000.3.13.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-pyasn1", rpm:"python3-pyasn1~0.4.2~150000.3.13.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-pyasn1", rpm:"python3-pyasn1~0.4.2~150000.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
