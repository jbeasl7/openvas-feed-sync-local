...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20926.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20926-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20926-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620926-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045226.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat11' package(s) announced via the SUSE-SU-2026:20926-1 advisory.");
...
Changelog:
 ...
 credential and salt are ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'tomcat11' package(s) on SUSE Linux Enterprise Server 16.0, SUSE Linux Enterprise Server for SAP Applications 16.0.");
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat11", rpm:"tomcat11~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-admin-webapps", rpm:"tomcat11-admin-webapps~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-doc", rpm:"tomcat11-doc~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-docs-webapp", rpm:"tomcat11-docs-webapp~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-el-6_0-api", rpm:"tomcat11-el-6_0-api~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-embed", rpm:"tomcat11-embed~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-jsp-4_0-api", rpm:"tomcat11-jsp-4_0-api~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-jsvc", rpm:"tomcat11-jsvc~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-lib", rpm:"tomcat11-lib~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-servlet-6_1-api", rpm:"tomcat11-servlet-6_1-api~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-webapps", rpm:"tomcat11-webapps~11.0.18~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }
