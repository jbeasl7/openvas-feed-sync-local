...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0789.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0789-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0789-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260789-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-March/024529.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.24-openssl' package(s) announced via the SUSE-SU-2026:0789-1 advisory.");
...
- go#77424 crypto/tls: CL 737700 broke session resumption on macOS");
  ...
  script_tag(name:"affected", value:"'go1.24-openssl' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl", rpm:"go1.24-openssl~1.24.13~150600.13.18.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-doc", rpm:"go1.24-openssl-doc~1.24.13~150600.13.18.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-race", rpm:"go1.24-openssl-race~1.24.13~150600.13.18.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
