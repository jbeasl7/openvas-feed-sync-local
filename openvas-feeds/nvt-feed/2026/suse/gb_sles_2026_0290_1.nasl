...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0290.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0290-1)");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenvswitch-3_1-0", rpm:"libopenvswitch-3_1-0~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libovn-23_03-0", rpm:"libovn-23_03-0~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvswitch3", rpm:"openvswitch3~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvswitch3-devel", rpm:"openvswitch3-devel~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvswitch3-ipsec", rpm:"openvswitch3-ipsec~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvswitch3-pki", rpm:"openvswitch3-pki~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvswitch3-test", rpm:"openvswitch3-test~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvswitch3-vtep", rpm:"openvswitch3-vtep~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovn3", rpm:"ovn3~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovn3-central", rpm:"ovn3-central~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovn3-devel", rpm:"ovn3-devel~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovn3-docker", rpm:"ovn3-docker~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovn3-host", rpm:"ovn3-host~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovn3-vtep", rpm:"ovn3-vtep~23.03.3~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-ovs3", rpm:"python3-ovs3~3.1.7~150500.3.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
