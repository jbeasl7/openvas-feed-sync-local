...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.1213.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:1213-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:1213-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20261213-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045329.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl-3' package(s) announced via the SUSE-SU-2026:1213-1 advisory.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenssl-3-devel", rpm:"libopenssl-3-devel~3.0.8~150500.5.60.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl3", rpm:"libopenssl3~3.0.8~150500.5.60.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-3", rpm:"openssl-3~3.0.8~150500.5.60.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
