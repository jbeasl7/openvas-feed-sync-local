...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0378.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0378-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0378-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260378-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024043.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gpg2' package(s) announced via the SUSE-SU-2026:0378-1 advisory.");
...
- Fixed error out on unverified output for non-detached
 signatures [T7903] (bsc#1256244)");
  ...
  script_tag(name:"affected", value:"'gpg2' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gpg2", rpm:"gpg2~2.0.24~9.17.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gpg2-lang", rpm:"gpg2-lang~2.0.24~9.17.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
