...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0222.1");
  script_cve_id("CVE-2025-67725", "CVE-2025-67726");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0222-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0222-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260222-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254904");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1254905");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-January/023863.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-tornado' package(s) announced via the SUSE-SU-2026:0222-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-tornado", rpm:"python3-tornado~4.5.3~150000.3.13.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-tornado", rpm:"python3-tornado~4.5.3~150000.3.13.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-tornado", rpm:"python3-tornado~4.5.3~150000.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
