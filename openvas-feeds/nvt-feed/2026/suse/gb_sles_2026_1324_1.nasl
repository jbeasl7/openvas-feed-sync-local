...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.1324.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:1324-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:1324-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20261324-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045523.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the SUSE-SU-2026:1324-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav", rpm:"clamav~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-devel", rpm:"clamav-devel~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-docs-html", rpm:"clamav-docs-html~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-milter", rpm:"clamav-milter~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libclamav12", rpm:"libclamav12~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libclammspack0", rpm:"libclammspack0~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfreshclam4", rpm:"libfreshclam4~1.5.2~3.53.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
