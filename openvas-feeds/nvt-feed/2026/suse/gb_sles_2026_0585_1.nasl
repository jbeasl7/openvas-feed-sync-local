...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0585.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0585-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0585-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260585-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024361.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql18' package(s) announced via the SUSE-SU-2026:0585-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libecpg6", rpm:"libecpg6~18.2~8.6.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libecpg6-32bit", rpm:"libecpg6-32bit~18.2~8.6.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpq5", rpm:"libpq5~18.2~8.6.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpq5-32bit", rpm:"libpq5-32bit~18.2~8.6.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
