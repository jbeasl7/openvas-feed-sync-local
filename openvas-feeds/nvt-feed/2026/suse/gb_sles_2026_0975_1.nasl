...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0975.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0975-1)");
...
- CVE-2026-28498: fail-open in behavior OIDC hash validation allows for bypass mandatory integrity protections
 (bsc#1259737).");
  ...
  script_tag(name:"affected", value:"'python-Authlib' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-Authlib", rpm:"python311-Authlib~1.3.1~150600.3.17.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
