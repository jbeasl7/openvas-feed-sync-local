...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0881.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0881-1)");
...
Regression fixes:
 ...
 - a standby may halt and return an error 'could not access status of transaction'.");
  ...
  script_tag(name:"affected", value:"'postgresql18' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libecpg6", rpm:"libecpg6~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpq5", rpm:"libpq5~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpq5-32bit", rpm:"libpq5-32bit~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18", rpm:"postgresql18~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-contrib", rpm:"postgresql18-contrib~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-devel", rpm:"postgresql18-devel~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-docs", rpm:"postgresql18-docs~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-plperl", rpm:"postgresql18-plperl~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-plpython", rpm:"postgresql18-plpython~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-pltcl", rpm:"postgresql18-pltcl~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-server", rpm:"postgresql18-server~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql18-server-devel", rpm:"postgresql18-server-devel~18.3~150600.13.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
