...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0457.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0457-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0457-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260457-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024134.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs20' package(s) announced via the SUSE-SU-2026:0457-1 advisory.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nodejs20", rpm:"nodejs20~20.20.0~150500.11.24.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20-devel", rpm:"nodejs20-devel~20.20.0~150500.11.24.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20-docs", rpm:"nodejs20-docs~20.20.0~150500.11.24.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm20", rpm:"npm20~20.20.0~150500.11.24.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
