...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20223.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20223-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20223-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620223-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256829");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256830");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256831");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256832");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1256833");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1257274");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024064.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl-3' package(s) announced via the SUSE-SU-2026:20223-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"- CVE-2025-11187: Improper validation of PBMAC1 parameters in PKCS#12 MAC verification (bsc#1256829).
...
- Enable livepatching support for ppc64le (bsc#1257274).");
  ...
  script_tag(name:"affected", value:"'openssl-3' package(s) on SUSE Linux Enterprise Server 16.0, SUSE Linux Enterprise Server for SAP Applications 16.0.");
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenssl-3-devel", rpm:"libopenssl-3-devel~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl-3-fips-provider", rpm:"libopenssl-3-fips-provider~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl-3-fips-provider-x86-64-v3", rpm:"libopenssl-3-fips-provider-x86-64-v3~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl3", rpm:"libopenssl3~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl3-x86-64-v3", rpm:"libopenssl3-x86-64-v3~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-3", rpm:"openssl-3~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-3-doc", rpm:"openssl-3-doc~3.5.0~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }
