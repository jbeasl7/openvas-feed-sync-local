...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0831.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0831-1)");
 ...
 * CVE-2025-13086: improper validation of IP addresses that can cause denial of service (bsc#1254486)");
  ...
  script_tag(name:"affected", value:"'openvpn' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openvpn", rpm:"openvpn~2.6.10~150600.3.20.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvpn-auth-pam-plugin", rpm:"openvpn-auth-pam-plugin~2.6.10~150600.3.20.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvpn-dco", rpm:"openvpn-dco~2.6.10~150600.3.20.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvpn-dco-devel", rpm:"openvpn-dco-devel~2.6.10~150600.3.20.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openvpn-devel", rpm:"openvpn-devel~2.6.10~150600.3.20.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
