...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0877.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0877-1)");
 ...
 * Catalina
 ...
 credential and salt ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'tomcat11' package(s) on SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat11", rpm:"tomcat11~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-admin-webapps", rpm:"tomcat11-admin-webapps~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-el-6_0-api", rpm:"tomcat11-el-6_0-api~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-jsp-4_0-api", rpm:"tomcat11-jsp-4_0-api~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-lib", rpm:"tomcat11-lib~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-servlet-6_1-api", rpm:"tomcat11-servlet-6_1-api~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat11-webapps", rpm:"tomcat11-webapps~11.0.18~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
