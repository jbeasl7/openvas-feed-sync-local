...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0993.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0993-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0993-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260993-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-March/024870.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.26-openssl' package(s) announced via the SUSE-SU-2026:0993-1 advisory.");
...
- go1.26.0 (released 2026-02-10) is a major release of Go.
 ...
 go1.26 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'go1.26-openssl' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl", rpm:"go1.26-openssl~1.26.1~150000.1.3.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl-doc", rpm:"go1.26-openssl-doc~1.26.1~150000.1.3.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl-race", rpm:"go1.26-openssl-race~1.26.1~150000.1.3.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl", rpm:"go1.26-openssl~1.26.1~150000.1.3.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl-doc", rpm:"go1.26-openssl-doc~1.26.1~150000.1.3.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.26-openssl-race", rpm:"go1.26-openssl-race~1.26.1~150000.1.3.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
