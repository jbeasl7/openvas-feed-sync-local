...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20428.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20428-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20428-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620428-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024344.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.25' package(s) announced via the SUSE-SU-2026:20428-1 advisory.");
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.25", rpm:"go1.25~1.25.7~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-doc", rpm:"go1.25-doc~1.25.7~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-libstd", rpm:"go1.25-libstd~1.25.7~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.25-race", rpm:"go1.25-race~1.25.7~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }
