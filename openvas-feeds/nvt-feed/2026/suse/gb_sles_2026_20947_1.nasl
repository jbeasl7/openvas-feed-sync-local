...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20947.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20947-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20947-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620947-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045205.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 2 for SUSE Linux Enterprise 16)' package(s) announced via the SUSE-SU-2026:20947-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the SUSE Linux Enterprise Kernel 6.12.0-160000.7.1 fixes various security issues
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-6_12_0-160000_7-default", rpm:"kernel-livepatch-6_12_0-160000_7-default~4~160000.1.1", rls:"SLES16.0.0"))) {
    report += res;
  }
