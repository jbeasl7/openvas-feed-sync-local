...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.1152.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:1152-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:1152-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20261152-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1259901");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1259902");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-March/045201.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-XML-Parser' package(s) announced via the SUSE-SU-2026:1152-1 advisory.");
...
- CVE-2006-10003: off-by-one heap buffer overflow in `st_serial_stack` (bsc#1259902).");
  ...
  script_tag(name:"affected", value:"'perl-XML-Parser' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-XML-Parser", rpm:"perl-XML-Parser~2.41~23.3.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
