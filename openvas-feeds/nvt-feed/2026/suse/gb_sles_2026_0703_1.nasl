...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0703.1");
  script_cve_id("CVE-2025-32049", "CVE-2025-4476", "CVE-2026-0716", "CVE-2026-2369", "CVE-2026-2443", "CVE-2026-2708");
  script_tag(name:"creation_date", value:"2026-03-04 04:35:06 +0000 (Wed, 04 Mar 2026)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0703-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0703-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260703-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-March/024517.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsoup' package(s) announced via the SUSE-SU-2026:0703-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoup-2_4-1", rpm:"libsoup-2_4-1~2.62.2~5.34.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-2_4-1-32bit", rpm:"libsoup-2_4-1-32bit~2.62.2~5.34.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-devel", rpm:"libsoup-devel~2.62.2~5.34.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-lang", rpm:"libsoup-lang~2.62.2~5.34.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"typelib-1_0-Soup-2_4", rpm:"typelib-1_0-Soup-2_4~2.62.2~5.34.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
