...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.20985.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:20985-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:20985-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-202620985-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2026-April/045346.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat' package(s) announced via the SUSE-SU-2026:20985-1 advisory.");
...
if(release == "SLES16.0.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.7.1~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libexpat-devel", rpm:"libexpat-devel~2.7.1~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libexpat1", rpm:"libexpat1~2.7.1~160000.5.1", rls:"SLES16.0.0"))) {
    report += res;
  }
