...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0308.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0308-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl", rpm:"go1.24-openssl~1.24.12~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-doc", rpm:"go1.24-openssl-doc~1.24.12~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.24-openssl-race", rpm:"go1.24-openssl-race~1.24.12~150600.13.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
