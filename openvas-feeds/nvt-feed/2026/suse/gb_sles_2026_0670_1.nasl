...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2026.0670.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2026:0670-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2026:0670-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2026/suse-su-20260670-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1229129");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1258046");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2026-February/024440.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2026:0670-1 advisory.");
...
- CVE-2025-31648: Improper handling of values in the microcode flow for
 some Intel Processor Family may allow an escalation of privilege. (bsc#1258046)");
  ...
  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE Linux Enterprise Server 11-SP4.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~1.17~102.83.90.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
