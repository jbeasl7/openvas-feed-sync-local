...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2026.103.01");
  script_tag(name:"creation_date", value:"2026-04-14 04:59:27 +0000 (Tue, 14 Apr 2026)");
  ...
  script_name("Slackware: Security Advisory (SSA:2026-103-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2026-103-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2026&m=slackware-security.384979");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive' package(s) announced via the SSA:2026-103-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libarchive", ver:"3.8.7-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"libarchive", ver:"3.8.7-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libarchive", ver:"3.8.7-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"libarchive", ver:"3.8.7-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
