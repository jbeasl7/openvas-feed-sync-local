...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1428");
  ...
  script_name("Huawei EulerOS: Security Advisory for gnutls (EulerOS-SA-2026-1428)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1428");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1428");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gnutls' package(s) announced via the EulerOS-SA-2026-1428 advisory.");
...
if(release == "EULEROSVIRT-2.12.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~3.7.2~6.h15.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnutls-utils", rpm:"gnutls-utils~3.7.2~6.h15.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }
