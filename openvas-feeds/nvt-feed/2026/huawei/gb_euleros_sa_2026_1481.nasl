...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1481");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdb (EulerOS-SA-2026-1481)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1481");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1481");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdb' package(s) announced via the EulerOS-SA-2026-1481 advisory.");
...
GNU Binutils before 2.40 was discovered to contain an excessive memory consumption vulnerability via the function bfd_dwarf2_find_nearest_line_with_alt at dwarf2.c. The attacker could supply a crafted ELF file and cause a DNS attack.(CVE-2022-48064)");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on Huawei EulerOS Virtualization release 2.12.0.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~11.1~3.h9.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-headless", rpm:"gdb-headless~11.1~3.h9.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-help", rpm:"gdb-help~11.1~3.h9.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
