...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1162");
  ...
  script_name("Huawei EulerOS: Security Advisory for elfutils (EulerOS-SA-2026-1162)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1162");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1162");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'elfutils' package(s) announced via the EulerOS-SA-2026-1162 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"elfutils", rpm:"elfutils~0.180~1.h8.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
