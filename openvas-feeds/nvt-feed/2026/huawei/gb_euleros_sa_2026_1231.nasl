...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1231");
  ...
  script_name("Huawei EulerOS: Security Advisory for cups (EulerOS-SA-2026-1231)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1231");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1231");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cups' package(s) announced via the EulerOS-SA-2026-1231 advisory.");
...
OpenPrinting CUPS is an open source printing system for Linux and other Unix-like operating systems. Prior to version 2.4.15, a client that connects to cupsd but sends slow messages, e.g. only one byte per second, delays cupsd as a whole, such that it becomes unusable by other clients. This issue has been patched in version 2.4.15.(CVE-2025-58436)");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Huawei EulerOS V2.0SP13(x86_64).");
...
if(release == "EULEROS-2.0SP13-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~2.4.0~10.h8.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }
