...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1110");
  ...
  script_name("Huawei EulerOS: Security Advisory for edk2 (EulerOS-SA-2026-1110)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1110");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1110");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'edk2' package(s) announced via the EulerOS-SA-2026-1110 advisory.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2-aarch64", rpm:"edk2-aarch64~202011~2.10.0.5.27", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
