...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1358");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdb (EulerOS-SA-2026-1358)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1358");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1358");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdb' package(s) announced via the EulerOS-SA-2026-1358 advisory.");
...
A vulnerability has been found in GNU Binutils 2.45. The affected element is the function elf_swap_shdr in the library bfd/elfcode.h of the component Linker. The manipulation leads to heap-based buffer overflow. The attack must be carried out locally. The exploit has been disclosed to the public and may be used. The identifier of the patch is 9ca499644a21ceb3f946d1c179c38a83be084490. To fix this issue, it is recommended to deploy a patch. The code maintainer replied with '[f]ixed for 2.46'.(CVE-2025-11083)");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on Huawei EulerOS V2.0SP12(x86_64).");
...
if(release == "EULEROS-2.0SP12-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~11.1~3.h9.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-headless", rpm:"gdb-headless~11.1~3.h9.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-help", rpm:"gdb-help~11.1~3.h9.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }
