...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1346");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-ldap (EulerOS-SA-2026-1346)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1346");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1346");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-ldap' package(s) announced via the EulerOS-SA-2026-1346 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-ldap-help", rpm:"python-ldap-help~3.1.0~3.h9.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-ldap", rpm:"python3-ldap~3.1.0~3.h9.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
