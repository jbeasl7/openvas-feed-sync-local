...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1475");
  script_cve_id("CVE-2025-3198", "CVE-2025-5244", "CVE-2025-5245", "CVE-2025-7545");
  ...
  script_name("Huawei EulerOS: Security Advisory for binutils (EulerOS-SA-2026-1475)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1475");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1475");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'binutils' package(s) announced via the EulerOS-SA-2026-1475 advisory.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.37~14.h16.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
