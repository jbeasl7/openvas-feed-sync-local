...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1166");
  script_cve_id("CVE-2024-34397", "CVE-2025-3360", "CVE-2025-4373", "CVE-2025-7039");
  ...
  script_name("Huawei EulerOS: Security Advisory for glib2 (EulerOS-SA-2026-1166)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1166");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1166");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'glib2' package(s) announced via the EulerOS-SA-2026-1166 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was found in glib. An integer overflow during temporary file creation leads to an out-of-bounds memory access, allowing an attacker to potentially perform path traversal or access private temporary file content by creating symbolic links. This vulnerability allows a local attacker to manipulate file paths and access unauthorized data. The core issue stems from insufficient validation of file path lengths during temporary file operations.(CVE-2025-7039)
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.62.5~6.h22.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
