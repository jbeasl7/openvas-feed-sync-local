...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1067");
  ...
  script_name("Huawei EulerOS: Security Advisory for docker-runc (EulerOS-SA-2026-1067)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1067");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1067");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'docker-runc' package(s) announced via the EulerOS-SA-2026-1067 advisory.");
...
if(release == "EULEROS-2.0SP12-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-runc", rpm:"docker-runc~1.1.3~9.h32.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }
