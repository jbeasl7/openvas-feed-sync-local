...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1109");
  ...
  script_name("Huawei EulerOS: Security Advisory for curl (EulerOS-SA-2026-1109)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1109");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1109");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'curl' package(s) announced via the EulerOS-SA-2026-1109 advisory.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.71.1~4.h31.r6.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.71.1~4.h31.r6.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
