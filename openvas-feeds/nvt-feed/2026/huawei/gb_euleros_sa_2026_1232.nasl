...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1232");
  ...
  script_name("Huawei EulerOS: Security Advisory for curl (EulerOS-SA-2026-1232)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1232");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1232");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'curl' package(s) announced via the EulerOS-SA-2026-1232 advisory.");
...
When doing SSH-based transfers using either SCP or SFTP, and asked to do public key authentication, curl would wrongly still ask and authenticate using a locally running SSH agent.(CVE-2025-15224)");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on Huawei EulerOS V2.0SP13(x86_64).");
...
if(release == "EULEROS-2.0SP13-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.79.1~25.h18.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.79.1~25.h18.eulerosv2r13", rls:"EULEROS-2.0SP13-x86_64"))) {
    report += res;
  }
