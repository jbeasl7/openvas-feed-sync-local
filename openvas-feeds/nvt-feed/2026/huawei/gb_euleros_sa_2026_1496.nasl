...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1496");
  ...
  script_name("Huawei EulerOS: Security Advisory for libssh (EulerOS-SA-2026-1496)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1496");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1496");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libssh' package(s) announced via the EulerOS-SA-2026-1496 advisory.");
...
A flaw was found in the libssh library. An out-of-bounds read can be triggered in the sftp_handle function due to an incorrect comparison check that permits the function to access memory beyond the valid handle list and to return an invalid pointer, which is used in further processing. This vulnerability allows an authenticated remote attacker to potentially read unintended memory regions, exposing sensitive information or affect service behavior.(CVE-2025-5318)");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on Huawei EulerOS Virtualization release 2.12.0.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh", rpm:"libssh~0.9.6~5.h11.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
