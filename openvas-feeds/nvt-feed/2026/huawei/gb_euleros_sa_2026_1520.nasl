...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1520");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2026-1520)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1520");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1520");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2026-1520 advisory.");
...
There exists a vulnerability in SQLite versions before 3.50.2 where the number of aggregate terms could exceed the number of columns available. This could lead to a memory corruption issue. We recommend upgrading to version 3.50.2 or above.(CVE-2025-6965)");
  ...
  script_tag(name:"affected", value:"'sqlite' package(s) on Huawei EulerOS Virtualization release 2.12.0.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.37.2~5.h8.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
