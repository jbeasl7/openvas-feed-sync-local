...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1539");
  ...
  script_name("Huawei EulerOS: Security Advisory for libpng (EulerOS-SA-2026-1539)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1539");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1539");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libpng' package(s) announced via the EulerOS-SA-2026-1539 advisory.");
...
LIBPNG is a reference library for use in applications that read, create, and manipulate PNG (Portable Network Graphics) raster image files. Prior to 1.6.52, an out-of-bounds read vulnerability in libpng's simplified API allows reading up to 1012 bytes beyond the png_sRGB_base[512] array when processing valid palette PNG images with partial transparency and gamma correction. The PNG files that trigger this vulnerability are valid per the PNG specification, the bug is in libpng's internal state management. Upgrade to libpng 1.6.52 or later.(CVE-2025-66293)");
  ...
  script_tag(name:"affected", value:"'libpng' package(s) on Huawei EulerOS Virtualization release 2.10.1.");
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.6.37~1.h3.eulerosv2r10", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
