...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1630");
  ...
  script_name("Huawei EulerOS: Security Advisory for libpng (EulerOS-SA-2026-1630)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1630");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1630");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libpng' package(s) announced via the EulerOS-SA-2026-1630 advisory.");
...
LIBPNG is a reference library for use in applications that read, create, and manipulate PNG (Portable Network Graphics) raster image files. Prior to version 1.6.51, a heap buffer over-read vulnerability exists in libpng's png_do_quantize function when processing PNG files with malformed palette indices. The vulnerability occurs when palette_lookup array bounds are not validated against externally-supplied image data, allowing an attacker to craft a PNG file with out-of-range palette indices that trigger out-of-bounds memory access. This issue has been patched in version 1.6.51.(CVE-2025-64505)");
  ...
  script_tag(name:"affected", value:"'libpng' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpng", rpm:"libpng~1.6.38~2.h1.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
