...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1462");
  ...
  script_name("Huawei EulerOS: Security Advisory for shim (EulerOS-SA-2026-1462)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1462");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1462");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'shim' package(s) announced via the EulerOS-SA-2026-1462 advisory.");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on Huawei EulerOS Virtualization release 2.12.1.");
...
if(release == "EULEROSVIRT-2.12.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.6~7.h16.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-aa64-storage", rpm:"shim-aa64-storage~15.6~7.h16.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }
