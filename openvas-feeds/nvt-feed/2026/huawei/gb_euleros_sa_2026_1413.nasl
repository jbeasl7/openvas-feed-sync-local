...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1413");
  ...
  script_name("Huawei EulerOS: Security Advisory for sssd (EulerOS-SA-2026-1413)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1413");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1413");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sssd' package(s) announced via the EulerOS-SA-2026-1413 advisory.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-sssd", rpm:"python3-sssd~2.6.1~8.h12.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"sssd", rpm:"sssd~2.6.1~8.h12.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
