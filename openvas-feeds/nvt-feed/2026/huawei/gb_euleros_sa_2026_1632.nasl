...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1632");
  ...
  script_name("Huawei EulerOS: Security Advisory for unbound (EulerOS-SA-2026-1632)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1632");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1632");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'unbound' package(s) announced via the EulerOS-SA-2026-1632 advisory.");
  ...
  script_tag(name:"affected", value:"'unbound' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-unbound", rpm:"python3-unbound~1.13.2~8.h9.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound-libs", rpm:"unbound-libs~1.13.2~8.h9.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
