...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2026.1333");
  ...
  script_name("Huawei EulerOS: Security Advisory for gdb (EulerOS-SA-2026-1333)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2026-1333");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2026-1333");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gdb' package(s) announced via the EulerOS-SA-2026-1333 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~9.2~1.h10.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-headless", rpm:"gdb-headless~9.2~1.h10.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-help", rpm:"gdb-help~9.2~1.h10.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
