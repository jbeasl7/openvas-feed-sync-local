...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2026.0018");
  ...
  script_tag(name:"creation_date", value:"2026-01-27 04:25:58 +0000 (Tue, 27 Jan 2026)");
  ...
  script_name("Mageia: Security Advisory (MGASA-2026-0018)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2026-0018");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2026-0018.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=35022");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-linus' package(s) announced via the MGASA-2026-0018 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Vanilla upstream kernel version 6.6.120 fixes bugs and vulnerabilities.
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-linus", rpm:"kernel-linus~6.6.120~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel", rpm:"kernel-linus-devel~6.6.120~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-devel-latest", rpm:"kernel-linus-devel-latest~6.6.120~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-doc", rpm:"kernel-linus-doc~6.6.120~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-latest", rpm:"kernel-linus-latest~6.6.120~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-linus-source", rpm:"kernel-linus-source~6.6.120~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
