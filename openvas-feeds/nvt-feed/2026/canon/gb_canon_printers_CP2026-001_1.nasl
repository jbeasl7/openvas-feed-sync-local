...
if( description )
{
  script_oid("1.3.6.1.4.1.25623.1.0.125674");
  ...
  script_cve_id("CVE-2025-14231", "CVE-2025-14232", "CVE-2025-14233", "CVE-2025-14234",
                "CVE-2025-14235", "CVE-2025-14237");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Canon Printers Multiple Vulnerabilities (CP2026-001)");
  ...
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2025-14231");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2025-14232");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2025-14233");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2025-14234");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2025-14235");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2025-14237");
...
# nb: Added models with and without i-SENSYS as i-SENSYS seems to be only a branding name
cpe_list = make_list("cpe:/o:canon:lbp233dw_firmware",
                     "cpe:/o:canon:lbp236dw_firmware",
                     "cpe:/o:canon:lbp237dw_firmware",
                     "cpe:/o:canon:lbp631cw_firmware",
                     "cpe:/o:canon:lbp632cdw_firmware",
                     "cpe:/o:canon:lbp633cdw_firmware",
                     "cpe:/o:canon:mf451dw_firmware",
                     ...
                     "cpe:/o:canon:i-sensys_lbp237dw_firmware",
                     "cpe:/o:canon:i-sensys_lbp631cw_firmware",
                     "cpe:/o:canon:i-sensys_lbp632cdw_firmware",
