...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.2160419731017");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-216041a3e7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-216041a3e7");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-216041a3e7");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2334010");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openttd' package(s) announced via the FEDORA-2026-216041a3e7 advisory.");
...
- Fix: [Script] Undefined behaviour after calling SwapList during iteration (#14805)");
  ...
  script_tag(name:"affected", value:"'openttd' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openttd", rpm:"openttd~15.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openttd-debuginfo", rpm:"openttd-debuginfo~15.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openttd-debugsource", rpm:"openttd-debugsource~15.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openttd-docs", rpm:"openttd-docs~15.1~1.fc42", rls:"FC42"))) {
    report += res;
  }
