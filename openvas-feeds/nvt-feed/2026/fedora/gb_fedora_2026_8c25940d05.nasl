...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.8992594010005");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-8c25940d05)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-8c25940d05");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-8c25940d05");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpunit12' package(s) announced via the FEDORA-2026-8c25940d05 advisory.");
...
* [#6470]([link moved to references]): Mocking a class with a property hook setter accepting more types than the property results in a fatal error");
  ...
  script_tag(name:"affected", value:"'phpunit12' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phpunit12", rpm:"phpunit12~12.5.8~1.fc42", rls:"FC42"))) {
    report += res;
  }
