...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.9998424102897972");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-cb424f8aa2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-cb424f8aa2");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-cb424f8aa2");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2426618");
  script_xref(name:"URL", value:"https://ipcrypt-std.github.io");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsodium' package(s) announced via the FEDORA-2026-cb424f8aa2 advisory.");
...
fixed
 ...
 - libsodium is now compatible with ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libsodium' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsodium", rpm:"libsodium~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsodium-debuginfo", rpm:"libsodium-debuginfo~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsodium-debugsource", rpm:"libsodium-debugsource~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsodium-devel", rpm:"libsodium-devel~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsodium-static", rpm:"libsodium-static~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-libsodium", rpm:"mingw32-libsodium~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-libsodium-debuginfo", rpm:"mingw32-libsodium-debuginfo~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-libsodium", rpm:"mingw64-libsodium~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-libsodium-debuginfo", rpm:"mingw64-libsodium-debuginfo~1.0.21~2.fc43", rls:"FC43"))) {
    report += res;
  }
