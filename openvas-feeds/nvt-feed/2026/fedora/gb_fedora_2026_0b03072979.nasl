...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.09803072979");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-0b03072979)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-0b03072979");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-0b03072979");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2428108");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'composer' package(s) announced via the FEDORA-2026-0b03072979 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"composer", rpm:"composer~2.9.3~1.fc43", rls:"FC43"))) {
    report += res;
  }
