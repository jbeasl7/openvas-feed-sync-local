...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.00985981023150");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-00b5bf3150)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-00b5bf3150");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-00b5bf3150");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2427483");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2436695");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2436699");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2436709");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2436714");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2436716");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django5' package(s) announced via the FEDORA-2026-00b5bf3150 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-django5", rpm:"python-django5~5.2.11~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-django", rpm:"python3-django~5.2.11~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-django-bash-completion", rpm:"python3-django-bash-completion~5.2.11~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-django-doc", rpm:"python3-django-doc~5.2.11~1.fc42", rls:"FC42"))) {
    report += res;
  }
