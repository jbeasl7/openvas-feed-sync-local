...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.357210271010199");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-3572f7e01c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-3572f7e01c");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-3572f7e01c");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2448281");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-YAML-Syck' package(s) announced via the FEDORA-2026-3572f7e01c advisory.");
  ...
  script_tag(name:"affected", value:"'perl-YAML-Syck' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-YAML-Syck", rpm:"perl-YAML-Syck~1.39~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-YAML-Syck-debuginfo", rpm:"perl-YAML-Syck-debuginfo~1.39~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-YAML-Syck-debugsource", rpm:"perl-YAML-Syck-debugsource~1.39~1.fc43", rls:"FC43"))) {
    report += res;
  }
