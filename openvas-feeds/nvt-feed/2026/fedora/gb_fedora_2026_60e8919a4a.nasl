...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.60101891997497");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-60e8919a4a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-60e8919a4a");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-60e8919a4a");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2431378");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the FEDORA-2026-60e8919a4a advisory.");
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'microcode_ctl' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~71.1.fc43", rls:"FC43"))) {
    report += res;
  }
