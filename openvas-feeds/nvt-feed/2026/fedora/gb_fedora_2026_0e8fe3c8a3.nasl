...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.010181021013998973");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-0e8fe3c8a3)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-0e8fe3c8a3");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-0e8fe3c8a3");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-openexr' package(s) announced via the FEDORA-2026-0e8fe3c8a3 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-openexr", rpm:"mingw-openexr~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-openexr", rpm:"mingw32-openexr~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-openexr-debuginfo", rpm:"mingw32-openexr-debuginfo~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-openexr-tools", rpm:"mingw32-openexr-tools~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-openexr", rpm:"mingw64-openexr~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-openexr-debuginfo", rpm:"mingw64-openexr-debuginfo~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-openexr-tools", rpm:"mingw64-openexr-tools~3.3.6~1.fc42", rls:"FC42"))) {
    report += res;
  }
