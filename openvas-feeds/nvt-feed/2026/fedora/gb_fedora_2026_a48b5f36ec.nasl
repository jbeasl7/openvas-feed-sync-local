...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.97489851023610199");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-a48b5f36ec)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-a48b5f36ec");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-a48b5f36ec");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2026-a48b5f36ec advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~145.0.25^chromium145.0.7632.75~4.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~145.0.25^chromium145.0.7632.75~4.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~145.0.25^chromium145.0.7632.75~4.fc42", rls:"FC42"))) {
    report += res;
  }
