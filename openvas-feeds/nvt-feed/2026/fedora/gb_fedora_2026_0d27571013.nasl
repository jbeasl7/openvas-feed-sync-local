...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.010027571013");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-0d27571013)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-0d27571013");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-0d27571013");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client' package(s) announced via the FEDORA-2026-0d27571013 advisory.");
...
- Fixed two reliability issues: one where a malicious RPKI Certification Authority can trigger a crash, one where malicious Trust Anchor can provoke memory exhaustion.");
  ...
  script_tag(name:"affected", value:"'rpki-client' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~9.7~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpki-client-debuginfo", rpm:"rpki-client-debuginfo~9.7~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpki-client-debugsource", rpm:"rpki-client-debugsource~9.7~1.fc43", rls:"FC43"))) {
    report += res;
  }
