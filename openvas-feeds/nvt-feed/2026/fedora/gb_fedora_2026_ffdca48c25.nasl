...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.1021021009997489925");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-ffdca48c25)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-ffdca48c25");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-ffdca48c25");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2454750");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2026-ffdca48c25 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~146.0.11^chromium146.0.7680.177~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~146.0.11^chromium146.0.7680.177~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~146.0.11^chromium146.0.7680.177~2.fc43", rls:"FC43"))) {
    report += res;
  }
