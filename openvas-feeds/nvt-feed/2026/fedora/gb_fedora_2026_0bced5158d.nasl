...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.098991011005158100");
  script_cve_id("CVE-2026-1861", "CVE-2026-1862", "CVE-2026-2313", "CVE-2026-2314", "CVE-2026-2315", "CVE-2026-2316", "CVE-2026-2317", "CVE-2026-2318", "CVE-2026-2319", "CVE-2026-2320", "CVE-2026-2321", "CVE-2026-2322", "CVE-2026-2323", "CVE-2026-2441");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-0bced5158d)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-0bced5158d");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-0bced5158d");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2026-0bced5158d advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Update to cef-145.0.25 + chromium 145.0.7632.75
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~145.0.25^chromium145.0.7632.75~4.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~145.0.25^chromium145.0.7632.75~4.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~145.0.25^chromium145.0.7632.75~4.fc43", rls:"FC43"))) {
    report += res;
  }
