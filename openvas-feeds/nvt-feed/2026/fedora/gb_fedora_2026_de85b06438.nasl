...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.100101859806438");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-de85b06438)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-de85b06438");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-de85b06438");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc' package(s) announced via the FEDORA-2026-de85b06438 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"New upstream release (#2442363) fixing various security issues");

  script_tag(name:"affected", value:"'opensc' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.27.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-debuginfo", rpm:"opensc-debuginfo~0.27.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-debugsource", rpm:"opensc-debugsource~0.27.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-libs", rpm:"opensc-libs~0.27.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-libs-debuginfo", rpm:"opensc-libs-debuginfo~0.27.1~1.fc42", rls:"FC42"))) {
    report += res;
  }
