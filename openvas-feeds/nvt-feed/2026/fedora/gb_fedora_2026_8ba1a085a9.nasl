...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.89897197085979");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-8ba1a085a9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-8ba1a085a9");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-8ba1a085a9");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail' package(s) announced via the FEDORA-2026-8ba1a085a9 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.6.15~1.fc43", rls:"FC43"))) {
    report += res;
  }
