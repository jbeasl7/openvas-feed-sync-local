...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.97671019897175102");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-a67eba175f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-a67eba175f");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-a67eba175f");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2451647");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2026-a67eba175f advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~146.0.9^chromium146.0.7680.164~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~146.0.9^chromium146.0.7680.164~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~146.0.9^chromium146.0.7680.164~1.fc43", rls:"FC43"))) {
    report += res;
  }
