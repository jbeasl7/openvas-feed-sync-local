...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.9920491027220");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-c2049f7220)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-c2049f7220");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-c2049f7220");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cpp-httplib' package(s) announced via the FEDORA-2026-c2049f7220 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"# Update to 0.37.0 (rhbz#2441656)
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cpp-httplib", rpm:"cpp-httplib~0.37.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cpp-httplib-devel", rpm:"cpp-httplib-devel~0.37.1~2.fc43", rls:"FC43"))) {
    report += res;
  }
