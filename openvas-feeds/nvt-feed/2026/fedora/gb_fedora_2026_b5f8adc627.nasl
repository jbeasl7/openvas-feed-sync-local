...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.98510289710099627");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-b5f8adc627)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-b5f8adc627");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-b5f8adc627");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2437035");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cef' package(s) announced via the FEDORA-2026-b5f8adc627 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cef", rpm:"cef~145.0.28^chromium145.0.7632.159~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-debuginfo", rpm:"cef-debuginfo~145.0.28^chromium145.0.7632.159~1.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cef-devel", rpm:"cef-devel~145.0.28^chromium145.0.7632.159~1.fc43", rls:"FC43"))) {
    report += res;
  }
