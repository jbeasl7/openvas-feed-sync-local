...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.89710201017101973101");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-8af0e7ea3e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-8af0e7ea3e");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-8af0e7ea3e");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'insight' package(s) announced via the FEDORA-2026-8af0e7ea3e advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"insight", rpm:"insight~18.0.50.20260306~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"insight-debuginfo", rpm:"insight-debuginfo~18.0.50.20260306~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"insight-debugsource", rpm:"insight-debugsource~18.0.50.20260306~1.fc42", rls:"FC42"))) {
    report += res;
  }
