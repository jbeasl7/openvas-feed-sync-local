...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.89999102101509958");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-8ccfe50c58)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-8ccfe50c58");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-8ccfe50c58");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpunit11' package(s) announced via the FEDORA-2026-8ccfe50c58 advisory.");
...
* [#6470]([link moved to references]): Mocking a class with a property hook setter accepting more types than the property results in a fatal error");
  ...
  script_tag(name:"affected", value:"'phpunit11' package(s) on Fedora 43.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phpunit11", rpm:"phpunit11~11.5.50~1.fc43", rls:"FC43"))) {
    report += res;
  }
