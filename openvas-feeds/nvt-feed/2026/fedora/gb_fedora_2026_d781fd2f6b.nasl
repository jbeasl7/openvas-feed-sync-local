...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.1007811021002102698");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-d781fd2f6b)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-d781fd2f6b");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-d781fd2f6b");
  script_xref(name:"URL", value:"https://github.com/zumba/json-serializer/security/advisories/GHSA-v7m3-fpcr-h7m2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-zumba-json-serializer' package(s) announced via the FEDORA-2026-d781fd2f6b advisory.");
...
[Security Advisory GHSA-v7m3-fpcr-h7m2]([link moved to references])");
  ...
  script_tag(name:"affected", value:"'php-zumba-json-serializer' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-zumba-json-serializer", rpm:"php-zumba-json-serializer~3.2.4~1.fc42", rls:"FC42"))) {
    report += res;
  }
