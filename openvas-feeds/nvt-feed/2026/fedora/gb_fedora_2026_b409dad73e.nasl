...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.984091009710073101");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-b409dad73e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-b409dad73e");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-b409dad73e");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorgxrdp, xrdp' package(s) announced via the FEDORA-2026-b409dad73e advisory.");
...
- CI: Update FreeBSD xrdp dependency (#398)");
  ...
  script_tag(name:"affected", value:"'xorgxrdp, xrdp' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorgxrdp", rpm:"xorgxrdp~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorgxrdp-debuginfo", rpm:"xorgxrdp-debuginfo~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorgxrdp-debugsource", rpm:"xorgxrdp-debugsource~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorgxrdp-glamor", rpm:"xorgxrdp-glamor~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorgxrdp-glamor-debuginfo", rpm:"xorgxrdp-glamor-debuginfo~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp", rpm:"xrdp~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-debuginfo", rpm:"xrdp-debuginfo~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-debugsource", rpm:"xrdp-debugsource~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-devel", rpm:"xrdp-devel~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-selinux", rpm:"xrdp-selinux~0.10.5~1.fc42", rls:"FC42"))) {
    report += res;
  }
