...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.917410161019737");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-9174e6ea37)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-9174e6ea37");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-9174e6ea37");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-binutils' package(s) announced via the FEDORA-2026-9174e6ea37 advisory.");
...
if(release == "FC43") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-binutils", rpm:"mingw-binutils~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw-binutils-debuginfo", rpm:"mingw-binutils-debuginfo~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw-binutils-debugsource", rpm:"mingw-binutils-debugsource~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw-binutils-generic", rpm:"mingw-binutils-generic~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw-binutils-generic-debuginfo", rpm:"mingw-binutils-generic-debuginfo~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-binutils", rpm:"mingw32-binutils~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-binutils-debuginfo", rpm:"mingw32-binutils-debuginfo~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-binutils", rpm:"mingw64-binutils~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-binutils-debuginfo", rpm:"mingw64-binutils-debuginfo~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucrt64-binutils", rpm:"ucrt64-binutils~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucrt64-binutils-debuginfo", rpm:"ucrt64-binutils-debuginfo~2.45.1~2.fc43", rls:"FC43"))) {
    report += res;
  }
