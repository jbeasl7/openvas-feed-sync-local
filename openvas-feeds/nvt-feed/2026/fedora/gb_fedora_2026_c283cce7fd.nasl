...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.9928399991017102100");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-c283cce7fd)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-c283cce7fd");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-c283cce7fd");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail' package(s) announced via the FEDORA-2026-c283cce7fd advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.6.14~1.fc42", rls:"FC42"))) {
    report += res;
  }
