...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2026.1101497526997");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2026-1e497526c7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2026-1e497526c7");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2026-1e497526c7");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2442507");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmaxminddb' package(s) announced via the FEDORA-2026-1e497526c7 advisory.");
...
- Fixed an off-by-one error in `MMDB_read_node()` that allowed reading one node
 ...
 This ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libmaxminddb' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmaxminddb", rpm:"libmaxminddb~1.13.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmaxminddb-debuginfo", rpm:"libmaxminddb-debuginfo~1.13.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmaxminddb-debugsource", rpm:"libmaxminddb-debugsource~1.13.1~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmaxminddb-devel", rpm:"libmaxminddb-devel~1.13.1~1.fc42", rls:"FC42"))) {
    report += res;
  }
