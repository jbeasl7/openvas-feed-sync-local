...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.171567");
  script_version("2025-07-03T05:42:54+0000");
  script_tag(name:"last_modification", value:"2025-07-03 05:42:54 +0000 (Thu, 03 Jul 2025)");
  script_tag(name:"creation_date", value:"2025-07-02 07:44:20 +0000 (Wed, 02 Jul 2025)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");

  script_tag(name:"qod_type", value:"remote_banner");

  script_name("ClamAV Detection Consolidation");

  script_category(ACT_GATHER_INFO);
  script_family("Product detection");
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_dependencies("gb_clamav_ssh_login_detect.nasl", "gb_clamav_smb_login_detect.nasl",
                      "gb_clamav_remote_detect.nasl");
  script_mandatory_keys("clamav/detected");

  script_tag(name:"summary", value:"Consolidation of ClamAV detections.");

  script_xref(name:"URL", value:"https://docs.clamav.net/");
...
if (!get_kb_item("clamav/detected"))
  exit(0);

report = ""; # nb: To make openvas-nasl-lint happy...

foreach source(make_list("ssh-login", "smb-login", "clamd")) {

  install_list = get_kb_list("clamav/" + source + "/*/installs");
  if (!install_list)
    continue;
  ...
  foreach install(install_list) {
    ...
    if (report)
      report += '\n\n';
    report += build_detection_report(app: "ClamAV",
                                     version: version,
                                     install:install,
                                     cpe: cpe,
