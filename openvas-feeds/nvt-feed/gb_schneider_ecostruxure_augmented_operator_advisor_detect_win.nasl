...
if(description)
{
  ...
  script_name("Schneider Electric EcoStruxure Augmented Operator Advisor Detection (Windows SMB Login)");
  ...
  script_tag(name:"summary", value:"SMB login-based detection of Schneider Electric EcoStruxure
  Augmented Operator Advisor.");

  script_xref(name:"URL", value:"https://www.se.com/us/en/product-range/64507-ecostruxure-augmented-operator-advisor/");
