...
if(description)
{
  ...
  script_name("NetWitness Platform Detection");
  ...
  script_tag(name:"summary", value:"HTTP based detection of NetWitness Platform.");

  script_xref(name:"URL", value:"https://www.netwitness.com/");
...
if ('meta name="sa/config/environment"' >< res && "rsa-loader__wheel" >< res) {
  ...
  set_kb_item(name: "rsa/netwitness/detected", value: TRUE);
  set_kb_item(name: "rsa/netwitness/http/detected", value: TRUE);
  ...
  log_message(data: build_detection_report(app: "RSA NetWitness Platform", version: version, install: location,
