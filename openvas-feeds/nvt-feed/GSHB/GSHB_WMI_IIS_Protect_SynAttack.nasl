...
if(description)
{
  ...
  script_name("Tests if all Registry entries set to prevent SYN-Attacks at an IIS Server - Windows");
  ...
  script_tag(name:"summary", value:"Tests if all Registry entries set to prevent SYN-Attacks at an
  IIS Server.");
