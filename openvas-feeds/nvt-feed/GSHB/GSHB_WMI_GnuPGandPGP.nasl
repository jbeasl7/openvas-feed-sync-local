...
if(description)
{
  ...
  script_name("Get GnuPG and PGP Version and User they have a pubring - Windows");
  ...
  script_tag(name:"summary", value:"Get GnuPG and PGP Version and User they have a pubring.");
