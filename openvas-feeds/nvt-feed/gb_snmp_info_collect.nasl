...
if( defined_func( "snmpv3_get" ) ) {
  ...
  res = chomp( res );
  if( res ) {
    extra += '\n  System Location (OID: ' + oid + ") :                   " + res;
    set_kb_item( name:"SNMP/" + port + "/syslocation", value:res );
    set_kb_item( name:"SNMP/" + port + "/syslocation/oid", value:oid );
    set_kb_item( name:"SNMP/syslocation/available", value:TRUE );
  }
