...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) < 3.1 Information Disclosure Vulnerability (Feb 2015)");
  ...
  script_tag(name:"affected", value:"Synology DSM prior to version 3.1.");
