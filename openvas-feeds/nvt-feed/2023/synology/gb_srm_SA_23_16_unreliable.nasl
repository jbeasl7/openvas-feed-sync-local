...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2024-06-28 07:15:06 +0000 (Fri, 28 Jun 2024)");
  ...
  script_name("Synology Router Manager (SRM) 1.2.x < 1.2.5-8227-11, 1.3.x < 1.3.1-9346-8 Multiple Vulnerabilities (Synology-SA-23:16) - Unreliable Remote Version Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.114442
