...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-05-27 01:49:00 +0000 (Sat, 27 May 2023)");
  ...
  remote authenticated users to inject HTML via the user email field, triggered on the User CP Home
  page.");
