...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-01-10 03:23:00 +0000 (Tue, 10 Jan 2023)");
  ...
  script_tag(name:"insight", value:"A directory traversal vulnerability in the Admin CP's
  Languages module allows remote authenticated users to include and execute arbitrary local files
  (LFI).");
