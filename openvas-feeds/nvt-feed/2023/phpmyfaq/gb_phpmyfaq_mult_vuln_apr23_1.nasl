...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-12 00:38:00 +0000 (Wed, 12 Apr 2023)");
  ...
  - CVE-2023-1760: In the admin account, there is a feature to add a user. In this feature, an XSS
  was found in the `Your Name` form.
