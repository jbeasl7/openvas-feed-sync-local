...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-11 13:55:00 +0000 (Tue, 11 Apr 2023)");
  ...
  script_dependencies("gb_checkmk_server_http_detect.nasl", "os_detection.nasl");
  script_mandatory_keys("checkmk/detected", "Host/runs_unixoide");
