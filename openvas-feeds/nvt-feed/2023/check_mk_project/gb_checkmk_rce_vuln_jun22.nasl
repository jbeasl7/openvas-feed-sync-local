...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-05-04 18:32:00 +0000 (Thu, 04 May 2023)");
  ...
  script_tag(name:"affected", value:"Checkmk versions prior to 2.0.0p28, 2.1.x prior to 2.1.0p7 and
  2.2.x prior to 2.2.0b1.");
