...
if (description)
{
  ...
  script_tag(name:"insight", value:"A lack of length validation allows an authenticated attacker
  to create a large Issue description via GraphQL which, when repeatedly requested, saturates CPU
  usage.");

  script_tag(name:"affected", value:"GitLab versions 12.4.x prior to 15.6.7, 15.7.x prior to
  15.7.6 and 15.8.x prior to 15.8.1.");
