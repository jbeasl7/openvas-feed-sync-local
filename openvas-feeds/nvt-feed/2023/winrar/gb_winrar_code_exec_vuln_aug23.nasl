...
if(description)
{
  ...
  script_version("2025-01-03T15:39:41+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2023-38831", "CVE-2023-40477");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2025-01-03 15:39:41 +0000 (Fri, 03 Jan 2025)");
  ...
  script_tag(name:"summary", value:"WinRAR is prone to multiple code execution
  vulnerabilities.");
  ...
  - CVE-2023-38831: An error in the processing of ZIP format.

  - CVE-2023-40477: An improper validation of array index.");
