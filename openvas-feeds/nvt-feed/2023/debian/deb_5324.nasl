...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5324-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5324-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5324");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/linux");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux' package(s) announced via the DSA-5324-1 advisory.");
