...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3505-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3505-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3505-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gst-plugins-good1.0");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-good1.0' package(s) announced via the DLA-3505-1 advisory.");
