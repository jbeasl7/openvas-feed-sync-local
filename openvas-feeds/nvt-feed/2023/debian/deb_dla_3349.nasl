...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-02-06 21:48:48 +0000 (Mon, 06 Feb 2023)");

  script_name("Debian: Security Advisory (DLA-3349-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3349-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3349-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/linux-5.10");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux-5.10' package(s) announced via the DLA-3349-1 advisory.");
