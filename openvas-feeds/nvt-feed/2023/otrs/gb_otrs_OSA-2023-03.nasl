...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-05-16 14:13:00 +0000 (Tue, 16 May 2023)");
  ...
  script_tag(name:"summary", value:"OTRS is prone to a information disclosure and denial of
  service (DoS) vulnerability via websocket push events.");
