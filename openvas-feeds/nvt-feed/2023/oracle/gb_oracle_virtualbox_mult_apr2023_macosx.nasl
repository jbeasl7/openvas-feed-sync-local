...
if(description)
{
  ...
  script_name("Oracle VirtualBox Security Update (Apr 2023) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions 6.1.x prior to 6.1.44,
  7.0.x prior to 7.0.8 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 6.1.44
  or 7.0.8 or later.");
