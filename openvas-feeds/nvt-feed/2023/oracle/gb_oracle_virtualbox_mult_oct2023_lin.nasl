...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-11-01 22:15:00 +0000 (Wed, 01 Nov 2023)");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions 7.0.x prior to 7.0.12
  on Linux.");
