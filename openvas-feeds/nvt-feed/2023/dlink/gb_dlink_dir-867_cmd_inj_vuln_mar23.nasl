...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-17 04:02:00 +0000 (Fri, 17 Mar 2023)");
  ...
  script_tag(name:"insight", value:"A command injection vulnerability in the component
  LocalIPAddress allows attackers to escalate privileges to root via a crafted payload.");
