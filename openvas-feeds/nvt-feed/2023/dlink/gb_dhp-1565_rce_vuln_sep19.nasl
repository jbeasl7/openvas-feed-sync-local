...
CPE = "cpe:/o:dlink:dhp-1565_firmware";

if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170780");
  ...
  script_name("D-Link DHP-1565 Devices RCE Vulnerability (Sep 2019)");

  script_category(ACT_GATHER_INFO);

  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Web application abuses");
  script_dependencies("gb_dlink_dhp_consolidation.nasl");
  script_mandatory_keys("d-link/dhp/detected");

  script_tag(name:"summary", value:"D-Link DHP-1565 devices are prone to a remote command execution
  (RCE) vulnerability.");
  ...
  script_tag(name:"affected", value:"D-Link DHP-1565 devices in all versions.");
