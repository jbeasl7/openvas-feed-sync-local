...
if(description)
{
  ...
  script_name(".NET Core SDK Remote Code Execution Vulnerability (Apr 2023)");

  script_tag(name:"summary", value:"ASP.NET Core SDK is prone to a remote code execution (RCE)
  vulnerability.");
