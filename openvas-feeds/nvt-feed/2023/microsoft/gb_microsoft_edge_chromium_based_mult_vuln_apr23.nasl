...
if(description)
{
  ...
  script_name("Microsoft Edge (Chromium-Based) Multiple Vulnerabilities (Apr 2023)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to version 112.0.1722.34.");
...
if(version_is_less(version:vers, test_version:"112.0.1722.34")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"112.0.1722.34", install_path:path);
