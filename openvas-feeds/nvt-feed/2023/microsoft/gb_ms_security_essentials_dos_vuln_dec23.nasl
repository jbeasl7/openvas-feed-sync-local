...
if(description)
{
  ...
  script_tag(name:"affected", value:"Microsoft Security Essentials prior to Engine version
  1.1.23110.2.");
  ...
  script_xref(name:"URL", value:"https://learn.microsoft.com/en-us/defender-endpoint/msda-updates-previous-versions-technical-upgrade-support");
...
if(version_is_less(version:mpe_version, test_version:"1.1.23110.2")) {
  report = report_fixed_ver(installed_version:mpe_version, fixed_version: "1.1.23110.2 or higher");
