...
if(description)
{
  ...
  # nb: Only vulnerable if using custom integrations, which we do not detect
  ...
  script_tag(name:"summary", value:"Home Assistant instances using custom integrations are prone to
