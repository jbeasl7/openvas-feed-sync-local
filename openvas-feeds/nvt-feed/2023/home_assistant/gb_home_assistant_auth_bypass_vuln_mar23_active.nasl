...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-15 14:20:00 +0000 (Wed, 15 Mar 2023)");
  ...
  script_tag(name:"summary", value:"Home Assistant is prone to an authentication bypass
  vulnerability.");

  script_tag(name:"vuldetect", value:"Sends a crafted HTTP GET request and checks the response.");

  script_tag(name:"affected", value:"- Home Assistant Core prior to version 2023.3.2

  - Home Assistant Supervisor prior to version 2023.03.3");

  script_tag(name:"solution", value:"- Home Assistant Core: Update to version 2023.3.2 or later

  - Home Assistant Supervisor: Update to version 2023.03.3 or later");
