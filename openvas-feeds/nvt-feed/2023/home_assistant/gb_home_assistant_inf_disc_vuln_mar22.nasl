...
if(description)
{
  ...
  # nb: Current detection does not distinguish between Supervised and other installation types
  ...
  script_tag(name:"insight", value:"An information leak allows a DNS operator to gain knowledge
  about internal network resources via the hardcoded DNS resolver configuration.");
