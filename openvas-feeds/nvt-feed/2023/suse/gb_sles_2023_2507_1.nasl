...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232507-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029874.html");
...
- KVM: x86: Update the exit_qualification ... [Please see the references for more information on the vulnerabilities]");
