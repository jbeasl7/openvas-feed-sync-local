...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230426-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208027");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208028");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013771.html");
 ...
 - CVE-2023-23946: Fixed issue where a path outside the working tree can be overwritten as the user who is running 'git apply' (bsc#1208028).");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
