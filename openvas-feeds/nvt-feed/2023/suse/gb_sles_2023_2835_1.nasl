...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232835-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201164");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-July/015500.html");
...
- CVE-2022-32084: Fixed segmentation fault via the component sub_select (bsc#1201164).");
  ...
  script_tag(name:"affected", value:"'mariadb' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
