...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234902-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214788");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217950");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-December/017494.html");
...
- Fix the 'no route to host' error when connecting via ProxyJump");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
