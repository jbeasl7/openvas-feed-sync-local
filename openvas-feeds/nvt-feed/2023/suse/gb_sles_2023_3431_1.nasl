...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233431-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214025");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-August/016020.html");
...
- CVE-2023-4156: Fix a heap out of bound read by validating the index into argument list. (bsc#1214025)");
  ...
  script_tag(name:"affected", value:"'gawk' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
