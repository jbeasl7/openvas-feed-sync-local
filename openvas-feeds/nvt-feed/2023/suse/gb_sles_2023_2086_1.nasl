...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232086-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185232");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185261");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185441");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185621");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187071");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187260");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193282");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193315");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198101");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198458");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201066");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202120");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205588");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014771.html");
...
- mok: relax the maximum ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
