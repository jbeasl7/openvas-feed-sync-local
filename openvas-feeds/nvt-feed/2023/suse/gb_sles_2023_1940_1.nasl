...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231940-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174246");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196741");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/028931.html");
...
- CVE-2021-38578: Fixed underflow in MdeModulePkg/PiSmmCore SmmEntryPointAdd (bsc#1196741).");
  ...
  script_tag(name:"affected", value:"'ovmf' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
