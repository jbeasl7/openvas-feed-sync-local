...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233866-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193948");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210994");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212794");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212844");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212855");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213257");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213441");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213630");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213960");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214796");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214797");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215489");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031791.html");
...
- Revert usage of long running REQ channel to prevent possible missing responses on requests and duplicated responses
 (bsc#1213960, bsc#1213630, bsc#1213257)");
  ...
  script_tag(name:"affected", value:"'salt' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
