...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231944-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208745");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014542.html");
...
- CVE-2023-27371: Fixed parser bug that could be used to crash servers using the MHD_PostProcessor (bsc#1208745).");
  ...
  script_tag(name:"affected", value:"'libmicrohttpd' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
