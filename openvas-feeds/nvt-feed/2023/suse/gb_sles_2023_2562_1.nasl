...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232562-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210398");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029972.html");
...
- CVE-2023-27349: Fixed crash while handling unsupported events (bsc#1210398).");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
