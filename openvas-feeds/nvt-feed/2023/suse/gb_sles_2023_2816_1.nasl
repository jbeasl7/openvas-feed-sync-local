...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-06-03 03:58:52 +0000 (Sat, 03 Jun 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232816-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189408");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211798");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-July/015475.html");
 ...
 - CVE-2023-32763: Fixed buffer overflow in QTextLayout (bsc#1211798).");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
