...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233091-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176689");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213068");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/030676.html");
 ...
 - CVE-2020-25559: Fixed double free when executing print_set_output (bsc#1176689).");
  ...
  script_tag(name:"affected", value:"'gnuplot' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
