...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233640-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214052");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031503.html");
...
- CVE-2023-4039: Fixed incorrect stack protector for C99 VLAs on Aarch64 (bsc#1214052).");
  ...
  script_tag(name:"affected", value:"'gcc12' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
