...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230210-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204526");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204527");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-January/013593.html");
...
- CVE-2022-41742: Handle duplicated atoms in mp4 streams, to mitigate out-of-bound reads. (bsc#1204527)");
  ...
  script_tag(name:"affected", value:"'nginx' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
