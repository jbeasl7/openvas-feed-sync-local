...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-03 16:59:11 +0000 (Mon, 03 Apr 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231812-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197093");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208364");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208510");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209495");
  script_xref(name:"URL", value:"https://github.com/containers/image/pull/1299");
  script_xref(name:"URL", value:"https://github.com/containers/storage/pull/1436");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014441.html");
 ...
 * oci: bind mount /sys with --userns=(auto<pipe>pod:)
 ...
 * quadlet: Add device support for ... [Please see the references for more information on the vulnerabilities]");
