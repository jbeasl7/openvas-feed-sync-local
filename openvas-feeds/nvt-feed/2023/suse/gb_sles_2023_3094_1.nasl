...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233094-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211674");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/030673.html");
...
- CVE-2023-32681: fixed unintended leak of Proxy-Authorization header (bsc#1211674).");
  ...
  script_tag(name:"affected", value:"'python-requests' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
