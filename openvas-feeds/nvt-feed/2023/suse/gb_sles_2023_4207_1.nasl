...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234207-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216190");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216205");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216272");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216273");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-October/032392.html");
...
- CVE-2023-39333: Fixed a code injection via WebAssembly export names. (bsc#1216273)");
  ...
  script_tag(name:"affected", value:"'nodejs18' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
