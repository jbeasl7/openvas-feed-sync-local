...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233662-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1071995");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1084842");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1114592");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1124644");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128794");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1129389");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1131264");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1141897");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142649");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146475");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1148517");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149145");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150164");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160086");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181618");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195517");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196861");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204505");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205145");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214052");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/018047.html");
...
- Fixed to no longer try linking -lieee with -mieee-fp. (bsc#1084842)");
  ...
  script_tag(name:"affected", value:"'gcc7' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
