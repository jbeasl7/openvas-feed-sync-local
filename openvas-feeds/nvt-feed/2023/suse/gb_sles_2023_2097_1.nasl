...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-12-22 03:08:08 +0000 (Wed, 22 Dec 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232097-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193795");
  ...
  script_tag(name:"insight", value:"+ CVE-2021-42550: Update Version of (optional) Logback (bsc#1193795)
 * Bug fixes:
...
- Remove RPM package build dependency on easymock (jsc#SLE-23217)");
  ...
  script_tag(name:"affected", value:"'maven and recommended update for antlr3, minlog, sbt, xmvn' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
