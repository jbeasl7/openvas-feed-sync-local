...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230014-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205385");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205386");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205946");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206504");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-January/013414.html");
...
- Fixed issue with bind start up (bsc#1205946).");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
