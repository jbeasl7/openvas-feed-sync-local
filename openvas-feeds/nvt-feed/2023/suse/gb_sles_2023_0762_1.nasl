...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230762-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-March/014066.html");
...
- scsi: qla2xxx: Add option to disable FC2 Target ... [Please see the references for more information on the vulnerabilities]");
