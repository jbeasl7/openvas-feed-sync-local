...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234216-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216378");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016851.html");
...
- CVE-2023-45853: Fixed an integer overflow that would lead to a
 buffer overflow in the minizip subcomponent (bsc#1216378).");
  ...
  script_tag(name:"affected", value:"'zlib' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
