...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234672-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216410");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217215");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-December/033022.html");
...
# rpm --import /usr/lib/rpm/gnupg/keys/gpg-pubkey-d588dc46-63c939db.asc");
  ...
  script_tag(name:"affected", value:"'suse-build-key' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
