...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234622-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196654");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211298");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211798");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211994");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213326");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214327");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-November/017266.html");
...
- CVE-2023-38197: Fix infinite loops in QXmlStreamReader (bsc#1213326).");
  ...
  script_tag(name:"affected", value:"'libqt4' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
