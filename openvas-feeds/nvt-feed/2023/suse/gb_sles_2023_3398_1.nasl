...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233398-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214054");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/031149.html");
...
- CVE-2023-36054: Fixed a DoS that could be triggered by an authenticated remote user. (bsc#1214054)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
