...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234527-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162112");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216529");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-November/017163.html");
...
- Upgraded maven-resolver to version 1.9.15.");
  ...
  script_tag(name:"affected", value:"'maven, maven-resolver, sbt, xmvn' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
