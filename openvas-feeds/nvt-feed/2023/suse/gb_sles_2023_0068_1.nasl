...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-08 04:23:51 +0000 (Tue, 08 Nov 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230068-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198059");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205148");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205150");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-January/013454.html");
...
- Fixed a potential invalid free of memory, and hardened string handling
 against concurrency issues (bsc#1198059).");
  ...
  script_tag(name:"affected", value:"'net-snmp' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
