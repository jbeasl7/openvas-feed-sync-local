...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234346-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-November/032580.html");
...
- sched/rt: Restore rt_runtime after disabling ... [Please see the references for more information on the vulnerabilities]");
