...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233794-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215231");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-September/016334.html");
 ...
 - CVE-2023-4863: Fixed a heap buffer overflow (bsc#1215231).");
  ...
  script_tag(name:"affected", value:"'libwebp' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
