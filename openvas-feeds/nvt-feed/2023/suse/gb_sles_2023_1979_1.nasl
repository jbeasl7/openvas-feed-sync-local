...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231979-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210323");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/028973.html");
...
- CVE-2022-48468: Fixed an unsigned integer overflow. (bsc#1210323)");
  ...
  script_tag(name:"affected", value:"'protobuf-c' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
