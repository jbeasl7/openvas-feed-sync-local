...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230736-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188607");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208443");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208471");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-March/014036.html");
...
- Fixed email.generator.py to not replace a non-existent header (bsc#1208443, gh#python/cpython#71508).");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
