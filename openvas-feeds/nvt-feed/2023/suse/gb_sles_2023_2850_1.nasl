...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232850-1.html");
  script_xref(name:"URL", value:"https://blog.mozilla.org/accessibility/firefox-113-accessibility-performance/");
  script_xref(name:"URL", value:"https://blog.mozilla.org/addons/2022/05/18/manifest-v3-in-firefox-recap-next-steps/");
  script_xref(name:"URL", value:"https://blog.mozilla.org/addons/2022/11/17/manifest-v3-signing-available-november-21-on-firefox-nightly/");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212101");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212438");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-July/015501.html");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/access-toolbar-functions-");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/how-generate-secure-password-firefox");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/how-set-tab-pickup-firefox-view");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/identify-problems-third-party-modules-firefox-windows");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/import-data-another-browser");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/task-manager-tabs-or-extensions-are-slowing-firefox");
  script_xref(name:"URL", value:"https://support.mozilla.org/kb/unified-extensions");
...
* New:
 ...
 devices (via ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'MozillaFirefox, MozillaFirefox-branding-SLE' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
