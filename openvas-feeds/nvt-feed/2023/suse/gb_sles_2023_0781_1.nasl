...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230781-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207780");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208828");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208957");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208959");
  script_xref(name:"URL", value:"https://github.com/vim/vim/compare/v9.0.1234...v9.0.1386");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-March/014074.html");
