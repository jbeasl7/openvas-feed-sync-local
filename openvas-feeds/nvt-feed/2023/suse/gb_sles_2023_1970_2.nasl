...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231970-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1094832");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146299");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184123");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/974847");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014565.html");
 ...
 * Fix SF bug #87: ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'giflib' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
