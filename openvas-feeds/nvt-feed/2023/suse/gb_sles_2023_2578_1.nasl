...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232578-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201535");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201539");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203185");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203596");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203597");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203599");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204501");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207830");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208719");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209645");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210458");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210640");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210907");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029951.html");
  ...
  script_tag(name:"insight", value:"- CVE-2023-1410: grafana: Stored XSS in Graphite FunctionDescription tooltip (bsc#1209645)
 ...
 * Important changes:
 ...
 caused testing ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'SUSE Manager Client Tools' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
