...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233634-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215231");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031493.html");
...
- CVE-2023-4863: Fixed heap buffer overflow (bsc#1215231).");
  ...
  script_tag(name:"affected", value:"'libwebp' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
