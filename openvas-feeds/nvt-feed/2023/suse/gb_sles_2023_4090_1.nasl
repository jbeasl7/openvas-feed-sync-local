...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234090-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215728");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-October/032175.html");
...
- CVE-2023-43641: Fixed a buffer overflow while parsing a malicious
 file (bsc#1215728).");
  ...
  script_tag(name:"affected", value:"'libcue' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
