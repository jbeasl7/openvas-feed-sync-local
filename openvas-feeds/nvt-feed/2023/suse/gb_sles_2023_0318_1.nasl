...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230318-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207378");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013708.html");
...
- CVE-2022-48279: Fixed a potential firewall bypass due to an
 incorrect parsing of HTTP multipart requests (bsc#1207378).");
  ...
  script_tag(name:"affected", value:"'apache2-mod_security2' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
