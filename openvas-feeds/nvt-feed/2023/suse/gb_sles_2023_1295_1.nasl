...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-20 20:06:51 +0000 (Tue, 20 Dec 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231295-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206337");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/030149.html");
...
- CVE-2022-46908: Properly implement the azProhibitedFunctions protection mechanism,
 when relying on --safe for execution of an untrusted CLI script (bsc#1206337).");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
