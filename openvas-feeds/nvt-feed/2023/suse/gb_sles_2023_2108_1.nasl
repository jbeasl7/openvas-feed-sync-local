...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232108-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209934");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014740.html");
...
- CVE-2022-48434: Fixed use after free in libavcodec/pthread_frame.c (bsc#1209934).");
  ...
  script_tag(name:"affected", value:"'ffmpeg' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
