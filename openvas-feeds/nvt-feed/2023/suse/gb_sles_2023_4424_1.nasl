...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234424-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1133284");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160294");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189936");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190531");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935380");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-November/017023.html");
...
- CVE-2021-41072: Fixed an issue where an attacker might have been
 ...
 symlink (bsc#1190531).");
  ...
  script_tag(name:"affected", value:"'squashfs' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
