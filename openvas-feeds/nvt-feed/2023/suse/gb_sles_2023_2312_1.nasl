...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232312-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183043");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193742");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198423");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198424");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198427");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199413");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200134");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200135");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200136");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200137");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201434");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201436");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201437");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201440");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201443");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201444");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201445");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201447");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201448");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202035");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203185");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204023");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204024");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204025");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204941");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206134");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206135");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208270");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208271");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208272");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208491");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/015005.html");
 ...
 * go#56711 net: re-enable ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'go1.18-openssl' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
