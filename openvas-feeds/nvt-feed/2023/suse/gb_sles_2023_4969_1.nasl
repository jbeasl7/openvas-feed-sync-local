...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234969-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198146");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-December/017556.html");
...
- CVE-2022-1210: Fixed denial of service in TIFF File Handler (bsc#1198146).");
  ...
  script_tag(name:"affected", value:"'jbigkit' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
