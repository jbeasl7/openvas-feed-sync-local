...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234210-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215415");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215416");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215417");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216162");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216169");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-October/032390.html");
...
- Updated to version 9.4.53.v20231009:
 ...
 be allowed to perform a single request (bsc#1215416).");
  ...
  script_tag(name:"affected", value:"'jetty-minimal' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
