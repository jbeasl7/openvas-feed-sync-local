...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233934-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213748");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215472");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-October/031872.html");
  ...
  script_tag(name:"insight", value:"- CVE-2023-3341: Fixed stack exhaustion flaw in control channel code may cause named to terminate unexpectedly (bsc#1215472).
