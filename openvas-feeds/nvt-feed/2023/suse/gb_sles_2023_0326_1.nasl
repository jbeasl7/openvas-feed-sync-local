...
if(description)
{
  ...
  script_cve_id("CVE-2021-20199", "CVE-2021-20206", "CVE-2021-4024", "CVE-2021-41190", "CVE-2022-27649", "CVE-2022-2989");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230326-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181640");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181961");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193166");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193273");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197672");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199790");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202809");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013710.html");
