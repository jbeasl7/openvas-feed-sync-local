...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233801-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185448");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213128");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213131");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-September/016338.html");
...
- CVE-2021-3522: Fixed frame size check and potential invalid reads (bsc#1185448).");
  ...
  script_tag(name:"affected", value:"'gstreamer-plugins-base' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
