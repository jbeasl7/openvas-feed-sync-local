...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232783-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1099269");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1133277");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1144068");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162343");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177127");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178168");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182066");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184753");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194530");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197726");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198331");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199282");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203681");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204256");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-July/015451.html");
...
- Include in SLE-15 (bsc#1199282, jsc#PM-3243, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'grpc, protobuf, python-Deprecated, python-PyGithub, python-aiocontextvars, python-avro, python-bcrypt, python-cryptography, python-cryptography-vectors, python-google-api-core, python-googleapis-common-protos, python-grpcio-gcp, python-humanfriendly, python-jsondiff, python-knack, python-opencensus, python-opencensus-context, python-opencensus-ext-threading, python-opentelemetry-api, python-psutil, python-pytest-asyncio, python-requests, python-websocket-client, python-websockets' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
