...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220944-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1022528");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188572");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189528");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-January/013608.html");
...
- Updated references for CVE-2017-5601, which was already fixed in a previous
 version (bsc#1022528 bsc#1189528).");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
