...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233144-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208612");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211741");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212279");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-August/015736.html");
  ...
  script_tag(name:"insight", value:"* CVE-2023-28370: Fixed an open redirect issue in the static file handler (bsc#1211741)
