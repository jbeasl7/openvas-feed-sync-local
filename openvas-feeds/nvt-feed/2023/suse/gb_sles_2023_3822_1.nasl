...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233822-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031743.html");
...
- Changes to getappcore version 1.53.02
 ...
 change (bsc#1205533, bsc#1204942)");
  ...
  script_tag(name:"affected", value:"'supportutils' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
