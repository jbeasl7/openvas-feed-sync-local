...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234330-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213451");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-November/016968.html");
...
- CVE-2022-33065: Fixed an integer overflow that could cause memory
 safety issues when reading a MAT4 file (bsc#1213451).");
  ...
  script_tag(name:"affected", value:"'libsndfile' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
