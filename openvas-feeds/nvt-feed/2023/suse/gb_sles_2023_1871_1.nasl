...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231871-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208744");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014476.html");
...
- CVE-2022-25881: Fixed regular expression denial of service vulnerability (bsc#1208744).");
  ...
  script_tag(name:"affected", value:"'nodejs10' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
