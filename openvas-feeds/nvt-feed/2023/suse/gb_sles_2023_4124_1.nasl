...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-02-24 16:56:30 +0000 (Fri, 24 Feb 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234124-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183043");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215588");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215711");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016751.html");
 ...
 * bugfix:(#11391) helm lint infinite loop ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'helm' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
