...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233962-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215686");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215687");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-October/031905.html");
...
- CVE-2023-43789: Fixed an out of bounds read when parsing an XPM file
 with a corrupted colormap (bsc#1215687).");
  ...
  script_tag(name:"affected", value:"'libXpm' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
