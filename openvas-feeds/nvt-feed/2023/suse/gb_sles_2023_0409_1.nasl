...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-03 13:19:15 +0000 (Mon, 03 Apr 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230409-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195175");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204502");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206677");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207034");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207497");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207508");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207769");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207878");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013761.html");
...
- nbd: Fix incorrect error handle when ... [Please see the references for more information on the vulnerabilities]");
