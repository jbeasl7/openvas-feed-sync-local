...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234458-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206480");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206684");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210557");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211427");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212101");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213915");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214052");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214460");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215427");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216664");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-November/017046.html");
...
- Adjust floatn fixincludes guard to work with SLE12 and earlier
 SLE15.
- Depend on at least LLVM 13 ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'gcc13' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
