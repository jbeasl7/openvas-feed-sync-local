...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234104-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215761");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215762");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016707.html");
...
- CVE-2023-40661: Fixed several memory safety issues that could happen
 during the card enrollment process using pkcs15-init (bsc#1215761).");
  ...
  script_tag(name:"affected", value:"'opensc' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
