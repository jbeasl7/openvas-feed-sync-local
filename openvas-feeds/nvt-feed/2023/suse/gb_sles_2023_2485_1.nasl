...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232485-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1068950");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1081527");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192285");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207712");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210081");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029799.html");
...
* New commands:
 ...
 - maint set internal-error backtrace on<pipe>off
 - maint show internal-error backtrace
 - maint set internal-warning backtrace on<pipe>off
 ...
 - set logging enabled on<pipe>off
 ...
 messages relating to ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'gdb' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
