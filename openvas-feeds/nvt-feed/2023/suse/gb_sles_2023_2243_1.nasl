...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232243-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208479");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211382");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-May/029457.html");
...
- New platforms:
 ...
 <pipe> AZB <pipe> R0 <pipe> 06-9a-04/40 <pipe> <pipe> 00000004 <pipe> Intel(R) Atom(R) C1100
- Updated Platforms
 <pipe> Processor <pipe> Stepping <pipe> F-M-S/PI <pipe> Old Ver <pipe> New Ver <pipe> Products
 <pipe>:---------------<pipe>:---------<pipe>:------------<pipe>:---------<pipe>:---------<pipe>:---------
