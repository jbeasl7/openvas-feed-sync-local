...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232127-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200441");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210127");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210128");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210129");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210130");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210938");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210963");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211029");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211030");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211031");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211073");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014783.html");
...
- Reduced install size (jsc#PED-1962).");
  ...
  script_tag(name:"affected", value:"'go1.19' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
