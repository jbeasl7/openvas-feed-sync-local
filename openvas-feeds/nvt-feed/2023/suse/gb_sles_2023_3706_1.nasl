...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233706-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212230");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214254");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215204");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-September/016254.html");
...
- CVE-2023-32360: Fixed information leak through Cups-Get-Document operation (bsc#1214254).");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
