...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232990-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-July/015666.html");
 ...
 - JDK-8268558: [TESTBUG] Case 2 in ... [Please see the references for more information on the vulnerabilities]");
