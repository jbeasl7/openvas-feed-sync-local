...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233835-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205927");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214850");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031730.html");
...
- jsc#PED-1344 - reinable building containerinfo plugin for SLES 15 SP4.");
  ...
  script_tag(name:"affected", value:"'Securitys update for open-vm-tools' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
