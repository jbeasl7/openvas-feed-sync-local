...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232668-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206337");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-June/015347.html");
...
- CVE-2022-46908: Properly implement the azProhibitedFunctions protection mechanism,
 when relying on --safe for execution of an untrusted CLI script (bsc#1206337).");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
