...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234506-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216374");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216379");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-November/017141.html");
...
- CVE-2015-4000: Fixed Logjam issue in SLES12SP5 (bsc#1211968).");
  ...
  script_tag(name:"affected", value:"'java-1_8_0-openjdk' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
