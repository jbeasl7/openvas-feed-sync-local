...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230724-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202666");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205244");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208471");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-March/014033.html");
...
- Making compileall.py compliant with year 2038 (bsc#1202666, gh#python/cpython#79171).");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
