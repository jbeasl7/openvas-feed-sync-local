...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230031-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206579");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013727.html");
...
- CVE-2022-47629: Fixed an integer overflow vulnerability in the CRL
 signature parser (bsc#1206579).");
  ...
  script_tag(name:"affected", value:"'libksba' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
