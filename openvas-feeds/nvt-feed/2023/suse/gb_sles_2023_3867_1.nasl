...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233867-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204501");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208046");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208270");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208298");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208692");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211525");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213880");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031790.html");
 ...
 * [BUGFIX] TSDB: Tombstone intervals are not modified ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'SUSE Manager Client Tools' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
