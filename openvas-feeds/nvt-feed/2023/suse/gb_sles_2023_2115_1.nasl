...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232115-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140754");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206778");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209934");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014741.html");
...
- CVE-2022-48434: Fixed use after free in libavcodec/pthread_frame.c (bsc#1209934).");
  ...
  script_tag(name:"affected", value:"'ffmpeg' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
