...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232047-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210057");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/029006.html");
...
- Fixed a timing-based side channel attack in RSA in the IBMCA engine (openssl-ibmca)");
  ...
  script_tag(name:"affected", value:"'openssl-ibmca' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
