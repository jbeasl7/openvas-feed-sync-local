...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230224-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206543");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013610.html");
...
- CVE-2022-4515: Fixed a command injection issue via a tag file wih a
 crafted filename (bsc#1206543).");
  ...
  script_tag(name:"affected", value:"'ctags' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
