...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232183-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208049");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208051");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208060");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208062");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208064");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208965");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209113");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-May/029370.html");
 ...
 * [FEATURE] Add slab info ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'SUSE Manager Client Tools' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
