...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230812-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201059");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205599");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205759");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207352");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207749");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207750");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208065");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208293");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-March/014098.html");
 ...
 * Allow using container images from different registry paths");
  ...
  script_tag(name:"affected", value:"'SUSE Manager Client Tools' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
