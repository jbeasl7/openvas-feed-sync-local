...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231776-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191502");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195529");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197244");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198507");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204423");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205000");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1206985");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208958");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014389.html");
...
- Fixed 'man' tweak description of auto/noauto (bsc#1191502).");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
