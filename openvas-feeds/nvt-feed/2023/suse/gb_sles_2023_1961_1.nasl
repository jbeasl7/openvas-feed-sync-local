...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231961-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209188");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014617.html");
...
- rebuild the package with the new secure boot key (bsc#1209188).");
  ...
  script_tag(name:"affected", value:"'s390-tools' package(s) on SUSE Linux Enterprise Server 15-SP3.");
