...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233955-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214922");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214924");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214925");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215004");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215006");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215033");
  script_xref(name:"URL", value:"https://github.com/vim/vim/compare/v9.0.1443...v9.0.1894");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016486.html");
  ...
  script_tag(name:"insight", value:"- CVE-2023-4733: Fixed use-after-free in function buflist_altfpos (bsc#1215004).
...
- Update to version 9.0 with patch level 1894,
 for the complete list of changes see [link moved to references]
- Use app icons generated from vimlogo.eps in the source tarball,
 add higher resolution icons of sizes 128x128, 256x256, and 512x512 as png sources");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
