...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234129-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214666");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216182");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016747.html");
 ...
 * Catalina:
 ...
 more than one concurrent ... [Please see the references for more information on the vulnerabilities]");
