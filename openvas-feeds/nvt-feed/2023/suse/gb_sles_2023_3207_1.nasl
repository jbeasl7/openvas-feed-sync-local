...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233207-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209616");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211642");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211797");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211994");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213326");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/030821.html");
...
- CVE-2023-24607: Fixed Qt SQL ODBC driver plugin DOS (bsc#1209616).");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
