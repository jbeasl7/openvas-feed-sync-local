...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232171-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210386");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210387");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210388");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210389");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014847.html");
...
CVE-2023-26551 (bsc#1210386), CVE-2023-26552 (bsc#1210388), CVE-2023-26553 (bsc#1210387), CVE-2023-26554 (bsc#1210389).");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
