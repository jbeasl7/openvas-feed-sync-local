...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-02-07 17:07:53 +0000 (Tue, 07 Feb 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231923-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208744");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/028908.html");
  ...
  script_tag(name:"insight", value:"- CVE-2022-25881: Fixed ReDoS vulnerability in http-cache-semantics (bsc#1208744).
