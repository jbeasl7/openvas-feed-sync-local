...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233857-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1088255");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031800.html");
...
- CVE-2018-9234: Fixed unenforced configuration allows for apparently valid certifications actually signed by signing subkeys (bsc#1088255).");
  ...
  script_tag(name:"affected", value:"'gpg2' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
