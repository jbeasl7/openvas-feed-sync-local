...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233187-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1036025");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1133277");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162343");
  script_xref(name:"URL", value:"https://github.com/fedora-java/javapackages");
  script_xref(name:"URL", value:"https://github.com/google/protobuf/issues/3937");
  script_xref(name:"URL", value:"https://github.com/google/protobuf/releases");
  script_xref(name:"URL", value:"https://github.com/mizdebsk/javapackages/commit/84211c0ee761e93ee507f5d37e9fc80ec377e89d");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/030794.html");
 ...
 * Bug#98667 (31711961), 'All pipe instances are ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'javapackages-tools, javassist, mysql-connector-java, protobuf, python-python-gflags' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
