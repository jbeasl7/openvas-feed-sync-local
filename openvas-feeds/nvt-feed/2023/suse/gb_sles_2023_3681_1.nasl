...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233681-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-September/031543.html");
...
- Bluetooth: nokia: fix value check in nokia_bluetooth_serdev_probe() ... [Please see the references for more information on the vulnerabilities]");
