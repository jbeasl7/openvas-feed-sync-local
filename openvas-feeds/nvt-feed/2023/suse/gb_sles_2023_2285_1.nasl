...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232285-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211389");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014956.html");
...
- CVE-2023-32700: Fixed arbitrary code execution in LuaTeX (bsc#1211389).");
  ...
  script_tag(name:"affected", value:"'texlive' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
