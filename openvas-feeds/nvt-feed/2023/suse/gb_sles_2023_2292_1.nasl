...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-09 00:58:24 +0000 (Thu, 09 Mar 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232292-1.html");
  script_xref(name:"URL", value:"https://github.com/kubernetes-sigs/apiserver-network-proxy/commits/v0.0.33");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-May/029534.html");
 ...
 * Bump konnectivity network proxy to v0.0.33. Includes a couple bug fixes for better handling of dial failures. [Agent & Server]([link moved to references]) include numerous other fixes.
 ...
 * Fixing issue in generatePodSandboxWindowsConfig for hostProcess containers by where pod sandbox won't have HostProcess bit set if pod does not have a security context but containers specify HostProcess.");
  ...
  script_tag(name:"affected", value:"'kubernetes1.23' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
