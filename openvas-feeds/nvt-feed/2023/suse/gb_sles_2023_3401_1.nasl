...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233401-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205318");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1207113");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/031146.html");
...
- Replaced the CVE-2022-37026 patch with the one released by the upstream to fix a regression in the previous one. (bsc#1205318)");
  ...
  script_tag(name:"affected", value:"'erlang' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
