...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234715-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216156");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-December/033062.html");
...
- CVE-2023-37536: Fixed an integer overflow that could have led to a out-of-bounds memory accesses (bsc#1216156).");
  ...
  script_tag(name:"affected", value:"'xerces-c' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
