...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233208-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213502");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-August/030820.html");
 ...
 - CVE-2023-38633: Fixed directory traversal in URI decoder (bsc#1213502).");
  ...
  script_tag(name:"affected", value:"'librsvg' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
