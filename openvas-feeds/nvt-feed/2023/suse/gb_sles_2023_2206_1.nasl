...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232206-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210303");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211228");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211229");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-May/014886.html");
...
Updated to version 15.3:
 ...
 - Internal fixes (bsc#1210303).");
  ...
  script_tag(name:"affected", value:"'postgresql15' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
