...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234230-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216432");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216433");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016889.html");
...
- CVE-2023-34059: Fixed a privilege escalation issue through
 vmware-user-suid-wrapper (bsc#1216433).");
  ...
  script_tag(name:"affected", value:"'open-vm-tools' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
