...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232003-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1168481");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208962");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209884");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209888");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-April/028987.html");
  ...
  script_tag(name:"insight", value:"- CVE-2023-25809: Fixed rootless `/sys/fs/cgroup` is writable when cgroupns isn't unshared (bnc#1209884).
...
Other fixes:
 ...
 - Drop version-specific Go requirement.");
  ...
  script_tag(name:"affected", value:"'runc' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
