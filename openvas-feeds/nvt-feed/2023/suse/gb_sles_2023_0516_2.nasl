...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230516-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176262");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195831");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013882.html");
...
- Switch this package to use update-alternatives for all files
 ...
 bsc#1195831).");
  ...
  script_tag(name:"affected", value:"'python-pip' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
