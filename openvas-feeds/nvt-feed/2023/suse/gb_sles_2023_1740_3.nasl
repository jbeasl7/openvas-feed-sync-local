...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-02-06 15:39:44 +0000 (Wed, 06 Feb 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20231740-3.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121227");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121230");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1122004");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1122021");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-April/014346.html");
...
- CVE-2019-6292: Fixed DOS by stack consumption in singledocparser.cpp (bsc#1122021).");
  ...
  script_tag(name:"affected", value:"'yaml-cpp' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
