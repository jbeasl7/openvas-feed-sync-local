...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20230568-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208275");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208276");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1208277");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-February/013926.html");
...
- CVE-2022-38090: Security updates for [INTEL-SA-00767]([link moved to references]) (bsc#1208275)
- CVE-2022-33196: Security updates for [INTEL-SA-00738]([link moved to references]) (bsc#1208276)
- CVE-2022-21216: Security updates for [INTEL-SA-00700]([link moved to references]) (bsc#1208277)
...
- Updated Platforms:
 ...
 <pipe> ICX-SP ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
