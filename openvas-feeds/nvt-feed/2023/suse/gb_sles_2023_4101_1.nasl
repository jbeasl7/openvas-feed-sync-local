...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234101-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215806");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-October/016710.html");
...
conmon is rebuilt with the current stable release go1.21 (bsc#1215806)");
  ...
  script_tag(name:"affected", value:"'conmon' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
