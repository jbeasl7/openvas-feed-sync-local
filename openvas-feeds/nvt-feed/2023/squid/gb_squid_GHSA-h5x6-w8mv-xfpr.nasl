...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151739");
  ...
  script_name("Squid DoS Vulnerability (GHSA-h5x6-w8mv-xfpr, SQUID-2024:2)");
  ...
  script_tag(name:"insight", value:"Due to a Collapse of Data into Unsafe Value bug, Squid may be
  vulnerable to a Denial of Service attack against HTTP header parsing.

  This flaw was part of the 'Squid Caching Proxy Security Audit: 55 vulnerabilities and 35 0days'
  publication in October 2023 and filed as 'Memory Leak in HTTP Response Parsing'.");

  script_tag(name:"affected", value:"Squid versions prior to 6.5.");

  script_tag(name:"solution", value:"Update to version 6.5 or later.");

  script_xref(name:"URL", value:"https://github.com/squid-cache/squid/security/advisories/GHSA-h5x6-w8mv-xfpr");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/response-memleaks.html");
