...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114405");
  ...
  script_tag(name:"severity_date", value:"2025-02-26 17:49:12 +0000 (Wed, 26 Feb 2025)");
  ...
  script_name("Squid DoS Vulnerability (GHSA-72c2-c3wm-8qxc, SQUID-2024:1)");
  ...
  script_tag(name:"summary", value:"Squid is prone to a denial of service (DoS) vulnerability in the
  HTTP Chunked Decoding.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Due to an Uncontrolled Recursion bug, Squid may be vulnerable to
  ...
  publication in October 2023 and filed as 'Chunked Encoding Stack Overflow'.");

  script_tag(name:"affected", value:"Squid version 3.5.27 through 6.7.");

  script_tag(name:"solution", value:"Update to version 6.8 or later.");

  script_xref(name:"URL", value:"https://github.com/squid-cache/squid/security/advisories/GHSA-72c2-c3wm-8qxc");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/chunked-stackoverflow.html");
...
if (version_in_range_exclusive(version: version, test_version_lo: "3.5.27", test_version_up: "6.7")) {
