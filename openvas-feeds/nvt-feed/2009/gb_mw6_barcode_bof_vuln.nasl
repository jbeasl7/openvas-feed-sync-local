...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/33451");
  ...
  script_tag(name:"summary", value:"MW6 Technologies Barcode ActiveX is prone to a buffer overflow vulnerability.");
