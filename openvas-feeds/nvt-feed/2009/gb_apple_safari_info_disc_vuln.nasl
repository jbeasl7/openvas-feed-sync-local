...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/33234");
  ...
  script_tag(name:"summary", value:"Apple Safari web browser is prone to remote file access vulnerability.");
