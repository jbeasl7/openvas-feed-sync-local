...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36611");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36612");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36618");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2009/ms09-061");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2009/ms09-061");
  exit(0);
}
