...
if(description)
{
  ...
  script_name("Horde Multiple Vulnerabilities (Apr 2009)");
  ...
  script_tag(name:"summary", value:"Horde is prone to a local file include (LFI) vulnerability and
  a cross-site scripting (XSS) vulnerability because they fail to properly sanitize user-supplied
  input.");
