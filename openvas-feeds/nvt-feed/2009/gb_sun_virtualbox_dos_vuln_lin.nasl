...
if(version_in_range(version:vers[1], test_version:"1.6.0", test_version2:"1.6.6") ||
   version_in_range(version:vers[1], test_version:"2.0.0", test_version2:"2.0.11") ||
   version_in_range(version:vers[1], test_version:"2.1.0", test_version2:"2.1.4") ||
   version_in_range(version:vers[1], test_version:"2.2.0", test_version2:"2.2.4") ||
   version_in_range(version:vers[1], test_version:"3.0.0", test_version2:"3.0.9")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"Apply patch from vendor");
