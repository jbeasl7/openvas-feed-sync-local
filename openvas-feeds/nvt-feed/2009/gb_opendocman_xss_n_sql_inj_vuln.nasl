...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36777");
  ...
  script_tag(name:"summary", value:"OpenDocMan is prone to multiple Cross-Site Scripting and SQL Injection vulnerabilities.");
