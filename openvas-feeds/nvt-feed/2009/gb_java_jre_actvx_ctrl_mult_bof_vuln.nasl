...
if(description)
{
  ...
  script_tag(name:"summary", value:"Java JRE Deployment Toolkit ActiveX is prone to multiple buffer overflow vulnerabilities.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/34931");
