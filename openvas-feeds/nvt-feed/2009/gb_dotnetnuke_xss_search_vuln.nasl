...
if(description)
{
  ...
  script_name("DotNetNuke 4.8.x <= 5.1.4 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw is due to input passed to the search parameters are
...
if (version_in_range(version: version, test_version: "4.8.0", test_version2: "5.1.4")) {
