...
if(description)
{
  ...
  script_name("PHP 5.2.7 SQLi Vulnerability");
  ...
  script_tag(name:"insight", value:"An improper field change in FILTER_UNSAFE_RAW, which can be
  exploited when magic_quotes_gpc settings is disabled, may lead to an SQL injection
  vulnerability.");

  script_tag(name:"impact", value:"Successful exploitation could allow attackers to inject SQL
  code in the affected user application, and this may lead to other attacks also.");

  script_tag(name:"affected", value:"PHP version 5.2.7 only.");
...
if (version_is_equal(version: version, test_version: "5.2.7")) {
