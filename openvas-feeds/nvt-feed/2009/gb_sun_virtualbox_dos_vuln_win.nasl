...
if(vmVer) {
  if(version_in_range(version:vmVer, test_version:"2.0.0", test_version2:"2.0.11") ||
    ...
    report = report_fixed_ver(installed_version:vmVer, fixed_version:"Apply patch from vendor");
...
if(xvmVer) {
  if(version_in_range(version:xvmVer, test_version:"1.6.0", test_version2:"1.6.6") ||
    ...
    report = report_fixed_ver(installed_version:xvmVer, fixed_version:"Apply patch from vendor");
    security_message(port:0, data:report);
    exit(0);
  }
}
