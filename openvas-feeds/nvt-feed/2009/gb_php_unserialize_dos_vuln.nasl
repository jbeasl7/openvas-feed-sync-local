...
if(description)
{
  ...
  script_name("PHP <= 5.3.0 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"An error in 'unserialize()' function while processing
  malformed user supplied data containing a long serialized string passed via the '__wakeup()' or
  '__destruct()' methods.");

  script_tag(name:"impact", value:"Successful exploitation could allow attackers to execute
  arbitrary PHP code and cause denial of service.");

  script_tag(name:"affected", value:"PHP versions 5.3.0 and prior.");
