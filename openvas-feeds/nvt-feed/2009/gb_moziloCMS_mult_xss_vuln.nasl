...
if(description)
{
  ...
  script_name("moziloCMS < 1.12 Multiple XSS Vulnerabilities");
  ...
  script_tag(name:"summary", value:"moziloCMS is prone to multiple cross-site scripting (XSS)
  vulnerabilities.");
...
if (version_is_less_equal(version: vers, test_version: "1.11.1")) {
