...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36602");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36614");
...
if(sysPath)
{
  ...
  {
    if(version_in_range(version:dllVer, test_version:"9.0", test_version2:"9.0.0.3268")||
       version_in_range(version:dllVer, test_version:"10.0", test_version2:"10.0.0.4069")){
  ...
  else if(hotfix_check_sp(xp:4) > 0)
  {
    ...
    if("Service Pack 2" >< SP || "Service Pack 3" >< SP)
    {
      ...
      if(version_in_range(version:dllVer, test_version:"9.0.0.3", test_version2:"9.0.0.3268")||
         version_in_range(version:dllVer, test_version:"9.0.0.4", test_version2:"9.0.0.4504")||
         version_in_range(version:dllVer, test_version:"10.0.0.3", test_version2:"10.0.0.3703")||
         version_in_range(version:dllVer, test_version:"10.0.0.40", test_version2:"10.0.0.4069")||
         version_in_range(version:dllVer, test_version:"10.0.0.43", test_version2:"10.0.0.4364")||
         version_in_range(version:dllVer, test_version:"11.0.0.0", test_version2:"11.0.5721.5262")){
         security_message( port: 0, data: "The target host was found to be vulnerable" );
      }
      exit(0);
    }
  ...
  else if(hotfix_check_sp(win2003:3) > 0)
  {
    ...
    {
      if(version_in_range(version:dllVer, test_version:"10.0.0.3", test_version2:"10.0.0.3711") ||
         version_in_range(version:dllVer, test_version:"10.0.0.4", test_version2:"10.0.0.4003")){
        security_message( port: 0, data: "The target host was found to be vulnerable" );
      }
      exit(0);
    }
