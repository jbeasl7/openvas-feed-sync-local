...
if(description)
{
  ...
  script_name("PHP 4.x, 5.2.6 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"An error occurs in 'dba_replace()' function while processing
  malformed user supplied data containing a key with the NULL byte.");

  script_tag(name:"impact", value:"Successful exploitation could allow attackers to execute
  arbitrary code, corrupt files and cause denial of service.");

  script_tag(name:"affected", value:"PHP versions 4.x and 5.2.6 (and probably prior).");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20141121221325/http://www.securityfocus.com/bid/33498");
  script_xref(name:"URL", value:"https://web.archive.org/web/20200229230422/http://www.securityfocus.com/archive/1/498746/100/0/threaded");
...
if (version_in_range_exclusive(version: version, test_version_lo: "4.0", test_version_up: "5.2.7")) {
