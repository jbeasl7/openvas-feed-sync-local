...
if(description)
{
  ...
  script_name("PHP < 4.4.5, 5.1.x < 5.1.7, 5.2.x < 5.2.6 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"An error occurs in the 'mbstring.func_overload' setting in
  ...
  script_tag(name:"impact", value:"Successful exploitation will let the local attackers to crash
  an affected web server.");

  script_tag(name:"affected", value:"PHP version 4.4.4 and prior, 5.1.x through 5.1.6 and 5.2.x
  through 5.2.5.");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20200228163106/http://www.securityfocus.com/bid/33542");
...
if (version_is_less_equal(version: version, test_version: "4.4.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.4.5", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "5.1.0", test_version2: "5.1.6")) {
