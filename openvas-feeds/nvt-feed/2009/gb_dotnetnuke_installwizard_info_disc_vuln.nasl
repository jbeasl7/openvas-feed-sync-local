...
if(description)
{
  ...
  script_name("DotNetNuke 4.0 <= 4.8.4, 5.0 Install Wizard Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"An unspecified vulnerability in DotNetNuke which could allow a
  remote attacker to gain unauthorised information.");

  script_tag(name:"impact", value:"Successful exploitation could allow remote attackers to view
  the install wizard page and obtain sensitive information.");

  script_tag(name:"affected", value:"DotNetNuke versions 4.0 through 4.8.4 and 5.0 only.");

  script_tag(name:"solution", value:"Update to version 4.9.0, 5.0.1 or later.");
...
if (version_in_range(version: version, test_version: "4.0", test_version2: "4.8.4")) {
