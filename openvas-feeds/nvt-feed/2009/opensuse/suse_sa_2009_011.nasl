...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for flash-player (SUSE-SA:2009:011)");
  ...
  script_tag(name:"insight", value:"Specially crafted swf files could cause a buffer overflow in
...
CVE-2009-0521).");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=SUSE-SA:2009:011");
