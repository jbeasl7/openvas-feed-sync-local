...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63187");
  ...
  script_mandatory_keys("ssh/login/opensuse", "ssh/login/rpms", re:"ssh/login/release=openSUSE11\.0");
  script_tag(name:"solution", value:"Update all out of date packages.");
