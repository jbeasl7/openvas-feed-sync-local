...
if(description)
{
  ...
  - CVE-2009-1371: Error in CLI_ISCONTAINED macro in libclamav/others.h while processing malformed
  files packed with UPack.

  - CVE-2009-1372: Buffer overflow error in cli_url_canon() function in libclamav/phishcheck.c while
  handling specially crafted URLs.");

  script_tag(name:"impact", value:"Attackers can exploit this issue by executing arbitrary code
  via a crafted URL in the context of affected application, and can cause denial of service.");

  script_tag(name:"affected", value:"ClamAV prior to version 0.95.1.");
...
if (version_is_less(version: version, test_version: "0.95.1")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.95.1", install_path: location);
