...
if(description)
{
  ...
  script_name("PHP < 5.2.8 XSS Vulnerability");
  ...
  script_tag(name:"impact", value:"Successful exploitation could allow attackers to inject
  arbitrary web script or HTML via unspecified vectors and conduct Cross-Site Scripting attacks.");

  script_tag(name:"affected", value:"PHP version 5.2.7 and prior.");
