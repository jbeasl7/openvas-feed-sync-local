...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openvpn", ver:"2.0.9-5ubuntu0.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openvpn", ver:"2.0.9-8ubuntu0.1", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openvpn", ver:"2.1~rc7-1ubuntu3.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
