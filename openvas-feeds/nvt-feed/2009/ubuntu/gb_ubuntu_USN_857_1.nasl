...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libqt4-webkit", ver:"4.4.3-0ubuntu1.4", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libqt4-webkit", ver:"4.5.0-0ubuntu4.3", rls:"UBUNTU9.04"))) {
    report += res;
  }
