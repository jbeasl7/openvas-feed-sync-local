...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-client", ver:"1:4.3p2-8ubuntu1.3", rls:"UBUNTU7.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:4.3p2-8ubuntu1.3", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-client", ver:"1:4.6p1-5ubuntu0.3", rls:"UBUNTU7.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:4.6p1-5ubuntu0.3", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-client", ver:"1:4.7p1-8ubuntu1.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:4.7p1-8ubuntu1.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
