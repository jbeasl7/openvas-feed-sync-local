...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnet-dns-perl", ver:"0.53-2ubuntu1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnet-dns-perl", ver:"0.57-1ubuntu1", rls:"UBUNTU6.10"))) {
    report += res;
  }
