...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-01-26 09:29:11 +0100 (Sat, 26 Jan 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("ABB DriveSize Detection (Windows SMB Login)");
  ...
  script_tag(name:"summary", value:"SMB login-based detection of ABB DriveSize.");
...
foreach key(key_list) {
  foreach item(registry_enum_keys(key:key)) {
    ...
    register_and_report_cpe(app:"ABB " + appName, ver:version, concluded:concluded,
                            base:"cpe:/a:abb:drivesize:", expr:"^([0-9.]+)", insloc:location,
