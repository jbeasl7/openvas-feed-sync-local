...
if( description )
{
  ...
  script_tag(name:"severity_date", value:"2020-05-12 16:03:00 +0000 (Tue, 12 May 2020)");
  ...
  script_tag(name:"insight", value:"Account details are shared in the Elasticsearch results for
  accounts that are not accessible when the config setting 'Isolated institutions' is turned on.");
