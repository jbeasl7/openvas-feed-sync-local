...
if(description)
{
  ...
  script_tag(name:"affected", value:"vBulletin versions prior to 5.5.6 Patch Level 1, 5.6.0 Patch
  Level 1 and 5.6.1 Patch Level 1.");

  script_tag(name:"solution", value:"Update to 5.5.6 Patch Level 1, 5.6.0 Patch Level 1, 5.6.1 Patch
  Level 1 or later.");
