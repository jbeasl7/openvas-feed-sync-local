...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for shadowsocks-libev (openSUSE-SU-2019:2667-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2667-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-12/msg00023.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'shadowsocks-libev'
  package(s) announced via the openSUSE-SU-2019:2667-1 advisory.");
