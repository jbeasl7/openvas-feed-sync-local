...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-07 19:29:00 +0000 (Tue, 07 May 2019)");
  script_tag(name:"creation_date", value:"2020-01-09 09:31:48 +0000 (Thu, 09 Jan 2020)");
  script_name("openSUSE: Security Advisory for teeworlds (openSUSE-SU-2019:1793-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1793-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-07/msg00046.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'teeworlds'
  package(s) announced via the openSUSE-SU-2019:1793-1 advisory.");
