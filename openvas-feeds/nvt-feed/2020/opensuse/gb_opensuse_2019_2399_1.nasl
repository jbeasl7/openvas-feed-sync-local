...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for lz4 (openSUSE-SU-2019:2399-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2399-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-10/msg00070.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'lz4'
  package(s) announced via the openSUSE-SU-2019:2399-1 advisory.");
