...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for docker-runc (openSUSE-SU-2019:2434-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2434-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-11/msg00009.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker-runc'
  package(s) announced via the openSUSE-SU-2019:2434-1 advisory.");
