...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for MozillaThunderbird (openSUSE-SU-2020:0003-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:0003-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2020-01/msg00000.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaThunderbird'
  package(s) announced via the openSUSE-SU-2020:0003-1 advisory.");
