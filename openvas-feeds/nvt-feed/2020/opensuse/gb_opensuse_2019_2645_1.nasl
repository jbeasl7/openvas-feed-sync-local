...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for haproxy (openSUSE-SU-2019:2645-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2645-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-12/msg00019.html");
