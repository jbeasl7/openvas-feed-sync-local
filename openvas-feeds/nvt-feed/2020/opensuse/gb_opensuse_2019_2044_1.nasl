...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for podman, slirp4netns and libcontainers-common (openSUSE-SU-2019:2044-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2044-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-09/msg00001.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman, slirp4netns and libcontainers-common'
  package(s) announced via the openSUSE-SU-2019:2044-1 advisory.");
