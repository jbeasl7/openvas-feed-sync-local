...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/opensuse", "ssh/login/rpms", re:"ssh/login/release=(openSUSELeap15\.0|openSUSELeap15\.1)");

  script_xref(name:"openSUSE-SU", value:"2020:0067-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2020-01/msg00031.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icingaweb2'
  package(s) announced via the openSUSE-SU-2020:0067-1 advisory.");
