...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for samba (openSUSE-SU-2019:2700-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2700-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-12/msg00038.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba'
  package(s) announced via the openSUSE-SU-2019:2700-1 advisory.");
