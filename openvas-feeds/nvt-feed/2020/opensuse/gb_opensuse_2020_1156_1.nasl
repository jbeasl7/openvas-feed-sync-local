...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853342");
  ...
  script_tag(name:"creation_date", value:"2020-08-08 03:01:28 +0000 (Sat, 08 Aug 2020)");
  script_name("openSUSE: Security Advisory for python-rtslib-fb (openSUSE-SU-2020:1156-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:1156-1");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-security-announce/2020-08/msg00012.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-rtslib-fb'
  package(s) announced via the openSUSE-SU-2020:1156-1 advisory.");
  ...
  * Remove '_if_needed' from RTSRoot._set_dbroot()'s name Replacing old
  ...
  zypper in -t patch openSUSE-2020-1156=1");

  script_tag(name:"affected", value:"'python-rtslib-fb' package(s) on openSUSE Leap 15.2.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python2-rtslib-fb", rpm:"python2-rtslib-fb~2.1.73~lp152.2.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-rtslib-fb", rpm:"python3-rtslib-fb~2.1.73~lp152.2.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
