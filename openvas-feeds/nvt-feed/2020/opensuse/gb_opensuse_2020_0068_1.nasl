...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-05-25 20:53:00 +0000 (Wed, 25 May 2022)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:0068-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2020-01/msg00033.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libredwg'
  package(s) announced via the openSUSE-SU-2020:0068-1 advisory.");
