...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-03 17:51:00 +0000 (Fri, 03 Mar 2023)");
  script_tag(name:"creation_date", value:"2020-01-09 09:38:37 +0000 (Thu, 09 Jan 2020)");
  script_name("openSUSE: Security Advisory for libopenmpt (openSUSE-SU-2019:2213-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2213-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-09/msg00084.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the openSUSE-SU-2019:2213-1 advisory.");
