...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for ucode-intel (openSUSE-SU-2019:2528-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2528-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-11/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel'
  package(s) announced via the openSUSE-SU-2019:2528-1 advisory.");
