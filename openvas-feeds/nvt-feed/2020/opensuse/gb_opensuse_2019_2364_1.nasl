...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for gcc7 (openSUSE-SU-2019:2364-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2364-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-10/msg00056.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gcc7'
  package(s) announced via the openSUSE-SU-2019:2364-1 advisory.");
