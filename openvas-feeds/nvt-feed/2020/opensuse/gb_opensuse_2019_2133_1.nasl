...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python-urllib3 (openSUSE-SU-2019:2133-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2133-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-09/msg00041.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-urllib3'
  package(s) announced via the openSUSE-SU-2019:2133-1 advisory.");
