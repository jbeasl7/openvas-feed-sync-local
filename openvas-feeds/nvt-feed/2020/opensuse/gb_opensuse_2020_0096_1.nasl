...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-23 07:15:00 +0000 (Thu, 23 Jan 2020)");
  ...
  script_xref(name:"openSUSE-SU", value:"2020:0096-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2020-01/msg00046.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libredwg'
  package(s) announced via the openSUSE-SU-2020:0096-1 advisory.");
