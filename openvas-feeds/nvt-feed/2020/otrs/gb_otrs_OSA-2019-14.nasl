...
if (description)
{
  ...
  script_name("OTRS 5.x < 5.0.39, 6.x < 6.0.24, 7.x < 7.0.13 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"An attacker who is logged into OTRS as an agent is able to
  list tickets assigned to other agents, which are in the queue where attacker doesn't have
  permissions.");

  script_tag(name:"affected", value:"OTRS versions 5.x through 5.0.38, 6.x through 6.0.23 and 7.x
  through 7.0.12.");
