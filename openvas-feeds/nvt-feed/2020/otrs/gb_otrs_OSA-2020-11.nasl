...
if (description)
{
  ...
  script_name("OTRS 5.0.x < 6.0.28, 7.0.x < 7.0.17 Information Disclosure Vulnerability (OSA-2020-11)");
  ...
  script_tag(name:"insight", value:"When user downloads PGP or S/MIME keys/certificates, the
  exported file has the same name for private and public keys. Therefore it's possible to mix them
  and to send the private key to the third-party instead of the public key.");

  script_tag(name:"affected", value:"OTRS versions 5.0.x through 5.0.42, 6.0.x through 6.0.27 and
  7.0.x through 7.0.16.");
...
if (version_in_range(version: version, test_version: "5.0.0", test_version2: "5.0.42") ||
    version_in_range(version: version, test_version: "6.0.0", test_version2: "6.0.27")) {
