...
if (description)
{
  ...
  script_tag(name:"insight", value:"An attacker who is logged into OTRS as an agent or customer
  user with appropriate permissions can create a carefully crafted string containing malicious
  JavaScript code as an article body. This malicious code is executed when an agent compose an
  answer to the original article.");

  script_tag(name:"affected", value:"OTRS 5.0.x through 5.0.37, 6.0.x through 6.0.22 and 7.0.x
  through 7.0.11.");

  script_tag(name:"solution", value:"Update to version 5.0.38, 6.0.23, 7.0.12 or later.");
