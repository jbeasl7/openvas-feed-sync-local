...
if(description)
{
  ...
  script_tag(name:"insight", value:"Improper error handling could cause a crash due to a NULL
  pointer dereference.");
...
if (version_in_range(version: version, test_version: "0.102.0", test_version2: "0.102.3")) {
