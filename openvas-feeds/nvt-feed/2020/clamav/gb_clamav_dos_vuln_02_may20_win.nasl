...
if(description)
{
  ...
  script_tag(name:"insight", value:"Improper size checking of a buffer used to initialize AES
...
if (version_in_range(version: version, test_version: "0.101", test_version2: "0.102.2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.102.3", install_path: location);
