...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2024-02-15 15:56:20 +0000 (Thu, 15 Feb 2024)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2019-1588");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2019-1588");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1588 advisory.");
...
Microprocessors use a '~load port' subcomponent to perform load operations from memory or IO. During a load operation, the load port receives data from the memory or IO subsystem and then provides the data to the CPU registers and operations in the CPU's pipelines. Stale load operations ... [Please see the references for more information on the vulnerabilities]");
