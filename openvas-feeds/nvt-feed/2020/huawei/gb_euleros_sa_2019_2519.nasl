...
if(description)
{
  ...
  script_cve_id("CVE-2015-7995", "CVE-2016-1683", "CVE-2016-1684", "CVE-2016-4607", "CVE-2016-4608", "CVE-2016-4609", "CVE-2016-4610", "CVE-2019-13117", "CVE-2019-13118", "CVE-2019-18197");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2019-2519");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2019-2519");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libxslt' package(s) announced via the EulerOS-SA-2019-2519 advisory.");
...
In numbers.c in libxslt 1.1.33, an xsl:number with certain format strings could lead to a uninitialized read ... [Please see the references for more information on the vulnerabilities]");
