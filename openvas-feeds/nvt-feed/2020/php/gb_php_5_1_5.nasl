...
if(description)
{
  ...
  script_tag(name:"affected", value:"PHP version 5.1.x prior to 5.1.5.");

  script_tag(name:"solution", value:"Update to version 5.1.5 or later.");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16878");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/19415");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/19582");
