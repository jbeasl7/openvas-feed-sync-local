...
if(description)
{
  ...
  script_cve_id("CVE-2007-3378", "CVE-2007-3799", "CVE-2007-3997", "CVE-2007-4657",
  ...
  script_tag(name:"solution", value:"Update to version 4.4.8 or later.");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/24661");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/49631");
