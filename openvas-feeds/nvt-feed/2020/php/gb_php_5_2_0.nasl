...
if(description)
{
  ...
  script_tag(name:"affected", value:"PHP prior to version 5.2.0.");

  script_tag(name:"solution", value:"Update to version 5.2.0 or later.");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/20349");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/20879");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/49634");
