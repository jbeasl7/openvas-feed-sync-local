...
if (description)
{
  ...
  script_mandatory_keys("phpldapadmin/detected", "Host/runs_unixoide");

  script_tag(name:"summary", value:"phpLDAPadmin is prone to multiple cross-site scripting (XSS)
  vulnerabilities.");
  ...
  - CVE-2019-14377: XSS in htdocs/create.php

  - CVE-2019-14376: XSS in htdocs/password_checker.php

  - CVE-2019-14375: XSS in htdocs/rename_form.php");

  script_tag(name:"impact", value:"The flaw allows remote users to inject arbitrary web script or
  HTML.");

  script_tag(name:"affected", value:"phpLDAPadmin version 1.2.4 and prior.");
