...
if (description)
{
  ...
  script_name("Oracle MySQL Server 8.0 <= 8.0.20 Security Update (cpuoct2020) - Windows");
  ...
  script_tag(name:"summary", value:"Oracle MySQL Server is prone to a Denial of Service vulnerability.");
