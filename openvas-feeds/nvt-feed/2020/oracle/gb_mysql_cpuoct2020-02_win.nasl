...
if (description)
{
  ...
  script_name("Oracle MySQL Server 5.7 <= 5.7.31 Security Update (cpuoct2020) - Windows");
  ...
  script_tag(name:"summary", value:"Oracle MySQL Server is prone to a vulnerability leading to a Denial of Service
  or to an unauthorized modification of accessible data.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.7 through 5.7.31.");
