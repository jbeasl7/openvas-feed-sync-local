...
if (description)
{
  ...
  script_name("Oracle MySQL Server 5.7 <= 5.7.29 Security Update (cpuapr2020) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 5.7 through 5.7.29.");
