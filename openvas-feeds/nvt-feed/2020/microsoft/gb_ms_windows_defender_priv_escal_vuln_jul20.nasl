...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-17 19:56:00 +0000 (Fri, 17 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-07-27 11:50:35 +0530 (Mon, 27 Jul 2020)");
  script_name("Microsoft Defender Elevation of Privilege Vulnerability (Jul 2020)");
...
if(version_is_less(version:mpe_version, test_version:"1.1.17200.2")){
  report = report_fixed_ver(installed_version:mpe_version, fixed_version:"1.1.17200.2 or higher");
