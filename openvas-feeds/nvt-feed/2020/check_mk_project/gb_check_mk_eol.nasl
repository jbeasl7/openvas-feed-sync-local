...
if( description )
{
  ...
  script_dependencies("gb_checkmk_server_http_detect.nasl", "gb_checkmk_agent_detect.nasl");
  script_mandatory_keys("checkmk/detected");

  script_tag(name:"summary", value:"The Check_MK version on the remote host has reached the End of
  Life (EOL) and should not be used anymore.");

  script_tag(name:"impact", value:"An EOL version of Check_MK is not receiving any security updates
  ...
  script_tag(name:"solution", value:"Update the Check_MK version on the remote host to a still
  supported version.");
