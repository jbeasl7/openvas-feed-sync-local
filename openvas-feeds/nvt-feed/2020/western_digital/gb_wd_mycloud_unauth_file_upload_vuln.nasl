...
if(description)
{
  ...
  script_name("Western Digital My Cloud Unauthenticated File Upload Vulnerability (CVE-2019-9951) - Active Check");
  # nb: Only direct access to a file, no ACT_ATTACK is expected
  ...
  script_tag(name:"summary", value:"Western Digital My Cloud is prone to an unauthenticatedfile
  upload vulnerability.");

  script_tag(name:"vuldetect", value:"Sends a crafted HTTP GET request and checks the response.");

  script_tag(name:"insight", value:"The page web/jquery/uploader/uploadify.php can be accesses
  without any credentials and allows uploading arbitrary files to any location on the attached
  storage under either:
  ...
  commands with root privileges in context of the affected application.");

  script_tag(name:"solution", value:"The vendor has released firmware updates. Please see the
  reference for more details and downloads.");
