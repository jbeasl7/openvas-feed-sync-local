...
if(description)
{
  ...
  script_name("VMware Products Detection (Windows SMB Login)");

  script_tag(name:"summary", value:"SMB login-based detection of VMware Products.");

  script_tag(name:"insight", value:"The following products are currently detected / covered:
