...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.130464");
  ...
  script_name("Do Not Enable the rsync Service");
  ...
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): HCE Linux Security Configuration (v1.0.0): 1. Initial deployment: 1.2 Software: 1.2.8 Do Not Enable the rsync Service (Requirement)");
...
title = "Do Not Enable the rsync Service";
