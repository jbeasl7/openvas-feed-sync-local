...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.130465");
  ...
  script_name("Do Not Enable the Avahi Service");
  ...
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): HCE Linux Security Configuration (v1.0.0): 1. Initial deployment: 1.2 Software: 1.2.9 Do Not Enable the Avahi Service (Requirement)");
...
title = "Do Not Enable the Avahi Service";

solution = "You can run the following command to disable the avahi-daemon service that does not
need to be enabled.
