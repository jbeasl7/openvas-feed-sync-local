...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.4 Avoid Enabling Unnecessary Services and Ports (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.4 Avoid Enabling Unnecessary Services and Ports (Recommendation)");
