...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.130361");
  ...
  script_name("Configure Proper Policies for INPUT of nftables");
  ...
  script_add_preference(name:"Chain", type:"entry", value:"input", id:2);
  script_add_preference(name:"Protocol", type:"entry", value:"tcp", id:3);
  script_add_preference(name:"Port", type:"entry", value:"22", id:4);

  script_xref(name:"Policy", value:"EulerOS Baseline: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.14 Configure Proper Policies for INPUT of nftables (Recommendation)");
  script_xref(name:"Policy", value:"EulerOS Virtual: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.14 Configure Proper Policies for INPUT of nftables (Recommendation)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.14 Configure Proper Policies for INPUT of nftables (Recommendation)");
  script_xref(name:"Policy", value:"openEuler Baseline: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.2 Firewall: 3.2.14 Configure Proper Policies for INPUT of nftables (Recommendation)");
...
title = "Configure Proper Policies for INPUT of nftables";
...
# nft list chain inet '+ table +' '+ chain +' 2>/dev/null | grep "'+ protocol +' dport '+ port +' accept"';
...
step_cmd = 'nft list chain inet '+ table +' '+ chain +' 2>/dev/null | grep "'+ protocol +' dport '+ port +' accept"';
