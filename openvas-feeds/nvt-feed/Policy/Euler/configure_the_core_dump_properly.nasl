...
if(description)
{
  ...
  script_xref(name:"Policy", value:"EulerOS Baseline: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.20 Configure the Core Dump Properly (Requirement)");
  script_xref(name:"Policy", value:"EulerOS Virtual: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.20 Configure the Core Dump Properly (Requirement)");
  script_xref(name:"Policy", value:"HCE Linux (Huawei Cloud EulerOS): Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.20 Configure the Core Dump Properly (Requirement)");
  script_xref(name:"Policy", value:"openEuler Baseline: Security Committee Benchmark (v1.0.0): 3. Running and Services: 3.5 Kernel: 3.5.20 Configure the Core Dump Properly (Requirement)");
...
# sysctl <quote>kernel.core_pattern=/corefiles/core-%e-%p-%t<quote>
...
# sysctl -w <quote>fs.suid_dumpable=0<quote>
