...
if(description)
{
  ...
  script_dependencies("find_service.nasl", "find_service2.nasl", "httpver.nasl",
                      "apache_SSL_complain.nasl", "global_settings.nasl");
  script_require_ports("Services/www", 80);
  script_exclude_keys("Settings/disable_cgi_scanning");

  script_tag(name:"summary", value:"This script tries to detect / enumerate different HTTP server
