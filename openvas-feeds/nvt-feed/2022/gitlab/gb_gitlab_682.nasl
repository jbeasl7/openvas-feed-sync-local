...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-13 18:43:00 +0000 (Wed, 13 Jul 2022)");
  ...
  script_tag(name:"insight", value:"GitLab allows an attacker with the appropriate access tokens
  to obtain CI variables in a group with using IP-based access restrictions even if the GitLab
  Runner is calling from outside the allowed IP range.");
