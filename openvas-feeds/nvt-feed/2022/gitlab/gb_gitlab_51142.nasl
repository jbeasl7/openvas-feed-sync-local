...
if (description)
{
  ...
  script_tag(name:"insight", value:"GitLab contains an issue which can be used by an attacker to
  make internal request to localhost i.e 127.0.0.1 and all local ip range.");

  script_tag(name:"affected", value:"GitLab version 5.3.x through 11.2.6, 11.3.x through 11.3.7
