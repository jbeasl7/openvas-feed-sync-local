...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-08-11 15:22:00 +0000 (Thu, 11 Aug 2022)");
  ...
  script_tag(name:"affected", value:"GitLab version 15.x through 15.0.4, 15.1.x through 15.1.3 and
  15.2.");
