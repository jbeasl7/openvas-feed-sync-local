...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-11 01:34:00 +0000 (Fri, 11 Nov 2022)");
  ...
  script_tag(name:"affected", value:"GitLab version 12.1.x and above prior to 15.3.5, 15.4.x prior
