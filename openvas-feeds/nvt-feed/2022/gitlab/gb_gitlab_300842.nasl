...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-08 17:38:00 +0000 (Fri, 08 Jul 2022)");
  ...
  script_tag(name:"affected", value:"GitLab prior to version 14.10.5, version 15.0.x through
  15.0.3 and 15.1.0.");
