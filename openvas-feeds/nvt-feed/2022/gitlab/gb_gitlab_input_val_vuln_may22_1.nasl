...
if (description)
{
  ...
  script_tag(name:"impact", value:"Improper input validation in GitLab CE/EE allows a Developer to
  read protected Group or Project CI/CD variables by importing a malicious project.");
