...
if (description)
{
  ...
  script_cve_id("CVE-2018-18644", "CVE-2018-18648");
  ...
  to provide an environment_id and prometheus_metric_id that doesn't belong to their project. When
  an alert persists that doesn't belong to their project, they can trigger it using the
  ...
  script_tag(name:"affected", value:"GitLab version 11.2.x through 11.2.6, 11.3.x through 11.3.7
  and 11.4.x through 11.4.2.");
