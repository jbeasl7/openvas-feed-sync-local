...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-13 17:43:00 +0000 (Wed, 13 Jul 2022)");
  ...
  script_tag(name:"insight", value:"GitLab allows an attacker to execute arbitrary JavaScript code
  in GitLab on a victim's behalf.");
