...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-11 19:45:00 +0000 (Mon, 11 Apr 2022)");

  script_cve_id("CVE-2022-1099", "CVE-2022-1120", "CVE-2022-1121", "CVE-2022-1157");
  ...
  script_tag(name:"affected", value:"GitLab prior to version 14.7.7, version 14.8.x prior to
