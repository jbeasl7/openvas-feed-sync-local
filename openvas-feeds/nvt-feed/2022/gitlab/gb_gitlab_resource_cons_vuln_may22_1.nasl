...
if (description)
{
  ...
  script_tag(name:"impact", value:"GitLab is not correctly handling malicious text in the CI
  Editor and CI Pipeline details page allowing the attacker to cause uncontrolled resource
  consumption.");
