...
if (description)
{
  ...
  script_tag(name:"insight", value:"Links in Security Reports & License Management are vulnerable
  to XSS attacks.");

  script_tag(name:"affected", value:"GitLab version 10.4.x through 11.2.6, 11.3.x through 11.3.7
