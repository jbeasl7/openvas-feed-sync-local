...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-11 01:55:00 +0000 (Fri, 11 Nov 2022)");
  ...
  script_tag(name:"impact", value:"An open redirect vulnerability in GitLab EE/CE allows an
  attacker to redirect users to an arbitrary location if they trust the URL.");

  script_tag(name:"affected", value:"GitLab version 9.4.x and above prior to 15.3.5, 15.4.x prior
