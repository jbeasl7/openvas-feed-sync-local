...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-11 01:37:00 +0000 (Fri, 11 Nov 2022)");
  ...
  script_tag(name:"impact", value:"An improper authorization issue in GitLab CE/EE allows a
  malicious users to set emojis on internal notes they don't have access to.");

  script_tag(name:"affected", value:"GitLab version 15.x and above prior to 15.3.5, 15.4.x prior
