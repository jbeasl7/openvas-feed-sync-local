...
if (description)
{
  ...
  script_tag(name:"summary", value:"GitLab is prone to a cleartext storage of sensitive
  ...
  script_tag(name:"affected", value:"GitLab version 8.10.x through 11.2.6, 11.3.x through 11.3.7
