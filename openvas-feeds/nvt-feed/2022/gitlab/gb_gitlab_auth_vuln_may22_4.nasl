...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-05-18 19:42:34 +0000 (Wed, 18 May 2022)");

  script_cve_id("CVE-2022-1545");
  ...
  script_tag(name:"affected", value:"GitLab version 13.2 through 14.8.5, 14.9.x through 14.9.3 and
  version 14.10.0.");
