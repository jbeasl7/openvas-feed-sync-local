...
if (description)
{
  ...
  - CVE-2017-0916: GitLab is vulnerable to a lack of input validation in the system_hook_push queue
  through web hook component resulting in remote code execution.
  ...
  script_tag(name:"affected", value:"GitLab version 8.8.x through 10.1.5, 10.2.x through 10.2.5
  and 10.3.x through 10.3.3.");
