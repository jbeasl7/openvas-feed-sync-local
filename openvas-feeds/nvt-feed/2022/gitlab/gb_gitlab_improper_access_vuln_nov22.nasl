...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-11 01:06:00 +0000 (Fri, 11 Nov 2022)");
  ...
  script_tag(name:"summary", value:"GitLab is prone to an improper access control
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Bypass of healthcheck endpoint allow list allows an
  unauthorized attacker to prevent access to GitLab.");

  script_tag(name:"affected", value:"GitLab version 12.x and above prior to 15.3.5, 15.4.x prior
