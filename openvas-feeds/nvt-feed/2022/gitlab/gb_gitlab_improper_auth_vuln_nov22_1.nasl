...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-11 01:43:00 +0000 (Fri, 11 Nov 2022)");
  ...
  script_tag(name:"insight", value:"Improper authorization in GitLab allows a user retrying a job
  in a downstream pipeline to take ownership of the retried jobs in the upstream pipeline even if
  the user doesn't have access to that project.");

  script_tag(name:"affected", value:"GitLab version 7.14.x and above prior to 15.3.5, 15.4.x prior
