...
if (description)
{
  ...
  script_tag(name:"insight", value:"It was possible to trigger a timeout on a page with markdown
  by using a specific amount of block-quotes.");

  script_tag(name:"affected", value:"GitLab version 8.10.x through 14.5.3, 14.6.x through 14.6.3
  and 14.7.0.");
