...
if (description)
{
  ...
  script_tag(name:"insight", value:"The api to update an asset as a link from a release had a
  regex check which caused exponential number of backtracks for certain user supplied values
