...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-11 01:51:00 +0000 (Fri, 11 Nov 2022)");
  ...
  script_tag(name:"summary", value:"GitLab is prone to an incorrect authorization
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Incorrect authorization during display of Audit Events in
  GitLab EE allowed Developers to view the project's Audit Events and Developers or Maintainers to
  view the group's Audit Events. These should have been restricted to Project Maintainers, Group
  Owners, and above.");

  script_tag(name:"affected", value:"GitLab version 14.5.x and above prior to 15.3.5, 15.4.x prior
  to 15.4.4 and 15.5.x prior to 15.5.2.");
