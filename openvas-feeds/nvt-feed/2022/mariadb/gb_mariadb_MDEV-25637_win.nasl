...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-03-07 21:10:00 +0000 (Mon, 07 Mar 2022)");
  ...
  script_tag(name:"affected", value:"MariaDB versions prior 10.3.32, 10.4.x prior to 10.4.22, 10.5.x
  prior to 10.5.13 and 10.6.x prior to 10.6.5.");
