...
if (description)
{
  ...
  script_tag(name:"affected", value:"MariaDB versions prior to 10.5.17, 10.6.x prior to 10.6.9,
  10.7.x prior to 10.7.5, 10.8.x prior to 10.8.4 and 10.9.x prior to 10.9.2.");

  script_tag(name:"solution", value:"Update to version 10.5.17, 10.6.9, 10.7.5, 10.8.4, 10.9.2 or
  later.");
...
if (version_is_less(version: version, test_version: "10.5.17")) {
