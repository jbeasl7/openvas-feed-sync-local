...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-11 17:13:00 +0000 (Mon, 11 Jul 2022)");
  ...
  script_name("MariaDB Multiple DoS Vulnerabilities (MDEV-24176, MDEV-26407, MDEV-26437) - Windows");
  ...
  # nb: There are a few duplicates attached to these so only the most prominent are used here
