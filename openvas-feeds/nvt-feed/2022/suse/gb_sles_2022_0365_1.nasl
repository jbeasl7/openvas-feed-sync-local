...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220365-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195009");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195065");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195184");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195254");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010211.html");
...
- net: sch_generic: avoid concurrent reset and enqueue op for lockless qdisc (bsc#1183405).
