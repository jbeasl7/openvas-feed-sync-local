...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-202214938-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198062");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010689.html");
...
- CVE-2022-1271: Fixed an incorrect escaping of malicious filenames (ZDI-CAN-16587). (bsc#1198062)");
  ...
  script_tag(name:"affected", value:"'xz' package(s) on SUSE Linux Enterprise Server 11-SP4.");
