...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-04-26 19:39:58 +0000 (Mon, 26 Apr 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224252-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1119562");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142681");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185002");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189338");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/013131.html");
...
- CVE-2021-29473: Fixed out-of-bounds read in Exiv2::Jp2Image:doWriteMetadata (bsc#1186231).");
  ...
  script_tag(name:"affected", value:"'exiv2' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
