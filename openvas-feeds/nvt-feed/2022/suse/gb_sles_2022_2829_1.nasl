...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222829-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199223");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199224");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200735");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200737");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011931.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libcurl4-32bit", rpm:"libcurl4-32bit~7.60.0~150000.33.1", rls:"SLES15.0"))) {
    report += res;
  }
