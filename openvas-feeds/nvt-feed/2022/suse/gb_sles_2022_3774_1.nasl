...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223774-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202593");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204383");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012702.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libcurl4-32bit", rpm:"libcurl4-32bit~7.60.0~150000.38.1", rls:"SLES15.0"))) {
    report += res;
  }
