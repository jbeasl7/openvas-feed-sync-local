...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-28 16:41:02 +0000 (Thu, 28 Jul 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220134-3.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193907");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193913");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012546.html");
...
- CVE-2021-41496: Fixed buffer overflow that could lead to DoS in array_from_pyobj function of fortranobject.c (bsc#1193907).");
  ...
  script_tag(name:"affected", value:"'python-numpy' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
