...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222057-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200363");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200364");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011271.html");
...
(CVE-2022-30790, bsc#1200364)");
  ...
  script_tag(name:"affected", value:"'u-boot' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
