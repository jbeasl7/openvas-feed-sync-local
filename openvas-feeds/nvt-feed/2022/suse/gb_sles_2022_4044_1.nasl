...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224044-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177083");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/012962.html");
 ...
 * updated vectors for the cryptography 2.9.2 testing");
  ...
  script_tag(name:"affected", value:"'python-cryptography, python-cryptography-vectors' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
