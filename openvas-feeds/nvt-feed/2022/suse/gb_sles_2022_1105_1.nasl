...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221105-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1081947");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1082293");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1084671");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1085196");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1106214");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1122417");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1125886");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1135534");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1135708");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1151708");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1168235");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1168389");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1169006");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172427");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174942");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1175514");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1175623");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178236");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178554");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178825");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188921");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194642");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010653.html");
...
- Fix warning on mounts to CIFS with mount -a. (bsc#1174942)");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
