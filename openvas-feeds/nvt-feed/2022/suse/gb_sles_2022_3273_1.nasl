...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223273-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200793");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201758");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202645");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2022-September/025151.html");
...
* New:
 ...
 - Voila! Support for images containing ICC v4 profiles is
 enabled on macOS.
 ...
 Windows will automatically unload tabs ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'MozillaFirefox' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
