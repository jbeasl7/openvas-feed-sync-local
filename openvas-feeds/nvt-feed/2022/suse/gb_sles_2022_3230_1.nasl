...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-20 15:01:19 +0000 (Thu, 20 Jan 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223230-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194633");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012198.html");
...
- CVE-2021-44648: Fixed overflow vulnerability in lzw code size (bsc#1194633).");
  ...
  script_tag(name:"affected", value:"'gdk-pixbuf' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
