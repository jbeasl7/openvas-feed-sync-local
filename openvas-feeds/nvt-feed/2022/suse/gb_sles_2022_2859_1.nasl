...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222859-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201840");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011953.html");
...
- CVE-2022-29154: Fixed an arbitrary file write issue that could be
 triggered by a malicious remote server (bsc#1201840).");
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
