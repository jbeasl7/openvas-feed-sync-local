...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222410-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198581");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-July/011559.html");
...
- rebuild with new secure boot key due to grub2 boothole 3 issues (bsc#1198581)");
  ...
  script_tag(name:"affected", value:"'crash' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
