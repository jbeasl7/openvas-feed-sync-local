...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224593-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181961");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-December/013297.html");
...
- CVE-2021-20206: Fixed arbitrary path injection via type field in CNI configuration (bsc#1181961).");
  ...
  script_tag(name:"affected", value:"'cni-plugins' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
