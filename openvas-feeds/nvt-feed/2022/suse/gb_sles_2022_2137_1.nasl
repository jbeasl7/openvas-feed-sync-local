...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222137-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1151558");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190535");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196338");
  script_xref(name:"URL", value:"https://github.com/prometheus/procfs/pull/343");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011313.html");
...
- Update to 1.1.2
 * Bug fixes
 + Handle errors from ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'golang-github-prometheus-node_exporter' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
