...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220712-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194610");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194611");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010349.html");
...
- CVE-2021-43860: A malicious repository could have sent invalid application metadata in a way that hides some of the app permissions displayed during installation (bsc#1194610).");

  script_tag(name:"affected", value:"'flatpak' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
