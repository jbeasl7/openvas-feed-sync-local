...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223942-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193625");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196852");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/013175.html");
...
- Recognize ppc64p7 arch to build for power7");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
