...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221686-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172456");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183723");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187055");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191647");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191958");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194625");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196018");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196247");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197075");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197343");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197391");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197663");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197888");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197914");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198217");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198413");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198516");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198687");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198742");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/011035.html");
...
- CVE-2022-1353: Fixed access control to kernel memory in the pfkey_register function in net/key/af_key.c (bnc#1198516).
