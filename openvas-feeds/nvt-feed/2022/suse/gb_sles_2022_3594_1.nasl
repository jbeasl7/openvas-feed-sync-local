...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223594-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1175144");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182282");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192115");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198035");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198037");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198038");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012542.html");
...
- CVE-2022-35414: Fixed an uninitialized read during address translation that leads to a crash. (bsc#1201367)");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
