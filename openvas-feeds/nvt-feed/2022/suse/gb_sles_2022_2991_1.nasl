...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222991-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198752");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200800");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201680");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012060.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtirpc3-32bit", rpm:"libtirpc3-32bit~1.0.2~150000.3.18.1", rls:"SLES15.0"))) {
    report += res;
  }
