...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223590-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185768");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012537.html");
...
- CVE-2021-42771: Fixed relative path traversal (bsc#1185768).");
  ...
  script_tag(name:"affected", value:"'python-Babel' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
