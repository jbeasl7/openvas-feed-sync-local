...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221512-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188160");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188161");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190375");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193035");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198441");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/010920.html");
...
- CVE-2021-31799: Fixed a command injection vulnerability in RDoc (bsc#1190375).");
  ...
  script_tag(name:"affected", value:"'ruby2.5' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
