...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-01-15 15:32:12 +0000 (Fri, 15 Jan 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223093-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181058");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012106.html");
...
- CVE-2021-21241: Fixed an issue where GET requests lacking CSRF
 ...
 authentication token (bsc#1181058).");
  ...
  script_tag(name:"affected", value:"'python-Flask-Security-Too' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
