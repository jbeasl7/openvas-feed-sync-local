...
if(description)
{
  ...
  script_cve_id("CVE-2020-25721", "CVE-2020-29361", "CVE-2021-20316", "CVE-2021-43566", "CVE-2021-44141", "CVE-2021-44142", "CVE-2022-0336");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220323-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1089938");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1139519");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158916");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180064");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182058");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191227");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192505");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192684");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193533");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193690");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194859");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195048");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010181.html");
...
- CVE-2021-44141: Information leak via symlinks of existence of
...
- Reorganize libs packages. Split samba-libs into samba-client-libs,
 ...
 packages as there were dependency problems every time one of these
...
- Fix multiple integer overflows in rpc code ... [Please see the references for more information on the vulnerabilities]");
