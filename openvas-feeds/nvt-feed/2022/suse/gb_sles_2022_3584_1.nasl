...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223584-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203424");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203462");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203552");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203769");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203933");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203935");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203987");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012540.html");
...
- cifs: fix uninitialized pointer in error ... [Please see the references for more information on the vulnerabilities]");
