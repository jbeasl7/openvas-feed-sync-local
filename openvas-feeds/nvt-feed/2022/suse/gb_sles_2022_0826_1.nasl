...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220826-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182637");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189492");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190775");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010431.html");
...
- Add 'ldap_ignore_unreadable_references' parameter to skip unreadable objects referenced by 'member' attributte (bsc#1190775).");
  ...
  script_tag(name:"affected", value:"'sssd' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sssd-32bit", rpm:"sssd-32bit~1.16.1~8.64.1", rls:"SLES15.0"))) {
    report += res;
  }
