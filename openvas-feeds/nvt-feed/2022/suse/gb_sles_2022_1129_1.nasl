...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221129-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140205");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/971617");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/980504");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010666.html");
...
- CVE-2022-1122: Fixed segmentation fault in opj2_decompress due to uninitialized pointer (bsc#1197738).");
  ...
  script_tag(name:"affected", value:"'openjpeg2' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
