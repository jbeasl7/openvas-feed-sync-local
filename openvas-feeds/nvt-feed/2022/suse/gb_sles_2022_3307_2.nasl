...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223307-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189802");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195773");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201783");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/012802.html");
...
Update to ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'sqlite3' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsqlite3-0-32bit", rpm:"libsqlite3-0-32bit~3.39.3~150000.3.17.1", rls:"SLES15.0"))) {
    report += res;
  }
