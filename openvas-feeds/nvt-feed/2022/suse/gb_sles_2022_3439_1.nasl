...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223439-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191507");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012403.html");
...
- CVE-2021-41133: Fixed sandbox bypass via recent syscalls (bsc#1191507).");
  ...
  script_tag(name:"affected", value:"'flatpak' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
