...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-21 13:57:37 +0000 (Fri, 21 Jan 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220493-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194731");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010270.html");
...
- CVE-2022-20698: Fixed invalid pointer read allowing denial of service crash. (bsc#1194731)");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
