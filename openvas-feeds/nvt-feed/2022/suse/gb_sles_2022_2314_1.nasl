...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222314-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1051798");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1068678");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1080238");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1082318");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101642");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1110456");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160414");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178288");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178490");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182653");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188039");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199061");
  script_xref(name:"URL", value:"https://github.com/rsyslog/rsyslog/issues/1494");
  script_xref(name:"URL", value:"https://github.com/rsyslog/rsyslog/issues/1508");
  ...
  script_xref(name:"URL", value:"https://github.com/rsyslog/rsyslog/pull/1520");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-July/011439.html");
 ...
 * NOTE: the prime new feature is support for TLS and non-TLS connections
 via imtcp in parallel. Furthermore, most TLS parameters can now be overridden
 ...
 * 2021-06-14: new global option 'parser.supportCompressionExtension'
 ...
 closes [link moved to references]
 ...
 * new ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'rsyslog' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
