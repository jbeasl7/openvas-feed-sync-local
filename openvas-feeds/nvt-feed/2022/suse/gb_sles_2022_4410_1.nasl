...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224410-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202802");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-December/013216.html");
...
- CVE-2021-42523: Fixed a small memory leak in sqlite3_exec (bsc#1202802).");
  ...
  script_tag(name:"affected", value:"'colord' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
