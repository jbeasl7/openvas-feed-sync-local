...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223456-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201770");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012445.html");
...
- CVE-2014-9862: Fixed arbitrary write on heap vulnerability (bsc#1201770).");
  ...
  script_tag(name:"affected", value:"'libostree' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
