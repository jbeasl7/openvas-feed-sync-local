...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221771-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198383");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199240");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/011114.html");
...
- Fixed issue with SASL init that crashed slapd at startup under certain conditions (bsc#1198383).");
  ...
  script_tag(name:"affected", value:"'openldap2' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
