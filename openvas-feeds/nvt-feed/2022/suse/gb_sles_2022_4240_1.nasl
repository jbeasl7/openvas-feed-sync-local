...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224240-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197998");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203201");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204986");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/013119.html");
  ...
  script_tag(name:"insight", value:"- CVE-2022-43995: Fixed a potential heap-based buffer over-read when entering a password of seven characters or fewer and using the crypt() password backend (bsc#1204986).
...
- Change sudo-ldap schema from ASCII to UTF8 (bsc#1197998).");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
