...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220498-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195054");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195217");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010268.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libexpat1-32bit", rpm:"libexpat1-32bit~2.2.5~3.12.1", rls:"SLES15.0"))) {
    report += res;
  }
