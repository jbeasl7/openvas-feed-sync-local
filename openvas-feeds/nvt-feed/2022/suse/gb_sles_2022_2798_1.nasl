...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222798-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1164472");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011907.html");
...
- CVE-2020-24330: Fixed a potential tss user to root privilege
 escalation issue (bsc#1164472).");
  ...
  script_tag(name:"affected", value:"'trousers' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
