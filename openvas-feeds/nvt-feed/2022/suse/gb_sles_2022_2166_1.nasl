...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222166-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1070738");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198511");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199441");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011339.html");
...
- CVE-2015-20107: avoid command injection in the mailcap module (bsc#1198511).");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
