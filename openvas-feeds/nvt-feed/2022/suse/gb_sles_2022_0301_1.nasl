...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220301-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2022-February/021588.html");
...
- CVE-2020-28935: Fixed symbolic link traversal when writing PID file (bsc#1179191).");
  ...
  script_tag(name:"affected", value:"'unbound' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
