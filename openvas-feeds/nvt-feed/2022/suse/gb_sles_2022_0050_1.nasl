...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220050-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027353");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1081164");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102775");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1108471");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1111122");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1116807");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140341");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1145864");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1152968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174961");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178021");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178351");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179009");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179699");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181591");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-January/009993.html");
...
- CVE-2018-18065: Fix remote DoS in agent/helpers/table.c (bsc#1111122)");
  ...
  script_tag(name:"affected", value:"'net-snmp' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
