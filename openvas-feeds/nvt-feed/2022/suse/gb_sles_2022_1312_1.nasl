...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-12 17:49:03 +0000 (Tue, 12 Apr 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221312-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181201");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181202");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198001");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010794.html");
...
- CVE-2021-33657: Fixed a Heap overflow problem in video/SDL_pixels.c. (bsc#1198001)");
  ...
  script_tag(name:"affected", value:"'SDL' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
