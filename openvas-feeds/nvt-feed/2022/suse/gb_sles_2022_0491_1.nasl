...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220491-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194767");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010252.html");
...
- CVE-2022-21658: Fixed race condition in std::fs::remove_dir_all (bsc#1194767).");
  ...
  script_tag(name:"affected", value:"'rust' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
