...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222716-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198458");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011839.html");
...
- mokutil --set-sbat-policy (latest <pipe> previous <pipe> delete)
...
- mokutil --list-sbat-revocations
 ...
 To list the current SBAT revocations.");
  ...
  script_tag(name:"affected", value:"'mokutil' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
