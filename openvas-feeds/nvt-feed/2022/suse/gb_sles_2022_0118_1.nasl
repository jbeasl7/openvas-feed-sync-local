...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220118-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193907");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193913");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-January/010024.html");
...
- CVE-2021-41496: Fixed buffer overflow that could lead to DoS in array_from_pyobj function of fortranobject.c (bsc#1193907).");
  ...
  script_tag(name:"affected", value:"'python-numpy' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
