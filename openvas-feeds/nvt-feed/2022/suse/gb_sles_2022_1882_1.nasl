...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221882-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195964");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195965");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197066");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197068");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197072");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197073");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197074");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197631");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/011182.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff5-32bit", rpm:"libtiff5-32bit~4.0.9~150000.45.8.1", rls:"SLES15.0"))) {
    report += res;
  }
