...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224573-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-December/013280.html");
...
- CVE-2022-3621: Fixed null pointer dereference in ... [Please see the references for more information on the vulnerabilities]");
