...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-18 17:15:29 +0000 (Mon, 18 Oct 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222855-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188917");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189368");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191601");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191602");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201325");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201326");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201327");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201328");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011954.html");
...
- CVE-2022-32212: Fixed a DNS rebinding issue caused by improper IPv4
 validation (bsc#1201328).");
  ...
  script_tag(name:"affected", value:"'nodejs10' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
