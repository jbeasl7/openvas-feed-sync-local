...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222987-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198166");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202368");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012053.html");
...
- CVE-2022-2625: Fixed an issue where extension scripts would replace objects not belonging to that extension (bsc#1202368).");
  ...
  script_tag(name:"affected", value:"'postgresql13' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
