...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221041-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1114649");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1122756");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149746");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149747");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158256");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158305");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1170809");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177364");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177378");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177380");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191957");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191992");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192000");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192005");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010580.html");
...
- Fixes segmentation fault in 'pkcs11-tool.c'. (bsc#1114649)");
  ...
  script_tag(name:"affected", value:"'opensc' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
