...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222140-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190535");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196338");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011315.html");
...
- Capture permission denied error for 'energy_uj' file (bsc#1190535)");
  ...
  script_tag(name:"affected", value:"'node_exporter' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
