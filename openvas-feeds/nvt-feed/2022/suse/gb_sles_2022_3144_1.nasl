...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223144-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201225");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012160.html");
...
- CVE-2022-34903: Fixed a potential signature forgery via injection
 into the status line when certain unusual conditions are met (bsc#1201225).");
  ...
  script_tag(name:"affected", value:"'gpg2' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
