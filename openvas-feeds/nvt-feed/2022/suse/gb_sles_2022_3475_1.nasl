...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-09-07 12:41:23 +0000 (Wed, 07 Sep 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223475-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202915");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012459.html");
...
- CVE-2020-35538: Fixed null pointer dereference in jcopy_sample_rows() function (bsc#1202915).");
  ...
  script_tag(name:"affected", value:"'libjpeg-turbo' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
