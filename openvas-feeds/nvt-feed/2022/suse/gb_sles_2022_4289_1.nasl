...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224289-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174414");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/013158.html");
...
- CVE-2019-2708: Fixed partial DoS due to data store execution (bsc#1174414).");
  ...
  script_tag(name:"affected", value:"'libdb-4_8' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
