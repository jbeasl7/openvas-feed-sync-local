...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222553-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185923");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186654");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200907");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-July/011655.html");
...
- CVE-2021-33620: Fixed DoS in HTTP Response processing (bsc#1185923, bsc#1186654)");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
