...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-11 18:58:07 +0000 (Wed, 11 Aug 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223674-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181050");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203651");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012595.html");
 ...
 - Fixed failures to remove btrfs snapshots (bsc#1203651).");
  ...
  script_tag(name:"affected", value:"'clone-master-clean-up' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
