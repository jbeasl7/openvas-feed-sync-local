...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222029-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196147");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196148");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196150");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011256.html");
...
- CVE-2022-25310: Fixed NULL pointer dereference in fribidi_remove_bidi_marks (bsc#1196150).");
  ...
  script_tag(name:"affected", value:"'fribidi' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libfribidi0-32bit", rpm:"libfribidi0-32bit~0.19.6~150000.3.3.1", rls:"SLES15.0"))) {
    report += res;
  }
