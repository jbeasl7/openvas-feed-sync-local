...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-11-21 14:50:07 +0000 (Sun, 21 Nov 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221751-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192953");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195786");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199459");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199470");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/011100.html");
...
- CVE-2021-33139, CVE-2021-33155: Improper conditions check in the firmware for some Intel Wireless Bluetooth and Killer Bluetooth products may allow an authenticated user to potentially cause denial of service via adjacent access.");
  ...
  script_tag(name:"affected", value:"'kernel-firmware' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
