...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222181-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200550");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011352.html");
...
- CVE-2022-2068: Fixed more shell code injection issues in c_rehash. (bsc#1200550)");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
