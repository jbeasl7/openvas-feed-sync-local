...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221108-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010651.html");
...
- Avoid segfault on PowerPC systems with valid hardware configurations. (bsc#1175623, bsc#1178554, bsc#1178825)
...
- Fix warning on mounts to CIFS with mount -a. (SG#57988, bsc#1174942)");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libblkid1-32bit", rpm:"libblkid1-32bit~2.31.1~150000.9.18.2", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmount1-32bit", rpm:"libmount1-32bit~2.31.1~150000.9.18.2", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libuuid1-32bit", rpm:"libuuid1-32bit~2.31.1~150000.9.18.2", rls:"SLES15.0"))) {
    report += res;
  }
