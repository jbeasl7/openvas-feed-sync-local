...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223386-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196177");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196180");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012376.html");
...
- CVE-2022-0529: Fixed heap out-of-bound writes and reads during conversion of wide string to local string (bsc#1196180).");
  ...
  script_tag(name:"affected", value:"'unzip' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
