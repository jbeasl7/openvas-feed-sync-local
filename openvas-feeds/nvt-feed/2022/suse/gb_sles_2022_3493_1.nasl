...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223493-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171685");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012482.html");
...
- CVE-2020-12825: Fixed recursion issue in block and any productions (bsc#1171685).");
  ...
  script_tag(name:"affected", value:"'libcroco' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libcroco-0_6-3-32bit", rpm:"libcroco-0_6-3-32bit~0.6.12~150000.4.6.2", rls:"SLES15.0"))) {
    report += res;
  }
