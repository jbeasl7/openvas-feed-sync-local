...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221012-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195908");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195949");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010561.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 41 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2022:1012-1 advisory.");
...
- CVE-2022-0492: Fixed a privilege escalation related to cgroups v1 release_agent feature, which allowed bypassing namespace isolation unexpectedly (bsc#1195543).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 41 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
