...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220895-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1118088");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179534");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184177");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193752");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010467.html");
...
- CVE-2018-19787: Fixed a potential XSS due to improper input sanitization (bsc#1118088).");
  ...
  script_tag(name:"affected", value:"'python-lxml' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
