...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222077-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011285.html");
...
- CVE-2017-13695: Fixed a bug that ... [Please see the references for more information on the vulnerabilities]");
