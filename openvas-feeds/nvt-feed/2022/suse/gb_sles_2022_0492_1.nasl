...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220492-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194471");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010267.html");
...
- CVE-2021-45079: Fixed authentication bypass in EAP authentication. (bsc#1194471)");
  ...
  script_tag(name:"affected", value:"'strongswan' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
