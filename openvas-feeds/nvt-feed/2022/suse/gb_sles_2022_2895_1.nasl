...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222895-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178903");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011991.html");
...
- CVE-2020-25713: Fixed an out of bounds access triggered via a
 malformed input file (bsc#1178903).");
  ...
  script_tag(name:"affected", value:"'raptor' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
