...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-29 02:57:56 +0000 (Fri, 29 Jul 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222669-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188514");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201830");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011801.html");
...
- CVE-2021-36978: Fixed heap-based buffer overflow in Pl_ASCII85Decoder::write (bsc#1188514).");
  ...
  script_tag(name:"affected", value:"'qpdf' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
