...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221289-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183709");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197872");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010784.html");
...
- CVE-2022-0934: Fixed an invalid memory access that could lead to remote denial
 of service via crafted packet (bsc#1197872).");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
