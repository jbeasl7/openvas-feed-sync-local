...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-202214909-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184751");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184752");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010438.html");
...
- CVE-2021-30498: Fixed a memory corruption issue when exporting TGA images (bsc#1184752).");
  ...
  script_tag(name:"affected", value:"'libcaca' package(s) on SUSE Linux Enterprise Server 11-SP4.");
