...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222134-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181223");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181400");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190462");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190535");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193600");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194873");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195726");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195727");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195728");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196338");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196704");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197507");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197689");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011316.html");
 ...
 * Removed
 ...
 Fix nvme collector ... [Please see the references for more information on the vulnerabilities]");
