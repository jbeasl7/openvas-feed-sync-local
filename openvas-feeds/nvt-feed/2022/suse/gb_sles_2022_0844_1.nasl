...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220844-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196025");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196784");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010445.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libexpat1-32bit", rpm:"libexpat1-32bit~2.2.5~3.19.1", rls:"SLES15.0"))) {
    report += res;
  }
