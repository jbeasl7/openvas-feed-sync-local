...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222341-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192051");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199460");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199565");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200088");
  ...
  script_xref(name:"URL", value:"https://github.com/opencontainers/runc/releases/tag/v1.1.0-rc.1");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-July/011489.html");
...
Update ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'containerd, docker and runc' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
