...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222103-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198776");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011299.html");
...
- CVE-2022-1975: Fixed a bug that ... [Please see the references for more information on the vulnerabilities]");
