...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221932-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1080985");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1092500");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142041");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198106");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011232.html");
  ...
  script_tag(name:"insight", value:"- CVE-2019-13636: Fixed mishandled following of symlinks in certain cases other than input files (bsc#1142041).
...
- Fix temporary file leak when applying ed-style patches (bsc#1092500).");
  ...
  script_tag(name:"affected", value:"'patch' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
