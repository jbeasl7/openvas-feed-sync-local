...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220176-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1076963");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1112009");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1112033");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179191");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185382");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185383");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185384");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185385");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185386");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185387");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185388");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185389");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185390");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185391");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185392");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185393");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-January/010064.html");
...
- CVE-2020-28935: Fixed symbolic link traversal when writing PID file (bsc#1179191).");
  ...
  script_tag(name:"affected", value:"'unbound' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
