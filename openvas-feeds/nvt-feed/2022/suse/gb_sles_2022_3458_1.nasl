...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223458-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1021387");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1052900");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181400");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187678");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187686");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/786024");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/971784");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012444.html");
...
- Allowed sendto() syscall when /dev/log support is enabled (bsc#786024).");
  ...
  script_tag(name:"affected", value:"'vsftpd' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
