...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224591-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204703");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205302");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-December/013295.html");
...
- CVE-2022-3676: A security vulnerability was fixed in version 7.1.5.15, adding the reference here.");
  ...
  script_tag(name:"affected", value:"'java-1_7_1-ibm' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
