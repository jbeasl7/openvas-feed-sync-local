...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222015-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142649");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1161913");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177947");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178675");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185395");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011253.html");
...
- Fixed an issue with exception handling on s390x (bsc#1161913).");
  ...
  script_tag(name:"affected", value:"'gcc48' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
