...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220802-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196490");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010416.html");
...
- CVE-2022-23308: Fixed a use-after-free of ID and IDREF attributes (bsc#1196490).");
  ...
  script_tag(name:"affected", value:"'python-libxml2-python' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
