...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223269-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198166");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200437");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202368");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012228.html");
...
- Pin to llvm13 until the next patchlevel update (bsc#1198166)");
  ...
  script_tag(name:"affected", value:"'postgresql14' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
