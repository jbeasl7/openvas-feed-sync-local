...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220366-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-February/010214.html");
...
- CVE-2021-28715: Fixed issue with xen/netback to do not queue unlimited ... [Please see the references for more information on the vulnerabilities]");
