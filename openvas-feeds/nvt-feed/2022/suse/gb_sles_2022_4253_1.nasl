...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224253-1.html");
  script_xref(name:"URL", value:"http://www.busybox.net/news.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1029961");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1064976");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1064978");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1069412");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1099260");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1099263");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102912");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121426");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121428");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184522");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191514");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192869");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/914660");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/951562");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/970662");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/970663");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/991940");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/013126.html");
...
- Add ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'busybox' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
