...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20224154-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189929");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205126");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-November/013053.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"krb5-32bit", rpm:"krb5-32bit~1.15.2~150000.6.17.1", rls:"SLES15.0"))) {
    report += res;
  }
