...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221652-1.html");
...
- CVE-2022-1304: Fixed out-of-bounds read/write leading to segmentation fault
 and possibly arbitrary code execution. (bsc#1198446)");
  ...
  script_tag(name:"affected", value:"'e2fsprogs' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
