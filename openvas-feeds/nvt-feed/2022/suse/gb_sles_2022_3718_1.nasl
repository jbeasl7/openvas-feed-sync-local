...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-11-30 18:57:41 +0000 (Tue, 30 Nov 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223718-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1013885");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193237");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012661.html");
 ...
 - CVE-2016-9803: Fixed memory leak (bsc#1013885).");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
