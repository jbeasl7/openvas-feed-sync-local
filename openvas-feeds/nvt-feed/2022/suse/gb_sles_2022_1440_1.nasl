...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221440-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197211");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197335");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197344");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010856.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 39 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2022:1440-1 advisory.");
...
- CVE-2021-39713: Fixed a race condition in the network scheduling subsystem which could lead to a use-after-free (bsc#1197211).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 39 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
