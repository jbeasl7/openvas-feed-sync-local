...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223690-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201723");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201971");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202026");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202466");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202467");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202468");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202971");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202973");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012599.html");
...
- CVE-2022-34526: Fixed stack overflow in the _TIFFVGetField function of Tiffsplit (bsc#1202026).");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff5-32bit", rpm:"libtiff5-32bit~4.0.9~150000.45.16.1", rls:"SLES15.0"))) {
    report += res;
  }
