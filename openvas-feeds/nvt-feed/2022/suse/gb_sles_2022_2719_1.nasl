...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222719-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1103269");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1114648");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190812");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200644");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200651");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200910");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201196");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201381");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201651");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201930");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201940");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201954");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201958");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/011833.html");
...
- Drop qla2xxx patch which prevented nvme port discovery (bsc#1200651 bsc#1200644 bsc#1201954 bsc#1201958)
...
- hex2bin: fix access beyond string ... [Please see the references for more information on the vulnerabilities]");
