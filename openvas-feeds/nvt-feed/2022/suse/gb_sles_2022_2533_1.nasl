...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-01-03 21:12:13 +0000 (Tue, 03 Jan 2023)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222533-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192079");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192080");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192086");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192087");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192228");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198486");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200027");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-July/011637.html");
...
- Add Telia Root ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'mozilla-nss' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libfreebl3-32bit", rpm:"libfreebl3-32bit~3.79~150000.3.74.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libfreebl3-hmac-32bit", rpm:"libfreebl3-hmac-32bit~3.79~150000.3.74.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoftokn3-32bit", rpm:"libsoftokn3-32bit~3.79~150000.3.74.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoftokn3-hmac-32bit", rpm:"libsoftokn3-hmac-32bit~3.79~150000.3.74.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mozilla-nspr-32bit", rpm:"mozilla-nspr-32bit~4.34~150000.3.23.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozilla-nss-32bit", rpm:"mozilla-nss-32bit~3.79~150000.3.74.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozilla-nss-certs-32bit", rpm:"mozilla-nss-certs-32bit~3.79~150000.3.74.1", rls:"SLES15.0"))) {
    report += res;
  }
