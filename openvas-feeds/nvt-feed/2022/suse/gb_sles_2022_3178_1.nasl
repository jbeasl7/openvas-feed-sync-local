...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-03 20:43:34 +0000 (Mon, 03 May 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223178-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176460");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180816");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180942");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181119");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181935");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183684");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187725");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188061");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193585");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197963");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199528");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200142");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200591");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200970");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201003");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1202614");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012182.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Important security update for SUSE Manager Client Tools' package(s) announced via the SUSE-SU-2022:3178-1 advisory.");
 ...
 * Log in before listing channels. (bsc#1197963, bsc#1193585)");
  ...
  script_tag(name:"affected", value:"'Important security update for SUSE Manager Client Tools' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
