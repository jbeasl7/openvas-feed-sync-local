...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-03-18 19:52:15 +0000 (Fri, 18 Mar 2022)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221678-1.html");
  script_xref(name:"URL", value:"https://blog.gradle.org/alignment-with-gradle-module-metadata");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177616");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182481");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197132");
  ...
  script_tag(name:"insight", value:"This update for jackson-databind, jackson-dataformats-binary, jackson-annotations, jackson-bom, jackson-core fixes the following issues:
...
jackson-core - update from version 2.10.2 to version 2.13.0:
 ...
 'JsonParser'
 + Replace 'JsonGenerator.writeObject()' (and ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'jackson-annotations, jackson-bom, jackson-core, jackson-databind, jackson-dataformats-binary' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
