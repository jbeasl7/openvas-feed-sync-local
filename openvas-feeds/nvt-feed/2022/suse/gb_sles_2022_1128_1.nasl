...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221128-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184501");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189622");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194848");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195485");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-April/010668.html");
...
- try to keep packages from a cycle close together in the
