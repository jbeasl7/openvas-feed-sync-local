...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221886-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191959");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192735");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192741");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193316");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/011201.html");
...
- CVE-2021-42096: Add protection against remote privilege escalation via csrf_token derived from admin password (bsc#1191959).");
  ...
  script_tag(name:"affected", value:"'mailman' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
