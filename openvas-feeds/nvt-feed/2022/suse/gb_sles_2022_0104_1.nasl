...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220104-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181201");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181202");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-January/010015.html");
...
- CVE-2020-14410: Fixed heap-based buffer over-read in Blit_3or4_to_3or4__inversed_rgb in video/SDL_blit_N.c via a crafted .BMP (bsc#1181201).");
  ...
  script_tag(name:"affected", value:"'SDL2' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
