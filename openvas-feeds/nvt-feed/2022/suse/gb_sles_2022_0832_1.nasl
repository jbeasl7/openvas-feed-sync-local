...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220832-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193625");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194640");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194768");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194770");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1195560");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010437.html");
...
- Fix pthread_rwlock_try*lock stalls (bsc#1195560)");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-32bit", rpm:"glibc-32bit~2.26~13.65.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-devel-32bit", rpm:"glibc-devel-32bit~2.26~13.65.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-locale-base-32bit", rpm:"glibc-locale-base-32bit~2.26~13.65.1", rls:"SLES15.0"))) {
    report += res;
  }
