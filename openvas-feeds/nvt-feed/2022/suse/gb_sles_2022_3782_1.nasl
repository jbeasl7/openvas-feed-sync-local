...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223782-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1036968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1036969");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-October/012717.html");
 ...
 - CVE-2017-8372: Fixed assertion failure in layer3.c (bsc#1036969).");
  ...
  script_tag(name:"affected", value:"'libmad' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
