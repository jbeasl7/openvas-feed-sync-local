...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20221689-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193930");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196441");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197284");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197517");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-May/011030.html");
...
- CVE-2021-43565: Fixed a panic in golang.org/x/crypto by empty plaintext packet (bsc#1193930).");
  ...
  script_tag(name:"affected", value:"'containerd, docker' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
