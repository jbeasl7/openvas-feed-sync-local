...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20223140-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1193951");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-September/012159.html");
...
- CVE-2020-21913: Fixed a memory safety issue that could lead to use
 after free (bsc#1193951).");
  ...
  script_tag(name:"affected", value:"'icu' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
