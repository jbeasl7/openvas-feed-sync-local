...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222074-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198495");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198496");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198581");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-June/011278.html");
...
- Use boot disks in OpenFirmware, fixing regression caused when the root LV is completely in the boot LUN (bsc#1197948)");
  ...
  script_tag(name:"affected", value:"'grub2' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
