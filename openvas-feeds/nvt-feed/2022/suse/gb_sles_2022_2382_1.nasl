...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222382-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194013");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1196964");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1197170");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199482");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199487");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1199657");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200343");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200571");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200599");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200600");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200604");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200605");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200608");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200619");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200692");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200762");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200806");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200807");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200809");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200810");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200813");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200820");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200821");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200822");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200829");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200868");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200869");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200870");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200871");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200872");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200873");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200925");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201080");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201251");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-July/011539.html");
...
- CVE-2022-2318: Fixed a use-after-free vulnerability in the timer handler in net/rose/rose_timer.c that allow attackers to crash the system without any privileges (bsc#1201251).
...
- ext4: fix race condition between ext4_write and ext4_convert_inline_data ... [Please see the references for more information on the vulnerabilities]");
