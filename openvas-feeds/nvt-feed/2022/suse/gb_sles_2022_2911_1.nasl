...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20222911-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201688");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201693");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201702");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201704");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201706");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201707");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1201708");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-August/012002.html");
...
- CVE-2022-2122: Fixed integer overflows in qtdemux using zlib (bsc#1201708).");
  ...
  script_tag(name:"affected", value:"'gstreamer-plugins-good' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
