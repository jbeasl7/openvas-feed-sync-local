...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-29 19:43:25 +0000 (Mon, 29 Apr 2019)");
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"60.6.1esr-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"60.6.1esr-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
