...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.6-i586-2", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"wpa_supplicant", ver:"2.6-x86_64-2", rls:"SLKcurrent"))) {
    report += res;
  }
