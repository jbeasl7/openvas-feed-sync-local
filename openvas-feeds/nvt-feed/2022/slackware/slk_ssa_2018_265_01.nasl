...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-04 13:59:52 +0000 (Tue, 04 Dec 2018)");
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"60.2.1esr-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"60.2.1esr-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
