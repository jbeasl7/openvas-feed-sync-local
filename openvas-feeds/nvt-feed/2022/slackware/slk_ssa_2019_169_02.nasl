...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"60.7.1esr-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"60.7.1esr-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
