...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3008-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3008-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssl");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DLA-3008-1 advisory.");
