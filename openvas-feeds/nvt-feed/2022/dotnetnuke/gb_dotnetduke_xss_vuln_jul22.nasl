...
if(description)
{
  ...
  script_name("DNN (DotNetNuke) <= 9.10.2 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"DNN (formerly DotNetNuke) is prone to a cross-site scripting
  (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"User profile biography section allows remote authenticated
  user to inject JavaScript and/or HTML via a crafted payload.");

  script_tag(name:"affected", value:"DNN version 9.10.2 and prior.");
