...
if(description)
{
  ...
  script_name("DNN (DotNetNuke) < 9.1.1 RCE Vulnerability");
  ...
  script_tag(name:"summary", value:"DNN (formerly DotNetNuke) is prone to a remote code execution
  (RCE) vulnerability.");
  ...
  script_tag(name:"affected", value:"DNN prior to version 9.1.1.");
