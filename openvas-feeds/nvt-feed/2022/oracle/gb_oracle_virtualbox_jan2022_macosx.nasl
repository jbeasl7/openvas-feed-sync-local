...
if(description)
{
  ...
  script_name("Oracle VirtualBox Security Update (cpujan2022) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions 6.1.x prior to 6.1.32
  on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 6.1.32
  or later.");
