...
if(description)
{
  ...
  script_name("Oracle VirtualBox 6.1.x < 6.1.38 Security Update (cpuoct2022) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions 6.1.x prior to 6.1.38
  on Windows.");

  script_tag(name:"solution", value:"Update to version 6.1.38
  or later.");
