...
if(description)
{
  ...
  script_name("Oracle VirtualBox 6.1.x < 6.1.40 Security Update (cpuoct2022) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions 6.1.x prior to 6.1.40
  on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 6.1.40
  or later.");
