...
if(description)
{
  ...
  script_tag(name:"summary", value:"Dropbear is prone to an information disclosure vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An inconsistent failure delay that may lead to revealing valid
  usernames.");

  script_tag(name:"affected", value:"Dropbear versions 2011.54 through 2018.76.");
