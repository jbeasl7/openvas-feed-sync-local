...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) 7.x Multiple Vulnerabilities (Synology-SA-22:23) - Remote Known Vulnerable Versions Check");
  ...
  script_tag(name:"affected", value:"Synology DSM versions 7.0.x prior to 7.0.1-42218-6 and 7.1.x
  prior to 7.1.1-42962-3.");

  script_tag(name:"solution", value:"Update to version 7.0.1-42218-6, 7.1.1-42962-3 or later.");
...
# nb: 6.x and earlier is checked by VT 1.3.6.1.4.1.25623.1.0.170271
if (version !~ "^7\.[01]")
  exit(0);
