...
if(description)
{
  ...
  script_cve_id("CVE-2022-46880", "CVE-2022-46881", "CVE-2022-46882", "CVE-2022-46878");
  ...
  script_name("Mozilla Thunderbird Security Advisories (MFSA2022-51, MFSA2022-53) - Windows");
