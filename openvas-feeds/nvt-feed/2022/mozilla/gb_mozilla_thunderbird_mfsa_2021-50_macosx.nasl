...
if(description)
{
  ...
  script_cve_id("CVE-2021-38503", "CVE-2021-38504", "CVE-2021-43534", "CVE-2021-38506",
                ...
                "CVE-2021-38510", "CVE-2021-43529", "CVE-2021-43527");
  ...
  script_name("Mozilla Thunderbird Security Advisory (MFSA2021-50) - Mac OS X");
  ...
  - Opportunistic Encryption in HTTP2 could be used to bypass the Same-Origin-Policy on services
  hosted on other ports.
  ...
  - Download Protections were bypassed by .inetloc files on Mac OS X.
