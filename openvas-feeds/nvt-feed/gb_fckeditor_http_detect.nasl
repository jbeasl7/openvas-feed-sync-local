...
subdirs = make_list( "/", "/fckeditor", "/editor", "/admin/fckeditor", "/sites/all/modules/fckeditor",
                     "/resources/fckeditor", "/clientscript/fckeditor", "/wp-content/plugins/fckeditor-for-wordpress/fckeditor",
                     "/FCKeditor", "/inc/fckeditor", "/includes/fckeditor", "/include/fckeditor", "/modules/fckeditor",
                     "/plugins/fckeditor", "/HTMLEditor", "/admin/htmleditor", "/sites/all/modules/fckeditor/fckeditor",
                     "/vendor/plugins/fckeditor/public/javascripts", "/extensions/FCKeditor", "/extensions/FCKeditor/fckeditor" );
