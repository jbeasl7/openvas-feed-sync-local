...
if(description)
{
  ...
  script_name("Dolibarr ERP/CRM Detection (HTTP)");
  ...
  script_tag(name:"summary", value:"HTTP based detection of Dolibarr ERP/CRM.");
...
foreach dir( make_list_unique("/", "/dolibarr", "/dolibarr/htdocs", "/htdocs", http_cgi_dirs(port: port)) ) {
  ...
  # nb: The "<title>Login" and "dolibarr_logo.png" || "dolibarr.org" are missing a compare operator.
  # Please re-check this when touching this detection (TODO task: VTD-2216).
