...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-12 17:30:00 +0000 (Fri, 12 Apr 2019)");
  ...
  - CVE-2018-19201: The ModCP Profile Editor allows remote attackers to inject JavaScript via the
  'username' parameter

  - CVE-2018-19202: index.php allows remote attackers to inject JavaScript via the
  'upsetting[bburl]' parameter");
