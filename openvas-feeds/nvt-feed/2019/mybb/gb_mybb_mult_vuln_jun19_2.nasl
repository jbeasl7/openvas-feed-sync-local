...
if(description)
{
  ...
  script_tag(name:"severity_vector", value:"CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:C/C:H/I:H/A:N");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2019-06-20 12:46:00 +0000 (Thu, 20 Jun 2019)");
  ...
  - An attacker can exploit a parsing flaw in the Private Message / Post renderer that leads to
  [video] BBCode persistent XSS to take over any forum account, aka a nested video MyCode issue.
  (CVE-2019-12830)

  - An attacker can abuse a default behavior of MySQL on many systems (that leads to truncation of
  strings that are too long for a database column) to create a PHP shell in the cache directory of a
  targeted forum via a crafted XML import, aka theme import stylesheet name RCE. (CVE-2019-12831)
  ...
  script_tag(name:"solution", value:"Update to version 1.8.21 or later.");
