...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2025-03-14 19:09:12 +0000 (Fri, 14 Mar 2025)");

  script_name("Debian: Security Advisory (DLA-1841-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1841-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1841-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gpac' package(s) announced via the DLA-1841-1 advisory.");
