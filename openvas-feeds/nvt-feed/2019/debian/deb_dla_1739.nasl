...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-02 18:30:13 +0000 (Tue, 02 Apr 2019)");

  script_name("Debian: Security Advisory (DLA-1739-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1739-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1739-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rails' package(s) announced via the DLA-1739-1 advisory.");
