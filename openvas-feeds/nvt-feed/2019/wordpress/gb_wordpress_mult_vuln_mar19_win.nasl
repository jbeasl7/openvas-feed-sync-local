...
if(description)
{
  ...
  script_name("WordPress Multiple Vulnerabilities (Mar 2019) - Windows");
  ...
  script_tag(name:"summary", value:"WordPress is prone to a cross-site request forgery (CSRF)
  vulnerability in a comment form which leads to HTML injection and cross-site scripting (XSS)
  attacks.");
