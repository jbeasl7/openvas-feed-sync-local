...
if (description)
{
  ...
  script_tag(name:"summary", value:"Apache Atlas is prone to a stored cross-site scripting (XSS)
  ...
  script_tag(name:"solution", value:"Update to version 0.8.4, 1.2.0 or later.");
...
if (version_is_equal(version: version, test_version: "0.8.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.8.4");
