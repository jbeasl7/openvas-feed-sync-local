...
if(description)
{
  ...
  script_tag(name:"summary", value:"Adobe Acrobat Reader 2017 is prone to an information disclosure vulnerability.");
...
if(version_in_range(version:vers, test_version:"17.0", test_version2:"17.011.30120")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"17.011.30127 (2017.011.30127)", install_path:path);
