...
if(description)
{
  ...
  - CVE-2019-16391: Authenticated visitors may modify any published content and execute other
  modifications in the database.

  - CVE-2019-16392: XSS in prive/formulaires/login.php

  - CVE-2019-16393: Mishandled redirect URLs in ecrire/inc/headers.php with a %0D, %0A, or %20
  character

  - CVE-2019-16394: Information disclosure vulnerability");

  script_tag(name:"affected", value:"SPIP prior to version 3.1.11 and version 3.2.x prior to version
  3.2.5.");
