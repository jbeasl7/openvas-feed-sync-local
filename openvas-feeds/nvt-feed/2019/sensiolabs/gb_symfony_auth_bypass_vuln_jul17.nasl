...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-24 19:35:00 +0000 (Fri, 24 May 2019)");
  ...
  script_name("Symfony Authentication Bypass Vulnerability (Jul 2017)");
  ...
  script_tag(name:"summary", value:"Symfony is prone to an authentication bypass vulnerability.");
