...
if(description)
{
  ...
  script_tag(name:"summary", value:"A vulnerability in flashcanvas.swf in OpenEMR could allow an
  unauthenticated, remote attacker to conduct a cross-site scripting (XSS) attack on a targeted
  system.");
...
if (version_is_less(version: version, test_version: "5.0.1-6")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.0.1-6", install_path: location);
