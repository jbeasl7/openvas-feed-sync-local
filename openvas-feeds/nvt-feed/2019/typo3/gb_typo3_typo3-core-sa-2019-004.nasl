...
if (description)
{
  ...
  script_tag(name:"insight", value:"Failing to properly encode information from external sources,
  language pack handling in the install tool is vulnerable to cross-site scripting.");

  script_tag(name:"affected", value:"TYPO3 versions 9.2.0 through 9.5.3.");
