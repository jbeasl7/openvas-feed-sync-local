...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-hwe' package(s) announced via the USN-4096-1 advisory.");
...
memory).");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-aws-hwe' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.04.");
