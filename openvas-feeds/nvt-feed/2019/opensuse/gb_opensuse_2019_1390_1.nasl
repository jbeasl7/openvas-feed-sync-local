...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for wireshark (openSUSE-SU-2019:1390-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1390-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-05/msg00027.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wireshark'
  package(s) announced via the openSUSE-SU-2019:1390-1 advisory.");
