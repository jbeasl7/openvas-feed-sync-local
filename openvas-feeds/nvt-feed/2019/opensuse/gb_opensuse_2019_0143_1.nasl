...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python-python-gnupg (openSUSE-SU-2019:0143-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:0143-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-02/msg00008.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-python-gnupg'
  package(s) announced via the openSUSE-SU-2019:0143-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"python2-python-gnupg", rpm:"python2-python-gnupg~0.4.4~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-python-gnupg", rpm:"python3-python-gnupg~0.4.4~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
