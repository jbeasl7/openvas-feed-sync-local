...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for mutt (openSUSE-SU-2019:0052-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:0052-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-01/msg00018.html");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"mutt-doc", rpm:"mutt-doc~1.10.1~2.5.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mutt-lang", rpm:"mutt-lang~1.10.1~2.5.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mutt", rpm:"mutt~1.10.1~2.5.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mutt-debuginfo", rpm:"mutt-debuginfo~1.10.1~2.5.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mutt-debugsource", rpm:"mutt-debugsource~1.10.1~2.5.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
