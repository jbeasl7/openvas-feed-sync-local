...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for containerd, docker, docker-runc, go, go1.11, go1.12, golang-github-docker-libnetwork (openSUSE-SU-2019:1499-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1499-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-06/msg00011.html");
