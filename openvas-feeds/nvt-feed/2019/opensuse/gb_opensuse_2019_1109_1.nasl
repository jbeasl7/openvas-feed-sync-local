...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for libssh2_org (openSUSE-SU-2019:1109-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1109-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00003.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh2_org'
  package(s) announced via the openSUSE-SU-2019:1109-1 advisory.");
