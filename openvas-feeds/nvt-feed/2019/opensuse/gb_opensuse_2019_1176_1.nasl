...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-18 13:11:00 +0000 (Tue, 18 Dec 2018)");
  script_tag(name:"creation_date", value:"2019-04-09 02:01:07 +0000 (Tue, 09 Apr 2019)");
  script_name("openSUSE: Security Advisory for sysstat (openSUSE-SU-2019:1176-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1176-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00044.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sysstat'
  package(s) announced via the openSUSE-SU-2019:1176-1 advisory.");
