...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for rmt-server (openSUSE-SU-2019:0185-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:0185-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-02/msg00026.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rmt-server'
  package(s) announced via the openSUSE-SU-2019:0185-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"rmt-server", rpm:"rmt-server~1.1.1~lp150.2.12.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rmt-server-debuginfo", rpm:"rmt-server-debuginfo~1.1.1~lp150.2.12.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mt-server-pubcloud", rpm:"mt-server-pubcloud~1.1.1~lp150.2.12.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
