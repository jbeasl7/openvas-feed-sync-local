...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for openssl (openSUSE-SU-2019:1175-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1175-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00047.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl'
  package(s) announced via the openSUSE-SU-2019:1175-1 advisory.");
