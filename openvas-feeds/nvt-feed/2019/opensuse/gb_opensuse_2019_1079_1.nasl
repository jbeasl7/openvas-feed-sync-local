...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for containerd, docker, docker-runc, golang-github-docker-libnetwork, runc (openSUSE-SU-2019:1079-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1079-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-03/msg00044.html");
  ...
  package(s) announced via the openSUSE-SU-2019:1079-1 advisory.");
