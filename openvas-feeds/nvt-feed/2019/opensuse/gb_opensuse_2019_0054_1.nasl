...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for gitolite (openSUSE-SU-2019:0054-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:0054-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-01/msg00024.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gitolite'
  package(s) announced via the openSUSE-SU-2019:0054-1 advisory.");
...
if(release == "openSUSELeap42.3") {
  if(!isnull(res = isrpmvuln(pkg:"gitolite", rpm:"gitolite~3.6.11~4.6.1", rls:"openSUSELeap42.3"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"gitolite", rpm:"gitolite~3.6.11~lp150.2.6.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
