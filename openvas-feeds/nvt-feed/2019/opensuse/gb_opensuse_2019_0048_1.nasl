...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for irssi (openSUSE-SU-2019:0048-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:0048-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-01/msg00017.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'irssi'
  package(s) announced via the openSUSE-SU-2019:0048-1 advisory.");
