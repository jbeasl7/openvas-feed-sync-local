...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for MozillaFirefox (openSUSE-SU-2019:1077-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1077-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-03/msg00043.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox'
  package(s) announced via the openSUSE-SU-2019:1077-1 advisory.");
