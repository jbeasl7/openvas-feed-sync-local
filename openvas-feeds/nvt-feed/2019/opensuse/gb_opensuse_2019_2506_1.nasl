...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for xen (openSUSE-SU-2019:2506-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2506-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-11/msg00037.html");
