...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for glib2 (openSUSE-SU-2019:1650-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1650-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-06/msg00076.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2'
  package(s) announced via the openSUSE-SU-2019:1650-1 advisory.");
