...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for libcroco (openSUSE-SU-2019:1575-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1575-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-06/msg00043.html");
