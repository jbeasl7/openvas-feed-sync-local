...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for zstd (openSUSE-SU-2019:1952-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1952-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-08/msg00062.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zstd'
  package(s) announced via the openSUSE-SU-2019:1952-1 advisory.");
  ...
  * perf: Slightly faster compression speed when reusing a context by
  @cyan4973 (#1658)
