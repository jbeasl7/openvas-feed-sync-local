...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python-cryptography, python-pyOpenSSL (openSUSE-SU-2019:1104-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1104-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00014.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-cryptography, python-pyOpenSSL'
  package(s) announced via the openSUSE-SU-2019:1104-1 advisory.");
