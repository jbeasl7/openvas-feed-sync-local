...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for zypper, libzypp and libsolv (openSUSE-SU-2019:1927-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1927-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-08/msg00057.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zypper, libzypp and libsolv'
  package(s) announced via the openSUSE-SU-2019:1927-1 advisory.");
  ...
  - Does no longer fail service-refresh on an empty repoindex.xml
  (bsc#1116840).
