...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for live555 (openSUSE-SU-2019:1797-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1797-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-07/msg00044.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'live555'
  package(s) announced via the openSUSE-SU-2019:1797-1 advisory.");
