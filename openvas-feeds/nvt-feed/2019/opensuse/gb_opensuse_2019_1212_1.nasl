...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for dovecot23 (openSUSE-SU-2019:1212-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1212-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00060.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot23'
  package(s) announced via the openSUSE-SU-2019:1212-1 advisory.");
