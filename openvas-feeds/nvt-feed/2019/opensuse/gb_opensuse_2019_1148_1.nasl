...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for gd (openSUSE-SU-2019:1148-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1148-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00025.html");
