...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for Recommended (openSUSE-SU-2019:1174-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1174-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00045.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Recommended'
  package(s) announced via the openSUSE-SU-2019:1174-1 advisory.");
