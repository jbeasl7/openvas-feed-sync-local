...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for epiphany (openSUSE-SU-2019:2318-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2318-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-10/msg00043.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'epiphany'
  package(s) announced via the openSUSE-SU-2019:2318-1 advisory.");
