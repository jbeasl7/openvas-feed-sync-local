...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for libseccomp (openSUSE-SU-2019:2280-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:2280-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-10/msg00027.html");
