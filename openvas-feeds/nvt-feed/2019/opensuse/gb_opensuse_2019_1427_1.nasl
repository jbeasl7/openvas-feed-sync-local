...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-04-28 19:05:00 +0000 (Wed, 28 Apr 2021)");
  script_tag(name:"creation_date", value:"2019-05-22 02:01:27 +0000 (Wed, 22 May 2019)");
  script_name("openSUSE: Security Advisory for GraphicsMagick (openSUSE-SU-2019:1427-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1427-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-05/msg00051.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'GraphicsMagick'
  package(s) announced via the openSUSE-SU-2019:1427-1 advisory.");
