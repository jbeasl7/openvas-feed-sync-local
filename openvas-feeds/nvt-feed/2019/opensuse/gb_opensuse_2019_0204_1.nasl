...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for chromium (openSUSE-SU-2019:0204-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:0204-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-02/msg00043.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the openSUSE-SU-2019:0204-1 advisory.");
...
if(release == "openSUSELeap15.0") {
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~72.0.3626.96~lp150.2.41.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromedriver-debuginfo", rpm:"chromedriver-debuginfo~72.0.3626.96~lp150.2.41.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~72.0.3626.96~lp150.2.41.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-debuginfo", rpm:"chromium-debuginfo~72.0.3626.96~lp150.2.41.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-debugsource", rpm:"chromium-debugsource~72.0.3626.96~lp150.2.41.1", rls:"openSUSELeap15.0"))) {
    report += res;
  }
