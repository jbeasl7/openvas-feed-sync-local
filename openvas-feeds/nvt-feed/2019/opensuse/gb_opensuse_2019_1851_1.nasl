...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for kconfig, kdelibs4 (openSUSE-SU-2019:1851-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1851-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-08/msg00015.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kconfig, kdelibs4'
  package(s) announced via the openSUSE-SU-2019:1851-1 advisory.");
