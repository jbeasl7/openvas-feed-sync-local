...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for spamassassin (openSUSE-SU-2019:1831-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1831-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-08/msg00002.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spamassassin'
  package(s) announced via the openSUSE-SU-2019:1831-1 advisory.");
