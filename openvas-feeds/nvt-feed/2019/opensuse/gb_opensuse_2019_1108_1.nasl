...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for wireshark (openSUSE-SU-2019:1108-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2019:1108-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2019-04/msg00007.html");
