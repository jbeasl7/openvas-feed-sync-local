...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-07 13:52:00 +0000 (Wed, 07 Aug 2019)");
  ...
  script_name("Magento 2.1.x < 2.1.18, 2.2.x < 2.2.9, 2.3.x < 2.3.2 Multiple Vulnerabilities (Jun 2019)");
