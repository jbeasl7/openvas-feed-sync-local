...
if(description)
{
  ...
  script_name("Microsoft Defender DoS Vulnerability (Sep 2019)");
  ...
  script_tag(name:"insight", value:"The flaw exists as Microsoft Defender improperly
  handles files");
...
if(version_is_less(version:mpe_version, test_version:"1.1.16400.2")){
  report = report_fixed_ver(installed_version:mpe_version, fixed_version:"1.1.16400.2 or higher");
