...
if (version_is_less(version: vers, test_version: "2.2.0") ||
    version_in_range(version: vers, test_version: "2.2.0.beta1", test_version2: "2.2.0.beta6")) {
  report = report_fixed_ver(installed_version: vers, fixed_version: "2.2.0.beta7", install_path: infos["location"]);
