...
if (description)
{
  ...
  script_tag(name:"impact", value:"An attacker who is logged into OTRS as an agent with
  appropriate permissions may create a carefully crafted calendar appointment in order to cause
  execution of JavaScript in the context of OTRS.");

  script_tag(name:"affected", value:"OTRS versions 6.x prior to 6.0.18 and 7.x prior to 7.0.7.");
