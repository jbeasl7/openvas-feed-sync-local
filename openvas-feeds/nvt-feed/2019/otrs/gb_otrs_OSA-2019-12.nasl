...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-01-20 16:26:00 +0000 (Fri, 20 Jan 2023)");
  ...
  script_name("OTRS 5.x < 5.0.37, 6.x < 6.0.20, 7.x < 7.0.9 Information Disclosure Vulnerability");
  ...
  appropriate permissions can leverage OTRS tags in templates in order to disclose hashed user
  passwords.");

  script_tag(name:"affected", value:"OTRS versions 5.x through 5.0.36, 6.x through 6.0.19 and 7.x
  through 7.0.8.");
