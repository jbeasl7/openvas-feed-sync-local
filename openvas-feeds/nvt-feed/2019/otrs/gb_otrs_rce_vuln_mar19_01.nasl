...
if (description)
{
  ...
  script_name("OTRS 5.x <= 5.0.33, 6.x <= 6.0.15, 7.x <= 7.0.3 RCE Vulnerability");
  ...
  script_tag(name:"impact", value:"An attacker who is logged into OTRS as an agent or a customer
  user may upload a carefully crafted resource in order to cause execution of JavaScript in the
  context of OTRS.");

  script_tag(name:"affected", value:"OTRS versions 5.x through 5.0.33, 6.x through 6.0.15 and 7.x
  through 7.0.3.");

  script_tag(name:"solution", value:"Update to version 5.0.34, 6.0.16, 7.0.4 or later.");
...
if (version_in_range(version: version, test_version: "5.0.0", test_version2: "5.0.33")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.0.34", install_path: location);
