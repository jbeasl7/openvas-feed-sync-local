...
if (description)
{
  ...
  script_name("OTRS 6.x <= 6.0.16, 7.x <= 7.0.4 RCE Vulnerability");
  ...
  script_tag(name:"impact", value:"An attacker who is logged into OTRS as an admin user may
  manipulate the URL to cause execution of JavaScript in the context of OTRS.");

  script_tag(name:"affected", value:"OTRS versions 6.x through 6.0.16 and 7.xthrough 7.0.4.");

  script_tag(name:"solution", value:"Update to version 6.0.17, 7.0.5 or later.");
...
if (version_in_range(version: version, test_version: "6.0.0", test_version2: "6.0.16")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "6.0.17", install_path: location);
