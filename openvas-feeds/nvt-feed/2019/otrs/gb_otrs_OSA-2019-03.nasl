...
if (description)
{
  ...
  script_name("OTRS 7.x < 7.0.5 Information Disclosure Vulnerability (OSA-2019-03)");
  ...
  script_tag(name:"insight", value:"An attacker who is logged into OTRS as an agent or a customer
  user can use the search result screens to disclose information from invalid system entities.");

  script_tag(name:"affected", value:"OTRS versions 7.x prior to 7.0.5.");
