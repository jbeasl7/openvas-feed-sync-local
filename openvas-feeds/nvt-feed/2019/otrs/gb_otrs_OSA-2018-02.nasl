...
if (description)
{
  ...
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:L/UI:R/S:U/C:L/I:L/A:N");
  ...
  script_name("OTRS 6.x < 6.0.8 Privilege Escalation Vulnerability (OSA-2018-02)");
  ...
  ticket overview screen to disclose internal article information of their customer tickets.");

  script_tag(name:"affected", value:"OTRS versions 6.x prior to 6.0.8.");
