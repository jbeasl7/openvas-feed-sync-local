...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-10-08 14:06:00 +0000 (Tue, 08 Oct 2019)");
  ...
  script_tag(name:"insight", value:"The vulnerability is exploitable via the Search Term field in Site
