...
if (description)
{
  ...
  - Potential path traversal attacks where user-controllable input is being used to construct file
  paths which are  being used by include or require PHP statements.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"SugarCRM version 7.9 and 7.10.");
