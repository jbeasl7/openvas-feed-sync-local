...
if (description)
{
  ...
  script_tag(name:"summary", value:"Horde Groupware Webmail is prone to multiple
  vulnerabilities.");
  ...
  - CVE-2019-12094: Cross-site scripting (XSS)

  - CVE-2019-12095: Cross-site request forgery (CSRF) in treanBookmarkTags parameter");
