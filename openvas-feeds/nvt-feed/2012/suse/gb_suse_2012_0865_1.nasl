...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2012:0865-1");
  script_name("openSUSE: Security Advisory for update (openSUSE-SU-2012:0865-1)");
...
if(release == "openSUSE12.1") {
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~12.00~16.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opera-gtk", rpm:"opera-gtk~12.00~16.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opera-kde4", rpm:"opera-kde4~12.00~16.1", rls:"openSUSE12.1"))) {
    report += res;
  }
