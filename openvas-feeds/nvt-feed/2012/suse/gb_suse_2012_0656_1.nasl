...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2012:0656-1");
  script_name("openSUSE: Security Advisory for update (openSUSE-SU-2012:0656-1)");
...
if(release == "openSUSE12.1") {
  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-debuginfo", rpm:"chromium-debuginfo~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-debugsource", rpm:"chromium-debugsource~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-desktop-gnome", rpm:"chromium-desktop-gnome~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-desktop-kde", rpm:"chromium-desktop-kde~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-suid-helper", rpm:"chromium-suid-helper~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-suid-helper-debuginfo", rpm:"chromium-suid-helper-debuginfo~21.0.1145.0~1.23.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libv8-3", rpm:"libv8-3~3.11.3.0~1.27.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libv8-3-debuginfo", rpm:"libv8-3-debuginfo~3.11.3.0~1.27.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"v8-debugsource", rpm:"v8-debugsource~3.11.3.0~1.27.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"v8-devel", rpm:"v8-devel~3.11.3.0~1.27.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"v8-private-headers-devel", rpm:"v8-private-headers-devel~3.11.3.0~1.27.1", rls:"openSUSE12.1"))) {
    report += res;
  }
