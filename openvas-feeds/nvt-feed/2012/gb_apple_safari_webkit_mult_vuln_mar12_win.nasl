...
if(description)
{
  ...
  script_name("Apple Safari Webkit Multiple Vulnerabilities (Mar 2012) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/52419");
...
if(version_is_less(version:vers, test_version:"5.34.54.16")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"Safari 5.1.4 (5.34.54.16)", install_path:path);
