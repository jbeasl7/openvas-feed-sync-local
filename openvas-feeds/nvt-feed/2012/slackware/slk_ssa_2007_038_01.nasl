...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2007-038-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2007-038-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.476916");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the SSA:2007-038-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on Slackware 10.0, Slackware 10.1, Slackware 10.2, Slackware 11.0.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.24-i486-1_slack10.0", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.24-i486-1_slack10.1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.24-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.24-i486-1_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }
