...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2004-108-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2004-108-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2004&m=slackware-security.441503");
  script_xref(name:"URL", value:"http://www.rapid7.com/advisories/R7-0017.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpdump' package(s) announced via the SSA:2004-108-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'tcpdump' package(s) on Slackware 8.1, Slackware 9.0, Slackware 9.1, Slackware current.");
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"tcpdump", ver:"3.8.3-i386-1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"tcpdump", ver:"3.8.3-i386-1", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"tcpdump", ver:"3.8.3-i486-1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"tcpdump", ver:"3.8.3-i486-2", rls:"SLKcurrent"))) {
    report += res;
  }
