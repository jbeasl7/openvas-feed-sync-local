...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2008-061-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2008-061-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.445399");
  ...
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/2008/mfsa2008-12.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-thunderbird' package(s) announced via the SSA:2008-061-01 advisory.");
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.12-i686-1", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.12-i686-1", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.12-i686-1", rls:"SLK12.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.12-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }
