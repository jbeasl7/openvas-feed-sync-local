...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2007-320-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2007-320-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.447739");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the SSA:2007-320-01 advisory.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.27-i486-1_slack10.0", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.27-i486-1_slack10.1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.27-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.27-i486-1_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.27-i486-1_slack12.0", rls:"SLK12.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"samba", ver:"3.0.27-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
