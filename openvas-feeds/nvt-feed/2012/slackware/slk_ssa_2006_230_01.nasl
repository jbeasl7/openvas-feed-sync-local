...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2006-230-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2006-230-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2006&m=slackware-security.536600");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libtiff' package(s) announced via the SSA:2006-230-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'libtiff' package(s) on Slackware 9.0, Slackware 9.1, Slackware 10.0, Slackware 10.1, Slackware 10.2, Slackware current.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libtiff", ver:"3.8.2-i486-1_slack10.0", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libtiff", ver:"3.8.2-i486-1_slack10.1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libtiff", ver:"3.8.2-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libtiff", ver:"3.8.2-i386-1_slack9.0", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libtiff", ver:"3.8.2-i486-1_slack9.1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"libtiff", ver:"3.8.2-i486-2", rls:"SLKcurrent"))) {
    report += res;
  }
