...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2008-191-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2008-191-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.539239");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the SSA:2008-191-02 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on Slackware 8.1, Slackware 9.0, Slackware 9.1, Slackware 10.0, Slackware 10.1, Slackware 10.2, Slackware 11.0, Slackware 12.0, Slackware 12.1, Slackware current.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i486-1_slack10.0", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i486-1_slack10.1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i486-1_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.4.2_P1-i486-1_slack12.0", rls:"SLK12.0"))) {
    report += res;
  }
...
if(release == "SLK12.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.4.2_P1-i486-1_slack12.1", rls:"SLK12.1"))) {
    report += res;
  }
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i386-1_slack8.1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i386-1_slack9.0", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.5_P1-i486-1_slack9.1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.4.2_P1-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
