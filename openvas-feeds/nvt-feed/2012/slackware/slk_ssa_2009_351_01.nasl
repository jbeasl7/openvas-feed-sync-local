...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2009-351-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2009-351-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2010&m=slackware-security.423666");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-firefox' package(s) announced via the SSA:2009-351-01 advisory.");
...
if(release == "SLK12.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.0.16-i686-1", rls:"SLK12.2"))) {
    report += res;
  }
...
if(release == "SLK13.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.5.6-i686-1", rls:"SLK13.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.5.6-x86_64-1_slack13.0", rls:"SLK13.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.5.6-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.5.6-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
