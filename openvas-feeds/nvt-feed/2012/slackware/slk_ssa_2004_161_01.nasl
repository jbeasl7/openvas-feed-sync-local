...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2004-161-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2004-161-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2004&m=slackware-security.427370");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cvs' package(s) announced via the SSA:2004-161-01 advisory.");
 ...
 * A potential buffer overflow vulnerability in the server has been fixed.
 ...
 CAN-2004-0414. Please see <[link moved to references]> for more information.
 (* Security fix *)
+--------------------------+");
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cvs", ver:"1.11.17-i386-1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cvs", ver:"1.11.17-i386-1", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cvs", ver:"1.11.17-i486-1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cvs", ver:"1.11.17-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
