...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2008-312-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2008-312-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.406571");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups' package(s) announced via the SSA:2008-312-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Slackware 12.0, Slackware 12.1, Slackware current.");
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cups", ver:"1.3.9-i486-1_slack12.0", rls:"SLK12.0"))) {
    report += res;
  }
...
if(release == "SLK12.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cups", ver:"1.3.9-i486-1_slack12.1", rls:"SLK12.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"cups", ver:"1.3.9-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
