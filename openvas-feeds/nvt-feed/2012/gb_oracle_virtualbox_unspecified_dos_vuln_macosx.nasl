...
if(description)
{
  ...
  script_name("Oracle VirtualBox Unspecified Denial of Service Vulnerability - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox version 3.2, 4.0 and 4.1 on Mac OS X.");
