...
if(description)
{
  ...
  script_name("Apple Safari Webkit Multiple Vulnerabilities (May 2012) - Windows");
...
if(version_is_less(version:vers, test_version:"5.34.57.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"Safari 5.1.7 (5.34.57.2)", install_path:path);
