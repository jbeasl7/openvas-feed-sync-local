...
if(description)
{
  ...
  script_name("IOServer < 1.0.19.0 Multiple Directory Traversal Vulnerabilities - Active Check");
  ...
  script_mandatory_keys("IOServer/banner", "Host/runs_windows");

  script_tag(name:"summary", value:"IOServer is prone to multiple directory traversal
  vulnerabilities.");
  ...
  script_tag(name:"solution", value:"Update to version 1.0.19.0 or later.");
