...
if(description)
{
  ...
  script_name("Apple iTunes Multiple Vulnerabilities (HT5318) - Windows");
  ...
  - CVE-2012-0672: Memory corruption issue in WebKit

  - CVE-2012-0677: Apple iTunes fails to handle '.m3u' playlist, allowing to cause a heap overflow
  ...
  script_tag(name:"affected", value:"Apple iTunes prior to version 10.6.3 on Windows.");
...
if(version_is_less(version:version, test_version:"10.6.3.25")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"10.6.3.25", install_path:location);
