...
if(description)
{
  ...
  script_cve_id("CVE-2010-0682", "CVE-2011-3016", "CVE-2011-3021", "CVE-2011-3027",
                ...
                "CVE-2011-3090", "CVE-2011-3105", "CVE-2011-3913", "CVE-2011-3924",
                "CVE-2011-3926", "CVE-2011-3958", "CVE-2011-3966", "CVE-2011-3968",
                "CVE-2011-3969", "CVE-2011-3971", "CVE-2012-0683", "CVE-2012-1520",
  ...
  script_name("Apple iTunes Multiple Vulnerabilities (Sep 2012) - Windows");

  script_tag(name:"summary", value:"Apple iTunes is prone to multiple vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"For more details about the vulnerabilities refer to the links
  given below.");

  script_tag(name:"impact", value:"Successful exploitation could allow attackers to conduct
  spoofing attacks, disclose potentially sensitive information, bypass certain security
  restrictions, manipulate certain data and compromise a user's system.");

  script_tag(name:"affected", value:"Apple iTunes prior to version 10.7 (10.7.0.21) on Windows.");
...
if(version_is_less(version:version, test_version:"10.7.0.21")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"10.7.0.21", install_path:location);
