...
if(description)
{
  ...
  service or possibly execute arbitrary code or inject html code via unknown vectors.");
...
if(version_is_less(version:version, test_version:"10.6.0.40")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"10.6.0.40", install_path:location);
