...
if(description)
{
  ...
  script_dependencies("smb_reg_service_pack.nasl", "gb_microsoft_sharepoint_smb_login_detect.nasl",
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/55797");
