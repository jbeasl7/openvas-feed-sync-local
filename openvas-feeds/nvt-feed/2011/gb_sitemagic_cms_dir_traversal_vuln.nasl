...
General solution options are to upgrade to a newer release, disable respective features, remove the product or replace the product by another one.");
  ...
  script_tag(name:"summary", value:"Sitemagic CMS is prone to a directory traversal vulnerability.");
...
foreach dir( make_list_unique( "/Sitemagic", "/CMS", "/", http_cgi_dirs( port:port ) ) ) {
