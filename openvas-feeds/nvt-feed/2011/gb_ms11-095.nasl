...
if(description)
{
  ...
  script_name("Microsoft Windows Active Directory Remote Code Execution Vulnerability (2640045)");
  script_xref(name:"URL", value:"http://support.microsoft.com/kb/2626416");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/50959");
