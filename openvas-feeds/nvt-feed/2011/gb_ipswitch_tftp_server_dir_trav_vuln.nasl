...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/50890");
  ...
  script_tag(name:"summary", value:"Ipswitch TFTP Server is prone to a directory traversal vulnerability.");
