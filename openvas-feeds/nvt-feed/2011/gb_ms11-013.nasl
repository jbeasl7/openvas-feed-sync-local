...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/46130");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/46140");
  script_xref(name:"URL", value:"http://support.microsoft.com/kb/2478971");
  script_xref(name:"URL", value:"http://www.vupen.com/english/advisories/2011/0326");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2011/ms11-013");
  exit(0);
}
