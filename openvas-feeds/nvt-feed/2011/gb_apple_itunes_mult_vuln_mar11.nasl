...
if(description)
{
  ...
  script_cve_id("CVE-2011-0111", "CVE-2011-0112", "CVE-2011-0113", "CVE-2011-0114",
                ...
                "CVE-2011-0155", "CVE-2011-0156", "CVE-2011-0164", "CVE-2011-0165",
  ...
  script_tag(name:"impact", value:"Successful exploitation could allow attacker to cause denial of
  service or obtain system privileges during installation.");
...
if(version_is_less(version:version, test_version:"10.2.0.34")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"10.2.0.34", install_path:location);
