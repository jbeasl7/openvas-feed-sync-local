...
if(description)
{
  ...
  script_name("ManageEngine ServiceDesk Plus <= 8.0 Build 8011 'searchText' XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"ManageEngine ServiceDesk Plus is prone to a cross-site scripting
  (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to an input validation error in
  'SolutionSearch.do' when handling search action via a 'searchText' parameter.");
  ...
  script_tag(name:"solution", value:"Update to version 8.0 Build 8012 or later.");
