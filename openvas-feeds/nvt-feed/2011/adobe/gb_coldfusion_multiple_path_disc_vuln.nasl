...
if(description)
{
  ...
  script_name("Adobe ColdFusion Multiple Path Disclosure Vulnerabilities (Nov 2011)");
  ...
  script_xref(name:"URL", value:"https://seclists.org/fulldisclosure/2011/Nov/250");
  script_xref(name:"URL", value:"https://packetstorm.news/files/id/107017/");
  script_xref(name:"URL", value:"http://websecurity.com.ua/5377/");

  script_tag(name:"summary", value:"Adobe ColdFusion is prone to multiple path disclosure
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Sends a crafted HTTP GET request and checks the response.");

  script_tag(name:"insight", value:"The flaw is due to insufficient error checking, allows remote
  attackers to obtain sensitive information via a direct request to a .cfm file, which reveals the
