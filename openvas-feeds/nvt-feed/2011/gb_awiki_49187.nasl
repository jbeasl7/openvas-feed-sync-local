...
if(description)
{
  ...
  script_name("awiki <= 20100125 Multiple LFI Vulnerabilities - Active Check");
  ...
  script_tag(name:"summary", value:"awiki is prone to multiple local file include (LFI)
  ...
  process. This may allow the attacker to compromise the application and the host.");

  script_tag(name:"affected", value:"awiki version 20100125 and prior.");
...
foreach dir( make_list_unique( "/awiki", "/wiki", http_cgi_dirs( port:port ) ) ) {
