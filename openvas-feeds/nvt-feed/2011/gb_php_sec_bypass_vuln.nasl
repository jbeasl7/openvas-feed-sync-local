...
if(description)
{
  ...
  script_name("PHP < 5.2.15 Security Bypass Vulnerability");
  ...
  script_tag(name:"insight", value:"An error in 'extract()' function does not prevent the use of
  the 'EXTR_OVERWRITE' parameter to overwrite the GLOBALS superglobal array.");

  script_tag(name:"impact", value:"Successful exploitation could allows remote attackers to bypass
  intended access restrictions by modifying data structures that were not intended to depend on
  external input.");
