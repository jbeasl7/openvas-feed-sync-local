...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/25305");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/25307");
  ...
  script_tag(name:"insight", value:"The flaws are due to an error in the parsing of header
  information in skin files.");
