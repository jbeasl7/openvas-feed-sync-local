...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/24411");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2007/ms07-032");
...
if(dllVer)
{
  if(hotfix_check_sp(winVista:3) > 0)
  {
    if(version_is_less(version:dllVer, test_version:"6.0.6000.16470")){
          report = report_fixed_ver(installed_version:dllVer, fixed_version:"6.0.6000.16470");
