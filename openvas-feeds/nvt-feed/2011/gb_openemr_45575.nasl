...
if(description)
{
  ...
  script_name("OpenEMR <= 3.2.0 Multiple Input Validation Vulnerabilities");
  ...
  script_tag(name:"summary", value:"OpenEMR is prone to SQL injection (SQLi), HTML injection, and
  ...
  script_tag(name:"affected", value:"OpenEMR 3.2.0 is vulnerable, other versions may also be
  affected.");
...
if (version_is_less_equal(version: version, test_version: "3.2.0")) {
