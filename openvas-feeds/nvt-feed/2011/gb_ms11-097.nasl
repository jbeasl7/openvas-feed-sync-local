...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/50972");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2011/ms11-097");
  ...
  information or gain privileges when running with administrator privileges.");
