...
if(description)
{
  ...
  script_name("phpLDAPadmin 'functions.php' Remote PHP Code Injection Vulnerability - Active Check");
  ...
  script_tag(name:"summary", value:"phpLDAPadmin is prone to a remote PHP code-injection
  vulnerability.");
