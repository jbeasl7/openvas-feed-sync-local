...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"transmission-cli", ver:"1.06-0ubuntu6.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"transmission-gtk", ver:"1.06-0ubuntu6.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"transmission-cli", ver:"1.34-0ubuntu2.3", rls:"UBUNTU8.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"transmission-gtk", ver:"1.34-0ubuntu2.3", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"transmission-cli", ver:"1.51-0ubuntu3.1", rls:"UBUNTU9.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"transmission-gtk", ver:"1.51-0ubuntu3.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"transmission-cli", ver:"1.75-0ubuntu2.2", rls:"UBUNTU9.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"transmission-gtk", ver:"1.75-0ubuntu2.2", rls:"UBUNTU9.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"transmission-qt", ver:"1.75-0ubuntu2.2", rls:"UBUNTU9.10"))) {
    report += res;
  }
