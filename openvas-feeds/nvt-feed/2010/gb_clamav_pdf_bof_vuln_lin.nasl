...
if(description)
{
  ...
  script_name("ClamAV < 0.96.3 PDF File Processing DoS Vulnerability - Linux");
  ...
  arbitrary code on the system with clamd privileges or cause the application to crash.");

  script_tag(name:"affected", value:"ClamAV prior to version 0.96.3.");
...
if (version_is_less(version: version, test_version: "0.96.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.96.3", install_path: location);
