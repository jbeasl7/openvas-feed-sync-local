...
if(description)
{
  ...
  script_name("PHP 4.4.x < 4.4.9, 5.2.x < 5.2.8 DoS Vulnerability");
  ...
  because the application fails to handle certain file requests.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Attackers can exploit this issue to crash the affected
  application, denying service to legitimate users.");

  script_tag(name:"affected", value:"PHP versions 4.4.x prior to 4.4.9 and 5.2.x through 5.2.6.");

  script_tag(name:"solution", value:"Updates are available. Please see the references for more
  information.");

  script_xref(name:"URL", value:"https://web.archive.org/web/20081205004344/http://www.securityfocus.com/bid/31612");
...
if (version_in_range_exclusive(version: version, test_version_lo: "4.4.0", test_version_up: "4.4.9")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.4.9", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "5.2.0", test_version_up: "5.2.8")) {
