...
if(description)
{
  ...
  script_cve_id("CVE-2010-1387", "CVE-2010-1763", "CVE-2010-1769");
  ...
  script_tag(name:"summary", value:"Apple iTunes is prone to multiple unspecified
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An unspecified vulnerability exists in 'WebKit' within Apple
  iTunes.");

  script_tag(name:"affected", value:"Apple iTunes prior to version 9.2 (9.2.0.61).");
...
if(version_is_less(version:version, test_version:"9.2.0.61")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"9.2.0.61", install_path:location);
