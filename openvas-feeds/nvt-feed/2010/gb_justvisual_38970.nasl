...
if(description)
{
  ...
  script_name("justVisual <= 2.0 LFI Vulnerability");
  ...
  script_dependencies("find_service.nasl", "no404.nasl", "webmirror.nasl", "DDI_Directory_Scanner.nasl",
                      "gb_php_http_detect.nasl", "os_detection.nasl", "global_settings.nasl");
  script_require_ports("Services/www", 80);
  script_exclude_keys("Settings/disable_cgi_scanning");

  script_tag(name:"summary", value:"justVisual is prone to a local file include (LFI) vulnerability
  ...
  script_tag(name:"affected", value:"justVisual version 2.0 and prior.");
...
foreach dir( make_list_unique( "/jv/www", "/www", http_cgi_dirs( port:port ) ) ) {
  ...
  foreach file( keys( files ) ) {
    url = dir + "/index.php?p=../../../../../../../../../../" + files[file] + "%00";
