...
if(description)
{
  ...
  script_name("Tor 0.2.2.x < 0.2.2.7-alpha Clients Information Disclosure Vulnerability - Windows");
...
if(version =~ "^0\.2\.2\."){
  if(version_is_less(version:version, test_version:"0.2.2.7.alpha")){
    report = report_fixed_ver(installed_version:version, fixed_version:"0.2.2.7.alpha");
