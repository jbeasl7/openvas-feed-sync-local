...
if(description)
{
  ...
  script_name("Whizzy CMS <= 10.02 LFI Vulnerability");
  ...
  script_tag(name:"summary", value:"Whizzy CMS is prone to a local file include (LFI) vulnerability
  ...
  script_tag(name:"affected", value:"Whizzy CMS version 10.02 and prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/41703");
...
foreach dir (make_list_unique("/cms", "/whizzy", http_cgi_dirs(port: port))) {
  if (dir == "/")
    dir = "";
