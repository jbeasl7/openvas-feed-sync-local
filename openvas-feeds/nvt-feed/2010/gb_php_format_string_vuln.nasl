...
if(description)
{
  ...
  script_name("PHP 5.3.x < 5.3.4 Multiple Vulnerabilities");
  ...
  - CVE-2010-2950: An error in 'stream.c' in the phar extension, which allows attackers to obtain
  sensitive information.

  - CVE-2010-3436: An error in 'open_wrappers.c', allow remote attackers to bypass open_basedir
  restrictions via vectors related to the length of a filename.

  - CVE-2010-4156: An error in 'mb_strcut()' function in 'Libmbfl', allows context-dependent
  attackers to obtain potentially sensitive information via a large value of the third parameter
  (aka the length parameter).");

  script_tag(name:"impact", value:"Successful exploitation could allow attackers to obtain
  sensitive information and possibly execute arbitrary code via a crafted phar:// URI.");

  script_tag(name:"affected", value:"PHP version 5.3.x through 5.3.3.");
