...
if(description)
{
  ...
  script_name("Apple QuickTime Multiple Vulnerabilities (Dec 2010) - Windows");
  script_xref(name:"URL", value:"http://support.apple.com/kb/HT4447");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/45236");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/45237");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/45242");
