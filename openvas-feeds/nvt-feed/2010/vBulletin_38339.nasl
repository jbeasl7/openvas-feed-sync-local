...
if(description)
{
  ...
  script_name("vBulletin 4.0.2 Multiple XSS Vulnerabilities");

  script_xref(name:"URL", value:"https://web.archive.org/web/20200229193756/http://www.securityfocus.com/bid/38339");
