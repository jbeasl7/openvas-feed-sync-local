...
if(description)
{
  ...
  script_name("Acritum Femitter Server <= 1.03 Directory Traversal Vulnerability");
  ...
  script_tag(name:"affected", value:"Acritum Femitter Server version 1.03 and prior.");
