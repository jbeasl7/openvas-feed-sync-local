...
if(description)
{
  ...
  specially crafted HTML page in the context of the affected system and cause memory corruption.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37883");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37884");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37891");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37892");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37893");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37894");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/37895");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2010/ms10-002");
  exit(0);
}
