...
if(description)
{
  ...
  script_cve_id("CVE-2007-1700", "CVE-2007-1701");
  ...
  within the context of the affected webserver.");

  script_tag(name:"affected", value:"PHP versions 4.x prior to 4.4.5 and PHP 5.x prior to
  5.2.1.");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20070428024826/http://www.php-security.org/MOPB/MOPB-31-2007.html");
