...
if(description)
{
  ...
  script_name("Microsoft Local Security Authority Subsystem Service Privilege Elevation Vulnerability (983539)");
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2010/ms10-068");
  exit(0);
}
