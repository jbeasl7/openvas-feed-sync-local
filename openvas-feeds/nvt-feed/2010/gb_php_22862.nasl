...
if(description)
{
  ...
  script_name("PHP < 4.4.5, 5.x < 5.2.1 RCE Vulnerability");
  ...
  script_tag(name:"insight", value:"The shmop functions in PHP do not verify that their arguments
  ...
  script_tag(name:"affected", value:"PHP prior to version 4.4.5 and 5.x prior to 5.2.1.");

  script_tag(name:"solution", value:"Update to version 4.4.5, 5.2.1 or later.");

  script_xref(name:"URL", value:"https://web.archive.org/web/20181007042631/http://www.securityfocus.com/bid/22862");
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.2.0", test_version_up: "5.2.1")) {
