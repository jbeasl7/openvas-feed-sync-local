...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/39927");
  ...
  client or can execute an arbitrary code by tricking a user into connecting
  ...
  received from a POP3 or IMAP server. This can be exploited by an attacker
  ...
  - Microsoft Outlook Express 6 Service Pack 1 on Microsoft Windows 2K Service Pack 4 and prior

  - Microsoft Outlook Express 6 on Microsoft Windows XP Service Pack 3 and prior

  - Microsoft Windows 2K3 Service Pack 2 and prior

  - Microsoft Windows Live Mail on Microsoft Windows XP Service Pack 3 and prior

  - Microsoft Windows Vista Service Pack 1/2");

  script_tag(name:"qod_type", value:"registry");
  script_tag(name:"solution_type", value:"VendorFix");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2010/ms10-030");
  exit(0);
}
