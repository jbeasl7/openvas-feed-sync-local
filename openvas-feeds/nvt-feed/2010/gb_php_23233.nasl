...
if(description)
{
  ...
  script_name("PHP 4.x < 4.4.5, 5.x < 5.2.1 Multiple Integer Overflow Vulnerabilities");
  ...
  script_tag(name:"insight", value:"These vulnerabilities occur because PHP fails to ensure that
  integer values aren't overrun. Attackers may exploit this issue to cause a buffer-overflow and
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20110926032100/http://www.securityfocus.com/bid/23233");
