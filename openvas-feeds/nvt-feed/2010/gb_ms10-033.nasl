...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/40432");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/40464");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2010/ms10-033");
...
if(wme9Installed)
{
  ...
  if(dllVer)
  {
    if(version_in_range(version:dllVer, test_version:"9.0", test_version2:"9.0.0.3368")){
...
if(hotfix_check_sp(win2k:5) > 0)
{
  ...
  if(directXver =~ "^4\.09")
  {
    ...
    if(dllVer)
    {
      if(version_in_range(version:dllVer, test_version:"6.5", test_version2:"6.5.1.913")){
        security_message( port: 0, data: "The target host was found to be vulnerable" );
        exit(0);
      }
    }
...
else if(hotfix_check_sp(xp:4) > 0)
{
  ...
  if(dllVer)
  {
    if("Service Pack 2" >< SP)
    {
      if(version_in_range(version:dllVer, test_version:"6.5", test_version2:"6.5.2600.3664")){
        security_message( port: 0, data: "The target host was found to be vulnerable" );
        exit(0);
      }
    }
    ...
    {
      if(version_in_range(version:dllVer, test_version:"6.5", test_version2:"6.5.2600.5932")){
        security_message( port: 0, data: "The target host was found to be vulnerable" );
        exit(0);
      }
    }
...
if(hotfix_check_sp(win2003:3) > 0)
{
  ...
  if("Service Pack 2" >< SP)
  {
    ...
    if(directXver =~ "^4\.09")
    {
      ...
      if(dllVer)
      {
        if(version_in_range(version:dllVer, test_version:"6.5", test_version2:"6.5.3790.4659")){
          security_message( port: 0, data: "The target host was found to be vulnerable" );
          exit(0);
        }
      }
    ...
    if(dllVer)
    {
      if(version_in_range(version:dllVer, test_version:"10.0", test_version2:"10.0.0.4006")){
        security_message( port: 0, data: "The target host was found to be vulnerable" );
        exit(0);
      }
    }
