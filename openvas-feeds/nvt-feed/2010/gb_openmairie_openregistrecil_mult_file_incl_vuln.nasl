...
if(description)
{
  ...
  script_mandatory_keys("openmairie/open_registre/http/detected");
  ...
  script_tag(name:"summary", value:"openMairie openRegistreCIL is prone to multiple file inclusion
  vulnerabilities.");
