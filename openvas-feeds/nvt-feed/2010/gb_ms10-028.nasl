...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/39300");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/39302");
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2010/ms10-028");
