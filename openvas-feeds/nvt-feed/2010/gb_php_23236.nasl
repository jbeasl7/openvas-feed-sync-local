...
if(description)
{
  ...
  script_cve_id("CVE-2007-1889", "CVE-2007-1890");
  ...
  buffer overflow and to corrupt process memory.");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20181007042712/http://www.securityfocus.com/bid/23236");
