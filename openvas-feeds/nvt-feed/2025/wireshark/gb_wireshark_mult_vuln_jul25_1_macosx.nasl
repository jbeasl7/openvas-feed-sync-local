...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836560");
  ...
  script_name("Wireshark 3.6.x < 3.6.10, 4.0.x < 4.0.3 Multiple Vulnerabilities (Jul 2025) - Mac OS X");
