...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834853");
  ...
  script_name("Wireshark 3.6.x < 3.6.20, 4.0.x < 4.0.12, 4.2.0 Multiple Vulnerabilities (Jan 2025) - Linux");
