...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836465");
  script_version("2025-06-26T05:40:52+0000");
  script_cve_id("CVE-2025-6424", "CVE-2025-6425", "CVE-2025-6429", "CVE-2025-6426",
                "CVE-2025-6430");
  ...
  script_name("Mozilla Firefox ESR Security Update (mfsa_2025-53) - Mac OS X");
...
if(version_in_range_exclusive(version:vers, test_version_lo:"120.0", test_version_up:"128.12")) {
