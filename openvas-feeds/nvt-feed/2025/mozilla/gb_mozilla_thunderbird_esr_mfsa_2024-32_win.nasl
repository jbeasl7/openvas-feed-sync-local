...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834271");
  script_version("2025-03-12T05:38:19+0000");
  script_cve_id("CVE-2024-6601", "CVE-2024-6602", "CVE-2024-6603", "CVE-2024-6606",
                "CVE-2024-6607", "CVE-2024-6608", "CVE-2024-6609", "CVE-2024-6610",
                "CVE-2024-6611", "CVE-2024-6612", "CVE-2024-6613", "CVE-2024-6614",
                "CVE-2024-6615", "CVE-2024-6604", "CVE-2024-7652");
  ...
  script_tag(name:"creation_date", value:"2025-03-11 11:33:38 +0530 (Tue, 11 Mar 2025)");
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2024-32) - Windows");
  ...
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-32/");
