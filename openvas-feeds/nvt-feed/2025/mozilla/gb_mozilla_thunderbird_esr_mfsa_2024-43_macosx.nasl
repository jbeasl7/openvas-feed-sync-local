...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834474");
  script_version("2025-03-14T05:38:04+0000");
  script_cve_id("CVE-2024-8394", "CVE-2024-8385", "CVE-2024-8381", "CVE-2024-8382",
  ...
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2024-43) - Mac OS X");
  ...
  to run arbitrary code, conduct spoofing and denial of service attacks.");

  script_tag(name: "affected" , value:"Mozilla Thunderbird ESR prior to version
  128.2 on Mac OS X.");

  script_tag(name: "solution" , value:"Update to version 128.2 or later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-43/");
...
if(version_is_less(version:vers, test_version:"128.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.2", install_path:path);
