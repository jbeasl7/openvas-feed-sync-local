...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836182");
  script_version("2025-05-01T05:40:03+0000");
  script_cve_id("CVE-2025-2817", "CVE-2025-4082", "CVE-2025-4083", "CVE-2025-4087",
  ...
  script_name("Mozilla Firefox ESR Security Update (mfsa_2025-29) - Mac OS X");
...
if(version_in_range_exclusive(version:vers, test_version_lo:"120.0", test_version_up:"128.10")) {
