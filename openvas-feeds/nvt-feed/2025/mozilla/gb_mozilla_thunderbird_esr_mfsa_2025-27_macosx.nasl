...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836157");
  script_version("2025-04-22T10:32:18+0000");
  script_cve_id("CVE-2025-2830", "CVE-2025-3523");
  ...
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2025-27) - Mac OS X");
  ...
  script_tag(name: "solution" , value:"Update to version 128.9.2 or later.");
...
if(version_is_less(version:vers, test_version:"128.9.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.9.2", install_path:path);
