...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836463");
  script_version("2025-06-26T05:40:52+0000");
  script_cve_id("CVE-2025-6424", "CVE-2025-6425", "CVE-2025-6426", "CVE-2025-6427",
                "CVE-2025-6429", "CVE-2025-6430", "CVE-2025-6432", "CVE-2025-6433",
                "CVE-2025-6434", "CVE-2025-6435", "CVE-2025-6436");
  ...
  script_name("Mozilla Firefox Security Update (mfsa_2025-51) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 140 on
  Mac OS X.");
