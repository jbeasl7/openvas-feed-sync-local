...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834470");
  script_version("2025-01-09T06:16:22+0000");
  script_cve_id("CVE-2024-8385", "CVE-2024-8386", "CVE-2024-8387");
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-40) - Mac OS X");
  ...
  - CVE-2024-8387: Memory safety bugs");
  ...
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-40/");
