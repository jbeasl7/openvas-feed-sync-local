...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836380");
  script_version("2025-06-25T05:41:02+0000");
  script_cve_id("CVE-2025-5263", "CVE-2025-5264", "CVE-2025-5266", "CVE-2025-5267",
  ...
  script_name("Mozilla Firefox ESR Security Update (mfsa_2025-44) - Mac OS X");
