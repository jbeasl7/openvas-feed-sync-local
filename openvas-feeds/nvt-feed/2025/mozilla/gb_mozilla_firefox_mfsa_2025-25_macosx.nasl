...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836153");
  ...
  script_tag(name:"creation_date", value:"2025-04-17 09:54:27 +0530 (Thu, 17 Apr 2025)");
  script_name("Mozilla Firefox Security Update (mfsa_2025-25) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 137.0.2 on
  Mac OS X.");
