...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834472");
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-41) - Mac OS X");
  ...
  115.15 and 128.x prior to 128.2 on Mac OS X.");
