...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836372");
  script_version("2025-06-25T05:41:02+0000");
  script_cve_id("CVE-2025-5263", "CVE-2025-5264", "CVE-2025-5266", "CVE-2025-5270",
  ...
  script_name("Mozilla Firefox Security Update (mfsa_2025-42) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 139 on
  Mac OS X.");
