...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836342");
  ...
  script_name("Mozilla Firefox ESR Security Update (mfsa_2025-37) - Mac OS X");
...
if(version_in_range_exclusive(version:vers, test_version_lo:"120.0", test_version_up:"128.10.1")) {
