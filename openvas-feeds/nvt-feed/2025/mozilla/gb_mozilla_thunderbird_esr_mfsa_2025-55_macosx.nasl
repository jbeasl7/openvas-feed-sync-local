...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836476");
  script_version("2025-07-04T05:42:00+0000");
  script_cve_id("CVE-2025-6424", "CVE-2025-6425", "CVE-2025-6426", "CVE-2025-6429",
                "CVE-2025-6430");
  ...
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2025-55) - Mac OS X");
  ...
  script_tag(name: "solution" , value:"Update to version 128.12 or later.");
...
if(version_is_less(version:vers, test_version:"128.12")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.12", install_path:path);
