...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834990");
  ...
  script_cve_id("CVE-2025-1931", "CVE-2025-1933", "CVE-2025-1934", "CVE-2025-1942",
                ...
                "CVE-2025-1943", "CVE-2025-26695", "CVE-2025-26696");
  ...
  script_name("Mozilla Thunderbird Security Update (mfsa_2025-17) - Mac OS X");
