...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2174");
  ...
  script_name("Huawei EulerOS: Security Advisory for libxml2 (EulerOS-SA-2025-2174)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2174");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2174");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libxml2' package(s) announced via the EulerOS-SA-2025-2174 advisory.");
...
In libxml2 before 2.13.8 and 2.14.x before 2.14.2, out-of-bounds memory access can occur in the Python API (Python bindings) because of an incorrect return value. This occurs in xmlPythonFileRead and xmlPythonFileReadRaw because of a difference between bytes and characters.(CVE-2025-32414)");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.9.14~9.h10.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-libxml2", rpm:"python3-libxml2~2.9.14~9.h10.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
