...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1012");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-requests (EulerOS-SA-2025-1012)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1012");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1012");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-requests' package(s) announced via the EulerOS-SA-2025-1012 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-requests", rpm:"python3-requests~2.24.0~1.h4.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
