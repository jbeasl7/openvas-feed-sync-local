...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1446");
  ...
  script_name("Huawei EulerOS: Security Advisory for krb5 (EulerOS-SA-2025-1446)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1446");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1446");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'krb5' package(s) announced via the EulerOS-SA-2025-1446 advisory.");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.18~1.h15.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-client", rpm:"krb5-client~1.18~1.h15.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-libs", rpm:"krb5-libs~1.18~1.h15.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"krb5-server", rpm:"krb5-server~1.18~1.h15.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
