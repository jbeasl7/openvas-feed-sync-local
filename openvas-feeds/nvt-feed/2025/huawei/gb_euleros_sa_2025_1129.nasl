...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1129");
  ...
  script_name("Huawei EulerOS: Security Advisory for ruby (EulerOS-SA-2025-1129)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1129");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1129");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ruby' package(s) announced via the EulerOS-SA-2025-1129 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby", rpm:"ruby~2.5.1~98.h19.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ruby-irb", rpm:"ruby-irb~2.5.1~98.h19.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ruby-libs", rpm:"ruby-libs~2.5.1~98.h19.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
