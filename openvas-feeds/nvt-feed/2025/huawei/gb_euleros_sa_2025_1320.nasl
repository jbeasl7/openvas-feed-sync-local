...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1320");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg2 (EulerOS-SA-2025-1320)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1320");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1320");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg2' package(s) announced via the EulerOS-SA-2025-1320 advisory.");
...
A flaw was found in the OpenJPEG project. A heap buffer overflow condition may be triggered when certain options are specified while using the opj_decompress utility. This can lead to an application crash or other undefined behavior.(CVE-2024-56826)");
  ...
  script_tag(name:"affected", value:"'openjpeg2' package(s) on Huawei EulerOS V2.0SP13.");
...
if(release == "EULEROS-2.0SP13") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.5.0~2.h1.eulerosv2r13", rls:"EULEROS-2.0SP13"))) {
    report += res;
  }
