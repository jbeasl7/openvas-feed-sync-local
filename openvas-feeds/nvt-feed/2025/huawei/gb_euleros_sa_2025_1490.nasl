...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1490");
  script_cve_id("CVE-2023-52425", "CVE-2023-52426", "CVE-2024-45490", "CVE-2024-45491", "CVE-2024-45492", "CVE-2024-50602");
  ...
  script_name("Huawei EulerOS: Security Advisory for expat (EulerOS-SA-2025-1490)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1490");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1490");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2025-1490 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An issue was discovered in libexpat before 2.6.4. There is a crash within the XML_ResumeParser function because XML_StopParser can stop/suspend an unstarted parser.(CVE-2024-50602)
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.2.9~1.h15.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
