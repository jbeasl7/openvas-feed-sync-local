...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1438");
  ...
  script_name("Huawei EulerOS: Security Advisory for rsync (EulerOS-SA-2025-1438)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1438");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1438");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'rsync' package(s) announced via the EulerOS-SA-2025-1438 advisory.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.2.5~1.h5.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
