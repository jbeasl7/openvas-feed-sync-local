...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1282");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-jinja2 (EulerOS-SA-2025-1282)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1282");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1282");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-jinja2' package(s) announced via the EulerOS-SA-2025-1282 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-jinja2", rpm:"python3-jinja2~2.10~10.h4.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
