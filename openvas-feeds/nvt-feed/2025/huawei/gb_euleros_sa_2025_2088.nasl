...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2088");
  ...
  script_name("Huawei EulerOS: Security Advisory for sudo (EulerOS-SA-2025-2088)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2088");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2088");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sudo' package(s) announced via the EulerOS-SA-2025-2088 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.9.2~3.h25.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
