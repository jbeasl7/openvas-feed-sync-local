...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1934");
  ...
  script_name("Huawei EulerOS: Security Advisory for libsoup (EulerOS-SA-2025-1934)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1934");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1934");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsoup' package(s) announced via the EulerOS-SA-2025-1934 advisory.");
...
A vulnerability was found in the libsoup package. This flaw stems from its failure to correctly verify the termination of multipart HTTP messages. This can allow a remote attacker to send a specially crafted multipart HTTP body, causing the libsoup-consuming server to read beyond its allocated memory boundaries (out-of-bounds read).(CVE-2025-4969)");
  ...
  script_tag(name:"affected", value:"'libsoup' package(s) on Huawei EulerOS V2.0SP11.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoup", rpm:"libsoup~2.74.2~1.h9.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-help", rpm:"libsoup-help~2.74.2~1.h9.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
