...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1469");
  script_cve_id("CVE-2024-41957", "CVE-2024-41965", "CVE-2024-43374", "CVE-2024-43802", "CVE-2024-47814");
  ...
  script_name("Huawei EulerOS: Security Advisory for vim (EulerOS-SA-2025-1469)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1469");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1469");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'vim' package(s) announced via the EulerOS-SA-2025-1469 advisory.");
...
Vim is an improved version of the unix vi text editor. When flushing the typeahead buffer, Vim moves the current position in the typeahead buffer but does not check whether there is enough space left in the buffer to handle the next characters. So this may lead to the tb_off position within the typebuf variable to point outside of the ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vim-common", rpm:"vim-common~9.0~1.h7.r16.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-enhanced", rpm:"vim-enhanced~9.0~1.h7.r16.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-filesystem", rpm:"vim-filesystem~9.0~1.h7.r16.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-minimal", rpm:"vim-minimal~9.0~1.h7.r16.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
