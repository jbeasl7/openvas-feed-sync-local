...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1306");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-jinja2 (EulerOS-SA-2025-1306)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1306");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1306");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-jinja2' package(s) announced via the EulerOS-SA-2025-1306 advisory.");
...
Jinja is an extensible templating engine. In versions on the 3.x branch prior to 3.1.5, a bug in the Jinja compiler allows an attacker that controls both the content and filename of a template to execute arbitrary Python code, regardless of if Jinja's sandbox is used. To exploit the vulnerability, an attacker needs to control both the filename and the contents of a template. Whether that is the case depends on the type of application using Jinja. This vulnerability impacts users of applications which execute untrusted templates where the template author can also choose the template filename.(CVE-2024-56201)");
  ...
  script_tag(name:"affected", value:"'python-jinja2' package(s) on Huawei EulerOS V2.0SP12.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-jinja2", rpm:"python3-jinja2~3.0.3~2.h4.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
