...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1412");
  ...
  script_name("Huawei EulerOS: Security Advisory for elfutils (EulerOS-SA-2025-1412)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1412");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1412");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'elfutils' package(s) announced via the EulerOS-SA-2025-1412 advisory.");
...
A vulnerability, which was classified as problematic, has been found in GNU elfutils 0.192. This issue affects the function gelf_getsymshndx of the file strip.c of the component eu-strip. The manipulation leads to denial of service. The attack needs to be approached locally. The exploit has been disclosed to the public and may be used. The identifier of the patch is fbf1df9ca286de3323ae541973b08449f8d03aba. It is recommended to apply a patch to fix this issue.(CVE-2025-1377)");
  ...
  script_tag(name:"affected", value:"'elfutils' package(s) on Huawei EulerOS V2.0SP12.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"elfutils", rpm:"elfutils~0.185~17.h7.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
