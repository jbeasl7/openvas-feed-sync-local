...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1072");
  ...
  script_name("Huawei EulerOS: Security Advisory for unbound (EulerOS-SA-2025-1072)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1072");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1072");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'unbound' package(s) announced via the EulerOS-SA-2025-1072 advisory.");
...
if(release == "EULEROSVIRT-2.12.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-unbound", rpm:"python3-unbound~1.13.2~7.h4.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound", rpm:"unbound~1.13.2~7.h4.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound-libs", rpm:"unbound-libs~1.13.2~7.h4.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }
