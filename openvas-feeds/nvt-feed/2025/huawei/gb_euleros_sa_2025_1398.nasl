...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1398");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-jinja2 (EulerOS-SA-2025-1398)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1398");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1398");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-jinja2' package(s) announced via the EulerOS-SA-2025-1398 advisory.");
...
Jinja is an extensible templating engine. In versions on the 3.x branch prior to 3.1.5, a bug in the Jinja compiler allows an attacker that controls both the content and filename of a template to execute arbitrary Python code, regardless of if Jinja's sandbox is used. To exploit the vulnerability, an attacker needs to control both the filename and the contents of a template. Whether that is the case depends on the type of application using Jinja. This vulnerability impacts users of applications which execute untrusted templates where the template author can also choose the template filename. This vulnerability is fixed in 3.1.5.(CVE-2024-56201)");
  ...
  script_tag(name:"affected", value:"'python-jinja2' package(s) on Huawei EulerOS Virtualization release 2.10.0.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-jinja2", rpm:"python3-jinja2~2.11.2~1.h7.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
