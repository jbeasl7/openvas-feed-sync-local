...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1432");
  ...
  script_name("Huawei EulerOS: Security Advisory for openssl (EulerOS-SA-2025-1432)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1432");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1432");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openssl' package(s) announced via the EulerOS-SA-2025-1432 advisory.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssl", rpm:"openssl~1.1.1m~15.h50.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-libs", rpm:"openssl-libs~1.1.1m~15.h50.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-perl", rpm:"openssl-perl~1.1.1m~15.h50.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-pkcs11", rpm:"openssl-pkcs11~0.4.12~1.h1.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
