...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1569");
  ...
  script_name("Huawei EulerOS: Security Advisory for expat (EulerOS-SA-2025-1569)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1569");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1569");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2025-1569 advisory.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.4.1~8.h6.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
