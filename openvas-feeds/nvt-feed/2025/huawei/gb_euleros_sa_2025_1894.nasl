...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1894");
  script_cve_id("CVE-2024-56171", "CVE-2025-24928", "CVE-2025-27113", "CVE-2025-32414", "CVE-2025-32415");
  ...
  script_name("Huawei EulerOS: Security Advisory for libxml2 (EulerOS-SA-2025-1894)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1894");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1894");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libxml2' package(s) announced via the EulerOS-SA-2025-1894 advisory.");
...
libxml2 before 2.12.10 and 2.13.x before 2.13.6 has a use-after-free in xmlSchemaIDCFillNodeTables and xmlSchemaBubbleIDCNodeTables in xmlschemas.c. To exploit this, a crafted XML document must be validated against an XML schema with certain identity constraints, or a crafted XML schema must be used.(CVE-2024-56171)");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on Huawei EulerOS Virtualization release 2.12.1.");
...
if(release == "EULEROSVIRT-2.12.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.9.14~4.h26.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-libxml2", rpm:"python3-libxml2~2.9.14~4.h26.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }
