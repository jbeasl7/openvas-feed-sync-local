...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1511");
  ...
  script_name("Huawei EulerOS: Security Advisory for ghostscript (EulerOS-SA-2025-1511)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1511");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1511");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ghostscript' package(s) announced via the EulerOS-SA-2025-1511 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~9.52~4.h15.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ghostscript-help", rpm:"ghostscript-help~9.52~4.h15.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
