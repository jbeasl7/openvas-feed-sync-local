...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1660");
  ...
  script_name("Huawei EulerOS: Security Advisory for grub2 (EulerOS-SA-2025-1660)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1660");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1660");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'grub2' package(s) announced via the EulerOS-SA-2025-1660 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grub2-common", rpm:"grub2-common~2.06~3.h37.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"grub2-efi-aa64", rpm:"grub2-efi-aa64~2.06~3.h37.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"grub2-efi-aa64-modules", rpm:"grub2-efi-aa64-modules~2.06~3.h37.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"grub2-tools", rpm:"grub2-tools~2.06~3.h37.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"grub2-tools-extra", rpm:"grub2-tools-extra~2.06~3.h37.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"grub2-tools-minimal", rpm:"grub2-tools-minimal~2.06~3.h37.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
