...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1731");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg2 (EulerOS-SA-2025-1731)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1731");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1731");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg2' package(s) announced via the EulerOS-SA-2025-1731 advisory.");
...
A heap-based buffer overflow was found in openjpeg in color.c:379:42 in sycc420_to_rgb when decompressing a crafted .j2k file. An attacker could use this to execute arbitrary code with the permissions of the application compiled against openjpeg.(CVE-2021-3575)");
  ...
  script_tag(name:"affected", value:"'openjpeg2' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.5.0~2.h1.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
