...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1968");
  ...
  script_name("Huawei EulerOS: Security Advisory for screen (EulerOS-SA-2025-1968)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1968");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1968");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'screen' package(s) announced via the EulerOS-SA-2025-1968 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"screen", rpm:"screen~4.8.0~11.h3.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
