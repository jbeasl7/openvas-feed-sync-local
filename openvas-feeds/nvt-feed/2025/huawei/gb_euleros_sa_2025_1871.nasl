...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1871");
  script_cve_id("CVE-2023-3341", "CVE-2024-11187");
  ...
  script_name("Huawei EulerOS: Security Advisory for dhcp (EulerOS-SA-2025-1871)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1871");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1871");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dhcp' package(s) announced via the EulerOS-SA-2025-1871 advisory.");
...
It is possible to construct a zone such that some queries to it will generate responses containing numerous records in the Additional section. An attacker sending many such queries can cause either the authoritative server itself or an independent resolver to use disproportionate resources processing the queries. Zones will usually need to have been deliberately crafted to attack this exposure.(CVE-2024-11187)");
  ...
  script_tag(name:"affected", value:"'dhcp' package(s) on Huawei EulerOS Virtualization release 2.12.0.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.4.3~1.h9.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
