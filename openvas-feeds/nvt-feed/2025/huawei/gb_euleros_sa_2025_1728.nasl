...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1728");
  ...
  script_name("Huawei EulerOS: Security Advisory for dhcp (EulerOS-SA-2025-1728)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1728");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1728");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dhcp' package(s) announced via the EulerOS-SA-2025-1728 advisory.");
  ...
  script_tag(name:"affected", value:"'dhcp' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.4.3~4.h4.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
