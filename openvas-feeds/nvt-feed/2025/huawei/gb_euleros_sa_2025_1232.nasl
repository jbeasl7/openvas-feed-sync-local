...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1232");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg2 (EulerOS-SA-2025-1232)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1232");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1232");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg2' package(s) announced via the EulerOS-SA-2025-1232 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.3.1~5.h10.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
