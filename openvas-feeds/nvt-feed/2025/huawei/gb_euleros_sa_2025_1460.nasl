...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1460");
  ...
  script_name("Huawei EulerOS: Security Advisory for syslinux (EulerOS-SA-2025-1460)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1460");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1460");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'syslinux' package(s) announced via the EulerOS-SA-2025-1460 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The png_format_buffer function in pngerror.c in libpng 1.0.x before 1.0.55, 1.2.x before 1.2.45, 1.4.x before 1.4.8, and 1.5.x before 1.5.4 allows remote attackers to cause a denial of service (application crash) via a crafted PNG image that triggers an out-of-bounds read during the copying of error-message data. NOTE: this vulnerability exists because of a CVE-2004-0421 regression. NOTE: this is called an off-by-one error by some sources.(CVE-2011-2501)
...
The png_convert_to_rfc1123 function in png.c in libpng 1.0.x before 1.0.64, 1.2.x before 1.2.54, and 1.4.x before 1.4.17 allows remote attackers to obtain sensitive process memory information via crafted tIME chunk data in an image file, which triggers an out-of-bounds ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "EULEROSVIRT-2.9.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"syslinux", rpm:"syslinux~6.04~5.h1.r3.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"syslinux-nonlinux", rpm:"syslinux-nonlinux~6.04~5.h1.r3.eulerosv2r9", rls:"EULEROSVIRT-2.9.0"))) {
    report += res;
  }
