...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1571");
  ...
  script_name("Huawei EulerOS: Security Advisory for pam (EulerOS-SA-2025-1571)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1571");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1571");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'pam' package(s) announced via the EulerOS-SA-2025-1571 advisory.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pam", rpm:"pam~1.5.2~4.h5.eulerosv2r12", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
