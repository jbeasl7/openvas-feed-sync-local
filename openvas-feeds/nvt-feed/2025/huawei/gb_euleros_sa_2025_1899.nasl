...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1899");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-jinja2 (EulerOS-SA-2025-1899)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1899");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1899");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-jinja2' package(s) announced via the EulerOS-SA-2025-1899 advisory.");
  ...
  script_tag(name:"affected", value:"'python-jinja2' package(s) on Huawei EulerOS Virtualization release 2.12.1.");
...
if(release == "EULEROSVIRT-2.12.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-jinja2", rpm:"python3-jinja2~3.0.3~2.h5.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }
