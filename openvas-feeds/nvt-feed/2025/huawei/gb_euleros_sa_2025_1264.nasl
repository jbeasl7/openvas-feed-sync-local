...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1264");
  ...
  script_name("Huawei EulerOS: Security Advisory for gstreamer1-plugins-base (EulerOS-SA-2025-1264)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1264");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1264");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gstreamer1-plugins-base' package(s) announced via the EulerOS-SA-2025-1264 advisory.");
