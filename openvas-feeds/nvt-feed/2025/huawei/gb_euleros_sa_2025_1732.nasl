...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1732");
  ...
  script_name("Huawei EulerOS: Security Advisory for openssl (EulerOS-SA-2025-1732)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1732");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1732");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openssl' package(s) announced via the EulerOS-SA-2025-1732 advisory.");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssl", rpm:"openssl~1.1.1wa~2.h24.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-libs", rpm:"openssl-libs~1.1.1wa~2.h24.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl-perl", rpm:"openssl-perl~1.1.1wa~2.h24.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
