...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2159");
  ...
  script_name("Huawei EulerOS: Security Advisory for glib2 (EulerOS-SA-2025-2159)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2159");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2159");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'glib2' package(s) announced via the EulerOS-SA-2025-2159 advisory.");
...
A vulnerability was found in GNU GLib up to 2.84.0 on Windows (Software Library). It has been rated as problematic. Affected by this issue is some unknown processing of the component Command Line Handler. Upgrading to version 2.84.1 eliminates this vulnerability.(CVE-2025-4056)");
  ...
  script_tag(name:"affected", value:"'glib2' package(s) on Huawei EulerOS Virtualization release 2.13.0.");
...
if(release == "EULEROSVIRT-2.13.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.72.2~12.h12.eulerosv2r13", rls:"EULEROSVIRT-2.13.0"))) {
    report += res;
  }
