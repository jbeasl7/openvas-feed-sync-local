...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1483");
  ...
  script_name("Huawei EulerOS: Security Advisory for curl (EulerOS-SA-2025-1483)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1483");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1483");
  script_xref(name:"URL", value:"https://curl.se/libcurl/c/CURLINFO_CERTINFO.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'curl' package(s) announced via the EulerOS-SA-2025-1483 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.69.1~2.h28.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl", rpm:"libcurl~7.69.1~2.h28.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
