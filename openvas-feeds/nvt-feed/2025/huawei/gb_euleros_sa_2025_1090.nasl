...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1090");
  ...
  script_name("Huawei EulerOS: Security Advisory for edk2 (EulerOS-SA-2025-1090)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1090");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1090");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'edk2' package(s) announced via the EulerOS-SA-2025-1090 advisory.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2-ovmf", rpm:"edk2-ovmf~202011.oe2203sp1~2.12.0.5.49", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
