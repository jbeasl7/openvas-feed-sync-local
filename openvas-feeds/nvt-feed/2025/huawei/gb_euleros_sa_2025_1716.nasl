...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1716");
  ...
  script_name("Huawei EulerOS: Security Advisory for dhcp (EulerOS-SA-2025-1716)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1716");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1716");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dhcp' package(s) announced via the EulerOS-SA-2025-1716 advisory.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dhcp", rpm:"dhcp~4.4.3~4.h4.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
