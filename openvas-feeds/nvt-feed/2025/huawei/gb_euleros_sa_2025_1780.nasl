...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1780");
  ...
  script_name("Huawei EulerOS: Security Advisory for libsoup (EulerOS-SA-2025-1780)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1780");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1780");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsoup' package(s) announced via the EulerOS-SA-2025-1780 advisory.");
...
A flaw was found in libsoup. The implementation of HTTP range requests is vulnerable to a resource consumption attack. This flaw allows a malicious client to request the same range many times in a single HTTP request, causing ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libsoup' package(s) on Huawei EulerOS V2.0SP10.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoup", rpm:"libsoup~2.71.0~1.h9.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-help", rpm:"libsoup-help~2.71.0~1.h9.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
