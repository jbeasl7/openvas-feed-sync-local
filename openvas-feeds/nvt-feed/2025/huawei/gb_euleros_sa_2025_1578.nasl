...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1578");
  ...
  script_name("Huawei EulerOS: Security Advisory for abseil-cpp (EulerOS-SA-2025-1578)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1578");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1578");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'abseil-cpp' package(s) announced via the EulerOS-SA-2025-1578 advisory.");
  ...
  script_tag(name:"affected", value:"'abseil-cpp' package(s) on Huawei EulerOS V2.0SP12.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"abseil-cpp", rpm:"abseil-cpp~20220623.1~4.h2.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
