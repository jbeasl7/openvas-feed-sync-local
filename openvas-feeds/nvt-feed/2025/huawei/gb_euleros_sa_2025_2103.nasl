...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2103");
  ...
  script_name("Huawei EulerOS: Security Advisory for libsoup (EulerOS-SA-2025-2103)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2103");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2103");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libsoup' package(s) announced via the EulerOS-SA-2025-2103 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoup", rpm:"libsoup~2.71.0~1.h10.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libsoup-help", rpm:"libsoup-help~2.71.0~1.h10.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
