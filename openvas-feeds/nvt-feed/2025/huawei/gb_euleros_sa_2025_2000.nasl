...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.2000");
  script_cve_id("CVE-2025-3198", "CVE-2025-5244", "CVE-2025-5245");
  ...
  script_tag(name:"severity_date", value:"2025-05-27 15:15:36 +0000 (Tue, 27 May 2025)");

  script_name("Huawei EulerOS: Security Advisory for binutils (EulerOS-SA-2025-2000)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-2000");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-2000");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'binutils' package(s) announced via the EulerOS-SA-2025-2000 advisory.");
...
if(release == "EULEROS-2.0SP12-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.37~14.h15.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }
