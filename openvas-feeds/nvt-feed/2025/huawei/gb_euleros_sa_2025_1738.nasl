...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2025.1738");
  ...
  script_name("Huawei EulerOS: Security Advisory for elfutils (EulerOS-SA-2025-1738)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2025-1738");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2025-1738");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'elfutils' package(s) announced via the EulerOS-SA-2025-1738 advisory.");
...
A vulnerability was found in GNU elfutils 0.192. It has been declared as critical. Affected by this vulnerability is the function dump_data_section/print_string_section of the file readelf.c of the component eu-readelf. The manipulation of the argument z/x leads to buffer overflow. An attack has to be approached locally. The exploit has been disclosed to the public and may be used. The identifier of the patch is 73db9d2021cab9e23fd734b0a76a612d52a6f1db. It is recommended to apply a patch to fix this issue.(CVE-2025-1372)");
  ...
  script_tag(name:"affected", value:"'elfutils' package(s) on Huawei EulerOS Virtualization release 2.13.1.");
...
if(release == "EULEROSVIRT-2.13.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"elfutils", rpm:"elfutils~0.185~18.h9.eulerosv2r13", rls:"EULEROSVIRT-2.13.1"))) {
    report += res;
  }
