...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2025.0121");
  ...
  script_name("Mageia: Security Advisory (MGASA-2025-0121)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2025-0121");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2025-0121.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=34136");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7367-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zvbi' package(s) announced via the MGASA-2025-0121 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A vulnerability was found in libzvbi up to 0.2.43. It has been
...
issue (CVE-2025-2174).");
  ...
  script_tag(name:"affected", value:"'zvbi' package(s) on Mageia 9.");
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64zvbi-devel", rpm:"lib64zvbi-devel~0.2.44~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64zvbi0", rpm:"lib64zvbi0~0.2.44~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libzvbi-devel", rpm:"libzvbi-devel~0.2.44~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libzvbi0", rpm:"libzvbi0~0.2.44~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zvbi", rpm:"zvbi~0.2.44~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
