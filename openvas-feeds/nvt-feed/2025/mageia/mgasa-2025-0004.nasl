...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2025.0004");
  ...
  script_name("Mageia: Security Advisory (MGASA-2025-0004)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2025-0004");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2025-0004.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=33519");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2024/09/03/1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opencontainers-runc' package(s) announced via the MGASA-2025-0004 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"runc 1.1.13 and earlier as well as 1.2.0-rc2 and earlier can be tricked into
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opencontainers-runc", rpm:"opencontainers-runc~1.1.14~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opencontainers-runc-devel", rpm:"opencontainers-runc-devel~1.1.14~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
