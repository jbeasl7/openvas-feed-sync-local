...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2025.4071");
  ...
  script_name("Debian: Security Advisory (DLA-4071-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-4071-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2025/DLA-4071-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-good1.0' package(s) announced via the DLA-4071-1 advisory.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-gtk3", ver:"1.18.4-2+deb11u3", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-plugins-good", ver:"1.18.4-2+deb11u3", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-pulseaudio", ver:"1.18.4-2+deb11u3", rls:"DEB11"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-qt5", ver:"1.18.4-2+deb11u3", rls:"DEB11"))) {
    report += res;
  }
