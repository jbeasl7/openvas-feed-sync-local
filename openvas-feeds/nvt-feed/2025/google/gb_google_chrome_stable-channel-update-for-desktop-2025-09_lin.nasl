...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836632");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2025-09) - Linux");
  ...
  140.0.7339.80 on Linux");

  script_tag(name: "solution", value:"Update to version 140.0.7339.80 or
  later.");
...
if(version_is_less(version:vers, test_version:"140.0.7339.80")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"140.0.7339.80", install_path:path);
