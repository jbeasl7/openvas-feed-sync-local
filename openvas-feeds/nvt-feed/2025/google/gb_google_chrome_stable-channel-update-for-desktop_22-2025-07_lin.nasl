...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836534");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_22-2025-07) - Linux");
  ...
  script_tag(name: "solution", value:"Update to version 138.0.7204.168 or
  later.");
...
if(version_is_less(version:vers, test_version:"138.0.7204.168")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"138.0.7204.168", install_path:path);
