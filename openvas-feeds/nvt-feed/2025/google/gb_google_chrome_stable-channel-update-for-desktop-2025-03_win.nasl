...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834981");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2025-03) - Windows");
  ...
  134.0.6998.35 on Windows");

  script_tag(name: "solution", value:"Update to version 134.0.6998.35/36 or
  later.");
...
if(version_is_less(version:vers, test_version:"134.0.6998.35")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"134.0.6998.35/36", install_path:path);
