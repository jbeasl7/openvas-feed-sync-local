...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836449");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_17-2025-06) - Linux");
  ...
  script_tag(name: "solution", value:"Update to version 137.0.7151.119 or
  later.");
...
if(version_is_less(version:vers, test_version:"137.0.7151.119")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"137.0.7151.119", install_path:path);
