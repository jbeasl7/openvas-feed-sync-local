...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834889");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_14-2025-01) - Linux");
  ...
  132.0.6834.83 on Linux");

  script_tag(name: "solution", value:"Update to version 132.0.6834.83 or
  later.");
...
if(version_is_less(version:vers, test_version:"132.0.6834.83")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"132.0.6834.83", install_path:path);
