...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834983");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2025-03) - Mac OS X");
  ...
  134.0.6998.44 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 134.0.6998.44/45 or
  later.");
...
if(version_is_less(version:vers, test_version:"134.0.6998.44")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"134.0.6998.44/45", install_path:path);
