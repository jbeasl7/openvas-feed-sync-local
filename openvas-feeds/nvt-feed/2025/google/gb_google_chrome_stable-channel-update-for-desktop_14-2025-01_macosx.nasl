...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834890");
  script_version("2025-01-17T05:37:18+0000");
  script_cve_id("CVE-2025-0434", "CVE-2025-0435", "CVE-2025-0436", "CVE-2025-0437",
  ...
  script_tag(name:"creation_date", value:"2025-01-15 20:31:21 +0530 (Wed, 15 Jan 2025)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_14-2025-01) - Mac OS X");
  ...
  132.0.6834.83 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 132.0.6834.83/84 or
  later.");
...
if(version_is_less(version:vers, test_version:"132.0.6834.83")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"132.0.6834.83/84", install_path:path);
