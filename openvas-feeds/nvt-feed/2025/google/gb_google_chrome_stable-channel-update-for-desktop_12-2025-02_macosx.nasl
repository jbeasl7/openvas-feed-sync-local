...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834959");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_12-2025-02) - Mac OS X");
  ...
  133.0.6943.98 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 133.0.6943.98/.99 or
  later.");
...
if(version_is_less(version:vers, test_version:"133.0.6943.98")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"133.0.6943.98/.99", install_path:path);
