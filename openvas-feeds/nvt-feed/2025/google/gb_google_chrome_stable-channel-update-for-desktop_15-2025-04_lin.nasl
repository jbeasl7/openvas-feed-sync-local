...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836141");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_15-2025-04) - Linux");
  ...
  135.0.7049.95 on Linux");

  script_tag(name:"solution", value:"Update to version 135.0.7049.95 or
  later.");
...
if(version_is_less(version:vers, test_version:"135.0.7049.95")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"135.0.7049.95", install_path:path);
