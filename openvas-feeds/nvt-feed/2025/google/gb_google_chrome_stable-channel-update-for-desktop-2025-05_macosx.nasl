...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836189");
  ...
  script_tag(name:"creation_date", value:"2025-05-07 12:31:08 +0530 (Wed, 07 May 2025)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2025-05) - Mac OS X");
  ...
  136.0.7103.92 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 136.0.7103.92/.93 or
  later.");
...
if(version_is_less(version:vers, test_version:"136.0.7103.92")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"136.0.7103.92/.93", install_path:path);
