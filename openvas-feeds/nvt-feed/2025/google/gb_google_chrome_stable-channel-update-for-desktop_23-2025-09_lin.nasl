...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836686");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_23-2025-09) - Linux");
  ...
  script_tag(name: "solution", value:"Update to version 140.0.7339.207 or later.");
...
if(version_is_less(version:vers, test_version:"140.0.7339.207")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"140.0.7339.207", install_path:path);
