...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836173");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_29-2025-04) - Linux");
  ...
  136.0.7103.59 on Linux");

  script_tag(name: "solution", value:"Update to version 136.0.7103.59 or
  later.");
...
if(version_is_less(version:vers, test_version:"136.0.7103.59")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"136.0.7103.59", install_path:path);
