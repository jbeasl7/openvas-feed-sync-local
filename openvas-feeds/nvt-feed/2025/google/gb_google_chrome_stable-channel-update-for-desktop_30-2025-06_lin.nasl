...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836471");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_30-2025-06) - Linux");
  ...
  138.0.7204.92 on Linux");

  script_tag(name: "solution", value:"Update to version 138.0.7204.92 or
  later.");
...
if(version_is_less(version:vers, test_version:"138.0.7204.92")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"138.0.7204.92", install_path:path);
