...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127924");
  script_version("2025-07-09T05:43:50+0000");
  script_tag(name:"last_modification", value:"2025-07-09 05:43:50 +0000 (Wed, 09 Jul 2025)");
  script_tag(name:"creation_date", value:"2025-07-08 08:00:51 +0000 (Tue, 08 Jul 2025)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:C");

  script_cve_id("CVE-2025-48367");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Redis DoS Vulnerability (GHSA-4q32-c38c-pwgq)");
  ...
  script_tag(name:"insight", value:"An unauthenticated connection can cause repeated IP protocol
  errors, leading to client starvation and, ultimately, a denial of service (DoS).");

  script_tag(name:"affected", value:"Redis versions prior to 6.2.19, 7.2.x prior to 7.2.10,
  ...
  script_xref(name:"URL", value:"https://github.com/redis/redis/security/advisories/GHSA-4q32-c38c-pwgq");
...
if (version_is_less(version: version, test_version: "6.2.19")) {
