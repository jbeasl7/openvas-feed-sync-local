...
CPE = "cpe:/o:dlink:dir-600l_firmware";

if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.171502");
  ...
  script_tag(name:"severity_date", value:"2025-05-12 17:30:15 +0000 (Mon, 12 May 2025)");
  ...
  script_name("D-Link DIR-600L Multiple Vulnerabilities (2025)");
  ...
  script_tag(name:"summary", value:"D-Link DIR-600L devices are prone to multiple
  vulnerabilities.");
  ...
  - CVE-2025-4342, CVE-2025-4343, CVE-2025-4344, CVE-2025-4345, CVE-2025-4346, CVE-2025-4347,
  CVE-2025-4348, CVE-2025-4349, CVE-2025-4350: Multiple Buffer overflow vulnerabilities");

  script_tag(name:"affected", value:"D-Link DIR-600L devices in all versions.");

  script_tag(name:"solution", value:"No solution was made available by the vendor. General solution
  options are to upgrade to a newer release, disable respective features, remove the product or
  replace the product by another one.

  Note: The vendor states that technical support for DIR-600L has ended in 15.12.2019, therefore
