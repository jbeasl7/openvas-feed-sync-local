...
if (description)
{
  ...
  script_name("H2O HTTP Server HTTP/2 Protocol DoS Vulnerability (GHSA-mrjm-qq9m-9mjq, MadeYouReset)");
  ...
  HTTP/2 protocol dubbed 'MadeYouReset'.");
  ...
  Note: The vendor has added a fix into the master repository with commit '4729b66'.");

  script_xref(name:"URL", value:"https://github.com/h2o/h2o/security/advisories/GHSA-mrjm-qq9m-9mjq");
  script_xref(name:"URL", value:"https://github.com/h2o/h2o/commit/4729b661e3c6654198d2cc62997e1af58bef4b80");
