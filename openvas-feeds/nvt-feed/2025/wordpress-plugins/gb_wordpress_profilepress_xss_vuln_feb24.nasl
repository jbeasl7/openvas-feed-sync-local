...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124715");
  ...
  cross-site scripting via the plugin 'reg-number-field' shortcode due to insufficient input
  ...
  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/wp-user-avatar/paid-membership-plugin-ecommerce-user-registration-form-login-form-user-profile-restrict-content-profilepress-4143-authenticated-contributor-stored-cross-site-scripting");
...
if (version_is_less(version: version, test_version: "4.14.4")) {
