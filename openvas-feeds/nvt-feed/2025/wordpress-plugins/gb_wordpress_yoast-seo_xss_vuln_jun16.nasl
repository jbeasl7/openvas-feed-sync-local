...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124742");
  ...
  script_name("WordPress Yoast SEO Plugin < 3.3.0 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The Yoast SEO plugin for WordPress is vulnerable to cross-site
  scripting due to insufficient input sanitization and output escaping.");

  script_tag(name:"affected", value:"WordPress Yoast SEO plugin prior to version 3.3.0.");

  script_tag(name:"solution", value:"Update to version 3.3.0 or later.");

  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/wordpress-seo/yoast-seo-325-cross-site-scripting");
