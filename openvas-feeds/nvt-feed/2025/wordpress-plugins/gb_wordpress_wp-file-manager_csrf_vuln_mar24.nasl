...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124732");
  ...
  script_tag(name:"severity_date", value:"2024-03-21 04:15:09 +0000 (Thu, 21 Mar 2024)");

  script_cve_id("CVE-2024-1538");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress File Manager Plugin < 7.2.5 CSRF Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress File Manager plugin prior to version 7.2.5.");

  script_tag(name:"solution", value:"Update to version 7.2.5 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/fd0ed716-1e6b-4fcc-a5b4-cf03d07857e6/");
...
if (version_is_less(version: version, test_version: "7.2.5")) {
