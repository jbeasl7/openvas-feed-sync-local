...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124882");
  ...
  script_name("WordPress Gravity Forms Plugin < 1.9.7 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Plugin is vulnerable to cross-site scripting due to the misuse
  of the add_query_arg() and remove_query_arg() functions.");

  script_tag(name:"affected", value:"WordPress Gravity Forms plugin prior to version 1.9.7.");

  script_tag(name:"solution", value:"Update to version 1.9.7 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/fa0a50d9-f6dd-4565-b00d-d1ff90539aea/");
