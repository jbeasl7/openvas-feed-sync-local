...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124735");
  ...
  script_cve_id("CVE-2024-37254");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress File Manager Plugin < 7.2.8 Missing Authorization Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'File Manager' is prone to a missing
  ...
  mk_file_manager_backup_callback function.");

  script_tag(name:"affected", value:"WordPress File Manager plugin prior to version 7.2.8.");

  script_tag(name:"solution", value:"Update to version 7.2.8 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/05d82b75-f4b8-432e-bfbc-65edcd1c4376/");
...
if (version_is_less(version: version, test_version: "7.2.8")) {
