...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.128092");
  ...
  script_tag(name:"severity_date", value:"2025-02-04 17:07:26 +0000 (Tue, 04 Feb 2025)");

  script_cve_id("CVE-2024-3550");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Shortcodes Ultimate Plugin < 7.1.3 - Contributor+ Stored XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The plugin is vulnerable to stored XSS due to insufficient
  ...
  script_tag(name:"affected", value:"WordPress Shortcodes Ultimate plugin prior to version 7.1.3.");

  script_tag(name:"solution", value:"Update to version 7.1.3 or later.");

  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/shortcodes-ultimate/wp-shortcodes-plugin-shortcodes-ultimate-712-authenticated-contributor-stored-cross-site-scripting-via-shortcode");
