...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124754");
  ...
  script_cve_id("CVE-2012-6692");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Yoast SEO Plugin < 2.2 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"WordPress SEO by Yoast plugin for WordPress allows remote
  attackers to inject arbitrary web script or HTML via the post_title parameter to
  wp-admin/post-new.php.");

  script_tag(name:"affected", value:"WordPress Yoast SEO plugin prior to version 2.2.");

  script_tag(name:"solution", value:"Update to version 2.2 or later.");

  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/wordpress-seo/yoast-seo-211-cross-site-scripting-via-post-title-parameter");
