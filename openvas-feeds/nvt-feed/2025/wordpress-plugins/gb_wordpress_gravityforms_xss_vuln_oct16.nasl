...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124880");
  ...
  script_name("WordPress Gravity Forms Plugin < 2.0.7 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"A blind XSS vulnerability exists in the select option dropdown
  boxes on forms. If the select column is displayed on the gf_entries page when viewed in the
  Dashboard, the code is executed by the admin / viewer of the submissions.");

  script_tag(name:"affected", value:"WordPress Gravity Forms plugin prior to version 2.0.7.");

  script_tag(name:"solution", value:"Update to version 2.0.7 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/978f6645-9187-4548-99ae-be6422d2ba46/");
