...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124738");
  ...
  script_tag(name:"severity_date", value:"2021-04-09 15:51:59 +0000 (Fri, 09 Apr 2021)");

  script_cve_id("CVE-2021-24177");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress File Manager Plugin < 7.1 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"In the default configuration a reflected XSS can occur on the
  endpoint /wp-admin/admin.php?page=wp_file_manager_properties when a payload is submitted on the
  user-agent parameter.");

  script_tag(name:"affected", value:"WordPress File Manager plugin prior to version 7.1.");

  script_tag(name:"solution", value:"Update to version 7.1 or later.");

  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/1cf3d256-cf4b-4d1f-9ed8-e2cc6392d8d8/");
