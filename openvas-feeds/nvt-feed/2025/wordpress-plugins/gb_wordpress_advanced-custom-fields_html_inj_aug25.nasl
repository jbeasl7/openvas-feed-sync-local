...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.127942");
  ...
  script_name("WordPress Advanced Custom Fields Plugin < 6.4.3 HTML Injection Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Advanced Custom Fields' plugin is prone to
  ...
  script_tag(name:"affected", value:"WordPress Advanced Custom Fields plugin prior to version
  6.4.3.");
