...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124744");
  ...
  script_name("WordPress Yoast SEO Plugin < 2.1 XSS Vulnerability");
  ...
  cross-site scripting due to insufficient input sanitization and output escaping on
  remove_query_arg and add_query_arg.");

  script_tag(name:"affected", value:"WordPress Yoast SEO plugin prior to version 2.1.");

  script_tag(name:"solution", value:"Update to version 2.1 or later.");

  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/wordpress-seo/yoast-seo-201-reflected-cross-site-scripting");
