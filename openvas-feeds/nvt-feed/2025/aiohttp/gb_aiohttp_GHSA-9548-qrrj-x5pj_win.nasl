...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.133011");
  script_version("2025-08-15T15:42:26+0000");
  script_cve_id("CVE-2025-53643");
  script_tag(name:"last_modification", value:"2025-08-15 15:42:26 +0000 (Fri, 15 Aug 2025)");
  script_tag(name:"creation_date", value:"2025-07-17 09:54:22 +0000 (Thu, 17 Jul 2025)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:C/A:N");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2025-08-14 20:40:05 +0000 (Thu, 14 Aug 2025)");
  script_name("aiohttp < 3.12.14 HTTP Request Smuggling Vulnerability - Windows");
