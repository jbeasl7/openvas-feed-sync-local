...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.171136");
  ...
  script_cve_id("CVE-2024-57041");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("NodeBB < 3.11.1 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"NodeBB is prone to a cross-site scripting (XSS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability allows remote attackers to store arbitrary
  code in the 'about me' section of their profile.");

  script_tag(name:"affected", value:"NodeBB prior to version 3.11.1.");

  script_tag(name:"solution", value:"Update to version 3.11.1 or later.");

  script_xref(name:"URL", value:"https://www.tonysec.com/posts/cve-2024-57041/");
  script_xref(name:"URL", value:"https://github.com/NodeBB/NodeBB/commit/4e69bff72fd04779064d37e46a43080e6c328adf");
