...
if(description)
{
  ...
  # nb:
  # - Vendor advisory only includes CVE-2021-29476
  # - But as seen on e.g. https://security-tracker.debian.org/tracker/CVE-2021-29476:
  #   > The CVE directly correspond to CVE-2020-28032 for WordPress and we can track same versions
  #   > as fixed. Strictly speaking CVE-2021-29476 is for the PHP Requests library directly.
  #   there is another relevant CVE
  # - As the WordPress app in My Cloud got fixed we can also include the WordPress CVE here
