...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.128133");
  ...
  script_name("Node.js < 20.19.2, 21.x < 22.15.1, 23.x < 23.11.1, 24.x < 24.0.2 DoS Vulnerability - Windows");
  ...
  ThrowException() based on user-supplied inputs when executing in a background thread, crashing the
  Node.js process. Such cryptographic operations are commonly applied to untrusted inputs. Thus,
