...
if(description)
{
  ...
  script_cve_id("CVE-2025-5153");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"NoneAvailable");

  script_name("CMS Made Simple <= 2.2.21 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"CMS Made Simple is vulnerable to XSS vulnerability due to
  inadequate sanitization of user input in the 'Templates Description' field in the Design Manager
  module of the admin panel.");

  script_tag(name:"affected", value:"CMS Made Simple version 2.2.21 and prior.");

  script_tag(name:"solution", value:"No known solution is available as of 23rd June, 2025.
