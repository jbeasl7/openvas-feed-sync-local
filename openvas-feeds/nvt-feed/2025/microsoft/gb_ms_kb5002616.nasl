...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836226");
  script_version("2025-06-13T05:40:07+0000");
  script_cve_id("CVE-2025-47167");
  ...
  script_tag(name:"severity_date", value:"2025-06-10 17:23:41 +0000 (Tue, 10 Jun 2025)");
  script_tag(name:"creation_date", value:"2025-06-11 11:17:30 +0530 (Wed, 11 Jun 2025)");
  script_name("Microsoft Office 2016 RCE Vulnerability (KB5002616)");

  script_tag(name:"summary", value:"This host is missing an critical security
  update according to Microsoft KB5002616");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002616");
...
foreach key (key_list) {
  ...
  if(comPath){
    ...
    if(ortVer && ortVer =~ "^16\.") {
      if(version_is_less(version:ortVer, test_version:"16.0.5504.1000")) {
        report = report_fixed_ver( file_checked:comPath + "Oart.dll",
                                   file_version:ortVer, vulnerable_range:"16.0 - 16.0.5504.999");
