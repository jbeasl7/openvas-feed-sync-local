...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834597");
  script_version("2025-03-14T05:38:04+0000");
  script_cve_id("CVE-2025-24081");
  ...
  script_tag(name:"severity_date", value:"2025-03-11 17:16:32 +0000 (Tue, 11 Mar 2025)");
  script_tag(name:"creation_date", value:"2025-03-12 06:16:37 +0000 (Wed, 12 Mar 2025)");
  script_name("Microsoft Office 2016 RCE Vulnerability (KB5002694)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002694");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002694");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5491.1000")) {
        report = report_fixed_ver(file_checked:offPath + "\graph.exe",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5491.0999");
