...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834954");
  script_version("2025-02-14T08:35:38+0000");
  script_cve_id("CVE-2025-21387");
  ...
  script_name("Microsoft Office 2016 RCE Vulnerability (KB5002684)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002684");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002684");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5487.1000")) {
        report = report_fixed_ver(file_checked:offPath + "\graph.exe",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5487.0999");
