...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836200");
  script_version("2025-04-11T15:45:04+0000");
  script_cve_id("CVE-2025-27744");
  ...
  script_name("Microsoft Office 2016 Elevation of Privilege Vulnerability (KB5002669)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002669");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002669");
