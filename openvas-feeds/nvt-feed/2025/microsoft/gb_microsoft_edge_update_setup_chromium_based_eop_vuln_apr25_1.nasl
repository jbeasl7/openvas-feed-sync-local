...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836137");
  script_version("2025-04-24T05:40:01+0000");
  script_cve_id("CVE-2025-29795");
  ...
  script_tag(name:"severity_date", value:"2025-03-23 17:15:28 +0000 (Sun, 23 Mar 2025)");
  script_tag(name:"creation_date", value:"2025-04-15 11:15:42 +0530 (Tue, 15 Apr 2025)");
  script_name("Microsoft Edge Update Setup (Chromium-based) < 1.3.195.45 Elevation of Privilege Vulnerability (Apr 2025)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge Update Setup (Chromium-based) prior to version 1.3.195.45.");
  ...
  script_xref(name:"URL", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2025-29795");
...
if(version_is_less(version:vers, test_version:"1.3.195.45")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"1.3.195.45", install_path:path);
