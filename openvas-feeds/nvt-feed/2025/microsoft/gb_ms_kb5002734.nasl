...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836506");
  script_version("2025-07-24T05:43:49+0000");
  script_cve_id("CVE-2025-48812");
  ...
  script_tag(name:"creation_date", value:"2025-07-11 10:27:43 +0530 (Fri, 11 Jul 2025)");
  script_name("Microsoft Office 2016 Information Disclosure Vulnerability (KB5002734)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002734");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002734");
