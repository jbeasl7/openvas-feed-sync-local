...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836418");
  ...
  script_name("Remote Desktop Client Multiple Vulnerabilities (Jun 2025) - Windows");
  ...
  version 1.2.6278.0 on Windows");

  script_tag(name:"solution", value:"Update to public version 1.2.6278.0 or
  later.");
...
if(version_is_less(version:vers, test_version:"1.2.6278.0")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:'1.2.6278.0', install_path:path);
