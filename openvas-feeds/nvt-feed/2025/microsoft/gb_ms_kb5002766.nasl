...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836258");
  ...
  script_name("Microsoft Office 2016 RCE Vulnerability (KB5002766)");

  script_tag(name:"summary", value:"This host is missing an critical security
  update according to Microsoft KB5002766");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002766");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(version_is_less(version:offdllVer, test_version:"16.0.5513.1000")) {
        report = report_fixed_ver( file_checked:offPath + "\mso99lwin32client.dll",
                                   file_version:offdllVer, vulnerable_range:"Less than 16.0.5513.1000");
