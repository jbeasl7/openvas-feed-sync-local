...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834579");
  ...
  script_cve_id("CVE-2025-21186", "CVE-2025-21345", "CVE-2025-21346", "CVE-2025-21354",
                ...
                "CVE-2025-21364", "CVE-2025-21365", "CVE-2025-21366", "CVE-2025-21395");
  ...
  script_name("Microsoft Office 365 (2016 Click-to-Run) Multiple Vulnerabilities (Jan 2025)");
...
if(UpdateChannel == "Monthly Channel") {
  if(version_is_less(version:officeVer, test_version:"16.0.18324.20190"))
    fix = "Version 2412 (Build 18324.20190";
}
## Semi-Annual Channel (Targeted) renamed to Semi-Annual Enterprise Channel (Preview)
## Semi-Annual Enterprise Channel (Preview): Version 2408 (Build 17928.20392)
else if(UpdateChannel == "Semi-Annual Channel (Targeted)") {
  if(version_is_less(version:officeVer, test_version:"16.0.17928.20392"))
    fix = "Version 2408 (Build 17928.20392)";
}
...
## Semi-Annual Channel renamed to Semi-Annual Enterprise Channel
  ...
  if(version_in_range(version:officeVer, test_version:"16.0.16731.0", test_version2:"16.0.16731.21063")) {
    fix = "Version 2308 (Build 16731.21064)";
  }
  else if(version_in_range(version:officeVer, test_version:"16.0.17328.0", test_version2:"16.0.17328.20687")) {
      fix = "Version 2402 (Build 17328.20688)";
  }
}
