...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836257");
  script_version("2025-09-11T05:38:37+0000");
  script_cve_id("CVE-2025-54906");
  ...
  script_name("Microsoft Office 2016 RCE Vulnerability (KB5002576)");

  script_tag(name:"summary", value:"This host is missing an critical security
  update according to Microsoft KB5002576");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002576");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      offdllVer = fetch_file_version(sysPath:offPath, file_name:"mso40uiwin32client.dll");
      if(!offdllVer || offdllVer !~ "^16\.") {
        exit(0);
      }

      if(version_is_less(version:offdllVer, test_version:"16.0.5517.1000")) {
        report = report_fixed_ver( file_checked:offPath + "\mso40uiwin32client.dll",
                                   file_version:offdllVer, vulnerable_range:"Less than 16.0.5517.1000");
