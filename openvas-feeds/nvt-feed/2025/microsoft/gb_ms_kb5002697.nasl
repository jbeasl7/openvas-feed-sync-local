...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834593");
  ...
  script_name("Microsoft Access 2016 RCE Vulnerability (KB5002697)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002697.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002697");
...
if(version_in_range(version:vers, test_version:"16.0", test_version2:"16.0.5491.1000")) {
  report = report_fixed_ver(file_checked:"msaccess.exe",
           file_version:vers, vulnerable_range:"16.0 - 16.0.5491.1000");
