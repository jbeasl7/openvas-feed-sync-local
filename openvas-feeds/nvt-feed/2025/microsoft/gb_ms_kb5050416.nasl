...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834575");
  ...
  script_name("Microsoft .NET Framework RCE Vulnerability (KB5050416)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5050416");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5050416");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer1 || dllVer2)
          {
            if(dllVer1 && version_in_range(version:dllVer1, test_version:"3.0.6920.0", test_version2:"3.0.6920.9162"))
            {
              vulnerable_range1 = "3.0.6920.0 - 3.0.6920.9162";
              break;
            }
            else if(dllVer2 && version_in_range(version:dllVer2, test_version:"4.8.9000", test_version2:"4.8.9289"))
            {
              vulnerable_range2 = "4.8.9000 - 4.8.9289" ;
              break;
            }
            else if(dllVer2 && version_in_range(version:dllVer2, test_version:"4.8", test_version2:"4.8.4771"))
            {
              vulnerable_range2 = "4.8 - 4.8.4771" ;
              break;
            }
          }
        }
