...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834884");
  ...
  script_tag(name:"severity_date", value:"2025-01-14 18:16:01 +0000 (Tue, 14 Jan 2025)");
  script_tag(name:"creation_date", value:"2025-01-15 16:05:56 +0530 (Wed, 15 Jan 2025)");
  script_name("Microsoft Outlook 2016 RCE Vulnerability (KB5002656)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002656");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002656");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.5483.0999")) {
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.5483.0999");
