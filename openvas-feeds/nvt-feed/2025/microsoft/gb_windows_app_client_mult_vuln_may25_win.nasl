...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836318");
  ...
  script_tag(name:"affected", value:"Microsoft Windows App Client prior to version  2.0.500.0 on Microsoft Windows.");

  script_tag(name:"solution", value:"Update to version 2.0.500.0 or later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://learn.microsoft.com/en-us/windows-app/whats-new?toc=admins%2Ftoc.json&tabs=windows");
...
if(version_is_less(version:version, test_version:"2.0.500.0")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.0.500.0", install_path: location);
