...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836262");
  script_version("2025-09-11T05:38:37+0000");
  script_cve_id("CVE-2025-54905");
  ...
  script_name("Microsoft Word 2016 Information Disclosure Vulnerability (KB5002780)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002780");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002780");
...
if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.5517.1000")) {
  report = report_fixed_ver(file_checked:exePath + "winword.exe", file_version:exeVer, vulnerable_range:"16.0 - 16.0.5517.999");
