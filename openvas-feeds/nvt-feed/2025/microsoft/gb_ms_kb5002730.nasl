...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836232");
  script_version("2025-06-13T05:40:07+0000");
  script_cve_id("CVE-2025-47162", "CVE-2025-47164", "CVE-2025-47173", "CVE-2025-47953");
  ...
  script_name("Microsoft Office 2016 Multiple RCE Vulnerabilities (KB5002730)");

  script_tag(name:"summary", value:"This host is missing an critical security
  update according to Microsoft KB5002730");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002730");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5504.1002")) {
        report = report_fixed_ver(file_checked:offPath + "\Mso.dll",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5504.1001");
