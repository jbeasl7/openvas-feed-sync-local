...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836647");
  ...
  script_tag(name:"creation_date", value:"2025-09-10 14:57:13 +0530 (Wed, 10 Sep 2025)");
  script_name("Microsoft PowerPoint 2016 RCE Vulnerability (KB5002779)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002779");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002779");
...
foreach key(key_list) {
  ...
  if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.5517.1000")) {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll", file_version:exeVer, vulnerable_range:"16.0 - 16.0.5517.999");
