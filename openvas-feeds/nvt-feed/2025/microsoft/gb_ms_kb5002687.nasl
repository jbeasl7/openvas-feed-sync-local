...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834953");
  script_version("2025-02-14T08:35:38+0000");
  script_cve_id("CVE-2025-21394", "CVE-2025-21390", "CVE-2025-21387", "CVE-2025-21386",
                "CVE-2025-21381");
  ...
  script_name("Microsoft Excel 2016 Multiple Vulnerabilities (KB5002687)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002687");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002687");
...
if(version_in_range(version:excelVer, test_version:"16.0", test_version2:"16.0.5487.0999")) {
  report = report_fixed_ver(file_checked:excelPath + "Excel.exe", file_version:excelVer, vulnerable_range:"16.0 - 16.0.5487.0999");
