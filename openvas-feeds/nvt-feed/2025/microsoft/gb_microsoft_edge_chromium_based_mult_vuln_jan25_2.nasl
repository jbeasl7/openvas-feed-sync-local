...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834901");
  script_version("2025-01-24T05:37:33+0000");
  script_cve_id("CVE-2024-8198", "CVE-2024-8194");
  ...
  script_name("Microsoft Edge (Chromium-Based) < 128.0.2739.54 Multiple Vulnerabilities (Jan 2025)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to  version 128.0.2739.54.");
...
if(version_is_less(version:vers, test_version:"128.0.2739.54")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.0.2739.54", install_path:path);
