...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834592");
  script_version("2025-03-26T05:38:58+0000");
  script_cve_id("CVE-2025-24057", "CVE-2025-24075", "CVE-2025-24077", "CVE-2025-24078",
                "CVE-2025-24079", "CVE-2025-24081", "CVE-2025-24082", "CVE-2025-24083");
  ...
  script_tag(name:"affected", value:"Microsoft Office 2021 prior to version 16.95 (Build 25030928).");

  script_tag(name:"solution", value:"Update to version 16.95 (Build 25030928)
  or later.");
...
if(vers =~ "^16\.") {
  if(version_in_range(version:vers, test_version:"16.79.0", test_version2:"16.94.2")) {
    report = report_fixed_ver(installed_version:vers, fixed_version:"16.95 (Build 25030928)");
