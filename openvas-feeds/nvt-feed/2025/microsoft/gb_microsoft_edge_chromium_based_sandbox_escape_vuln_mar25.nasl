...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836074");
  ...
  script_tag(name:"creation_date", value:"2025-03-27 12:52:34 +0530 (Thu, 27 Mar 2025)");
  script_name("Microsoft Edge (Chromium-Based) Sandbox Escape Vulnerability (Mar 2025)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to  version 134.0.3124.93.");
...
if(version_is_less(version:vers, test_version:"134.0.3124.93")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"134.0.3124.93", install_path:path);
