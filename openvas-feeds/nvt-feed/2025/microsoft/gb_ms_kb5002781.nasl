...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836259");
  script_version("2025-09-11T05:38:37+0000");
  script_cve_id("CVE-2025-54910", "CVE-2025-54906");
  ...
  script_name("Microsoft Office 2016 Multiple Vulnerabilities (KB5002781)");

  script_tag(name:"summary", value:"This host is missing an critical security
  update according to Microsoft KB5002781");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002781");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5517.1000")) {
        report = report_fixed_ver(file_checked:offPath + "\Mso.dll",
                 file_version:offexeVer, vulnerable_range:"16.0 - 16.0.5517.999");
