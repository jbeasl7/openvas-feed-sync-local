...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836499");
  script_version("2025-07-11T05:42:17+0000");
  script_cve_id("CVE-2025-49705", "CVE-2025-49699");
  ...
  script_tag(name:"severity_date", value:"2025-07-08 17:15:58 +0000 (Tue, 08 Jul 2025)");
  script_tag(name:"creation_date", value:"2025-07-09 09:12:56 +0530 (Wed, 09 Jul 2025)");
  script_name("Microsoft PowerPoint 2016 Multiple RCE Vulnerabilities (KB5002746)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002746");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002746");
...
foreach key(key_list) {
  ...
  if(exeVer =~ "^16\." && version_is_less(version:exeVer, test_version:"16.0.5508.1000")) {
    report = report_fixed_ver(file_checked:offPath + "\ppcore.dll", file_version:exeVer, vulnerable_range:"16.0 - 16.0.5508.999");
