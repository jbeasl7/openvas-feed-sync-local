...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836498");
  script_version("2025-07-11T05:42:17+0000");
  script_cve_id("CVE-2025-49699");
  ...
  script_name("Microsoft Outlook 2016 RCE Vulnerability (KB5002747)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002747");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002747");
...
if(version_in_range(version:outlookVer, test_version:"16.0", test_version2:"16.0.5507.999")) {
  report = report_fixed_ver(file_checked: outlookFile + "outlook.exe",
                            file_version:outlookVer, vulnerable_range:"16.0 - 16.0.5507.999");
