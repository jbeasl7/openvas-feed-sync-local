...
if(description)
{
  ...
  script_name("QNAP QuTS hero Multiple Vulnerabilities (QSA-25-21, QSA-25-23)");
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h5.x prior to h5.2.5.3138 build
  20250519.
  ...
  script_tag(name:"solution", value:"Update to version h5.2.5.3138 build 20250519 or later.");
...
if (version =~ "^h5\.") {
  if (version_is_less(version: version, test_version: "h5.2.5.3138")) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "h5.2.5.3138", fixed_build: "20250519");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "h5.2.5.3138") &&
      (!build || version_is_less(version: build, test_version: "20250519"))) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "h5.2.5.3138", fixed_build: "20250519");
    security_message(port: 0, data: report);
    exit(0);
