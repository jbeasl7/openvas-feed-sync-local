...
if(description)
{
  ...
  script_name("QNAP QuTS hero Out-of-bounds Write Vulnerability (QSA-24-52)");
  ...
  script_tag(name:"summary", value:"QNAP QuTS hero is prone to an out-of-bounds write
  vulnerability.");
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h5.1.x prior to h5.1.9.2954 build
  20241120.");

  script_tag(name:"solution", value:"Update to version h5.1.9.2954 build 20241120 or later.");
