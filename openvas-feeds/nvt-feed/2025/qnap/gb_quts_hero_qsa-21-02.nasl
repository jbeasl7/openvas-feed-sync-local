...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.119063");
  ...
  script_name("QNAP QuTS hero Heap-Based Buffer Overflow Vulnerability (QSA-21-02, Baron Samedit)");
  ...
  script_tag(name:"summary", value:"QNAP QuTS hero is prone to a heap-based buffer overflow
  vulnerability in sudo dubbed 'Baron Samedit'.");
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero versions prior to h4.5.1.1582 build 20210217.");

  script_tag(name:"solution", value:"Update to version h4.5.1.1582 build 20210217 or later.");
...
if (version_is_less(version: version, test_version: "h4.5.1.1582")) {
  report = report_fixed_ver(installed_version: version, installed_build: build,
                            fixed_version: "h4.5.1.1582", fixed_build: "20210217");
  security_message(port: 0, data: report);
  exit(0);
}

if (version_is_equal(version: version, test_version: "h4.5.1.1582") &&
   (!build || version_is_less(version: build, test_version: "20210217"))) {
  report = report_fixed_ver(installed_version: version, installed_build: build,
                            fixed_version: "h4.5.1.1582", fixed_build: "20210217");
  security_message(port: 0, data: report);
  exit(0);
