...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.118998992336");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-1189bc2336)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-1189bc2336");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-1189bc2336");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'radare2' package(s) announced via the FEDORA-2025-1189bc2336 advisory.");
...
Fix CVE-2025-1744 and CVE-2025-1864");
  ...
  script_tag(name:"affected", value:"'radare2' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"radare2", rpm:"radare2~5.9.8~7.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"radare2-common", rpm:"radare2-common~5.9.8~7.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"radare2-debuginfo", rpm:"radare2-debuginfo~5.9.8~7.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"radare2-debugsource", rpm:"radare2-debugsource~5.9.8~7.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"radare2-devel", rpm:"radare2-devel~5.9.8~7.fc42", rls:"FC42"))) {
    report += res;
  }
