...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.65369010221027");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-653690f2f7)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-653690f2f7");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-653690f2f7");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'screen' package(s) announced via the FEDORA-2025-653690f2f7 advisory.");
...
New upstream release 5.0.1");
  ...
  script_tag(name:"affected", value:"'screen' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"screen", rpm:"screen~5.0.1~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"screen-debuginfo", rpm:"screen-debuginfo~5.0.1~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"screen-debugsource", rpm:"screen-debugsource~5.0.1~4.fc41", rls:"FC41"))) {
    report += res;
  }
