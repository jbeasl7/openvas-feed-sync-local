...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.10173101971211025");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-e73ea121f5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-e73ea121f5");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-e73ea121f5");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'yarnpkg' package(s) announced via the FEDORA-2025-e73ea121f5 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yarnpkg", rpm:"yarnpkg~1.22.22~7.fc42", rls:"FC42"))) {
    report += res;
  }
