...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.797069102481014");
  script_cve_id("CVE-2015-2104", "CVE-2023-27043", "CVE-2024-28757", "CVE-2024-4030", "CVE-2024-4032", "CVE-2024-45490", "CVE-2024-45491", "CVE-2024-45492", "CVE-2024-6232", "CVE-2024-6923", "CVE-2024-7592", "CVE-2024-8088");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-7a069f48e4)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-7a069f48e4");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7a069f48e4");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.8' package(s) announced via the FEDORA-2024-7a069f48e4 advisory.");
...
- [gh-121650]([link moved to references]): [`email`]([link moved to references]) headers with embedded newlines are now quoted on output. The [`generator`]([link moved to references]) will now refuse to serialize ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'python3.8' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.8", rpm:"python3.8~3.8.20~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.8-debuginfo", rpm:"python3.8-debuginfo~3.8.20~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.8-debugsource", rpm:"python3.8-debugsource~3.8.20~1.fc41", rls:"FC41"))) {
    report += res;
  }
