...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.49965803101976");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-4c65803ea6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-4c65803ea6");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4c65803ea6");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2025-4c65803ea6 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~132.0.6834.83~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~132.0.6834.83~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~132.0.6834.83~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~132.0.6834.83~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-qt5-ui", rpm:"chromium-qt5-ui~132.0.6834.83~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-qt6-ui", rpm:"chromium-qt6-ui~132.0.6834.83~1.fc40", rls:"FC40"))) {
    report += res;
  }
