...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.9904101598951021");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-c04e5b95f1)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-c04e5b95f1");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c04e5b95f1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-libsoup' package(s) announced via the FEDORA-2025-c04e5b95f1 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mingw-libsoup", rpm:"mingw-libsoup~2.74.3~12.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-libsoup", rpm:"mingw32-libsoup~2.74.3~12.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw32-libsoup-debuginfo", rpm:"mingw32-libsoup-debuginfo~2.74.3~12.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-libsoup", rpm:"mingw64-libsoup~2.74.3~12.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mingw64-libsoup-debuginfo", rpm:"mingw64-libsoup-debuginfo~2.74.3~12.fc42", rls:"FC42"))) {
    report += res;
  }
