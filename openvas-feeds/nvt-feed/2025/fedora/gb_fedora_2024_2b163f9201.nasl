...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.2981631029201");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-2b163f9201)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2b163f9201");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-2b163f9201");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2293390");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2303157");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2307459");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2310088");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.10' package(s) announced via the FEDORA-2024-2b163f9201 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This is a security release of Python 3.10
-----------------------------------------
...
- [gh-121650]([link moved to references]): [`email`]([link moved to references]) headers with embedded newlines are now quoted on output. The [`generator`]([link moved to references]) will now refuse to serialize ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'python3.10' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.10", rpm:"python3.10~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-debug", rpm:"python3.10-debug~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-debuginfo", rpm:"python3.10-debuginfo~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-debugsource", rpm:"python3.10-debugsource~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-devel", rpm:"python3.10-devel~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-idle", rpm:"python3.10-idle~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-libs", rpm:"python3.10-libs~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-test", rpm:"python3.10-test~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.10-tkinter", rpm:"python3.10-tkinter~3.10.15~1.fc41", rls:"FC41"))) {
    report += res;
  }
