...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.9999102910078997");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-c99f9d789a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-c99f9d789a");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c99f9d789a");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the FEDORA-2025-c99f9d789a advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~67.1.fc41", rls:"FC41"))) {
    report += res;
  }
