...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.9949791025410014");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-c4a9f54d14)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-c4a9f54d14");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c4a9f54d14");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2025-c4a9f54d14 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~135.0.7049.52~2.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~135.0.7049.52~2.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~135.0.7049.52~2.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~135.0.7049.52~2.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-qt5-ui", rpm:"chromium-qt5-ui~135.0.7049.52~2.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-qt6-ui", rpm:"chromium-qt6-ui~135.0.7049.52~2.fc42", rls:"FC42"))) {
    report += res;
  }
