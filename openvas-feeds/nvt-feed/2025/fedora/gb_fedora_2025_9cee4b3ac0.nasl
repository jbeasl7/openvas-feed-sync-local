...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.999101101498397990");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-9cee4b3ac0)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-9cee4b3ac0");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-9cee4b3ac0");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh2' package(s) announced via the FEDORA-2025-9cee4b3ac0 advisory.");
...
In addition, there are a large number of bug fixes and enhancements, which again are described in the `RELEASE_NOTES` file.");
  ...
  script_tag(name:"affected", value:"'libssh2' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh2", rpm:"libssh2~1.11.1~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-debuginfo", rpm:"libssh2-debuginfo~1.11.1~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-debugsource", rpm:"libssh2-debugsource~1.11.1~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-devel", rpm:"libssh2-devel~1.11.1~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-docs", rpm:"libssh2-docs~1.11.1~1.fc41", rls:"FC41"))) {
    report += res;
  }
