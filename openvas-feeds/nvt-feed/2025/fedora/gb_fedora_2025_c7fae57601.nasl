...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.9971029710157601");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-c7fae57601)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-c7fae57601");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c7fae57601");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'vyper' package(s) announced via the FEDORA-2025-c7fae57601 advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vyper", rpm:"vyper~0.4.1~1.fc41", rls:"FC41"))) {
    report += res;
  }
