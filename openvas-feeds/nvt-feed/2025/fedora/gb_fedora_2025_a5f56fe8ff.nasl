...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.975102561021018102102");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-a5f56fe8ff)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-a5f56fe8ff");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-a5f56fe8ff");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2369708");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail' package(s) announced via the FEDORA-2025-a5f56fe8ff advisory.");
...
* Fix bug where attachments with content type of application/vnd.ms-tnef were not parsed (#7119)");
  ...
  script_tag(name:"affected", value:"'roundcubemail' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.6.11~1.fc41", rls:"FC41"))) {
    report += res;
  }
