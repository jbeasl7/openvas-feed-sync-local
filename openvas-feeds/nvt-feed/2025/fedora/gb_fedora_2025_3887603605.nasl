...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.3887603605");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-3887603605)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-3887603605");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-3887603605");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client' package(s) announced via the FEDORA-2025-3887603605 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~9.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpki-client-debuginfo", rpm:"rpki-client-debuginfo~9.5~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpki-client-debugsource", rpm:"rpki-client-debugsource~9.5~1.fc42", rls:"FC42"))) {
    report += res;
  }
