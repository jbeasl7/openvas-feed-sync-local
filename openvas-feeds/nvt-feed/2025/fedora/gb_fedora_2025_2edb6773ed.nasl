...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.2101100986773101100");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-2edb6773ed)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-2edb6773ed");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2edb6773ed");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'incus' package(s) announced via the FEDORA-2025-2edb6773ed advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"incus", rpm:"incus~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-agent", rpm:"incus-agent~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-agent-debuginfo", rpm:"incus-agent-debuginfo~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-client", rpm:"incus-client~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-client-debuginfo", rpm:"incus-client-debuginfo~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-debuginfo", rpm:"incus-debuginfo~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-debugsource", rpm:"incus-debugsource~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-selinux", rpm:"incus-selinux~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-tools", rpm:"incus-tools~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"incus-tools-debuginfo", rpm:"incus-tools-debuginfo~6.15~1.fc42", rls:"FC42"))) {
    report += res;
  }
