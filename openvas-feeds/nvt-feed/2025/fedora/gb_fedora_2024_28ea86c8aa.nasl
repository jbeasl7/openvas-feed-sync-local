...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.2810197869989797");
  script_cve_id("CVE-2024-21820", "CVE-2024-21853", "CVE-2024-23918", "CVE-2024-23984");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-28ea86c8aa)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-28ea86c8aa");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-28ea86c8aa");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the FEDORA-2024-28ea86c8aa advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"- Update to upstream 2.1-47. 20241112
 ...
 - Update of 06-97-05/0x07 (ADL-S 6+0 K0) microcode ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~67.fc41", rls:"FC41"))) {
    report += res;
  }
