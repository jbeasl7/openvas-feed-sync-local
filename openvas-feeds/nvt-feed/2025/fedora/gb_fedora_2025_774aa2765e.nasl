...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.77497972765101");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-774aa2765e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-774aa2765e");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-774aa2765e");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2375936");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'guacamole-server' package(s) announced via the FEDORA-2025-774aa2765e advisory.");
 ...
 * Enforce user access ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'guacamole-server' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"guacamole-server", rpm:"guacamole-server~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"guacamole-server-debuginfo", rpm:"guacamole-server-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"guacamole-server-debugsource", rpm:"guacamole-server-debugsource~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"guacd", rpm:"guacd~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"guacd-debuginfo", rpm:"guacd-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac", rpm:"libguac~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-kubernetes", rpm:"libguac-client-kubernetes~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-kubernetes-debuginfo", rpm:"libguac-client-kubernetes-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-rdp", rpm:"libguac-client-rdp~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-rdp-debuginfo", rpm:"libguac-client-rdp-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-ssh", rpm:"libguac-client-ssh~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-ssh-debuginfo", rpm:"libguac-client-ssh-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-telnet", rpm:"libguac-client-telnet~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-telnet-debuginfo", rpm:"libguac-client-telnet-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-vnc", rpm:"libguac-client-vnc~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-client-vnc-debuginfo", rpm:"libguac-client-vnc-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-debuginfo", rpm:"libguac-debuginfo~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libguac-devel", rpm:"libguac-devel~1.6.0~1.fc42", rls:"FC42"))) {
    report += res;
  }
