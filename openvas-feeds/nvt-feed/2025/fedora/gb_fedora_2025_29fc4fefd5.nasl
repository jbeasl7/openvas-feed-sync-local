...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.291029941021011021005");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-29fc4fefd5)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-29fc4fefd5");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-29fc4fefd5");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2342133");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2342337");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'fastd' package(s) announced via the FEDORA-2025-29fc4fefd5 advisory.");
...
- Fix config loading to fail on `offload l2tp no,` when L2TP offloading is unsupported by the ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'fastd' package(s) on Fedora 40.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"fastd", rpm:"fastd~23~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fastd-debuginfo", rpm:"fastd-debuginfo~23~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"fastd-debugsource", rpm:"fastd-debugsource~23~1.fc40", rls:"FC40"))) {
    report += res;
  }
