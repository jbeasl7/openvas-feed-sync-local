...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.61009979897899399");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-6d9aba8c3c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-6d9aba8c3c");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6d9aba8c3c");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'llvm-test-suite' package(s) announced via the FEDORA-2024-6d9aba8c3c advisory.");
...
+ ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'llvm-test-suite' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"llvm-test-suite", rpm:"llvm-test-suite~19.1.0~4.fc41", rls:"FC41"))) {
    report += res;
  }
