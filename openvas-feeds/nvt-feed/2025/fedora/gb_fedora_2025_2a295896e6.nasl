...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.2972958961016");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-2a295896e6)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-2a295896e6");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2a295896e6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'suricata' package(s) announced via the FEDORA-2025-2a295896e6 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"suricata", rpm:"suricata~7.0.10~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"suricata-debuginfo", rpm:"suricata-debuginfo~7.0.10~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"suricata-debugsource", rpm:"suricata-debugsource~7.0.10~1.fc40", rls:"FC40"))) {
    report += res;
  }
