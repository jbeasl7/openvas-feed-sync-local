...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.19957101211009799");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-1c57e21dac)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-1c57e21dac");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-1c57e21dac");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'deluge' package(s) announced via the FEDORA-2025-1c57e21dac advisory.");
...
AutoAdd
 ...
 Fix #3515 - Torrent file decoding errors disabled watch folder.");
  ...
  script_tag(name:"affected", value:"'deluge' package(s) on Fedora 42.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"deluge", rpm:"deluge~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deluge-common", rpm:"deluge-common~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deluge-console", rpm:"deluge-console~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deluge-daemon", rpm:"deluge-daemon~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deluge-gtk", rpm:"deluge-gtk~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deluge-images", rpm:"deluge-images~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"deluge-web", rpm:"deluge-web~2.2.0~1.fc42", rls:"FC42"))) {
    report += res;
  }
