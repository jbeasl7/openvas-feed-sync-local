...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.49889798383499");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-4b8ab3834c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-4b8ab3834c");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-4b8ab3834c");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2327066");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2331110");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2334300");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2334303");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2334305");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2334346");
  script_xref(name:"URL", value:"https://github.com/phpmyadmin/phpmyadmin/blob/RELEASE_5_2_2/ChangeLog");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'phpMyAdmin' package(s) announced via the FEDORA-2025-4b8ab3834c advisory.");
...
There are many, many more fixes that you can see in the ChangeLog file included with this release or [online]([link moved to references])");
  ...
  script_tag(name:"affected", value:"'phpMyAdmin' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"phpMyAdmin", rpm:"phpMyAdmin~5.2.2~1.fc41", rls:"FC41"))) {
    report += res;
  }
