...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.7799631017236");
  script_cve_id("CVE-2025-21607", "CVE-2025-26622", "CVE-2025-27104", "CVE-2025-27105");
  script_tag(name:"creation_date", value:"2025-03-12 04:04:51 +0000 (Wed, 12 Mar 2025)");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-77c63e7236)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-77c63e7236");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-77c63e7236");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'vyper' package(s) announced via the FEDORA-2025-77c63e7236 advisory.");
...
Fix for a few known issues");
  ...
  script_tag(name:"affected", value:"'vyper' package(s) on Fedora 40.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vyper", rpm:"vyper~0.4.1~1.fc40", rls:"FC40"))) {
    report += res;
  }
