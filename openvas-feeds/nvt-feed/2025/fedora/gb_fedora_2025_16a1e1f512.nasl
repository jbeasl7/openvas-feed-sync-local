...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.169711011102512");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-16a1e1f512)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-16a1e1f512");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-16a1e1f512");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay' package(s) announced via the FEDORA-2025-16a1e1f512 advisory.");
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'tcpreplay' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.5.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcpreplay-debuginfo", rpm:"tcpreplay-debuginfo~4.5.2~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tcpreplay-debugsource", rpm:"tcpreplay-debugsource~4.5.2~1.fc41", rls:"FC41"))) {
    report += res;
  }
