...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.5021029797722101");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-502faa722e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-502faa722e");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-502faa722e");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2388158");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2388163");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2388164");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2025-502faa722e advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~139.0.7258.127~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~139.0.7258.127~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~139.0.7258.127~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~139.0.7258.127~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-qt5-ui", rpm:"chromium-qt5-ui~139.0.7258.127~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-qt6-ui", rpm:"chromium-qt6-ui~139.0.7258.127~1.fc42", rls:"FC42"))) {
    report += res;
  }
