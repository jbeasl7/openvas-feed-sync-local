...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.298299756499");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-2b2997564c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-2b2997564c");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-2b2997564c");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'open62541' package(s) announced via the FEDORA-2025-2b2997564c advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"open62541", rpm:"open62541~1.4.13~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"open62541-debuginfo", rpm:"open62541-debuginfo~1.4.13~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"open62541-debugsource", rpm:"open62541-debugsource~1.4.13~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"open62541-devel", rpm:"open62541-devel~1.4.13~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"open62541-doc", rpm:"open62541-doc~1.4.13~1.fc41", rls:"FC41"))) {
    report += res;
  }
