...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.31977101101102988102");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-31a7eefb8f)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-31a7eefb8f");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-31a7eefb8f");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'salt' package(s) announced via the FEDORA-2025-31a7eefb8f advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"salt", rpm:"salt~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"salt-api", rpm:"salt-api~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"salt-cloud", rpm:"salt-cloud~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"salt-master", rpm:"salt-master~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"salt-minion", rpm:"salt-minion~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"salt-ssh", rpm:"salt-ssh~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"salt-syndic", rpm:"salt-syndic~3007.4~4.fc41", rls:"FC41"))) {
    report += res;
  }
