...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.6797389808197");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-67a38b081a)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-67a38b081a");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-67a38b081a");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2305324");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the FEDORA-2024-67a38b081a advisory.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~64.fc41", rls:"FC41"))) {
    report += res;
  }
