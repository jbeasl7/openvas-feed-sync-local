...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.82714100989822");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-82714dbb22)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-82714dbb22");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-82714dbb22");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'SDL2_sound' package(s) announced via the FEDORA-2025-82714dbb22 advisory.");
...
CVE-2023-45682: Wild address read in vorbis_decode_packet_rest()");
  ...
  script_tag(name:"affected", value:"'SDL2_sound' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"SDL2_sound", rpm:"SDL2_sound~2.0.4~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"SDL2_sound-debuginfo", rpm:"SDL2_sound-debuginfo~2.0.4~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"SDL2_sound-debugsource", rpm:"SDL2_sound-debugsource~2.0.4~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"SDL2_sound-devel", rpm:"SDL2_sound-devel~2.0.4~1.fc41", rls:"FC41"))) {
    report += res;
  }
