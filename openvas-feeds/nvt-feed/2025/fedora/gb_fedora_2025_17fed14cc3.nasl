...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.171021011001499993");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-17fed14cc3)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-17fed14cc3");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-17fed14cc3");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'rpki-client' package(s) announced via the FEDORA-2025-17fed14cc3 advisory.");
...
- Starting with release 9.6, rpki-client will emit all key identifiers (AKI and SKI) encoded in JSON as bare hex strings without colons.");
  ...
  script_tag(name:"affected", value:"'rpki-client' package(s) on Fedora 41.");
...
if(release == "FC41") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rpki-client", rpm:"rpki-client~9.5~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpki-client-debuginfo", rpm:"rpki-client-debuginfo~9.5~1.fc41", rls:"FC41"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rpki-client-debugsource", rpm:"rpki-client-debugsource~9.5~1.fc41", rls:"FC41"))) {
    report += res;
  }
