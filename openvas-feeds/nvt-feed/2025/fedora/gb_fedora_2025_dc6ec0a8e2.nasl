...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.1009961019909781012");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-dc6ec0a8e2)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-dc6ec0a8e2");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-dc6ec0a8e2");
  ...
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2369337");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2369379");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2370279");
  script_xref(name:"URL", value:"https://downloads.isc.org/isc/kea/2.6.3/Kea-2.6.3-ReleaseNotes.txt");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kea' package(s) announced via the FEDORA-2025-dc6ec0a8e2 advisory.");
...
if(release == "FC42") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kea", rpm:"kea~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-debuginfo", rpm:"kea-debuginfo~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-debugsource", rpm:"kea-debugsource~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-devel", rpm:"kea-devel~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-doc", rpm:"kea-doc~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-hooks", rpm:"kea-hooks~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-hooks-debuginfo", rpm:"kea-hooks-debuginfo~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-keama", rpm:"kea-keama~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-keama-debuginfo", rpm:"kea-keama-debuginfo~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-libs", rpm:"kea-libs~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kea-libs-debuginfo", rpm:"kea-libs-debuginfo~2.6.3~1.fc42", rls:"FC42"))) {
    report += res;
  }
