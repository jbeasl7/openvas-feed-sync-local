...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2025.9958133101520");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2025-c58133e520)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2025-c58133e520");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2025-c58133e520");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2335113");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxmp' package(s) announced via the FEDORA-2025-c58133e520 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxmp", rpm:"libxmp~4.6.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxmp-debuginfo", rpm:"libxmp-debuginfo~4.6.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxmp-debugsource", rpm:"libxmp-debugsource~4.6.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxmp-devel", rpm:"libxmp-devel~4.6.1~2.fc40", rls:"FC40"))) {
    report += res;
  }
