...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.3.x Multiple Vulnerabilities (Synology_SA_25_04) - Unreliable Remote Version Check");
...
if (version =~ "^1\.3\.1-9346" && (revcomp(a: version, b: "1.3.1-9346-13") < 0)) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.3.1-9346-13");
  security_message(port: 0, data: report);
  exit(0);
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.154199
