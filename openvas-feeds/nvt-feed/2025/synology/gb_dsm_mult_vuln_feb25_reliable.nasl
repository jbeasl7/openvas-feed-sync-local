...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.171234");
  ...
  script_name("Synology DiskStation Manager (DSM) Multiple Vulnerabilities (Synology-SA-25:01, Synology-SA-25:03) - Remote Known Vulnerable Versions Check");
...
# 7.2.2-72806-3 and not 7.2.2-72806), there will be 2 VTs with different qod_type.
...
if (version =~ "^7\.2" && (revcomp(a: version, b: "7.2.1-69057") < 0)) {
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.171235
if (version =~ "^7\.1\.1-42962" || version =~ "^7\.2\.1-69057" ||
    version =~ "^7\.2\.2-72806")
  exit(0);
