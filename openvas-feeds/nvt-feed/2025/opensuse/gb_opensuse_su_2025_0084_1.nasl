...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.1.2025.0084.1");
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2025:0084-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2025:0084-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/RXNDPKOASMYM2SMWNDENDFTKUIT4CM4A/");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1238575");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the openSUSE-SU-2025:0084-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Chromium was updated to 134.0.6998.35 (stable release 2025-03-04) (boo#1238575):
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~134.0.6998.35~bp156.2.90.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~134.0.6998.35~bp156.2.90.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
