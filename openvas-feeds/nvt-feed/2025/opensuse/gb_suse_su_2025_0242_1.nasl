...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_150-default-debuginfo-15", rpm:"kernel-livepatch-5_3_18-150300_59_150-default-debuginfo-15~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_150-default-15", rpm:"kernel-livepatch-5_3_18-150300_59_150-default-15~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3_Update_41-debugsource-15", rpm:"kernel-livepatch-SLE15-SP3_Update_41-debugsource-15~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_150-preempt-15", rpm:"kernel-livepatch-5_3_18-150300_59_150-preempt-15~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_150-preempt-debuginfo-15", rpm:"kernel-livepatch-5_3_18-150300_59_150-preempt-debuginfo-15~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
