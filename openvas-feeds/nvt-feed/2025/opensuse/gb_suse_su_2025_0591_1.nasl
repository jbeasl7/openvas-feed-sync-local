...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0591.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0591-1)");
...
- Intel CPU Microcode was updated to the 20250211 release (bsc#1237096)
 ...
 <pipe> RPL-E/HX/S <pipe> B0 <pipe> 06-b7-01/32 <pipe> 0000012b <pipe> 0000012c <pipe> ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'ucode-intel' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250211~150200.53.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
