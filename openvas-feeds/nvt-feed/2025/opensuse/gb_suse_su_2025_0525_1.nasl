...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0525.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0525-1)");
 ...
 * The `PUT /api/folders/:uid` endpoint ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'SUSE Manager Client Tools' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dracut-saltboot", rpm:"dracut-saltboot~0.1.1728559936.c16d4fb~150000.1.56.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-promu", rpm:"golang-github-prometheus-promu~0.17.0~150000.3.24.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"spacecmd", rpm:"spacecmd~5.0.11~150000.3.130.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"supportutils-plugin-salt", rpm:"supportutils-plugin-salt~1.2.3~150000.3.16.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"supportutils-plugin-susemanager-client", rpm:"supportutils-plugin-susemanager-client~5.0.4~150000.3.27.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
