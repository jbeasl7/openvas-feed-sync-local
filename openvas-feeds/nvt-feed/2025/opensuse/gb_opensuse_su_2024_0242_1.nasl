...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.1.2024.0242.1");
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0242-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2024:0242-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/VLQLL2NJLWVHFDIAGLNKQMBBCIEQQ32B/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opera' package(s) announced via the openSUSE-SU-2024:0242-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~112.0.5197.53~lp156.2.14.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
