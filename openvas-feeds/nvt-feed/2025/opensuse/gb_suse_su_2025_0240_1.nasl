...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_158-default-debuginfo-11", rpm:"kernel-livepatch-5_3_18-150300_59_158-default-debuginfo-11~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3_Update_43-debugsource-11", rpm:"kernel-livepatch-SLE15-SP3_Update_43-debugsource-11~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_158-default-11", rpm:"kernel-livepatch-5_3_18-150300_59_158-default-11~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_158-preempt-debuginfo-11", rpm:"kernel-livepatch-5_3_18-150300_59_158-preempt-debuginfo-11~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_158-preempt-11", rpm:"kernel-livepatch-5_3_18-150300_59_158-preempt-11~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
