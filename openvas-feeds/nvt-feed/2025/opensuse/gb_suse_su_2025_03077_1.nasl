...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.03077.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:03077-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"librav1e0_6", rpm:"librav1e0_6~0.6.6~150600.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"librav1e0_6-32bit", rpm:"librav1e0_6-32bit~0.6.6~150600.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rav1e", rpm:"rav1e~0.6.6~150600.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rav1e-devel", rpm:"rav1e-devel~0.6.6~150600.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
