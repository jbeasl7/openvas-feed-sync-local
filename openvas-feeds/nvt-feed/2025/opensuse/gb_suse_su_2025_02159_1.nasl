...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.02159.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:02159-1)");
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'apache-commons-fileupload' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apache-commons-fileupload", rpm:"apache-commons-fileupload~1.6.0~150200.3.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache-commons-fileupload-javadoc", rpm:"apache-commons-fileupload-javadoc~1.6.0~150200.3.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
