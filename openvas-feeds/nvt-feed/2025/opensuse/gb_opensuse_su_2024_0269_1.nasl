...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.1.2024.0269.1");
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0269-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2024:0269-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/OQ7DWO7D4FBUA7VBLBTF3YWOOT4647TB/");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1224781");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1227022");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trivy' package(s) announced via the openSUSE-SU-2024:0269-1 advisory.");
...
* refactor(secret): ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"trivy", rpm:"trivy~0.54.1~bp156.2.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
