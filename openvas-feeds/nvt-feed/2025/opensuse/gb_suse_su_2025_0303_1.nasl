...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0303-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-libxml2-python", rpm:"python3-libxml2-python~2.9.7~150000.3.73.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
