...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.1.2024.0276.1");
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0276-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2024:0276-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/JAAOBG657QTBRHKB55GHL2C7553NKG67/");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cacti, cacti-spine' package(s) announced via the openSUSE-SU-2024:0276-1 advisory.");
 ...
 * Restore AES Support");
  ...
  script_tag(name:"affected", value:"'cacti, cacti-spine' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cacti", rpm:"cacti~1.2.27~bp156.2.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cacti-spine", rpm:"cacti-spine~1.2.27~bp156.2.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
