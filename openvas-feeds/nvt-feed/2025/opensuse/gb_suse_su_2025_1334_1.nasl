...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.1334.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:1334-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pam", rpm:"pam~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pam-32bit", rpm:"pam-32bit~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pam-devel", rpm:"pam-devel~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pam-devel-32bit", rpm:"pam-devel-32bit~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pam-doc", rpm:"pam-doc~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pam-extra", rpm:"pam-extra~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pam-extra-32bit", rpm:"pam-extra-32bit~1.3.0~150000.6.76.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
