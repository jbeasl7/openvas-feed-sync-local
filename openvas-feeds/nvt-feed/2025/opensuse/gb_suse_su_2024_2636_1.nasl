...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.2636.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2636-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:2636-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242636-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228255");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228256");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228257");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228258");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/036147.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the SUSE-SU-2024:2636-1 advisory.");
 ...
 * When looking up the NS records of parent zones as part of
 ...
 fixed. (CVE-2024-4076)");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bind", rpm:"bind~9.18.28~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-doc", rpm:"bind-doc~9.18.28~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-utils", rpm:"bind-utils~9.18.28~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
