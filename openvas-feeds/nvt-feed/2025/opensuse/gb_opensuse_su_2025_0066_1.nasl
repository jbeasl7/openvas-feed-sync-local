...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.1.2025.0066.1");
  script_cve_id("CVE-2020-14803", "CVE-2021-41041", "CVE-2022-21426", "CVE-2022-21434", "CVE-2022-21443", "CVE-2022-21476", "CVE-2022-21496", "CVE-2022-21540", "CVE-2022-21541", "CVE-2022-21618", "CVE-2022-21619", "CVE-2022-21624", "CVE-2022-21626", "CVE-2022-21628", "CVE-2022-34169", "CVE-2022-3676", "CVE-2022-39399", "CVE-2023-21835", "CVE-2023-21843", "CVE-2023-21930", "CVE-2023-21937", "CVE-2023-21938", "CVE-2023-21939", "CVE-2023-21954", "CVE-2023-21967", "CVE-2023-21968", "CVE-2023-22006", "CVE-2023-22036", "CVE-2023-22041", "CVE-2023-22045", "CVE-2023-22049", "CVE-2023-22081", "CVE-2023-25193", "CVE-2023-2597", "CVE-2023-5676", "CVE-2024-20918", "CVE-2024-20919", "CVE-2024-20921", "CVE-2024-20926", "CVE-2024-20945", "CVE-2024-20952", "CVE-2024-21011", "CVE-2024-21012", "CVE-2024-21068", "CVE-2024-21085", "CVE-2024-21094", "CVE-2024-21131", "CVE-2024-21138", "CVE-2024-21140", "CVE-2024-21144", "CVE-2024-21145", "CVE-2024-21147", "CVE-2024-21208", "CVE-2024-21210", "CVE-2024-21217", "CVE-2024-21235", "CVE-2024-3933", "CVE-2025-21502");
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2025:0066-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2025:0066-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GS63GCBRVH7N4JEIZNQAPVFNNVB2OGSU/");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181239");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185055");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185056");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188564");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188565");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188566");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191901");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191903");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191904");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191906");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191909");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191910");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191911");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191912");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191913");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191914");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194925");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194926");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194927");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194928");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194929");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194930");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194931");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194932");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194933");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194934");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194935");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194937");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194939");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194940");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194941");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198671");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198672");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198673");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198674");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198675");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198935");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222984");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222986");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222987");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1225470");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228050");
  ...
  script_xref(name:"URL", value:"https://www.eclipse.org/openj9/docs/version0.24");
  script_xref(name:"URL", value:"https://www.eclipse.org/openj9/docs/version0.26");
  script_xref(name:"URL", value:"https://www.eclipse.org/openj9/docs/version0.29");
  script_xref(name:"URL", value:"https://www.eclipse.org/openj9/docs/version0.30.1");
  script_xref(name:"URL", value:"https://www.eclipse.org/openj9/docs/version0.32");
  script_xref(name:"URL", value:"https://www.eclipse.org/openj9/docs/version0.33");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-11-openj9' package(s) announced via the openSUSE-SU-2025:0066-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for java-11-openj9 fixes the following issues:
 ...
 * ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'java-11-openj9' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9", rpm:"java-11-openj9~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9-demo", rpm:"java-11-openj9-demo~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9-devel", rpm:"java-11-openj9-devel~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9-headless", rpm:"java-11-openj9-headless~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9-javadoc", rpm:"java-11-openj9-javadoc~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9-jmods", rpm:"java-11-openj9-jmods~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-11-openj9-src", rpm:"java-11-openj9-src~11.0.26.0~bp156.4.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
