...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.01884.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:01884-1)");
...
- CVE-2024-2467: Side-channel attack in PKCS#1 v1.5 padding mode (Marvin Attack)
 (bsc#1221446)");
  ...
  script_tag(name:"affected", value:"'perl-Crypt-OpenSSL-RSA' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Crypt-OpenSSL-RSA", rpm:"perl-Crypt-OpenSSL-RSA~0.28~150600.19.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
