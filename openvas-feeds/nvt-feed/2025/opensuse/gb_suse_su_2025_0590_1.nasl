...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0590.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0590-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netty", rpm:"netty~4.1.118~150200.4.29.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"netty-javadoc", rpm:"netty-javadoc~4.1.118~150200.4.29.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"netty-tcnative", rpm:"netty-tcnative~2.0.70~150200.3.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"netty-tcnative-javadoc", rpm:"netty-tcnative-javadoc~2.0.70~150200.3.25.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
