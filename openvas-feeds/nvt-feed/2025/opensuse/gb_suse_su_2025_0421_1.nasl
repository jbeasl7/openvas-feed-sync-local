...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0421.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0421-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0421-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250421-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218886");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218887");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-February/020305.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ovmf' package(s) announced via the SUSE-SU-2025:0421-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ovmf", rpm:"ovmf~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovmf-tools", rpm:"ovmf-tools~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-ia32", rpm:"qemu-ovmf-ia32~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86_64", rpm:"qemu-ovmf-x86_64~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86_64-debug", rpm:"qemu-ovmf-x86_64-debug~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-uefi-aarch32", rpm:"qemu-uefi-aarch32~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-uefi-aarch64", rpm:"qemu-uefi-aarch64~202308~150600.5.9.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
