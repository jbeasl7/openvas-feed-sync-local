...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.0730.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0730-1)");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"corepack18", rpm:"corepack18~18.19.1~150400.9.18.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18", rpm:"nodejs18~18.19.1~150400.9.18.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18-devel", rpm:"nodejs18-devel~18.19.1~150400.9.18.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs18-docs", rpm:"nodejs18-docs~18.19.1~150400.9.18.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm18", rpm:"npm18~18.19.1~150400.9.18.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }
