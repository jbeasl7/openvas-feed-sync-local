...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.03260.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:03260-1)");
...
- Fix netrom support.");
  ...
  script_tag(name:"affected", value:"'net-tools' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"net-tools", rpm:"net-tools~2.0+git20170221.479bb4a~150000.5.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"net-tools-deprecated", rpm:"net-tools-deprecated~2.0+git20170221.479bb4a~150000.5.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"net-tools-lang", rpm:"net-tools-lang~2.0+git20170221.479bb4a~150000.5.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
