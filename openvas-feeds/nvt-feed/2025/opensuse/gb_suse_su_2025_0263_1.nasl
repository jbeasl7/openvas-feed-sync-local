...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-6_4_0-150600_21-default-9", rpm:"kernel-livepatch-6_4_0-150600_21-default-9~150600.4.19.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-6_4_0-150600_21-default-debuginfo-9", rpm:"kernel-livepatch-6_4_0-150600_21-default-debuginfo-9~150600.4.19.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP6_Update_0-debugsource-9", rpm:"kernel-livepatch-SLE15-SP6_Update_0-debugsource-9~150600.4.19.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
