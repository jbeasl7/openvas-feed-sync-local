...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.0898.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0898-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0898-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240898-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-March/018169.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdb' package(s) announced via the SUSE-SU-2024:0898-1 advisory.");
 ...
 * New ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~13.2~150400.15.14.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdb-testresults", rpm:"gdb-testresults~13.2~150400.15.14.4", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdbserver", rpm:"gdbserver~13.2~150400.15.14.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
