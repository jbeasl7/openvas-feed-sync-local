...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.1530.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1530-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1530-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241530-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1219912");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222155");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-May/035151.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'grafana and mybatis' package(s) announced via the SUSE-SU-2024:1530-1 advisory.");
...
- Fixed building with log4j v1 and v2 dependencies");
  ...
  script_tag(name:"affected", value:"'grafana and mybatis' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grafana", rpm:"grafana~9.5.18~150200.3.56.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mybatis", rpm:"mybatis~3.5.6~150200.5.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mybatis-javadoc", rpm:"mybatis-javadoc~3.5.6~150200.5.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
