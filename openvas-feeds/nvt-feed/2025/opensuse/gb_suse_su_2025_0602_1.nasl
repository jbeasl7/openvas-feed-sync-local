...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0602.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0602-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"helm", rpm:"helm~3.17.1~150000.1.41.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"helm-bash-completion", rpm:"helm-bash-completion~3.17.1~150000.1.41.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"helm-fish-completion", rpm:"helm-fish-completion~3.17.1~150000.1.41.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"helm-zsh-completion", rpm:"helm-zsh-completion~3.17.1~150000.1.41.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
