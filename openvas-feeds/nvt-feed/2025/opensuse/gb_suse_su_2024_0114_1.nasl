...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.0114.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0114-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0114-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240114-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017670.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xwayland' package(s) announced via the SUSE-SU-2024:0114-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xwayland", rpm:"xwayland~22.1.5~150500.7.14.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xwayland-devel", rpm:"xwayland-devel~22.1.5~150500.7.14.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
