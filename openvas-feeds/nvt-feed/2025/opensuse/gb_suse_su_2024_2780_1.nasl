...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.2780.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2780-1)");
...
- CVE-2019-20633: Fixed double-free/OOB read in pch.c (bsc#1167721)");
  ...
  script_tag(name:"affected", value:"'patch' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"patch", rpm:"patch~2.7.6~150000.5.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"patch", rpm:"patch~2.7.6~150000.5.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
