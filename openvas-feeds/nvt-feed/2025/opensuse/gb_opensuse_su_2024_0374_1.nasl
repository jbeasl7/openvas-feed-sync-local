...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.1.2024.0374.1");
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0374-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2024:0374-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/A7QMTYLP34CYAKUQBOBH4ELPCOH5C2VF/");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1233311");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the openSUSE-SU-2024:0374-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~131.0.6778.69~bp156.2.53.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~131.0.6778.69~bp156.2.53.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
