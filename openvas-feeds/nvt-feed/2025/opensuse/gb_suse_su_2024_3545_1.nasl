...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.3545.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3545-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3545-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243545-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231208");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231230");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-October/037169.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah' package(s) announced via the SUSE-SU-2024:3545-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.35.4~150500.3.13.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.35.4~150500.3.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
