...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0985.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0985-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bsdtar", rpm:"bsdtar~3.7.2~150600.3.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive-devel", rpm:"libarchive-devel~3.7.2~150600.3.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive13", rpm:"libarchive13~3.7.2~150600.3.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive13-32bit", rpm:"libarchive13-32bit~3.7.2~150600.3.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
