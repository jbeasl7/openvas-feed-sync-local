...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.1439.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:1439-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:1439-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20251439-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1241453");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1241551");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-May/039132.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2' package(s) announced via the SUSE-SU-2025:1439-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-libxml2-python", rpm:"python3-libxml2-python~2.9.7~150000.3.79.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
