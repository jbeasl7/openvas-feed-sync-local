...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.02566.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:02566-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:02566-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202502566-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-July/040969.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive' package(s) announced via the SUSE-SU-2025:02566-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bsdtar", rpm:"bsdtar~3.7.2~150600.3.17.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive-devel", rpm:"libarchive-devel~3.7.2~150600.3.17.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive13", rpm:"libarchive13~3.7.2~150600.3.17.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive13-32bit", rpm:"libarchive13-32bit~3.7.2~150600.3.17.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
