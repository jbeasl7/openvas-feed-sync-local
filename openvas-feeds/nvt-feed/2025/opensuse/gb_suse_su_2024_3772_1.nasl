...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.3772.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3772-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3772-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243772-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-October/019688.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.22-openssl' package(s) announced via the SUSE-SU-2024:3772-1 advisory.");
...
- go1.22.5 (released 2024-07-02) includes security fixes to the
 ...
 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'go1.22-openssl' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.22-openssl", rpm:"go1.22-openssl~1.22.7.1~150000.1.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.22-openssl-doc", rpm:"go1.22-openssl-doc~1.22.7.1~150000.1.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.22-openssl-race", rpm:"go1.22-openssl-race~1.22.7.1~150000.1.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
