...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2024.2574.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2574-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:2574-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242574-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/036101.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs20' package(s) announced via the SUSE-SU-2024:2574-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"corepack20", rpm:"corepack20~20.15.1~150600.3.3.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20", rpm:"nodejs20~20.15.1~150600.3.3.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20-devel", rpm:"nodejs20-devel~20.15.1~150600.3.3.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nodejs20-docs", rpm:"nodejs20-docs~20.15.1~150600.3.3.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"npm20", rpm:"npm20~20.15.1~150600.3.3.2", rls:"openSUSELeap15.6"))) {
    report += res;
  }
