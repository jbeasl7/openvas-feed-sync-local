...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_161-default-9", rpm:"kernel-livepatch-5_3_18-150300_59_161-default-9~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3_Update_44-debugsource-9", rpm:"kernel-livepatch-SLE15-SP3_Update_44-debugsource-9~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_161-default-debuginfo-9", rpm:"kernel-livepatch-5_3_18-150300_59_161-default-debuginfo-9~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_161-preempt-debuginfo-9", rpm:"kernel-livepatch-5_3_18-150300_59_161-preempt-debuginfo-9~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_161-preempt-9", rpm:"kernel-livepatch-5_3_18-150300_59_161-preempt-9~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
