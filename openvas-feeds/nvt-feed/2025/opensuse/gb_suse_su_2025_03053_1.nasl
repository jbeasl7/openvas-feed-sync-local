...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.03053.1");
  script_cve_id("CVE-2025-20053", "CVE-2025-20109", "CVE-2025-22839", "CVE-2025-22840", "CVE-2025-22889", "CVE-2025-26403", "CVE-2025-32086");
  script_tag(name:"creation_date", value:"2025-09-03 14:29:46 +0000 (Wed, 03 Sep 2025)");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:03053-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250812~150200.59.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
