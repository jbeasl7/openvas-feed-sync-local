...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.03348.1");
  script_cve_id("CVE-2024-13978", "CVE-2025-8534", "CVE-2025-8961", "CVE-2025-9165");
  script_tag(name:"creation_date", value:"2025-09-25 14:59:31 +0000 (Thu, 25 Sep 2025)");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:03348-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff-devel-32bit", rpm:"libtiff-devel-32bit~4.7.0~150600.3.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~4.7.0~150600.3.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff6-32bit", rpm:"libtiff6-32bit~4.7.0~150600.3.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff6", rpm:"libtiff6~4.7.0~150600.3.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tiff", rpm:"tiff~4.7.0~150600.3.18.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
