...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_164-default-debuginfo-7", rpm:"kernel-livepatch-5_3_18-150300_59_164-default-debuginfo-7~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_164-default-7", rpm:"kernel-livepatch-5_3_18-150300_59_164-default-7~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3_Update_45-debugsource-7", rpm:"kernel-livepatch-SLE15-SP3_Update_45-debugsource-7~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_164-preempt-7", rpm:"kernel-livepatch-5_3_18-150300_59_164-preempt-7~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_164-preempt-debuginfo-7", rpm:"kernel-livepatch-5_3_18-150300_59_164-preempt-debuginfo-7~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
