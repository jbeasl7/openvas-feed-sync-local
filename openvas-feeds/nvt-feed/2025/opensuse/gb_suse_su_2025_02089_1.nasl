...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.02089.1");
  script_cve_id("CVE-2024-0397", "CVE-2024-4032", "CVE-2024-6923");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:02089-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:02089-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202502089-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-June/040459.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python311' package(s) announced via the SUSE-SU-2025:02089-1 advisory.");
