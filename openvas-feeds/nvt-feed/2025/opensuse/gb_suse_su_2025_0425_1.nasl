...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.0425.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0425-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wget", rpm:"wget~1.20.3~150600.19.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wget-lang", rpm:"wget-lang~1.20.3~150600.19.12.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
