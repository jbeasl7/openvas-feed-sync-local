...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.18.2.2025.03038.1");
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:03038-1)");
...
- CVE-2025-50817: Fixed arbitrary code execution via the automatic import of file test.py (bsc#1248124)");
  ...
  script_tag(name:"affected", value:"'python-future' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-future", rpm:"python311-future~0.18.3~150400.6.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
