...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2025:0005-1)");
 ...
 * Other ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'liboqs, oqs-provider' package(s) on openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"liboqs-devel", rpm:"liboqs-devel~0.12.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"liboqs-devel-32bit", rpm:"liboqs-devel-32bit~0.12.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"liboqs7", rpm:"liboqs7~0.12.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"liboqs7-32bit", rpm:"liboqs7-32bit~0.12.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"oqs-provider", rpm:"oqs-provider~0.7.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
