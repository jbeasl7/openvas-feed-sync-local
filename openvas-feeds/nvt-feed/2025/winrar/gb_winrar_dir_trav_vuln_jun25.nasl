...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836457");
  ...
  script_name("RARLabs WinRAR Directory Traversal Vulnerability (Jun 2025) - Windows");

  script_tag(name:"summary", value:"WinRAR is prone to a directory traversal
  vulnerability.");
  ...
  script_tag(name:"affected", value:"RARLabs WinRAR prior to version 7.12 Beta 1 on
  Windows.");
  ...
  script_xref(name:"URL", value:"https://www.wiz.io/vulnerability-database/cve/cve-2025-6218");
...
if(version_is_less(version:vers, test_version:"7.12")) {
