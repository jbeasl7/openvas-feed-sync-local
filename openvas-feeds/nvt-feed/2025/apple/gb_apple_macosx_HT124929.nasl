...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836617");
  ...
  script_name("Apple MacOSX Security Update (HT124929)");
  ...
  script_tag(name:"solution", value:"Update macOS Ventura to version 13.7.8 or
  later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/124929");
...
if(version_is_less(version:osVer, test_version:"13.7.8")) {
  report = report_fixed_ver(installed_version:osVer, fixed_version:"13.7.8");
