...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836619");
  ...
  script_name("Apple MacOSX Security Update (HT124928)");
  ...
  script_tag(name:"solution", value:"Update macOS Sonoma to version 14.7.8 or
  later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/124928");
...
if(version_is_less(version:osVer, test_version:"14.7.8")) {
  report = report_fixed_ver(installed_version:osVer, fixed_version:"14.7.8");
