...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.171463");
  script_version("2025-05-07T05:40:10+0000");
  script_tag(name:"last_modification", value:"2025-05-07 05:40:10 +0000 (Wed, 07 May 2025)");
  script_tag(name:"creation_date", value:"2025-05-02 21:09:49 +0000 (Fri, 02 May 2025)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:P/I:N/A:N");

  script_cve_id("CVE-2025-32700");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MediaWiki 1.43.x < 1.43.1 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"An exposure of sensitive information to an unauthorized actor
  vulnerability exists in Wikimedia Foundation AbuseFilter.");

  script_tag(name:"affected", value:"MediaWiki version 1.43.x prior to 1.43.1.");

  script_tag(name:"solution", value:"Update to version 1.43.1 or later.");
  ...
  script_xref(name:"URL", value:"https://phabricator.wikimedia.org/T389235");
