...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.131503");
  ...
  script_cve_id("CVE-2024-55647");

  script_tag(name:"qod_type", value:"remote_banner_unreliable");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Moodle 4.3.x < 4.3.9, 4.4.x < 4.4.5, 4.5.x < 4.5.1 XSS Vulnerability (MSA-24-0055)");
  ...
  script_tag(name:"insight", value:"Question bank filtering required additional sanitizing to
  prevent a reflected XSS risk.");

  script_tag(name:"affected", value:"Moodle version 4.3.x prior to 4.3.9, 4.4.x prior to 4.4.5 and
  4.5.x prior to 4.5.1.");

  script_tag(name:"solution", value:"Update to version 4.3.9, 4.4.5, 4.5.1 or later.");

  script_xref(name:"URL", value:"https://moodle.org/mod/forum/discuss.php?d=464558");
