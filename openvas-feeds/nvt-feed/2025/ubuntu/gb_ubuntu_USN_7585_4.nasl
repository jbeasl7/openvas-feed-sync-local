...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7585.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7585-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7585-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7585-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.4' package(s) announced via the USN-7585-4 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1152-azure", ver:"5.4.0-1152.159~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.4.0.1152.159~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
