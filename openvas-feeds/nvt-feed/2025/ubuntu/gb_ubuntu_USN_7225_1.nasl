...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7225.1");
  script_cve_id("CVE-2022-0137", "CVE-2022-0534", "CVE-2022-24191", "CVE-2022-27114", "CVE-2022-28085", "CVE-2022-34033", "CVE-2022-34035", "CVE-2024-45508", "CVE-2024-46478");
  ...
  script_name("Ubuntu: Security Advisory (USN-7225-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7225-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7225-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'htmldoc' package(s) announced via the USN-7225-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that HTMLDOC incorrectly handled memory in the
...
arbitrary code. (CVE-2024-46478)");
  ...
  script_tag(name:"affected", value:"'htmldoc' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04, Ubuntu 24.10.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.8.27-8ubuntu1+esm4", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.8.27-8ubuntu1.1+esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.2-1ubuntu0.2+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.7-1ubuntu0.3+esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.15-1ubuntu0.1~esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.17-1ubuntu0.1~esm1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.18-1ubuntu0.1", rls:"UBUNTU24.10"))) {
    report += res;
  }
