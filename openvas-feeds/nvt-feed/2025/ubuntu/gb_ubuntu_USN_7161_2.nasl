...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7161.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7161-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7161-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7161-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker.io, docker.io-app' package(s) announced via the USN-7161-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7161-1 fixed CVE-2024-29018 in Ubuntu 24.04 LTS. This update fixes it
...
and the source package docker.io in Ubuntu 18.04 LTS. (CVE-2024-41110)");
  ...
  script_tag(name:"affected", value:"'docker.io, docker.io-app' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"docker.io", ver:"18.09.7-0ubuntu1~16.04.9+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"docker.io", ver:"20.10.21-0ubuntu1~18.04.3+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"docker.io", ver:"26.1.3-0ubuntu1~20.04.1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"docker.io", ver:"26.1.3-0ubuntu1~22.04.1+esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
