...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.6940.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6940-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6940-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6940-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'snapd' package(s) announced via the USN-6940-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6940-1 fixed vulnerabilities in snapd. This update provides the
...
Original advisory details:
 ...
 information. (CVE-2024-29069)");
  ...
  script_tag(name:"affected", value:"'snapd' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapd", ver:"2.61.4ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snapd", ver:"2.61.4ubuntu0.18.04.1+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
