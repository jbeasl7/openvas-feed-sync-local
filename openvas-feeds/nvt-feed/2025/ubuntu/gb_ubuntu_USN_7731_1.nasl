...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7731.1");
  script_cve_id("CVE-2017-17689", "CVE-2020-11880");
  ...
  script_name("Ubuntu: Security Advisory (USN-7731-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7731-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7731-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kmail' package(s) announced via the USN-7731-1 advisory.");
...
possibly use this issue to obtain sensitive files. (CVE-2020-11880)");
  ...
  script_tag(name:"affected", value:"'kmail' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kmail", ver:"4:17.12.3-0ubuntu1+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kmail", ver:"4:19.12.3-0ubuntu1+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
