...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7640-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7640-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7640-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-iot' package(s) announced via the USN-7640-1 advisory.");
...
CVE-2025-22054, CVE-2023-52664, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1051-iot", ver:"5.4.0-1051.54", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
