...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7380.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7380-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7380-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7380-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lowlatency' package(s) announced via the USN-7380-1 advisory.");
...
CVE-2024-53682, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-lowlatency' package(s) on Ubuntu 24.10.");
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1011-lowlatency", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1011-lowlatency-64k", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-64k", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }
