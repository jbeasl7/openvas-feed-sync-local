...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7169.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7169-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7169-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7169-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-realtime' package(s) announced via the USN-7169-5 advisory.");
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1003-realtime", ver:"6.11.0-1003.3", rls:"UBUNTU24.10"))) {
    report += res;
  }
