...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7166.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7166-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7166-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7166-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-xilinx-zynqmp' package(s) announced via the USN-7166-4 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1039-xilinx-zynqmp", ver:"5.15.0-1039.43", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"5.15.0.1039.43", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
