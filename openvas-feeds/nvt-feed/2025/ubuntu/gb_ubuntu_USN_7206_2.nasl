...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7206.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7206-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7206-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7206-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2095004");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the USN-7206-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7206-1 fixed vulnerabilities in rsync. The update introduced a
...
Original advisory details:
 ...
 information or escalate privileges. (CVE-2024-12747)");
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.1.0-2ubuntu0.4+esm2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.1.1-3ubuntu1.3+esm4", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.1.2-2.1ubuntu1.6+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.1.3-8ubuntu0.9", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.2.7-0ubuntu0.22.04.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.2.7-1ubuntu1.2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
