...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7496.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7496-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7496-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7496-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-4.15' package(s) announced via the USN-7496-3 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1188-azure", ver:"4.15.0-1188.203~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"4.15.0.1188.203~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1188-azure", ver:"4.15.0-1188.203", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-18.04", ver:"4.15.0.1188.156", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
