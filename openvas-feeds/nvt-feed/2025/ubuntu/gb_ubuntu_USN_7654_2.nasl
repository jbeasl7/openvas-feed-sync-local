...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7654.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7654-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7654-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7654-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iot-realtime, linux-realtime' package(s) announced via the USN-7654-2 advisory.");
...
CVE-2025-37740, CVE-2025-37803, CVE-2025-22027, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1081-intel-iot-realtime", ver:"5.15.0-1081.83", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1088-realtime", ver:"5.15.0-1088.97", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"5.15.0.1081.85", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime-5.15", ver:"5.15.0.1081.85", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"5.15.0.1088.92", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-5.15", ver:"5.15.0.1088.92", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
