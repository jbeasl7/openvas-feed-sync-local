...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7595.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7595-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7595-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7595-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi-realtime' package(s) announced via the USN-7595-3 advisory.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-2024-raspi-realtime", ver:"6.8.0-2024.25", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-realtime", ver:"6.8.0-2024.25", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
