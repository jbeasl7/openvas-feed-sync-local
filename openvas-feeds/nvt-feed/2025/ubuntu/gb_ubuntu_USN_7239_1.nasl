...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7239.1");
  script_cve_id("CVE-2020-6071", "CVE-2020-6072", "CVE-2020-6073", "CVE-2020-6077", "CVE-2020-6078", "CVE-2020-6079", "CVE-2020-6080");
  script_tag(name:"creation_date", value:"2025-01-29 11:41:14 +0000 (Wed, 29 Jan 2025)");
  ...
  script_tag(name:"severity_date", value:"2020-03-26 17:40:03 +0000 (Thu, 26 Mar 2020)");

  script_name("Ubuntu: Security Advisory (USN-7239-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7239-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7239-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmicrodns' package(s) announced via the USN-7239-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that libmicrodns could recursively follow the same
...
(CVE-2020-6079, CVE-2020-6080)");
  ...
  script_tag(name:"affected", value:"'libmicrodns' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmicrodns0", ver:"0.0.8-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
