...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7591.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7591-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7591-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7591-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iot-realtime, linux-realtime' package(s) announced via the USN-7591-3 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1079-intel-iot-realtime", ver:"5.15.0-1079.81", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1086-realtime", ver:"5.15.0-1086.95", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"5.15.0.1079.83", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"5.15.0.1086.90", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
