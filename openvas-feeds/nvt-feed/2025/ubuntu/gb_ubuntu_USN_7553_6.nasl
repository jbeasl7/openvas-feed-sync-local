...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7553.6");
  ...
  script_name("Ubuntu: Security Advisory (USN-7553-6)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7553-6");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7553-6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fips' package(s) announced via the USN-7553-6 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-2098-azure-fips", ver:"4.15.0-2098.104", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips", ver:"4.15.0.2098.94", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
