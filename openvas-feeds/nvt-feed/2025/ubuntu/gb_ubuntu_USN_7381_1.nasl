...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7381.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7381-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7381-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7381-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lowlatency-hwe-6.11' package(s) announced via the USN-7381-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ALSA framework,
 - Intel ASoC ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1011-lowlatency", ver:"6.11.0-1011.12~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1011-lowlatency-64k", ver:"6.11.0-1011.12~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-64k-hwe-24.04", ver:"6.11.0-1011.12~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-hwe-24.04", ver:"6.11.0-1011.12~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
