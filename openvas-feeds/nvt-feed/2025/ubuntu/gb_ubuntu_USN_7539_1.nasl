...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7539-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7539-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7539-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi' package(s) announced via the USN-7539-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Timer subsystem,
 - VLANs driver,
 - KVM ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1129-raspi", ver:"5.4.0-1129.142", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.4.0.1129.160", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi2", ver:"5.4.0.1129.160", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
