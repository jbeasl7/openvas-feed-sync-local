...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7294.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7294-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7294-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7294-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm' package(s) announced via the USN-7294-4 advisory.");
...
CVE-2024-50040, CVE-2024-49958, CVE-2024-50205, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1127-kvm", ver:"5.4.0-1127.136", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.4.0.1127.123", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
