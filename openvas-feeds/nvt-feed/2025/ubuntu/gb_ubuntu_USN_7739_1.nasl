...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7739.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7739-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7739-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7739-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-7739-1 advisory.");
...
(CVE-2021-25216)");
  ...
  script_tag(name:"affected", value:"'bind9' package(s) on Ubuntu 14.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.9.5.dfsg-3ubuntu0.19+esm13", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
