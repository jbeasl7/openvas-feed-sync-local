...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7776-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7776-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7776-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle-5.15' package(s) announced via the USN-7776-1 advisory.");
...
CVE-2025-38514, CVE-2025-38389, CVE-2025-38319, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1090-oracle", ver:"5.15.0-1090.96~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.15.0.1090.96~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-5.15", ver:"5.15.0.1090.96~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
