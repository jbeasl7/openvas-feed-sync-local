...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7510.7");
  ...
  script_name("Ubuntu: Security Advisory (USN-7510-7)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7510-7");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7510-7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-intel-iotg-5.15, linux-nvidia-tegra-igx, linux-raspi' package(s) announced via the USN-7510-7 advisory.");
...
CVE-2025-21826, CVE-2025-21708, CVE-2025-21802, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws, linux-intel-iotg-5.15, linux-nvidia-tegra-igx, linux-raspi' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1079-intel-iotg", ver:"5.15.0-1079.85~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1079.85~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1079.85~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1026-nvidia-tegra-igx", ver:"5.15.0-1026.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1026-nvidia-tegra-igx-rt", ver:"5.15.0-1026.26", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1078-raspi", ver:"5.15.0-1078.81", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1084-aws", ver:"5.15.0-1084.91", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-22.04", ver:"5.15.0.1084.86", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx", ver:"5.15.0.1026.28", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-rt", ver:"5.15.0.1026.28", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.15.0.1078.76", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-nolpae", ver:"5.15.0.1078.76", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
