...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7294.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7294-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7294-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7294-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm' package(s) announced via the USN-7294-3 advisory.");
...
CVE-2024-49896, CVE-2024-49957, CVE-2024-49952, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1086-ibm", ver:"5.4.0-1086.91", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-lts-20.04", ver:"5.4.0.1086.115", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
