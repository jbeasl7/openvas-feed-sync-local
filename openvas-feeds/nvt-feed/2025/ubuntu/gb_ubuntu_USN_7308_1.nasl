...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7308.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7308-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7308-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7308-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-7308-1 advisory.");
...
CVE-2024-41080, CVE-2024-50143, CVE-2023-52913, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1078-aws", ver:"5.15.0-1078.85", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-22.04", ver:"5.15.0.1078.80", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
