...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7384.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7384-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7384-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7384-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-6.8' package(s) announced via the USN-7384-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - User-space API (UAPI),
 - io_uring ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure-6.8' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1025-azure", ver:"6.8.0-1025.30~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1025-azure-fde", ver:"6.8.0-1025.30~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.8.0-1025.30~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.8.0-1025.30~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
