...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7392.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7392-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7392-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7392-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-7392-3 advisory.");
...
CVE-2024-57922, CVE-2024-53135, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1142-aws", ver:"5.4.0-1142.152", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-20.04", ver:"5.4.0.1142.139", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
