...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7506.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7506-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7506-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7506-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-fips' package(s) announced via the USN-7506-3 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.4.0-1113-fips", ver:"4.4.0-1113.120", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"4.4.0.1113.114", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
