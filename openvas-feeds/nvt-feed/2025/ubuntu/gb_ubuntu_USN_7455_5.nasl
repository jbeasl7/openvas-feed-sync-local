...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7455.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7455-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7455-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7455-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.15' package(s) announced via the USN-7455-5 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1082-aws", ver:"5.15.0-1082.89~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.15.0.1082.89~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
