...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7413.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7413-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7413-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7413-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-iot' package(s) announced via the USN-7413-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - JFFS2 file system,
 - JFS file ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1048-iot", ver:"5.4.0-1048.51", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
