...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7669.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7669-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7669-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7669-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-24' package(s) announced via the USN-7669-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the 2D component of OpenJDK 24 did not properly
...
(CVE-2025-50059)");
  ...
  script_tag(name:"affected", value:"'openjdk-24' package(s) on Ubuntu 25.04.");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openjdk-24-jdk", ver:"24.0.2+12~us1-0ubuntu1~25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-24-jdk-headless", ver:"24.0.2+12~us1-0ubuntu1~25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-24-jre", ver:"24.0.2+12~us1-0ubuntu1~25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-24-jre-headless", ver:"24.0.2+12~us1-0ubuntu1~25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-24-jre-zero", ver:"24.0.2+12~us1-0ubuntu1~25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-24-jvmci-jdk", ver:"24.0.2+12~us1-0ubuntu1~25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }
