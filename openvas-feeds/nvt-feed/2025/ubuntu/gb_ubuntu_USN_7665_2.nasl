...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7665-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7665-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7665-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-6.14' package(s) announced via the USN-7665-2 advisory.");
...
CVE-2025-37936, CVE-2025-37934, CVE-2025-37921, CVE-2025-37922)");
  ...
  script_tag(name:"affected", value:"'linux-aws-6.14' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1009-aws", ver:"6.14.0-1009.9~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1009-aws-64k", ver:"6.14.0-1009.9~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.14.0-1009.9~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-6.14", ver:"6.14.0-1009.9~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k", ver:"6.14.0-1009.9~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k-6.14", ver:"6.14.0-1009.9~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
