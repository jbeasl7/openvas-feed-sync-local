...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7346.3");
  script_cve_id("CVE-2021-42780", "CVE-2021-42782", "CVE-2023-2977", "CVE-2023-40660", "CVE-2023-40661", "CVE-2024-45615", "CVE-2024-45616", "CVE-2024-45617", "CVE-2024-45618", "CVE-2024-45620", "CVE-2024-8443");
  ...
  script_name("Ubuntu: Security Advisory (USN-7346-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7346-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7346-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2104948");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc' package(s) announced via the USN-7346-3 advisory.");
...
Original advisory details:
 ...
 Matteo Marini discovered that OpenSC did not correctly handle certain
 memory operations. A physically proximate attacker could possibly use this
 issue to gain ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'opensc' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"opensc", ver:"0.20.0-3ubuntu0.1~esm4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"opensc-pkcs11", ver:"0.20.0-3ubuntu0.1~esm4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
