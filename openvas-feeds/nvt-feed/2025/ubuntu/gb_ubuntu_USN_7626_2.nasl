...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7626.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7626-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7626-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7626-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2116251");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'git' package(s) announced via the USN-7626-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7626-1 fixed vulnerabilities in Git. The update introduced a regression
...
Original advisory details:
 ...
 cause a denial of service. (CVE-2025-48386)");
  ...
  script_tag(name:"affected", value:"'git' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git-gui", ver:"1:2.7.4-0ubuntu1.10+esm10", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gitk", ver:"1:2.7.4-0ubuntu1.10+esm10", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git-gui", ver:"1:2.17.1-1ubuntu0.18+esm3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gitk", ver:"1:2.17.1-1ubuntu0.18+esm3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git-gui", ver:"1:2.25.1-1ubuntu3.14+esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gitk", ver:"1:2.25.1-1ubuntu3.14+esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git-gui", ver:"1:2.34.1-1ubuntu1.14", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gitk", ver:"1:2.34.1-1ubuntu1.14", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
