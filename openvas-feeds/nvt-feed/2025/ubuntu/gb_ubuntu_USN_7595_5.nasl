...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7595.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7595-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7595-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7595-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp, linux-gcp-6.8' package(s) announced via the USN-7595-5 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1031-gcp", ver:"6.8.0-1031.33~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1031-gcp-64k", ver:"6.8.0-1031.33~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.8.0-1031.33~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.8.0-1031.33~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1031-gcp", ver:"6.8.0-1031.33", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1031-gcp-64k", ver:"6.8.0-1031.33", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k-lts-24.04", ver:"6.8.0-1031.33", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-lts-24.04", ver:"6.8.0-1031.33", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
