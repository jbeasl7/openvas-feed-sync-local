...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7594.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7594-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7594-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7594-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-7594-2 advisory.");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-azure", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-azure-fde", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }
