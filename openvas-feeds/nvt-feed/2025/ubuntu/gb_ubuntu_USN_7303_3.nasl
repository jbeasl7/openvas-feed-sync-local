...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7303.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7303-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7303-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7303-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp-6.8, linux-raspi' package(s) announced via the USN-7303-3 advisory.");
...
CVE-2024-49937, CVE-2024-47744, CVE-2024-49890, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1024-gcp", ver:"6.8.0-1024.26~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1024-gcp-64k", ver:"6.8.0-1024.26~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.8.0-1024.26~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.8.0-1024.26~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1019-raspi", ver:"6.8.0-1019.23", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.8.0-1019.23", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
