...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7295.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7295-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7295-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7295-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-xilinx-zynqmp' package(s) announced via the USN-7295-1 advisory.");
...
CVE-2024-50202, CVE-2024-49868, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1058-xilinx-zynqmp", ver:"5.4.0-1058.62", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"5.4.0.1058.58", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
