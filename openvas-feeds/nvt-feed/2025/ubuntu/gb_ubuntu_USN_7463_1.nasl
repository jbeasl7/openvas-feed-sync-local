...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7463-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7463-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7463-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm-5.4' package(s) announced via the USN-7463-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - USB sound devices,
(CVE-2024-56586, CVE-2024-52332, CVE-2024-56570, CVE-2024-49936,
CVE-2024-56595, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1090-ibm", ver:"5.4.0-1090.95~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"5.4.0.1090.95~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
