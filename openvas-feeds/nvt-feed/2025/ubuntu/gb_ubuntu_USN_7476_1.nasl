...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7476.1");
  script_cve_id("CVE-2021-41125", "CVE-2022-0577", "CVE-2024-1892", "CVE-2024-1968", "CVE-2024-3572", "CVE-2024-3574");
  ...
  script_tag(name:"severity_date", value:"2025-01-10 14:49:33 +0000 (Fri, 10 Jan 2025)");

  script_name("Ubuntu: Security Advisory (USN-7476-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7476-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7476-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-scrapy' package(s) announced via the USN-7476-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Scrapy improperly exposed HTTP authentication
...
(CVE-2024-1968)");
  ...
  script_tag(name:"affected", value:"'python-scrapy' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-scrapy", ver:"1.5.0-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-scrapy", ver:"1.5.0-1ubuntu0.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-scrapy", ver:"1.7.3-1ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-scrapy", ver:"2.5.1-2ubuntu0.1~esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-scrapy", ver:"2.11.1-1ubuntu0.1~esm2", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
