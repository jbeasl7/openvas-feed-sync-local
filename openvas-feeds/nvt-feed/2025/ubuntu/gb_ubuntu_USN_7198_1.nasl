...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7198.1");
  script_cve_id("CVE-2021-31315", "CVE-2021-31317", "CVE-2021-31318", "CVE-2021-31319", "CVE-2021-31320", "CVE-2021-31321", "CVE-2021-31322");
  ...
  script_tag(name:"severity_date", value:"2021-05-25 18:10:40 +0000 (Tue, 25 May 2021)");

  script_name("Ubuntu: Security Advisory (USN-7198-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7198-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7198-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rlottie' package(s) announced via the USN-7198-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Paolo Giai discovered a series of stack-based overflow vulnerabilities in
...
This issue only affected Ubuntu 20.04 LTS. (CVE-2021-31320, CVE-2021-31322)");
  ...
  script_tag(name:"affected", value:"'rlottie' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"librlottie0-1", ver:"0~git20200305.a717479+dfsg-1ubuntu0.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"librlottie0-1", ver:"0.1+dfsg-2ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
