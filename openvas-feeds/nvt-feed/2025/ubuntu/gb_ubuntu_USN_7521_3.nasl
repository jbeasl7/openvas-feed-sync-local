...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7521.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7521-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7521-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7521-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lowlatency, linux-lowlatency-hwe-6.11, linux-oracle' package(s) announced via the USN-7521-3 advisory.");
...
CVE-2024-57987, CVE-2024-58053, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-lowlatency, linux-lowlatency-hwe-6.11, linux-oracle' package(s) on Ubuntu 24.04, Ubuntu 24.10.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1014-lowlatency", ver:"6.11.0-1014.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1014-lowlatency-64k", ver:"6.11.0-1014.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-64k-hwe-24.04", ver:"6.11.0-1014.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-hwe-24.04", ver:"6.11.0-1014.15~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1014-lowlatency", ver:"6.11.0-1014.15", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1014-lowlatency-64k", ver:"6.11.0-1014.15", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1016-oracle", ver:"6.11.0-1016.17", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1016-oracle-64k", ver:"6.11.0-1016.17", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency", ver:"6.11.0-1014.15", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-64k", ver:"6.11.0-1014.15", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.11.0-1016.17", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.11.0-1016.17", rls:"UBUNTU24.10"))) {
    report += res;
  }
