...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7517.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7517-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7517-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7517-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-bluefield' package(s) announced via the USN-7517-3 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1105-bluefield", ver:"5.4.0-1105.112", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-bluefield", ver:"5.4.0.1105.101", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
