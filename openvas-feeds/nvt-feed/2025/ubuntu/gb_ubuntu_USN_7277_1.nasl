...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7277-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7277-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7277-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-azure, linux-gcp, linux-oracle, linux-raspi, linux-realtime' package(s) announced via the USN-7277-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - EROFS ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws, linux-azure, linux-gcp, linux-oracle, linux-raspi, linux-realtime' package(s) on Ubuntu 24.10.");
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1005-realtime", ver:"6.11.0-1005.5", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1008-raspi", ver:"6.11.0-1008.8", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1009-aws", ver:"6.11.0-1009.10", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1009-azure", ver:"6.11.0-1009.9", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1009-azure-fde", ver:"6.11.0-1009.9", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1009-gcp", ver:"6.11.0-1009.9", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1011-oracle", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1011-oracle-64k", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.11.0-1009.10", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.11.0-1009.9", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.11.0-1009.9", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.11.0-1009.9", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.11.0-1011.12", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.11.0-1008.8", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.11.0-1005.5", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-hwe-24.04", ver:"6.11.0-1005.5", rls:"UBUNTU24.10"))) {
    report += res;
  }
