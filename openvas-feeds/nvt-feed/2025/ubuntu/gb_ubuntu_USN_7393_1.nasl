...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7393-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7393-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7393-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-fips' package(s) announced via the USN-7393-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Closures library,
 - Memory management,
 - 9P file system ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-fips' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1116-fips", ver:"5.4.0-1116.126", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"5.4.0.1116.113", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
