...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7699.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7699-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7699-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7699-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe-6.14, linux-oem-6.14' package(s) announced via the USN-7699-2 advisory.");
...
CVE-2025-37959, CVE-2025-37950, CVE-2025-37949)");
  ...
  script_tag(name:"affected", value:"'linux-hwe-6.14, linux-oem-6.14' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1010-oem", ver:"6.14.0-1010.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-28-generic", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-28-generic-64k", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-6.14", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k-6.14", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k-hwe-24.04", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-hwe-24.04", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-24.04a", ver:"6.14.0-1010.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-24.04c", ver:"6.14.0-1010.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-6.14", ver:"6.14.0-1010.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual-6.14", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual-hwe-24.04", ver:"6.14.0-28.28~24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
