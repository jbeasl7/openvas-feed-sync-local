...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.6885.6");
  ...
  script_name("Ubuntu: Security Advisory (USN-6885-6)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6885-6");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6885-6");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2119395");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-6885-6 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6885-1 fixed vulnerabilities in Apache. The patch for
...
Original advisory details:
 ...
 to handle unsafe substitutions. (CVE-2024-38474)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.52-1ubuntu4.16", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.58-1ubuntu8.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
