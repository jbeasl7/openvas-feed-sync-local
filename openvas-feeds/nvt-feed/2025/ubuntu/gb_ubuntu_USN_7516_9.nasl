...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7516.9");
  ...
  script_name("Ubuntu: Security Advisory (USN-7516-9)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7516-9");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7516-9");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-7516-9 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1146-aws", ver:"5.4.0-1146.156", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-20.04", ver:"5.4.0.1146.143", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
