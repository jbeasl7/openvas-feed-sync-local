...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7510.6");
  ...
  script_name("Ubuntu: Security Advisory (USN-7510-6)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7510-6");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7510-6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-fips' package(s) announced via the USN-7510-6 advisory.");
...
CVE-2024-58058, CVE-2024-57986, CVE-2025-21971, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws-fips' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1084-aws-fips", ver:"5.15.0-1084.91+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips", ver:"5.15.0.1084.80", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
