...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7602-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7602-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7602-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-xilinx-zynqmp' package(s) announced via the USN-7602-1 advisory.");
...
(CVE-2025-21647, CVE-2025-21925, CVE-2024-58034, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1050-xilinx-zynqmp", ver:"5.15.0-1050.54", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"5.15.0.1050.53", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
