...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7510.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7510-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7510-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7510-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fips' package(s) announced via the USN-7510-5 advisory.");
...
CVE-2025-21919, CVE-2024-58083, CVE-2025-21763, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1089-azure-fips", ver:"5.15.0-1089.98+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips", ver:"5.15.0.1089.74", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
