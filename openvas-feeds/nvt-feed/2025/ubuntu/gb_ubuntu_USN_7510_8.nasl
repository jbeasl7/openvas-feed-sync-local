...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7510.8");
  ...
  script_name("Ubuntu: Security Advisory (USN-7510-8)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7510-8");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7510-8");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.15' package(s) announced via the USN-7510-8 advisory.");
...
CVE-2025-21898, CVE-2025-21811, CVE-2024-57979, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws-5.15' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1084-aws", ver:"5.15.0-1084.91~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.15.0.1084.91~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
