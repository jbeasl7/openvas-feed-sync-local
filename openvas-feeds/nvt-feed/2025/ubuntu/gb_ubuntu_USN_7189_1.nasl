...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7189.1");
  script_cve_id("CVE-2021-20308", "CVE-2021-23158", "CVE-2021-23191", "CVE-2021-23206", "CVE-2021-26252", "CVE-2021-26259", "CVE-2021-26948", "CVE-2021-34119", "CVE-2021-34121", "CVE-2021-40985", "CVE-2021-43579");
  ...
  script_tag(name:"severity_date", value:"2022-03-22 17:02:57 +0000 (Tue, 22 Mar 2022)");

  script_name("Ubuntu: Security Advisory (USN-7189-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7189-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7189-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'htmldoc' package(s) announced via the USN-7189-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that HTMLDOC incorrectly handled certain inputs, which
...
information. (CVE-2021-34121)");
  ...
  script_tag(name:"affected", value:"'htmldoc' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.8.27-8ubuntu1+esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.8.27-8ubuntu1.1+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.2-1ubuntu0.2+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htmldoc", ver:"1.9.7-1ubuntu0.3+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
