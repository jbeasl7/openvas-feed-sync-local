...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7747.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7747-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7747-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7747-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygems' package(s) announced via the USN-7747-1 advisory.");
...
(ReDoS).");
  ...
  script_tag(name:"affected", value:"'rubygems' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-bundler", ver:"2.3.5-2ubuntu1.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
