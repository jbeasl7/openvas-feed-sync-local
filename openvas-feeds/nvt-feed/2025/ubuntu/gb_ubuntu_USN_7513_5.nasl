...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7513.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-7513-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7513-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7513-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle-6.8' package(s) announced via the USN-7513-5 advisory.");
...
CVE-2024-57893, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1026-oracle", ver:"6.8.0-1026.27~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1026-oracle-64k", ver:"6.8.0-1026.27~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.8.0-1026.27~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.8.0-1026.27~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
