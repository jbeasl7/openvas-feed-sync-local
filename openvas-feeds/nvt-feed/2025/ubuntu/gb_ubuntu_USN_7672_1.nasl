...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7672.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7672-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7672-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7672-1");
  script_xref(name:"URL", value:"https://openjdk.org/groups/vulnerability/advisories/2025-07-15");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-17-crac' package(s) announced via the USN-7672-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the 2D component of CRaC JDK 17 did not properly
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'openjdk-17-crac' package(s) on Ubuntu 25.04.");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openjdk-17-crac-jdk", ver:"17.0.16+8-0ubuntu2~25.04", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-17-crac-jdk-headless", ver:"17.0.16+8-0ubuntu2~25.04", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-17-crac-jre", ver:"17.0.16+8-0ubuntu2~25.04", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-17-crac-jre-headless", ver:"17.0.16+8-0ubuntu2~25.04", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openjdk-17-crac-jre-zero", ver:"17.0.16+8-0ubuntu2~25.04", rls:"UBUNTU25.04"))) {
    report += res;
  }
