...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7696.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7696-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7696-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7696-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh' package(s) announced via the USN-7696-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.6.3-4.3ubuntu0.6+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.8.0~20170825.94fa1e38-1ubuntu0.7+esm4", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.9.3-2ubuntu2.5+esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
