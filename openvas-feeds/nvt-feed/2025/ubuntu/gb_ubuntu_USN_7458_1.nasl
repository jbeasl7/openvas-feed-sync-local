...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7458-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7458-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7458-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm-5.15' package(s) announced via the USN-7458-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Tracing ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-ibm-5.15' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1074-ibm", ver:"5.15.0-1074.77~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"5.15.0.1074.77~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
