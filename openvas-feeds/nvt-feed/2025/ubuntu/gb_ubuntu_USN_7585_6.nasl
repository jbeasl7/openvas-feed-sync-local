...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7585.6");
  ...
  script_name("Ubuntu: Security Advisory (USN-7585-6)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7585-6");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7585-6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-bluefield' package(s) announced via the USN-7585-6 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1106-bluefield", ver:"5.4.0-1106.113", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-bluefield", ver:"5.4.0.1106.102", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
