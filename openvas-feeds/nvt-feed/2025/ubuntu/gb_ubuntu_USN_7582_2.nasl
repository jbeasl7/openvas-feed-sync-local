...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7582.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7582-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7582-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7582-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2115450");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the USN-7582-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7582-1 fixed vulnerabilities in Samba. The update introduced a
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.3.11+dfsg-0ubuntu0.14.04.20+esm14", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.3.11+dfsg-0ubuntu0.16.04.34+esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.7.6+dfsg~ubuntu-0ubuntu2.29+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
