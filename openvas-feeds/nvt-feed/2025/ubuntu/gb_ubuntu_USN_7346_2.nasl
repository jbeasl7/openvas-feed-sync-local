...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7346.2");
  script_cve_id("CVE-2021-42780", "CVE-2021-42782", "CVE-2023-2977", "CVE-2023-40660", "CVE-2023-40661", "CVE-2023-5992", "CVE-2024-45615", "CVE-2024-45616", "CVE-2024-45617");
  ...
  script_name("Ubuntu: Security Advisory (USN-7346-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7346-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7346-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2104948");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc' package(s) announced via the USN-7346-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7346-1 fixed vulnerabilities in OpenSC. The update introduced a
...
Original advisory details:
 ...
 Matteo Marini discovered that OpenSC did not correctly handle certain
 memory operations. A physically proximate ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"opensc", ver:"0.15.0-1ubuntu1+esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"opensc-pkcs11", ver:"0.15.0-1ubuntu1+esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"opensc", ver:"0.17.0-3ubuntu0.1~esm3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"opensc-pkcs11", ver:"0.17.0-3ubuntu0.1~esm3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"opensc", ver:"0.20.0-3ubuntu0.1~esm3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"opensc-pkcs11", ver:"0.20.0-3ubuntu0.1~esm3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
