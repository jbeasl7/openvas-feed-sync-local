...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7588.1");
  script_cve_id("CVE-2023-25563", "CVE-2023-25564", "CVE-2023-25565", "CVE-2023-25567");
  ...
  script_name("Ubuntu: Security Advisory (USN-7588-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7588-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7588-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gss-ntlmssp' package(s) announced via the USN-7588-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Phil Turnbull discovered that GSS NTLMSSP may perform out-of-bounds reads
...
failure, resulting in a denial of service. (CVE-2023-25565)");
  ...
  script_tag(name:"affected", value:"'gss-ntlmssp' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gss-ntlmssp", ver:"0.7.0-3~ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gss-ntlmssp", ver:"0.7.0-4ubuntu0.18.04.1~esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gss-ntlmssp", ver:"0.7.0-4ubuntu0.20.04.1~esm1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gss-ntlmssp", ver:"0.7.0-4ubuntu0.22.04.1~esm1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
