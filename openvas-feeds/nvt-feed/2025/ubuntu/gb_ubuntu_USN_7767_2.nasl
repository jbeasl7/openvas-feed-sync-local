...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7767.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7767-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7767-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7767-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-realtime-6.8' package(s) announced via the USN-7767-2 advisory.");
...
CVE-2025-22010, CVE-2025-21904, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-realtime-6.8' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.1-1034-realtime", ver:"6.8.1-1034.35~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-6.8.1", ver:"6.8.1-1034.35~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-hwe-22.04", ver:"6.8.1-1034.35~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
