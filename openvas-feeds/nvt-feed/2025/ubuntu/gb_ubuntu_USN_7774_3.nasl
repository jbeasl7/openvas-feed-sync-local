...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7774.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7774-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7774-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7774-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iot-realtime, linux-realtime' package(s) announced via the USN-7774-3 advisory.");
...
CVE-2025-38540, CVE-2025-38362, CVE-2025-38384, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1085-intel-iot-realtime", ver:"5.15.0-1085.87", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1092-realtime", ver:"5.15.0-1092.101", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"5.15.0.1085.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime-5.15", ver:"5.15.0.1085.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"5.15.0.1092.96", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime-5.15", ver:"5.15.0.1092.96", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
