...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7585.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7585-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7585-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7585-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-fips, linux-gcp-fips' package(s) announced via the USN-7585-2 advisory.");
...
CVE-2025-22079, CVE-2025-21957, CVE-2025-21993)");
  ...
  script_tag(name:"affected", value:"'linux-aws-fips, linux-gcp-fips' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1147-aws-fips", ver:"5.4.0-1147.157+fips1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1150-gcp-fips", ver:"5.4.0-1150.159+fips1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips", ver:"5.4.0.1147.94", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-fips", ver:"5.4.0.1150.92", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
