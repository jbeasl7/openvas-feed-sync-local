...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7506.4");
  ...
  script_tag(name:"creation_date", value:"2025-05-13 14:20:59 +0000 (Tue, 13 May 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7506-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7506-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7506-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-xenial' package(s) announced via the USN-7506-4 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.4.0-268-generic", ver:"4.4.0-268.302~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.4.0-268-lowlatency", ver:"4.4.0-268.302~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-lts-xenial", ver:"4.4.0.268.302~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-lts-xenial", ver:"4.4.0.268.302~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual-lts-xenial", ver:"4.4.0.268.302~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
