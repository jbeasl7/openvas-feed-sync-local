...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7294.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7294-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7294-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7294-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-oracle, linux-oracle-5.4' package(s) announced via the USN-7294-2 advisory.");
...
CVE-2024-49955, CVE-2024-53104, CVE-2024-49894, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws, linux-oracle, linux-oracle-5.4' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1138-oracle", ver:"5.4.0-1138.147~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.4.0.1138.147~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1138-oracle", ver:"5.4.0-1138.147", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1140-aws", ver:"5.4.0-1140.150", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-20.04", ver:"5.4.0.1140.137", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-lts-20.04", ver:"5.4.0.1138.131", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
