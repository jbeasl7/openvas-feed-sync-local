...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7516.8");
  ...
  script_name("Ubuntu: Security Advisory (USN-7516-8)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7516-8");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7516-8");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-fips, linux-fips' package(s) announced via the USN-7516-8 advisory.");
...
CVE-2025-21865, CVE-2025-21735)");
  ...
  script_tag(name:"affected", value:"'linux-aws-fips, linux-fips' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1120-fips", ver:"5.4.0-1120.130", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1146-aws-fips", ver:"5.4.0-1146.156+fips1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips", ver:"5.4.0.1146.93", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"5.4.0.1120.117", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
