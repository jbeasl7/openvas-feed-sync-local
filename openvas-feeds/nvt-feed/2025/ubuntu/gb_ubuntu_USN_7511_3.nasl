...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7511.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7511-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7511-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7511-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke' package(s) announced via the USN-7511-3 advisory.");
...
CVE-2025-21865, CVE-2024-58010, CVE-2025-21719, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1081-gke", ver:"5.15.0-1081.87", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"5.15.0.1081.80", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-5.15", ver:"5.15.0.1081.80", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
