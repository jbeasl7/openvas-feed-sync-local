...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7510.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7510-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7510-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7510-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iot-realtime, linux-realtime' package(s) announced via the USN-7510-4 advisory.");
...
CVE-2025-21904, CVE-2024-58016, CVE-2025-21934, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1077-intel-iot-realtime", ver:"5.15.0-1077.79", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1084-realtime", ver:"5.15.0-1084.93", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iot-realtime", ver:"5.15.0.1077.81", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"5.15.0.1084.88", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
