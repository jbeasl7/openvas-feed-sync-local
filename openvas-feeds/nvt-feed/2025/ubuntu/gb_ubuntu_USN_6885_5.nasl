...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.6885.5");
  ...
  script_name("Ubuntu: Security Advisory (USN-6885-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6885-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6885-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-6885-5 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6885-1 fixed vulnerabilities in Apache. This update provides
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2", ver:"2.4.7-1ubuntu4.22+esm10", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
