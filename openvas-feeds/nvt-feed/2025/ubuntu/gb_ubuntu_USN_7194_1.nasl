...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7194-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7194-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7194-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.15' package(s) announced via the USN-7194-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure-5.15' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1078-azure", ver:"5.15.0-1078.87~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.15.0.1078.87~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-cvm", ver:"5.15.0.1078.87~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
