...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7585.3");
  ...
  script_tag(name:"creation_date", value:"2025-06-26 06:40:34 +0000 (Thu, 26 Jun 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7585-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7585-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7585-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fips, linux-fips' package(s) announced via the USN-7585-3 advisory.");
...
CVE-2025-22079, CVE-2025-21957, CVE-2025-21993)");
  ...
  script_tag(name:"affected", value:"'linux-azure-fips, linux-fips' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1121-fips", ver:"5.4.0-1121.131", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1153-azure-fips", ver:"5.4.0-1153.160+fips1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fips", ver:"5.4.0.1153.90", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"5.4.0.1121.118", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
