...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7186-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7186-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7186-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-intel-iotg-5.15' package(s) announced via the USN-7186-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - SCTP protocol,
 - TIPC protocol,
 - VMware vSockets ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure, linux-intel-iotg-5.15' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1071-intel-iotg", ver:"5.15.0-1071.77~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1071.77~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1071.77~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1078-azure", ver:"5.15.0-1078.87", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-22.04", ver:"5.15.0.1078.76", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
