...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7619.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7619-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7619-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7619-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh' package(s) announced via the USN-7619-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Ronald Crane discovered that libssh incorrectly handled certain base64
...
24.04 LTS, Ubuntu 24.10, and Ubuntu 25.04. (CVE-2025-5987)");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on Ubuntu 22.04, Ubuntu 24.04, Ubuntu 24.10, Ubuntu 25.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.9.6-2ubuntu0.22.04.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.10.6-2ubuntu0.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.10.6-3ubuntu1.1", rls:"UBUNTU24.10"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssh-4", ver:"0.11.1-1ubuntu0.1", rls:"UBUNTU25.04"))) {
    report += res;
  }
