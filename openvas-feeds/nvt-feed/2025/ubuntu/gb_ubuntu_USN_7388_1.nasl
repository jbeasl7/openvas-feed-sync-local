...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7388.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7388-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7388-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7388-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.15, linux-kvm' package(s) announced via the USN-7388-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Memory ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws-5.15, linux-kvm' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1080-aws", ver:"5.15.0-1080.87~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.15.0.1080.87~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1076-kvm", ver:"5.15.0-1076.81", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.15.0.1076.72", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
