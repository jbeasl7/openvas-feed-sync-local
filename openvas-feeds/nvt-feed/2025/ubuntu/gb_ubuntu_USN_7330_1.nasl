...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7330.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7330-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7330-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7330-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible' package(s) announced via the USN-7330-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Ansible did not properly verify certain fields of
...
access sensitive information. (CVE-2020-1739)");
  ...
  script_tag(name:"affected", value:"'ansible' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"1.5.4+dfsg-1ubuntu0.1~esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ansible-fireball", ver:"1.5.4+dfsg-1ubuntu0.1~esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ansible-node-fireball", ver:"1.5.4+dfsg-1ubuntu0.1~esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.0.0.2-2ubuntu1.3+esm5", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ansible-fireball", ver:"2.0.0.2-2ubuntu1.3+esm5", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ansible-node-fireball", ver:"2.0.0.2-2ubuntu1.3+esm5", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.5.1+dfsg-1ubuntu0.1+esm5", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.9.6+dfsg-1ubuntu0.1~esm3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
