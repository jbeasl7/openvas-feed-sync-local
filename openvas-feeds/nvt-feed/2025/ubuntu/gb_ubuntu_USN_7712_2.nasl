...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7712.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7712-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7712-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7712-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.15' package(s) announced via the USN-7712-2 advisory.");
...
CVE-2025-37788, CVE-2025-37892, CVE-2025-38001, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1094-azure", ver:"5.15.0-1094.103~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.15.0.1094.103~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-5.15", ver:"5.15.0.1094.103~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-cvm", ver:"5.15.0.1094.103~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
