...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7303.2");
  ...
  script_tag(name:"creation_date", value:"2025-03-03 04:04:08 +0000 (Mon, 03 Mar 2025)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7303-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7303-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7303-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle, linux-oracle-6.8' package(s) announced via the USN-7303-2 advisory.");
...
CVE-2024-47682, CVE-2024-49976, CVE-2024-49895, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1020-oracle", ver:"6.8.0-1020.21~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1020-oracle-64k", ver:"6.8.0-1020.21~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.8.0-1020.21~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.8.0-1020.21~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1020-oracle", ver:"6.8.0-1020.21", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1020-oracle-64k", ver:"6.8.0-1020.21", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.8.0-1020.21", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.8.0-1020.21", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k-lts-24.04", ver:"6.8.0-1020.21", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-lts-24.04", ver:"6.8.0-1020.21", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
