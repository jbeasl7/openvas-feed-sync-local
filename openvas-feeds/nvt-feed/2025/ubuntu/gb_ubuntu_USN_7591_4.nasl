...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7591.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7591-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7591-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7591-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-7591-4 advisory.");
...
CVE-2025-22018)");
  ...
  script_tag(name:"affected", value:"'linux-aws' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1086-aws", ver:"5.15.0-1086.93", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1086-aws-64k", ver:"5.15.0-1086.93", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k-lts-22.04", ver:"5.15.0.1086.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-22.04", ver:"5.15.0.1086.89", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
