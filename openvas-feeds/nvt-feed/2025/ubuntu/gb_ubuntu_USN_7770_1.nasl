...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7770-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7770-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7770-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-7770-1 advisory.");
...
CVE-2025-38073, CVE-2025-38070, CVE-2025-38138, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1012-azure", ver:"6.14.0-1012.12", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.14.0-1012.12", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-6.14", ver:"6.14.0-1012.12", rls:"UBUNTU25.04"))) {
    report += res;
  }
