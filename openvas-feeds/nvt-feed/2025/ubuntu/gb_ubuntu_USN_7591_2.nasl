...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7591.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7591-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7591-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7591-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-fips, linux-fips, linux-gcp-fips' package(s) announced via the USN-7591-2 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1085-gcp-fips", ver:"5.15.0-1085.94+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1086-aws-fips", ver:"5.15.0-1086.93+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-142-fips", ver:"5.15.0-142.152+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-fips", ver:"5.15.0.1086.82", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"5.15.0.142.82", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-fips", ver:"5.15.0.1085.75", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
