...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7401-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7401-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7401-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.4' package(s) announced via the USN-7401-1 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1142-aws", ver:"5.4.0-1142.152~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.4.0.1142.152~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
