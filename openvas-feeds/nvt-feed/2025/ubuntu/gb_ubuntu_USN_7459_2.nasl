...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7459.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7459-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7459-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7459-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp-5.15' package(s) announced via the USN-7459-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - IPv4 networking,
 - IPv6 networking,
 - IEEE 802.15.4 ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1081-gcp", ver:"5.15.0-1081.90~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"5.15.0.1081.90~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
