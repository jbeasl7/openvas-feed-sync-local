...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7206.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7206-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7206-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7206-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2096914");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the USN-7206-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7206-3 fixed vulnerabilities in rsync for Ubuntu 24.10. The update
...
Original advisory details:
 ...
 information or escalate privileges. (CVE-2024-12747)");
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on Ubuntu 24.10.");
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rsync", ver:"3.3.0-1ubuntu0.2", rls:"UBUNTU24.10"))) {
    report += res;
  }
