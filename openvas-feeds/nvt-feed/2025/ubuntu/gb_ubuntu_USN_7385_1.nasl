...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7385-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7385-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7385-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm' package(s) announced via the USN-7385-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-ibm' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1022-ibm", ver:"6.8.0-1022.22", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"6.8.0-1022.22", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-classic", ver:"6.8.0-1022.22", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm-lts-24.04", ver:"6.8.0-1022.22", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
