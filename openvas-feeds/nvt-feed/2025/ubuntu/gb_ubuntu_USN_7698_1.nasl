...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7698.1");
  script_cve_id("CVE-2020-36221", "CVE-2020-36222", "CVE-2020-36223", "CVE-2020-36224", "CVE-2020-36225", "CVE-2020-36226", "CVE-2020-36227", "CVE-2020-36228");
  ...
  script_tag(name:"severity_date", value:"2021-01-29 13:06:30 +0000 (Fri, 29 Jan 2021)");

  script_name("Ubuntu: Security Advisory (USN-7698-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7698-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7698-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openldap' package(s) announced via the USN-7698-1 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"slapd", ver:"2.4.31-1+nmu2ubuntu8.5+esm7", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
