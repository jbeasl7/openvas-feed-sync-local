...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7510.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7510-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7510-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7510-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-fips' package(s) announced via the USN-7510-2 advisory.");
...
CVE-2024-58051, CVE-2025-21761, CVE-2025-21760, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-fips' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-140-fips", ver:"5.15.0-140.150+fips1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-fips", ver:"5.15.0.140.80", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
