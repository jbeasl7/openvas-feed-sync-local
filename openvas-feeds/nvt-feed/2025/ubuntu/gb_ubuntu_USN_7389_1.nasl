...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7389-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7389-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7389-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-nvidia-tegra, linux-nvidia-tegra-igx' package(s) announced via the USN-7389-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Memory ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-nvidia-tegra, linux-nvidia-tegra-igx' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1021-nvidia-tegra-igx", ver:"5.15.0-1021.21", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1021-nvidia-tegra-igx-rt", ver:"5.15.0-1021.21", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1033-nvidia-tegra", ver:"5.15.0-1033.33", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1033-nvidia-tegra-rt", ver:"5.15.0-1033.33", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra", ver:"5.15.0.1033.33", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx", ver:"5.15.0.1021.23", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-igx-rt", ver:"5.15.0.1021.23", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-tegra-rt", ver:"5.15.0.1033.33", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
