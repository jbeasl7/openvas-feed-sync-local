...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7311.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7311-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7311-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7311-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-6.8' package(s) announced via the USN-7311-1 advisory.");
...
CVE-2024-49896, CVE-2024-47707, CVE-2024-47743, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws, linux-aws-6.8' package(s) on Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1023-aws", ver:"6.8.0-1023.25~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.8.0-1023.25~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1023-aws", ver:"6.8.0-1023.25", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.8.0-1023.25", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-24.04", ver:"6.8.0-1023.25", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
