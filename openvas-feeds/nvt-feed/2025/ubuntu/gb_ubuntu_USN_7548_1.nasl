...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7548.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7548-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7548-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7548-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb' package(s) announced via the USN-7548-1 advisory.");
...
new features, and possibly incompatible changes.");
  ...
  script_tag(name:"affected", value:"'mariadb' package(s) on Ubuntu 24.04, Ubuntu 25.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mariadb-server", ver:"1:10.11.13-0ubuntu0.24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mariadb-server", ver:"1:11.4.7-0ubuntu0.25.04.1", rls:"UBUNTU25.04"))) {
    report += res;
  }
