...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7521.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7521-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7521-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7521-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-7521-2 advisory.");
...
CVE-2025-21775, CVE-2025-21711, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws' package(s) on Ubuntu 24.10.");
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.11.0-1014-aws", ver:"6.11.0-1014.15", rls:"UBUNTU24.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.11.0-1014.15", rls:"UBUNTU24.10"))) {
    report += res;
  }
