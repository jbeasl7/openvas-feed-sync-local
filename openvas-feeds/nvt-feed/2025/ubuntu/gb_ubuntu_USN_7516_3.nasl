...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7516.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7516-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7516-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7516-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-kvm' package(s) announced via the USN-7516-3 advisory.");
...
CVE-2024-57973, CVE-2025-21708)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-kvm' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1133-kvm", ver:"5.4.0-1133.142", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1151-azure", ver:"5.4.0-1151.158", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-20.04", ver:"5.4.0.1151.145", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.4.0.1133.129", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
