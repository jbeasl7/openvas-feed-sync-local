...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7594-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7594-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7594-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-gcp, linux-raspi, linux-realtime' package(s) announced via the USN-7594-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Netfilter,
 - Open vSwitch,
 - Network ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1004-realtime", ver:"6.14.0-1004.4", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-raspi", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1008-gcp", ver:"6.14.0-1008.8", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1008-gcp-64k", ver:"6.14.0-1008.8", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-22-generic", ver:"6.14.0-22.22", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-22-generic-64k", ver:"6.14.0-22.22", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.14.0-1008.8", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp-64k", ver:"6.14.0-1008.8", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic", ver:"6.14.0-22.22", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k", ver:"6.14.0-22.22", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-realtime", ver:"6.14.0-1004.4", rls:"UBUNTU25.04"))) {
    report += res;
  }
