...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2025.7594.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-7594-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7594-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7594-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-oracle' package(s) announced via the USN-7594-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Network ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-oracle' package(s) on Ubuntu 25.04.");
...
if(release == "UBUNTU25.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-aws", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-aws-64k", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-oracle", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.14.0-1007-oracle-64k", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.14.0-1007.7+1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-64k", ver:"6.14.0-1007.7+1", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.14.0-1007.7", rls:"UBUNTU25.04"))) {
    report += res;
  }
