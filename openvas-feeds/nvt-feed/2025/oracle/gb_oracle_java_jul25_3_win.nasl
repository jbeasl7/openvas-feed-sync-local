...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836516");
  script_version("2025-07-18T15:43:33+0000");
  script_cve_id("CVE-2025-50059");
  ...
  script_name("Oracle Java SE Security Update (Jul 2025) - Windows");
  ...
  to gain unauthorized access to critical data.");

  script_tag(name:"affected", value:"Oracle Java SE version 11.0.x through
  11.0.27, 17.0.x through 17.0.15, 21.0.x through 21.0.7 and 24.0.x through
  24.0.1 on Windows");
...
if(version_in_range(version:vers, test_version:"11.0", test_version2:"11.0.27") ||
