...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836518");
  ...
  script_name("Oracle Java SE Multiple Vulnerabilities (Jul 2025) - Windows");
  ...
  to gain unauthorized access to critical data and take control of Oracle Java SE.");

  script_tag(name:"affected", value:"Oracle Java SE version 8u451 and prior,
  11.0.x through 11.0.27, 17.0.x through 17.0.15, 21.0.x through 21.0.7 and
  24.0.x through 24.0.1 on Windows");
...
if(version_in_range(version:vers, test_version:"1.8.0", test_version2:"1.8.0.451") ||
   version_in_range(version:vers, test_version:"11.0", test_version2:"11.0.27") ||
   version_in_range(version:vers, test_version:"17.0", test_version2:"17.0.15") ||
   version_in_range(version:vers, test_version:"21.0", test_version2:"21.0.7") ||
   version_in_range(version:vers, test_version:"24.0", test_version2:"24.0.1")) {
