...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836510");
  script_version("2025-07-18T15:43:33+0000");
  script_cve_id("CVE-2025-30752");
  ...
  script_tag(name:"severity_date", value:"2025-07-15 20:15:29 +0000 (Tue, 15 Jul 2025)");
  script_tag(name:"creation_date", value:"2025-07-16 15:04:46 +0530 (Wed, 16 Jul 2025)");
  script_name("Oracle Java SE DoS Vulnerability (Jul 2025) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 24.0.x through
  24.0.1 on Windows.");
...
if(version_in_range(version:vers, test_version:"24.0", test_version2:"24.0.1")) {
