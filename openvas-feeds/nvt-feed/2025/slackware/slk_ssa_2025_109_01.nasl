...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2025.109.01");
  ...
  script_name("Slackware: Security Advisory (SSA:2025-109-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2025-109-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2025&m=slackware-security.357864");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2021-45444");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zsh' package(s) announced via the SSA:2025-109-01 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"New zsh packages are available for Slackware 15.0 to fix a security issue.
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'zsh' package(s) on Slackware 15.0.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"zsh", ver:"5.9-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"zsh", ver:"5.9-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
