...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.154111");
  script_version("2025-06-05T05:40:56+0000");
  script_tag(name:"last_modification", value:"2025-06-05 05:40:56 +0000 (Thu, 05 Jun 2025)");
  script_tag(name:"creation_date", value:"2025-03-04 04:20:32 +0000 (Tue, 04 Mar 2025)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_cve_id("CVE-2024-11346");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Lexmark Printer Type Confusion Vulnerability (CVE-2024-11346)");
  ...
  script_tag(name:"summary", value:"Multiple Lexmark printer devices are prone to a type confusion
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable firmware version is present on the
  target host.");

  script_tag(name:"insight", value:"A type confusion vulnerability has been identified in the
  ...
  script_xref(name:"URL", value:"https://support.lexmark.com/content/dam/support/collateral/security-alerts/CVE-2024-11346.pdf");
