...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.154101");
  script_version("2025-06-05T05:40:56+0000");
  script_tag(name:"last_modification", value:"2025-06-05 05:40:56 +0000 (Thu, 05 Jun 2025)");
  script_tag(name:"creation_date", value:"2025-03-03 04:30:05 +0000 (Mon, 03 Mar 2025)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_cve_id("CVE-2024-11345");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Lexmark Printer RCE Vulnerability (CVE-2024-11345)");
  ...
  script_tag(name:"insight", value:"A heap-based memory vulnerability has been identified in the
  ...
  script_xref(name:"URL", value:"https://support.lexmark.com/content/dam/support/collateral/security-alerts/CVE-2024-11345.pdf");
...
if (cpe =~ "^cpe:/o:lexmark:cx96[1-3]" || cpe =~ "^cpe:/o:lexmark:xc96[3-5]5" ||
  ...
  if (version_is_less(version: version, test_version: "CXTLS.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTLS.230.342");
...
if (cpe =~ "^cpe:/o:lexmark:cs963") {
  if (version_is_less(version: version, test_version: "CSTLS.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTLS.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms[56]31") {
  if (version_is_less(version: version, test_version: "MSNSN.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSNSN.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms632" || cpe =~ "^cpe:/o:lexmark:m3350") {
  if (version_is_less(version: version, test_version: "MSTSN.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSTSN.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mx[56]32" || cpe =~ "^cpe:/o:lexmark:xm3350") {
  if (version_is_less(version: version, test_version: "MXTSN.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXTSN.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs531" || cpe =~ "^cpe:/o:lexmark:c2335") {
  if (version_is_less(version: version, test_version: "CSNGV.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSNGV.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs632") {
  if (version_is_less(version: version, test_version: "CSTGV.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTGV.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx532" || cpe =~ "^cpe:/o:lexmark:cx635" ||
  ...
  if (version_is_less(version: version, test_version: "CXTGV.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTGV.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx9(30|31|42|43|44)" || cpe =~ "^cpe:/o:lexmark:xc93[23]5" ||
  ...
  if (version_is_less(version: version, test_version: "CXTPC.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTPC.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs943") {
  if (version_is_less(version: version, test_version: "CSTPC.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTPC.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mx432" || cpe =~ "^cpe:/o:lexmark:xm3142") {
  if (version_is_less(version: version, test_version: "MXTCT.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXTCT.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mx931") {
  if (version_is_less(version: version, test_version: "MXTPM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXTPM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx73[057]" || cpe =~ "^cpe:/o:lexmark:xc43[45]2") {
  if (version_is_less(version: version, test_version: "CXTMM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTMM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs73[057]" || cpe =~ "^cpe:/o:lexmark:c43[45]2") {
  if (version_is_less(version: version, test_version: "CSTMM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTMM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:b2236") {
  if (version_is_less(version: version, test_version: "MSLSG.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSLSG.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mb2236") {
  if (version_is_less(version: version, test_version: "MXLSG.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXLSG.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms331" || cpe =~ "^cpe:/o:lexmark:ms43[19]" ||
  ...
  if (version_is_less(version: version, test_version: "MSLBD.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSLBD.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:xm1342" || cpe =~ "^cpe:/o:lexmark:mx[34]31" ||
  ...
  if (version_is_less(version: version, test_version: "MXLBD.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXLBD.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms[3-6]21" || cpe =~ "^cpe:/o:lexmark:m124[26]" ||
  ...
  if (version_is_less(version: version, test_version: "MSNGM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSNGM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms622" || cpe =~ "^cpe:/o:lexmark:m3250") {
  if (version_is_less(version: version, test_version: "MSTGM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSTGM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mx321" || cpe =~ "^cpe:/o:lexmark:mb2338") {
  if (version_is_less(version: version, test_version: "MXNGM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXNGM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mx[45]21" || cpe =~ "^cpe:/o:lexmark:mx[56]22" ||
  ...
  if (version_is_less(version: version, test_version: "MXTGM.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXTGM.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms725" || cpe =~ "^cpe:/o:lexmark:ms82[135]" ||
  ...
  if (version_is_less(version: version, test_version: "MSNGW.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSNGW.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:ms82[26]" || cpe =~ "^cpe:/o:lexmark:m52(55|70)") {
  if (version_is_less(version: version, test_version: "MSTGW.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MSTGW.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mx72[125]" || cpe =~ "^cpe:/o:lexmark:mx82[26]" ||
  ...
  if (version_is_less(version: version, test_version: "MXTGW.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "MXTGW.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:c3426" || cpe =~ "^cpe:/o:lexmark:cs43[19]" ||
  ...
  if (version_is_less(version: version, test_version: "CSLBN.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSLBN.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs331" || cpe =~ "^cpe:/o:lexmark:c3224" ||
  ...
  if (version_is_less(version: version, test_version: "CSLBL.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSLBL.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mc3426" || cpe =~ "^cpe:/o:lexmark:cx431" ||
  ...
  if (version_is_less(version: version, test_version: "CXLBN.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXLBN.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:mc3224" || cpe =~ "^cpe:/o:lexmark:mc3326" ||
  ...
  if (version_is_less(version: version, test_version: "CXLBL.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXLBL.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs622" || cpe =~ "^cpe:/o:lexmark:c2240") {
  if (version_is_less(version: version, test_version: "CSTZJ.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTZJ.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs[45]21" || cpe =~ "^cpe:/o:lexmark:c2[34]25" ||
  ...
  if (version_is_less(version: version, test_version: "CSNZJ.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSNZJ.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx[56]22" || cpe =~ "^cpe:/o:lexmark:cx625" ||
  ...
  if (version_is_less(version: version, test_version: "CXTZJ.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTZJ.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx421" || cpe =~ "^cpe:/o:lexmark:mc2[34]25") {
  if (version_is_less(version: version, test_version: "CXNZJ.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXNZJ.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx82[057]" || cpe =~ "^cpe:/o:lexmark:cx860" ||
  ...
  if (version_is_less(version: version, test_version: "CXTPP.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTPP.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs82[07]" || cpe =~ "^cpe:/o:lexmark:c6160") {
  if (version_is_less(version: version, test_version: "CSTPP.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTPP.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs72[0578]" || cpe =~ "^cpe:/o:lexmark:c4150") {
  if (version_is_less(version: version, test_version: "CSTAT.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTAT.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx72[57]" || cpe =~ "^cpe:/o:lexmark:xc41(40|43|50|53)") {
  if (version_is_less(version: version, test_version: "CXTAT.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTAT.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cs92[137]" || cpe =~ "^cpe:/o:lexmark:c9235") {
  if (version_is_less(version: version, test_version: "CSTMH.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CSTMH.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
...
if (cpe =~ "^cpe:/o:lexmark:cx92[0-4]" || cpe =~ "^cpe:/o:lexmark:xc92[2-6]5") {
  if (version_is_less(version: version, test_version: "CXTMH.230.342")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "CXTMH.230.342");
    security_message(port: 0, data: report);
    exit(0);
  }
}
