...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0988.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0988-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0988-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250988-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-March/020581.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zvbi' package(s) announced via the SUSE-SU-2025:0988-1 advisory.");
...
- CVE-2025-2177: Fixed integer overflow in function vbi_search_new in src/search.c (bsc#1239320).");
  ...
  script_tag(name:"affected", value:"'zvbi' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libzvbi0", rpm:"libzvbi0~0.2.35~3.3.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zvbi-devel", rpm:"zvbi-devel~0.2.35~3.3.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
