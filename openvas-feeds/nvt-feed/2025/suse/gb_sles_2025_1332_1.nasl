...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1332.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1332-1)");
 ...
 * Bug Fixes
 ...
 - hashedrekord: fix schema $id (#2092)");
  ...
  script_tag(name:"affected", value:"'rekor' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rekor", rpm:"rekor~1.3.10~150400.4.25.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rekor", rpm:"rekor~1.3.10~150400.4.25.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rekor", rpm:"rekor~1.3.10~150400.4.25.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
