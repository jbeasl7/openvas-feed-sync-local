...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03219.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03219-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03219-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503219-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-September/041704.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jasper' package(s) announced via the SUSE-SU-2025:03219-1 advisory.");
...
- CVE-2025-8837: missing operations in cleanup code of the JPEG-2000 (JPC) Encoder leads to use-after-free when
 processing malformed JPEG2000 images with certain debug levels enabled (bsc#1247901).");
  ...
  script_tag(name:"affected", value:"'jasper' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libjasper4", rpm:"libjasper4~2.0.14~150000.3.37.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
