...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1294.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1294-1)");
...
- Updated to version 2.2.34");
  ...
  script_tag(name:"affected", value:"'rubygem-bundler' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~2.2.34~150000.3.11.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~2.2.34~150000.3.11.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~2.2.34~150000.3.11.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~2.2.34~150000.3.11.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
