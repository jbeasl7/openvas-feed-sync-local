...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0407.1");
  ...
  script_tag(name:"creation_date", value:"2025-02-11 10:21:23 +0000 (Tue, 11 Feb 2025)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0407-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0407-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250407-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-February/020300.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ovmf' package(s) announced via the SUSE-SU-2025:0407-1 advisory.");
...
- CVE-2023-45237: use of a weak pseudorandom number generator in edk2. (bsc#1218887)");
  ...
  script_tag(name:"affected", value:"'ovmf' package(s) on SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ovmf", rpm:"ovmf~202208~150500.6.6.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovmf-tools", rpm:"ovmf-tools~202208~150500.6.6.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86_64", rpm:"qemu-ovmf-x86_64~202208~150500.6.6.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-uefi-aarch64", rpm:"qemu-uefi-aarch64~202208~150500.6.6.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
