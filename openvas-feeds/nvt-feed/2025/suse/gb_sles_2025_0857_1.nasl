...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0857.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0857-1)");
...
- ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'build' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"build", rpm:"build~20250306~150200.19.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"build-mkbaselibs", rpm:"build-mkbaselibs~20250306~150200.19.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"build", rpm:"build~20250306~150200.19.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"build-mkbaselibs", rpm:"build-mkbaselibs~20250306~150200.19.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"build", rpm:"build~20250306~150200.19.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"build-mkbaselibs", rpm:"build-mkbaselibs~20250306~150200.19.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
