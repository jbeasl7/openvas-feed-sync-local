...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1534.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1534-1)");
...
- CVE-2025-2588: Check for NULL pointers when calling re_case_expand in function fa_expand_nocase. (bsc#1239909)");
  ...
  script_tag(name:"affected", value:"'augeas' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"augeas", rpm:"augeas~1.14.1~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"augeas-devel", rpm:"augeas-devel~1.14.1~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"augeas-lenses", rpm:"augeas-lenses~1.14.1~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libaugeas0", rpm:"libaugeas0~1.14.1~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfa1", rpm:"libfa1~1.14.1~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
