...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1451.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1451-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:1451-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20251451-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-May/039142.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libva' package(s) announced via the SUSE-SU-2025:1451-1 advisory.");
 ...
 * win: Add ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libva' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libva-devel", rpm:"libva-devel~2.20.0~150300.3.3.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva-drm2", rpm:"libva-drm2~2.20.0~150300.3.3.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva-wayland2", rpm:"libva-wayland2~2.20.0~150300.3.3.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva-x11-2", rpm:"libva-x11-2~2.20.0~150300.3.3.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva2", rpm:"libva2~2.20.0~150300.3.3.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
