...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02311.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02311-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libprotobuf-lite25_1_0", rpm:"libprotobuf-lite25_1_0~25.1~150600.16.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libprotobuf25_1_0", rpm:"libprotobuf25_1_0~25.1~150600.16.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libprotoc25_1_0", rpm:"libprotoc25_1_0~25.1~150600.16.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
