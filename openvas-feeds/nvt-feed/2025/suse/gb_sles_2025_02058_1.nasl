...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02058.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02058-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gstreamer-plugins-good", rpm:"gstreamer-plugins-good~1.24.0~150600.3.7.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gstreamer-plugins-good-lang", rpm:"gstreamer-plugins-good-lang~1.24.0~150600.3.7.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
