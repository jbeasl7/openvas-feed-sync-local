...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03114.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03114-1)");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netty-tcnative", rpm:"netty-tcnative~2.0.73~150200.3.30.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netty-tcnative", rpm:"netty-tcnative~2.0.73~150200.3.30.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"netty-tcnative", rpm:"netty-tcnative~2.0.73~150200.3.30.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
