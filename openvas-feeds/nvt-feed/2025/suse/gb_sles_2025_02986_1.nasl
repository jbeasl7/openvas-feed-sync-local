...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02986.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02986-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpq5", rpm:"libpq5~17.6~150600.13.16.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpq5-32bit", rpm:"libpq5-32bit~17.6~150600.13.16.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"postgresql17", rpm:"postgresql17~17.6~150600.13.16.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
