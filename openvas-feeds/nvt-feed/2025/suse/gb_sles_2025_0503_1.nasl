...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0503.1");
  script_cve_id("CVE-2023-45229", "CVE-2023-45230", "CVE-2023-45231", "CVE-2023-45232", "CVE-2023-45233", "CVE-2023-45234", "CVE-2023-45235", "CVE-2023-45236", "CVE-2023-45237", "CVE-2024-1298");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0503-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0503-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250503-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-February/020334.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ovmf' package(s) announced via the SUSE-SU-2025:0503-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ovmf", rpm:"ovmf~202202~150400.5.15.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ovmf-tools", rpm:"ovmf-tools~202202~150400.5.15.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-ovmf-x86_64", rpm:"qemu-ovmf-x86_64~202202~150400.5.15.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-uefi-aarch64", rpm:"qemu-uefi-aarch64~202202~150400.5.15.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
