...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.1962.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1962-1)");
...
- CVE-2024-4418: Fixed a stack use-after-free by ensuring temporary GSource is removed from client event loop. (bsc#1223849)");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-libs", rpm:"libvirt-libs~10.0.0~150600.8.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
