...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.01638.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:01638-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssh", rpm:"openssh~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-clients", rpm:"openssh-clients~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-common", rpm:"openssh-common~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-fips", rpm:"openssh-fips~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-helpers", rpm:"openssh-helpers~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-server", rpm:"openssh-server~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssh-server-config-disallow-rootlogin", rpm:"openssh-server-config-disallow-rootlogin~9.6p1~150600.6.26.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
