...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.01987.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:01987-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:01987-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202501987-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-June/040351.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Multi-Linux Manager Client Tools' package(s) announced via the SUSE-SU-2025:01987-1 advisory.");
 ...
 * Data sources: Responses which are ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Multi-Linux Manager Client Tools' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-github-prometheus-node_exporter", rpm:"golang-github-prometheus-node_exporter~1.9.1~1.36.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
