...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.1486.2");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1486-2)");
 ...
 * Adds Support for Fulcio Client Credentials Flow, and Argument to Set Flow Explicitly (#3578)");
  ...
  script_tag(name:"affected", value:"'cosign' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cosign", rpm:"cosign~2.2.4~150400.3.20.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
