...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.4784.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:4784-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:4784-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20234784-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1084909");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176950");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190208");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214408");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214764");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216031");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1216759");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217087");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217206");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217519");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217525");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217603");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217604");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217607");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2023-December/017319.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2023:4784-1 advisory.");
...
- md: Flush ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-default", rpm:"kernel-default~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-base", rpm:"kernel-default-base~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-devel", rpm:"kernel-default-devel~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-man", rpm:"kernel-default-man~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-devel", rpm:"kernel-devel~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-macros", rpm:"kernel-macros~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-source", rpm:"kernel-source~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-syms", rpm:"kernel-syms~4.12.14~122.186.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
