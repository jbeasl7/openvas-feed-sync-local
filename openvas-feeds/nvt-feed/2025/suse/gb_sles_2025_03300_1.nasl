...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03300.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03300-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"vim", rpm:"vim~9.1.1629~150500.20.33.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-data", rpm:"vim-data~9.1.1629~150500.20.33.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-data-common", rpm:"vim-data-common~9.1.1629~150500.20.33.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-small", rpm:"vim-small~9.1.1629~150500.20.33.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
