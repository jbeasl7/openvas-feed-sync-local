...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02684.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02684-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apache2", rpm:"apache2~2.4.58~150600.5.35.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache2-prefork", rpm:"apache2-prefork~2.4.58~150600.5.35.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
