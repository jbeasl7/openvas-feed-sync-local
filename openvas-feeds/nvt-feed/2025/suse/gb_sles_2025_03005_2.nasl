...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03005.2");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03005-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03005-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503005-2.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-September/041652.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql16' package(s) announced via the SUSE-SU-2025:03005-2 advisory.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"postgresql16", rpm:"postgresql16~16.10~150600.16.21.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
