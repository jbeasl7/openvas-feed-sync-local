...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02316.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02316-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen-libs", rpm:"xen-libs~4.18.5_04~150600.3.28.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools-domU", rpm:"xen-tools-domU~4.18.5_04~150600.3.28.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
