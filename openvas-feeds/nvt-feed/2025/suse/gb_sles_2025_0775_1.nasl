...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0775.1");
  script_cve_id("CVE-2023-45288", "CVE-2024-11218", "CVE-2024-1753", "CVE-2024-6104", "CVE-2024-9341", "CVE-2024-9407", "CVE-2024-9675", "CVE-2024-9676", "CVE-2025-27144");
  script_tag(name:"creation_date", value:"2025-03-06 04:08:48 +0000 (Thu, 06 Mar 2025)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0775-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0775-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250775-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1237641");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-March/020479.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman' package(s) announced via the SUSE-SU-2025:0775-1 advisory.");
 ...
 * Default to netavark everywhere where it's available");
  ...
  script_tag(name:"affected", value:"'podman' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"podman", rpm:"podman~4.9.5~150300.9.43.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"podman-remote", rpm:"podman-remote~4.9.5~150300.9.43.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
