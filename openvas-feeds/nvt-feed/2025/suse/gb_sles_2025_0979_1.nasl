...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0979.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0979-1)");
 ...
 - CVE-2025-2177: Fixed integer overflow in function vbi_search_new in src/search.c (bsc#1239320).");
  ...
  script_tag(name:"affected", value:"'zvbi' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libzvbi0", rpm:"libzvbi0~0.2.35~150000.4.3.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libzvbi0", rpm:"libzvbi0~0.2.35~150000.4.3.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
