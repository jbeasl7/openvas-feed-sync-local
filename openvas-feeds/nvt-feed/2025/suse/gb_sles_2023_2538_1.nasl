...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2023.2538.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2023:2538-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:2538-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232538-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1065729");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1118212");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209857");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210544");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210806");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210940");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211044");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211105");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211186");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211275");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211360");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211361");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211362");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211363");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211364");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211365");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211366");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211801");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211816");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211960");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2023-June/029925.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2023:2538-1 advisory.");
...
- KVM: x86: Update the exit_qualification access bits while walking an address ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-default", rpm:"kernel-default~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-base", rpm:"kernel-default-base~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-devel", rpm:"kernel-default-devel~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-man", rpm:"kernel-default-man~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-devel", rpm:"kernel-devel~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-macros", rpm:"kernel-macros~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-source", rpm:"kernel-source~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-syms", rpm:"kernel-syms~4.12.14~122.162.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
