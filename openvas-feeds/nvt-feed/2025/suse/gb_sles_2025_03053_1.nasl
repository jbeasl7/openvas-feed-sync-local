...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03053.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03053-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03053-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503053-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1248438");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-September/041494.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2025:03053-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250812~150200.59.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250812~150200.59.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250812~150200.59.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250812~150200.59.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
