...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02016.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02016-1)");
...
- Fix resume after suspend in multi-user mode.");
  ...
  script_tag(name:"affected", value:"'screen' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"screen", rpm:"screen~4.6.2~150000.5.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
