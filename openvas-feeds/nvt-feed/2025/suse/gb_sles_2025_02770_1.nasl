...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02770.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02770-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff-devel", rpm:"libtiff-devel~4.7.0~150600.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff6-32bit", rpm:"libtiff6-32bit~4.7.0~150600.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff6", rpm:"libtiff6~4.7.0~150600.3.13.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
