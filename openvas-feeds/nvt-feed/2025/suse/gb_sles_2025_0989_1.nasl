...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0989.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0989-1)");
...
- CVE-2024-57258: multiple integer overflows in U-Boot's memory allocator (bsc#1237287).");
  ...
  script_tag(name:"affected", value:"'u-boot' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"u-boot-rpiarm64", rpm:"u-boot-rpiarm64~2021.10~150600.11.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"u-boot-rpiarm64-doc", rpm:"u-boot-rpiarm64-doc~2021.10~150600.11.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"u-boot-tools", rpm:"u-boot-tools~2021.10~150600.11.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
