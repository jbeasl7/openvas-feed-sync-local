...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0130.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0130-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0130-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250130-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1235517");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-January/020139.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq' package(s) announced via the SUSE-SU-2025:0130-1 advisory.");
...
- CVE-2023-50868: Fixed a Denial Of Service while trying to validate specially crafted DNSSEC responses. (bsc#1219826)");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.90~150100.7.28.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
