...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.01968.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:01968-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libwireshark17", rpm:"libwireshark17~4.2.12~150600.18.23.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libwiretap14", rpm:"libwiretap14~4.2.12~150600.18.23.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libwsutil15", rpm:"libwsutil15~4.2.12~150600.18.23.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wireshark", rpm:"wireshark~4.2.12~150600.18.23.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
