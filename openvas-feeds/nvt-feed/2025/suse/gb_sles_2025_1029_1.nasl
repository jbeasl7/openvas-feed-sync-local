...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1029.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1029-1)");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ed25519-java", rpm:"ed25519-java~0.3.0~150200.5.9.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ed25519-java", rpm:"ed25519-java~0.3.0~150200.5.9.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ed25519-java", rpm:"ed25519-java~0.3.0~150200.5.9.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
