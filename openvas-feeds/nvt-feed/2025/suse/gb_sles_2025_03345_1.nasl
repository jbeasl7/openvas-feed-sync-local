...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.03345.1");
  script_cve_id("CVE-2025-8534", "CVE-2025-8961", "CVE-2025-9165");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:03345-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:03345-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202503345-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-September/041837.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the SUSE-SU-2025:03345-1 advisory.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtiff5-32bit", rpm:"libtiff5-32bit~4.0.9~150000.45.55.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtiff5", rpm:"libtiff5~4.0.9~150000.45.55.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
