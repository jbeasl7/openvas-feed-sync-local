...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02740.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02740-1)");
...
- CVE-2024-45751: Fixed CHAP authentication bypass in user-space Linux target framework (bsc#1230360)");
  ...
  script_tag(name:"affected", value:"'tgt' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tgt", rpm:"tgt~1.0.85~150600.10.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
