...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0970.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0970-1)");
...
- Implement an error message with a condition by checking the return value of a function call. (bsc#1154002)");
  ...
  script_tag(name:"affected", value:"'zziplib' package(s) on SUSE Linux Enterprise Server 15-SP4.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libzzip-0-13", rpm:"libzzip-0-13~0.13.69~150000.3.17.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"zziplib-devel", rpm:"zziplib-devel~0.13.69~150000.3.17.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
