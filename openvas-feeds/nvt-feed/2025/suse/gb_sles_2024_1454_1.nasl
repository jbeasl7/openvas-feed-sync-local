...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1454-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1454-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241454-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220468");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220529");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220532");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220536");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220554");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220556");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220560");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220561");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220566");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220575");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220580");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220583");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220611");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220615");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220625");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220631");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220638");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220669");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220687");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220692");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220697");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220749");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220751");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220764");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220779");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220785");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220861");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221534");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221606");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221935");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221989");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221991");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221992");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/035109.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2024:1454-1 advisory.");
...
- CVE-2021-47013: Fixed a use after free in ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-default", rpm:"kernel-default~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-base", rpm:"kernel-default-base~5.3.18~150200.24.188.1.150200.9.95.3", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-default-devel", rpm:"kernel-default-devel~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-devel", rpm:"kernel-devel~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-docs", rpm:"kernel-docs~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-macros", rpm:"kernel-macros~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-obs-build", rpm:"kernel-obs-build~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-preempt", rpm:"kernel-preempt~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-preempt-devel", rpm:"kernel-preempt-devel~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-source", rpm:"kernel-source~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-syms", rpm:"kernel-syms~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"reiserfs-kmp-default", rpm:"reiserfs-kmp-default~5.3.18~150200.24.188.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
