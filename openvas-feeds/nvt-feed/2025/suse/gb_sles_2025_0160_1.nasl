...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0160.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0160-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250160-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1235386");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1235387");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-January/020158.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'redis7' package(s) announced via the SUSE-SU-2025:0160-1 advisory.");
...
- CVE-2024-46981: Fixed a bug where lua scripts can be used to manipulate the garbage collector, leading to remote code execution. (bsc#1235387)");
  ...
  script_tag(name:"affected", value:"'redis7' package(s) on SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"redis7", rpm:"redis7~7.0.8~150500.3.15.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
