...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.01651.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:01651-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:01651-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202501651-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1243123");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-May/039306.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2025:01651-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250512~150200.56.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250512~150200.56.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250512~150200.56.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250512~150200.56.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
