...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0591.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0591-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0591-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250591-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1237096");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-February/020376.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2025:0591-1 advisory.");
...
- Intel CPU Microcode was updated to the 20250211 release (bsc#1237096)
 ...
 <pipe> RPL-E/HX/S <pipe> B0 <pipe> 06-b7-01/32 <pipe> 0000012b <pipe> 0000012c <pipe> ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250211~150200.53.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250211~150200.53.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250211~150200.53.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20250211~150200.53.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
