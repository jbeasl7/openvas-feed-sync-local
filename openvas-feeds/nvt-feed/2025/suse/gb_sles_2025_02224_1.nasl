...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02224.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02224-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server", rpm:"xorg-x11-server~21.1.11~150600.5.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-Xvfb", rpm:"xorg-x11-server-Xvfb~21.1.11~150600.5.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-extra", rpm:"xorg-x11-server-extra~21.1.11~150600.5.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
