...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0783.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0783-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0783-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250783-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1237683");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-March/020480.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2025:0783-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~128.8.0~112.249.3", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-devel", rpm:"MozillaFirefox-devel~128.8.0~112.249.3", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~128.8.0~112.249.3", rls:"SLES12.0SP5"))) {
    report += res;
  }
