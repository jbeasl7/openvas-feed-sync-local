...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.2636.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:2636-1)");
 ...
 * When looking up the NS records of parent zones as part of
 ...
 fixed. (CVE-2024-4076)");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bind-utils", rpm:"bind-utils~9.18.28~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
