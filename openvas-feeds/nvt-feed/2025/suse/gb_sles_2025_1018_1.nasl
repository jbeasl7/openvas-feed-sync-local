...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1018.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1018-1)");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.35.5~150500.3.34.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
