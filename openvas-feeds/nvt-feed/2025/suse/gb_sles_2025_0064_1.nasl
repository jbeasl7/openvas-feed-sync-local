...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0064.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0064-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250064-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-January/020090.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer-plugins-good' package(s) announced via the SUSE-SU-2025:0064-1 advisory.");
...
- CVE-2024-47834: Fixed a use-after-free in the Matroska demuxer that can cause crashes for certain input files. (boo#1234440)");
  ...
  script_tag(name:"affected", value:"'gstreamer-plugins-good' package(s) on SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gstreamer-plugins-good", rpm:"gstreamer-plugins-good~1.22.0~150500.4.6.1", rls:"SLES15.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gstreamer-plugins-good-lang", rpm:"gstreamer-plugins-good-lang~1.22.0~150500.4.6.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
