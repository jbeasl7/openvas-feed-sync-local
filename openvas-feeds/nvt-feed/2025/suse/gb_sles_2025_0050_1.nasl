...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0050.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0050-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0050-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250050-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-January/020084.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmfx' package(s) announced via the SUSE-SU-2025:0050-1 advisory.");
...
- CVE-2023-47169: Fixed an improper buffer restrictions. (bsc#1226901)");
  ...
  script_tag(name:"affected", value:"'libmfx' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmfx1", rpm:"libmfx1~21.3.4~150400.3.5.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
