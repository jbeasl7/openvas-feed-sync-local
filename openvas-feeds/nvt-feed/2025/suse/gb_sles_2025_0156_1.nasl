...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0156.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0156-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250156-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1234100");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-January/020160.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the SUSE-SU-2025:0156-1 advisory.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.2.7~150600.3.8.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
