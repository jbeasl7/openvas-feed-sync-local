...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0006.1");
  script_cve_id("CVE-2024-56201", "CVE-2024-56326");
  script_tag(name:"creation_date", value:"2025-01-03 04:18:10 +0000 (Fri, 03 Jan 2025)");
  script_version("2025-08-15T15:42:26+0000");
  script_tag(name:"last_modification", value:"2025-08-15 15:42:26 +0000 (Fri, 15 Aug 2025)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("SUSE: Security Advisory (SUSE-SU-2025:0006-1)");
 ...
 - CVE-2024-56326: Fixed sandbox breakout through indirect reference to format method (bsc#1234809)");
  ...
  script_tag(name:"affected", value:"'python-Jinja2' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP5, SUSE Linux Enterprise Server for SAP Applications 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP5.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-Jinja2", rpm:"python311-Jinja2~3.1.2~150400.12.11.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python311-Jinja2", rpm:"python311-Jinja2~3.1.2~150400.12.11.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
