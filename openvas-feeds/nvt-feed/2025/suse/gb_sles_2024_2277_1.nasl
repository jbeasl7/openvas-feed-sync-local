...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.2277.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:2277-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"git-core", rpm:"git-core~2.43.0~150600.3.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
