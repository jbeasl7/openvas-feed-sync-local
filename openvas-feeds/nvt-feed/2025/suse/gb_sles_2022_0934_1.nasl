...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2022.0934.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2022:0934-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:0934-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2022/suse-su-20220934-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183909");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184519");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184620");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184794");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188941");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191473");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192267");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2022-March/010497.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'binutils' package(s) announced via the SUSE-SU-2022:0934-1 advisory.");
...
* Readelf and objdump will now follow links to separate debug info
 ...
 '--debug-dump=info') then the ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'binutils' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.37~6.23.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"binutils-devel", rpm:"binutils-devel~2.37~6.23.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"binutils-devel-32bit", rpm:"binutils-devel-32bit~2.37~6.23.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libctf-nobfd0", rpm:"libctf-nobfd0~2.37~6.23.1", rls:"SLES15.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libctf0", rpm:"libctf0~2.37~6.23.1", rls:"SLES15.0"))) {
    report += res;
  }
