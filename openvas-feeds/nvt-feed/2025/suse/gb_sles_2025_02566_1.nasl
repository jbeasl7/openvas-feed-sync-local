...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02566.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02566-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libarchive-devel", rpm:"libarchive-devel~3.7.2~150600.3.17.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libarchive13", rpm:"libarchive13~3.7.2~150600.3.17.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
