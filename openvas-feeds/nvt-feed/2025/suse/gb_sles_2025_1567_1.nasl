...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1567.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1567-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:1567-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20251567-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1243123");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-May/020842.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the SUSE-SU-2025:1567-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~1.17~102.83.84.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
