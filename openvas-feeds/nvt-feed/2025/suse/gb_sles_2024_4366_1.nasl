...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.4366.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:4366-1)");
...
- CVE-2024-46901: Fixed denial-of-service via control characters in paths in mod_dav_svn (bsc#1234317)");
  ...
  script_tag(name:"affected", value:"'subversion' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"subversion", rpm:"subversion~1.14.1~150400.5.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"subversion-devel", rpm:"subversion-devel~1.14.1~150400.5.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
