...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.0166.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:0166-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0166-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20250166-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-January/020167.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the SUSE-SU-2025:0166-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rsync", rpm:"rsync~3.1.3~3.22.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
