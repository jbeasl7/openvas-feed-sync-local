...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.02339.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:02339-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:02339-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-202502339-1.html");
  script_xref(name:"URL", value:"http://github.com/tc39/proposal-error-");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1244670");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2025-July/040754.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox, MozillaFirefox-branding-SLE' package(s) announced via the SUSE-SU-2025:02339-1 advisory.");
...
Security & Privacy:
 ...
 - HTTPS is replacing HTTP as the default ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'MozillaFirefox, MozillaFirefox-branding-SLE' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~140.0~112.270.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-branding-SLE", rpm:"MozillaFirefox-branding-SLE~140~35.19.5", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-devel", rpm:"MozillaFirefox-devel~140.0~112.270.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~140.0~112.270.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
