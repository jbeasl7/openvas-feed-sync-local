...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2025.1477.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2025:1477-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:1477-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2025/suse-su-20251477-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2025-May/020798.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libva' package(s) announced via the SUSE-SU-2025:1477-1 advisory.");
 ...
 * win: Add ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libva' package(s) on SUSE Linux Enterprise Server 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libva-devel", rpm:"libva-devel~2.20.0~3.3.4", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva-drm2", rpm:"libva-drm2~2.20.0~3.3.4", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva-x11-2", rpm:"libva-x11-2~2.20.0~3.3.4", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libva2", rpm:"libva2~2.20.0~3.3.4", rls:"SLES12.0SP5"))) {
    report += res;
  }
