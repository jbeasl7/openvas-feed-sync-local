...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124853");
  ...
  script_cve_id("CVE-2025-49586");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 7.2-milestone-2 < 16.4.7, 16.5.0-rc-1 < 16.10.3, 17.0.0-rc-1 < 17.0.0 RCE Vulnerability (GHSA-jp4x-w9cj-97q7)");
  ...
  script_tag(name:"insight", value:"Any XWiki user with edit right on at least one App Within
  Minutes application (the default for all users XWiki) can obtain programming right/perform remote
  code execution by editing the application. The detailed reproduction steps can be found in the
  original bug report.");

  script_tag(name:"affected", value:"XWiki version 7.2-milestone-2 prior to 16.4.7, 16.5.0-rc-1
  prior to 16.10.3 and 17.0.0-rc-1 prior to 17.0.0.");

  script_tag(name:"solution", value:"Update to version 16.4.7, 16.10.3, 17.0.0 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-jp4x-w9cj-97q7");
...
if( version_in_range_exclusive( version:version, test_version_lo:"7.2-milestone-2", test_version_up:"16.4.7" ) ) {
