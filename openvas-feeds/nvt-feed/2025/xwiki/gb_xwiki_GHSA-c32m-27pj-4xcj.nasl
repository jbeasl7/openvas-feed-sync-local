...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124856");
  ...
  script_cve_id("CVE-2025-49582");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 15.9-rc-1 < 16.4.7, 16.5.0-rc-1 < 16.10.3, 17.0.0-rc-1 < 17.0.0 RCE Vulnerability (GHSA-c32m-27pj-4xcj)");
  ...
  script_tag(name:"insight", value:"When editing content that contains 'dangerous' macros like
  malicious script macros that were authored by a user with fewer rights.");

  script_tag(name:"affected", value:"XWiki version 15.9-rc-1 prior to 16.4.7, 16.5.0-rc-1 prior
  ...
  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-c32m-27pj-4xcj");
...
if( version_in_range_exclusive( version:version, test_version_lo:"15.9-rc-1", test_version_up:"16.4.7" ) ) {
