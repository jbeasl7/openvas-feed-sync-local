...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124823");
  ...
  script_tag(name:"severity_date", value:"2025-04-30 15:50:37 +0000 (Wed, 30 Apr 2025)");

  script_cve_id("CVE-2025-32969");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 1.8 < 15.10.16, 16.0.0 < 16.4.6, 16.5.0 < 16.10.1 SQLi Vulnerability (GHSA-f69v-xrj8-rhxf)");
  ...
  script_tag(name:"insight", value:"Depending on the used database backend, the attacker may be
  able to not only obtain confidential information such as password hashes from the database, but
  also execute UPDATE/INSERT/DELETE queries.");

  script_tag(name:"affected", value:"XWiki version 1.8 prior to 15.10.16, 16.0.0 prior to
  16.4.6 and 16.5.0 prior to 16.10.1.");

  script_tag(name:"solution", value:"Update to version 15.10.16, 16.4.6, 16.10.1 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-f69v-xrj8-rhxf");
...
if( version_in_range_exclusive( version:version, test_version_lo:"1.8", test_version_up:"15.10.16" ) ) {
