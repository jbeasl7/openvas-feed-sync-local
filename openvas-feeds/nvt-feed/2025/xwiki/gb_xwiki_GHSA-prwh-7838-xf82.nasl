...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124868");
  ...
  script_cve_id("CVE-2024-56158");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 1.0 < 15.10.16, 16.0.0-rc-1 < 16.4.7, 16.5.0-rc-1 < 16.10.2 SQLi Vulnerability (GHSA-prwh-7838-xf82)");
  ...
  script_tag(name:"insight", value:"It's possible to execute any SQL query in Oracle by using the
  function like DBMS_XMLGEN or DBMS_XMLQUERY.");

  script_tag(name:"affected", value:"XWiki version 1.0 prior to 15.10.16, 16.0.0-rc-1 prior
  ...
  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-prwh-7838-xf82");
...
if( version_in_range_exclusive( version:version, test_version_lo:"1.0", test_version_up:"15.10.16" ) ) {
