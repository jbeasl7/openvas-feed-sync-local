...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124851");
  ...
  script_cve_id("CVE-2025-49583", "CVE-2025-49585");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki < 15.10.16, 16.0.0-rc-1 < 16.4.7, 16.5.0-rc-1 < 16.10.2 Multiple Vulnerabilities");
  ...
  - CVE-2025-49583: No warning when granting
  XWiki.Notifications.Code.NotificationEmailRendererClass admin right

  - CVE-2025-49585: No required right warnings for XClass definitions");

  script_tag(name:"affected", value:"XWiki versions prior to 15.10.16, 16.0.0-rc-1 prior to 16.4.7
  and 16.5.0-rc-1 prior to 16.10.2.");

  script_tag(name:"solution", value:"Update to version 15.10.16, 16.4.7, 16.10.2 or later.");

  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-ff6v-w58f-v97w");
  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-59w6-r9hm-439h");
...
if( version_is_less( version: version, test_version: "15.10.16" )) {
