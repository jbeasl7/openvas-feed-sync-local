...
if (description)
{
  ...
  script_cve_id("CVE-2024-11235", "CVE-2025-1217", "CVE-2025-1219", "CVE-2025-1734",
  ...
  script_name("PHP 8.3.x < 8.3.19, 8.4.x < 8.4.5 Multiple Vulnerabilities - Windows");
  ...
  script_tag(name:"affected", value:"PHP version 8.3.x prior to 8.3.19 and 8.4.x prior to 8.4.5.");

  script_tag(name:"solution", value:"Update to version 8.3.19, 8.4.5 or later.");

  script_xref(name:"URL", value:"https://www.php.net/ChangeLog-8.php#8.3.19");
  script_xref(name:"URL", value:"https://www.php.net/ChangeLog-8.php#8.4.5");
...
if (version_in_range_exclusive(version: version, test_version_lo: "8.3", test_version_up: "8.3.19")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.3.19", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range_exclusive(version: version, test_version_lo: "8.4", test_version_up: "8.4.5")) {
