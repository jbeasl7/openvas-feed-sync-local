...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836170");
  ...
  script_name("LibreOffice Improper Verification of Cryptographic Signature Vulnerability (Apr 2025) - Mac OS X");
  ...
  25.x before 25.2.2 on Mac OS X.");
