...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836064");
  ...
  script_name("LibreOffice Improper Certificate Validation Vulnerability (Mar 2025) - Mac OS X");
