...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836572");
  ...
  script_name("Libre Office Arbitrary Code Execution vulnerability (Aug 2025) - Mac OS X");
  ...
  7.3.x before 7.3.1 on Mac OS X.");
