...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834980");
  ...
  script_name("LibreOffice Arbitrary Script Execution Vulnerability (Mar 2025) - Mac OS X");
  ...
  25.2 before 25.2.1 on Mac OS X.");
