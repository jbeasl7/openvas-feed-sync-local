...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836192");
  ...
  script_name("LibreOffice Improper Validation of Array Index vulnerability (May 2025) - Mac OS X");
