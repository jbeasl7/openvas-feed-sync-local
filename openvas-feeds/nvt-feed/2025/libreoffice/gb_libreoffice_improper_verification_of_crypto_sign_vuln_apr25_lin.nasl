...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836169");
  ...
  script_name("LibreOffice Improper Verification of Cryptographic Signature Vulnerability (Apr 2025) - Linux");
