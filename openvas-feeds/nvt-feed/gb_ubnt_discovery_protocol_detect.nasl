...
if (description)
{
  ...
  script_name("UBNT Discovery Protocol Detection (UDP)");
  ...
  script_tag(name:"summary", value:"UDP based detections of services supporting the UBNT (Ubiquiti
  Networks) discovery protocol.");
...
# nb:
# - Store link between this and e.g. gb_ubnt_discovery_protocol_dos_vuln.nasl
