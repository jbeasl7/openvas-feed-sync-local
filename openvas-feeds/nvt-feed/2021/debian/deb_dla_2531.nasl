...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2531-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2531-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python-bottle");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-bottle' package(s) announced via the DLA-2531-1 advisory.");
