...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.853771");
  ...
  script_tag(name:"creation_date", value:"2021-04-23 03:01:13 +0000 (Fri, 23 Apr 2021)");
  script_name("openSUSE: Security Advisory for jhead (openSUSE-SU-2021:0594-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2021:0594-1");
  ...
  package(s) announced via the openSUSE-SU-2021:0594-1 advisory.");
...
if(release == "openSUSELeap15.2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jhead", rpm:"jhead~3.00~lp152.7.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"jhead-debuginfo", rpm:"jhead-debuginfo~3.00~lp152.7.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"jhead-debugsource", rpm:"jhead-debugsource~3.00~lp152.7.3.1", rls:"openSUSELeap15.2"))) {
    report += res;
  }
