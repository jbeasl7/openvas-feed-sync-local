...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.13.14+dfsg-0ubuntu0.21.04.3", rls:"UBUNTU21.04"))) {
    report += res;
  }
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.13.14+dfsg-0ubuntu0.21.10.3", rls:"UBUNTU21.10"))) {
    report += res;
  }
