...
if(description)
{
  ...
  script_name("Oracle VirtualBox Security Update (cpujul2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox versions prior to 6.1.24 on Windows.");

  script_tag(name:"solution", value:"Update to version 6.1.24 or later.");
