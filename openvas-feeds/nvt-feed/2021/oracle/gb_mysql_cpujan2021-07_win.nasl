...
if (description)
{
  ...
  script_name("Oracle MySQL Server 8.0 <= 8.0.21 Security Update (cpujan2021) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server versions 8.0 through 8.0.21.");
