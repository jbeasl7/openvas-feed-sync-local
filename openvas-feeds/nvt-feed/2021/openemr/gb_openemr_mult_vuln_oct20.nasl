...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-01 17:44:00 +0000 (Tue, 01 Jun 2021)");
  ...
  - CVE-2020-36243: Command injection

  - No CVE: Persistent XSS

  - No CVE: Insecure API permissions

  - No CVE: SQL injection");
