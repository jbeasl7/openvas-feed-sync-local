...
if(description)
{
  ...
  script_name("Microsoft Windows Defender Multiple Vulnerabilities (Jun 2021)");
...
if(version_is_less(version:mpe_version, test_version:"1.1.18200.3")) {
  report = report_fixed_ver(installed_version:mpe_version, fixed_version:"1.1.18200.3 or higher");
