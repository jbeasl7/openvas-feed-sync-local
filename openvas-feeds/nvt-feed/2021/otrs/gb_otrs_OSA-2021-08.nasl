...
if (description)
{
  ...
  script_tag(name:"insight", value:"Agents are able to see linked FAQ articles without permissions
  (defined in FAQ Category).");

  script_tag(name:"affected", value:"OTRS versions 7.0.x prior to 7.0.24.");
