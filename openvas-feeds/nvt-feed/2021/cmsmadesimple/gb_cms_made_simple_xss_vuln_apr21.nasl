...
if(description)
{
  ...
  script_name("CMS Made Simple <= 2.2.16 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The vulnerability is exploitable via the '/admin/addbookmark.php'
  script through the 'Site Admin > My Preferences > Title' field.");
  ...
  script_tag(name:"affected", value:"CMS Made Simple through version 2.2.16.");
