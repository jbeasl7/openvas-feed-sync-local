...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-23 22:14:00 +0000 (Tue, 23 Mar 2021)");

  script_cve_id("CVE-2021-27889", "CVE-2021-27890", "CVE-2021-27946", "CVE-2021-27947",
                "CVE-2021-27948", "CVE-2021-27949");
  ...
  sensitive information, inject arbitrary HTML or JavaScript into the site or even execute arbitrary
  code on the target machine.");

  script_tag(name:"affected", value:"MyBB through version 1.8.25.");

  script_tag(name:"solution", value:"Update to version 1.8.26 or later.");
