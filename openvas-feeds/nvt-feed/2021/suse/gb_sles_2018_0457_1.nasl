...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.0457.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:0457-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:0457-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180457-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1021669");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1065641");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003735.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'quagga' package(s) announced via the SUSE-SU-2018:0457-1 advisory.");
...
- The telnet 'vty' CLI of the Quagga daemon is no longer enabled by default,
 ...
 [bsc#1021669]");
  ...
  script_tag(name:"affected", value:"'quagga' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
...
if(release == "SLES11.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"quagga", rpm:"quagga~0.99.15~0.30.3.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"quagga", rpm:"quagga~0.99.15~0.30.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
