...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212803-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177780");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177781");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177782");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177783");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009312.html");
...
- CVE-2020-25653: UNIX domain socket peer PID retrieved via `SO_PEERCRED` is subject to race condition (bsc#1177783)");
  ...
  script_tag(name:"affected", value:"'spice-vdagent' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
