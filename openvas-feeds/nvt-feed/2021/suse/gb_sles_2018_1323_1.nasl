...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181323-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1081056");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1083463");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1084137");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1085124");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086825");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087922");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1090194");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-May/004059.html");
...
if(release == "SLES11.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl-openssl1", rpm:"curl-openssl1~7.37.0~70.27.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libcurl4-openssl1-32bit", rpm:"libcurl4-openssl1-32bit~7.37.0~70.27.1", rls:"SLES11.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libcurl4-openssl1", rpm:"libcurl4-openssl1~7.37.0~70.27.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
