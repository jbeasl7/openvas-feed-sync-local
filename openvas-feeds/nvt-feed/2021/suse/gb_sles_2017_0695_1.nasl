...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170695-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1025950");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1025951");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/974092");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-March/002694.html");
...
- Remove sysvinit script, not used under systemd. (bsc#974092)");
  ...
  script_tag(name:"affected", value:"'dbus-1' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
