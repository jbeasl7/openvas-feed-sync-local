...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-02-27 14:41:48 +0000 (Mon, 27 Feb 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170286-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1017902");
...
- CVE-2016-10109: This use-after-free and double-free issue allowed local attacker to cause a Denial of Service and possible privilege escalation (bsc#1017902).");
  ...
  script_tag(name:"affected", value:"'pcsc-lite' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
