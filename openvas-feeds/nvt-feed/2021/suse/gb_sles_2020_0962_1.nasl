...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200962-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1166484");
...
- CVE-2020-1760: Fixed XSS due to RGW GetObject header-splitting (bsc#1166484).");
  ...
  script_tag(name:"affected", value:"'ceph' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
