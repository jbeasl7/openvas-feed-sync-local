...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-12 13:48:13 +0000 (Thu, 12 Dec 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192935-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1153666");
...
- CVE-2019-14857: Fixed an open redirect issue that exists in URLs with trailing slashes (bsc#1153666).");
  ...
  script_tag(name:"affected", value:"'apache2-mod_auth_openidc' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
