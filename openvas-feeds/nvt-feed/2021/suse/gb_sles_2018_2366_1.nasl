...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182366-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004445.html");
...
- CVE-2018-5814: Multiple race condition errors when handling probe, disconnect, and ... [Please see the references for more information on the vulnerabilities]");
