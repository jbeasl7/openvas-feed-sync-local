...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2015-04-16 18:27:52 +0000 (Thu, 16 Apr 2015)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150343-1.html");
  script_xref(name:"URL", value:"http://www.ibm.com/developerworks/java/jdk/alerts/#IBM_Security_Update_November_2014");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/861782");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-February/001240.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'IBM Java' package(s) announced via the SUSE-SU-2015:0343-1 advisory.");
 ...
 * ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'IBM Java' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
