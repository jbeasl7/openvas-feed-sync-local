...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180074-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1051042");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1053188");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1063675");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1070905");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1071319");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1073231");
...
- A bug that would lose the syscall error code value in case of crashes has
 been fixed. [bsc#1063675]");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
