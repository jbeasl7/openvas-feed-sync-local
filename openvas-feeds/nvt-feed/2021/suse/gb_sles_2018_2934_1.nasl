...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182934-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102062");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102068");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102073");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-September/004622.html");
...
- CVE-2018-14598: A malicious server could have sent a reply in which the first
 ...
 on, leading to DoS (segmentation fault) (bsc#1102073)");
  ...
  script_tag(name:"affected", value:"'xorg-x11-libX11' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
