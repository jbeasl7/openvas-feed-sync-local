...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:0290-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:0290-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150290-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/897874");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/898439");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/912002");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-February/001225.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5' package(s) announced via the SUSE-SU-2015:0290-2 advisory.");
...
CVE-2014-5351: The kadm5_randkey_principal_3 function in lib/kadm5/srv/svr_principal.c in kadmind in MIT Kerberos 5 (aka krb5)
sent old keys in a response to a -randkey -keepold request, which allowed remote authenticated users to forge tickets by leveraging administrative access.
...
- Work around replay cache creation race, (bnc#898439).");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
