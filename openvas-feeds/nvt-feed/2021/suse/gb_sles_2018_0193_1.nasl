...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-10-05 14:36:23 +0000 (Thu, 05 Oct 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180193-1.html");
...
- CVE-2017-7544: Fixed out-of-bounds heap read vulnerability in
 ...
 denial-of-service or possibly information disclosure (bsc#1059893)");
  ...
  script_tag(name:"affected", value:"'libexif' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
