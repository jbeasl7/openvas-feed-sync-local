...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:1275-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:1275-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201275-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1056134");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087813");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1154118");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1154844");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1157804");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158021");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158642");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1161586");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162227");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1164009");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1164846");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1165111");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1165311");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1170847");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-May/006817.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2020:1275-1 advisory.");
...
- CVE-2019-5108: Fixed a denial-of-service vulnerability ... [Please see the references for more information on the vulnerabilities]");
