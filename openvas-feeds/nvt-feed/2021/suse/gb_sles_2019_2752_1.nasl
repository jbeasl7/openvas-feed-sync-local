...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192752-1.html");
...
- CVE-2019-16167: Fixed a memory corruption due to an integer overflow. (bsc#1150114)");
  ...
  script_tag(name:"affected", value:"'sysstat' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
