...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201584-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172461");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172506");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgnutls30-32bit", rpm:"libgnutls30-32bit~3.6.7~6.29.1", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgnutls30-hmac-32bit", rpm:"libgnutls30-hmac-32bit~3.6.7~6.29.1", rls:"SLES15.0"))) {
    report += res;
  }
