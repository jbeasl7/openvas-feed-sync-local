...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:1602-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:1602-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201602-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/006928.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2020:1602-1 advisory.");
...
- CVE-2019-9455: Fixed a pointer leak due to a WARN_ON statement in a video driver. This could lead to local information disclosure ... [Please see the references for more information on the vulnerabilities]");
