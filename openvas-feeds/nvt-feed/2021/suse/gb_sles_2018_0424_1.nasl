...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-27 17:52:37 +0000 (Thu, 27 Jul 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180424-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1047443");
...
- CVE-2016-10396: The racoon daemon contained a remotely exploitable
 ...
 (bsc#1047443).");
  ...
  script_tag(name:"affected", value:"'ipsec-tools' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
