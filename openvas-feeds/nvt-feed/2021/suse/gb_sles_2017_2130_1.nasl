...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172130-1.html");
...
- A bug in the HTTP Chunked Encoding code has been fixed that could have been
 ...
 server code running libsoup (bsc#1052916, CVE-2017-2885).");
  ...
  script_tag(name:"affected", value:"'libsoup' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
