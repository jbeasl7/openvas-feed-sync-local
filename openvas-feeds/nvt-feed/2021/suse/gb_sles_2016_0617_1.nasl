...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160617-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/952871");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/958501");
...
- CVE-2016-0799 (bnc#968374)
 ...
 data. Therefore applications that print this data could have ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
