...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172237-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1048278");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1048339");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1048352");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1048387");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1048790");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1052577");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1054017");
...
The CTDB resource agent was also fixed to not fail when the database is empty.");
  ...
  script_tag(name:"affected", value:"'samba and resource-agents' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
