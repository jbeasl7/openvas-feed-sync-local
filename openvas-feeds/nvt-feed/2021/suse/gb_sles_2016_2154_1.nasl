...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162154-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/979208");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/985860");
...
- CVE-2016-4463: Apache Xerces-C XML Parser crashed on malformed DTD (bnc#985860).");
  ...
  script_tag(name:"affected", value:"'xerces-c' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
