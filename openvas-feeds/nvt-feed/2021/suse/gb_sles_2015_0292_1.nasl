...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150292-1.html");
...
- Directory traversal vulnerability in the read_long_names function (CVE-2014-9447).");
  ...
  script_tag(name:"affected", value:"'elfutils' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
