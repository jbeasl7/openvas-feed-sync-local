...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211455-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1152930");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174477");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183239");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184815");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-April/008716.html");
...
- Fixed a bug where it was no longer possible to mount CIFS filesystem after
 the last maintenance update. (bsc#1184815)");
  ...
  script_tag(name:"affected", value:"'cifs-utils' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
