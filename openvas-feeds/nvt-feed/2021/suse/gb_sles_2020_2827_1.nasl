...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-23 17:56:43 +0000 (Wed, 23 Sep 2020)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20202827-1.html");
...
- CVE-2019-20919: Fixed a NULL profile dereference in dbi_profile (bsc#1176764).");
  ...
  script_tag(name:"affected", value:"'perl-DBI' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
