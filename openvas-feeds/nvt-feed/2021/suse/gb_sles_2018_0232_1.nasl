...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180232-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1069257");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003636.html");
...
- CVE-2017-16899: Fix array index error in the fig2dev program (bsc#1069257).");
  ...
  script_tag(name:"affected", value:"'transfig' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
