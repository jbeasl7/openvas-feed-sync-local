...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:2631-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:2631-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182631-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1079869");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1091427");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1094325");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1094725");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1100112");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the SUSE-SU-2018:2631-1 advisory.");
...
- bsc#959329: libxl: don't set hasManagedSave when performing save");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
