...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151013-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/900611");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/915323");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/927558");
...
- CVE-2015-1863: P2P SSID processing vulnerability");
  ...
  script_tag(name:"affected", value:"'wpa_supplicant' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
