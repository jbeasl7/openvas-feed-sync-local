...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172747-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061041");
...
- CVE-2017-14867: Git used unsafe Perl scripts to support subcommands such as
 ...
 metacharacters in a module name (bsc#1061041).");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
