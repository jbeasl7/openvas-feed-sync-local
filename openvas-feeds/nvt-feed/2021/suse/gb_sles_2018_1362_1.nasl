...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:1362-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:1362-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181362-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1079405");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu' package(s) announced via the SUSE-SU-2018:1362-1 advisory.");
