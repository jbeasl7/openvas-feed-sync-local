...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163044-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002448.html");
...
- CVE-2016-7909: The pcnet_rdra_addr function in ... [Please see the references for more information on the vulnerabilities]");
