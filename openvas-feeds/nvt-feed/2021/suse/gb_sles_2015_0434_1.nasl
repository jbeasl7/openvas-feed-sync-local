...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150434-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/911662");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-March/001269.html");
 ...
 * CVE-2014-9447
 <[link moved to references]>");
  ...
  script_tag(name:"affected", value:"'elfutils' package(s) on SUSE Linux Enterprise Desktop 11-SP3, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
