...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192053-2.html");
...
- CVE-2018-1000802: Fixed a command injection in the shutil module (bsc#1109663).");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE Linux Enterprise Server 12-SP3.");
