...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183066-1.html");
  script_xref(name:"URL", value:"http://qpdf.sourceforge.net/files/qpdf-manual.html#ref.release-notes");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040311");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040312");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040313");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050577");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050578");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050579");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050581");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1055960");
 ...
 * [link moved to references]");
  ...
  script_tag(name:"affected", value:"'qpdf' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
