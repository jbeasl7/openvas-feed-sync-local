...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2016:2002-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2016:2002-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162002-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel Live Patch 10 for SLE 12' package(s) announced via the SUSE-SU-2016:2002-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the Linux Kernel 3.12.51-52_34 fixes several issues.
...
- CVE-2013-7446: Use-after-free vulnerability in net/unix/af_unix.c in the Linux kernel allowed local users to bypass intended AF_UNIX socket permissions or cause a denial of service (panic) via crafted epoll_ctl calls (bsc#973570, bsc#955837).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 10 for SLE 12' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_51-52_34-default", rpm:"kgraft-patch-3_12_51-52_34-default~5~2.2", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_51-52_34-xen", rpm:"kgraft-patch-3_12_51-52_34-xen~5~2.2", rls:"SLES12.0"))) {
    report += res;
  }
