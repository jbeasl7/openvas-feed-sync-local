...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203842-1.html");
...
- CVE-2018-10893: Fixed a buffer overflow on image lz checks (bsc#1101295)");
  ...
  script_tag(name:"affected", value:"'spice' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
