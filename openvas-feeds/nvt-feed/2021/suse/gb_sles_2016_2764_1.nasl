...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162764-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/994399");
...
- bsc#982331: libmount: ignore redundant slashes");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
