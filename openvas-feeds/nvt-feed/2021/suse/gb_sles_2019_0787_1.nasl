...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20190787-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128189");
  ...
  script_tag(name:"insight", value:"This update for openssl-1_1 (OpenSSL Security Advisory [6 March 2019]) fixes the following issues:
