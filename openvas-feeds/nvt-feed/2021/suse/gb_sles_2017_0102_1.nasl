...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170102-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1013311");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/911886");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935573");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/951404");
...
- Fixed failing rebuild of freeradius-server package (bsc#951404)");
  ...
  script_tag(name:"affected", value:"'freeradius-server' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
