...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212353-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183155");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183851");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183852");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184450");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187973");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187976");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187977");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-July/009145.html");
...
- reduce memory footprint of test-worker-stdio (bsc#1183155)");
  ...
  script_tag(name:"affected", value:"'nodejs10' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
