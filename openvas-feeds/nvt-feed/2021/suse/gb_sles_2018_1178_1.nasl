...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-04-18 15:08:07 +0000 (Wed, 18 Apr 2018)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181178-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1047356");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1058635");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1074117");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086773");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086782");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087027");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087033");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087037");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087039");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087825");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1089781");
...
- CVE-2017-10928: a heap-based buffer over-read in the GetNextToken function in token.c
 ...
 GetUserSpaceCoordinateValue function in coders/svg.c. [bsc#1047356]");
  ...
  script_tag(name:"affected", value:"'ImageMagick' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
