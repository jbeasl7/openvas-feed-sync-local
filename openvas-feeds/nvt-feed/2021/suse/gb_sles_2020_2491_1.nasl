...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20202491-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173100");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173659");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173661");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173663");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173664");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173665");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173666");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173867");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173869");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173942");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173963");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 28 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2020:2491-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the Linux Kernel 4.4.180-94_103 fixes several issues.
...
- CVE-2019-14895: Fixed a heap-based buffer overflow in the Marvell WiFi driver (bsc#1173100).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 28 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
