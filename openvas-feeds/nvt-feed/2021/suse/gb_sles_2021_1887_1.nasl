...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211887-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/008955.html");
...
- CVE-2021-23133: Fixed a race ... [Please see the references for more information on the vulnerabilities]");
