...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2019:0789-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2019:0789-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20190789-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1125401");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128525");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-March/005258.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the SUSE-SU-2019:0789-1 advisory.");
...
- Added a missing check for ENABLE_CMAC.");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
