...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192444-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146569");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146571");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146572");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146702");
...
- Fixed segfault when libtiff encounters corrupted TIFF (upstream issue #295).");
  ...
  script_tag(name:"affected", value:"'djvulibre' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
