...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181832-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1044970");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1082060");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1082290");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1082484");
...
- Enabled --enable-fastvalidate option in configure (bsc#1044970)");
  ...
  script_tag(name:"affected", value:"'unixODBC' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
