...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:1874-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:1874-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151874-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/951376");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-November/001659.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1_7_0-openjdk' package(s) announced via the SUSE-SU-2015:1874-2 advisory.");
...
- CVE-2015-4734: Unspecified vulnerability in Oracle Java SE 6u101, 7u85 and 8u60, and Java SE ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'java-1_7_0-openjdk' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
