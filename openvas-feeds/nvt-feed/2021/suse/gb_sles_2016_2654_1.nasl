...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162654-1.html");
...
- CVE-2016-8602: Insufficient parameter check in .sethalftone5 (bsc#1004237).");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
