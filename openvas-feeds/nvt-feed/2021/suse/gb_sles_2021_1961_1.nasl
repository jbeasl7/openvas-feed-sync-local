...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211961-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171164");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171569");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183436");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185916");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185918");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185919");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185921");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185923");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/009003.html");
...
- Change pinger and basic_pam_auth helper to use standard permissions. pinger uses cap_net_raw=ep instead (bsc#1171569)");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
