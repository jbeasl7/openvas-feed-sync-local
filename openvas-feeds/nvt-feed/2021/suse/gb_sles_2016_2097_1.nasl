...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162097-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/899486");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/976920");
...
- Missing Requires(post) on coreutils as it is using rm(1). (bsc#976920)");
  ...
  script_tag(name:"affected", value:"'ctags' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
