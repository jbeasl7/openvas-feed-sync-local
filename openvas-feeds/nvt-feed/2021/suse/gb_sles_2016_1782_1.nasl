...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161782-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-July/002151.html");
...
- CVE-2014-9846: Added ... [Please see the references for more information on the vulnerabilities]");
