...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150866-1.html");
...
* possible buffer read overflow (CVE-2014-9709)");
  ...
  script_tag(name:"affected", value:"'gd' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
