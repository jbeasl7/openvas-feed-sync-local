...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-03-04 16:52:27 +0000 (Fri, 04 Mar 2016)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160779-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/965803");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/965807");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/965810");
...
- CVE-2016-1526: The TtfUtil:LocaLookup function in TtfUtil.cpp in
 ...
 smart font.");
  ...
  script_tag(name:"affected", value:"'graphite2' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
