...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162355-1.html");
...
- Use stdin, not tmp files for passwords (bsc#986971, CVE-2016-5746)");
  ...
  script_tag(name:"affected", value:"'libstorage' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
