...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:0438-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:0438-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180438-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027519");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1035442");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1051729");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061081");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1067317");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen' package(s) announced via the SUSE-SU-2018:0438-1 advisory.");
...
- bsc#1067317: pass cache=writeback<pipe>unsafe<pipe>directsync to qemu depending on the
 libxl disk settings
