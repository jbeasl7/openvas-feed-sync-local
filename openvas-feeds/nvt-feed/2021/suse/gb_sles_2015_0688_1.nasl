...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-13 16:26:23 +0000 (Mon, 13 Mar 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150688-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/866728");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/871792");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/879607");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/883026");
  ...
  script_tag(name:"insight", value:"CVE-2014-1344, CVE-2014-1384, CVE-2014-1385,
...
- Bugs fixed: boo#871792, boo#879607 and boo#879607.");
  ...
  script_tag(name:"affected", value:"'webkitgtk' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
