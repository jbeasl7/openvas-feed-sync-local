...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-08 20:32:20 +0000 (Tue, 08 Jan 2019)");

  script_name("SUSE: Security Advisory (SUSE-SU-2020:0317-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:0317-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200317-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1118597");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1130246");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libqt5-qtbase' package(s) announced via the SUSE-SU-2020:0317-1 advisory.");
...
- CVE-2018-19872: Fixed an issue which could allow a division by zero leading to crash (bsc#1130246).");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
