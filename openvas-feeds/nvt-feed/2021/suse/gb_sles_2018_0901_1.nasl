...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:0901-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:0901-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180901-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1057406");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086774");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086775");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086813");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086814");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086817");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086820");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-April/003877.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the SUSE-SU-2018:0901-1 advisory.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apache2", rpm:"apache2~2.4.10~14.31.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache2-doc", rpm:"apache2-doc~2.4.10~14.31.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache2-example-pages", rpm:"apache2-example-pages~2.4.10~14.31.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache2-prefork", rpm:"apache2-prefork~2.4.10~14.31.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache2-utils", rpm:"apache2-utils~2.4.10~14.31.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"apache2-worker", rpm:"apache2-worker~2.4.10~14.31.1", rls:"SLES12.0"))) {
    report += res;
  }
