...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161366-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/970550");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/970989");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-May/002075.html");
...
- Fix file permissions (bsc#970550)");
  ...
  script_tag(name:"affected", value:"'SUSE Manager Client Tools' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
