...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200810-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1118987");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162197");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162200");
...
- CVE-2020-1931: Fixed an issue with rule configuration (.cf) files which
 can be configured to run system commands with warnings (bsc#1162200).");
  ...
  script_tag(name:"affected", value:"'spamassassin' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
