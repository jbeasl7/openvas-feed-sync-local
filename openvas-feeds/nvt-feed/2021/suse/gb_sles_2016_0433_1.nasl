...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2016.0433.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2016:0433-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2016:0433-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160433-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/960402");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/963937");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-February/001874.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1_7_0-ibm' package(s) announced via the SUSE-SU-2016:0433-1 advisory.");
...
- bsc#960402: resolve package conflicts in devel package");
  ...
  script_tag(name:"affected", value:"'java-1_7_0-ibm' package(s) on SUSE Linux Enterprise Server 11-SP2.");
...
if(release == "SLES11.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-ibm", rpm:"java-1_7_0-ibm~1.7.0_sr9.30~45.1", rls:"SLES11.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-ibm-alsa", rpm:"java-1_7_0-ibm-alsa~1.7.0_sr9.30~45.1", rls:"SLES11.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-ibm-devel", rpm:"java-1_7_0-ibm-devel~1.7.0_sr9.30~45.1", rls:"SLES11.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-ibm-jdbc", rpm:"java-1_7_0-ibm-jdbc~1.7.0_sr9.30~45.1", rls:"SLES11.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-ibm-plugin", rpm:"java-1_7_0-ibm-plugin~1.7.0_sr9.30~45.1", rls:"SLES11.0SP2"))) {
    report += res;
  }
