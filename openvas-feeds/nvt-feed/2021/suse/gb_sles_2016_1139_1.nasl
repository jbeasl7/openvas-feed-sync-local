...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161139-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/974847");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-April/002024.html");
...
- CVE-2016-3977: Heap buffer overflow in gif2rgb (bsc#974847).");
  ...
  script_tag(name:"affected", value:"'giflib' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
