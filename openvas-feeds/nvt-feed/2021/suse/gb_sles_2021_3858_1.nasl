...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213858-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192580");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009808.html");
...
- CVE-2020-23903: Fixed zero division error in read_samples (bsc#1192580).");
  ...
  script_tag(name:"affected", value:"'speex' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
