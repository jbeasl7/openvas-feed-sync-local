...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2015.2110.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:2110-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:2110-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20152110-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/897031");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-November/001701.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'LibVNCServer' package(s) announced via the SUSE-SU-2015:2110-1 advisory.");
...
if(release == "SLES11.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"LibVNCServer", rpm:"LibVNCServer~0.9.1~156.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"LibVNCServer", rpm:"LibVNCServer~0.9.1~156.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
