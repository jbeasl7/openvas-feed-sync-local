...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2016:1995-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2016:1995-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161995-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/979078");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel Live Patch 9 for SLE 12' package(s) announced via the SUSE-SU-2016:1995-1 advisory.");
...
- CVE-2013-7446: Use-after-free vulnerability in net/unix/af_unix.c in the Linux kernel allowed local users to bypass intended AF_UNIX socket permissions or cause a denial of service (panic) via crafted epoll_ctl calls (bsc#973570, bsc#955837).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 9 for SLE 12' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_51-52_31-default", rpm:"kgraft-patch-3_12_51-52_31-default~5~2.2", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_51-52_31-xen", rpm:"kgraft-patch-3_12_51-52_31-xen~5~2.2", rls:"SLES12.0"))) {
    report += res;
  }
