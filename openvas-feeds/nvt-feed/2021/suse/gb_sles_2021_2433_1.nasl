...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-25 16:28:20 +0000 (Fri, 25 Jun 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212433-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187597");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187687");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-July/009189.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 34 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2021:2433-1 advisory.");
...
- CVE-2021-0512: Fixed a possible out-of-bounds write which could lead to local escalation of privilege with no additional execution privileges needed. (bsc#1187597)");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 34 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
