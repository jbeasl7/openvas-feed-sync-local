...
if(description)
{
  ...
  script_cve_id("CVE-2017-18204", "CVE-2020-0404", "CVE-2020-0427", "CVE-2020-0431", "CVE-2020-0432", "CVE-2020-12352", "CVE-2020-14351", "CVE-2020-14381", "CVE-2020-14390", "CVE-2020-25212", "CVE-2020-25284", "CVE-2020-25643", "CVE-2020-25645", "CVE-2020-25656", "CVE-2020-25705", "CVE-2020-26088", "CVE-2020-8694");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:3501-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:3501-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203501-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176382");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2020:3501-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The SUSE Linux Enterprise 12 SP2 kernel was updated to receive various security and bug fixes.
...
- btrfs: btrfs_test_opt and friends should take a ... [Please see the references for more information on the vulnerabilities]");
