...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200860-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040973");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1110282");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142678");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142683");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1153577");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1161901");
...
- CVE-2017-9239: Fixed a segmentation fault in TiffImageEntry::doWriteImage function (bsc#1040973).");
  ...
  script_tag(name:"affected", value:"'exiv2' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
