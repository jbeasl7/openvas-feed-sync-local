...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-10-27 14:18:11 +0000 (Fri, 27 Oct 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180373-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062937");
...
- CVE-2017-15232: Fix NULL pointer dereference in jdpostct.c and jquant1.c (bsc#1062937).");
  ...
  script_tag(name:"affected", value:"'libjpeg-turbo' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
