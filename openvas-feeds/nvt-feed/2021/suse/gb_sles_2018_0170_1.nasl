...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180170-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1046848");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003615.html");
...
- CVE-2017-10672: A use-after-free allowed remote attackers to potentially
 ...
 (bsc#1046848)");
  ...
  script_tag(name:"affected", value:"'perl-XML-LibXML' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
