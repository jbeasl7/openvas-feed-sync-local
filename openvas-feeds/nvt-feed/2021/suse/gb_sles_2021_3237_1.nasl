...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-09-24 12:52:45 +0000 (Fri, 24 Sep 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213237-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190522");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009512.html");
...
- CVE-2021-41054: Fixed buffer overflow caused by combination of data, OACK, and other options (bsc#1190522).");
  ...
  script_tag(name:"affected", value:"'atftp' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
