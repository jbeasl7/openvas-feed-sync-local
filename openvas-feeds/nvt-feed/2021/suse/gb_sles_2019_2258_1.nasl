...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192258-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/990204");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-September/005866.html");
...
- Fixed that passwords are not echoed on terminal when asking for them (bsc#990204).");
  ...
  script_tag(name:"affected", value:"'NetworkManager' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
