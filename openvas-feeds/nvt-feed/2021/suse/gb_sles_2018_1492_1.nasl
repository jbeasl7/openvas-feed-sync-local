...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181492-1.html");
 ...
 All versions before 18.02.1 are vulnerable. (bsc#1089638).");
  ...
  script_tag(name:"affected", value:"'dpdk-thunderxdpdk' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
