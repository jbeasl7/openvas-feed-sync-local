...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210931-1.html");
...
- CVE-2020-11080: HTTP/2 Large Settings Frame DoS (bsc#1181358)");
  ...
  script_tag(name:"affected", value:"'nghttp2' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libnghttp2-14-32bit", rpm:"libnghttp2-14-32bit~1.40.0~3.11.1", rls:"SLES15.0"))) {
    report += res;
  }
