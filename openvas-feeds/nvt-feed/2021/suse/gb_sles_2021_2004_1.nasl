...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212004-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1145740");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180530");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182703");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186922");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186923");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186924");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187017");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187174");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/009030.html");
...
- Fixed for an issue when 'gensslcert' does not set CA:True. (bsc#1180530)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
