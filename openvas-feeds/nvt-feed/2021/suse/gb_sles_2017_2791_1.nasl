...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000112", "CVE-2017-15274", "CVE-2017-8890", "CVE-2017-9242");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:2791-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:2791-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172791-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel Live Patch 21 for SLE 12 SP1' package(s) announced via the SUSE-SU-2017:2791-1 advisory.");
