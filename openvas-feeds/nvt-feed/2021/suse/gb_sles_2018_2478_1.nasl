...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:2478-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:2478-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182478-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1092874");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1094932");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096748");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1099162");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ceph' package(s) announced via the SUSE-SU-2018:2478-1 advisory.");
