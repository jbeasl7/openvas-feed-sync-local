...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-08-21 12:36:04 +0000 (Tue, 21 Aug 2018)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171250-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1032248");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/854512");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/932386");
...
More changes are available in the changelog. Please make sure you read README.SUSE after installing this update.");
  ...
  script_tag(name:"affected", value:"'dovecot22' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
