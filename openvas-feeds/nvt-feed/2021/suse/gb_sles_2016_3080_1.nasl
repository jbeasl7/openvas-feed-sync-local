...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163080-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1012964");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/992549");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002464.html");
...
- font warning messages would flood console, now using fontconfig configuration from
 firefox-fontconfig instead of the system one (bsc#1000751)");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, mozilla-nss' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
