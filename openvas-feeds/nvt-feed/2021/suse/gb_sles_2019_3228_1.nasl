...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20193228-1.html");
...
- Fixed boot up hang revealed by int3 self test (bsc#1157770).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 27 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
