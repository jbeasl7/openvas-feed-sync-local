...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172936-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1043176");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1043808");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1057966");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1059369");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062069");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062942");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1063122");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/997358");
...
- Fixed wrong ... [Please see the references for more information on the vulnerabilities]");
