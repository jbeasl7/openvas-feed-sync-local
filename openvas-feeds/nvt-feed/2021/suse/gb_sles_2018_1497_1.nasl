...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181497-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1093086");
...
- CVE-2017-18266: Fix an argument injection when BROWSER contains %s (bsc#1093086).");
  ...
  script_tag(name:"affected", value:"'xdg-utils' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
