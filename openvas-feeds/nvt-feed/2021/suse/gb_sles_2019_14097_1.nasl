...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-08 15:37:00 +0000 (Thu, 08 Aug 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-201914097-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1131595");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1138301");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-June/005597.html");
...
- CVE-2019-3886: Fixed a information exposure which allowed to retrieve the guest
 hostname under readonly mode (bsc#1131595).");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Linux Enterprise Server 11-SP4.");
