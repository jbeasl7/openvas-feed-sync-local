...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-09-04 16:42:42 +0000 (Wed, 04 Sep 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200843-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1133817");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149110");
...
- CVE-2019-15026: Fixed a stack-based buffer over-read (bsc#1149110).");
  ...
  script_tag(name:"affected", value:"'memcached' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
