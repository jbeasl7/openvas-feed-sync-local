...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:2850-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:2850-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172850-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062563");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062620");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-October/003354.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the SUSE-SU-2017:2850-1 advisory.");
