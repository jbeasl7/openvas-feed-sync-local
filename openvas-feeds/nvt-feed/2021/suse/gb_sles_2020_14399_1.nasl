...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-202014399-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172265");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/006979.html");
...
- CVE-2017-9108: Fixed an issue which could have led to denial of service (bsc#1172265).");
  ...
  script_tag(name:"affected", value:"'adns' package(s) on SUSE Linux Enterprise Server 11-SP4.");
