...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162872-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1000396");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1001299");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1001759");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/898812");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/898884");
...
- CVE-2014-6278: Code execution after original 6271 fix (bsc#898884)");
  ...
  script_tag(name:"affected", value:"'bash' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
