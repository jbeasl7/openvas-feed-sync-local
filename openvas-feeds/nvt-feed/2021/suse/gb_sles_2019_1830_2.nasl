...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2019:1830-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2019:1830-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191830-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1139959");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140122");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-August/005822.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2' package(s) announced via the SUSE-SU-2019:1830-2 advisory.");
...
- Added explicit requires between libglib2 and libgio2 (bsc#1140122).");
  ...
  script_tag(name:"affected", value:"'glib2' package(s) on SUSE Linux Enterprise Server 12-SP3.");
