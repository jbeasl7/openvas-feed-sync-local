...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160677-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/949669");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/949670");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/966435");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/966436");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-March/001914.html");
...
- Relax dependency on libpq to major version.");
  ...
  script_tag(name:"affected", value:"'postgresql94' package(s) on SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
