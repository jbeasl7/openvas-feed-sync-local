...
if(description)
{
  ...
  script_cve_id("CVE-2012-5611", "CVE-2012-5612", "CVE-2012-5613", "CVE-2012-5615", "CVE-2015-4000");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151177-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/792444");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/934789");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-July/001491.html");
  ...
  script_tag(name:"insight", value:"A stack-based buffer overflow in MySQL has been fixed that could have
 ...
 * CVE-2012-5611
 <[link moved to references]>");
  ...
  script_tag(name:"affected", value:"'MySQL' package(s) on SUSE Linux Enterprise Server 11-SP1, SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Server for SAP Applications 11-SP2.");
...
if(release == "SLES11.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmysqlclient15-32bit", rpm:"libmysqlclient15-32bit~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmysqlclient15", rpm:"libmysqlclient15~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmysqlclient_r15", rpm:"libmysqlclient_r15~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mysql", rpm:"mysql~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mysql-Max", rpm:"mysql-Max~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mysql-client", rpm:"mysql-client~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mysql-tools", rpm:"mysql-tools~5.0.96~0.6.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
