...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211241-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1112499");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1119115");
...
- ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
