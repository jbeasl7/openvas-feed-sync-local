...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211901-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177158");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181686");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/008963.html");
...
- CVE-2020-14355: Fixed multiple buffer overflow vulnerabilities in QUIC decoding code (bsc#1177158)");
  ...
  script_tag(name:"affected", value:"'spice' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
