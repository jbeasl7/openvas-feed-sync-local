...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20152166-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/955131");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-December/001705.html");
...
- Version update to 6.0-16.15 bsc#955131:
 ...
 CVE-2015-0204");
  ...
  script_tag(name:"affected", value:"'java-1_6_0-ibm' package(s) on SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
