...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212817-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102408");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1138715");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1138746");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176389");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177120");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182421");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182422");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009334.html");
  ...
  script_tag(name:"insight", value:"# python-urllib3:
...
- CVE-2020-26137: urllib3 before 1.25.9 allows CRLF injection if the attacker controls the HTTP request method, as demonstrated
 by inserting CR and LF control characters in the first argument of putrequest() (bsc#1177120)");
  ...
  script_tag(name:"affected", value:"'aws-cli, python-boto3, python-botocore, python-service_identity, python-trustme, python-urllib3' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
