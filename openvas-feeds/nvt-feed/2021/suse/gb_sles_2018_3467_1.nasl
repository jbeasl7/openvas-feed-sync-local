...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183467-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1104076");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1111056");
...
- Fix sibling sync errors (bsc#1111056):
 ...
 `synchronize` API calls");
  ...
  script_tag(name:"affected", value:"'smt' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
