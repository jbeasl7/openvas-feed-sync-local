...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20193266-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009254");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1071853");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1093536");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1094462");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107874");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1109845");
...
- Handle unexpected informational message from SonicWall. (bsc#1009254)");
  ...
  script_tag(name:"affected", value:"'strongswan' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
