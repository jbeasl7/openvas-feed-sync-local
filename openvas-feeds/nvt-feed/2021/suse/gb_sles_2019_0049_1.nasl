...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20190049-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101644");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101645");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101651");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101656");
...
- CVE-2018-3639 cpu speculative store bypass mitigation");
  ...
  script_tag(name:"affected", value:"'java-1_7_0-openjdk' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
