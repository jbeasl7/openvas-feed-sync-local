...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150789-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/927591");
...
* CVE-2015-0492: JavaFX: unauthenticated remote attackers could execute arbitrary code via multiple protocols.");
  ...
  script_tag(name:"affected", value:"'java-1_7_0-openjdk, java-1_7_0-openjdk-bootstrap' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
