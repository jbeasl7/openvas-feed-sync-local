...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213019-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189521");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009433.html");
...
- CVE-2021-3712: This is an update for the incomplete fix for CVE-2021-3712.
 Read buffer overruns processing ASN.1 strings (bsc#1189521).");
  ...
  script_tag(name:"affected", value:"'compat-openssl098' package(s) on SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
