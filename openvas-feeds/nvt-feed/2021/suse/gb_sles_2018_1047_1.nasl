...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181047-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086936");
  ...
  script_tag(name:"insight", value:"- CVE-2018-1106: Drop the polkit rule which could allow users in wheel group to install
 packages without root password (bsc#1086936).");

  script_tag(name:"affected", value:"'PackageKit' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
