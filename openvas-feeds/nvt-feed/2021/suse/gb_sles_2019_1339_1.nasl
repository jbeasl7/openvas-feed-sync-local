...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191339-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1013708");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1013712");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1013893");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1015171");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1015173");
...
- CVE-2016-9918: Fixed an out-of-bounds stack read in packet_hexdump(),
 ...
 in a crash of the hcidump tool (bsc#1015173)");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
