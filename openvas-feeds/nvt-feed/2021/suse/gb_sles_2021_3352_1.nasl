...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213352-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188638");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188639");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188848");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188849");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190223");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-October/009576.html");
...
- CVE-2021-39191: open redirect issue in target_link_uri parameter (bsc#1190223)");
  ...
  script_tag(name:"affected", value:"'apache2-mod_auth_openidc' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
