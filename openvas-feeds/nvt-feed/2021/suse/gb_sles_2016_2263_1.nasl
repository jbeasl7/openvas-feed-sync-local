...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162263-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/928292");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/932894");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/967082");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/984906");
...
- Missing lock prototype to the debugger. (bsc#932894)");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
