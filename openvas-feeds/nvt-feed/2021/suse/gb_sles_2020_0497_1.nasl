...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200497-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1068664");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159208");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159623");
...
- CVE-2017-1000158: Fix an integer overflow in thePyString_DecodeEscape function in stringobject.c, resulting in heap-based bufferoverflow (bsc#1068664).");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
...
if(release == "SLES12.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-devel", rpm:"python3-devel~3.4.10~25.39.2", rls:"SLES12.0SP1"))) {
    report += res;
  }
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-devel", rpm:"python3-devel~3.4.10~25.39.2", rls:"SLES12.0SP2"))) {
    report += res;
  }
...
if(release == "SLES12.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-devel", rpm:"python3-devel~3.4.10~25.39.2", rls:"SLES12.0SP3"))) {
    report += res;
  }
