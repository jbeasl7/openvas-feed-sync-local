...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1175-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1175-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211175-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2021:1175-1 advisory.");
...
- CVE-2021-26930: Fixed an improper ... [Please see the references for more information on the vulnerabilities]");
