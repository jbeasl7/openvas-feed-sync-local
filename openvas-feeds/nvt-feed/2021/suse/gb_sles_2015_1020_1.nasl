...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151020-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/901448");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/909472");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/913376");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/916203");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/917977");
...
- Fix autofs.service so that multiple options passed through sysconfig AUTOFS_OPTIONS work correctly (bnc#909472)");
  ...
  script_tag(name:"affected", value:"'autofs' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
