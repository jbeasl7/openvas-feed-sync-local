...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212916-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184739");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009383.html");
...
- CVE-2021-3497: Matroskademux: Fix extraction of multichannel WavPack (bsc#1184739).");
  ...
  script_tag(name:"affected", value:"'gstreamer-plugins-good' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
