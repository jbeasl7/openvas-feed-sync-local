...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151475-1.html");
...
- CVE-2014-9655: Access of uninitialized memory (bnc#916927).");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
