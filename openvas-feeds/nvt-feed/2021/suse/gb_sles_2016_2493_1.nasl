...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162493-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1001951");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/939342");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-October/002322.html");
...
- An integer overflow in the gs_heap_alloc_bytes function used to allow remote
 ...
 Postscript files. (CVE-2015-3228, boo#939342)");
  ...
  script_tag(name:"affected", value:"'ghostscript-library' package(s) on SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
