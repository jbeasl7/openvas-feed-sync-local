...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200419-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1138743");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1154849");
...
- Removed cache size limit (bsc#1138743).");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
