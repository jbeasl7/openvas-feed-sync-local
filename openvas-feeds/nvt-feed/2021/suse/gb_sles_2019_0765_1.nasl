...
if(description)
{
  ...
  script_cve_id("CVE-2017-5753", "CVE-2018-20669", "CVE-2019-2024", "CVE-2019-3459", "CVE-2019-3460", "CVE-2019-3819", "CVE-2019-6974", "CVE-2019-7221", "CVE-2019-7222", "CVE-2019-7308", "CVE-2019-8912", "CVE-2019-8980", "CVE-2019-9213");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2019:0765-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2019:0765-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20190765-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/824948");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/828192");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/925178");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-March/005240.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2019:0765-1 advisory.");
...
- acpi/device_sysfs: Avoid OF modalias creation for ... [Please see the references for more information on the vulnerabilities]");
