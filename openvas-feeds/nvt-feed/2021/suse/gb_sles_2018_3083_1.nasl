...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183083-1.html");
...
- CVE-2018-10902: Protect against concurrent access to prevent double realloc
 ...
 (bnc#1105322).
- CVE-2018-10879: A local user could have ... [Please see the references for more information on the vulnerabilities]");
