...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182403-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/936807");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004462.html");
...
- bsc#936807: On entering a 70 character subject line in mutt, a tab is added to the text after 67 characters.");
  ...
  script_tag(name:"affected", value:"'mutt' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
