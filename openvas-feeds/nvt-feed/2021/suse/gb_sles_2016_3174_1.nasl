...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2016.3174.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2016:3174-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2016:3174-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163174-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1000106");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1000893");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1003030");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1003032");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1004016");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1005004");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1005005");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1007157");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1007160");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009100");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009103");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009104");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009107");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009109");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009111");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1011652");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002492.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen' package(s) announced via the SUSE-SU-2016:3174-1 advisory.");
...
- CVE-2016-9383: The x86 64-bit bit test instruction emulation was broken, allowing a guest to modify arbitrary memory leading to arbitrary code execution (bsc#1009107)
...
- ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'xen' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.4.4_10~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-doc-html", rpm:"xen-doc-html~4.4.4_10~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-default", rpm:"xen-kmp-default~4.4.4_10_3.0.101_88~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-pae", rpm:"xen-kmp-pae~4.4.4_10_3.0.101_88~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-libs-32bit", rpm:"xen-libs-32bit~4.4.4_10~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-libs", rpm:"xen-libs~4.4.4_10~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools", rpm:"xen-tools~4.4.4_10~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools-domU", rpm:"xen-tools-domU~4.4.4_10~43.5", rls:"SLES11.0SP4"))) {
    report += res;
  }
