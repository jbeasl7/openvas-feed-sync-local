...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162891-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1007501");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1007766");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1008043");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/948973");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/966755");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-November/002413.html");
...
- When the SSSD plugin was used and a local user ran sudo, an e-mail used to be
 ...
 [bsc#1008043]");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
