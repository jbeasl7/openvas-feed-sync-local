...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182204-1.html");
...
- bsc#1086036: translation-update-upstream commented out for Leap");
  ...
  script_tag(name:"affected", value:"'libsoup' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
