...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:2233-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:2233-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20202233-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1161883");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171946");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172052");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174458");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-August/007266.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the SUSE-SU-2020:2233-1 advisory.");
