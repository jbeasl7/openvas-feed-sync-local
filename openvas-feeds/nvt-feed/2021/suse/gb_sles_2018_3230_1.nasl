...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:3230-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:3230-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183230-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen' package(s) announced via the SUSE-SU-2018:3230-1 advisory.");
