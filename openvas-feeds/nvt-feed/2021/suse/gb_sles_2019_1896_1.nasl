...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191896-1.html");
...
- Fixed a bug related to the fix for CVE-2016-9318 which allowed xsltproc to access
 ...
 incomplete xml catalog file (bsc#1010675, bsc#1126613 and bsc#1110146).");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
