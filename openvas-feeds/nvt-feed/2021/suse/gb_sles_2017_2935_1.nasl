...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172935-1.html");
...
- CVE-2017-15638: Fixed security issue with too open implicit portmapper rules
 ...
 the 'rpc' matching was used.");
  ...
  script_tag(name:"affected", value:"'SuSEfirewall2' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
