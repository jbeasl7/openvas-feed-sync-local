...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20152065-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935338");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935993");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/947518");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/952491");
...
- Always install dm-snaphost module if lvm dracut module is needed, even if dm-snapshot is not loaded on the host yet (bsc#947518).");
  ...
  script_tag(name:"affected", value:"'dracut' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
