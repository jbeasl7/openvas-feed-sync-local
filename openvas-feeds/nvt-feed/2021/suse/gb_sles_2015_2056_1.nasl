...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20152056-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/926826");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-November/001687.html");
...
- Fixed an integer overflow, an out of bounds read and a stack overflow issues (bsc#926826).");
  ...
  script_tag(name:"affected", value:"'libksba' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libksba8", rpm:"libksba8~1.3.0~18.1", rls:"SLES12.0"))) {
    report += res;
  }
