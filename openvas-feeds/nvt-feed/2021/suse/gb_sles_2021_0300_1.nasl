...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210300-1.html");
...
- CVE-2020-27827: Fixed a memory leak when parsing lldp packets (bsc#1181345)");
  ...
  script_tag(name:"affected", value:"'openvswitch' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
