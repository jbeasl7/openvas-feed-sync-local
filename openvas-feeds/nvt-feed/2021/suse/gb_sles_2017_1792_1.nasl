...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-17 15:08:30 +0000 (Mon, 17 Jul 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171792-1.html");
...
- CVE-2017-1000381: A NAPTR parser out of bounds access was fixed that could lead to crashes. (bsc#1044946)");
  ...
  script_tag(name:"affected", value:"'libcares2' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
