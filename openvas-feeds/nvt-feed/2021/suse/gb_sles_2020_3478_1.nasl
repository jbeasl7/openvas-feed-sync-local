...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-11-30 00:51:26 +0000 (Mon, 30 Nov 2020)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203478-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178882");
 ...
 * For further details see [link moved to references]");
  ...
  script_tag(name:"affected", value:"'c-ares' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
