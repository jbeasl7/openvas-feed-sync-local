...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163083-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1003870");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009108");
...
- CVE-2016-8667: The rc4030_write function in hw/dma/rc4030.c in allowed local guest OS administrators to cause a denial of service (divide-by-zero error and QEMU process crash) via a large interval timer reload value ... [Please see the references for more information on the vulnerabilities]");
