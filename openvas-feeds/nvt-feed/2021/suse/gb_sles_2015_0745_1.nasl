...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150745-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/918995");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/918998");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/919464");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/922705");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/922706");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-April/001355.html");
  ...
  script_tag(name:"insight", value:"The Virtualization service XEN was updated to fix various bugs and security
issues.
...
if(release == "SLES11.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.0.3_21548_18~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-doc-html", rpm:"xen-doc-html~4.0.3_21548_18~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-doc-pdf", rpm:"xen-doc-pdf~4.0.3_21548_18~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-default", rpm:"xen-kmp-default~4.0.3_21548_18_2.6.32.54_0.55.TDC~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-trace", rpm:"xen-kmp-trace~4.0.3_21548_18_2.6.32.54_0.55.TDC~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-libs", rpm:"xen-libs~4.0.3_21548_18~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools", rpm:"xen-tools~4.0.3_21548_18~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools-domU", rpm:"xen-tools-domU~4.0.3_21548_18~0.17.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
