...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-31 18:57:27 +0000 (Mon, 31 Jul 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183487-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/958347");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004799.html");
...
- CVE-2015-7543: Insecure creation of temporary directories allowed local users
 to hijack the IPC by pre-creating the temporary directory (bsc#958347).");
  ...
  script_tag(name:"affected", value:"'kdelibs3' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
