...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-04-28 19:34:39 +0000 (Thu, 28 Apr 2016)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161140-1.html");
...
- CVE-2016-3977: Heap buffer overflow in gif2rgb (bsc#974847).");
  ...
  script_tag(name:"affected", value:"'giflib' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
