...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172356-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1051684");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1051685");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1053259");
...
The changelog for this release is here:
 [link moved to references]");
  ...
  script_tag(name:"affected", value:"'postgresql96' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
