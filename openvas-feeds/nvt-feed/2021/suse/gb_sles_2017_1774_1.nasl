...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171774-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1016503");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1016504");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1017081");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1017084");
...
- CVE-2017-7980: An out-of-bounds r/w access issues in the Cirrus CLGD 54xx VGA Emulator support allowed privileged user inside guest to use this flaw to crash the Qemu process resulting in DoS or potentially execute arbitrary code on a host with privileges of Qemu ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'qemu' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-s390", rpm:"qemu-s390~2.6.2~41.16.1", rls:"SLES12.0SP2"))) {
    report += res;
  }
