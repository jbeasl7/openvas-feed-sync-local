...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:2975-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:2975-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182975-1.html");
  script_xref(name:"URL", value:"http://www.ghostscript.com/doc/9.25/News.htm");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1106171");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1106172");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1106173");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1106195");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107410");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107411");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107412");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107413");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107420");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107421");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107422");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107423");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107426");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107581");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1108027");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1109105");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-October/004632.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript' package(s) announced via the SUSE-SU-2018:2975-1 advisory.");
...
- CVE-2018-16585: The .setdistillerkeys PostScript command was accepted even
 ...
 startup phase). This lead to memory ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~9.25~23.13.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ghostscript-x11", rpm:"ghostscript-x11~9.25~23.13.1", rls:"SLES12.0"))) {
    report += res;
  }
