...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-01-14 20:09:33 +0000 (Thu, 14 Jan 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210408-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 31 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2021:0408-1 advisory.");
...
- CVE-2020-29661: Fixed a locking issue in the tty subsystem that allowed a use-after-free attack against TIOCSPGRP (bsc#1179877).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 31 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
