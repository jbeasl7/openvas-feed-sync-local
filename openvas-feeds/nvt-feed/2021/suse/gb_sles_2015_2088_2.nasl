...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20152088-2.html");
...
- bsc#854151: Restrict the SSL cipher suite.");
  ...
  script_tag(name:"affected", value:"'LibVNCServer' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
