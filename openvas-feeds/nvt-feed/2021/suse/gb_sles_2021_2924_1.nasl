...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212924-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027519");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179246");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180491");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180846");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182654");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183243");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185682");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186428");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186429");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186433");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186434");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187369");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187376");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187378");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188050");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189373");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189376");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189378");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189380");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189381");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189882");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009390.html");
...
- Fixed an issue with xencommons, where file format expecations by fillup did not align (bsc#1185682)
