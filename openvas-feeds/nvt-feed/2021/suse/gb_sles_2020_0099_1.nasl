...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200099-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1133925");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140277");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150003");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150247");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150250");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158809");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/SLE-6430");
...
- Update to 1.1.1d (bsc#1133925, jsc#SLE-6430).");
  ...
  script_tag(name:"affected", value:"'openssl-1_1' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
