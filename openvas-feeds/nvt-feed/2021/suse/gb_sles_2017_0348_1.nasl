...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170348-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1005879");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1018832");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/999646");
...
- GnuTLS could have suffered from 100% CPU load DoS attacks by using SSL alert
 packets during the handshake (bsc#1005879, CVE-2016-8610)");
  ...
  script_tag(name:"affected", value:"'gnutls' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
