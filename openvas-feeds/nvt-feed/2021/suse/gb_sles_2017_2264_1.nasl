...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172264-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009745");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1036659");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1046417");
...
- Do not crash when the repository URL is not defined. (bsc#1043218)");
  ...
  script_tag(name:"affected", value:"'libzypp' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
