...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171094-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1024929");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1026833");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1031045");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1031875");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1031877");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1031879");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1031886");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1032272");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1032880");
...
- Crop operations to visible screen. (bnc#1032272)");
  ...
  script_tag(name:"affected", value:"'tigervnc' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
