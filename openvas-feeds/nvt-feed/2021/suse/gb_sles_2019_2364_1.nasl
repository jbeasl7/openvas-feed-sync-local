...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192364-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121567");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149961");
...
- CVE-2018-16889: Fixed missing sanitation of customer encryption keys from log output in v4 auth. (bsc#1121567)");
  ...
  script_tag(name:"affected", value:"'ceph' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
