...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160455-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/964845");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/964847");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/964849");
...
- CVE-2015-8805: Fixed miscomputation bugs in secp-256r1 modulo functions. (bsc#964849)");
  ...
  script_tag(name:"affected", value:"'libnettle' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
