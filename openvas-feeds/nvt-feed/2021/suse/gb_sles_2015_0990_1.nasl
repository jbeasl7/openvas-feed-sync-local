...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150990-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/927556");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/927607");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/927608");
...
* CVE-2015-3153: curl could have sent sensitive HTTP headers also to proxies");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
