...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:0432-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:0432-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210432-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176262");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180686");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181126");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-February/008310.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python' package(s) announced via the SUSE-SU-2021:0432-1 advisory.");
...
- Provide the newest setuptools wheel (bsc#1176262,
 CVE-2019-20916) in their correct form (bsc#1180686).");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
