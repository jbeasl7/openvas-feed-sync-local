...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151364-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/915402");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/918346");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/932539");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-August/001530.html");
 ...
 * CVE-2015-1572
 <[link moved to references]>");
  ...
  script_tag(name:"affected", value:"'e2fsprogs' package(s) on SUSE Linux Enterprise Desktop 11-SP3, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
