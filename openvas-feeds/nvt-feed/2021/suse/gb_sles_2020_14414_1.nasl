...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-202014414-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/007052.html");
...
- CVE-2020-14154: Fixed an issue where Mutt was ignoring an expired certificate and was proceeding with a connection (bsc#1172906, bsc#1172935).");
  ...
  script_tag(name:"affected", value:"'mutt' package(s) on SUSE Linux Enterprise Server 11-SP4.");
