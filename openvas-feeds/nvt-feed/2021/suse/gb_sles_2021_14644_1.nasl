...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-202114644-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181944");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-February/008377.html");
...
- CVE-2020-28493: Improve the speed of the 'urlize' filter by reducing regex
 ...
 domain part, and only word characters in the TLD. (bsc#1181944)");
  ...
  script_tag(name:"affected", value:"'python-Jinja2' package(s) on SUSE Linux Enterprise Server 11, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4.");
