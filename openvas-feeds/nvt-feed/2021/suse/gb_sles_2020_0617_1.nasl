...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200617-1.html");
...
- picmg discover messages are now DEBUG and not INFO messages (bsc#1085469).");
  ...
  script_tag(name:"affected", value:"'ipmitool' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
