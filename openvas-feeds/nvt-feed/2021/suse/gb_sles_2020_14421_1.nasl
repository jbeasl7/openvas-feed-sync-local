...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2020.14421.1");
  ...
  script_tag(name:"severity_date", value:"2020-07-15 18:27:25 +0000 (Wed, 15 Jul 2020)");

  script_name("SUSE: Security Advisory (SUSE-SU-2020:14421-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:14421-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-202014421-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1166238");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1167231");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173576");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-July/007099.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2020:14421-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for MozillaFirefox to version 78.0.1 ESR fixes the following issues:
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~78.0.1~78.80.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-branding-SLED", rpm:"MozillaFirefox-branding-SLED~78~21.12.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~78.0.1~78.80.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-other", rpm:"MozillaFirefox-translations-other~78.0.1~78.80.2", rls:"SLES11.0SP4"))) {
    report += res;
  }
