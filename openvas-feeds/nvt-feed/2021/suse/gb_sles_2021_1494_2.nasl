...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211494-2.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184521");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/008929.html");
...
- CVE-2021-3468: avoid infinite loop by handling HUP event in client_work (bsc#1184521).");
  ...
  script_tag(name:"affected", value:"'avahi' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
