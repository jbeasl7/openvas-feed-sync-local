...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181659-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/915323");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004183.html");
...
- CVE-2015-0210: Fix broken certificate subject check (bsc#915323.)");
  ...
  script_tag(name:"affected", value:"'wpa_supplicant' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
