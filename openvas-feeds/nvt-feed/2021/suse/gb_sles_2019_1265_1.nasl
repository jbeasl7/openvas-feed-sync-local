...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191265-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1080919");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121563");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1125352");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1126056");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1127557");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128657");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1130230");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1132348");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1132400");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1132721");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/955942");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/SLE-5933");
...
- Do not automatically online memory on s390x (bsc#1127557)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
