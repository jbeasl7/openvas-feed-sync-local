...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212211-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187105");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/009108.html");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libdbus-1-3-32bit", rpm:"libdbus-1-3-32bit~1.12.2~3.11.1", rls:"SLES15.0"))) {
    report += res;
  }
