...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210452-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180815");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181096");
...
- CVE-2020-15437: Fixed a null pointer dereference which could have allowed ... [Please see the references for more information on the vulnerabilities]");
