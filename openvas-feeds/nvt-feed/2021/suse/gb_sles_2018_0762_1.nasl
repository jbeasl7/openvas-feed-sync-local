...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180762-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1074572");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1076114");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1076775");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1076813");
...
- CVE-2018-5683: ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'qemu' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
