...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162896-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1007188");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/913058");
...
- Fix Amanda integration issue (bsc#913058)");
  ...
  script_tag(name:"affected", value:"'tar' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
