...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2017.2872.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:2872-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:2872-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172872-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1060445");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061005");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-October/003363.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox, mozilla-nss' package(s) announced via the SUSE-SU-2017:2872-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libfreebl3-x86", rpm:"libfreebl3-x86~3.29.5~47.6.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsoftokn3-x86", rpm:"libsoftokn3-x86~3.29.5~47.6.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozilla-nss-x86", rpm:"mozilla-nss-x86~3.29.5~47.6.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
