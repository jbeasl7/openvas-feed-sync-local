...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191866-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1131055");
...
and
 [link moved to references](markt)");
  ...
  script_tag(name:"affected", value:"'tomcat' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
