...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-16 18:52:04 +0000 (Mon, 16 Dec 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212320-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1157818");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158812");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158958");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158959");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158960");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159491");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159715");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159847");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159850");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160309");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160438");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160439");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1164719");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172091");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172115");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172234");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172236");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172240");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173641");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/928700");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/928701");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-July/009137.html");
...
- CVE-2020-13435: Malicious SQL statements could have crashed the process that is running SQLite (bsc#1172091)");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsqlite3-0-32bit", rpm:"libsqlite3-0-32bit~3.36.0~3.12.1", rls:"SLES15.0"))) {
    report += res;
  }
