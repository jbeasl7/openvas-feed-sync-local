...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171248-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1026102");
...
This update also contains java-1_8_0-openjdk that needed to be rebuilt against the new mozilla-nss version.");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, java-1_8_0-openjdk, mozilla-nspr, mozilla-nss' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
