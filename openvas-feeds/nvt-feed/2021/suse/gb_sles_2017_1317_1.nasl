...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171317-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010845");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1035371");
...
Additionally, the popd build-in now ensures that the normalized stack offset is within bounds before trying to free that stack entry. This fixes a segmentation fault.");
  ...
  script_tag(name:"affected", value:"'bash' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
