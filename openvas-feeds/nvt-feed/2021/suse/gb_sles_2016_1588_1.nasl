...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-05-09 17:21:13 +0000 (Mon, 09 May 2016)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161588-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/979005");
...
- Fix a heap-based buffer overflow (CVE-2016-1541, bsc#979005)");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
