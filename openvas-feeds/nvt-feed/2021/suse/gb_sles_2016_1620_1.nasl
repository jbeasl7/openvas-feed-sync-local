...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161620-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/961935");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/963806");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/963810");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/970287");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/970295");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/980904");
...
- CVE-2016-0650: Unspecified vulnerability allowed local users to affect availability via ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'mariadb' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
