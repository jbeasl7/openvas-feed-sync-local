...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181498-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1086069");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1092807");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004112.html");
...
if(release == "SLES11.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc43-fortran-32bit", rpm:"gcc43-fortran-32bit~4.3.4_20091019~37.9.1", rls:"SLES11.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gcc43-fortran", rpm:"gcc43-fortran~4.3.4_20091019~37.9.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
