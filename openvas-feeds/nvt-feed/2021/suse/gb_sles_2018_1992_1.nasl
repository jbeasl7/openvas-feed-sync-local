...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-07-23 13:53:51 +0000 (Mon, 23 Jul 2018)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181992-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096718");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-July/004286.html");
...
- CVE-2018-12015: The Archive::Tar module allowed remote attackers to bypass a
 ...
 (bsc#1096718).");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
