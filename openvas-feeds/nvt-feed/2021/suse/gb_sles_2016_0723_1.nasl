...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160723-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/961964");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/967026");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-March/001923.html");
 ...
 * Weakness in diffie-hellman secret key generation lead to much shorter DH groups
 then needed, which could be used to retrieve server keys.");
  ...
  script_tag(name:"affected", value:"'libssh2_org' package(s) on SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
