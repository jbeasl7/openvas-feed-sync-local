...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162507-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/966467");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/993507");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/994136");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-October/002325.html");
...
- CVE-2016-6836: VMWARE VMXNET3 NIC device allowed privileged user inside the guest to leak information. It occurred while processing transmit(tx) queue, when it reaches the end of packet (bsc#994761)
