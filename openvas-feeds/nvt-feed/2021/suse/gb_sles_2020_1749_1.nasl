...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201749-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1160249");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1165680");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1169952");
...
- Fix random connection freezes (bsc#1169952, bsc#1160249, bsc#1165680):");
  ...
  script_tag(name:"affected", value:"'tigervnc' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
