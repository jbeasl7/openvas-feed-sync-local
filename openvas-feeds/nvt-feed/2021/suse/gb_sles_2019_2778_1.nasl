...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192778-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1099699");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1139487");
...
- Improved wtmp io performance (bsc#1139487).");
  ...
  script_tag(name:"affected", value:"'accountsservice' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
