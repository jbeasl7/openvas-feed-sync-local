...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172526-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1011348");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1022062");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1028744");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1039513");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1044016");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050947");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/988274");
...
- Fixed DR#1288. [bnc#1011348]");
  ...
  script_tag(name:"affected", value:"'gcc48' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
