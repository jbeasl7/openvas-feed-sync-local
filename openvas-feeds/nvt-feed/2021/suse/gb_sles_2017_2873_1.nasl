...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:2873-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:2873-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172873-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1059777");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061076");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061077");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen' package(s) announced via the SUSE-SU-2017:2873-1 advisory.");
