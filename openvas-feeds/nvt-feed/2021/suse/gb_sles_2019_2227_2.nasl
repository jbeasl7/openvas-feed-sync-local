...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2019:2227-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2019:2227-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192227-2.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the SUSE-SU-2019:2227-2 advisory.");
...
- Added support for overriding max threads per process limit (bsc#1133719)");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Linux Enterprise Server 12-SP3.");
