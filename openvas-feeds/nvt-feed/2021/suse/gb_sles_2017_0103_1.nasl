...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170103-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/828003");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/967671");
...
- Add rrdtool-cached sub-package to SLE 12-SP1. (bsc#967671)");
  ...
  script_tag(name:"affected", value:"'rrdtool' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
