...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163196-1.html");
...
- Simplify ntpd's search for its own executable to prevent AppArmor
 warnings (bsc#956365).");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
