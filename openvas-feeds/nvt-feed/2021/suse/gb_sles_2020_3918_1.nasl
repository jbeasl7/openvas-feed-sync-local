...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203918-1.html");
  script_xref(name:"URL", value:"https://blog.clamav.net/2018/12/clamav-01010-has-been-released.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1118459");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1119353");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1144504");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149458");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1157763");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171981");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174250");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174255");
...
* CVE-2019-12900: An out of bounds write in the NSIS bzip2
 (bsc#1149458)
* CVE-2019-12625: Introduce a configurable ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'clamav' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
