...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182388-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1099497");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004456.html");
...
- CVE-2018-10860: Prevent directory traversal caused by not properly sanitizing
 ...
 arbitrary files in the context of the perl interpreter (bsc#1099497).");
  ...
  script_tag(name:"affected", value:"'perl-Archive-Zip' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
