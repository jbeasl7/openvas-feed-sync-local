...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2020.3036.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:3036-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:3036-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203036-1/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rmt-server' package(s) announced via the SUSE-SU-2020:3036-1 advisory.");
...
Updated rails and puma dependencies for security fixes.");
  ...
  script_tag(name:"affected", value:"'rmt-server' package(s) on SUSE Linux Enterprise Module for Public Cloud 15-SP2, SUSE Linux Enterprise Module for Server Applications 15-SP2.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rmt-server-debuginfo", rpm:"rmt-server-debuginfo~2.6.5~3.3.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rmt-server-debugsource", rpm:"rmt-server-debugsource~2.6.5~3.3.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rmt-server-pubcloud", rpm:"rmt-server-pubcloud~2.6.5~3.3.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rmt-server", rpm:"rmt-server~2.6.5~3.3.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"rmt-server-config", rpm:"rmt-server-config~2.6.5~3.3.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
