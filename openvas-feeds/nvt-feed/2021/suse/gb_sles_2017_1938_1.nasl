...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171938-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/947731");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-July/003060.html");
...
- CVE-2015-1338: Insecurely created crash dumps could lead to a DoS or privilege escalation through
 malicious symlinks. (bsc#947731)");
  ...
  script_tag(name:"affected", value:"'apport' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
