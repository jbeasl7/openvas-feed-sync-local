...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-08 20:27:49 +0000 (Tue, 08 Jan 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20202923-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1118598");
...
- CVE-2018-19871: Fixed CPU exhaustion in QTgaFile (bsc#1118598)");
  ...
  script_tag(name:"affected", value:"'libqt5-qtimageformats' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
