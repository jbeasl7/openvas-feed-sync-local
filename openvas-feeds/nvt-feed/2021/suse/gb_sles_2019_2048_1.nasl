...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192048-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1013882");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101676");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101677");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101678");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1103342");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1136037");
...
- [links moved to references]");
  ...
  script_tag(name:"affected", value:"'mariadb' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
