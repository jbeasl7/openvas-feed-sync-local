...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212818-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174514");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009336.html");
...
- CVE-2020-14343: A vulnerability was discovered in the PyYAML library,
 ...
 constructor. This flaw is due to an incomplete fix for CVE-2020-1747.");
  ...
  script_tag(name:"affected", value:"'python-PyYAML' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
