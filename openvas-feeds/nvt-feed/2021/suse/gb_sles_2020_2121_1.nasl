...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20202121-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1152472");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1161016");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162002");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1162063");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1168081");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1169194");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171904");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172759");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-August/007219.html");
...
- CVE-2019-20810: go7007_snd_init in drivers/media/usb/go7007/snd-go7007.c in the Linux kernel did not call snd_card_free for a failure path, which causes a memory leak, aka ... [Please see the references for more information on the vulnerabilities]");
