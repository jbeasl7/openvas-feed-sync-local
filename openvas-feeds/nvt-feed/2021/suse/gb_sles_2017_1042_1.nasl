...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171042-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1015332");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027712");
...
With this release new default ciphers are active (SUSE_DEFAULT, bsc#1027712).");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
