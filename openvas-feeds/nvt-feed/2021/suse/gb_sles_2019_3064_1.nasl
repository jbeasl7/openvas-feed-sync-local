...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20193064-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1155199");
...
- CVE-2019-14866: Fixed an improper validation of the values written
 ...
 have led to unexpected TAR generation (bsc#1155199).");
  ...
  script_tag(name:"affected", value:"'cpio' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
