...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182860-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096723");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 18 for SLE 12 SP2)' package(s) announced via the SUSE-SU-2018:2860-1 advisory.");
