...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191867-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140095");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140101");
...
- CVE-2019-13117: Fixed a uninitialized read which allowed to discern whether a byte on the stack contains certain special characters (bsc#1140095).");
  ...
  script_tag(name:"affected", value:"'libxslt' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
