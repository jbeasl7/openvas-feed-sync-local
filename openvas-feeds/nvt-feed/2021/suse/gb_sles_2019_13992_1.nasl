...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-201913992-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1113038");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1113039");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-March/005252.html");
...
- CVE-2018-18585: chmd_read_headers accepted a filename that has '\0' as its first or second character (such as the '/\0' name). (bsc#1113039)");
  ...
  script_tag(name:"affected", value:"'libmspack' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
