...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-20 17:23:32 +0000 (Fri, 20 Dec 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201088-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1151585");
...
- CVE-2019-16680: Fixed a path traversal vulnerability which could have allowed
 an overwriting of a file during extraction (bsc#1151585).");
  ...
  script_tag(name:"affected", value:"'file-roller' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
