...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-202014313-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1038508");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1163026");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-March/006600.html");
...
- Added a missing patch for DDR4 support (bsc#1038508).");
  ...
  script_tag(name:"affected", value:"'ipmitool' package(s) on SUSE Linux Enterprise Server 11-SP4.");
