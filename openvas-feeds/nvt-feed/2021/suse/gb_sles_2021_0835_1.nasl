...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210835-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 37 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2021:0835-1 advisory.");
...
- CVE-2020-1749: Fixed an issue in some networking protocols in IPsec, such as VXLAN and GENEVE tunnels over IPv6 where the kernel was not correctly routing tunneled data over the encrypted link rather sending the data unencrypted (bsc#1165631).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 37 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
