...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160884-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/939342");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/963017");
...
- fix a crash in mutex handling (bsc#963017)");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
