...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151680-1.html");
...
The Mozilla NSPR library was updated to version 4.10.9, fixing various bugs.");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, mozilla-nspr' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
