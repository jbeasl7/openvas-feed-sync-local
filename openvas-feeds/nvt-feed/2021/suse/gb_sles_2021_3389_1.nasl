...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213389-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2021-October/020461.html");
...
- Fix build warnings. Also ... [Please see the references for more information on the vulnerabilities]");
