...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20161154-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-April/002029.html");
...
- CVE-2015-8558: Infinite loop in ehci_advance_state resulted in DoS ... [Please see the references for more information on the vulnerabilities]");
