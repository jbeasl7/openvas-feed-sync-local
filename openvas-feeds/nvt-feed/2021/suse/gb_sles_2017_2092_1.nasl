...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:2092-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:2092-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172092-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel Live Patch 13 for SLE 12 SP1' package(s) announced via the SUSE-SU-2017:2092-1 advisory.");
...
- CVE-2017-8890: The inet_csk_clone_lock function in net/ipv4/inet_connection_sock.c in the Linux kernel allowed attackers to cause a denial of service (double free) or possibly have unspecified other impact by leveraging use of the accept system call (bsc#1038564).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 13 for SLE 12 SP1' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
