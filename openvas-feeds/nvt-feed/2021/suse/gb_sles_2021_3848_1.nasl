...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213848-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1094840");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1114648");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1141655");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192718");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192750");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192753");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192781");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192802");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192906");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009789.html");
...
- crypto: s5p-sss - Add error ... [Please see the references for more information on the vulnerabilities]");
