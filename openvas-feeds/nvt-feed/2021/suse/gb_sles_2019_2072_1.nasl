...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2019:2072-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2019:2072-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192072-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-August/005786.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2019:2072-1 advisory.");
