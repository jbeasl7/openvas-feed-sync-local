...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20193094-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1131830");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1134550");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1154036");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1154037");
...
- Fixed ppc64le build configuration (bsc#1134550).");
  ...
  script_tag(name:"affected", value:"'ncurses' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
