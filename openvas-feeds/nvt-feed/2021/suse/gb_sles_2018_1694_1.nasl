...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181694-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1060031");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004191.html");
...
- CVE-2017-14604: Fixed a file type spoofing attack by adding a
 ...
 (bsc#1060031).");
  ...
  script_tag(name:"affected", value:"'nautilus' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
