...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213125-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1024266");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1024268");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1046782");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188292");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009456.html");
...
- Fix possible crash on connection failure (bsc#1188292).");
  ...
  script_tag(name:"affected", value:"'gtk-vnc' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
