...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201682-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172348");
...
- Fixed a bad warning in features.ph (bsc#1172348).");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-base-32bit", rpm:"perl-base-32bit~5.26.1~7.12.1", rls:"SLES15.0"))) {
    report += res;
  }
