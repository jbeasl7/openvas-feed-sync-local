...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163115-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1003002");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-December/002481.html");
 ...
 of boundary memory writes (bsc#1003002, CVE-2016-7949, CVE-2016-7950)");
  ...
  script_tag(name:"affected", value:"'xorg-x11-libXrender' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
