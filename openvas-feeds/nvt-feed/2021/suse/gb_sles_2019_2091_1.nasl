...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192091-1.html");
...
- CVE-2018-20852: Fixed an information leak where cookies could be send to the wrong server because of incorrect domain validation (bsc#1141853).");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
...
if(release == "SLES12.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-devel", rpm:"python-devel~2.7.13~28.31.1", rls:"SLES12.0SP3"))) {
    report += res;
  }
...
if(release == "SLES12.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-devel", rpm:"python-devel~2.7.13~28.31.1", rls:"SLES12.0SP4"))) {
    report += res;
  }
