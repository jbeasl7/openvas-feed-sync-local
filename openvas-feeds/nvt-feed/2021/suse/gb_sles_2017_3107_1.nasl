...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-26 17:29:20 +0000 (Mon, 26 Mar 2018)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20173107-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062722");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-November/003420.html");
...
- CVE-2017-14798: A race condition in the init script could be used by attackers able to access the postgresql account to escalate their privileges to root (bsc#1062722)");
  ...
  script_tag(name:"affected", value:"'postgresql-init' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
