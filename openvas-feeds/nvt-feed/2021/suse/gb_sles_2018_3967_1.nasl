...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:3967-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:3967-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183967-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1115929");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ncurses' package(s) announced via the SUSE-SU-2018:3967-1 advisory.");
...
- CVE-2018-19211: Fixed denial of service issue that was triggered by a NULL pointer dereference at function _nc_parse_entry (bsc#1115929).");
  ...
  script_tag(name:"affected", value:"'ncurses' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
