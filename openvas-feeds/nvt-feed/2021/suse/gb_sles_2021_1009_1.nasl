...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2021:1009-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2021:1009-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211009-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat' package(s) announced via the SUSE-SU-2021:1009-1 advisory.");
...
- CVE-2021-25329: Complete fix for CVE-2020-9484 (bsc#1182909)");
  ...
  script_tag(name:"affected", value:"'tomcat' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
