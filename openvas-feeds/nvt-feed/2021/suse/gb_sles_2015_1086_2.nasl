...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:1086-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:1086-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151086-2.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-June/001447.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'IBM Java' package(s) announced via the SUSE-SU-2015:1086-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"java-1_6_0-ibm has been updated to version 1.6.0_sr16.2 to fix 18 security
issues.
 ...
 * Unspecified vulnerability in Oracle Java SE 6u81, 7u67, and 8u20
 ...
 related to Deployment ... [Please see the references for more information on the vulnerabilities]");
