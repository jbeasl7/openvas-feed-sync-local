...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:1161-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:1161-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181161-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the SUSE-SU-2018:1161-1 advisory.");
 ...
 * CVE-2018-1302: when an HTTP/2 stream was destroyed after being handled, it
 ...
 [bsc#1086820]");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
