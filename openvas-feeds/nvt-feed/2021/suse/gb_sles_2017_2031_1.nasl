...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-05 15:43:24 +0000 (Wed, 05 Jul 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172031-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1004995");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1029102");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1029516");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1032029");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1033238");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1036873");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1037120");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1038865");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040153");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040258");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040614");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040942");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1040968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1043758");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1043900");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1045290");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1046750");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/982303");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/986216");
...
- Add minimal support for boot.d/* scripts in systemd-sysv-convert (bsc#1046750)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
