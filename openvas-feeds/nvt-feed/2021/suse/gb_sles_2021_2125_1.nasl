...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-23 17:38:45 +0000 (Tue, 23 Mar 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212125-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179930");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179931");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179932");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179933");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180102");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180232");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181598");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181599");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183353");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184110");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185128");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/009067.html");
...
libqt5-qtmultimedia and sbc are necessary dependencies. libvirt is needed to rebuild wireshark-plugin-libvirt.");
  ...
  script_tag(name:"affected", value:"'wireshark' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-libxl", rpm:"libvirt-daemon-driver-libxl~4.0.0~9.37.21", rls:"SLES15.0"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-xen", rpm:"libvirt-daemon-xen~4.0.0~9.37.21", rls:"SLES15.0"))) {
    report += res;
  }
