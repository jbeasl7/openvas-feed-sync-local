...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170338-1.html");
...
* CVE-2016-7545: nonpriv session can escape to parent [bsc#1000998]");
  ...
  script_tag(name:"affected", value:"'policycoreutils' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
