...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181425-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1054028");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1055851");
...
- Fix a GSS failure in legacy applications by not indicating deprecated GSS mechanisms in
 gss_indicate_mech() list. (bsc#1081725)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
