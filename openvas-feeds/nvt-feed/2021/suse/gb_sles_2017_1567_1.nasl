...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171567-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009470");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1037396");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1041764");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/972331");
...
- Fix an issue with transaction management that can cause server crash (bsc#972331)");
  ...
  script_tag(name:"affected", value:"'openldap2' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
