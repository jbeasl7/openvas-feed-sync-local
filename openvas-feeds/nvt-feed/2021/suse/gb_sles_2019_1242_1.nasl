...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191242-1.html");
...
- alsa: hda - add ... [Please see the references for more information on the vulnerabilities]");
