...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182978-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/910683");
...
+- Allow processing of Windows zip64 archives (Windows archivers set
 ...
 (bnc#910683)");
  ...
  script_tag(name:"affected", value:"'unzip' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
