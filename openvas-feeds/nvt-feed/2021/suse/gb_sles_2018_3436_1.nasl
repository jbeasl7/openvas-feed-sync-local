...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183436-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1104457");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1110723");
...
- Restore exit code compatibility of freshclam with versions before
 ...
 (bsc#1104457).");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
