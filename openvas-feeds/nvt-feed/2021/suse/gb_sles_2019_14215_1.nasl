...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-201914215-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120610");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1130496");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1152736");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/ECO-339");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2019-November/006107.html");
...
- CVE-2018-20482: Fixed a denial of service when the '--sparse' option mishandles file shrinkage during read access (bsc#1120610).");
  ...
  script_tag(name:"affected", value:"'tar' package(s) on SUSE Linux Enterprise Server 11-SP4.");
