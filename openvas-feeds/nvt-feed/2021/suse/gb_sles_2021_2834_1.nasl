...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-21 17:06:16 +0000 (Mon, 21 Aug 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212834-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1046882");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1054038");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187974");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009355.html");
...
- Prevent conditional jumps depending on uninitialised values (bsc#1046882)");
  ...
  script_tag(name:"affected", value:"'unrar' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
