...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163067-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1004981");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1007941");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009105");
...
- CVE-2016-8669: The serial_update_parameters function in hw/char/serial.c allowed local guest OS administrators to ... [Please see the references for more information on the vulnerabilities]");
