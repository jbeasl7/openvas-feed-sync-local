...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162226-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/937096");
 ...
 (bsc#958342)");
  ...
  script_tag(name:"affected", value:"'wget' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
