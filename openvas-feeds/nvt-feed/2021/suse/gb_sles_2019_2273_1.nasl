...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192273-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1054986");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1105607");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1122858");
...
- Fixed OS detection for multiple versions of SLE12, SLE15 and openSUSE Leap (bsc#1105607, bsc#1122858, bsc#1105607, bsc#1054986, bsc#1054986)");
  ...
  script_tag(name:"affected", value:"'libosinfo' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
