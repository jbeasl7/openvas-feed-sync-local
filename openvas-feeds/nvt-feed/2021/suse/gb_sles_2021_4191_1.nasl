...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20214191-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1152968");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174961");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009952.html");
...
- CVE-2020-15862: Make extended MIB read-only (bsc#1174961)");
  ...
  script_tag(name:"affected", value:"'net-snmp' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
