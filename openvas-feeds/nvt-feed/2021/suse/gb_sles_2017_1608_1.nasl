...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171608-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1042326");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/931932");
...
- Don't require secure memory for the fips selftests, this prevents the
 'Oops, secure memory pool already initialized' warning. (bsc#931932)");
  ...
  script_tag(name:"affected", value:"'libgcrypt' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
