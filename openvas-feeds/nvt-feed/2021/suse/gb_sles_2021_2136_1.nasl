...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212136-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186226");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/009076.html");
...
- avoid hard coding 127.0.0.1 in host ID of alive message test, let system administrator mount and unmount disks by issuing these two commands on key server.");
  ...
  script_tag(name:"affected", value:"'cryptctl' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
