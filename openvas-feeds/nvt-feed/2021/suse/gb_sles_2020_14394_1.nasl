...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2020.14394.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:14394-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:14394-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-202014394-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1154824");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1156353");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172466");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/006920.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the SUSE-SU-2020:14394-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~1.17~102.83.53.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
