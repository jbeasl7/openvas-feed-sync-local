...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200790-1.html");
...
* ffi.gc() now takes an optional third parameter, which gives an
 ...
 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'python-cffi, python-cryptography, python-xattr' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
