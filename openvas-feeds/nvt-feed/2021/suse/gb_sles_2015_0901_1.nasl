...
if(description)
{
  ...
  script_cve_id("CVE-2014-3467", "CVE-2014-3468", "CVE-2014-3469", "CVE-2015-2806");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150901-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/880735");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/880737");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/880738");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/924828");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-May/001393.html");
 ...
 * CVE-2014-3469
 <[link moved to references]>");
  ...
  script_tag(name:"affected", value:"'libtasn1' package(s) on SUSE Linux Enterprise Desktop 11-SP3, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
