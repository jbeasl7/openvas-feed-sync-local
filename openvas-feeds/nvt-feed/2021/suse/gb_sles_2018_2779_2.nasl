...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:2779-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:2779-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182779-2.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openslp' package(s) announced via the SUSE-SU-2018:2779-2 advisory.");
...
- Prevent out of bounds reads in message parsing");
  ...
  script_tag(name:"affected", value:"'openslp' package(s) on SUSE Linux Enterprise Server 12-SP2.");
