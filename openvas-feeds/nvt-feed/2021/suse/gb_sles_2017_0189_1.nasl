...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170189-1.html");
  ...
  script_tag(name:"insight", value:"* CVE-2016-9811: out of bound memory read could lead to crash [bsc#1013669].");
