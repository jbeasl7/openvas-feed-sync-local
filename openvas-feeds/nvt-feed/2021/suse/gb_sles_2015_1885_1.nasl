...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2015.1885.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:1885-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:1885-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151885-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/941676");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-November/001657.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the SUSE-SU-2015:1885-1 advisory.");
...
- only enable the port 443 for TCP protocol, not UDP. (bsc#931002)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
