...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:1605-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:1605-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201605-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-June/006929.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2020:1605-1 advisory.");
...
- CVE-2019-20812: Fixed an issue in prb_calc_retire_blk_tmo() which could have resulted in ... [Please see the references for more information on the vulnerabilities]");
