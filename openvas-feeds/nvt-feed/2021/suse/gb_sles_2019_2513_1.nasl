...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192513-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010783");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1117505");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1117507");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1117508");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1117511");
...
- CVE-2016-9396: Fixed a denial of service in jpc_cox_getcompparms (bsc#1010783).");
  ...
  script_tag(name:"affected", value:"'jasper' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
