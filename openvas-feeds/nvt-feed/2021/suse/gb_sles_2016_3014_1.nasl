...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20163014-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1009026");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010395");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010401");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010402");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010404");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010410");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010422");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010427");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1010517");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/992549");
...
The Mozilla Firefox changelog was amended to document patched dropped in a previous update.");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, mozilla-nss' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
