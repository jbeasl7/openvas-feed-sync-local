...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20170841-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027147");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-March/002743.html");
...
- CVE-2017-2619: symlink race permits opening files outside share directory (bsc#1027147).");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
