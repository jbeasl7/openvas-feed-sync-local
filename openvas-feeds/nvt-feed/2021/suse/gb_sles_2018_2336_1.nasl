...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-08-21 22:08:19 +0000 (Tue, 21 Aug 2018)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182336-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1101689");
...
- CVE-2018-1333: Fixed a worker exhaustion that could have lead to a denial
 of service via specially crafted HTTP/2 requests (bsc#1101689).");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
