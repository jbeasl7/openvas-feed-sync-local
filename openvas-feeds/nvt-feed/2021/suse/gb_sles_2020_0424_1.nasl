...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200424-1.html");
...
- Fix a race condition in the shutdown sequence in wtp that was causing rsyslog not to
 shutdown properly. (bsc#1022804)");
  ...
  script_tag(name:"affected", value:"'rsyslog' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
