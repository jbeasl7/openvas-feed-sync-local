...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20193092-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1032089");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1037008");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1037009");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1059134");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1059139");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120653");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120654");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1124341");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1124342");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1155079");
...
- CVE-2019-18408: Fixed a use-after-free in RAR format support (bsc#1155079).");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
