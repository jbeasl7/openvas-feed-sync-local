...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183787-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1103098");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1112039");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-November/004859.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 15 for SLE 12 SP2)' package(s) announced via the SUSE-SU-2018:3787-1 advisory.");
