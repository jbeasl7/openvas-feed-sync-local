...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:3085-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:3085-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203085-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177158");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-October/007662.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spice-gtk' package(s) announced via the SUSE-SU-2020:3085-1 advisory.");
...
- CVE-2020-14355: Fixed multiple buffer overflow vulnerabilities in QUIC image decoding (bsc#1177158).");
  ...
  script_tag(name:"affected", value:"'spice-gtk' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
