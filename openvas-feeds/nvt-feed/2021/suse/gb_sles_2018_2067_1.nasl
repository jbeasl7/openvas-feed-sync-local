...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182067-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1085295");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1085585");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-July/004313.html");
...
- CVE-2017-18234: Fix use-after-free issue that allows remote attackers to cause a denial of service via a .pdf file (bsc#1085585).");
  ...
  script_tag(name:"affected", value:"'exempi' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
