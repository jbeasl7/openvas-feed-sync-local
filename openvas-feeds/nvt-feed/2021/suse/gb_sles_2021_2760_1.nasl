...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212760-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188881");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2021-August/019883.html");
...
- Use unbuffered /dev/urandom for random data to prevent early startup performance issues");
  ...
  script_tag(name:"affected", value:"'c-ares' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
