...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20210770-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179415");
...
- add '-D' option in rpmdb2solv to set the dbpath");
  ...
  script_tag(name:"affected", value:"'libsolv, libzypp, yast2-installation, zypper' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP Applications 15.");
