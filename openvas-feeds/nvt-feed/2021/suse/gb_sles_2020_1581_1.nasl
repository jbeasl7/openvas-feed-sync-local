...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201581-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1138793");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158910");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1159740");
...
- Fixed an issue where pstopdf was crashing (bsc#1138793).");
  ...
  script_tag(name:"affected", value:"'texlive' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
