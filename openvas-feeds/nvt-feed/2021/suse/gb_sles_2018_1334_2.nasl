...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:1334-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:1334-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181334-2.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2018:1334-2 advisory.");
