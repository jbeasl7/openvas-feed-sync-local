...
if(description)
{
  ...
  script_cve_id("CVE-2016-10906", "CVE-2017-18509", "CVE-2017-18595", "CVE-2018-12207", "CVE-2018-20976", "CVE-2019-0154", "CVE-2019-0155", "CVE-2019-10220", "CVE-2019-11135", "CVE-2019-13272", "CVE-2019-14814", "CVE-2019-14815", "CVE-2019-14816", "CVE-2019-14821", "CVE-2019-14835", "CVE-2019-15098", "CVE-2019-15211", "CVE-2019-15212", "CVE-2019-15214", "CVE-2019-15215", "CVE-2019-15216", "CVE-2019-15217", "CVE-2019-15218", "CVE-2019-15219", "CVE-2019-15220", "CVE-2019-15221", "CVE-2019-15290", "CVE-2019-15291", "CVE-2019-15505", "CVE-2019-15666", "CVE-2019-15807", "CVE-2019-15902", "CVE-2019-15924", "CVE-2019-15926", "CVE-2019-15927", "CVE-2019-16231", "CVE-2019-16232", "CVE-2019-16233", "CVE-2019-16234", "CVE-2019-16413", "CVE-2019-16995", "CVE-2019-17055", "CVE-2019-17056", "CVE-2019-17133", "CVE-2019-17666", "CVE-2019-18680", "CVE-2019-18805", "CVE-2019-9456", "CVE-2019-9506");
  ...
  script_tag(name:"severity_date", value:"2019-11-08 22:38:39 +0000 (Fri, 08 Nov 2019)");

  script_name("SUSE: Security Advisory (SUSE-SU-2019:2984-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2019:2984-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192984-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1068032");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1084878");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1139550");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1140671");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149849");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150025");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150112");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1150223");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1155898");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel' package(s) announced via the SUSE-SU-2019:2984-1 advisory.");
...
- CVE-2018-12207: Untrusted virtual machines on Intel CPUs could exploit a race
 ...
 needed. More information can be found on [link moved to references]
...
- CVE-2019-15291: Fixed a NULL pointer dereference issue that could be caused
 by a malicious USB device ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "SLES12.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-4_4_121-92_125-default", rpm:"kgraft-patch-4_4_121-92_125-default~1~3.5.1", rls:"SLES12.0SP2"))) {
    report += res;
  }
