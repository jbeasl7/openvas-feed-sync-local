...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213854-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1092945");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102531");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1107597");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1114966");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1115185");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1115186");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1115187");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1115626");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120495");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120496");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120939");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1120956");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1124150");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1127329");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1129202");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1130229");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1131696");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1131722");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1142465");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1143950");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179163");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009785.html");
...
- CVE-2020-27778: Fixed buffer overflow vulnerability in pdftohtml (bsc#1179163).");
  ...
  script_tag(name:"affected", value:"'poppler' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
