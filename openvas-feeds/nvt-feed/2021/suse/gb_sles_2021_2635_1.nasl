...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212635-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188517");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009264.html");
...
- CVE-2010-2322: Fixed a directory traversal vulnerabilities. (bsc#1188517)");
  ...
  script_tag(name:"affected", value:"'fastjar' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
