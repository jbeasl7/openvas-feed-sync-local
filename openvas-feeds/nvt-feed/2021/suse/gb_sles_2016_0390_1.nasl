...
if(description)
{
  ...
  script_cve_id("CVE-2015-5041", "CVE-2015-7575", "CVE-2015-8126", "CVE-2015-8472", "CVE-2016-0402", "CVE-2016-0448", "CVE-2016-0466", "CVE-2016-0475", "CVE-2016-0483", "CVE-2016-0494");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2016:0390-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2016:0390-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160390-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1_8_0-ibm' package(s) announced via the SUSE-SU-2016:0390-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for java-1_8_0-ibm fixes the following security issues by updating to 8.0-2.10 (bsc#963937):
...
- bsc#960402: resolve package conflicts in devel package");
  ...
  script_tag(name:"affected", value:"'java-1_8_0-ibm' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
