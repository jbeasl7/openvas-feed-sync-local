...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171777-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1041445");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/912873");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935573");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-July/003008.html");
...
- Cannot create table radpostauth because of deprecated TIMESTAMP(14) syntax. (bsc#912873)");
  ...
  script_tag(name:"affected", value:"'freeradius-server' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
