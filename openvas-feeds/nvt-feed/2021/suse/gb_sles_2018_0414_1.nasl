...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180414-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1028103");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1035807");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1036457");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1079600");
...
- Fix several integer overflow issues in truetype/ttinterp.c (bsc#1079600)");
  ...
  script_tag(name:"affected", value:"'freetype2' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
