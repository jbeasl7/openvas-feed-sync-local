...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171712-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1018870");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1024724");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027053");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027057");
...
- Speed up YAML syntax highlighting (bsc#1018870)");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
