...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200079-2.html");
...
- CVE-2019-18900: Fixed assert cookie file that was world readable (bsc#1158763).");
  ...
  script_tag(name:"affected", value:"'libzypp' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
