...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-12 13:14:08 +0000 (Tue, 12 Mar 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191990-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128935");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128937");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1130746");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1133100");
...
- Cron schedules only one job of crontab (bsc#1130746).");
  ...
  script_tag(name:"affected", value:"'cronie' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
