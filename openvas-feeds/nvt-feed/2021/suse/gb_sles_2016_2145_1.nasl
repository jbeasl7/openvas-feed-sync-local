...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162145-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/912607");
...
- bsc#912607: Attempt to rename root dir in fsck due to uninitialized fields.");
  ...
  script_tag(name:"affected", value:"'dosfstools' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
