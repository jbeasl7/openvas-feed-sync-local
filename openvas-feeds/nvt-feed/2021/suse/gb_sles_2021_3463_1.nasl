...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213463-1.html");
...
- Fix for warning on mounts to CIFS with mount. (SG#57988, bsc#1174942)");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
