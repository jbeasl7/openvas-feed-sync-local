...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212800-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188571");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009316.html");
...
- CVE-2021-36222: Fixed KDC null deref on bad encrypted challenge. (bsc#1188571)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
