...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:1828-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:1828-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20201828-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd' package(s) announced via the SUSE-SU-2020:1828-1 advisory.");
...
- udev/cdrom_id: Do not open CD-rom in exclusive mode. (bsc#1154256)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
