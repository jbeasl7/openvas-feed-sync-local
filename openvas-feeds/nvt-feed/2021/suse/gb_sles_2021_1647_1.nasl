...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211647-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185438");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2021-May/018981.html");
...
- CVE-2021-3520: Fixed memory corruption due to an integer overflow bug caused by memmove argument (bsc#1185438).");
  ...
  script_tag(name:"affected", value:"'lz4' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"liblz4-1-32bit", rpm:"liblz4-1-32bit~1.8.0~3.8.1", rls:"SLES15.0"))) {
    report += res;
  }
