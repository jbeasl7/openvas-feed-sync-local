...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181760-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/707645");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004204.html");
...
- CVE-2011-3172: Ensure that unix2_chkpwd calls pam_acct_mgmt to prevent usage
 of locked accounts (bsc#707645).");
  ...
  script_tag(name:"affected", value:"'pam-modules' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
