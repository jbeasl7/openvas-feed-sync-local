...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182780-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1095189");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1095945");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1097103");
...
- CVE-2018-12085: Fixed a stack-based buffer overflow in the function
 ...
 CVE-2018-11440) (bsc#1097103)");
  ...
  script_tag(name:"affected", value:"'liblouis' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
