...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-06-29 17:59:28 +0000 (Fri, 29 Jun 2018)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20202968-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096180");
...
- CVE-2018-11439: The TagLib::Ogg::FLAC::File::scan function allowed remote
 ...
 crafted audio file (bsc#1096180).");
  ...
  script_tag(name:"affected", value:"'taglib' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
