...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20214018-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1152964");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190069");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190896");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009892.html");
...
- Added hardening to systemd service(s) (bsc#1181400).");
  ...
  script_tag(name:"affected", value:"'fetchmail' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
