...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20172375-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1047236");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1047240");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2017-September/003189.html");
...
- CVE-2017-9233: External Entity Vulnerability could lead to denial of service (bsc#1047236)");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
