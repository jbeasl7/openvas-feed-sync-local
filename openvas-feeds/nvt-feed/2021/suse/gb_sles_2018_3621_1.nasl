...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.3621.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:3621-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:3621-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183621-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-November/004829.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc' package(s) announced via the SUSE-SU-2018:3621-1 advisory.");
...
- CVE-2018-16427: Fixed out of bounds reads when handling responses in OpenSC (bsc#1107033)");
  ...
  script_tag(name:"affected", value:"'opensc' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopensc2", rpm:"libopensc2~0.11.6~5.27.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopensc2-32bit", rpm:"libopensc2-32bit~0.11.6~5.27.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopensc2-x86", rpm:"libopensc2-x86~0.11.6~5.27.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc", rpm:"opensc~0.11.6~5.27.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-32bit", rpm:"opensc-32bit~0.11.6~5.27.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"opensc-x86", rpm:"opensc-x86~0.11.6~5.27.3.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
