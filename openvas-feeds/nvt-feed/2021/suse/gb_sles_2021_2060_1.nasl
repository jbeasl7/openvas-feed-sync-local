...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-07 15:55:07 +0000 (Mon, 07 Jun 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212060-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185899");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186285");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/009049.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 33 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2021:2060-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the Linux Kernel 4.4.180-94_124 fixes several issues.
...
- CVE-2021-32399: Fixed a race condition when removing the HCI controller (bnc#1184611).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 33 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
