...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-02-19 18:31:17 +0000 (Fri, 19 Feb 2016)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192152-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/962522");
...
- CVE-2016-1923: Fixed anout of bounds read int opj_j2k_update_image_data() and opj_tgt_reset () (bsc#962522).");
  ...
  script_tag(name:"affected", value:"'openjpeg2' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
