...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203125-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1172524");
 ...
 * The new escl backend cannot be provided for SLE12 because
 ...
 undeclared curl_easy_setopt(handle, CURLOPT_UNIX_SOCKET_PATH'");
  ...
  script_tag(name:"affected", value:"'sane-backends' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
