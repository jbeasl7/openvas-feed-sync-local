...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180119-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1015964");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1044995");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/986631");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/986632");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/986639");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/986642");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/986658");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003605.html");
...
- libical crashes while parsing timezones (bsc#1044995)");
  ...
  script_tag(name:"affected", value:"'libical' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
