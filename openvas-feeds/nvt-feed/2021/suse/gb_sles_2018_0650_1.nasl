...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180650-1.html");
...
- CVE-2017-7555: Fix a memory corruption bug could have lead to arbitrary code execution
 by passing crafted strings that would be mis-handled by parse_name() (bsc#1054171).");
  ...
  script_tag(name:"affected", value:"'augeas' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
