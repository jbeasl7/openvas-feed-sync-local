...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20190284-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1122012");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/936786");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/976955");
...
- Fixed build on armv7 (bsc#976955)");
  ...
  script_tag(name:"affected", value:"'libunwind' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
