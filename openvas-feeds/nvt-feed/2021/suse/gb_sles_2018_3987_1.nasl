...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.3987.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:3987-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:3987-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183987-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1112185");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1114422");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-December/004921.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kvm' package(s) announced via the SUSE-SU-2018:3987-1 advisory.");
...
if(release == "SLES11.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kvm", rpm:"kvm~1.4.2~53.26.2", rls:"SLES11.0SP3"))) {
    report += res;
  }
