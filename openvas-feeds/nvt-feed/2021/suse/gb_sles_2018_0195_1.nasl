...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180195-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1059893");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-January/003626.html");
...
- CVE-2017-7544: Fixed out-of-bounds heap read vulnerability in
 ...
 denial-of-service or possibly information disclosure (bsc#1059893)");
  ...
  script_tag(name:"affected", value:"'libexif' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
