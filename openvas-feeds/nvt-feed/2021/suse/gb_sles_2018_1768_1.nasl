...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181768-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/938906");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-June/004209.html");
...
- CVE-2015-4000: Prevent Logjam. The TLS protocol 1.2 and earlier, when a
 ...
 replaced by DHE (bsc#938906).");
  ...
  script_tag(name:"affected", value:"'nagios-nrpe' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
