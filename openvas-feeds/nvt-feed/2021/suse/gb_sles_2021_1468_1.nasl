...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-08 02:34:58 +0000 (Sat, 08 May 2021)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211468-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181495");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1185345");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-May/008725.html");
...
- MD5 warning message using host, dig, nslookup (bind-utils) on SLES 12 SP5 with FIPS enabled (bsc#1181495).");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
