...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150232-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/883174");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/901216");
...
- LPAR crashes when drmgr attempts to offline last remaining cpu core (bnc#901216)");
  ...
  script_tag(name:"affected", value:"'powerpc-utils' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
