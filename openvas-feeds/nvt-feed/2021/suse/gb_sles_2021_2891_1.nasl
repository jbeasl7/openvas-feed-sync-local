...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212891-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187418");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187419");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187420");
  script_xref(name:"URL", value:"https://doc.dovecot.org/admin_manual/list_of_events/");
  script_xref(name:"URL", value:"https://doc.dovecot.org/admin_manual/list_of_events/#authentication-server");
  script_xref(name:"URL", value:"https://doc.dovecot.org/admin_manual/list_of_events/#indexer-worker-indexing-finished");
  script_xref(name:"URL", value:"https://doc.dovecot.org/admin_manual/list_of_events/#mail");
  script_xref(name:"URL", value:"https://doc.dovecot.org/admin_manual/list_of_events/#mail-index-recreated");
  script_xref(name:"URL", value:"https://doc.dovecot.org/configuration_manual/config_file/config_file_syntax/#environment-variables");
  script_xref(name:"URL", value:"https://doc.dovecot.org/configuration_manual/config_file/config_variables/");
  script_xref(name:"URL", value:"https://doc.dovecot.org/configuration_manual/event_filter/");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-August/009375.html");
...
* config: Some settings are now marked as 'hidden'. It's discouraged to
 ...
 is used. See [link moved to references] for details.
...
- *-login: When login process reaches client/process limits, oldest
 client connections ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'dovecot23' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
