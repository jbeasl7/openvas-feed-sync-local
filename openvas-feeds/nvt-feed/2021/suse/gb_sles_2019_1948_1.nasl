...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191948-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 25 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2019:1948-1 advisory.");
...
This update contains a regression fix for CVE-2019-11477 and CVE-2019-11478 (bsc#1140747).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 25 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
