...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151509-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935540");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/936844");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/938895");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/941939");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-September/001577.html");
...
* CVE-2015-4000: Very difficult to exploit vulnerability in the JSSE component ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'java-1_6_0-ibm' package(s) on SUSE Linux Enterprise Server 11-SP1, SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
