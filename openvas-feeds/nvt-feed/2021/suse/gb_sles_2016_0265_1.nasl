...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160265-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/939523");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/960996");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/962743");
  ...
  script_tag(name:"insight", value:"java-1_7_0-openjdk was updated to version 7u95 to fix 9 security issues. (bsc#962743)
