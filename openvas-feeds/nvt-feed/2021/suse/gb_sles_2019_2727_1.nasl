...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192727-1.html");
...
- Use IPv6 when called as dhclient6, dhcpd6, and dhcrelay6 (bsc#1136572).");
  ...
  script_tag(name:"affected", value:"'dhcp' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
