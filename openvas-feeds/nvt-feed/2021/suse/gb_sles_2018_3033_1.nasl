...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183033-1.html");
...
- CVE-2018-17407: Prevent buffer overflow when handling of Type 1 fonts allowed
 ...
 vulnerable tools: pdflatex, pdftex, dvips, or luatex (bsc#1109673)");
  ...
  script_tag(name:"affected", value:"'texlive' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
