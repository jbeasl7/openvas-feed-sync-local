...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182527-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1103737");
...
- CVE-2018-14424: The daemon in GDM did not properly unexport display objects
 ...
 (bsc#1103737).");
  ...
  script_tag(name:"affected", value:"'gdm' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
