...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20193058-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1108606");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1121626");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1125113");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1146608");
...
- CVE-2019-7663: Fixed an invalid address dereference in the
 TIFFWriteDirectoryTagTransfer function in libtiff/tif_dirwrite.c (bsc#1125113)");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
