...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150887-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/846389");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-May/001389.html");
  ...
  script_tag(name:"insight", value:"openldap2 was updated to fix three security issues and one non-security
bug.
 ...
 * CVE-2013-4449
 <[link moved to references]>");
  ...
  script_tag(name:"affected", value:"'openldap2' package(s) on SUSE Linux Enterprise Desktop 11-SP3, SUSE Linux Enterprise Server 11, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for SAP Applications 11-SP3.");
...
if(release == "SLES11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libldap-openssl1-2_4-2", rpm:"libldap-openssl1-2_4-2~2.4.26~0.30.2", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libldap-openssl1-2_4-2-32bit", rpm:"libldap-openssl1-2_4-2-32bit~2.4.26~0.30.2", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libldap-openssl1-2_4-2-x86", rpm:"libldap-openssl1-2_4-2-x86~2.4.26~0.30.2", rls:"SLES11.0"))) {
    report += res;
  }
