...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:0412-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:0412-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20200412-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1151455");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1156146");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1157179");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-February/006497.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dpdk' package(s) announced via the SUSE-SU-2020:0412-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for dpdk to version 18.11.3 fixes the following issues:
...
- Fixed a regression caused by loading old version drivers (bsc#1157179).");
  ...
  script_tag(name:"affected", value:"'dpdk' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
