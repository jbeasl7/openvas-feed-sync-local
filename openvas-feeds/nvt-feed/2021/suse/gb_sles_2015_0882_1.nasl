...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:0882-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:0882-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150882-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the SUSE-SU-2015:0882-1 advisory.");
...
* CVE-2015-2305: Apply upstream patch for possible heap overflow in Henry Spencer's regex library.");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
