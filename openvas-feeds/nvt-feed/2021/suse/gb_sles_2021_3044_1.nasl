...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213044-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184123");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190381");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009444.html");
...
- Link as position independent executable (bsc#1184123)");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
