...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192480-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1124847");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1141093");
...
- Allow coredumps in X11 desktop sessions (bsc#1124847).");
  ...
  script_tag(name:"affected", value:"'gpg2' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
