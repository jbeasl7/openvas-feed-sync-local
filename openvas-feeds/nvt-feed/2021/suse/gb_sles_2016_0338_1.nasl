...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160338-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/964332");
...
- bsc#964332: Fixed leaking file descriptors inside FIPS selfcheck code");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, MozillaFirefox-branding-SLE, mozilla-nss' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
