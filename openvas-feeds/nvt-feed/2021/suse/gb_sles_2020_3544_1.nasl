...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203544-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-November/007876.html");
...
- CVE-2020-25284: Fixed an incomplete permission checking for access to rbd devices, which could ... [Please see the references for more information on the vulnerabilities]");
