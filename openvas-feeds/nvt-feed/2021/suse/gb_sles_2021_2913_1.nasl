...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20212913-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188457");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188458");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188459");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188460");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188461");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1188462");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009386.html");
...
- CVE-2021-20304 [bsc#1188461]: Fixed Undefined-shift in Imf_2_5:hufDecode");
  ...
  script_tag(name:"affected", value:"'openexr' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
