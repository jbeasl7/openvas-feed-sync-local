...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:3154-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:3154-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20173154-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 19 for SLE 12)' package(s) announced via the SUSE-SU-2017:3154-1 advisory.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_61-52_66-default", rpm:"kgraft-patch-3_12_61-52_66-default~9~2.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_61-52_66-xen", rpm:"kgraft-patch-3_12_61-52_66-xen~9~2.1", rls:"SLES12.0"))) {
    report += res;
  }
