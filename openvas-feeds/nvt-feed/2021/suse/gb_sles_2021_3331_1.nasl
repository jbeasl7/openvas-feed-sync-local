...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213331-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1190710");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1191332");
  script_xref(name:"URL", value:"https://github.com/crossbeam-rs/crossbeam/security/advisories/GHSA-pqqp-xmhj-wgcw");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-October/009561.html");
