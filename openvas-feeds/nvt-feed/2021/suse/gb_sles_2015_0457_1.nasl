...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150457-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/916343");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/916785");
...
- Do not allow calls to UpdateActivationEnvironment or the
 ...
 path.");
  ...
  script_tag(name:"affected", value:"'dbus-1' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
