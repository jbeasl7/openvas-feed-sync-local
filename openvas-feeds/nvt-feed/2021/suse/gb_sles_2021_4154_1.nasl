...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-18 15:58:17 +0000 (Fri, 18 Dec 2020)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20214154-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180064");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1187993");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009932.html");
...
- Add support for CKA_NSS_{SERVER,EMAIL}_DISTRUST_AFTER (bsc#1187993).");
  ...
  script_tag(name:"affected", value:"'p11-kit' package(s) on SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libp11-kit0-32bit", rpm:"libp11-kit0-32bit~0.23.2~4.13.1", rls:"SLES15.0"))) {
    report += res;
  }
