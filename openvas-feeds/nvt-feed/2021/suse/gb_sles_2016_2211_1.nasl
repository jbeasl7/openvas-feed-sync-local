...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162211-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/928923");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/992966");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-September/002248.html");
...
- Call textdomain in cracklib-check main function so that program
 output is translated accordingly. (bsc#928923)");
  ...
  script_tag(name:"affected", value:"'cracklib' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
