...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151156-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/931625");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/931626");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/931627");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/931628");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/932770");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/932996");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-June/001467.html");
...
if(release == "SLES11.0SP1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.0.3_21548_18~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-doc-html", rpm:"xen-doc-html~4.0.3_21548_18~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-doc-pdf", rpm:"xen-doc-pdf~4.0.3_21548_18~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-default", rpm:"xen-kmp-default~4.0.3_21548_18_2.6.32.54_0.59.TDC~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-trace", rpm:"xen-kmp-trace~4.0.3_21548_18_2.6.32.54_0.59.TDC~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-libs", rpm:"xen-libs~4.0.3_21548_18~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools", rpm:"xen-tools~4.0.3_21548_18~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools-domU", rpm:"xen-tools-domU~4.0.3_21548_18~0.23.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
