...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180510-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1043886");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003748.html");
...
- A DB_CONFIG file in the current working directory allowed local
 ...
 involving a setgid or setuid application using libdb-4_8. (bsc#1043886)");
  ...
  script_tag(name:"affected", value:"'libdb-4_8' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
