...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-06-05 19:42:37 +0000 (Wed, 05 Jun 2019)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20191749-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1124781");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1128140");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1135727");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1135729");
...
- CVE-2019-12210: Fixed file descriptor leaks (bsc#1135727).");
  ...
  script_tag(name:"affected", value:"'libu2f-host' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server for SAP Applications 12-SP4.");
