...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180118-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1028842");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062063");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1066644");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1071459");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1071460");
...
- Ensure -X flag works even when setting owner/group (bsc#1028842)");
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
