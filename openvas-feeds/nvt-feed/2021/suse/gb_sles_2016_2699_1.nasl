...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162699-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1005640");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1005642");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1005643");
...
- CVE-2016-7167: escape and unescape integer overflows (bsc#998760)");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
