...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2019/suse-su-20192648-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1143478");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1145134");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1149313");
...
- CVE-2019-15030: In the Linux kernel on the ... [Please see the references for more information on the vulnerabilities]");
