...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2020.14312.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2020:14312-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2020:14312-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-202014312-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1132665");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2020-March/006599.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2020:14312-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~68.6.0~78.64.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~68.6.0~78.64.1", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-other", rpm:"MozillaFirefox-translations-other~68.6.0~78.64.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
