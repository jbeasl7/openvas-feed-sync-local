...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.2335.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:2335-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:2335-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182335-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1104134");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-August/004419.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Security update to ucode-intel' package(s) announced via the SUSE-SU-2018:2335-1 advisory.");
...
(bsc#1104134 bsc#1087082 bsc#1087083 bsc#1089343)
 ...
 SKL-H/S/E3 R0 6-5e-3/36 000000c2->000000c6 Core Gen6, Xeon E3 v5");
  ...
  script_tag(name:"affected", value:"'Security update to ucode-intel' package(s) on SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
...
if(release == "SLES11.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~1.17~102.83.27.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~1.17~102.83.27.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
