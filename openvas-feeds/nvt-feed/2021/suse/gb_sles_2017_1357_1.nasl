...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-13 18:19:06 +0000 (Tue, 13 Jun 2017)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171357-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1038395");
 ...
 * fix 'git log -L...' buffer overrun");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP2.");
