...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-202114800-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171685");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-September/009454.html");
...
- CVE-2020-12825: Fixed recursion issue in block and any productions (bsc#1171685).");
  ...
  script_tag(name:"affected", value:"'libcroco' package(s) on SUSE Linux Enterprise Server 11-SP4.");
