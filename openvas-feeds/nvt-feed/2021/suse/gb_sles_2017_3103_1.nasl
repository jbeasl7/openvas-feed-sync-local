...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2017:3103-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2017:3103-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20173103-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 23 for SLE 12)' package(s) announced via the SUSE-SU-2017:3103-1 advisory.");
...
if(release == "SLES12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_61-52_80-default", rpm:"kgraft-patch-3_12_61-52_80-default~5~2.1", rls:"SLES12.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kgraft-patch-3_12_61-52_80-xen", rpm:"kgraft-patch-3_12_61-52_80-xen~5~2.1", rls:"SLES12.0"))) {
    report += res;
  }
