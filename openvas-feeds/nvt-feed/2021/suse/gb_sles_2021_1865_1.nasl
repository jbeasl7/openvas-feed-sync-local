...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20211865-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184710");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1184952");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1186235");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-June/008939.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Linux Kernel (Live Patch 32 for SLE 12 SP3)' package(s) announced via the SUSE-SU-2021:1865-1 advisory.");
...
- CVE-2021-29154: BPF JIT compilers in the Linux kernel have incorrect computation of branch displacements, allowing them to execute arbitrary code within the kernel context. This affects arch/x86/net/bpf_jit_comp.c and arch/x86/net/bpf_jit_comp32.c (bsc#1184710)");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 32 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
