...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2018.0638.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:0638-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:0638-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180638-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1027519");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1031382");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1035442");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061081");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1068032");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1070158");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1070159");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1070160");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1070163");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1074562");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1076116");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1076180");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1080635");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1080662");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-March/003795.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen' package(s) announced via the SUSE-SU-2018:0638-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.4.4_28~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-doc-html", rpm:"xen-doc-html~4.4.4_28~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-default", rpm:"xen-kmp-default~4.4.4_28_3.0.101_108.35~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-kmp-pae", rpm:"xen-kmp-pae~4.4.4_28_3.0.101_108.35~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-libs-32bit", rpm:"xen-libs-32bit~4.4.4_28~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-libs", rpm:"xen-libs~4.4.4_28~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools", rpm:"xen-tools~4.4.4_28~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xen-tools-domU", rpm:"xen-tools-domU~4.4.4_28~61.23.2", rls:"SLES11.0SP4"))) {
    report += res;
  }
