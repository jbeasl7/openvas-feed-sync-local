...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2017/suse-su-20171999-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1041783");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1042802");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1042803");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1043088");
...
- CVE-2017-9408: Memory leak in the Object::initArray function (bsc#1042802)");
  ...
  script_tag(name:"affected", value:"'poppler' package(s) on SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP2, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
