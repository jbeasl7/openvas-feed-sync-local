...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151821-1.html");
...
* For the full release notes for 9.3.9 see: [link moved to references]");
