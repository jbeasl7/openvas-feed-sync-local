...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20213530-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1173646");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1180914");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1183709");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-October/009660.html");
...
- Open inotify socket only when used (bsc#1180914).");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
