...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2021/suse-su-20214168-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1166066");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2021-December/009936.html");
...
- CVE-2020-0034: Fixed out-of-bounds read on truncated key frames (bsc#1166066)");
  ...
  script_tag(name:"affected", value:"'libvpx' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
