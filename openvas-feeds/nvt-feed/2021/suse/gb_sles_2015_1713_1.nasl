...
if(description)
{
  ...
  script_cve_id("CVE-2015-3813", "CVE-2015-6241", "CVE-2015-6242", "CVE-2015-6243", "CVE-2015-6244", "CVE-2015-6245", "CVE-2015-6246", "CVE-2015-6247", "CVE-2015-6248", "CVE-2015-6249");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:1713-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:1713-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20151713-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/935158");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/941500");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'wireshark' package(s) announced via the SUSE-SU-2015:1713-1 advisory.");
...
Also a fix from 1.12.6 in GSM DTAP was backported. (bnc#935158)");
  ...
  script_tag(name:"affected", value:"'wireshark' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server for SAP Applications 12.");
