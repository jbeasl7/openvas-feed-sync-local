...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20180423-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1047443");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2018-February/003723.html");
...
- CVE-2016-10396: The racoon daemon contained a remotely exploitable
 ...
 (bsc#1047443).");
  ...
  script_tag(name:"affected", value:"'ipsec-tools' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
