...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20162827-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/994819");
...
- out-of-bounds write in eog (bsc#994819, CVE-2016-6855)");
  ...
  script_tag(name:"affected", value:"'eog' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP Applications 12-SP1.");
