...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2020/suse-su-20203503-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1176816");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177816");
...
- CVE-2019-19063: Fixed two ... [Please see the references for more information on the vulnerabilities]");
