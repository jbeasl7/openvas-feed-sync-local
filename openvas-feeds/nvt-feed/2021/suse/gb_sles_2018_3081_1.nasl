...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20183081-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1088279");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1088601");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1102046");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1105166");
...
- CVE-2017-18258: The xz_head function allowed remote attackers to cause a
 ...
 legitimate file (bsc#1088601).");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
