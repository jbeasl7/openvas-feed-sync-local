...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20182162-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050082");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1061066");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1087018");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096405");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096406");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096407");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1096408");
...
- Fixed authorization check for clients (like samba) connected through the
 local socket when Kerberos authentication is enabled (bsc#1050082)");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP Applications 12-SP3.");
