...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2016.0010.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2016:0010-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2016:0010-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2016/suse-su-20160010-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/947164");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/950590");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/953187");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/956829");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/957162");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2016-January/001775.html");
  script_xref(name:"URL", value:"https://www.suse.com/support/kb/doc.php?id=7017048");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kvm' package(s) announced via the SUSE-SU-2016:0010-1 advisory.");
...
- Fix kvm live migration fails between sles11 sp3 and sp4 (bsc#950590)");
  ...
  script_tag(name:"affected", value:"'kvm' package(s) on SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server for SAP Applications 11-SP4.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kvm", rpm:"kvm~1.4.2~35.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
