...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2015.0546.1");
  script_cve_id("CVE-2010-5298", "CVE-2014-0160", "CVE-2014-0195", "CVE-2014-0198", "CVE-2014-0221", "CVE-2014-0224", "CVE-2014-3470", "CVE-2014-3505", "CVE-2014-3506", "CVE-2014-3507", "CVE-2014-3508", "CVE-2014-3509", "CVE-2014-3510", "CVE-2014-3511", "CVE-2014-3512", "CVE-2014-3513", "CVE-2014-3566", "CVE-2014-3567", "CVE-2014-3568", "CVE-2014-3570", "CVE-2014-3571", "CVE-2014-3572", "CVE-2014-5139", "CVE-2014-8176", "CVE-2014-8275", "CVE-2015-0204", "CVE-2015-0205", "CVE-2015-0206", "CVE-2015-0209", "CVE-2015-0286", "CVE-2015-0287", "CVE-2015-0288", "CVE-2015-0289", "CVE-2015-0292", "CVE-2015-0293", "CVE-2015-1788", "CVE-2015-1789", "CVE-2015-1790", "CVE-2015-1791", "CVE-2015-1792", "CVE-2015-4000");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2015:0546-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2015:0546-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2015/suse-su-20150546-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/860332");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/861014");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/864912");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/869945");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/872299");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/873351");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/876282");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/880891");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/889812");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/906878");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/912292");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/923384");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/934494");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2015-March/001300.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl1' package(s) announced via the SUSE-SU-2015:0546-1 advisory.");
...
if(release == "SLES11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libopenssl1-devel", rpm:"libopenssl1-devel~1.0.1g~0.22.1", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl1_0_0", rpm:"libopenssl1_0_0~1.0.1g~0.22.1", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl1_0_0-32bit", rpm:"libopenssl1_0_0-32bit~1.0.1g~0.22.1", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libopenssl1_0_0-x86", rpm:"libopenssl1_0_0-x86~1.0.1g~0.22.1", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl1", rpm:"openssl1~1.0.1g~0.22.1", rls:"SLES11.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"openssl1-doc", rpm:"openssl1-doc~1.0.1g~0.22.1", rls:"SLES11.0"))) {
    report += res;
  }
