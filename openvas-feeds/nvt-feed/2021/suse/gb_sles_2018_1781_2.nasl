...
if(description)
{
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2018:1781-2)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2018:1781-2");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2018/suse-su-20181781-2.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb' package(s) announced via the SUSE-SU-2018:1781-2 advisory.");
 ...
 * [links moved to references]");
  ...
  script_tag(name:"affected", value:"'mariadb' package(s) on SUSE Linux Enterprise Server 12-SP2.");
