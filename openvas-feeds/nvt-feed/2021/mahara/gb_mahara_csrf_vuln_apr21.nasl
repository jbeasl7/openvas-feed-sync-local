...
if( description )
{
  ...
  script_tag(name:"impact", value:"An attacker can craft a
  module/multirecipientnotification/inbox.php pieform_delete_all_notifications request, which leads
  to removing all messages from a mailbox.");
