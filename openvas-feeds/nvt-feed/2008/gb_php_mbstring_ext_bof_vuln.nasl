...
if(description)
{
  ...
  script_name("PHP 4.3.x < 5.2.7 Buffer Overflow Vulnerability");
  ...
  script_tag(name:"insight", value:"An error exists in mbfilter_htmlent.c file in the mbstring
  ...
  script_tag(name:"affected", value:"PHP versions 4.3.x through 5.2.6.");
...
if (version_in_range(version: version, test_version: "4.3.0", test_version2: "5.2.6")) {
