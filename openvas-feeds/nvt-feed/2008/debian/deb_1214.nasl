...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1214-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1214-2");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1214-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1214");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gv' package(s) announced via the DSA-1214-2 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gv", ver:"1:3.6.1-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }
