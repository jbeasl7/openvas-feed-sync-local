...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/30550");
...
mplayerVer = registry_get_sz(key:"SOFTWARE\Microsoft\Active setup\Installed Components" +
    "\{6BF52A52-394A-11d3-B153-00C04F79FAA6}", item:"Version");
...
if("11,0,5721" >< mplayerVer) {
  ...
  # Vuln: Wmpeffects.dll versions < 11.0.5721.5252
