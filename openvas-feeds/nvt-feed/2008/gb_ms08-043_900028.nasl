...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2008/ms08-043");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/30638");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/30639");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/30640");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/30641");
  ...
  - an error during processing/parsing of certain array indexes and record
  ...
  script_tag(name:"affected", value:"- Microsoft Excel 2002/XP/2003/2007
