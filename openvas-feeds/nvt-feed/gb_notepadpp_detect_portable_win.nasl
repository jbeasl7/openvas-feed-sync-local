...
if(description)
{
  ...
  script_dependencies("gb_notepadpp_detect_win.nasl", "lsc_options.nasl");
  ...
  script_tag(name:"summary", value:"SMB login and WMI file search based detection of Notepad++
  Portable.");
...
fileList = powershell_wmi_file_search_version_query( file_name:"notepad++", file_extension:"exe" );
