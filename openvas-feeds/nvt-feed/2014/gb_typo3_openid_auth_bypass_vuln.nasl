...
if(description)
{
  ...
  script_tag(name:"insight", value:"An error exists in the built-in OpenID extension, which fails to verify user
identities properly");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/38438");
  script_xref(name:"URL", value:"http://secunia.com/advisories/38206");
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-sa-2010-001/");
...
if(version_is_equal(version:vers, test_version:"4.3.0")) {
  report = report_fixed_ver(installed_version:vers, vulnerable_range:"Equal to 4.3.0", install_path:path);
