...
if(description)
{
  ...
  script_name("Oracle MySQL Multiple Unspecified vulnerabilities - 01 (May 2014) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66835");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66846");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66880");
