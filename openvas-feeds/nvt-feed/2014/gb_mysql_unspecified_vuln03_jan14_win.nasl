...
if(description)
{
  ...
  script_name("Oracle MySQL Multiple Unspecified vulnerabilities - 03 (Jan 2014) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/64891");
...
if(vers =~ "^5\.[56]") {
  if(version_in_range(version:vers, test_version:"5.5", test_version2:"5.5.33")||
