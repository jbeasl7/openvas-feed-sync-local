...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for update (openSUSE-SU-2014:1029-1)");
  ...
  * APSB14-18, CVE-2014-0538, CVE-2014-0540, CVE-2014-0541, CVE-2014-0542,
  ...
  script_xref(name:"openSUSE-SU", value:"2014:1029-1");
...
if(release == "openSUSE11.4") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.400~123.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.400~123.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.400~123.1", rls:"openSUSE11.4"))) {
    report += res;
  }
