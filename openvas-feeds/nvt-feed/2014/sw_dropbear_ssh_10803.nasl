...
if(description)
{
  ...
  script_name("Dropbear < 0.43 DSS Verification Code Vulnerability");
  ...
  script_tag(name:"summary", value:"Dropbear is prone to a DSS verification code vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The DSS verification code in Dropbear frees uninitialized
  variables.");

  script_tag(name:"impact", value:"This flaw might allow remote attackers to gain access.");

  script_tag(name:"affected", value:"Dropbear versions prior to 0.43.");

  script_tag(name:"solution", value:"Update to version 0.43 or later.");

  script_xref(name:"URL", value:"https://web.archive.org/web/20210131183208/http://www.securityfocus.com/bid/10803");
