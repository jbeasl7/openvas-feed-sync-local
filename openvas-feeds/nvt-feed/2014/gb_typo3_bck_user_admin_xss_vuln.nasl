...
cookie-based authentication credentials.");
  ...
  script_tag(name:"insight", value:"An error exists in backend user administration, which fails to properly encode user
input.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/64244");
...
if(version_in_range(version:vers, test_version:"6.0.0", test_version2:"6.0.11") ||
