...
if(description)
{
  ...
  script_name("PHP 5.4.x < 5.4.27, 5.5.x < 5.5.12 Privilege Escalation Vulnerability");
  ...
  script_tag(name:"insight", value:"An error in 'sapi/fpm/fpm/fpm_unix.c' within FastCGI Process
  ...
  script_tag(name:"solution", value:"Update to version 5.4.28, 5.5.12 or later.");
...
if (version_in_range(version: version, test_version: "5.4.0", test_version2: "5.4.27")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.4.28", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "5.5.0", test_version2: "5.5.11")) {
