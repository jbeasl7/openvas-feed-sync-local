...
cookie-based authentication credentials.");
  ...
  script_tag(name:"insight", value:"An error exists in Exception Handler, which fails to properly encode the output.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/53047");
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-core-sa-2012-002");
...
if(version_in_range(version:vers, test_version:"4.4.0", test_version2:"4.4.14") ||
   version_in_range(version:vers, test_version:"4.5.0", test_version2:"4.5.14") ||
   version_in_range(version:vers, test_version:"4.6.0", test_version2:"4.6.7")) {
