...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/20173");
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-20060911-1");
...
if(version_is_less(version:vers, test_version:"4.0.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"4.0.2", install_path:path);
