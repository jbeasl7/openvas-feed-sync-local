...
if(description)
{
  ...
  script_name("Oracle VirtualBox Multiple Unspecified Vulnerabilities-01 (Jan 2014) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Oracle VirtualBox before version 3.2.20, before version 4.0.22, before
