...
configured database table with an arbitrary value.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/64248");
...
if(version_in_range(version:vers, test_version:"4.5.0", test_version2:"4.5.31") ||
  ...
  report = report_fixed_ver(installed_version:vers, fixed_version:"4.5.32 / 4.7.17 / 6.0.12", install_path:path);
