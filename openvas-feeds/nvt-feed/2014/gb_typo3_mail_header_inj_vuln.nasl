...
validate certain email headers.");
  ...
  script_tag(name:"summary", value:"TYPO3 is prone to mail header injection vulnerability.");
  script_tag(name:"affected", value:"TYPO3 version before 4.0.5");

  script_xref(name:"URL", value:"http://secunia.com/advisories/24207");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/22668");
  script_xref(name:"URL", value:"http://xforce.iss.net/xforce/xfdb/32630");
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-20070221-1/");
