...
sanitize user supplied input to 'file' parameter.");
  ...
  script_xref(name:"URL", value:"https://typo3.org/security/advisory/typo3-20081113-1");
...
if(version_is_equal(version:vers, test_version:"4.2.2")) {
  report = report_fixed_ver(installed_version:vers, vulnerable_range:"Equal to 4.2.2", install_path:path);
