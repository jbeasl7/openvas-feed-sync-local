...
if(description)
{
  ...
  script_tag(name:"summary", value:"WordPress Contact Form Plugin is prone to a cross-site scripting (XSS) vulnerability.");
...
browser and the server.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68311");
...
url = dir + "/wp-content/plugins/contactme/xd_resize.php?width=1'})</script><script>alert(document.cookie)</script>&height=0";
