...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.11.0-23-generic", ver:"3.11.0-23.40", rls:"UBUNTU13.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.11.0-23-generic-lpae", ver:"3.11.0-23.40", rls:"UBUNTU13.10"))) {
    report += res;
  }
