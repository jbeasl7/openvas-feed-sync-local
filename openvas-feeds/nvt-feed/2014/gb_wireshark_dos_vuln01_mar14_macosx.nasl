...
if(description)
{
  ...
  script_name("Wireshark 'M3UA' Denial of Service Vulnerability-01 (Mar 2014) - Mac OS X");
...
if(vers =~ "^1\.10") {
  if(version_in_range(version:vers, test_version:"1.10.0", test_version2:"1.10.5")) {
    report = report_fixed_ver(installed_version:vers, vulnerable_range:"1.10.0 - 1.10.5", install_path:path);
