...
if(description)
{
  ...
  script_name("Dropbear 0.52 - 2011.54 UAF Vulnerability");
  ...
  script_tag(name:"summary", value:"Dropbear is prone to a use-after-free (UAF) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"A use-after-free vulnerability exists when command restriction
  and public key authentication are enabled.");

  script_tag(name:"impact", value:"This flaw allows remote authenticated users to execute arbitrary
  code and bypass command restrictions via multiple crafted command requests, related to channels
  concurrency.");

  script_tag(name:"affected", value:"Dropbear versions 0.52 through 2011.54.");

  script_tag(name:"solution", value:"Update to version 2012.55 or later.");

  script_xref(name:"URL", value:"https://web.archive.org/web/20210120050120/http://www.securityfocus.com/bid/52159");
