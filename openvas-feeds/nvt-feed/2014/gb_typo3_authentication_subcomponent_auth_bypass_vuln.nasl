...
to a backend users account without needing any knowledge of the password.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/67627");
...
if(version_is_less(version:vers, test_version:"6.2")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"6.2", install_path:path);
