...
if(description)
{
  ...
  script_name("Oracle VirtualBox Multiple Unspecified Vulnerabilities-02 (Aug 2014) - Mac OS X");

  script_tag(name:"summary", value:"Oracle VirtualBox is prone to multiple unspecified vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple flaws exist due to unspecified errors related to the 'core'
  subcomponent.");

  script_tag(name:"impact", value:"Successful exploitation will allow local users to affect confidentiality,
  integrity, and availability via unknown vectors.");

  script_tag(name:"affected", value:"Oracle VirtualBox before versions 3.2.24, 4.0.26, 4.1.34, 4.2.26, and
  4.3.12.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68610");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68613");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68618");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68621");
