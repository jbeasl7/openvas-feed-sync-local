...
if(description)
{
  ...
  script_tag(name:"summary", value:"HTTP based detection of Yawcam (Yet Another Webcam Software).");
  ...
  script_xref(name:"URL", value:"https://www.yawcam.com/");
...
set_kb_item(name: "yawcam/detected", value: TRUE);
set_kb_item(name: "yawcam/http/detected", value: TRUE);
...
log_message(data: build_detection_report(app: "Yawcam", version: version, install: install, cpe: cpe,
                                         concluded: concl),
            port: port);
