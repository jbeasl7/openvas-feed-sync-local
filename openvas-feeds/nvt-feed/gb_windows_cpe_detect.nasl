...
if(description)
{
  ...
  script_version("2025-03-28T15:41:52+0000");
  script_tag(name:"last_modification", value:"2025-03-28 15:41:52 +0000 (Fri, 28 Mar 2025)");
  ...
  script_tag(name:"summary", value:"SMB login-based collection of information about
  installed applications from a Microsoft Windows system.");
...
SCRIPT_DESC = "Windows Application CPE Detection (SMB Login)";
...
if(!handle || !handlereg){
  ...
  if (smbregentriesx && max_index(smbregentriesx) != 0)
  {
    x64 = "1";
      ...
      if (visiopath){
        ...
        if(!VisioRegVer){
          ...
          for(v=0; v<max_index(Visioentry); v++){
            valv = registry_get_sz(key:officekey + entry + "\Visio\" + Visioentry[v], item:"InstalledVersion");
            if (valv )VisioRegVer = valv;
          }
        }
      }
    ...
    for(i=0; i<max_index(entry); i++)
    {
      ...
      if (visiopath){
        ...
        if(!VisioRegVer){
          ...
          if(!Visioentry)Visioentry = Visioregentries;
          for(v=0; v<max_index(Visioentry); v++){
            valv = wmi_reg_get_sz(wmi_handle:handlereg, key:officekey + entry[i] + "\Visio\" + Visioentry[v], key_name:"InstalledVersion");
            if (valv )VisioRegVer = valv;
          }
        }
      }
...
if ("Windows NT" >< OSNAME && OSVER < 3) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt", desc:SCRIPT_DESC);
else if (OSVER == "3.0.1") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt:3.0.1", desc:SCRIPT_DESC);
else if (OSVER == "3.1") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt:3.1", desc:SCRIPT_DESC);
else if (OSVER == "3.5") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt:3.5", desc:SCRIPT_DESC);
else if (OSVER == "3.5.1") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt:3.5.1", desc:SCRIPT_DESC);
else if (OSVER == "3.5.1" && OSSP != "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt:3.5.1:sp" + OSSP, desc:SCRIPT_DESC);
else if (OSVER == "3.51") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_nt:3.51", desc:SCRIPT_DESC);

else if (OSVER == "4.0"){
  cpe = "cpe:/o:microsoft:windows_nt";
  if (OSSP == "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:gold", desc:SCRIPT_DESC);
  else if (OSSP != "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:sp" + OSSP, desc:SCRIPT_DESC);
  else if (OSSP == "0" && "WinNT" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:gold:workstation", desc:SCRIPT_DESC);
  else if (OSSP == "0" && ("ServerNT" >< type || "LanmanNT">< type))os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:gold:server", desc:SCRIPT_DESC);
  else if (OSSP == "0" && "Enterprise" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:gold:enterprise", desc:SCRIPT_DESC);
  else if (OSSP == "0" && "Terminal Server">< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:gold:terminal_server", desc:SCRIPT_DESC);
  else if (OSSP != "0" && "WinNT" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:sp" + OSSP + ":workstation", desc:SCRIPT_DESC);
  else if (OSSP != "0" && ("ServerNT" >< type || "LanmanNT">< type))os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:sp" + OSSP + ":server", desc:SCRIPT_DESC);
  else if (OSSP != "0" && "Enterprise" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:sp" + OSSP + ":enterprise", desc:SCRIPT_DESC);
  else if (OSSP != "0" && "Terminal Server" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0:sp" + OSSP + ":terminal_server", desc:SCRIPT_DESC);
  else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":4.0", desc:SCRIPT_DESC);
}
if (OSVER == "5.0"){
  cpe = "cpe:/o:microsoft:windows_2000";

  if (OSSP == "0" ) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold", desc:SCRIPT_DESC);
  else if (OSSP != "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP, desc:SCRIPT_DESC);
  else if (OSSP == "0" && ("ServerNT" >< type || "LanmanNT">< type))os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:server", desc:SCRIPT_DESC);
  else if (OSSP == "0" && "WinNT" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:professional", desc:SCRIPT_DESC);
  else if (OSSP != "0" && "WinNT" >< type)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":professional", desc:SCRIPT_DESC);
  else if (OSSP != "0" && ("ServerNT" >< type || "LanmanNT">< type))os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":server", desc:SCRIPT_DESC);
  else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_2000", desc:SCRIPT_DESC);
}
if (OSVER == "5.1"){
  cpe = "cpe:/o:microsoft:windows_xp";
  if (OSSP == "0"){
    if (Embedded_NT)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:embedded", desc:SCRIPT_DESC);
    else if ("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:professional", desc:SCRIPT_DESC);
    else if ("home" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:home", desc:SCRIPT_DESC);
    else if ("media" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:media_center", desc:SCRIPT_DESC);
    else if ("tablet" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:tablet_pc", desc:SCRIPT_DESC);
    else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold", desc:SCRIPT_DESC);
  }
  else if (OSSP == "1" || OSSP == "2"){
    if (Embedded_NT)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":embedded", desc:SCRIPT_DESC);
    else if ("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":professional", desc:SCRIPT_DESC);
    else if ("media" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":media_center", desc:SCRIPT_DESC);
    else if ("tablet" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":tablet_pc", desc:SCRIPT_DESC);
  }
  else if (OSSP == "3"){
    if (Embedded_NT)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp3:embedded", desc:SCRIPT_DESC);
    else if ("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp3:professional", desc:SCRIPT_DESC);
    else if ("media" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp3:media_center", desc:SCRIPT_DESC);
    else if ("tablet" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp3:tablet_pc", desc:SCRIPT_DESC);
  }
  if (OSSP != "0" && ("home" >< lowOSNAME )) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":home", desc:SCRIPT_DESC);
  else if (OSSP != "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP, desc:SCRIPT_DESC);
  else if (!OSSP) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_xp", desc:SCRIPT_DESC);
}
if (OSVER == "5.2"){
  if ("WinNT" >< type){
  cpe = "cpe:/o:microsoft:windows_xp";
    if (OSSP != "0" && x64 == "1") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":x64", desc:SCRIPT_DESC);
    if (x64 != 1) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86", desc:SCRIPT_DESC);
    if (OSSP == "2" && x64 != 1) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x86", desc:SCRIPT_DESC);
    if (OSSP == "0" && x64 == "1") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64", desc:SCRIPT_DESC);
  }
  else if ("WinNT" >!< type){
    cpe = "cpe:/o:microsoft:windows_server_2003";
    if (OSCPU && OSOTD != "R2"){
      if (x64 != "1"){
        if (OSSP == "0" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:standard", desc:SCRIPT_DESC);
        else if (OSSP != "0" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":standard", desc:SCRIPT_DESC);
        else if (OSSP == "0" && DataCenter) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:datacenter", desc:SCRIPT_DESC);
        else if (OSSP == "0" && Enterprise) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:enterprise", desc:SCRIPT_DESC);
        else if (OSSP != "0" && DataCenter) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":datacenter", desc:SCRIPT_DESC);
        else if (OSSP != "0" && Enterprise) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":enterprise", desc:SCRIPT_DESC);
        else if (OSSP != "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP, desc:SCRIPT_DESC);
        else if (OSSP == "2") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2", desc:SCRIPT_DESC);
        else if (OSSP == "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold", desc:SCRIPT_DESC);
      }
      else if (x64 == "1"){
        if (OSSP == "0" && OSCPU == "9" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64-standard", desc:SCRIPT_DESC);
        else if (OSSP != "0" && OSCPU == "9" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":x64-standard", desc:SCRIPT_DESC);
        else if (OSSP == "0" && OSCPU == "9" && DataCenter) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64-datacenter", desc:SCRIPT_DESC);
        else if (OSSP == "0" && OSCPU == "9" && Enterprise) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64-enterprise", desc:SCRIPT_DESC);
        else if (OSSP != "0" && OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":x64", desc:SCRIPT_DESC);
        else if (OSSP == "0" && OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64", desc:SCRIPT_DESC);

        if (OSSP == "2" && OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x64", desc:SCRIPT_DESC);
        else if (OSSP == "0" && OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
      }

      if (OSSP == "0" && OSCPU == "6") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:itanium", desc:SCRIPT_DESC);
      if (OSSP == "1" && OSCPU == "6") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:itanium", desc:SCRIPT_DESC);
      if (OSSP == "2" && OSCPU == "6") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:itanium", desc:SCRIPT_DESC);

    }
    else if (OSCPU && OSOTD == "R2"){
      if (x64 != "1"){
        if (16384 >= OSPRODS) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:compute_cluster", desc:SCRIPT_DESC);
        else if (Stor_Serv_2003R2) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:storage", desc:SCRIPT_DESC);
        else if (!DataCenter && !Enterprise && !Web_2003 && !SBS_R && !Stor_Serv_2003R2) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:standard", desc:SCRIPT_DESC);
        else if (Enterprise) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:enterprise", desc:SCRIPT_DESC);
        else if (DataCenter) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:datacenter", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2", desc:SCRIPT_DESC);
      }
      else if (x64 == "1"){
        if (OSCPU == "9" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R && !Stor_Serv_2003R2) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:x64-standard", desc:SCRIPT_DESC);
        else if (Enterprise && OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:x64-enterprise", desc:SCRIPT_DESC);
        else if (DataCenter && OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:x64-datacenter", desc:SCRIPT_DESC);
        else if (OSCPU == "9") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":r2:-:x64", desc:SCRIPT_DESC);
      }
    }
...
#        else if (OSSP != "0" && DataCenter) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":datacenter", desc:SCRIPT_DESC);
#        else if (OSSP != "0" && Enterprise) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":enterprise", desc:SCRIPT_DESC);
        if (OSSP != "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP, desc:SCRIPT_DESC);
        else if (OSSP == "2") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2", desc:SCRIPT_DESC);
        else if (OSSP == "0") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold", desc:SCRIPT_DESC);
      }
      else if (x64 == "1"){
#        if (OSSP == "0" && cputype == "AMD64" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64-standard", desc:SCRIPT_DESC);
#        else if (OSSP != "0" && cputype == "AMD64" && !DataCenter && !Enterprise && !Web_2003 && !SBS_R) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":x64-standard", desc:SCRIPT_DESC);
#        else if (OSSP == "0" && cputype == "AMD64" && DataCenter) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64-datacenter", desc:SCRIPT_DESC);
#        else if (OSSP == "0" && cputype == "AMD64" && Enterprise) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64-enterprise", desc:SCRIPT_DESC);
        if (OSSP != "0" && cputype == "AMD64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp" + OSSP + ":x64", desc:SCRIPT_DESC);
        else if (OSSP == "0" && cputype == "AMD64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64", desc:SCRIPT_DESC);
        else if (OSSP == "0" && cputype == "AMD64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:x64", desc:SCRIPT_DESC);
        if (OSSP == "2" && cputype == "AMD64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x64", desc:SCRIPT_DESC);
        else if (OSSP == "0" && cputype == "AMD64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
      }
      if (OSSP == "0" && cputype =="IA64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:itanium", desc:SCRIPT_DESC);
      if (OSSP == "1" && cputype =="IA64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:itanium", desc:SCRIPT_DESC);
      if (OSSP == "2" && cputype =="IA64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:itanium", desc:SCRIPT_DESC);
    }
    else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe, desc:SCRIPT_DESC);
  }
}
if (OSVER == "6.0"){
  if(OSTYPE == "1"){#Vista
    ...
    if (x64 != "1"){
      if (OSSP == "0"){
        if(OSSKU == "4")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "1")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-ultimate", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86", desc:SCRIPT_DESC);
      }
      if (OSSP == "1"){
        if(OSSKU == "4")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "1")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-ultimate", desc:SCRIPT_DESC);
        else{
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1", desc:SCRIPT_DESC);
        }
      }
      if (OSSP == "2"){
        os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2", desc:SCRIPT_DESC);
      }
    }
    else if (x64 == "1"){
      if (OSSP == "0"){
        if(OSSKU == "4")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "1")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-ultimate", desc:SCRIPT_DESC);
        else {
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
        }
      }
      if (OSSP == "1"){
        if(OSSKU == "4")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "1")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-ultimate", desc:SCRIPT_DESC);
        else if(OSSKU == "3")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-home_premium", desc:SCRIPT_DESC);
        else {
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64", desc:SCRIPT_DESC);
        }
      }
      if (OSSP == "2"){
        os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x64", desc:SCRIPT_DESC);
      }
    }
    else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe, desc:SCRIPT_DESC);
  }
    ...
    if (x64 != "1"){
      if (OSSP == "0"){
        if(OSSKU == "8" || OSSKU == "12")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:datacenter", desc:SCRIPT_DESC);
        else if(OSSKU == "4" || OSSKU == "14"|| OSSKU == "10")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "18")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:hpc", desc:SCRIPT_DESC);
        else if(OSSKU == "7" || OSSKU == "13")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:standard", desc:SCRIPT_DESC);
        else if(OSSKU == "20" || OSSKU == "21" || OSSKU == "22" || OSSKU == "23")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:storage", desc:SCRIPT_DESC);
        else if(OSSKU == "17")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:web", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold", desc:SCRIPT_DESC);
      }
      else if (OSSP == "1"){
        if(OSSKU == "4" || OSSKU == "14")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:enterprise", desc:SCRIPT_DESC);
      }
      else if (OSSP == "2"){
        if(OSSKU == "8" || OSSKU == "12")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:datacenter", desc:SCRIPT_DESC);
        else if(OSSKU == "4" || OSSKU == "14"|| OSSKU == "10")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "18")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:hpc", desc:SCRIPT_DESC);
        else if(OSSKU == "7" || OSSKU == "13")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:standard", desc:SCRIPT_DESC);
        else if(OSSKU == "20" || OSSKU == "21" || OSSKU == "22" || OSSKU == "23")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:storage", desc:SCRIPT_DESC);
        else if(OSSKU == "17")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:web", desc:SCRIPT_DESC);
        else {
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2", desc:SCRIPT_DESC);
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x32", desc:SCRIPT_DESC);
        }
      }
      else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x32", desc:SCRIPT_DESC);
    }
    else if (x64 == "1" && OSCPU != "6"){
      if (OSSP == "0"){
      }
      else if (OSSP == "1"){
        if(OSSKU == "4" || OSSKU == "14"|| OSSKU == "10")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:enterprise_x64", desc:SCRIPT_DESC);
      }
      else if (OSSP == "2"){
        os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x64", desc:SCRIPT_DESC);
        if(OSSKU == "4" || OSSKU == "14"|| OSSKU == "10")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:enterprise_x64", desc:SCRIPT_DESC);
      }
      else{
        os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
      }
    }
    else if (OSSP == "0" && OSSKU == "15") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:itanium", desc:SCRIPT_DESC);
    else if (OSSP == "0" && OSSKU == "15") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:itanium", desc:SCRIPT_DESC);
    else if (OSSP == "2" && OSSKU == "15") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:itanium", desc:SCRIPT_DESC);
    else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe, desc:SCRIPT_DESC);
  }
  #SMB fallback. Is not so exactly as wmi.
  else if(!OSTYPE){
    if("Vista" >< OSNAME){#Vista
      ...
      if (x64 != "1"){
        if (OSSP == "0"){
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-enterprise", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-ultimate", desc:SCRIPT_DESC);
          else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86", desc:SCRIPT_DESC);
        }
        if (OSSP == "1"){
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-enterprise", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-ultimate", desc:SCRIPT_DESC);
          else{
            os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1", desc:SCRIPT_DESC);
          }
        }
        ...
        if (OSSP == "0"){
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-enterprise", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-ultimate", desc:SCRIPT_DESC);
          else if("premium" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-home_premium", desc:SCRIPT_DESC);
          else {
            os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
          }
        }
        if (OSSP == "1"){
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-enterprise", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-ultimate", desc:SCRIPT_DESC);
          else if("premium" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-home_premium", desc:SCRIPT_DESC);
          else {
            os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64", desc:SCRIPT_DESC);
          }
        }
    ...
    if("Windows Server 2008" >< OSNAME){#Windows 2008
      ...
      if (x64 != "1"){
        if (OSSP == "0"){
          if("datacenter" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:datacenter", desc:SCRIPT_DESC);
          else if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:enterprise", desc:SCRIPT_DESC);
          else if("cluster" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:hpc", desc:SCRIPT_DESC);
          else if("standard" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:standard", desc:SCRIPT_DESC);
          else if("storage" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:storage", desc:SCRIPT_DESC);
          else if("web" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:web", desc:SCRIPT_DESC);
          else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold", desc:SCRIPT_DESC);
        }
        else if (OSSP == "1"){
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:enterprise", desc:SCRIPT_DESC);
        }
        else if (OSSP == "2"){
          if("datacenter" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:datacenter", desc:SCRIPT_DESC);
          else if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:enterprise", desc:SCRIPT_DESC);
          else if("cluster" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:hpc", desc:SCRIPT_DESC);
          else if("standard" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:standard", desc:SCRIPT_DESC);
          else if("storage" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:storage", desc:SCRIPT_DESC);
          else if("web" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:web", desc:SCRIPT_DESC);
          else {
            os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2", desc:SCRIPT_DESC);
            os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x32", desc:SCRIPT_DESC);
          }
        ...
        if (OSSP == "0"){
          ...
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:enterprise_x64", desc:SCRIPT_DESC);
        }
        else if (OSSP == "2"){
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:x64", desc:SCRIPT_DESC);
          if("enterprise" >< lowOSNAME)os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:enterprise_x64", desc:SCRIPT_DESC);
        }
        else{
          os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
        }
      }
      else if (OSSP == "0" && cputype =="IA64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:itanium", desc:SCRIPT_DESC);
      else if (OSSP == "0" && cputype =="IA64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:gold:itanium", desc:SCRIPT_DESC);
      else if (OSSP == "2" && cputype =="IA64") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp2:itanium", desc:SCRIPT_DESC);
      else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe, desc:SCRIPT_DESC);
    }
  }
}
...
if (OSVER == "6.1"){
  ...
  if(OSTYPE == "1"){#Windows 7
    if (x64 != "1"){
      if (OSSP == "0"){
        if(OSSKU == "4" || OSSKU == "27") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "2") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-home_basic", desc:SCRIPT_DESC);
        else if(OSSKU == "3") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-home_premium", desc:SCRIPT_DESC);
        else if(OSSKU == "48" || OSSKU == "103") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-professional", desc:SCRIPT_DESC);
        else if(OSSKU == "11") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-starter", desc:SCRIPT_DESC);
        else if(OSSKU == "1" || OSSKU == "28") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-ultimate", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86", desc:SCRIPT_DESC);
      }
      if (OSSP == "1"){
        if(OSSKU == "4" || OSSKU == "27")  os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "2") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-home_basic", desc:SCRIPT_DESC);
        else if(OSSKU == "3") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-home_premium", desc:SCRIPT_DESC);
        else if(OSSKU == "48" || OSSKU == "103") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-professional", desc:SCRIPT_DESC);
        else if(OSSKU == "11") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-starter", desc:SCRIPT_DESC);
        else if(OSSKU == "1" || OSSKU == "28") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-ultimate", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86", desc:SCRIPT_DESC);
      }
    }
    if (x64 == "1"){
      if (OSSP == "0"){
        if(OSSKU == "4" || OSSKU == "27")  os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "2") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-home_basic", desc:SCRIPT_DESC);
        else if(OSSKU == "3") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-home_premium", desc:SCRIPT_DESC);
        else if(OSSKU == "48" || OSSKU == "103") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-professional", desc:SCRIPT_DESC);
        else if(OSSKU == "11") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-starter", desc:SCRIPT_DESC);
        else if(OSSKU == "1" || OSSKU == "28") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-ultimate", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
      }
      if (OSSP == "1"){
        if(OSSKU == "4" || OSSKU == "27")  os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-enterprise", desc:SCRIPT_DESC);
        else if(OSSKU == "2") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-home_basic", desc:SCRIPT_DESC);
        else if(OSSKU == "3") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-home_premium", desc:SCRIPT_DESC);
        else if(OSSKU == "48" || OSSKU == "103") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-professional", desc:SCRIPT_DESC);
        else if(OSSKU == "11") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-starter", desc:SCRIPT_DESC);
        else if(OSSKU == "1" || OSSKU == "28") os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-ultimate", desc:SCRIPT_DESC);
        else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64", desc:SCRIPT_DESC);
      }
    }
  }
    ...
    if (OSSP == "0"){
      if (OSSKU != "15")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe, desc:SCRIPT_DESC);
      if (OSSKU != "15")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:x64", desc:SCRIPT_DESC);
      if (OSSKU == "15")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:itanium", desc:SCRIPT_DESC);
    }
    if (OSSP == "1"){
      if (OSSKU != "15")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":sp1:x64", desc:SCRIPT_DESC);
      if (OSSKU == "15")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":sp1:itanium", desc:SCRIPT_DESC);
    }
  }
  #SMB fallback. Is not so exactly as wmi.
  else if(!OSTYPE){
    if ("Windows Server 2008" >< OSNAME){
      cpe = "cpe:/o:microsoft:windows_server_2008:r2";
      if (OSSP == "0"){
        if (cputype !="IA64")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe, desc:SCRIPT_DESC);
        else if (cputype =="AMD64" && x64 == "1")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:x64", desc:SCRIPT_DESC);
        else if (cputype =="IA64")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:itanium", desc:SCRIPT_DESC);
      }
      if (OSSP == "1"){
        if (cputype =="AMD64" && x64 == "1")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":sp1:x64", desc:SCRIPT_DESC);
        else if (cputype =="IA64")os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":sp1:itanium", desc:SCRIPT_DESC);
      }
    }
      ...
      if (x64 != "1"){
        if (OSSP == "0"){
          if("enterprise" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-enterprise", desc:SCRIPT_DESC);
          else if("home_basic" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-home_basic", desc:SCRIPT_DESC);
          else if("home_premium" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-home_premium", desc:SCRIPT_DESC);
          else if("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-professional", desc:SCRIPT_DESC);
          else if("starter" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-starter", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86-ultimate", desc:SCRIPT_DESC);
          else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86", desc:SCRIPT_DESC);
        }
        if (OSSP == "1"){
          if("enterprise" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-enterprise", desc:SCRIPT_DESC);
          else if("home_basic" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-home_basic", desc:SCRIPT_DESC);
          else if("home_premium" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-home_premium", desc:SCRIPT_DESC);
          else if("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-professional", desc:SCRIPT_DESC);
          else if("starter" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-starter", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86-ultimate", desc:SCRIPT_DESC);
          else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x86", desc:SCRIPT_DESC);
        }
      }
      if (x64 == "1"){
        if (OSSP == "0"){
          if("enterprise" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-enterprise", desc:SCRIPT_DESC);
          else if("home_basic" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-home_basic", desc:SCRIPT_DESC);
          else if("home_premium" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-home_premium", desc:SCRIPT_DESC);
          else if("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-professional", desc:SCRIPT_DESC);
          else if("starter" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-starter", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64-ultimate", desc:SCRIPT_DESC);
          else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x64", desc:SCRIPT_DESC);
        }
        if (OSSP == "1"){
          if("enterprise" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-enterprise", desc:SCRIPT_DESC);
          else if("home_basic" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-home_basic", desc:SCRIPT_DESC);
          else if("home_premium" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-home_premium", desc:SCRIPT_DESC);
          else if("professional" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-professional", desc:SCRIPT_DESC);
          else if("starter" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-starter", desc:SCRIPT_DESC);
          else if("ultimate" >< lowOSNAME) os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64-ultimate", desc:SCRIPT_DESC);
          else os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:sp1:x64", desc:SCRIPT_DESC);
        }
      }
...
if (OSVER == "6.2"){
  ...
  if(OSTYPE == "1"){#Windows 8
    if (x64 != "1"){
      if (OSSP == "0"){
        os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:cpe + ":-:-:x86", desc:SCRIPT_DESC);
      }
    }
    if (x64 == "1"){
      if (OSSP == "0"){
    ...
    if (OSSP == "0"){
      os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_server_2012", desc:SCRIPT_DESC);
    }
    if (OSSP == "1"){
      os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_server_2012:-:sp1", desc:SCRIPT_DESC);
    }
  }
  #SMB fallback. Is not so exactly as wmi.
  else if(!OSTYPE){
...
if (OSVER == "6.3"){
  if(OSTYPE == "1"){#Windows 8.1
    os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_8.1", desc:SCRIPT_DESC);
  }
  else if(OSTYPE == "2" || OSTYPE == "3"){#Windows 2012 R2
    if (OSSP == "0"){
      os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_server_2012:r2", desc:SCRIPT_DESC);
    }
    if (OSSP == "1"){
      os_register_and_report( os:OSNAME, runs_key:"windows", banner_type:BANNER_TYPE, cpe:"cpe:/o:microsoft:windows_server_2012:r2:sp1", desc:SCRIPT_DESC);
    }
  }
  #SMB fallback. Is not so exactly as wmi.
  else if(!OSTYPE){
    ...
    else if ("Windows Server 2025" >< OSNAME){
...
if (iever){
  ...
  else if (version_is_equal(version:iever, test_version:"6.00.2600.0000") ||
           version_is_equal(version:iever, test_version:"6.0.2600")) {
  ...
  else if (version_is_equal(version:iever, test_version:"6.00.2800.1106") ||
           version_is_equal(version:iever, test_version:"6.0.2800.1106")) {
...
if (IISMajorVersion >= "1" && IISMinorVersion){
  ...
  if (IISMajorVersion == "4" && IISMinorVersion == "0"){
    ...
    register_host_detail(name:"App", value:cpe + ":7.5", desc:SCRIPT_DESC);
  }
  else register_host_detail(name:"App", value:cpe, desc:SCRIPT_DESC);
}
