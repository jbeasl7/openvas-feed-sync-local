...
if(description)
{
  ...
  script_name("PHP < 5.4.40, 5.5.x < 5.5.24, 5.6.x < 5.6.8 Improper Input Validation Vulnerability (Jun 2015) - Windows");
  ...
  script_tag(name:"insight", value:"The flaw occurs in the php_handler function in
