...
if(description)
{
  ...
  script_name("Wireshark Denial-of-Service Vulnerability-02 (Mar 2015) - Mac OS X");
  ...
  script_tag(name:"solution", value:"Update to version 1.12.4, 1.10.3 or
  later.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/72942");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/72944");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/72941");
...
if(version_in_range(version:vers, test_version:"1.12.0", test_version2:"1.12.3")) {
  fix = "1.12.4";
  VULN = TRUE;
}

else if(version_in_range(version:vers, test_version:"1.10.0", test_version2:"1.10.12")) {
  fix = "1.10.13";
  VULN = TRUE;
}
