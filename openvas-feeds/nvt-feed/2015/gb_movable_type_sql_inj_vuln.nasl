...
if(description)
{
  ...
  script_name("Movable Type SQLi Vulnerability (Dec 2014)");
  ...
  script_tag(name:"summary", value:"Movable Type is prone to an SQL injection (SQLi)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to the XML-RPC interface not properly
  sanitizing user-supplied input to unspecified vectors.");
  ...
  script_tag(name:"affected", value:"Movable Type prior to version 5.2.11, 5.18 or 6.0.6.");

  script_tag(name:"solution", value:"Update to version 5.2.11, 5.18, 6.0.6 or later.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "5.3", test_version_up: "5.18")) {
