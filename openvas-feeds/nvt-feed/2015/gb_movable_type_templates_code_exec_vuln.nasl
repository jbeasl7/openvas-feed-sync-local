...
if(description)
{
  ...
  script_name("Movable Type RCE Vulnerability (Apr 2015)");
  ...
  script_tag(name:"insight", value:"The flaw is due to the format string specifiers are not
  properly sanitized in user-supplied input. This may allow a remote attacker to cause a denial of
  service or potentially execute arbitrary code.");

  script_tag(name:"impact", value:"Successful exploitation will allow an unauthenticated remote
  attacker to execute arbitrary code in an affected site.");

  script_tag(name:"affected", value:"Movable Type prior to version 5.2.13 and 6.x prior to
  6.0.8.");

  script_tag(name:"solution", value:"Update to version 5.2.13, 6.0.8 or later.");
