...
if(description)
{
  ...
  script_name("PHP Multiple Vulnerabilities (Jan 2015)");
  ...
  script_tag(name:"affected", value:"PHP versions 5.4.x before 5.4.34, 5.5.x before 5.5.18, and
  5.6.x before 5.6.2");

  script_tag(name:"solution", value:"Update to version 5.4.34, 5.5.18, 5.6.2 or later.");
...
if (version_in_range(version: version, test_version: "5.4.0", test_version2: "5.4.33")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.4.34", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "5.5.0", test_version2: "5.5.17")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.5.18", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "5.6.0", test_version2: "5.6.1")) {
