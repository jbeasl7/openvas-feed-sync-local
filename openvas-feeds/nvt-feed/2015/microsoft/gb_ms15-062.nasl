...
if(description)
{
  ...
  script_name("Microsoft Active Directory Federation Services Privilege Escalation Vulnerability (3062577)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75023");
