...
if(description)
{
  ...
  script_name("Wireshark Multiple Denial-of-Service Vulnerabilities-01 (Jul 2015) - Mac OS X");
...
if(version_in_range(version:vers, test_version:"1.12.0", test_version2:"1.12.5")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"1.12.6", install_path:path);
