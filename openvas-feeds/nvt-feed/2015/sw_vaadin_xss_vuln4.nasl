...
if(description)
{
  ...
  script_name("Vaadin Framework 7.0.0 - 7.3.6 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"This flaw exists due to proper escaping of HTML in portlet
  error message was not ensured.");

  script_tag(name:"impact", value:"This could allow a reflected cross-site scripting attack through
  VaadinPortlet by making the user load a URL designed to include an error message crafted by the
  attacker.");

  script_tag(name:"affected", value:"Vaadin Framework version 7.0.0 through 7.3.6.");

  script_tag(name:"solution", value:"Update to version 7.3.7 or later.");
...
if( version_in_range( version:version, test_version:"7.0.0", test_version2:"7.3.6" ) ) {
