...
if (description)
{
  ...
  script_name("pfSense Multiple Vulnerabilities (pfSense-SA-15_06.webgui)");
  ...
  - Various other input validation errors.");
  ...
  script_tag(name:"affected", value:"pfSense prior to version 2.2.3.");
