...
if(description)
{
  ...
  script_name("Oracle MySQL Multiple Unspecified vulnerabilities-02 (Apr 2015) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/74078");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/74073");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/74103");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/74089");
...
if(vers =~ "^5\.[56]\.")
{
  if(version_in_range(version:vers, test_version:"5.5", test_version2:"5.5.41") ||
     version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.22"))
  {
