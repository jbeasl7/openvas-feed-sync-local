...
if(description)
{
  ...
  script_name("Apple Mac OS X Multiple Vulnerabilities-01 (Jul 2015)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75493");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75495");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75491");
