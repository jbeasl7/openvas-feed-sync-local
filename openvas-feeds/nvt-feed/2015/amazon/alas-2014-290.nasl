...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:18:45 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-290");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-290.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby19' package(s) announced via the ALAS-2014-290 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem19-json", rpm:"rubygem19-json~1.5.5~32.60.amzn1", rls:"AMAZON"))) {
    report += res;
  }
