...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-197");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-197.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls' package(s) announced via the ALAS-2013-197 advisory.");
