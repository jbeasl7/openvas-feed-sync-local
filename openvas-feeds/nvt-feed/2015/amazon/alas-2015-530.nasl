...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:55 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-530");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby19' package(s) announced via the ALAS-2015-530 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby19-devel", rpm:"ruby19-devel~1.9.3.551~32.66.amzn1", rls:"AMAZON"))) {
    report += res;
  }
