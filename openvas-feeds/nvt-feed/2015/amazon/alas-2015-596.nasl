...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-25 08:17:58 +0000 (Fri, 25 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-596");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-596.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss-softokn' package(s) announced via the ALAS-2015-596 advisory.");
  ...
  script_tag(name:"affected", value:"'nss-softokn' package(s) on Amazon Linux.");
