...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-22 05:25:44 +0000 (Thu, 22 Oct 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-601");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-601.html");
  script_xref(name:"URL", value:"https://bugs.php.net/bug.php?id=69720");
  script_xref(name:"URL", value:"https://bugs.php.net/bug.php?id=70433");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php56' package(s) announced via the ALAS-2015-601 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"As reported upstream, A NULL pointer dereference flaw was found in the way PHP's Phar extension parsed Phar archives. A specially crafted archive could cause PHP to crash. (CVE-2015-7803 )
