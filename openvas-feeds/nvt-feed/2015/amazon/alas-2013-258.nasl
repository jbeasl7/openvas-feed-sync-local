...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:29:06 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-258");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-258.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel' package(s) announced via the ALAS-2013-258 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-debuginfo-common-x86_64", rpm:"kernel-debuginfo-common-x86_64~3.4.73~64.112.amzn1", rls:"AMAZON"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-devel", rpm:"kernel-devel~3.4.73~64.112.amzn1", rls:"AMAZON"))) {
    report += res;
  }
