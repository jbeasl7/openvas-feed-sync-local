...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-605");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-605.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.7.0-openjdk' package(s) announced via the ALAS-2015-605 advisory.");
