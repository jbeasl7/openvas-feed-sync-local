...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-524");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-524.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php' package(s) announced via the ALAS-2015-524 advisory.");
