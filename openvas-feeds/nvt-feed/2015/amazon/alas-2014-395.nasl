...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-395");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-395.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'exim' package(s) announced via the ALAS-2014-395 advisory.");
  ...
  script_tag(name:"affected", value:"'exim' package(s) on Amazon Linux.");
