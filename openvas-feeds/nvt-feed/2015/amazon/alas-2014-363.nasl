...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-363");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-363.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel' package(s) announced via the ALAS-2014-363 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-debuginfo-common-x86_64", rpm:"kernel-debuginfo-common-x86_64~3.10.42~52.145.amzn1", rls:"AMAZON"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"perf", rpm:"perf~3.10.42~52.145.amzn1", rls:"AMAZON"))) {
    report += res;
  }
