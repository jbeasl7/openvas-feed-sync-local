...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-12-15 00:51:27 +0000 (Tue, 15 Dec 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-626");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-626.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'autofs' package(s) announced via the ALAS-2015-626 advisory.");
  ...
  script_tag(name:"affected", value:"'autofs' package(s) on Amazon Linux.");
