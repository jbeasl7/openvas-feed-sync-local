...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-538");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-538.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the '389-ds-base' package(s) announced via the ALAS-2015-538 advisory.");
