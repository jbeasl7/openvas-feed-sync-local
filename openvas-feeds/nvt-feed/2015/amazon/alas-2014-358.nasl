...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:23:26 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-358");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-358.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Capture-Tiny' package(s) announced via the ALAS-2014-358 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was found [1] that the Capture::Tiny module, provided by the perl-Capture-Tiny package, used the File::temp::tmpnam module to generate temporary files:
...
This module makes use of the mktemp() function when called in the scalar context, which creates significantly more predictable temporary files. Additionally, the temporary file is created with world-writable (0666) permission. A local attacker could use this flaw to perform a symbolic link attack, overwriting arbitrary files accessible to a program using the Capture::Tiny module.");
  ...
  script_tag(name:"affected", value:"'perl-Capture-Tiny' package(s) on Amazon Linux.");
