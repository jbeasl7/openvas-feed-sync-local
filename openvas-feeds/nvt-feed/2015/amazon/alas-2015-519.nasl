...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:29:02 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-519");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-519.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-x11-server' package(s) announced via the ALAS-2015-519 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server", rpm:"xorg-x11-server~1.15.0~26.41.amzn1", rls:"AMAZON"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-debuginfo", rpm:"xorg-x11-server-debuginfo~1.15.0~26.41.amzn1", rls:"AMAZON"))) {
    report += res;
  }
