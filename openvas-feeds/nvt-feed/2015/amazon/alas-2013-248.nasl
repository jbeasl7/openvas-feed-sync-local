...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:17:49 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-248");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-248.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby' package(s) announced via the ALAS-2013-248 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby-ri", rpm:"ruby-ri~1.8.7.374~2.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }
