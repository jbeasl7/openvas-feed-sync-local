...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:21:58 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2012-104");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2012-104.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-x11-server' package(s) announced via the ALAS-2012-104 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was found in the way the X.Org server handled lock files. A local user with access to the system console could use this flaw to determine the existence of a file in a directory not accessible to the user, via a symbolic link attack. (CVE-2011-4028)
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server", rpm:"xorg-x11-server~1.10.6~1.12.amzn1", rls:"AMAZON"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-debuginfo", rpm:"xorg-x11-server-debuginfo~1.10.6~1.12.amzn1", rls:"AMAZON"))) {
    report += res;
  }
