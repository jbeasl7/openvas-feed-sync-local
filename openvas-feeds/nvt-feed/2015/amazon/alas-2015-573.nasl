...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-573");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-573.html");
  script_xref(name:"URL", value:"https://kb.isc.org/article/AA-01272/0");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the ALAS-2015-573 advisory.");
