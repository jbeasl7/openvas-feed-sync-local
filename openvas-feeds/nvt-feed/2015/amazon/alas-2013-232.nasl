...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:19:37 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-232");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-232.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xinetd' package(s) announced via the ALAS-2013-232 advisory.");
  ...
  script_tag(name:"affected", value:"'xinetd' package(s) on Amazon Linux.");
