...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-11-08 11:10:58 +0000 (Sun, 08 Nov 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-606");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-606.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk' package(s) announced via the ALAS-2015-606 advisory.");
