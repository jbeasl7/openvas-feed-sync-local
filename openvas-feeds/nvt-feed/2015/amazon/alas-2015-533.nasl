...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:54 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-533");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby22' package(s) announced via the ALAS-2015-533 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rubygem22-bigdecimal", rpm:"rubygem22-bigdecimal~1.2.6~1.5.amzn1", rls:"AMAZON"))) {
    report += res;
  }
