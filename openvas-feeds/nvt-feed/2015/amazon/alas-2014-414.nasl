...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:17:02 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-414");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-414.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'httpd' package(s) announced via the ALAS-2014-414 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"httpd-tools", rpm:"httpd-tools~2.2.29~1.4.amzn1", rls:"AMAZON"))) {
    report += res;
  }
