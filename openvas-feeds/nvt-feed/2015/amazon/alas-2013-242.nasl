...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:17:51 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-242");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-242.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'scipy' package(s) announced via the ALAS-2013-242 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"scipy: weave /tmp and current directory issues (CVE-2013-4251)");

  script_tag(name:"affected", value:"'scipy' package(s) on Amazon Linux.");
