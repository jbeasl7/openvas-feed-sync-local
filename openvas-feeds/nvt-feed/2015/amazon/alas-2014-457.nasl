...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:14:59 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-457");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-457.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the ALAS-2014-457 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav-devel", rpm:"clamav-devel~0.98.5~1.10.amzn1", rls:"AMAZON"))) {
    report += res;
  }
