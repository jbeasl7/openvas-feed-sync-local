...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:26:38 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-540");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-540.html");
  script_xref(name:"URL", value:"http://seclists.org/oss-sec/2014/q4/557");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libjpeg-turbo' package(s) announced via the ALAS-2015-540 advisory.");
  ...
  script_tag(name:"affected", value:"'libjpeg-turbo' package(s) on Amazon Linux.");
