...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:15:24 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-204");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-204.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.7.0-openjdk' package(s) announced via the ALAS-2013-204 advisory.");
...
It was found that documentation generated by Javadoc was vulnerable to a frame injection attack. If such documentation was accessible over a network, and a remote attacker could trick a user into visiting a specially-crafted URL, it would lead to arbitrary web content being displayed next to the documentation. This could be used to perform a phishing attack by providing frame content that spoofed a login ... [Please see the references for more information on the vulnerabilities]");
