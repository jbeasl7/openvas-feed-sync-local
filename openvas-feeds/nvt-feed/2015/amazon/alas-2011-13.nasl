...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 09:22:42 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2011-13");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2011-13.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-x11-server' package(s) announced via the ALAS-2011-13 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple input sanitization flaws were found in the X.Org GLX (OpenGL extension to the X Window System) extension. A malicious, authorized client could use these flaws to crash the X.Org server or, potentially, execute arbitrary code with root privileges. (CVE-2010-4818)
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server", rpm:"xorg-x11-server~1.7.7~29.10.amzn1", rls:"AMAZON"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-debuginfo", rpm:"xorg-x11-server-debuginfo~1.7.7~29.10.amzn1", rls:"AMAZON"))) {
    report += res;
  }
