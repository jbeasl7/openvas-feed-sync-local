...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:24:20 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-435");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-435.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php55' package(s) announced via the ALAS-2014-435 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An out of bounds read flaw was found in the way the xmlrpc extension parsed dates in the ISO 8601 format. A specially crafted XML-RPC request or response could possibly cause a PHP application to crash. (CVE-2014-3668)
