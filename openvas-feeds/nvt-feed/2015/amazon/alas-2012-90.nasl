...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2012-90");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2012-90.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'quagga' package(s) announced via the ALAS-2012-90 advisory.");
