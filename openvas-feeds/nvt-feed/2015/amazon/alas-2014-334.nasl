...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-334");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-334.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mod24_security' package(s) announced via the ALAS-2014-334 advisory.");
  ...
  script_tag(name:"affected", value:"'mod24_security' package(s) on Amazon Linux.");
