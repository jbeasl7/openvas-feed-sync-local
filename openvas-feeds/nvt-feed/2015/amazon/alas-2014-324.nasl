...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:33 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-324");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-324.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-YAML-LibYAML' package(s) announced via the ALAS-2014-324 advisory.");
...
Heap-based buffer overflow in the yaml_parser_scan_uri_escapes function in LibYAML before 0.1.6 allows context-dependent attackers to execute arbitrary code via a long sequence of percent-encoded characters in a URI in a YAML file.");
  ...
  script_tag(name:"affected", value:"'perl-YAML-LibYAML' package(s) on Amazon Linux.");
