...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:27:58 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-582");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-582.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mailman' package(s) announced via the ALAS-2015-582 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was found that mailman did not sanitize the list name before passing it to certain MTAs. A local attacker could use this flaw to execute arbitrary code as the user running mailman. (CVE-2015-2775)
...
It was found that mailman stored private email messages in a world-readable directory. A local user could use this flaw to read private mailing list archives. (CVE-2002-0389)");
  ...
  script_tag(name:"affected", value:"'mailman' package(s) on Amazon Linux.");
