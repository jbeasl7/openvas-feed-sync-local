...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-221");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-221.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'subversion' package(s) announced via the ALAS-2013-221 advisory.");
