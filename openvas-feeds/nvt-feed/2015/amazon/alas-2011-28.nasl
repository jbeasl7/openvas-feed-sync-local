...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 09:24:53 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2011-28");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2011-28.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5' package(s) announced via the ALAS-2011-28 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"krb5", rpm:"krb5~1.9~22.20.amzn1", rls:"AMAZON"))) {
    report += res;
  }
