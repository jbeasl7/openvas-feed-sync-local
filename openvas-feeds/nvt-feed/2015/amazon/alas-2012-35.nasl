...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:37 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2012-35");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2012-35.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby' package(s) announced via the ALAS-2012-35 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby-devel", rpm:"ruby-devel~1.8.7.357~1.10.amzn1", rls:"AMAZON"))) {
    report += res;
  }
