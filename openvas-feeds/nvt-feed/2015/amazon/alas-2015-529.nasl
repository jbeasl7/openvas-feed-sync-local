...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:16:22 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-529");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby18' package(s) announced via the ALAS-2015-529 advisory.");
  ...
  script_tag(name:"affected", value:"'ruby18' package(s) on Amazon Linux.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby18", rpm:"ruby18~1.8.7.374~2.42.4.amzn1", rls:"AMAZON"))) {
    report += res;
  }
