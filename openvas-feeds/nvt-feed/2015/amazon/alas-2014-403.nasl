...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-403");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-403.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libXext' package(s) announced via the ALAS-2014-403 advisory.");
  ...
  script_tag(name:"affected", value:"'libXext' package(s) on Amazon Linux.");
