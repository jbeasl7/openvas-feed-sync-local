...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:23:39 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-486");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-486.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the ALAS-2015-486 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav-milter", rpm:"clamav-milter~0.98.6~1.11.amzn1", rls:"AMAZON"))) {
    report += res;
  }
