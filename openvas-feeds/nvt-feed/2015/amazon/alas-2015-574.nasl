...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:22:40 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-574");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-574.html");
  script_xref(name:"URL", value:"https://blog.fuzzing-project.org/5-Multiple-issues-in-GnuPG-found-through-keyring-fuzzing-TFPA-0012015.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnupg2' package(s) announced via the ALAS-2015-574 advisory.");
  ...
  script_tag(name:"affected", value:"'gnupg2' package(s) on Amazon Linux.");
