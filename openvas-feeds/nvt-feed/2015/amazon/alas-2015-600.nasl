...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-13 04:35:21 +0000 (Tue, 13 Oct 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-600");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-600.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libunwind' package(s) announced via the ALAS-2015-600 advisory.");
  ...
  script_tag(name:"affected", value:"'libunwind' package(s) on Amazon Linux.");
