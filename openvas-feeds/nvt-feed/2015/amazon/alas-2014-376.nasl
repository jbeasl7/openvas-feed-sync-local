...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:29:57 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-376");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-376.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mod_wsgi' package(s) announced via the ALAS-2014-376 advisory.");
...
mod_wsgi allows you to host Python applications on the Apache HTTP Server. It was found that a remote attacker could leak portions of a mod_wsgi application's memory via the Content-Type header.");
  ...
  script_tag(name:"affected", value:"'mod_wsgi' package(s) on Amazon Linux.");
