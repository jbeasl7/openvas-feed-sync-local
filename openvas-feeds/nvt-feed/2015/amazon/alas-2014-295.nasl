...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-295");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-295.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the ALAS-2014-295 advisory.");
