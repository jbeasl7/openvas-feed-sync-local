...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:17:52 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2013-243");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2013-243.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-crypto' package(s) announced via the ALAS-2013-243 advisory.");
  ...
  script_tag(name:"affected", value:"'python-crypto' package(s) on Amazon Linux.");
