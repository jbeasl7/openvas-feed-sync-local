...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 09:27:36 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2011-9");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2011-9.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'httpd' package(s) announced via the ALAS-2011-9 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"httpd-debuginfo", rpm:"httpd-debuginfo~2.2.21~1.19.amzn1", rls:"AMAZON"))) {
    report += res;
  }
