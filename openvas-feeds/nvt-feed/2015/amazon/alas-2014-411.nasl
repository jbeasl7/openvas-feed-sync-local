...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:16:59 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-411");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-411.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the ALAS-2014-411 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was found in the way Squid handled malformed HTTP Range headers. A remote attacker able to send HTTP requests to the Squid proxy could use this flaw to crash Squid. (CVE-2014-3609)
