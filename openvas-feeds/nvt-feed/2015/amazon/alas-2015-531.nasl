...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:56 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-531");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby20' package(s) announced via the ALAS-2015-531 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby20", rpm:"ruby20~2.0.0.645~1.25.amzn1", rls:"AMAZON"))) {
    report += res;
  }
