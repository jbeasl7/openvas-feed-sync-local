...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-625");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-625.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssh' package(s) announced via the ALAS-2015-625 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pam_ssh_agent_auth", rpm:"pam_ssh_agent_auth~0.9.3~9.22.58.amzn1", rls:"AMAZON"))) {
    report += res;
  }
