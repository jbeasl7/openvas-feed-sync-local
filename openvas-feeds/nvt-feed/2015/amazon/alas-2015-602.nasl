...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-602");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php55' package(s) announced via the ALAS-2015-602 advisory.");
