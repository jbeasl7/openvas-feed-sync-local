...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:36 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2012-33");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2012-33.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icu' package(s) announced via the ALAS-2012-33 advisory.");
  ...
  script_tag(name:"affected", value:"'icu' package(s) on Amazon Linux.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"icu-debuginfo", rpm:"icu-debuginfo~4.2.1~9.9.amzn1", rls:"AMAZON"))) {
    report += res;
  }
