...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:20:46 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-537");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-537.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the ALAS-2015-537 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"ClamAV before 0.98.7 allows remote attackers to cause a denial of service (infinite loop) via a crafted y0da cryptor file. (CVE-2015-2221)
...
The upx decoder in ClamAV before 0.98.7 allows remote attackers to cause a denial of service (crash) via a crafted file. (CVE-2015-2170)");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on Amazon Linux.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav-milter", rpm:"clamav-milter~0.98.7~1.12.amzn1", rls:"AMAZON"))) {
    report += res;
  }
