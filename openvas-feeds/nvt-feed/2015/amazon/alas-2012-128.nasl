...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:27:34 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2012-128");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2012-128.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dbus' package(s) announced via the ALAS-2012-128 advisory.");
  ...
  script_tag(name:"affected", value:"'dbus' package(s) on Amazon Linux.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dbus-devel", rpm:"dbus-devel~1.2.24~7.16.amzn1", rls:"AMAZON"))) {
    report += res;
  }
