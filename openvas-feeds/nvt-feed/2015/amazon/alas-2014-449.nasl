...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:25:57 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-449");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-449.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby21' package(s) announced via the ALAS-2014-449 advisory.");
...
if(release == "AMAZON") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby21-libs", rpm:"ruby21-libs~2.1.5~1.15.amzn1", rls:"AMAZON"))) {
    report += res;
  }
