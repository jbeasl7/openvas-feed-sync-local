...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 09:27:44 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2011-2");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2011-2.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cyrus-imapd' package(s) announced via the ALAS-2011-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The cyrus-imapd packages contain a high-performance mail server with IMAP, POP3, NNTP, and Sieve support.
...
Users of cyrus-imapd are advised to upgrade to these updated packages, which contain a backported patch to correct this issue. After installing the update, cyrus-imapd will be restarted automatically.");
  ...
  script_tag(name:"affected", value:"'cyrus-imapd' package(s) on Amazon Linux.");
