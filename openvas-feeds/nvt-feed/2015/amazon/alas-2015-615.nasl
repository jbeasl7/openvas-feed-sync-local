...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-615");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-615.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpng' package(s) announced via the ALAS-2015-615 advisory.");
