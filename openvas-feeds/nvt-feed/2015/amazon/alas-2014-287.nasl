...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2014-287");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2014-287.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the ALAS-2014-287 advisory.");
