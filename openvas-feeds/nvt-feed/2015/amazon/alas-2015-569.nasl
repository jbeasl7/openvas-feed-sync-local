...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-08 11:17:47 +0000 (Tue, 08 Sep 2015)");
  ...
  script_xref(name:"Advisory-ID", value:"ALAS-2015-569");
  script_xref(name:"URL", value:"https://alas.aws.amazon.com/ALAS-2015-569.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss, nss-util' package(s) announced via the ALAS-2015-569 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was found in the way the TLS protocol composes the Diffie-Hellman (DH) key exchange. A man-in-the-middle attacker could use this flaw to force the use of weak 512 bit export-grade keys during the key exchange, allowing them do decrypt all traffic. (CVE-2015-4000)
...
Please note that this update forces the TLS/SSL client implementation in NSS to reject DH key sizes below 768 bits, which prevents sessions to be downgraded to export-grade keys. Future updates may raise this limit to 1024 bits.");
  ...
  script_tag(name:"affected", value:"'nss, nss-util' package(s) on Amazon Linux.");
