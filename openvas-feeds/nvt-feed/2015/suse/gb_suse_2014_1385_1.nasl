...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for MozillaFirefox (SUSE-SU-2014:1385-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2014:1385-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~31.2.0esr~0.14.2", rls:"SLES11.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-branding-SLED", rpm:"MozillaFirefox-branding-SLED~31.0~0.8.1", rls:"SLES11.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations", rpm:"MozillaFirefox-translations~31.2.0esr~0.14.2", rls:"SLES11.0SP3"))) {
    report += res;
  }
