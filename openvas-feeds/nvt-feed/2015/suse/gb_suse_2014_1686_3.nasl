...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for ntp (SUSE-SU-2014:1686-3)");
  ...
  * A potential remote code execution problem was found inside ntpd. The
  ...
  script_xref(name:"SUSE-SU", value:"2014:1686-3");
...
if(release == "SLES11.0SP1") {
  if(!isnull(res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.4p8~1.28.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.4p8~1.28.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
