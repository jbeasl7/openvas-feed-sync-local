...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for flash-player (SUSE-SU-2015:1618-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2015:1618-1");
...
if(release == "SLED12.0SP0") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.521~102.1", rls:"SLED12.0SP0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.521~102.1", rls:"SLED12.0SP0"))) {
    report += res;
  }
