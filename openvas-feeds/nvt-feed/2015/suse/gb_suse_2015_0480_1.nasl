...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for bind (SUSE-SU-2015:0480-1)");
  ...
  * CVE-2014-0591
  ...
  script_xref(name:"SUSE-SU", value:"2015:0480-1");
...
if(release == "SLES11.0SP1") {
  if(!isnull(res = isrpmvuln(pkg:"bind", rpm:"bind~9.6ESVR11W1~0.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-chrootenv", rpm:"bind-chrootenv~9.6ESVR11W1~0.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-doc", rpm:"bind-doc~9.6ESVR11W1~0.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-libs", rpm:"bind-libs~9.6ESVR11W1~0.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"bind-utils", rpm:"bind-utils~9.6ESVR11W1~0.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ind-libs-32bit", rpm:"ind-libs-32bit~9.6ESVR11W1~0.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
