...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for shim (SUSE-SU-2014:1619-1)");
  ...
  * Memory corruption when processing user provided MOK lists
  ...
  script_xref(name:"SUSE-SU", value:"2014:1619-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"gnu-efi", rpm:"gnu-efi~3.0u~0.7.2", rls:"SLES11.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~0.7.318.81ee561d~0.9.2", rls:"SLES11.0SP3"))) {
    report += res;
  }
