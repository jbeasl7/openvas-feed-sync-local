...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for Mozilla (SUSE-SU-2015:0447-1)");
  ...
  * CVE-2015-0822: The Form Autocompletion feature in Mozilla Firefox
  ...
  script_xref(name:"SUSE-SU", value:"2015:0447-1");
...
if(release == "SLES11.0SP2") {
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~31.5.0esr~0.4.2.1", rls:"SLES11.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations", rpm:"MozillaFirefox-translations~31.5.0esr~0.4.2.1", rls:"SLES11.0SP2"))) {
    report += res;
  }
...
if(release == "SLES11.0SP1") {
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~31.5.0esr~0.4.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations", rpm:"MozillaFirefox-translations~31.5.0esr~0.4.2.1", rls:"SLES11.0SP1"))) {
    report += res;
  }
