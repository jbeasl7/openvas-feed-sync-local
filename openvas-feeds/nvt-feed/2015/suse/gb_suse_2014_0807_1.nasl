...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for Linux (SUSE-SU-2014:0807-1)");
  ...
  *
  ...
  script_xref(name:"SUSE-SU", value:"2014:0807-1");
...
if(release == "SLES11.0SP1") {
  if(!isnull(res = isrpmvuln(pkg:"btrfs-kmp-default-0", rpm:"btrfs-kmp-default-0~2.6.32.59_0.13~0.3.163", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ext4dev-kmp-default-0", rpm:"ext4dev-kmp-default-0~2.6.32.59_0.13~7.9.130", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ext4dev-kmp-trace-0", rpm:"ext4dev-kmp-trace-0~2.6.32.59_0.13~7.9.130", rls:"SLES11.0SP1"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"btrfs-kmp-xen-0", rpm:"btrfs-kmp-xen-0~2.6.32.59_0.13~0.3.163", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ext4dev-kmp-xen-0", rpm:"ext4dev-kmp-xen-0~2.6.32.59_0.13~7.9.130", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hyper-v-kmp-default-0", rpm:"hyper-v-kmp-default-0~2.6.32.59_0.13~0.18.39", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hyper-v-kmp-trace-0", rpm:"hyper-v-kmp-trace-0~2.6.32.59_0.13~0.18.39", rls:"SLES11.0SP1"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"btrfs-kmp-pae-0", rpm:"btrfs-kmp-pae-0~2.6.32.59_0.13~0.3.163", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ext4dev-kmp-pae-0", rpm:"ext4dev-kmp-pae-0~2.6.32.59_0.13~7.9.130", rls:"SLES11.0SP1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"hyper-v-kmp-pae-0", rpm:"hyper-v-kmp-pae-0~2.6.32.59_0.13~0.18.39", rls:"SLES11.0SP1"))) {
    report += res;
  }
