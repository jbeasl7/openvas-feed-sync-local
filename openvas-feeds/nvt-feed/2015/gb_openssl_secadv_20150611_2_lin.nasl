...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to version 0.9.8zg, 1.0.0s, 1.0.1n, 1.0.2b or later.");

  script_xref(name:"URL", value:"https://www.openssl.org/news/secadv/20150611.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75156");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75157");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75161");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75154");
