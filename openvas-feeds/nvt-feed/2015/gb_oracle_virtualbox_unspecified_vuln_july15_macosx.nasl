...
if(description)
{
  ...
  script_name("Oracle VirtualBox Unspecified Vulnerability (Jul 2015) - Mac OS X");
...
if(vers =~ "^4\.[0-3]") {
  ...
  if(version_in_range(version:vers, test_version:"4.2.0", test_version2:"4.2.31")) {
    fix = "4.2.32";
    VULN = TRUE;
  }

  if(version_in_range(version:vers, test_version:"4.3.0", test_version2:"4.3.29")) {
    fix = "4.3.30";
    VULN = TRUE;
  }
