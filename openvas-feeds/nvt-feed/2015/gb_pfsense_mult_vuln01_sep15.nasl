...
if (description)
{
  ...
  script_name("pfSense Multiple Vulnerabilities (Jun 2016)");

  script_tag(name:"summary", value:"pfSense is prone to multiple vulnerabilities.");
  ...
  script_tag(name:"affected", value:"pfSense prior to version 2.1.4.");
...
if(version_is_less(version:version, test_version:"2.1.4")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"2.1.4");
