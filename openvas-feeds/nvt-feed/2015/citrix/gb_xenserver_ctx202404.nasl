...
if (description)
{
  ...
  - CVE-2015-7969: Leak of main per-domain vcpu pointer array/Leak of per-domain profiling-related vcpu pointer array

  - CVE-2015-7970: Host crash when migrating a PoD VM

  - CVE-2015-7971: Some pmu and profiling hypercalls log without rate limiting

  - CVE-2015-7972: Populate-on-demand balloon size inaccuracy can crash guests");
