...
if (description)
{
  ...
  - CVE-2014-7815: The set_pixel_format function in QEMU allows a denial of service (crash)

  - CVE-2014-3615: The VGA emulator in QEMU allows users to read memory");
