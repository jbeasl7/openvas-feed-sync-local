...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-06 11:04:18 +0000 (Tue, 06 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2014-0133)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2014-0133");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2014-0133.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the ELSA-2014-0133 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[24.3.0-2.0.1.el6_5]
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~24.3.0~2.0.1.el5_10", rls:"OracleLinux5"))) {
    report += res;
  }
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"thunderbird", rpm:"thunderbird~24.3.0~2.0.1.el6_5", rls:"OracleLinux6"))) {
    report += res;
  }
