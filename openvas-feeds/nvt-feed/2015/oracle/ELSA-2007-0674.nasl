...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2007-0674");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2007-0674.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Net-DNS' package(s) announced via the ELSA-2007-0674 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[0.31-4.el3]
 ...
 - Also allow disabling of online tests");
  ...
  script_tag(name:"affected", value:"'perl-Net-DNS' package(s) on Oracle Linux 3, Oracle Linux 5.");
...
if(release == "OracleLinux3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Net-DNS", rpm:"perl-Net-DNS~0.31~4.el3", rls:"OracleLinux3"))) {
    report += res;
  }
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Net-DNS", rpm:"perl-Net-DNS~0.59~3.el5", rls:"OracleLinux5"))) {
    report += res;
  }
