...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-08 11:47:02 +0000 (Thu, 08 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2009-0315)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2009-0315");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2009-0315.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, xulrunner' package(s) announced via the ELSA-2009-0315 advisory.");
...
if(release == "OracleLinux4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~3.0.7~1.0.1.el4", rls:"OracleLinux4"))) {
    report += res;
  }
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~3.0.7~1.0.1.el5", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~1.9.0.7~1.0.1.el5", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~1.9.0.7~1.0.1.el5", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner-devel-unstable", rpm:"xulrunner-devel-unstable~1.9.0.7~1.0.1.el5", rls:"OracleLinux5"))) {
    report += res;
  }
