...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-12-08 09:03:28 +0000 (Tue, 08 Dec 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2015-2549)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2015-2549");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2015-2549.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2' package(s) announced via the ELSA-2015-2549 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[2.7.6-20.0.1]
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.7.6~20.0.1.el6_7.1", rls:"OracleLinux6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxml2-devel", rpm:"libxml2-devel~2.7.6~20.0.1.el6_7.1", rls:"OracleLinux6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxml2-python", rpm:"libxml2-python~2.7.6~20.0.1.el6_7.1", rls:"OracleLinux6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libxml2-static", rpm:"libxml2-static~2.7.6~20.0.1.el6_7.1", rls:"OracleLinux6"))) {
    report += res;
  }
