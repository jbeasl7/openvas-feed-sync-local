...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-11-24 08:17:27 +0000 (Tue, 24 Nov 2015)");
  ...
  script_tag(name:"severity_date", value:"2020-06-18 17:30:00 +0000 (Thu, 18 Jun 2020)");

  script_name("Oracle: Security Advisory (ELSA-2015-2231)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2015-2231");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2015-2231.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the ELSA-2015-2231 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[4.2.6p5-22]
...
- improve documentation of restrict command (#1213953)");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on Oracle Linux 7.");
...
if(release == "OracleLinux7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.6p5~22.el7", rls:"OracleLinux7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.6p5~22.el7", rls:"OracleLinux7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-perl", rpm:"ntp-perl~4.2.6p5~22.el7", rls:"OracleLinux7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntpdate", rpm:"ntpdate~4.2.6p5~22.el7", rls:"OracleLinux7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"sntp", rpm:"sntp~4.2.6p5~22.el7", rls:"OracleLinux7"))) {
    report += res;
  }
