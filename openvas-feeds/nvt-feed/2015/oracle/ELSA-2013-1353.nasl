...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-06 11:05:32 +0000 (Tue, 06 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2013-1353)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2013-1353");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2013-1353.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sudo' package(s) announced via the ELSA-2013-1353 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[1.7.2p1-28]
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sudo", rpm:"sudo~1.7.2p1~28.el5", rls:"OracleLinux5"))) {
    report += res;
  }
