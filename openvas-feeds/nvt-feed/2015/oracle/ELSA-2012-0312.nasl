...
if(description)
{
  ...
  script_name("Oracle: Security Advisory (ELSA-2012-0312)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2012-0312");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2012-0312.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'initscripts' package(s) announced via the ELSA-2012-0312 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[8.45.42-1.0.1.el5]
...
- fix logic error with removing arp_ip_target (#745681)");
  ...
  script_tag(name:"affected", value:"'initscripts' package(s) on Oracle Linux 5.");
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"initscripts", rpm:"initscripts~8.45.42~1.0.1.el5", rls:"OracleLinux5"))) {
    report += res;
  }
