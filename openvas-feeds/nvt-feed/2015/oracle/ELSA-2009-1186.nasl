...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-08 11:45:56 +0000 (Thu, 08 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2009-1186)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2009-1186");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2009-1186.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nspr, nss' package(s) announced via the ELSA-2009-1186 advisory.");
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nss", rpm:"nss~3.12.3.99.3~1.0.1.el5_3.2", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-devel", rpm:"nss-devel~3.12.3.99.3~1.0.1.el5_3.2", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-pkcs11-devel", rpm:"nss-pkcs11-devel~3.12.3.99.3~1.0.1.el5_3.2", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nss-tools", rpm:"nss-tools~3.12.3.99.3~1.0.1.el5_3.2", rls:"OracleLinux5"))) {
    report += res;
  }
