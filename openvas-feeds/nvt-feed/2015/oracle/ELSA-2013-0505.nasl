...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-06 11:07:27 +0000 (Tue, 06 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2013-0505)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2013-0505");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2013-0505.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the ELSA-2013-0505 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[7:3.1.10-16]
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~3.1.10~16.el6", rls:"OracleLinux6"))) {
    report += res;
  }
