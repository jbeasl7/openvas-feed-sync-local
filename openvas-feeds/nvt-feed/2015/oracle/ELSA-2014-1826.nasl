...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-06 11:01:21 +0000 (Tue, 06 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2014-1826)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2014-1826");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2014-1826.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvncserver' package(s) announced via the ELSA-2014-1826 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[0.9.7-7.1]
...
- Fix CVE-2011-0905 (bug #696767)");
  ...
  script_tag(name:"affected", value:"'libvncserver' package(s) on Oracle Linux 6, Oracle Linux 7.");
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvncserver", rpm:"libvncserver~0.9.7~7.el6_6.1", rls:"OracleLinux6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncserver-devel", rpm:"libvncserver-devel~0.9.7~7.el6_6.1", rls:"OracleLinux6"))) {
    report += res;
  }
...
if(release == "OracleLinux7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvncserver", rpm:"libvncserver~0.9.9~9.el7_0.1", rls:"OracleLinux7"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvncserver-devel", rpm:"libvncserver-devel~0.9.9~9.el7_0.1", rls:"OracleLinux7"))) {
    report += res;
  }
