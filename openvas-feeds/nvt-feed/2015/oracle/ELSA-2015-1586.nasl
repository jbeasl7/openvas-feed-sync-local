...
if(description)
{
  ...
  script_name("Oracle: Security Advisory (ELSA-2015-1586)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2015-1586");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2015-1586.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the ELSA-2015-1586 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[38.2.0-4.0.1]
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.2.0~4.0.1.el5_11", rls:"OracleLinux5"))) {
    report += res;
  }
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.2.0~4.0.1.el6_7", rls:"OracleLinux6"))) {
    report += res;
  }
...
if(release == "OracleLinux7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~38.2.0~4.0.1.el7_1", rls:"OracleLinux7"))) {
    report += res;
  }
