...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-06 11:08:47 +0000 (Tue, 06 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2012-1350)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2012-1350");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2012-1350.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, xulrunner' package(s) announced via the ELSA-2012-1350 advisory.");
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~10.0.8~1.0.2.el5_8", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~10.0.8~1.0.1.el5_8", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~10.0.8~1.0.1.el5_8", rls:"OracleLinux5"))) {
    report += res;
  }
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~10.0.8~1.0.2.el6_3", rls:"OracleLinux6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner", rpm:"xulrunner~10.0.8~1.0.1.el6_3", rls:"OracleLinux6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xulrunner-devel", rpm:"xulrunner-devel~10.0.8~1.0.1.el6_3", rls:"OracleLinux6"))) {
    report += res;
  }
