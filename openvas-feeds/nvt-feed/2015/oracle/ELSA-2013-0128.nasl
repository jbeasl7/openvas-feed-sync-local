...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-06 11:08:11 +0000 (Tue, 06 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2013-0128)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2013-0128");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2013-0128.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'conga' package(s) announced via the ELSA-2013-0128 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[0.12.2-64.0.2.el5]
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"conga", rpm:"conga~0.12.2~64.0.2.el5", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"luci", rpm:"luci~0.12.2~64.0.2.el5", rls:"OracleLinux5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ricci", rpm:"ricci~0.12.2~64.0.2.el5", rls:"OracleLinux5"))) {
    report += res;
  }
