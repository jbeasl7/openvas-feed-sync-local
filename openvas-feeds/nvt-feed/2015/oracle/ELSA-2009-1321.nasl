...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-08 11:45:34 +0000 (Thu, 08 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2009-1321)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2009-1321");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2009-1321.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nfs-utils' package(s) announced via the ELSA-2009-1321 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[1.0.9-42 ]
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"nfs-utils", rpm:"nfs-utils~1.0.9~42.el5", rls:"OracleLinux5"))) {
    report += res;
  }
