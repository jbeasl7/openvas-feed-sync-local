...
if(description)
{
  ...
  script_name("Oracle: Security Advisory (ELSA-2013-0120)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2013-0120");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2013-0120.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'quota' package(s) announced via the ELSA-2013-0120 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[1:3.13-8.0.1]
...
- Make RPC block factor dynamic (bug #667360)");
  ...
  script_tag(name:"affected", value:"'quota' package(s) on Oracle Linux 5.");
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"quota", rpm:"quota~3.13~8.0.1.el5", rls:"OracleLinux5"))) {
    report += res;
  }
