...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-08 11:47:16 +0000 (Thu, 08 Oct 2015)");
  ...
  script_name("Oracle: Security Advisory (ELSA-2009-0205)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2009-0205");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2009-0205.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot' package(s) announced via the ELSA-2009-0205 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[1.0.7-7]
...
- Resolves: #448089, #238016, #436287, #439369");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Oracle Linux 5.");
...
if(release == "OracleLinux5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dovecot", rpm:"dovecot~1.0.7~7.el5", rls:"OracleLinux5"))) {
    report += res;
  }
