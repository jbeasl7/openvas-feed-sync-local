...
if(description)
{
  ...
  script_name("Oracle: Security Advisory (ELSA-2015-1447)");
  ...
  script_xref(name:"Advisory-ID", value:"ELSA-2015-1447");
  script_xref(name:"URL", value:"https://linux.oracle.com/errata/ELSA-2015-1447.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'grep' package(s) announced via the ELSA-2015-1447 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"[2.20-3]
...
- Documented --fixed-regexp option
 Resolves: rhbz#1103270");
  ...
  script_tag(name:"affected", value:"'grep' package(s) on Oracle Linux 6.");
...
if(release == "OracleLinux6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"grep", rpm:"grep~2.20~3.el6", rls:"OracleLinux6"))) {
    report += res;
  }
