...
if(description)
{
  ...
  script_name("Apache HTTP Server Multiple Vulnerabilities (Aug 2015) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 2.4.14 or later.");

  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"http://www.apache.org/dist/httpd/CHANGES_2.4");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75965");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75963");
...
if(version_in_range(version:vers, test_version:"2.4", test_version2:"2.4.13")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.4.14", install_path:path);
