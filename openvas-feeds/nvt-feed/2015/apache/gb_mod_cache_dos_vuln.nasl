...
if(description)
{
  ...
  script_name("Apache HTTP Server 'mod_cache' Denial of Service Vulnerability (May 2015)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68863");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69248");
