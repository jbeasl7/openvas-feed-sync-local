...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170983");
  ...
  script_tag(name:"severity_date", value:"2025-07-12 00:24:01 +0000 (Sat, 12 Jul 2025)");

  script_cve_id("CVE-2024-10781");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress CleanTalk Plugin < 6.45 Authorization Bypass Vulnerability");
  ...
  installation due to an missing empty value check on the 'api_key' value in the 'perform'
  function.");
  ...
  script_tag(name:"affected", value:"WordPress CleanTalk plugin prior to version 6.45.");

  script_tag(name:"solution", value:"Update to version 6.45 or later.");
  ...
  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/cleantalk-spam-protect/spam-protection-anti-spam-firewall-by-cleantalk-644-authorization-bypass-due-to-missing-empty-value-check-to-unauthenticated-arbitrary-plugin-installation");
...
if (version_is_less(version: version, test_version: "6.45")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "6.45", install_path: location);
