...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834850");
  ...
  script_tag(name:"creation_date", value:"2024-12-20 12:00:59 +0530 (Fri, 20 Dec 2024)");
  script_name("Microsoft Edge (Chromium-Based) Multiple Vulnerabilities - (Dec-2 2024)");
  ...
  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to  version 131.0.2903.112.");
...
if(version_is_less(version:vers, test_version:"131.0.2903.112")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"131.0.2903.112", install_path:path);
