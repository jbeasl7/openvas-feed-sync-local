...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834479");
  script_version("2024-11-29T15:40:53+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2024-38119", "CVE-2024-38246", "CVE-2024-38254", "CVE-2024-38240",
                "CVE-2024-43487", "CVE-2024-30073", "CVE-2024-43461", "CVE-2024-38045",
                ...
                "CVE-2024-38217", "CVE-2024-38046", "CVE-2024-38014", "CVE-2024-38256",
  ...
  script_tag(name:"creation_date", value:"2024-09-11 09:46:41 +0530 (Wed, 11 Sep 2024)");
  script_name("Microsoft Windows Multiple Vulnerabilities (KB5043064)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5043064");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5043064");
...
if(version_is_less(version:fileVer, test_version:"10.0.19041.4894")) {
  report = report_fixed_ver(file_checked:dllPath + "\ntoskrnl.exe", file_version:fileVer, vulnerable_range:"Less than 10.0.19041.4894");
