...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832664");
  ...
  script_name("Microsoft Office 2016 Multiple Remote Code Execution Vulnerabilities (KB5002467)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002467");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002467");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(version_is_less(version:offdllVer, test_version:"16.0.5431.1001")) {
        report = report_fixed_ver( file_checked:offPath + "\mso20win32client.dll",
