...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834032");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 18:11:36 +0530 (Mon, 27 May 2024)");
  script_name("Microsoft Edge (Chromium-Based) Type Confusion Vulnerability - May24");
  ...
  to arbitrary code execution in the context of the logged on user and conduct
  ...
  script_xref(name:"URL", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2024-5274");
