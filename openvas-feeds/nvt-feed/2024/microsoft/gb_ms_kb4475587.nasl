...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834552");
  script_version("2025-01-13T08:32:03+0000");
  script_cve_id("CVE-2024-49059", "CVE-2024-43600");
  ...
  script_name("Microsoft Office 2016 Multiple Vulnerabilities (KB4475587)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB4475587");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/4475587");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      offexeVer = fetch_file_version(sysPath:offPath, file_name:"Olicenseheartbeat.exe");
      if(!offexeVer) {
        continue ;
      }

      if(offexeVer =~ "^16\." && version_is_less(version:offexeVer, test_version:"16.0.5478.1000")) {
        report = report_fixed_ver(file_checked:offPath + "\Olicenseheartbeat.exe",
