...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7126.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7126-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7126-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7126-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsoup2.4' package(s) announced via the USN-7126-1 advisory.");
...
cause a denial of service. (CVE-2024-52532)");
  ...
  script_tag(name:"affected", value:"'libsoup2.4' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04, Ubuntu 24.10.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsoup2.4-1", ver:"2.62.1-1ubuntu0.4+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsoup2.4-1", ver:"2.70.0-1ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsoup2.4-1", ver:"2.74.2-3ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsoup-2.4-1", ver:"2.74.3-6ubuntu1.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsoup-2.4-1", ver:"2.74.3-7ubuntu0.1", rls:"UBUNTU24.10"))) {
    report += res;
  }
