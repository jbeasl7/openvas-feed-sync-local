...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6896.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6896-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6896-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6896-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle, linux-xilinx-zynqmp' package(s) announced via the USN-6896-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - Bluetooth ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-oracle, linux-xilinx-zynqmp' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1047-xilinx-zynqmp", ver:"5.4.0-1047.51", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1127-oracle", ver:"5.4.0-1127.136", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-lts-20.04", ver:"5.4.0.1127.120", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"5.4.0.1047.47", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
