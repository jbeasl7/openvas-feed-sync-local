...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6766.3");
  ...
  script_tag(name:"creation_date", value:"2024-05-21 04:07:33 +0000 (Tue, 21 May 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6766-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6766-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6766-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-5.15' package(s) announced via the USN-6766-3 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1061-aws", ver:"5.15.0-1061.67~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.15.0.1061.67~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1061-aws", ver:"5.15.0-1061.67", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-22.04", ver:"5.15.0.1061.61", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
