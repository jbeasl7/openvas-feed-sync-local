...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6817.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6817-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6817-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6817-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.8' package(s) announced via the USN-6817-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-oem-6.8' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1006-oem", ver:"6.8.0-1006.6", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-24.04", ver:"6.8.0-1006.6+1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oem-24.04a", ver:"6.8.0-1006.6+1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
