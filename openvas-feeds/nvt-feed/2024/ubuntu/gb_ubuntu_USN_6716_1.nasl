...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6716.1");
  script_cve_id("CVE-2021-44879", "CVE-2023-22995", "CVE-2023-23000", "CVE-2023-23004", "CVE-2023-4244", "CVE-2023-51779", "CVE-2023-51780", "CVE-2023-51782", "CVE-2023-6121", "CVE-2024-0340", "CVE-2024-1086", "CVE-2024-24855");
  ...
  script_name("Ubuntu: Security Advisory (USN-6716-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6716-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6716-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-5.4' package(s) announced via the USN-6716-1 advisory.");
...
after-free vulnerability. A local attacker could use ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1126-azure", ver:"5.4.0-1126.133~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.4.0.1126.99", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1126-azure", ver:"5.4.0-1126.133", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-20.04", ver:"5.4.0.1126.119", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
