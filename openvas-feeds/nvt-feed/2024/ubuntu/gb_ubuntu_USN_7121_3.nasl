...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7121.3");
  ...
  script_tag(name:"creation_date", value:"2024-11-26 04:08:22 +0000 (Tue, 26 Nov 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7121-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7121-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7121-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle' package(s) announced via the USN-7121-3 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1137-oracle", ver:"4.15.0-1137.148~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"4.15.0.1137.148~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
