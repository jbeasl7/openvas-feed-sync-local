...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-6918-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6918-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6918-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle' package(s) announced via the USN-6918-1 advisory.");
...
CVE-2024-35895, CVE-2024-36027, CVE-2024-35896, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1008-oracle", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1008-oracle-64k", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
