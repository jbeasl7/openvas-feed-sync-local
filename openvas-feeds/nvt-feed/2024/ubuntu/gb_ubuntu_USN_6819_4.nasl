...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6819.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-6819-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6819-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6819-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle-6.5' package(s) announced via the USN-6819-4 advisory.");
...
CVE-2024-26620, CVE-2023-52692, CVE-2024-26669, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-oracle-6.5' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-oracle", ver:"6.5.0-1024.24~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-oracle-64k", ver:"6.5.0-1024.24~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.5.0.1024.24~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.5.0.1024.24~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
