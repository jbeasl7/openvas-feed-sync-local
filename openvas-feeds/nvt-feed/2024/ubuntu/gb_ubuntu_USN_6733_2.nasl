...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6733.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6733-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6733-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6733-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls28' package(s) announced via the USN-6733-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6733-1 fixed vulnerabilities in GnuTLS. This update provides the
...
Original advisory details:
 ...
 22.04 LTS and Ubuntu 23.10. (CVE-2024-28835)");
  ...
  script_tag(name:"affected", value:"'gnutls28' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgnutls30t64", ver:"3.8.3-1.1ubuntu3.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
