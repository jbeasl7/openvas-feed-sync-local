...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6759.1");
  script_cve_id("CVE-2024-32658", "CVE-2024-32659", "CVE-2024-32660", "CVE-2024-32661", "CVE-2024-32662");
  ...
  script_name("Ubuntu: Security Advisory (USN-6759-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6759-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6759-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freerdp3' package(s) announced via the USN-6759-1 advisory.");
...
resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'freerdp3' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreerdp3-3", ver:"3.5.1+dfsg1-0ubuntu1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
