...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6818.4");
  ...
  script_tag(name:"creation_date", value:"2024-06-19 04:07:50 +0000 (Wed, 19 Jun 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6818-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6818-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6818-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe-6.5' package(s) announced via the USN-6818-4 advisory.");
...
CVE-2023-52487, CVE-2023-52465, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-hwe-6.5' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-41-generic", ver:"6.5.0-41.41~22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-41-generic-64k", ver:"6.5.0-41.41~22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k-hwe-22.04", ver:"6.5.0.41.41~22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-hwe-22.04", ver:"6.5.0.41.41~22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual-hwe-22.04", ver:"6.5.0.41.41~22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
