...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6893.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6893-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6893-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6893-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke, linux-nvidia' package(s) announced via the USN-6893-2 advisory.");
...
CVE-2024-26984, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-gke, linux-nvidia' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1006-gke", ver:"6.8.0-1006.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1009-nvidia", ver:"6.8.0-1009.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1009-nvidia-64k", ver:"6.8.0-1009.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"6.8.0-1006.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia", ver:"6.8.0-1009.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-64k", ver:"6.8.0-1009.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
