...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6992.2");
  ...
  script_tag(name:"creation_date", value:"2024-09-23 04:07:54 +0000 (Mon, 23 Sep 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6992-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6992-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6992-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2081668");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-6992-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6992-1 fixed vulnerabilities in Firefox. The update introduced
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"130.0.1+build1-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
