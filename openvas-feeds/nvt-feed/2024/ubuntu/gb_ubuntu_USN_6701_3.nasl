...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6701.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6701-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6701-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6701-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-hwe, linux-azure, linux-azure-4.15, linux-oracle' package(s) announced via the USN-6701-3 advisory.");
...
not properly handle verdict parameters in certain cases, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws-hwe, linux-azure, linux-azure-4.15, linux-oracle' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1129-oracle", ver:"4.15.0-1129.140~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1166-aws", ver:"4.15.0-1166.179~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1175-azure", ver:"4.15.0-1175.190~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-hwe", ver:"4.15.0.1166.149", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"4.15.0.1175.159", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"4.15.0.1129.110", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1175-azure", ver:"4.15.0-1175.190", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-18.04", ver:"4.15.0.1175.143", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
