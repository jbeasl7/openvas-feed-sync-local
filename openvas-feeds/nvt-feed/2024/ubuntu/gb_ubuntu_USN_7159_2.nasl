...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7159.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7159-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7159-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7159-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-5.4' package(s) announced via the USN-7159-2 advisory.");
...
CVE-2024-42240, CVE-2024-44942, CVE-2021-47076)");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-aws-5.4' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1136-aws", ver:"5.4.0-1136.146~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.4.0.1136.146~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1136-aws", ver:"5.4.0-1136.146", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-20.04", ver:"5.4.0.1136.133", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
