...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7156-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7156-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7156-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gkeop' package(s) announced via the USN-7156-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Chenyuan Yang discovered that the USB Gadget subsystem in the Linux kernel
...
This update corrects flaws in the following subsystems:
 ...
 - Proc file ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-gkeop' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1002-gkeop", ver:"6.8.0-1002.4", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gkeop", ver:"6.8.0-1002.4", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gkeop-6.8", ver:"6.8.0-1002.4", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
