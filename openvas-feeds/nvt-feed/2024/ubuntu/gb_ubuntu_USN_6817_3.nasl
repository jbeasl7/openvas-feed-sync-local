...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-6817-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6817-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6817-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gke' package(s) announced via the USN-6817-3 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-gke' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1004-gke", ver:"6.8.0-1004.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1008-azure", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1008-azure-fde", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.8.0-1008.8", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"6.8.0-1004.7", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
