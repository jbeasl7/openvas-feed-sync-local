...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6705.1");
  script_cve_id("CVE-2023-22995", "CVE-2023-23000", "CVE-2023-32247", "CVE-2023-4134", "CVE-2023-46343", "CVE-2023-46862", "CVE-2023-51779", "CVE-2023-51782", "CVE-2023-6121", "CVE-2024-0340", "CVE-2024-0607", "CVE-2024-1085", "CVE-2024-1086", "CVE-2024-24855");
  ...
  script_name("Ubuntu: Security Advisory (USN-6705-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6705-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6705-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-5.15' package(s) announced via the USN-6705-1 advisory.");
...
Lonial ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1056-aws", ver:"5.15.0-1056.61~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.15.0.1056.61~20.04.43", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1056-aws", ver:"5.15.0-1056.61", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-22.04", ver:"5.15.0.1056.55", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
