...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7117.3");
  script_cve_id("CVE-2024-10224", "CVE-2024-11003", "CVE-2024-48990", "CVE-2024-48991", "CVE-2024-48992");
  script_tag(name:"creation_date", value:"2024-12-06 08:41:01 +0000 (Fri, 06 Dec 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7117-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7117-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7117-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2091096");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'needrestart' package(s) announced via the USN-7117-3 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"needrestart", ver:"2.6-1ubuntu0.1~esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"needrestart", ver:"3.1-1ubuntu0.1+esm3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"needrestart", ver:"3.4-6ubuntu0.1+esm3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"needrestart", ver:"3.5-5ubuntu2.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"needrestart", ver:"3.6-7ubuntu4.5", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"needrestart", ver:"3.6-8ubuntu4.4", rls:"UBUNTU24.10"))) {
    report += res;
  }
