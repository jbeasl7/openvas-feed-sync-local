...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7144-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7144-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7144-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg, linux-intel-iotg-5.15' package(s) announced via the USN-7144-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Supraja Sridhara, Benedict Schluter, Mark Kuhne, Andrin Bertschi, and
...
This update corrects flaws in the following subsystems:
 ...
 - Sun RPC protocol,
 - TIPC protocol,
 - TLS ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1067-intel-iotg", ver:"5.15.0-1067.73~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel", ver:"5.15.0.1067.73~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1067.73~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1067-intel-iotg", ver:"5.15.0-1067.73", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1067.67", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
