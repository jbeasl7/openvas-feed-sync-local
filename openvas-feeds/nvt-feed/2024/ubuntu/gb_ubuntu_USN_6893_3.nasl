...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6893.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6893-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6893-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6893-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-6893-3 advisory.");
...
CVE-2024-35959, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1011-aws", ver:"6.8.0-1011.12", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.8.0-1011.12", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
