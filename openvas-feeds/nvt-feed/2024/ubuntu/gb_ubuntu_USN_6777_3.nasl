...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6777.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6777-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6777-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6777-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp' package(s) announced via the USN-6777-3 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1162-gcp", ver:"4.15.0-1162.179~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"4.15.0.1162.179~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"4.15.0.1162.179~16.04.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
