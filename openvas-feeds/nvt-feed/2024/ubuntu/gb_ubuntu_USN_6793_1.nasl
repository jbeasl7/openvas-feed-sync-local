...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6793.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6793-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6793-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6793-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'git' package(s) announced via the USN-6793-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Git incorrectly handled certain submodules.
...
(CVE-2024-32465)");
  ...
  script_tag(name:"affected", value:"'git' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.10, Ubuntu 24.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.25.1-1ubuntu3.12", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.34.1-1ubuntu1.11", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.40.1-1ubuntu1.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.43.0-1ubuntu7.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
