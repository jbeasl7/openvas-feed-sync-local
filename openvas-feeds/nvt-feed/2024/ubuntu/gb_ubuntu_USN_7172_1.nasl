...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7172.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7172-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7172-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7172-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvpx' package(s) announced via the USN-7172-1 advisory.");
