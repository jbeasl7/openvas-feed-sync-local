...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6782.1");
  script_cve_id("CVE-2024-4367", "CVE-2024-4767", "CVE-2024-4768", "CVE-2024-4769", "CVE-2024-4770", "CVE-2024-4777");
  script_tag(name:"creation_date", value:"2024-05-23 04:07:41 +0000 (Thu, 23 May 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6782-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6782-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6782-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-6782-1 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:115.11.0+build2-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:115.11.0+build2-0ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:115.11.0+build2-0ubuntu0.23.10.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
