...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6817.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6817-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6817-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6817-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-gcp' package(s) announced via the USN-6817-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-gcp' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1008-gcp", ver:"6.8.0-1008.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1009-aws", ver:"6.8.0-1009.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.8.0-1009.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.8.0-1008.9", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
