...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6950.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6950-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6950-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6950-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oracle' package(s) announced via the USN-6950-3 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1065-oracle", ver:"5.15.0-1065.71", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-lts-22.04", ver:"5.15.0.1065.61", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
