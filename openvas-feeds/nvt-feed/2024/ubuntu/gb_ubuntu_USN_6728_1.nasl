...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6728.1");
  script_cve_id("CVE-2023-49288", "CVE-2023-5824", "CVE-2024-23638", "CVE-2024-25111", "CVE-2024-25617");
  ...
  script_name("Ubuntu: Security Advisory (USN-6728-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6728-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6728-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the USN-6728-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Joshua Rogers discovered that Squid incorrectly handled collapsed
...
Squid to crash, resulting in a denial of service. (CVE-2024-25617)");
  ...
  script_tag(name:"affected", value:"'squid' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.10.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"4.10-1ubuntu1.10", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"5.7-0ubuntu0.22.04.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"6.1-2ubuntu1.3", rls:"UBUNTU23.10"))) {
    report += res;
  }
