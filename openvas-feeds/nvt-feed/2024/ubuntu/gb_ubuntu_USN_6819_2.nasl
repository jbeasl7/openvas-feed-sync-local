...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6819.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6819-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6819-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6819-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-oracle' package(s) announced via the USN-6819-2 advisory.");
...
CVE-2024-26620, CVE-2023-52692, CVE-2024-26669, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-oracle' package(s) on Ubuntu 23.10.");
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1021-aws", ver:"6.5.0-1021.21", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-oracle", ver:"6.5.0-1024.24", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-oracle-64k", ver:"6.5.0-1024.24", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"6.5.0.1021.21", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"6.5.0.1024.26", rls:"UBUNTU23.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-64k", ver:"6.5.0.1024.26", rls:"UBUNTU23.10"))) {
    report += res;
  }
