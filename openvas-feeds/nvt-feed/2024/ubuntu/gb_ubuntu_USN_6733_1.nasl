...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6733.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6733-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6733-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6733-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls28' package(s) announced via the USN-6733-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that GnuTLS had a timing side-channel when performing
...
22.04 LTS and Ubuntu 23.10. (CVE-2024-28835)");
  ...
  script_tag(name:"affected", value:"'gnutls28' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.10.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgnutls30", ver:"3.6.13-2ubuntu1.11", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgnutls30", ver:"3.7.3-4ubuntu1.5", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgnutls30", ver:"3.8.1-4ubuntu1.3", rls:"UBUNTU23.10"))) {
    report += res;
  }
