...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6644.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6644-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6644-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6644-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the USN-6644-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6644-1 fixed vulnerabilities in LibTIFF.
...
Original advisory details:
 ...
 resources, resulting in a denial of service. (CVE-2023-6277)");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"4.3.0-6ubuntu0.8", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtiff5", ver:"4.3.0-6ubuntu0.8", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
