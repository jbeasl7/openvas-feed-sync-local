...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834692");
  ...
  script_name("Oracle VirtualBox Security Update (oct24) - Windows");

  script_tag(name:"summary", value:"Oracle VirtualBox is prone to a denial
