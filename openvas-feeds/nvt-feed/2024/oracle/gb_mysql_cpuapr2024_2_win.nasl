...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170757");
  ...
  script_tag(name:"severity_date", value:"2024-04-16 22:15:24 +0000 (Tue, 16 Apr 2024)");

  script_cve_id("CVE-2024-21061", "CVE-2024-20993");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.x <= 8.0.35, 8.1.x <= 8.2.0 Security Update (cpuapr2024) - Windows");
