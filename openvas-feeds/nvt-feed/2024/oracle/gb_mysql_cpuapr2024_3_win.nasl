...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170759");
  ...
  script_tag(name:"severity_date", value:"2024-04-16 22:15:16 +0000 (Tue, 16 Apr 2024)");
  ...
  script_name("Oracle MySQL Server 8.x <= 8.0.34, 8.1.x <= 8.3.0 Security Update (cpuapr2024) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 8.0.35, 8.3.1 or later.");
