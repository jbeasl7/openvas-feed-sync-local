...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170761");
  ...
  script_cve_id("CVE-2024-21049", "CVE-2024-21050", "CVE-2024-21051", "CVE-2024-21052",
                "CVE-2024-21053", "CVE-2024-21056");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.x <= 8.0.34 Security Update (cpuapr2024) - Windows");
