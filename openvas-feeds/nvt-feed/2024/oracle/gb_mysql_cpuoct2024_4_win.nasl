...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170873");
  ...
  script_tag(name:"severity_date", value:"2024-10-15 20:15:13 +0000 (Tue, 15 Oct 2024)");

  script_cve_id("CVE-2024-21238");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server <= 8.0.39, 8.1 <= 8.4.1, 9.0 <= 9.0.1 Security Update (cpuoct2024) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 8.0.40, 8.4.2, 9.0.2 or later.");
