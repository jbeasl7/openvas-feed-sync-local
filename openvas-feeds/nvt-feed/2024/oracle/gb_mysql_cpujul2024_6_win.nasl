...
if (description)
{
  ...
  script_name("Oracle MySQL Server 8.0.38, 8.4.1, 9.0.0 Security Update (cpujul2024) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.0.38, 8.4.1 and 9.0.0.");

  script_tag(name:"solution", value:"Update to version 8.0.39, 8.4.2, 9.0.1 or later.");
...
if (version_is_equal(version: version, test_version: "8.0.38")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.0.39", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

if (version_is_equal(version: version, test_version: "8.4.1")) {
