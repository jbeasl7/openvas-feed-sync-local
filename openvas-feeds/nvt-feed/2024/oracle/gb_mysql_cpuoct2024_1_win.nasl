...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170867");
  ...
  script_tag(name:"severity_date", value:"2024-10-15 20:15:07 +0000 (Tue, 15 Oct 2024)");

  script_cve_id("CVE-2024-21200");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server <= 8.0.35 Security Update (cpuoct2024) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.0.35 and prior.");

  script_tag(name:"solution", value:"Update to version 8.0.36 or later.");
...
if (version_is_less_equal(version: version, test_version: "8.0.35")) {
