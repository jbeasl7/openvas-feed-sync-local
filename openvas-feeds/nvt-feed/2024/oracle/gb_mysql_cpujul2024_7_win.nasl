...
if (description)
{
  ...
  script_cve_id("CVE-2024-21176");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.1.x <= 8.4.0 Security Update (cpujul2024) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.1.x through 8.4.0.");

  script_tag(name:"solution", value:"Update to version 8.4.1 or later.");
