...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832955");
  ...
  script_tag(name:"severity_date", value:"2024-04-16 22:15:28 +0000 (Tue, 16 Apr 2024)");
  script_tag(name:"creation_date", value:"2024-04-18 15:03:40 +0530 (Thu, 18 Apr 2024)");
  script_name("Oracle Java SE Security Update (Apr 2024) -03 - Windows");
