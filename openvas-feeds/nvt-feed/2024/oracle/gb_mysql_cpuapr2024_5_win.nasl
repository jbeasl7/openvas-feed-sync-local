...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170763");
  ...
  script_tag(name:"severity_date", value:"2024-04-16 22:15:23 +0000 (Tue, 16 Apr 2024)");

  script_cve_id("CVE-2024-21055", "CVE-2024-21057");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.x <= 8.0.35 Security Update (cpuapr2024) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.x through 8.0.35.");
