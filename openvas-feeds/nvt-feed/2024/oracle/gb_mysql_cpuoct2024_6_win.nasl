...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170875");
  ...
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:H/PR:H/UI:N/S:U/C:L/I:N/A:N");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2024-10-15 20:15:14 +0000 (Tue, 15 Oct 2024)");

  script_cve_id("CVE-2024-21232", "CVE-2024-21243", "CVE-2024-21244");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.4 <= 8.4.2, 9.0 <= 9.0.1 Security Update (cpuoct2024) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.4 through 8.4.2 and 9.0 through
  9.0.1.");

  script_tag(name:"solution", value:"Update to version 8.4.3, 9.0.2 or later.");
