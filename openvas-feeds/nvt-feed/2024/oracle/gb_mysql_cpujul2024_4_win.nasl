...
if (description)
{
  ...
  script_name("Oracle MySQL Server 8.x <= 8.0.37 Security Update (cpujul2024) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.x through 8.0.37.");

  script_tag(name:"solution", value:"Update to version 8.0.38 or later.");
