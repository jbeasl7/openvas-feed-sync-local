...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832934");
  ...
  script_tag(name:"severity_date", value:"2024-04-10 13:51:37 +0000 (Wed, 10 Apr 2024)");
  script_tag(name:"creation_date", value:"2024-04-14 20:15:50 +0530 (Sun, 14 Apr 2024)");
  script_name("Adobe InDesign Out-of-bounds Reads Vulnerability (APSB24-20) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe InDesign 18.x through 18.5.1 and
  19.x through 19.2 on Mac OS X.");
