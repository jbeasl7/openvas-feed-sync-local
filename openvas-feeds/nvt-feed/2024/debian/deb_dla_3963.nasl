...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.2.2024.3963");
  ...
  script_name("Debian: Security Advisory (DLA-3963-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3963-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2024/DLA-3963-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ansible' package(s) announced via the DLA-3963-1 advisory.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.10.7+merged+base+2.10.17+dfsg-0+deb11u2", rls:"DEB11"))) {
    report += res;
  }
