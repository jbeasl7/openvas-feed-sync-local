...
if(description)
{
  ...
  script_cve_id("CVE-2024-40817", "CVE-2024-40776", "CVE-2024-40782", "CVE-2024-40779",
                ...
                "CVE-2024-40794", "CVE-2024-44185", "CVE-2024-44206", "CVE-2024-54551");
...
if(version_is_less(version:vers, test_version:"17.6")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"17.6", install_path:path);
