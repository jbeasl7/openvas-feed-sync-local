...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834715");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_29-2024-10) - Linux");
  ...
  130.0.6723.91 on Linux");

  script_tag(name: "solution", value:"Update to version 130.0.6723.91 or
  later.");
...
if(version_is_less(version:vers, test_version:"130.0.6723.91")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"130.0.6723.91", install_path:path);
