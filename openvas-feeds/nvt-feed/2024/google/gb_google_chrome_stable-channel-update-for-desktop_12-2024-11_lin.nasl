...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834747");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_12-2024-11) - Linux");
  ...
  131.0.6778.69 on Linux");

  script_tag(name: "solution", value:"Update to version 131.0.6778.69 or
  later.");
...
if(version_is_less(version:vers, test_version:"131.0.6778.69")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"131.0.6778.69", install_path:path);
