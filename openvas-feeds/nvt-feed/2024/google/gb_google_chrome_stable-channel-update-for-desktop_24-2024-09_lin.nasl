...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834629");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_24-2024-09) - Linux");
  ...
  129.0.6668.70 on Linux");

  script_tag(name: "solution", value:"Update to version 129.0.6668.70 or
  later.");
...
if(version_is_less(version:vers, test_version:"129.0.6668.70")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"129.0.6668.70", install_path:path);
