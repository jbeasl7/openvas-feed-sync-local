...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832897");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_26-2024-03) - Linux");
  ...
  123.0.6312.86 on Linux");

  script_tag(name:"solution", value:"Update to version 123.0.6312.86 or
  later.");
...
if(version_is_less(version:vers, test_version:"123.0.6312.86")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"123.0.6312.86", install_path:path);
