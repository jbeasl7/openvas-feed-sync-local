...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832904");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2024-03) - Linux");
  ...
  122.0.6261.111 on Linux");

  script_tag(name:"solution", value:"Update to version 122.0.6261.111 or
  later.");
...
if(version_is_less(version:vers, test_version:"122.0.6261.111")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"122.0.6261.111", install_path:path);
