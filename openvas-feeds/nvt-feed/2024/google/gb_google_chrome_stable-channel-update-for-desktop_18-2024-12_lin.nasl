...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834845");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_18-2024-12) - Linux");
  ...
  131.0.6778.204 on Linux");

  script_tag(name: "solution", value:"Update to version 131.0.6778.204 or
  later.");
...
if(version_is_less(version:vers, test_version:"131.0.6778.204")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"131.0.6778.204", install_path:path);
