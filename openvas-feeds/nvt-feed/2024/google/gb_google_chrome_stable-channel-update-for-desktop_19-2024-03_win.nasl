...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832875");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_19-2024-03) - Windows");
  ...
  123.0.6312.58 on Windows");

  script_tag(name:"solution", value:"Update to version 123.0.6312.58/.59 or
  later.");
