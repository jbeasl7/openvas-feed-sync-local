...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832898");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_26-2024-03) - Mac OS X");
