...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834630");
  ...
  script_tag(name:"creation_date", value:"2024-09-26 09:59:26 +0530 (Thu, 26 Sep 2024)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_24-2024-09) - Mac OS X");
  ...
  129.0.6668.70 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 129.0.6668.70/.71 or
  later.");
...
if(version_is_less(version:vers, test_version:"129.0.6668.70")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"129.0.6668.70/.71", install_path:path);
