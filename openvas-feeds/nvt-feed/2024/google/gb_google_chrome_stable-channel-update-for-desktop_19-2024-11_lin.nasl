...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834763");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_19-2024-11) - Linux");
  ...
  131.0.6778.85 on Linux");

  script_tag(name: "solution", value:"Update to version 131.0.6778.85 or
  later.");
...
if(version_is_less(version:vers, test_version:"131.0.6778.85")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"131.0.6778.85", install_path:path);
