...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834202");
  ...
  script_tag(name:"severity_date", value:"2025-01-02 16:01:16 +0000 (Thu, 02 Jan 2025)");
  script_tag(name:"creation_date", value:"2024-06-25 14:39:27 +0530 (Tue, 25 Jun 2024)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_24-2024-06) - Mac OS X");
  ...
  126.0.6478.126 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 126.0.6478.126/127 or
  later.");
...
if(version_is_less(version:vers, test_version:"126.0.6478.126")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"126.0.6478.126/127", install_path:path);
