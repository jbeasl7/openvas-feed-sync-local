...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834260");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2024-07) - Linux");
  ...
  126.0.6478.182 on Linux");

  script_tag(name: "solution", value:"Update to version 126.0.6478.182 or
  later.");
...
if(version_is_less(version:vers, test_version:"126.0.6478.182")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"126.0.6478.182", install_path:path);
