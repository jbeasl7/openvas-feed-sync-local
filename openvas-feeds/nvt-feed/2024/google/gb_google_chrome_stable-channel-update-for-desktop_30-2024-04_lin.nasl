...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832964");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_30-2024-04) - Linux");
  ...
  124.0.6367.118 on Linux");

  script_tag(name: "solution", value:"Update to version 124.0.6367.118 or
  later.");
...
if(version_is_less(version:vers, test_version:"124.0.6367.118")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"124.0.6367.118", install_path:path);
