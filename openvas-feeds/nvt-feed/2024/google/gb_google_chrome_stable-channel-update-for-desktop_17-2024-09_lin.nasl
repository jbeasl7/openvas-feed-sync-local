...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834614");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_17-2024-09) - Linux");
  ...
  129.0.6668.58 on Linux");

  script_tag(name: "solution", value:"Update to version 129.0.6668.58 or
  later.");
...
if(version_is_less(version:vers, test_version:"129.0.6668.58")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"129.0.6668.58", install_path:path);
