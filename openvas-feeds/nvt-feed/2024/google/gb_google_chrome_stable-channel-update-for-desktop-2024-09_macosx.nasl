...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834465");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2024-09) - Mac OS X");
  ...
  128.0.6613.119 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 128.0.6613.119/.120 or
  later.");
...
if(version_is_less(version:vers, test_version:"128.0.6613.119")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.0.6613.119/.120", install_path:path);
