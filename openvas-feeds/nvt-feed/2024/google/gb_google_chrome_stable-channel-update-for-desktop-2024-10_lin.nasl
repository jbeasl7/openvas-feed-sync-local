...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834636");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2024-10) - Linux");
  ...
  129.0.6668.89 on Linux.");

  script_tag(name: "solution", value:"Update to version 129.0.6668.89 or
  later.");
...
if(version_is_less(version:vers, test_version:"129.0.6668.89")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"129.0.6668.89", install_path:path);
