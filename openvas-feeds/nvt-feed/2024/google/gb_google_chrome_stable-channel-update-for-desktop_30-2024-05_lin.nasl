...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834034");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_30-2024-05) - Linux");
  ...
  125.0.6422.141 on Linux");

  script_tag(name: "solution", value:"Update to version 125.0.6422.141 or
  later.");
...
if(version_is_less(version:vers, test_version:"125.0.6422.141")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"125.0.6422.141", install_path:path);
