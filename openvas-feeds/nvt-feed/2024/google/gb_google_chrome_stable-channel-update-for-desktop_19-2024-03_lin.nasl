...
if(description)
{
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_19-2024-03) - Linux");
  ...
  123.0.6312.58 on Linux");

  script_tag(name:"solution", value:"Upgrade to version 123.0.6312.58 or
  later.");
...
if(version_is_less(version:vers, test_version:"123.0.6312.58")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"123.0.6312.58", install_path:path);
