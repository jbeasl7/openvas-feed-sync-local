...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832905");
  ...
  script_tag(name:"creation_date", value:"2024-04-02 11:19:44 +0530 (Tue, 02 Apr 2024)");
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop-2024-03) - Mac OS X");
  ...
  122.0.6261.111 on Mac OS X");

  script_tag(name:"solution", value:"Update to version 122.0.6261.111/.112 or
  later.");
...
if(version_is_less(version:vers, test_version:"122.0.6261.111")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"122.0.6261.111/.112", install_path:path);
