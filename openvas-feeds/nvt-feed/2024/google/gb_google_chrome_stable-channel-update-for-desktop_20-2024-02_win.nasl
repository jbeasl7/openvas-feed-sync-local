...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832845");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_20-2024-02) - Windows");
  ...
  122.0.6261.57 on Windows");

  script_tag(name:"solution", value:"Upgrade to version 122.0.6261.57/.58 or
...
if(version_is_less(version:vers, test_version:"122.0.6261.57")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"122.0.6261.57/.58", install_path:path);
