...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832895");
  ...
  script_tag(name:"creation_date", value:"2024-03-27 05:29:14 +0530 (Wed, 27 Mar 2024)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_12-2024-03) - Mac OS X");
  ...
  122.0.6261.128 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 122.0.6261.128/.129 or
  later.");
...
if(version_is_less(version:vers, test_version:"122.0.6261.128")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"122.0.6261.128/.129", install_path:path);
