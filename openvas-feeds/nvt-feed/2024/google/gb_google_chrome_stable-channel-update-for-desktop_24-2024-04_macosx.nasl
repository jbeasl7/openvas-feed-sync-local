...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832962");
  script_version("2024-12-12T09:30:20+0000");
  script_cve_id("CVE-2024-4058", "CVE-2024-4059", "CVE-2024-4060", "CVE-2024-7018");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_24-2024-04) - MAC OS X");
  ...
  124.0.6367.78 on MAC OS X");

  script_tag(name: "solution", value:"Update to version 124.0.6367.78/.79 or
  later.");
...
if(version_is_less(version:vers, test_version:"124.0.6367.78")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"124.0.6367.78/.79", install_path:path);
