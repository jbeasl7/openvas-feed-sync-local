...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834430");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_21-2024-08) - Linux");
  ...
  128.0.6613.84 on Linux");

  script_tag(name: "solution", value:"Update to version 128.0.6613.84 or
  later.");
...
if(version_is_less(version:vers, test_version:"128.0.6613.84")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.0.6613.84", install_path:path);
