...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242898-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228120");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-August/036431.html");
...
- CVE-2024-6655: Fixed library injection from current working directory (bsc#1228120).");
  ...
  script_tag(name:"affected", value:"'gtk3' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
