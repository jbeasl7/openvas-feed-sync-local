...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3309.1");
  ...
  script_tag(name:"severity_date", value:"2025-08-28 01:45:31 +0000 (Thu, 28 Aug 2025)");

  script_name("SUSE: Security Advisory (SUSE-SU-2024:3309-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3309-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243309-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036947.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmfx' package(s) announced via the SUSE-SU-2024:3309-1 advisory.");
...
- CVE-2023-47169: Fixed an improper buffer restrictions. (bsc#1226901)");
  ...
  script_tag(name:"affected", value:"'libmfx' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmfx", rpm:"libmfx~19.1.0~3.3.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libmfx1", rpm:"libmfx1~19.1.0~3.3.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
