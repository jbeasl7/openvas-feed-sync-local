...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243871-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220262");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230698");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-November/019759.html");
...
- CVE-2024-41996: Avoid expensive public key validation for known safe-prime groups (DHEATATTACK) (bsc#1230698)");
  ...
  script_tag(name:"affected", value:"'openssl-3' package(s) on SUSE Linux Enterprise Server 15-SP4.");
