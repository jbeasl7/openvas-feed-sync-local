...
* Remove no longer necessary BuildRequires: libfstrm-devel and
 libprotobuf-c-devel");
  ...
  script_tag(name:"affected", value:"'unbound' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
