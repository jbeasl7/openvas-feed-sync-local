...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240558-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218971");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/017960.html");
 ...
 * The strict-kex extension is announced in the list of available
 ...
 or replaced, the extension is not added back automatically.");
  ...
  script_tag(name:"affected", value:"'libssh2_org' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
