...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243252-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036896.html");
...
- CVE-2024-43819: Reject memory region operations for ... [Please see the references for more information on the vulnerabilities]");
