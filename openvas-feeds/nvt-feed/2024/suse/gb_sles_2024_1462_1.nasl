...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241462-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/035120.html");
...
- Removed POST_PROCESS_PE_FLAGS=-N from the build command in shim.spec to
 ...
 and testing. (bsc#1205588)");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
