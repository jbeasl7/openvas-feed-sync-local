...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240506-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/017930.html");
...
- Remove python-boto dependency for the python3-salt-testsuite package for Tumbleweed");
  ...
  script_tag(name:"affected", value:"'salt' package(s) on SUSE Linux Enterprise Server 15-SP1.");
