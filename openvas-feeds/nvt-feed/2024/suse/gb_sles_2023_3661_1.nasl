...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20233661-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214052");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/018046.html");
...
- CVE-2023-4039: Fixed incorrect stack protector for C99 VLAs on Aarch64 (bsc#1214052).");
  ...
  script_tag(name:"affected", value:"'gcc12' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cross-nvptx-gcc12", rpm:"cross-nvptx-gcc12~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cross-nvptx-newlib12-devel", rpm:"cross-nvptx-newlib12-devel~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc12-32bit", rpm:"gcc12-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc12-c++-32bit", rpm:"gcc12-c++-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"gcc12-fortran-32bit", rpm:"gcc12-fortran-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libasan8-32bit", rpm:"libasan8-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libatomic1-32bit", rpm:"libatomic1-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgcc_s1-32bit", rpm:"libgcc_s1-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgfortran5-32bit", rpm:"libgfortran5-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgomp1-32bit", rpm:"libgomp1-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libitm1-32bit", rpm:"libitm1-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libobjc4-32bit", rpm:"libobjc4-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libquadmath0-32bit", rpm:"libquadmath0-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libstdc++6-32bit", rpm:"libstdc++6-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libstdc++6-devel-gcc12-32bit", rpm:"libstdc++6-devel-gcc12-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libstdc++6-pp-32bit", rpm:"libstdc++6-pp-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libubsan1-32bit", rpm:"libubsan1-32bit~12.3.0+git1204~150000.1.16.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
