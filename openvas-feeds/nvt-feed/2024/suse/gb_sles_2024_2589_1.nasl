...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242589-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1225567");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-July/019008.html");
...
- CVE-2024-36472: Fixed portal helper automatically launched without user confirmation (bsc#1225567)");
  ...
  script_tag(name:"affected", value:"'gnome-shell' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
