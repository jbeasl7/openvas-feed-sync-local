...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0899.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0899-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0899-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240899-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1068950");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1081527");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211052");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-March/034658.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdb' package(s) announced via the SUSE-SU-2024:0899-1 advisory.");
 ...
 * New ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~13.2~150100.8.39.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdbserver", rpm:"gdbserver~13.2~150100.8.39.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~13.2~150100.8.39.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdbserver", rpm:"gdbserver~13.2~150100.8.39.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
