...
- Re-enabled build tests for s390x and ppc (bsc#1222553)");
  ...
  script_tag(name:"affected", value:"'python-Pillow' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
