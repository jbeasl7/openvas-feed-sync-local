...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0759.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0759-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0759-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240759-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1018158");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1178386");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179694");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1179721");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1181505");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1182117");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-March/018088.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc' package(s) announced via the SUSE-SU-2024:0759-1 advisory.");
...
if(release == "SLES11.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-32bit", rpm:"glibc-32bit~2.11.3~17.110.43.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-devel-32bit", rpm:"glibc-devel-32bit~2.11.3~17.110.43.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-locale-32bit", rpm:"glibc-locale-32bit~2.11.3~17.110.43.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"glibc-profile-32bit", rpm:"glibc-profile-32bit~2.11.3~17.110.43.1", rls:"SLES11.0SP4"))) {
    report += res;
  }
