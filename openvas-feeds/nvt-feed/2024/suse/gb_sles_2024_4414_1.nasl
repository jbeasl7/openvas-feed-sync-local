...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.4414.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:4414-1)");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~14.2~150400.15.20.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdbserver", rpm:"gdbserver~14.2~150400.15.20.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
