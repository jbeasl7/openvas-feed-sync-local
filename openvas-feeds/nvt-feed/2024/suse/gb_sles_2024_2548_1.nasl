...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242548-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1224122");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-July/018997.html");
...
- CVE-2024-3727: Fixed digest type does not guarantee valid type in containers/image (bsc#1224122)");
  ...
  script_tag(name:"affected", value:"'podman' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
