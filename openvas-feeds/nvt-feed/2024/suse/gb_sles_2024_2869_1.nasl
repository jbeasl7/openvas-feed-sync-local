...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242869-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220356");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1227525");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-August/019164.html");
...
- Updated to 2.66 state of Mozilla SSL root CAs (bsc#1220356)
 ...
 - VeriSign Class 2 Public Primary Certification Authority - G3");
  ...
  script_tag(name:"affected", value:"'ca-certificates-mozilla' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ca-certificates-mozilla", rpm:"ca-certificates-mozilla~2.68~150200.33.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
