...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3518.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3518-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3518-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243518-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230979");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-October/037136.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2024:3518-1 advisory.");
...
Update to Firefox Extended Support Release 128.3.0 ESR (MFSA-2024-47, bsc#1230979):
 ...
 - CVE-2024-9402: Memory safety bugs fixed in Firefox 131, Firefox ESR 128.3, Thunderbird 131, and Thunderbird 128.3");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~128.3.0~112.228.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-devel", rpm:"MozillaFirefox-devel~128.3.0~112.228.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations-common", rpm:"MozillaFirefox-translations-common~128.3.0~112.228.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
