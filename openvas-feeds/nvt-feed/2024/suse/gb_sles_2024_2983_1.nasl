...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.2983.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:2983-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~8.2.6~150600.3.9.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-pr-helper", rpm:"qemu-pr-helper~8.2.6~150600.3.9.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-tools", rpm:"qemu-tools~8.2.6~150600.3.9.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
