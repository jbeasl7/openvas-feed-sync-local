...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0885.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0885-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0885-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240885-1.html");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-March/018178.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'spectre-meltdown-checker' package(s) announced via the SUSE-SU-2024:0885-1 advisory.");
...
- updated to 0.45
 ...
 - feat: add --cpu, apply changes to (read<pipe>write)_msr, update fwdb to v221+i20220208
 ...
 - fix: variant4: added case where prctl ssbd status is tagged as 'unknown'");
  ...
  script_tag(name:"affected", value:"'spectre-meltdown-checker' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"spectre-meltdown-checker", rpm:"spectre-meltdown-checker~0.46~3.9.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
