...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3344.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3344-1)");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.25-client", rpm:"kubernetes1.25-client~1.25.16~150400.9.16.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.25-client-common", rpm:"kubernetes1.25-client-common~1.25.16~150400.9.16.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
