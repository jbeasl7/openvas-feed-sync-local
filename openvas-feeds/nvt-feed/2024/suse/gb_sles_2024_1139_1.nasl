...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.1139.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1139-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241139-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221323");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034883.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2024:1139-1 advisory.");
...
- CVE-2023-43490: Incorrect calculation in microcode keying mechanism
 for some Intel Xeon D Processors with Intel(r) SGX may allow a
 privileged user to potentially enable information disclosure via
 local access.");

  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20240312~150200.38.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20240312~150200.38.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20240312~150200.38.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
