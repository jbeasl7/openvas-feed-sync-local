...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0898.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0898-1)");
 ...
 * New ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gdb", rpm:"gdb~13.2~150400.15.14.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gdbserver", rpm:"gdbserver~13.2~150400.15.14.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
