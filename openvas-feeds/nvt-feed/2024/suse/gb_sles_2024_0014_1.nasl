...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240014-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218226");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017586.html");
...
- CVE-2023-4255: Fixed out-of-bounds write in function checkType() in etc.c (bsc#1218226).");
  ...
  script_tag(name:"affected", value:"'w3m' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
