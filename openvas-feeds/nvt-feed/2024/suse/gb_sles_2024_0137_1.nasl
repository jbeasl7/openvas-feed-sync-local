...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240137-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218475");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017680.html");
...
- CVE-2024-22365: Fixed a local denial of service during PAM login
 due to a missing check during path manipulation (bsc#1218475).");
  ...
  script_tag(name:"affected", value:"'pam' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
