...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242685-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211674");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-August/036241.html");
...
- CVE-2023-32681: Fixed unintended leak of Proxy-Authorization header (bsc#1211674).");
  ...
  script_tag(name:"affected", value:"'python-requests' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
