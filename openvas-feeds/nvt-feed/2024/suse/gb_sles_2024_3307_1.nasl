...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3307.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3307-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3307-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243307-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230400");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036948.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ucode-intel' package(s) announced via the SUSE-SU-2024:3307-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20240910~143.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
