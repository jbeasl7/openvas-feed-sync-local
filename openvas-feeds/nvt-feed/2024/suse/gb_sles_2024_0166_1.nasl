...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240166-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1192760");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218300");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218301");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017715.html");
...
- CVE-2023-50230: Fixed an out of bounds write in the secondary
 ...
 (bsc#1218301).");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Server 15-SP1, SUSE Linux Enterprise Server for SAP Applications 15-SP1.");
