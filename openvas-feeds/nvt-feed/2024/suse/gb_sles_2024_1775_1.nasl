...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241775-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1171479");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-May/035355.html");
...
- CVE-2020-12762: Fixed integer overflow and out-of-bounds write via a large JSON file (bsc#1171479).");
  ...
  script_tag(name:"affected", value:"'libfastjson' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
