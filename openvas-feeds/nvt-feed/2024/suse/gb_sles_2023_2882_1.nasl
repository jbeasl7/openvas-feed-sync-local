...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232882-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210999");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/017860.html");
 ...
 - CVE-2023-31484: Enable TLS cert verification in CPAN (bsc#1210999).");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
