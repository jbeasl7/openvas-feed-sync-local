...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240770-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220552");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-March/018097.html");
 ...
 * this makes it easy to replace the package from nVidia's
 CUDA repository with this presigned package");
  ...
  script_tag(name:"affected", value:"'kernel-firmware-nvidia-gspx-G06, nvidia-open-driver-G06-signed' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
