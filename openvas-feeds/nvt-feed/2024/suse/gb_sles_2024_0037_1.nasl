...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240037-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1105832");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017591.html");
...
- CVE-2018-15853");
  ...
  script_tag(name:"affected", value:"'libxkbcommon' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
