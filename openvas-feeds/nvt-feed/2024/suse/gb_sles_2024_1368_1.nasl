...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.1368.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1368-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241368-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198101");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205588");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1205855");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210382");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1213945");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215098");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215099");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215100");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215101");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215102");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215103");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1219460");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/035046.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'shim' package(s) announced via the SUSE-SU-2024:1368-1 advisory.");
...
- Removed POST_PROCESS_PE_FLAGS=-N from the build command in shim.spec to
 ...
 and testing. (bsc#1205588)");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~150300.4.20.2", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~150300.4.20.2", rls:"SLES15.0SP4"))) {
    report += res;
  }
