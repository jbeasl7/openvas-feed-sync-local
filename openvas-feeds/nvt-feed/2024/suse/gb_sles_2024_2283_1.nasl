...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242283-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1225771");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/035808.html");
...
- CVE-2024-5564: Add a check on the route information option length field. (bsc#1225771)");
  ...
  script_tag(name:"affected", value:"'libndp' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
