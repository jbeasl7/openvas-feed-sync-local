...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242681-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1137930");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-July/019069.html");
...
- CVE-2019-12795: Fixed attack via local D-Bus method calls (bsc#1137930)");
  ...
  script_tag(name:"affected", value:"'gvfs' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
