...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242975-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228204");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-August/019282.html");
...
- Fix QTextureAtlas parenting that could lead to crashes due to being used after free'd.");
  ...
  script_tag(name:"affected", value:"'libqt5-qt3d' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
