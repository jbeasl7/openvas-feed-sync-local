...
- Craft the jgit script from the real Main class of the jar file instead of using a jar launcher (bsc#1209646)");
  ...
  script_tag(name:"affected", value:"'eclipse-jgit, jsch' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
