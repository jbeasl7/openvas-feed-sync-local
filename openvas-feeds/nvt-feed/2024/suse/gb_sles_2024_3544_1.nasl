...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3544.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3544-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243544-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-October/037170.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Mesa' package(s) announced via the SUSE-SU-2024:3544-1 advisory.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"Mesa-libVulkan-devel", rpm:"Mesa-libVulkan-devel~21.2.4~150400.68.15.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
