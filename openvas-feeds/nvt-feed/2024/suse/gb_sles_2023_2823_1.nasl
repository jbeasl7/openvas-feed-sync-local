...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2023/suse-su-20232823-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1212499");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/018036.html");
...
- CVE-2023-35789: Fixed insecure credentials submission (bsc#1212499).");
  ...
  script_tag(name:"affected", value:"'rabbitmq-c' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
