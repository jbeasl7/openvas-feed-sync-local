...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243575-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231264");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231265");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-October/019582.html");
...
- CVE-2024-31449: Fixed integer overflow bug in Lua bit_tohex (bsc#1231264)");
  ...
  script_tag(name:"affected", value:"'redis' package(s) on SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
