...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242767-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220356");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1227525");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-August/036323.html");
...
- Updated to 2.66 state of Mozilla SSL root CAs (bsc#1220356)
 ...
 - VeriSign Class 2 Public Primary Certification Authority - G3");
  ...
  script_tag(name:"affected", value:"'ca-certificates-mozilla' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
