...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3343.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3343-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243343-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1062303");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1194400");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211630");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211631");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1214406");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036980.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes1.24' package(s) announced via the SUSE-SU-2024:3343-1 advisory.");
...
- Update go to version 1.22.5 in build requirements. (bsc#1229858)");
  ...
  script_tag(name:"affected", value:"'kubernetes1.24' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.24-client", rpm:"kubernetes1.24-client~1.24.17~150300.7.6.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.24-client-common", rpm:"kubernetes1.24-client-common~1.24.17~150300.7.6.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
