...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0539.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:0539-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0539-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240539-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1158095");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1168699");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1174713");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1189608");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/017974.html");
  script_xref(name:"URL", value:"https://www.libssh.org/2020/04/09/libssh-0-9-4-and-libssh-0-8-9-security-release/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh' package(s) announced via the SUSE-SU-2024:0539-1 advisory.");
...
* ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh-config", rpm:"libssh-config~0.9.8~3.12.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh4", rpm:"libssh4~0.9.8~3.12.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh4-32bit", rpm:"libssh4-32bit~0.9.8~3.12.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
