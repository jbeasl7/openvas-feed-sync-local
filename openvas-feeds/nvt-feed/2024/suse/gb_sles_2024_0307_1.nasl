...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240307-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1215796");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/017841.html");
...
- CVE-2023-40474: Fixed an integer overflow during MXF file parsing (bsc#1215796).");
  ...
  script_tag(name:"affected", value:"'gstreamer' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
