...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.4360.1");
  script_cve_id("CVE-2023-45142", "CVE-2023-47108", "CVE-2024-41110");
  script_tag(name:"creation_date", value:"2024-12-18 04:17:48 +0000 (Wed, 18 Dec 2024)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:4360-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20244360-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-December/020020.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker' package(s) announced via the SUSE-SU-2024:4360-1 advisory.");
...
- Update --add-runtime to point to correct binary path.");
  ...
  script_tag(name:"affected", value:"'docker' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker", rpm:"docker~26.1.5_ce~150000.212.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-bash-completion", rpm:"docker-bash-completion~26.1.5_ce~150000.212.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker", rpm:"docker~26.1.5_ce~150000.212.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-bash-completion", rpm:"docker-bash-completion~26.1.5_ce~150000.212.1", rls:"SLES15.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-fish-completion", rpm:"docker-fish-completion~26.1.5_ce~150000.212.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker", rpm:"docker~26.1.5_ce~150000.212.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-bash-completion", rpm:"docker-bash-completion~26.1.5_ce~150000.212.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-rootless-extras", rpm:"docker-rootless-extras~26.1.5_ce~150000.212.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
