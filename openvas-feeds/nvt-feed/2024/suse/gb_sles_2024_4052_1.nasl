...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.4052.1");
  script_cve_id("CVE-2024-10976", "CVE-2024-10977", "CVE-2024-10978", "CVE-2024-10979");
  script_tag(name:"creation_date", value:"2024-11-26 04:15:00 +0000 (Tue, 26 Nov 2024)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:4052-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4052-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20244052-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-November/019843.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql, postgresql16, postgresql17' package(s) announced via the SUSE-SU-2024:4052-1 advisory.");
