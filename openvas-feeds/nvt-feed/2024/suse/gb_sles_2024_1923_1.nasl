...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.1923.1");
  script_cve_id("CVE-2022-30698", "CVE-2022-30699", "CVE-2022-3204", "CVE-2023-50387", "CVE-2023-50868");
  script_tag(name:"creation_date", value:"2024-06-05 04:27:37 +0000 (Wed, 05 Jun 2024)");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1923-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libunbound8", rpm:"libunbound8~1.20.0~150600.23.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound-anchor", rpm:"unbound-anchor~1.20.0~150600.23.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound-devel", rpm:"unbound-devel~1.20.0~150600.23.3.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
