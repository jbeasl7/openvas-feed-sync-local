...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3873.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3873-1)");
...
- CVE-2021-43809: Fixed remote execution via Gemfile argument injection (bsc#1193578)");
  ...
  script_tag(name:"affected", value:"'rubygem-bundler' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server 15-SP6, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~1.16.1~150000.3.6.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~1.16.1~150000.3.6.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~1.16.1~150000.3.6.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-bundler", rpm:"ruby2.5-rubygem-bundler~1.16.1~150000.3.6.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
