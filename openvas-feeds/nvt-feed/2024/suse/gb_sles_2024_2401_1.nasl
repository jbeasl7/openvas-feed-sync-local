...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.2401.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:2401-1)");
...
- CVE-2019-13225: Fixed null-pointer dereference in match_at() in regexec.c (bsc#1141157).");
  ...
  script_tag(name:"affected", value:"'oniguruma' package(s) on SUSE Linux Enterprise Server 15-SP6.");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libonig4", rpm:"libonig4~6.7.0~150000.3.6.1", rls:"SLES15.0SP6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"oniguruma-devel", rpm:"oniguruma-devel~6.7.0~150000.3.6.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
