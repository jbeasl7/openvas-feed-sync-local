...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3548.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3548-1)");
...
if(release == "SLES15.0SP6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvdpau_r300", rpm:"libvdpau_r300~22.3.5~150500.77.5.1", rls:"SLES15.0SP6"))) {
    report += res;
  }
