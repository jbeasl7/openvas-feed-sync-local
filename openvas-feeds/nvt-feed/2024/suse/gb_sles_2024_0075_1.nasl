...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240075-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1198666");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1200085");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1204040");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1209242");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1210687");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1211746");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017614.html");
  ...
  script_xref(name:"URL", value:"https://www.w3.org/TR/xmlsec-algorithms/#bib-XMLDSIG-CORE1");
 ...
 * Support for ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'LibreOffice' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
