...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240106-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017657.html");
...
- bsc#1206796: Refine the distinction of where to use sysusers and
 use bcond to have the expression only in one place.");
  ...
  script_tag(name:"affected", value:"'postgresql, postgresql15, postgresql16' package(s) on SUSE Linux Enterprise Server 15-SP3.");
