...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.4359.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:4359-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20244359-1/");
...
if(release == "SLES15.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libcurl4", rpm:"libcurl4~8.0.1~150400.5.59.1", rls:"SLES15.0SP5"))) {
    report += res;
  }
