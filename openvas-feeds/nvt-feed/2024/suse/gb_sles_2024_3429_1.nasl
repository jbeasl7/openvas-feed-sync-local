...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243429-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1229783");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-September/019514.html");
...
- CVE-2023-49582: Fixed an unexpected lax shared memory permissions. (bsc#1229783)");
  ...
  script_tag(name:"affected", value:"'apr' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
