...
- CVE-2023-51764: Fixed SMTP smuggling attack (bsc#1218304).");
  ...
  script_tag(name:"affected", value:"'postfix' package(s) on SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
