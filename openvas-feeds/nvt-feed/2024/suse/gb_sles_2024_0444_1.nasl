...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.0444.1");
  script_tag(name:"creation_date", value:"2024-02-12 04:22:16 +0000 (Mon, 12 Feb 2024)");
  script_version("2025-08-15T15:42:26+0000");
  script_tag(name:"last_modification", value:"2025-08-15 15:42:26 +0000 (Fri, 15 Aug 2025)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("SUSE: Security Advisory (SUSE-SU-2024:0444-1)");
...
- run rpm commands in import script only when libzypp is not
 active. bsc#1219189 bsc#1219123");
  ...
  script_tag(name:"affected", value:"'suse-build-key' package(s) on SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server 15-SP3, SUSE Linux Enterprise Server 15-SP4, SUSE Linux Enterprise Server for SAP Applications 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP3, SUSE Linux Enterprise Server for SAP Applications 15-SP4.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"suse-build-key", rpm:"suse-build-key~12.0~150000.8.40.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"suse-build-key", rpm:"suse-build-key~12.0~150000.8.40.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"suse-build-key", rpm:"suse-build-key~12.0~150000.8.40.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
