...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.1145.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:1145-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241145-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034877.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah' package(s) announced via the SUSE-SU-2024:1145-1 advisory.");
...
if(release == "SLES15.0SP3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"buildah", rpm:"buildah~1.34.1~150300.8.22.1", rls:"SLES15.0SP3"))) {
    report += res;
  }
