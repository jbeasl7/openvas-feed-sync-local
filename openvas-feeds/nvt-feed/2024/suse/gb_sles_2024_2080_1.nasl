...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242080-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1050625");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1177583");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1223971");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-June/035640.html");
...
- clean: Do not report an error if no repos are defined at all (bsc#1223971)");
  ...
  script_tag(name:"affected", value:"'libzypp, zypper' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
