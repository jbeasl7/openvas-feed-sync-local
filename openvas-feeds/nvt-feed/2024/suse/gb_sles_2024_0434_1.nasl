...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240434-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1022790");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1022791");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/017895.html");
...
- CVE-2017-5849: Fixed out-of-bound read and write issue that can occur in function putgreytile() and put1bitbwtile() (bsc#1022790, bsc#1022791).");
  ...
  script_tag(name:"affected", value:"'netpbm' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5.");
