...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.4409.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:4409-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4409-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20244409-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220618");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1229238");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231373");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-December/020043.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim' package(s) announced via the SUSE-SU-2024:4409-1 advisory.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gvim", rpm:"gvim~9.1.0836~17.38.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim", rpm:"vim~9.1.0836~17.38.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-data", rpm:"vim-data~9.1.0836~17.38.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"vim-data-common", rpm:"vim-data-common~9.1.0836~17.38.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
