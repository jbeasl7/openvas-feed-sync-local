...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.3094.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:3094-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243094-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036778.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes1.26' package(s) announced via the SUSE-SU-2024:3094-1 advisory.");
...
if(release == "SLES15.0SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.26-client", rpm:"kubernetes1.26-client~1.26.15~150400.9.11.1", rls:"SLES15.0SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kubernetes1.26-client-common", rpm:"kubernetes1.26-client-common~1.26.15~150400.9.11.1", rls:"SLES15.0SP4"))) {
    report += res;
  }
