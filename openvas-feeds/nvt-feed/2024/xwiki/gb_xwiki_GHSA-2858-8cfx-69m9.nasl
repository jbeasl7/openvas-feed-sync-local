...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124632");
  ...
  script_tag(name:"severity_date", value:"2025-01-21 16:25:17 +0000 (Tue, 21 Jan 2025)");

  script_cve_id("CVE-2024-31982");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 2.4-milestone-1 < 14.10.20, 15.0-rc-1 < 15.5.4, 15.6-rc-1 < 15.10-rc-1 RCE Vulnerability (GHSA-2858-8cfx-69m9)");
  ...
  script_tag(name:"insight", value:"XWiki's database search allows remote code execution through
  the search text. This allows remote code execution for any visitor of a public wiki or user of a
  closed wiki as the database search is by default accessible for all users. This impacts the
  confidentiality, integrity and availability of the whole XWiki installation.");

  script_tag(name:"affected", value:"XWiki version 2.4-milestone-1 prior to 14.10.20, 15.0-rc-1
  ...
  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-2858-8cfx-69m9");
...
if( version_in_range_exclusive( version:version, test_version_lo:"2.4-milestone-1", test_version_up:"14.10.20" ) ) {
