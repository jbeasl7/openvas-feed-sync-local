...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124631");
  ...
  script_tag(name:"severity_date", value:"2025-01-09 16:49:22 +0000 (Thu, 09 Jan 2025)");

  script_cve_id("CVE-2024-31465");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 5.2-milestone-2 < 14.10.20, 15.0-rc-1 < 15.5.4, 15.6-rc-1 < 15.10-rc-1 RCE Vulnerability (GHSA-34fj-r5gq-7395)");
  ...
  script_tag(name:"insight", value:"Any user with edit right on any page can execute any code on
  the server by adding an object of type XWiki.SearchSuggestSourceClass to their user profile or
  any other page. This compromises the confidentiality, integrity and availability of the whole
  XWiki installation.");

  script_tag(name:"affected", value:"XWiki version 5.2-milestone-2 prior to 14.10.20, 15.0-rc-1
  ...
  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-34fj-r5gq-7395");
...
if( version_in_range_exclusive( version:version, test_version_lo:"5.2-milestone-2", test_version_up:"14.10.20" ) ) {
