...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.124628");
  ...
  script_tag(name:"severity_date", value:"2025-01-21 16:26:42 +0000 (Tue, 21 Jan 2025)");

  script_cve_id("CVE-2024-31981");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("XWiki 3.0.1 < 14.10.19, 15.0-rc-1 < 15.5.4, 15.6-rc-1 < 15.9 Privilege Escalation Vulnerability (GHSA-vxwr-wpjv-qjq7)");
  ...
  script_tag(name:"insight", value:"Privilege escalation (PR) from user registration through PDFClass.");
  ...
  script_xref(name:"URL", value:"https://github.com/xwiki/xwiki-platform/security/advisories/GHSA-vxwr-wpjv-qjq7");
