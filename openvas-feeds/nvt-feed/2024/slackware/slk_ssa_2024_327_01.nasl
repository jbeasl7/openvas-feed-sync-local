...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2024.327.01");
  script_cve_id("CVE-2024-11233", "CVE-2024-11234", "CVE-2024-11236", "CVE-2024-8929", "CVE-2024-8932");
  script_tag(name:"creation_date", value:"2024-11-25 08:45:29 +0000 (Mon, 25 Nov 2024)");
  ...
  script_name("Slackware: Security Advisory (SSA:2024-327-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2024-327-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2024&m=slackware-security.414039");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2024-11233");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2024-11234");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2024-11236");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2024-8929");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2024-8932");
  script_xref(name:"URL", value:"https://www.php.net/ChangeLog-8.php#8.1.31");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php' package(s) announced via the SSA:2024-327-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php81", ver:"8.1.31-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"php81", ver:"8.1.31-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"8.3.14-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"8.3.14-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
