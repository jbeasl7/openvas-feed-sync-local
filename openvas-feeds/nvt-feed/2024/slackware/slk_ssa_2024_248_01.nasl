...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2024.248.01");
  script_cve_id("CVE-2024-45490", "CVE-2024-45491", "CVE-2024-45492");
  script_tag(name:"creation_date", value:"2024-09-05 04:09:37 +0000 (Thu, 05 Sep 2024)");
  ...
  script_name("Slackware: Security Advisory (SSA:2024-248-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2024-248-01");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat' package(s) announced via the SSA:2024-248-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"expat", ver:"2.6.3-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"expat", ver:"2.6.3-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"expat", ver:"2.6.3-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"expat", ver:"2.6.3-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
