...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832842");
  ...
  script_tag(name:"creation_date", value:"2024-02-21 14:09:12 +0530 (Wed, 21 Feb 2024)");
  script_name("Mozilla Firefox ESR Security Update (mfsa_2024-06) - Mac OS X");
  ...
  script_tag(name:"solution", value:"Upgrade to version 115.8 or later, Please
