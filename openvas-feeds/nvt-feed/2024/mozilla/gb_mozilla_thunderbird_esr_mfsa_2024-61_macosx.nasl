...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834758");
  ...
  script_name("Mozilla Thunderbird ESR Security Update (MFSA2024-61) - Mac OS X");
  ...
  script_tag(name: "solution" , value:"Update to version 128.4.3 or later.");
...
if(version_is_less(version:vers, test_version:"128.4.3")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.4.3", install_path:path);
