...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834725");
  script_version("2025-01-24T05:37:33+0000");
  script_cve_id("CVE-2024-10460", "CVE-2024-10461", "CVE-2024-10462", "CVE-2024-10464",
                "CVE-2024-10465", "CVE-2024-10466", "CVE-2024-10467", "CVE-2024-10458",
                "CVE-2024-10459", "CVE-2024-10463");
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-56) - Windows");
...
if(version_in_range_exclusive(version:vers, test_version_lo:"120.0", test_version_up:"128.4")) {
