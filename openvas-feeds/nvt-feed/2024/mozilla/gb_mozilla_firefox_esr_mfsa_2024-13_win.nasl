...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832882");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2024-0743", "CVE-2024-2605", "CVE-2024-2608", "CVE-2024-2616",
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-13) - Windows");
