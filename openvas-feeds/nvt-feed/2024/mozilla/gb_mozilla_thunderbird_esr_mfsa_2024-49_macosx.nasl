...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834641");
  script_version("2025-01-09T06:16:22+0000");
  script_cve_id("CVE-2024-9392", "CVE-2024-9393", "CVE-2024-9394", "CVE-2024-8900",
  ...
  script_tag(name:"creation_date", value:"2024-10-03 11:13:14 +0530 (Thu, 03 Oct 2024)");
  script_name("Mozilla Thunderbird ESR Security Update (MFSA2024-49) - Mac OS X");
