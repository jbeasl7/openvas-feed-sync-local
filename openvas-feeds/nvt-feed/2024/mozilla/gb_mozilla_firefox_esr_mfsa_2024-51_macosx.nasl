...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834672");
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-51) - Mac OS X");

  script_tag(name:"summary", value:"Mozilla Firefox ESR is prone to an use
  ...
  115.16.1 and 128.x prior to 128.3.1 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 115.16.1 or 128.3.1
  later.");
...
if(version_is_less(version:vers, test_version:"115.16.1")) {
  fix = "115.16.1 or later";
}
else if(version_in_range_exclusive(version: vers, test_version_lo: "128", test_version_up: "128.3.1")) {
  fix = "128.3.1 or later";
}
