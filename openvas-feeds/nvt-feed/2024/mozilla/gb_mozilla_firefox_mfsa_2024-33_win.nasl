...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834455");
  ...
  script_name("Mozilla Firefox Security Update (MFSA2024-33) - Windows");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 129 on
  Windows.");
