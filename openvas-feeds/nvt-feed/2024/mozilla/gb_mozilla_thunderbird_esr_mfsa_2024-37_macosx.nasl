...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834450");
  script_version("2025-01-09T06:16:22+0000");
  script_cve_id("CVE-2024-7518", "CVE-2024-7519", "CVE-2024-7520", "CVE-2024-7521",
                "CVE-2024-7522", "CVE-2024-7525", "CVE-2024-7526", "CVE-2024-7527",
                "CVE-2024-7528", "CVE-2024-7529");
  ...
  script_tag(name:"creation_date", value:"2024-08-28 16:40:56 +0530 (Wed, 28 Aug 2024)");
  script_name("Mozilla Thunderbird ESR Security Update (MFSA2024-37) - Mac OS X");
  ...
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2024-37/");
