...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834452");
  script_version("2025-01-09T06:16:22+0000");
  script_cve_id("CVE-2024-7519", "CVE-2024-7521", "CVE-2024-7522", "CVE-2024-7525",
  ...
  script_tag(name:"creation_date", value:"2024-08-28 17:17:15 +0530 (Wed, 28 Aug 2024)");
  script_name("Mozilla Thunderbird Security Update (MFSA2024-38) - Mac OS X");
  ...
  script_tag(name: "solution" , value:"Update to version 115.14 or later.");
...
if(version_is_less(version:vers, test_version:"115.14")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"115.14", install_path:path);
