...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832841");
  ...
  script_tag(name:"creation_date", value:"2024-02-21 14:08:55 +0530 (Wed, 21 Feb 2024)");
  script_name("Mozilla Firefox ESR Security Update (mfsa_2024-06) - Windows");
