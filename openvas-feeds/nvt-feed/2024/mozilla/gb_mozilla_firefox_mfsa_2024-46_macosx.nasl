...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834639");
  ...
  script_tag(name:"creation_date", value:"2024-10-03 10:59:58 +0530 (Thu, 03 Oct 2024)");
  script_name("Mozilla Firefox Security Update (MFSA2024-46) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Mozilla Firefox prior to version 131 on
  Mac OS X.");
