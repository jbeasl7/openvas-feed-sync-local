...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834783");
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-65) - Mac OS X");
  ...
  to bypass the Content Security Policy (CSP) frame-src and conduct denial of
  service and DOM-based cross-site scripting (XSS) attacks.");
