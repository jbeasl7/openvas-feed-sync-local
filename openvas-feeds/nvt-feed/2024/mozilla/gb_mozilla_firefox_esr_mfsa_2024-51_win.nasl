...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834671");
  ...
  script_name("Mozilla Firefox ESR Security Update (MFSA2024-51) - Windows");
  ...
  115.16.1 and 128.x prior to 128.3.1 on Windows.");
