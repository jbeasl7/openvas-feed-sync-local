...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832888");
  ...
  script_tag(name:"creation_date", value:"2024-03-25 15:23:16 +0530 (Mon, 25 Mar 2024)");
  script_name("Mozilla Firefox Security Update (MFSA2024-15) - Windows");
