...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2024.0356");
  ...
  script_name("Mageia: Security Advisory (MGASA-2024-0356)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2024-0356");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2024-0356.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=33709");
  script_xref(name:"URL", value:"https://www.openwall.com/lists/oss-security/2024/10/25/1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'networkmanager-libreswan' package(s) announced via the MGASA-2024-0356 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was found in the libreswan client plugin for NetworkManager
...
(CVE-2024-9050)");
  ...
  script_tag(name:"affected", value:"'networkmanager-libreswan' package(s) on Mageia 9.");
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"networkmanager-libreswan", rpm:"networkmanager-libreswan~1.2.24~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
