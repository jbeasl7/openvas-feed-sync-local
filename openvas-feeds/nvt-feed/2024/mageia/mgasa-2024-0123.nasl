...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2024.0123");
  ...
  script_name("Mageia: Security Advisory (MGASA-2024-0123)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2024-0123");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2024-0123.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=33075");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-rack' package(s) announced via the MGASA-2024-0123 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Carefully crafted content type headers can cause Rack's media type
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby-rack", rpm:"ruby-rack~2.2.8.1~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ruby-rack-doc", rpm:"ruby-rack-doc~2.2.8.1~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
