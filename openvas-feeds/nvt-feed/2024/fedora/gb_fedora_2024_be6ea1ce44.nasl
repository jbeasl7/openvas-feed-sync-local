...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.9810161019719910144");
  script_cve_id("CVE-2024-12254", "CVE-2024-9287");
  script_tag(name:"creation_date", value:"2024-12-19 04:08:58 +0000 (Thu, 19 Dec 2024)");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-be6ea1ce44)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-be6ea1ce44");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-be6ea1ce44");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.13' package(s) announced via the FEDORA-2024-be6ea1ce44 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.13", rpm:"python3.13~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-debug", rpm:"python3.13-debug~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-debuginfo", rpm:"python3.13-debuginfo~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-debugsource", rpm:"python3.13-debugsource~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-devel", rpm:"python3.13-devel~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-freethreading", rpm:"python3.13-freethreading~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-freethreading-debug", rpm:"python3.13-freethreading-debug~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-idle", rpm:"python3.13-idle~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-libs", rpm:"python3.13-libs~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-test", rpm:"python3.13-test~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.13-tkinter", rpm:"python3.13-tkinter~3.13.1~2.fc40", rls:"FC40"))) {
    report += res;
  }
