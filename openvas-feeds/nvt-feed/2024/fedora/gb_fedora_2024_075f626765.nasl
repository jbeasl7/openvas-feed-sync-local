...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.075102626765");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-075f626765)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-075f626765");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-075f626765");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2327512");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2328745");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'uv' package(s) announced via the FEDORA-2024-075f626765 advisory.");
...
- [links moved to references]");
  ...
  script_tag(name:"affected", value:"'uv' package(s) on Fedora 40.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-uv", rpm:"python3-uv~0.5.5~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"uv", rpm:"uv~0.5.5~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"uv-debuginfo", rpm:"uv-debuginfo~0.5.5~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"uv-debugsource", rpm:"uv-debugsource~0.5.5~2.fc40", rls:"FC40"))) {
    report += res;
  }
