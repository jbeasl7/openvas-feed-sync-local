...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886506");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:42:18 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for c-ares (FEDORA-2024-d351e7318e)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-d351e7318e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2P76QYINQNPEHUTEEDOUYIRZ2X6UVZ5K");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'c-ares'
  package(s) announced via the FEDORA-2024-d351e7318e advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"c-ares", rpm:"c-ares~1.28.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
