...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-55e7e839f1)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-55e7e839f1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2024-55e7e839f1 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~124.0.6367.155~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~124.0.6367.155~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~124.0.6367.155~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~124.0.6367.155~1.fc39", rls:"FC39"))) {
    report += res;
  }
