...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.89710010249749824");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-8adf4a4b24)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-8adf4a4b24");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8adf4a4b24");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2327529");
  script_xref(name:"URL", value:"https://github.com/rschupp/PAR-Packer/issues/88");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Module-ScanDeps' package(s) announced via the FEDORA-2024-8adf4a4b24 advisory.");
...
- add preload rule for MooX::HandlesVia
 cf. [link moved to references]");
  ...
  script_tag(name:"affected", value:"'perl-Module-ScanDeps' package(s) on Fedora 40.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Module-ScanDeps", rpm:"perl-Module-ScanDeps~1.37~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"perl-Module-ScanDeps-tests", rpm:"perl-Module-ScanDeps-tests~1.37~1.fc40", rls:"FC40"))) {
    report += res;
  }
