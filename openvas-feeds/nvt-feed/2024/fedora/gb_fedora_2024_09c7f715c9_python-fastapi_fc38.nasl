...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886299");
  ...
  script_name("Fedora: Security Advisory for python-fastapi (FEDORA-2024-09c7f715c9)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RJTG2EGWSYJG2H3MN7QOPFYYHTWU3QRI");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-fastapi", rpm:"python-fastapi~0.99.0~7.fc38", rls:"FC38"))) {
    report += res;
  }
