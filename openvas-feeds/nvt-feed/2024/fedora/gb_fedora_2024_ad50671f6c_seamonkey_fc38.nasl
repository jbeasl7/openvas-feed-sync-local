...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886391");
  ...
  script_tag(name:"creation_date", value:"2024-04-03 01:16:15 +0000 (Wed, 03 Apr 2024)");
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2024-ad50671f6c)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-ad50671f6c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/B43YBFNLAVDFNM7QYIEEBVWFGD2FJR4P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2024-ad50671f6c advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.18.2~1.fc38", rls:"FC38"))) {
    report += res;
  }
