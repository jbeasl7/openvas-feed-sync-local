...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2782");
  ...
  script_name("Huawei EulerOS: Security Advisory for qemu (EulerOS-SA-2024-2782)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2782");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2782");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'qemu' package(s) announced via the EulerOS-SA-2024-2782 advisory.");
...
if(release == "EULEROSVIRT-2.12.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu", rpm:"qemu~6.2.0.oe2203sp1~2.12.0.5.388", rls:"EULEROSVIRT-2.12.0"))) {
    report += res;
  }
