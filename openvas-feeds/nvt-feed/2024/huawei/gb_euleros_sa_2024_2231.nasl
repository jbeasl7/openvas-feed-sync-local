...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2231");
  ...
  script_name("Huawei EulerOS: Security Advisory for xorg-x11-server (EulerOS-SA-2024-2231)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2231");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2231");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'xorg-x11-server' package(s) announced via the EulerOS-SA-2024-2231 advisory.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xorg-x11-server-help", rpm:"xorg-x11-server-help~1.20.11~13.h8.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
