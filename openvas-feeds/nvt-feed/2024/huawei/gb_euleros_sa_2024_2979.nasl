...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2979");
  ...
  script_name("Huawei EulerOS: Security Advisory for docker-runc (EulerOS-SA-2024-2979)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2979");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2979");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'docker-runc' package(s) announced via the EulerOS-SA-2024-2979 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-runc", rpm:"docker-runc~1.0.0.rc3~300.h30.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
