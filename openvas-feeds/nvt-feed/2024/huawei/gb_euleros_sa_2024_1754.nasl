...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1754");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2024-1754)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1754");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1754");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2024-1754 advisory.");
  ...
  script_tag(name:"affected", value:"'sqlite' package(s) on Huawei EulerOS V2.0SP12.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.37.2~5.h5.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
