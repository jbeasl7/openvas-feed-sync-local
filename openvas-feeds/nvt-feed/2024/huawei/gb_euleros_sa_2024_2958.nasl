...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2958");
  ...
  script_name("Huawei EulerOS: Security Advisory for syslinux (EulerOS-SA-2024-2958)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2958");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2958");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'syslinux' package(s) announced via the EulerOS-SA-2024-2958 advisory.");
...
The png_handle_sCAL function in pngrutil.c in libpng 1.0.x before 1.0.55, 1.2.x before 1.2.45, 1.4.x before 1.4.8, and ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'syslinux' package(s) on Huawei EulerOS V2.0SP12(x86_64).");
...
if(release == "EULEROS-2.0SP12-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"syslinux", rpm:"syslinux~6.04~13.h3.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"syslinux-nonlinux", rpm:"syslinux-nonlinux~6.04~13.h3.eulerosv2r12", rls:"EULEROS-2.0SP12-x86_64"))) {
    report += res;
  }
