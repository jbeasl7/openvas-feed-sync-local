...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2116");
  ...
  script_name("Huawei EulerOS: Security Advisory for expat (EulerOS-SA-2024-2116)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2116");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2116");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2024-2116 advisory.");
...
if(release == "EULEROSVIRT-2.10.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.2.9~2.h10.eulerosv2r10", rls:"EULEROSVIRT-2.10.0"))) {
    report += res;
  }
