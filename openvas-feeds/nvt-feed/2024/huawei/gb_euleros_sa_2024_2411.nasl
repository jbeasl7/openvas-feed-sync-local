...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2411");
  ...
  script_name("Huawei EulerOS: Security Advisory for docker-engine (EulerOS-SA-2024-2411)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2411");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2411");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'docker-engine' package(s) announced via the EulerOS-SA-2024-2411 advisory.");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"docker-engine", rpm:"docker-engine~1:18.09.0~200.h88.42.30.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"docker-engine-selinux", rpm:"docker-engine-selinux~1:18.09.0~200.h88.42.30.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
