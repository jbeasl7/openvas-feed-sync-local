...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1790");
  ...
  script_name("Huawei EulerOS: Security Advisory for libuv (EulerOS-SA-2024-1790)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1790");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1790");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libuv' package(s) announced via the EulerOS-SA-2024-1790 advisory.");
  ...
  script_tag(name:"affected", value:"'libuv' package(s) on Huawei EulerOS V2.0SP11.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libuv", rpm:"libuv~1.42.0~1.h4.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
