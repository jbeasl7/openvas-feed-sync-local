...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2739");
  ...
  script_name("Huawei EulerOS: Security Advisory for openjpeg2 (EulerOS-SA-2024-2739)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2739");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2739");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openjpeg2' package(s) announced via the EulerOS-SA-2024-2739 advisory.");
  ...
  script_tag(name:"affected", value:"'openjpeg2' package(s) on Huawei EulerOS Virtualization release 2.11.0.");
...
if(release == "EULEROSVIRT-2.11.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openjpeg2", rpm:"openjpeg2~2.4.0~4.h3.eulerosv2r11", rls:"EULEROSVIRT-2.11.0"))) {
    report += res;
  }
