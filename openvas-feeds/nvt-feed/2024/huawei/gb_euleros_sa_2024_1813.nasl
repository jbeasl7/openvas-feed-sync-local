...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1813");
  ...
  script_name("Huawei EulerOS: Security Advisory for gnutls (EulerOS-SA-2024-1813)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1813");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1813");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'gnutls' package(s) announced via the EulerOS-SA-2024-1813 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnutls", rpm:"gnutls~3.7.2~2.h30.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gnutls-utils", rpm:"gnutls-utils~3.7.2~2.h30.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
