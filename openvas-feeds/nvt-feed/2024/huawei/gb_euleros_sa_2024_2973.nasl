...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2973");
  ...
  script_name("Huawei EulerOS: Security Advisory for unbound (EulerOS-SA-2024-2973)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2973");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2973");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'unbound' package(s) announced via the EulerOS-SA-2024-2973 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-unbound", rpm:"python3-unbound~1.13.2~3.h9.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound", rpm:"unbound~1.13.2~3.h9.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"unbound-libs", rpm:"unbound-libs~1.13.2~3.h9.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
