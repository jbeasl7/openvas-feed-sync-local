...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1906");
  ...
  script_name("Huawei EulerOS: Security Advisory for git (EulerOS-SA-2024-1906)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1906");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1906");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'git' package(s) announced via the EulerOS-SA-2024-1906 advisory.");
...
if(release == "EULEROS-2.0SP10-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"git", rpm:"git~2.27.0~2.h15.r1.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"git-help", rpm:"git-help~2.27.0~2.h15.r1.eulerosv2r10", rls:"EULEROS-2.0SP10-x86_64"))) {
    report += res;
  }
