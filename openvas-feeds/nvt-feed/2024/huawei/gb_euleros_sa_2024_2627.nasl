...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2627");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2024-2627)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2627");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2627");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2024-2627 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.31.1~1.h12.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
