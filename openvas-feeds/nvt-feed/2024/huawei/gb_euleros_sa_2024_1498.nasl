...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1498");
  ...
  script_name("Huawei EulerOS: Security Advisory for sqlite (EulerOS-SA-2024-1498)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1498");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1498");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'sqlite' package(s) announced via the EulerOS-SA-2024-1498 advisory.");
...
if(release == "EULEROS-2.0SP9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"sqlite", rpm:"sqlite~3.31.1~1.h12.eulerosv2r9", rls:"EULEROS-2.0SP9"))) {
    report += res;
  }
