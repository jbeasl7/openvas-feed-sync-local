...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1415");
  script_cve_id("CVE-2022-40982", "CVE-2022-45884", "CVE-2022-45887", "CVE-2022-45919", "CVE-2023-1829", "CVE-2023-20569", "CVE-2023-20588", "CVE-2023-21400", "CVE-2023-31085", "CVE-2023-37453", "CVE-2023-3777", "CVE-2023-39189", "CVE-2023-39192", "CVE-2023-39193", "CVE-2023-39194", "CVE-2023-39198", "CVE-2023-4015", "CVE-2023-4244", "CVE-2023-42753", "CVE-2023-42754", "CVE-2023-42756", "CVE-2023-45862", "CVE-2023-45863", "CVE-2023-45871", "CVE-2023-4622", "CVE-2023-4623", "CVE-2023-46813", "CVE-2023-46862", "CVE-2023-4921", "CVE-2023-5178", "CVE-2023-5197", "CVE-2023-5717", "CVE-2023-6176");
  ...
  script_name("Huawei EulerOS: Security Advisory for kernel (EulerOS-SA-2024-1415)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1415");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1415");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2024-1415 advisory.");
...
if(release == "EULEROSVIRT-2.11.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"bpftool", rpm:"bpftool~5.10.0~60.18.0.50.h1083.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel", rpm:"kernel~5.10.0~60.18.0.50.h1083.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-abi-stablelists", rpm:"kernel-abi-stablelists~5.10.0~60.18.0.50.h1083.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-tools", rpm:"kernel-tools~5.10.0~60.18.0.50.h1083.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-tools-libs", rpm:"kernel-tools-libs~5.10.0~60.18.0.50.h1083.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-perf", rpm:"python3-perf~5.10.0~60.18.0.50.h1083.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }
