...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833205");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:47:26 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for chromium (openSUSE-SU-2022:10010-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2022:10010-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/XQH6PSD7KEJELPMITIH22447OE2UFOEG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the openSUSE-SU-2022:10010-1 advisory.");
...
if(release == "openSUSEBackportsSLE-15-SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~102.0.5005.115~bp154.2.8.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~102.0.5005.115~bp154.2.8.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }
