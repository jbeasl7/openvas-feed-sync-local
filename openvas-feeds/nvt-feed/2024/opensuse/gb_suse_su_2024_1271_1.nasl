...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1271-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241271-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034953.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls' package(s) announced via the SUSE-SU-2024:1271-1 advisory.");
...
Other fixes:
 ...
 pre-intitization done in the main thread (bsc#1221242)");
  ...
  script_tag(name:"affected", value:"'gnutls' package(s) on openSUSE Leap 15.5.");
