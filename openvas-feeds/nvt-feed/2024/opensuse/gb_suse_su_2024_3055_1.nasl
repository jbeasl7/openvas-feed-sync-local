...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3055-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243055-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228105");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-August/036708.html");
...
- CVE-2024-6345: Fixed code execution via download functions in the package_index module (bsc#1228105)");
  ...
  script_tag(name:"affected", value:"'python-setuptools' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
