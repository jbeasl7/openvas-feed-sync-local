...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3538-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243538-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-October/019556.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozjs115' package(s) announced via the SUSE-SU-2024:3538-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmozjs-115-0", rpm:"libmozjs-115-0~115.4.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mozjs115", rpm:"mozjs115~115.4.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"mozjs115-devel", rpm:"mozjs115-devel~115.4.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
