...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833868");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:43:52 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for python (openSUSE-SU-2023:0272-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0272-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/74KEOEJKIQ5UHFG7M5KN7X37WT37PVYX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python'
  package(s) announced via the openSUSE-SU-2023:0272-1 advisory.");
...
if(release == "openSUSEBackportsSLE-15-SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-CairoSVG", rpm:"python3-CairoSVG~2.5.2~bp154.2.3.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }
