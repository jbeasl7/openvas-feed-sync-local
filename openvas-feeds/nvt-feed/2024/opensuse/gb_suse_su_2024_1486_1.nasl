...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1486-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241486-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222835");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222837");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-August/019271.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cosign' package(s) announced via the SUSE-SU-2024:1486-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cosign", rpm:"cosign~2.2.4~150400.3.20.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
