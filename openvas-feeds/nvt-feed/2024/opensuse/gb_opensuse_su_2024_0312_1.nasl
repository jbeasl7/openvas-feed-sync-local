...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0312-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the openSUSE-SU-2024:0312-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~129.0.6668.58~bp155.2.117.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~129.0.6668.58~bp155.2.117.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }
