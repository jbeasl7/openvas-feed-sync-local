...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3332-1)");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20240910~150200.47.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20240910~150200.47.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
