...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1882-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241882-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1224806");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-May/035429.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer-plugins-base' package(s) announced via the SUSE-SU-2024:1882-1 advisory.");
...
- CVE-2024-4453: Fixed lack of proper validation of user-supplied data when parsing EXIF metadata (bsc#1224806)");
  ...
  script_tag(name:"affected", value:"'gstreamer-plugins-base' package(s) on openSUSE Leap 15.5.");
