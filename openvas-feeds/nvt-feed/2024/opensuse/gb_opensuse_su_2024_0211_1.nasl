...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0211-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'caddy' package(s) announced via the openSUSE-SU-2024:0211-1 advisory.");
 ...
 * run `golangci-lint run --fix --fast` ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'caddy' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"caddy", rpm:"caddy~2.8.4~bp155.2.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"caddy-bash-completion", rpm:"caddy-bash-completion~2.8.4~bp155.2.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"caddy-fish-completion", rpm:"caddy-fish-completion~2.8.4~bp155.2.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"caddy-zsh-completion", rpm:"caddy-zsh-completion~2.8.4~bp155.2.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
