...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php8-pear", rpm:"php8-pear~1.10.21~150400.9.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"php8-pecl", rpm:"php8-pecl~1.10.21~150400.9.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
