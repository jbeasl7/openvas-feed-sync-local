...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php7-firebird-debuginfo", rpm:"php7-firebird-debuginfo~7.4.33~150200.3.57.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"php7-firebird", rpm:"php7-firebird~7.4.33~150200.3.57.1##", rls:"openSUSELeap15.4"))) {
    report += res;
  }
