...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.13.35-rt-10", rpm:"kernel-livepatch-5.14.21-150500.13.35-rt-10~150500.11.8.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.13.35-rt-debuginfo-10", rpm:"kernel-livepatch-5.14.21-150500.13.35-rt-debuginfo-10~150500.11.8.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5-RT.Update.10-debugsource-10", rpm:"kernel-livepatch-SLE15-SP5-RT.Update.10-debugsource-10~150500.11.8.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
