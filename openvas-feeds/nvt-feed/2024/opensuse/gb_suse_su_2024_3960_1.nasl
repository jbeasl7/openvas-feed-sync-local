...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3960-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243960-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231714");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-November/019798.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libheif' package(s) announced via the SUSE-SU-2024:3960-1 advisory.");
...
- CVE-2024-41311: Fixed out-of-bounds read and write in ImageOverlay:parse() due to decoding a heif file containing an overlay image with forged offsets (bsc#1231714).");
  ...
  script_tag(name:"affected", value:"'libheif' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
