...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.13.38-rt-debuginfo-8", rpm:"kernel-livepatch-5.14.21-150500.13.38-rt-debuginfo-8~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.13.38-rt-8", rpm:"kernel-livepatch-5.14.21-150500.13.38-rt-8~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5-RT.Update.11-debugsource-8", rpm:"kernel-livepatch-SLE15-SP5-RT.Update.11-debugsource-8~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
