...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.13.47-rt-debuginfo-9", rpm:"kernel-livepatch-5.14.21-150500.13.47-rt-debuginfo-9~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5-RT.Update.13-debugsource-9", rpm:"kernel-livepatch-SLE15-SP5-RT.Update.13-debugsource-9~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.13.47-rt-9", rpm:"kernel-livepatch-5.14.21-150500.13.47-rt-9~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
