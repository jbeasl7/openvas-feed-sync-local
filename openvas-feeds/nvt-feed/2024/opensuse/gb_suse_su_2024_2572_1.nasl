...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2572-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242572-1.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1227152");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1227378");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/036102.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python312' package(s) announced via the SUSE-SU-2024:2572-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpython3_12-1_0", rpm:"libpython3_12-1_0~3.12.4~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpython3_12-1_0-32bit", rpm:"libpython3_12-1_0-32bit~3.12.4~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
