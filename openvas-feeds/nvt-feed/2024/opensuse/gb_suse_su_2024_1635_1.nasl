...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1635-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241635-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1223690");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-May/035254.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tpm2-0-tss' package(s) announced via the SUSE-SU-2024:1635-1 advisory.");
...
- CVE-2024-29040: Fixed quote data validation by Fapi_VerifyQuote (bsc#1223690).");
  ...
  script_tag(name:"affected", value:"'tpm2-0-tss' package(s) on openSUSE Leap 15.5.");
