...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5_Update_1-debugsource-2", rpm:"kernel-livepatch-SLE15-SP5_Update_1-debugsource-2~150500.2.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_14_21-150500_55_7-default-2", rpm:"kernel-livepatch-5_14_21-150500_55_7-default-2~150500.2.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_14_21-150500_55_7-default-debuginfo-2", rpm:"kernel-livepatch-5_14_21-150500_55_7-default-debuginfo-2~150500.2.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
