...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0001-1)");
  ...
  script_xref(name:"URL", value:"https://blogs.opera.com/desktop/changelog-for-106/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opera' package(s) announced via the openSUSE-SU-2024:0001-1 advisory.");
 ...
 * DNA-112522 'Find in page' option does not show text cursor");
  ...
  script_tag(name:"affected", value:"'opera' package(s) on openSUSE Leap 15.4.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~106.0.4998.19~lp154.2.68.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
