...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833690");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:36:43 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for opera (openSUSE-SU-2023:0297-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0297-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/SA3UIF6YUP4F422WZCCPKQ6TLSBG7YAK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opera'
  package(s) announced via the openSUSE-SU-2023:0297-1 advisory.");
...
if(release == "openSUSELeap15.5:NonFree") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~103.0.4928.16~lp155.3.12.1", rls:"openSUSELeap15.5:NonFree"))) {
    report += res;
  }
