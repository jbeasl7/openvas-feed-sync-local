...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3604-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243604-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1229910");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-October/019591.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'OpenIPMI' package(s) announced via the SUSE-SU-2024:3604-1 advisory.");
...
- CVE-2024-42934: Fixed missing check on the authorization type on incoming LAN messages in IPMI simulator (bsc#1229910)");
  ...
  script_tag(name:"affected", value:"'OpenIPMI' package(s) on openSUSE Leap 15.5.");
