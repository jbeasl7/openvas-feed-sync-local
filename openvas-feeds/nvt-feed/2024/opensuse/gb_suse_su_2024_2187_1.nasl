...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2187-1)");
...
- CVE-2023-52890: fix a use after free in ntfs_uppercase_mbs (bsc#1226007)");
  ...
  script_tag(name:"affected", value:"'ntfs-3g_ntfsprogs' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
