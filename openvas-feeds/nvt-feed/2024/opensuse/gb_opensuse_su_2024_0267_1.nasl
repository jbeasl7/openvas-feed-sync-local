...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0267-1)");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1229897");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the openSUSE-SU-2024:0267-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~128.0.6613.113~bp156.2.20.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~128.0.6613.113~bp156.2.20.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~128.0.6613.113~bp156.2.20.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~128.0.6613.113~bp156.2.20.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
