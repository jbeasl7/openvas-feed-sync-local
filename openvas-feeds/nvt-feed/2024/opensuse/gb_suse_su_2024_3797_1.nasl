...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3.Update.38-debugsource-14", rpm:"kernel-livepatch-SLE15-SP3.Update.38-debugsource-14~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.141-default-debuginfo-14", rpm:"kernel-livepatch-5.3.18-150300.59.141-default-debuginfo-14~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.141-default-14", rpm:"kernel-livepatch-5.3.18-150300.59.141-default-14~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.141-preempt-debuginfo-14", rpm:"kernel-livepatch-5.3.18-150300.59.141-preempt-debuginfo-14~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.141-preempt-14", rpm:"kernel-livepatch-5.3.18-150300.59.141-preempt-14~150300.2.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
