...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3957-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243957-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230906");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1232241");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-November/019801.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python311' package(s) announced via the SUSE-SU-2024:3957-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpython3_11-1_0", rpm:"libpython3_11-1_0~3.11.10~150400.9.38.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpython3_11-1_0-32bit", rpm:"libpython3_11-1_0-32bit~3.11.10~150400.9.38.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }
