...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0125-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-Pillow' package(s) announced via the openSUSE-SU-2024:0125-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-Pillow", rpm:"python3-Pillow~8.4.0~bp155.3.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-Pillow-tk", rpm:"python3-Pillow-tk~8.4.0~bp155.3.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
