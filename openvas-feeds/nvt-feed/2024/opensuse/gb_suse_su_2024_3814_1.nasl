...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.158-default-debuginfo-8", rpm:"kernel-livepatch-5.3.18-150300.59.158-default-debuginfo-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.158-default-8", rpm:"kernel-livepatch-5.3.18-150300.59.158-default-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3.Update.43-debugsource-8", rpm:"kernel-livepatch-SLE15-SP3.Update.43-debugsource-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.158-preempt-8", rpm:"kernel-livepatch-5.3.18-150300.59.158-preempt-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.158-preempt-debuginfo-8", rpm:"kernel-livepatch-5.3.18-150300.59.158-preempt-debuginfo-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
