...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3003-1)");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-branding-SLE", rpm:"MozillaFirefox-branding-SLE~128~150200.9.16.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-branding-SLE", rpm:"MozillaFirefox-branding-SLE~128~150200.9.16.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
