...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP4.Update.23-debugsource-11", rpm:"kernel-livepatch-SLE15-SP4.Update.23-debugsource-11~150400.9.8.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150400.24.108-default-debuginfo-11", rpm:"kernel-livepatch-5.14.21-150400.24.108-default-debuginfo-11~150400.9.8.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150400.24.108-default-11", rpm:"kernel-livepatch-5.14.21-150400.24.108-default-11~150400.9.8.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
