...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3404-1)");
...
- CVE-2024-43806: Fixed rustix::fs::Dir iterator with the linux_raw backend that can cause memory exhaustion. (bsc#1229959)");
  ...
  script_tag(name:"affected", value:"'rage-encryption' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
