...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1377-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241377-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221793");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1221797");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/035050.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-commons-configuration' package(s) announced via the SUSE-SU-2024:1377-1 advisory.");
...
- CVE-2024-29133: Fixed StackOverflowError calling ListDelimiterHandler.flatten(Object, int) with a cyclical object tree (bsc#1221793).");
  ...
  script_tag(name:"affected", value:"'apache-commons-configuration' package(s) on openSUSE Leap 15.5.");
