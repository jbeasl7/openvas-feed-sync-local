...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833655");
  ...
  script_name("openSUSE: Security Advisory for opera (openSUSE-SU-2023:0354-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0354-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/2Y5GV5TH6NRTLTHJ4VYCUYSWH6XUX5TQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opera'
  package(s) announced via the openSUSE-SU-2023:0354-1 advisory.");
...
if(release == "openSUSELeap15.5:NonFree") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~104.0.4944.36~lp155.3.18.1", rls:"openSUSELeap15.5:NonFree"))) {
    report += res;
  }
