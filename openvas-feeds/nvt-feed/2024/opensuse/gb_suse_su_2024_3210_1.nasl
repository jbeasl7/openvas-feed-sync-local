...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3210-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243210-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230020");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230034");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036856.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpcap' package(s) announced via the SUSE-SU-2024:3210-1 advisory.");
...
- CVE-2023-7256: double free via struct addrinfo in function sock_initaddress(). (bsc#1230020)");
  ...
  script_tag(name:"affected", value:"'libpcap' package(s) on openSUSE Leap 15.5.");
