...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3345-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243345-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230100");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036978.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-azure-identity' package(s) announced via the SUSE-SU-2024:3345-1 advisory.");
...
- CVE-2024-35255: Fixed an Azure identity libraries elevation of privilege vulnerability. (bsc#1230100)");
  ...
  script_tag(name:"affected", value:"'python-azure-identity' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
