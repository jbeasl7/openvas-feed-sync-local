...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ctags", rpm:"ctags~5.8~150000.3.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ctags-debuginfo", rpm:"ctags-debuginfo~5.8~150000.3.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ctags-debugsource", rpm:"ctags-debugsource~5.8~150000.3.3.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
