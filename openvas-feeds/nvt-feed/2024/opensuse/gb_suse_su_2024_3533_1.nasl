...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3533-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243533-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-October/019549.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pcp' package(s) announced via the SUSE-SU-2024:3533-1 advisory.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pcp-pmda-nutcracker", rpm:"pcp-pmda-nutcracker~6.2.0~150600.3.6.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
