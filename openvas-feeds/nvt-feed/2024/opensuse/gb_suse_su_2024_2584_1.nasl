...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2584-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242584-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1219660");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1219664");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-July/019010.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgit2' package(s) announced via the SUSE-SU-2024:2584-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"- CVE-2024-24577: Fixed arbitrary code execution due to heap corruption in git_index_add (bsc#1219660)
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libgit2-1_7", rpm:"libgit2-1_7~1.7.2~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
