...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3.Update.42-debugsource-10", rpm:"kernel-livepatch-SLE15-SP3.Update.42-debugsource-10~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.153-default-10", rpm:"kernel-livepatch-5.3.18-150300.59.153-default-10~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.153-default-debuginfo-10", rpm:"kernel-livepatch-5.3.18-150300.59.153-default-debuginfo-10~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.153-preempt-10", rpm:"kernel-livepatch-5.3.18-150300.59.153-preempt-10~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.3.18-150300.59.153-preempt-debuginfo-10", rpm:"kernel-livepatch-5.3.18-150300.59.153-preempt-debuginfo-10~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
