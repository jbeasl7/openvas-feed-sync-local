...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0208-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240208-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1217649");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-January/017751.html");
  script_xref(name:"URL", value:"https://tomcat.apache.org/tomcat-9.0-doc/changelog.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat10' package(s) announced via the SUSE-SU-2024:0208-1 advisory.");
