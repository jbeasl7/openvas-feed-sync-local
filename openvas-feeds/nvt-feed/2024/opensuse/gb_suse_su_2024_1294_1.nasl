...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1294-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241294-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034984.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'emacs' package(s) announced via the SUSE-SU-2024:1294-1 advisory.");
...
- CVE-2024-30205: Fixed Org mode considering contents of remote files as trusted (bsc#1222050)");
  ...
  script_tag(name:"affected", value:"'emacs' package(s) on openSUSE Leap 15.5.");
