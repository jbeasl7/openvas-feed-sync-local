...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833236");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:17:06 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for opera (openSUSE-SU-2023:0385-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");
  script_dependencies("gather-package-list.nasl");
  script_mandatory_keys("ssh/login/opensuse", "ssh/login/rpms", re:"ssh/login/release=openSUSELeap15\.4:NonFree");

  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0385-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/VPV6XY6LXPJXCOKW6JTLRHMNB4XCYJ7Q");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opera'
  package(s) announced via the openSUSE-SU-2023:0385-1 advisory.");
...
if(release == "openSUSELeap15.4:NonFree") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~105.0.4970.21~lp154.2.62.1", rls:"openSUSELeap15.4:NonFree"))) {
    report += res;
  }
