...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0601-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240601-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218564");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-February/018003.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-pycryptodome' package(s) announced via the SUSE-SU-2024:0601-1 advisory.");
...
- CVE-2023-52323: Fixed side-channel leakage in RSA decryption by using constant-time (faster) padding decoding for OAEP (bsc#1218564).");
  ...
  script_tag(name:"affected", value:"'python-pycryptodome' package(s) on openSUSE Leap 15.5.");
