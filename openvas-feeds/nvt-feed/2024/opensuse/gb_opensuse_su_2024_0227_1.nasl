...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0227-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gh' package(s) announced via the openSUSE-SU-2024:0227-1 advisory.");
...
* add `-a` flag to `gh run list`");
  ...
  script_tag(name:"affected", value:"'gh' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gh", rpm:"gh~2.53.0~bp155.2.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gh-bash-completion", rpm:"gh-bash-completion~2.53.0~bp155.2.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gh-fish-completion", rpm:"gh-fish-completion~2.53.0~bp155.2.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"gh-zsh-completion", rpm:"gh-zsh-completion~2.53.0~bp155.2.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
