...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3305-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243305-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230161");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230162");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036950.html");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"clamav", rpm:"clamav~0.103.12~150000.3.53.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"clamav-devel", rpm:"clamav-devel~0.103.12~150000.3.53.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libclamav9", rpm:"libclamav9~0.103.12~150000.3.53.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libfreshclam2", rpm:"libfreshclam2~0.103.12~150000.3.53.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
