...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.62-default-6", rpm:"kernel-livepatch-5.14.21-150500.55.62-default-6~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.62-default-debuginfo-6", rpm:"kernel-livepatch-5.14.21-150500.55.62-default-debuginfo-6~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5.Update.13-debugsource-6", rpm:"kernel-livepatch-SLE15-SP5.Update.13-debugsource-6~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
