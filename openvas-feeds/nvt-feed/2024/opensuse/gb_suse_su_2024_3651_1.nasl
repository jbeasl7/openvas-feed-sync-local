...
if(release == "openSUSELeap15.3") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP3_Update_42-debugsource-8", rpm:"kernel-livepatch-SLE15-SP3_Update_42-debugsource-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_153-default-8", rpm:"kernel-livepatch-5_3_18-150300_59_153-default-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_153-default-debuginfo-8", rpm:"kernel-livepatch-5_3_18-150300_59_153-default-debuginfo-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_153-preempt-debuginfo-8", rpm:"kernel-livepatch-5_3_18-150300_59_153-preempt-debuginfo-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_3_18-150300_59_153-preempt-8", rpm:"kernel-livepatch-5_3_18-150300_59_153-preempt-8~150300.7.6.1", rls:"openSUSELeap15.3"))) {
    report += res;
  }
