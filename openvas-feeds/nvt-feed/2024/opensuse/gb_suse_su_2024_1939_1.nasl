...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1939-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241939-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222842");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-June/035533.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-idna' package(s) announced via the SUSE-SU-2024:1939-1 advisory.");
...
- CVE-2024-3651: Fixed a denial of service via resource consumption through
 specially crafted inputs to idna.encode() (bsc#1222842)");
  ...
  script_tag(name:"affected", value:"'python-idna' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
