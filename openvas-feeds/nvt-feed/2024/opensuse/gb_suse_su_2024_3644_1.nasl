...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3644-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243644-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218638");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1230848");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-October/019615.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem-puma' package(s) announced via the SUSE-SU-2024:3644-1 advisory.");
...
- CVE-2024-21647: Fixed DoS when parsing chunked Transfer-Encoding bodies (bsc#1218638).");
  ...
  script_tag(name:"affected", value:"'rubygem-puma' package(s) on openSUSE Leap 15.5.");
