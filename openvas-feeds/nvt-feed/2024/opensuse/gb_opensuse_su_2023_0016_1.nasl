...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833226");
  script_version("2025-03-11T05:38:16+0000");
  script_cve_id("CVE-2023-0128", "CVE-2023-0129", "CVE-2023-0130", "CVE-2023-0131", "CVE-2023-0132", "CVE-2023-0133", "CVE-2023-0134", "CVE-2023-0136", "CVE-2023-0137", "CVE-2023-0138", "CVE-2023-0139", "CVE-2023-0140", "CVE-2023-0141", "CVE-2023-0135");
  ...
  script_tag(name:"severity_date", value:"2023-01-13 14:08:56 +0000 (Fri, 13 Jan 2023)");
  script_tag(name:"creation_date", value:"2024-03-04 07:16:30 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for chromium (openSUSE-SU-2023:0016-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0016-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/2PZLKYPQOBOYUPBN4TZGMVMENMO3USHV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium'
  package(s) announced via the openSUSE-SU-2023:0016-1 advisory.");
...
if(release == "openSUSEBackportsSLE-15-SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~109.0.5414.74~bp154.2.58.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium", rpm:"chromium~109.0.5414.74~bp154.2.58.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }
