...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_14_21-150500_53-default-debuginfo-3", rpm:"kernel-livepatch-5_14_21-150500_53-default-debuginfo-3~150500.6.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5_Update_0-debugsource-3", rpm:"kernel-livepatch-SLE15-SP5_Update_0-debugsource-3~150500.6.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5_14_21-150500_53-default-3", rpm:"kernel-livepatch-5_14_21-150500_53-default-3~150500.6.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }
