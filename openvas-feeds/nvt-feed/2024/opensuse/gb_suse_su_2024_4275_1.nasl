...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150400.24.122-default-6", rpm:"kernel-livepatch-5.14.21-150400.24.122-default-6~150400.9.6.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150400.24.122-default-debuginfo-6", rpm:"kernel-livepatch-5.14.21-150400.24.122-default-debuginfo-6~150400.9.6.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP4.Update.27-debugsource-6", rpm:"kernel-livepatch-SLE15-SP4.Update.27-debugsource-6~150400.9.6.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
