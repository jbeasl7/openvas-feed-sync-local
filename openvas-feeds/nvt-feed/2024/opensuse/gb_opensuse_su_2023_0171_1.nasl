...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833252");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:42:12 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for nextcloud (openSUSE-SU-2023:0171-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");
  script_dependencies("gather-package-list.nasl");
  script_mandatory_keys("ssh/login/opensuse", "ssh/login/rpms", re:"ssh/login/release=openSUSEBackportsSLE-15-SP5");

  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0171-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/MYOV4BMU2LQGVZ5NTYTI7BA3XMRNOCDF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nextcloud'
  package(s) announced via the openSUSE-SU-2023:0171-1 advisory.");
  ...
  script_tag(name:"affected", value:"'nextcloud' package(s) on openSUSE Backports SLE-15-SP5.");
...
if(release == "openSUSEBackportsSLE-15-SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libnextcloudsync-devel", rpm:"libnextcloudsync-devel~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libnextcloudsync0", rpm:"libnextcloudsync0~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nextcloud-desktop", rpm:"nextcloud-desktop~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nextcloud-desktop-dolphin", rpm:"nextcloud-desktop-dolphin~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"caja-extension-nextcloud", rpm:"caja-extension-nextcloud~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cloudproviders-extension-nextcloud", rpm:"cloudproviders-extension-nextcloud~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nautilus-extension-nextcloud", rpm:"nautilus-extension-nextcloud~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nemo-extension-nextcloud", rpm:"nemo-extension-nextcloud~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nextcloud-desktop-doc", rpm:"nextcloud-desktop-doc~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"nextcloud-desktop-lang", rpm:"nextcloud-desktop-lang~3.8.0~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }
