...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0381-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey' package(s) announced via the openSUSE-SU-2024:0381-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.19~bp155.2.23.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"seamonkey-dom-inspector", rpm:"seamonkey-dom-inspector~2.53.19~bp155.2.23.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"seamonkey-irc", rpm:"seamonkey-irc~2.53.19~bp155.2.23.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
