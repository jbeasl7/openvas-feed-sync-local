...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP6.Update.0-debugsource-7", rpm:"kernel-livepatch-SLE15-SP6.Update.0-debugsource-7~150600.4.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-6.4.0-150600.21-default-7", rpm:"kernel-livepatch-6.4.0-150600.21-default-7~150600.4.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-6.4.0-150600.21-default-debuginfo-7", rpm:"kernel-livepatch-6.4.0-150600.21-default-debuginfo-7~150600.4.13.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
