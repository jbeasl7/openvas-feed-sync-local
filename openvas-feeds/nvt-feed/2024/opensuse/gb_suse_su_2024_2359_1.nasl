...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2359-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242359-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1223414");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-July/035875.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freeradius-server' package(s) announced via the SUSE-SU-2024:2359-1 advisory.");
...
- CVE-2024-3596: Fixed chosen-prefix collision attack against MD5 (bsc#1223414).");
  ...
  script_tag(name:"affected", value:"'freeradius-server' package(s) on openSUSE Leap 15.6.");
