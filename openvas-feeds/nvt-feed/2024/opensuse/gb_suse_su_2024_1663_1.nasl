...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1663-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241663-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-August/019268.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel' package(s) announced via the SUSE-SU-2024:1663-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The SUSE Linux Enterprise 15 SP5 Real Time kernel was updated to receive various security bugfixes.
...
- CVE-2024-26881: Fixed net/hns3 ... [Please see the references for more information on the vulnerabilities]");
