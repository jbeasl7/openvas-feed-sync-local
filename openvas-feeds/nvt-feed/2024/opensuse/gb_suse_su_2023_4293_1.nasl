...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xwayland", rpm:"xwayland~21.1.4~150400.3.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xwayland-devel", rpm:"xwayland-devel~21.1.4~150400.3.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xwayland-debugsource", rpm:"xwayland-debugsource~21.1.4~150400.3.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xwayland-debuginfo", rpm:"xwayland-debuginfo~21.1.4~150400.3.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
