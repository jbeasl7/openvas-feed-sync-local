...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1950-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gio-branding-SLE", rpm:"gio-branding-SLE~15~150600.35.2.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
