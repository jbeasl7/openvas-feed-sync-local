...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0258-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the openSUSE-SU-2024:0258-1 advisory.");
