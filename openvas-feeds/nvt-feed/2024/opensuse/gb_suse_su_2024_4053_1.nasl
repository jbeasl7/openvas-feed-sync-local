...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:4053-1)");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20241112~150200.50.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel", rpm:"ucode-intel~20241112~150200.50.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
