...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0006-1)");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh2-1", rpm:"libssh2-1~1.11.0~150000.4.22.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-1-32bit", rpm:"libssh2-1-32bit~1.11.0~150000.4.22.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-devel", rpm:"libssh2-devel~1.11.0~150000.4.22.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh2-1", rpm:"libssh2-1~1.11.0~150000.4.22.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-1-32bit", rpm:"libssh2-1-32bit~1.11.0~150000.4.22.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh2-devel", rpm:"libssh2-devel~1.11.0~150000.4.22.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
