...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2985-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242985-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228199");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-August/036642.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libqt5-qtquick3d' package(s) announced via the SUSE-SU-2024:2985-1 advisory.");
...
- Skipped processing unknown uniforms, as those that are vendor specific");
  ...
  script_tag(name:"affected", value:"'libqt5-qtquick3d' package(s) on openSUSE Leap 15.6.");
