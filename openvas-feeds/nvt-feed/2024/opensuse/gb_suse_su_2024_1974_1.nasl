...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1974-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241974-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1203171");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1225997");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-June/035541.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rmt-server' package(s) announced via the SUSE-SU-2024:1974-1 advisory.");
...
- CVE-2024-28103: Fixed Permissions-Policy that was only served on responses with an HTML related Content-Type. (bsc#1225997)");
  ...
  script_tag(name:"affected", value:"'rmt-server' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
