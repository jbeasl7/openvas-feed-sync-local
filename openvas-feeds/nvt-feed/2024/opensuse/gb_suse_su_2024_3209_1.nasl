...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3209-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243209-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036854.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel' package(s) announced via the SUSE-SU-2024:3209-1 advisory.");
...
- CVE-2021-47106: Fix use-after-free in nft_set_catchall_destroy() ... [Please see the references for more information on the vulnerabilities]");
