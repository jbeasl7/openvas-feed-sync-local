...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2029-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242029-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1226185");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-security-updates/2024-June/018715.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-scikit-learn' package(s) announced via the SUSE-SU-2024:2029-1 advisory.");
...
-CVE-2024-5206: Fixed a possible sensitive data leak in TfidfVectorizer. (bsc#1226185)");
  ...
  script_tag(name:"affected", value:"'python-scikit-learn' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
