...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1439-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241439-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1222842");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/035104.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-idna' package(s) announced via the SUSE-SU-2024:1439-1 advisory.");
...
- CVE-2024-3651: Fixed potential DoS via resource consumption via specially crafted inputs to idna.encode() (bsc#1222842).");
  ...
  script_tag(name:"affected", value:"'python-idna' package(s) on openSUSE Leap 15.5.");
