...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0026-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey' package(s) announced via the openSUSE-SU-2024:0026-1 advisory.");
...
* Additional important security fixes up to Current Firefox 115.7
 ...
 subsequent 2.53.x beta and release versions as fast as we are able to.");
  ...
  script_tag(name:"affected", value:"'seamonkey' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"seamonkey", rpm:"seamonkey~2.53.18.1~bp155.2.15.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"seamonkey-dom-inspector", rpm:"seamonkey-dom-inspector~2.53.18.1~bp155.2.15.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"seamonkey-irc", rpm:"seamonkey-irc~2.53.18.1~bp155.2.15.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
