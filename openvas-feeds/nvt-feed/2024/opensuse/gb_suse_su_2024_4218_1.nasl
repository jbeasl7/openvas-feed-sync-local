...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.49-default-debuginfo-11", rpm:"kernel-livepatch-5.14.21-150500.55.49-default-debuginfo-11~150500.11.8.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5.Update.10-debugsource-11", rpm:"kernel-livepatch-SLE15-SP5.Update.10-debugsource-11~150500.11.8.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.49-default-11", rpm:"kernel-livepatch-5.14.21-150500.55.49-default-11~150500.11.8.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
