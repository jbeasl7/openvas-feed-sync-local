...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1368-1)");
...
- Removed POST_PROCESS_PE_FLAGS=-N from the build command in shim.spec to
 ...
 and testing. (bsc#1205588)");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~150300.4.20.2", rls:"openSUSELeap15.5"))) {
    report += res;
  }
