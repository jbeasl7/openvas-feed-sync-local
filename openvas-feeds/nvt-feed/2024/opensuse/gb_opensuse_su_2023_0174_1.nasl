...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833622");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:48:28 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for python (openSUSE-SU-2023:0174-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0174-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CGRJARKS4352V5BRO6NUJYHVKDUI4VU4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python'
  package(s) announced via the openSUSE-SU-2023:0174-1 advisory.");
...
if(release == "openSUSEBackportsSLE-15-SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-Django", rpm:"python3-Django~2.2.28~bp154.2.12.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }
