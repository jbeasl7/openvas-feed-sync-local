...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3543-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243543-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1231295");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-October/037171.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'json-lib' package(s) announced via the SUSE-SU-2024:3543-1 advisory.");
...
- CVE-2024-47855: Fixed mishandled unbalanced comment string (bsc#1231295)");
  ...
  script_tag(name:"affected", value:"'json-lib' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
