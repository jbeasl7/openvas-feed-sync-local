...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:4333-1)");
 ...
 * ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libaom, libyuv' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"aom-tools", rpm:"aom-tools~3.7.1~150400.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libaom-devel", rpm:"libaom-devel~3.7.1~150400.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libaom-devel-doc", rpm:"libaom-devel-doc~3.7.1~150400.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libaom3", rpm:"libaom3~3.7.1~150400.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libaom3-32bit", rpm:"libaom3-32bit~3.7.1~150400.3.9.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libyuv-devel", rpm:"libyuv-devel~20230517+a377993~150400.9.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libyuv-tools", rpm:"libyuv-tools~20230517+a377993~150400.9.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libyuv0", rpm:"libyuv0~20230517+a377993~150400.9.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libyuv0-32bit", rpm:"libyuv0-32bit~20230517+a377993~150400.9.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
