...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833303");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:32:10 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for perl (openSUSE-SU-2023:0215-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0215-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/7UYESPZ25JO4DP7GV5KTIH3W7NKCQ62I");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl'
  package(s) announced via the openSUSE-SU-2023:0215-1 advisory.");
  ...
  * CVE-2021-29424: Leading zeros are no longer allowed for IPv4 octets.
  ...
  script_tag(name:"affected", value:"'perl' package(s) on openSUSE Backports SLE-15-SP4.");
...
if(release == "openSUSEBackportsSLE-15-SP4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"perl-Net-Netmask", rpm:"perl-Net-Netmask~1.9022~bp154.2.3.1", rls:"openSUSEBackportsSLE-15-SP4"))) {
    report += res;
  }
