...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.59-default-debuginfo-9", rpm:"kernel-livepatch-5.14.21-150500.55.59-default-debuginfo-9~150500.11.10.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.59-default-9", rpm:"kernel-livepatch-5.14.21-150500.55.59-default-9~150500.11.10.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5.Update.12-debugsource-9", rpm:"kernel-livepatch-SLE15-SP5.Update.12-debugsource-9~150500.11.10.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
