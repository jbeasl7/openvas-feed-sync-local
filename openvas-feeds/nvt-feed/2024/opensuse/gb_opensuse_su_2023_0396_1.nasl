...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833456");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:33:24 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for opera (openSUSE-SU-2023:0396-1)");
  ...
  script_xref(name:"Advisory-ID", value:"openSUSE-SU-2023:0396-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5KYG44T7BT4X7NZ6LSLZ3V2IJ27BBBPS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opera'
  package(s) announced via the openSUSE-SU-2023:0396-1 advisory.");
...
if(release == "openSUSELeap15.5:NonFree") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"opera", rpm:"opera~105.0.4970.34~lp155.3.24.1", rls:"openSUSELeap15.5:NonFree"))) {
    report += res;
  }
