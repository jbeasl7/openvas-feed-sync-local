...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3861-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243861-1.html");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'uwsgi' package(s) announced via the SUSE-SU-2024:3861-1 advisory.");
...
- CVE-2024-24795: Fixed HTTP Response Splitting in multiple modules (bsc#1222332)");
  ...
  script_tag(name:"affected", value:"'uwsgi' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apache2-mod_uwsgi", rpm:"apache2-mod_uwsgi~2.0.19.1~150400.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"uwsgi-emperor_pg", rpm:"uwsgi-emperor_pg~2.0.19.1~150400.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"uwsgi-emperor_zeromq", rpm:"uwsgi-emperor_zeromq~2.0.19.1~150400.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
