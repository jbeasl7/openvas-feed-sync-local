...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0218-1)");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1227423");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'exim' package(s) announced via the openSUSE-SU-2024:0218-1 advisory.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"exim", rpm:"exim~4.97.1~bp155.5.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"eximon", rpm:"eximon~4.97.1~bp155.5.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"eximstats-html", rpm:"eximstats-html~4.97.1~bp155.5.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
