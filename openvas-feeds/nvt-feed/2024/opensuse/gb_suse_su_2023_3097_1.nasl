...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833520");
  ...
  script_name("openSUSE: Security Advisory for pipewire (SUSE-SU-2023:3097-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3097-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/UDDYF6VS7F76GUT275QO2DJH3O5VSUUZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pipewire'
  package(s) announced via the SUSE-SU-2023:3097-1 advisory.");
...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pipewire-libpulse-0_3-debuginfo", rpm:"pipewire-libpulse-0_3-debuginfo~0.3.6~150200.3.9.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pipewire-libpulse-0_3", rpm:"pipewire-libpulse-0_3~0.3.6~150200.3.9.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
