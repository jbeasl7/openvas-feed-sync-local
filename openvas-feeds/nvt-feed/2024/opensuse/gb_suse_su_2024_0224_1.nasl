...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:0224-1)");
 ...
 * Bugs ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'apache-parent, apache-sshd' package(s) on openSUSE Leap 15.5.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"apache-parent", rpm:"apache-parent~31~150200.3.12.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
