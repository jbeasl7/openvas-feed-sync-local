...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:1133-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241133-1.html");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1220061");
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-April/034889.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ncurses' package(s) announced via the SUSE-SU-2024:1133-1 advisory.");
...
- CVE-2023-45918: Fixed NULL pointer dereference via corrupted xterm-256color file (bsc#1220061).");
  ...
  script_tag(name:"affected", value:"'ncurses' package(s) on openSUSE Leap 15.5.");
