...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150400.24.111-default-9", rpm:"kernel-livepatch-5.14.21-150400.24.111-default-9~150400.9.6.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150400.24.111-default-debuginfo-9", rpm:"kernel-livepatch-5.14.21-150400.24.111-default-debuginfo-9~150400.9.6.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP4.Update.24-debugsource-9", rpm:"kernel-livepatch-SLE15-SP4.Update.24-debugsource-9~150400.9.6.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
