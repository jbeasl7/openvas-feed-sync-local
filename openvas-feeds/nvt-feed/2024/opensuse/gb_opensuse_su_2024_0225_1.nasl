...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (openSUSE-SU-2024:0225-1)");
  ...
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1218474");
  script_xref(name:"URL", value:"https://bugzilla.suse.com/1228142");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'assimp' package(s) announced via the openSUSE-SU-2024:0225-1 advisory.");
...
- CVE-2024-40724: Fixed heap-based buffer overflow in the PLY importer class (boo#1228142),");
  ...
  script_tag(name:"affected", value:"'assimp' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"assimp-devel", rpm:"assimp-devel~5.3.1~bp156.3.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libassimp5", rpm:"libassimp5~5.3.1~bp156.3.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"assimp-devel", rpm:"assimp-devel~5.3.1~bp156.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libassimp5", rpm:"libassimp5~5.3.1~bp156.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
