...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.52-default-8", rpm:"kernel-livepatch-5.14.21-150500.55.52-default-8~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-SLE15-SP5.Update.11-debugsource-8", rpm:"kernel-livepatch-SLE15-SP5.Update.11-debugsource-8~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kernel-livepatch-5.14.21-150500.55.52-default-debuginfo-8", rpm:"kernel-livepatch-5.14.21-150500.55.52-default-debuginfo-8~150500.11.6.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
