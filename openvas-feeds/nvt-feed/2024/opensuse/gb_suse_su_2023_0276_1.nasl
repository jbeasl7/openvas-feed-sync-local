...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-rack", rpm:"ruby2.5-rubygem-rack~2.0.8~150000.3.12.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-rack-doc", rpm:"ruby2.5-rubygem-rack-doc~2.0.8~150000.3.12.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ruby2.5-rubygem-rack-testsuite", rpm:"ruby2.5-rubygem-rack-testsuite~2.0.8~150000.3.12.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
