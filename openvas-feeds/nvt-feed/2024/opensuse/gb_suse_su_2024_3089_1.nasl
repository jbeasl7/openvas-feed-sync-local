...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:3089-1)");
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20243089-1.html");
  ...
  script_xref(name:"URL", value:"https://lists.suse.com/pipermail/sle-updates/2024-September/036783.html");
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"go1.21-openssl", rpm:"go1.21-openssl~1.21.13.1~150000.1.11.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.21-openssl-doc", rpm:"go1.21-openssl-doc~1.21.13.1~150000.1.11.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"go1.21-openssl-race", rpm:"go1.21-openssl-race~1.21.13.1~150000.1.11.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
