...
if(description)
{
  ...
  script_name("openSUSE Security Advisory (SUSE-SU-2024:2633-1)");
...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"typelib-1_0-Gtk-3_0", rpm:"typelib-1_0-Gtk-3_0~3.24.38+111~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
