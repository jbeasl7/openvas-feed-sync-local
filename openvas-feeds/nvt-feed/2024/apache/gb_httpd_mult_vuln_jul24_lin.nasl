...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114682");
  ...
  script_cve_id("CVE-2024-36387", "CVE-2024-38473", "CVE-2024-38474", "CVE-2024-38475",
  ...
  script_name("Apache HTTP Server < 2.4.60 Multiple Vulnerabilities - Linux");
