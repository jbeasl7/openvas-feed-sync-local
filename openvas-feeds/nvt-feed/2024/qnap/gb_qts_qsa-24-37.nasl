...
if(description)
{
  ...
  script_name("QNAP QTS Multiple OpenSSH Vulnerabilities (QSA-24-37)");
  ...
  script_tag(name:"affected", value:"QNAP QTS version 5.1.x prior to 5.1.8.2823 build 20240712.");
