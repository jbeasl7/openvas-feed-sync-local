...
if(description)
{
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-24-43)");
  ...
  script_tag(name:"affected", value:"QNAP QTS version 5.2.x prior to 5.2.1.2930 build 20241025.");

  script_tag(name:"solution", value:"Update to version 5.2.1.2930 build 20241025 or later.");
...
if (version =~ "^5\.2") {
  if (version_is_less(version: version, test_version: "5.2.1.2930")) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.2.1.2930", fixed_build: "20241025");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "5.2.1.2930") &&
