...
if(description)
{
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-24-49)");
  ...
  script_tag(name:"affected", value:"QNAP QTS version 5.1.x prior to 5.1.9.2954 and 5.2.x prior to
  5.2.2.2950.");

  script_tag(name:"solution", value:"Update to version 5.1.9.2954 build 20241120, 5.2.2.2950 build
  20241114 or later.");
...
if (version =~ "^5\.2") {
  if (version_is_less(version: version, test_version: "5.2.2.2950")) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.2.2.2950", fixed_build: "20241114");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "5.2.2.2950") &&
      (!build || version_is_less(version: build, test_version: "20241114"))) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.2.2.2950", fixed_build: "20241114");
    security_message(port: 0, data: report);
    exit(0);
