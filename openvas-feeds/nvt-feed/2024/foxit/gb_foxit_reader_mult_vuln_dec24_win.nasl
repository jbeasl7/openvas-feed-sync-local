...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834799");
  ...
  script_name("Foxit Reader Multiple Vulnerabilities (Dec 2024) - Windows");
  ...
  script_tag(name:"affected", value:"Foxit Reader version 11.1.0.52543 and
  prior on Windows.");

  script_tag(name:"solution", value:"Update to version 11.2.1 or later.");
