...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114421");
  ...
  script_cve_id("CVE-2024-11398");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Synology Router Manager (SRM) 1.3.x Multiple Vulnerabilities (Synology-SA-24:03) - Remote Known Vulnerable Versions Check");
  ...
  - CVE-2024-11398: Path traversal in the OTP reset functionality

  - No CVE: Unknown HTML code injection

  - No CVE: Unknown security constraints bypass");

  script_tag(name:"impact", value:"These vulnerabilities allow remote attackers or remote
  ...
  script_tag(name:"solution", value:"Update to version 1.3.1-9346-9 or later.");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.114422
