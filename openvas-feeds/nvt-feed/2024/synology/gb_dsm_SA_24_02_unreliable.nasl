...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) Open Redirect Vulnerability (Synology-SA-24:02) - Unreliable Remote Version Check");
  ...
  7.0.1-42218-7, 7.1.x prior to 7.1.1-42962-7 and 7.2.x prior to 7.2.1-69057-2.");

  script_tag(name:"solution", value:"Update to version 6.2.4-25556-8, 7.0.1-42218-7, 7.1.1-42962-7,
  7.2.1-69057-2 or later.");
...
if (version =~ "^6\.2\.4-25556" && revcomp(a: version, b: "6.2.4-25556-8") < 0) {
  report = report_fixed_ver(installed_version: version, fixed_version: "6.2.4-25556-8");
  security_message(port: 0, data: report);
  exit(0);
}

if (version =~ "^7\.0\.1-42218" && revcomp(a: version, b: "7.0.1-42218-7") < 0) {
