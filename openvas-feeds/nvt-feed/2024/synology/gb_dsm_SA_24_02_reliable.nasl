...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) Open Redirect Vulnerability (Synology-SA-24:02) - Remote Known Vulnerable Versions Check");
...
if (version =~ "^6\.2\.4-25556" || version =~ "^7\.0\.1-42218" ||
    version =~ "^7\.1\.1-42962" || version =~ "^7\.2\.1-69057")
  exit(0);
