...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.171013");
  ...
  script_name("Synology DiskStation Manager (DSM) ACE Vulnerability (Synology-SA-24:01) - Unreliable Remote Version Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.151501
if ((revcomp(a: version, b: "6.2.4-25556") < 0) ||
    ...
    (version =~ "^7\.2" && (revcomp(a: version, b: "7.2-64561") < 0)))
  exit(0);
