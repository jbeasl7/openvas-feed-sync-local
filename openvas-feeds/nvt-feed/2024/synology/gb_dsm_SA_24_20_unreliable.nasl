...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170911");
  ...
  script_name("Synology DiskStation Manager (DSM) Multiple Vulnerabilities (Synology-SA-24:20) - Unreliable Remote Version Check");
...
if (version =~ "^7\.1\.1-42962" && revcomp(a: version, b: "7.1.1-42962-7") < 0) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.1.1-42962-7");
  security_message(port: 0, data: report);
  exit(0);
}

if (version =~ "^7\.2-64570" && revcomp(a: version, b: "7.2-64570-4") < 0) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2-64570-4");
  security_message(port: 0, data: report);
  exit(0);
}

if (version =~ "^7\.2\.1-69057" && revcomp(a: version, b: "7.2.1-69057-6") < 0) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2.1-69057-6");
  security_message(port: 0, data: report);
  exit(0);
}

if (version =~ "^7\.2\.2-72806" && (revcomp(a: version, b: "7.2.2-72806-1") < 0)) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2.2-72806-1");
  security_message(port: 0, data: report);
  exit(0);
}

# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170912
if ((revcomp(a: version, b: "7.1.1-42962") < 0) ||
    (version =~ "^7\.2-" && (revcomp(a: version, b: "7.2-64570") < 0)) ||
    (version =~ "^7\.2\.[01]" && (revcomp(a: version, b: "7.2.1-69057") < 0)) ||
