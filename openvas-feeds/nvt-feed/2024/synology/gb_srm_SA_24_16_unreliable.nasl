...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170888");
  ...
  script_name("Synology Router Manager (SRM) 1.3.x Multiple Vulnerabilities (Synology-SA-24:16) - Unreliable Remote Version Check");
...
if (version =~ "^1\.3\.1-9346" && (revcomp(a: version, b: "1.3.1-9346-11") < 0)) {
