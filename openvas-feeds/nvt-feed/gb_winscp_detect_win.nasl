...
if(description)
{
  ...
  script_name("WinSCP Detection (Windows SMB Login)");
  ...
  if(FEED_NAME == "GSF" || FEED_NAME == "GEF" || FEED_NAME == "SCM")
    script_dependencies("gsf/gb_winscp_smb_login_detect.nasl");

  script_mandatory_keys("SMB/WindowsVersion", "SMB/Windows/Arch");
  script_tag(name:"summary", value:"SMB login-based detection of WinSCP.");
...
# Already covered for enterprise users
if(FEED_NAME == "GSF" || FEED_NAME == "GEF" || FEED_NAME == "SCM")
  exit(0);
