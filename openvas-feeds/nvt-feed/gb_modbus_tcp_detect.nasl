...
if(description)
{
  ...
  script_name("Modbus Protocol Detection (TCP)");

  script_tag(name:"summary", value:"TCP based detection of services supporting the Modbus
  protocol.");

  script_tag(name:"insight", value:"Modbus is a serial communications protocol for use with
  ...
  # nb: nessus_detect.nasl to avoid double check for echo tests
  script_dependencies("find_service.nasl", "nessus_detect.nasl");
