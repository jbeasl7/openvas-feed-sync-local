...
if(description)
{
  ...
  script_name("Microsoft Windows Kernel-Mode Driver Privilege Elevation Vulnerability (3019215)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/71960");
