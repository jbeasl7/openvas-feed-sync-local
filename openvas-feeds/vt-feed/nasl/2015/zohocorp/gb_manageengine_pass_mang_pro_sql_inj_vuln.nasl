...
if (description)
{
  ...
  script_name("ManageEngine Password Manager Pro SQLi Vulnerability (Jul 2015)");

  script_tag(name:"summary", value:"ManageEngine Password Manager Pro is prone to an SQL injection
  (SQLi) vulnerability.");
