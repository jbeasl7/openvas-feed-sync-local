...
if(description)
{
  ...
  script_name("ManageEngine ServiceDesk Plus (SDP) Multiple Vulnerabilities (Feb 2015)");

  script_tag(name:"summary", value:"ManageEngine ServiceDesk Plus (SDP) is prone to multiple vulnerabilities.");
  ...
  script_tag(name:"affected", value:"ManageEngine ServiceDesk Plus (SDP)
  version before 9.0 build 9031.");

  script_tag(name:"solution", value:"Update to version 9.0 build 9031 or later.");
