...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for KVM (SUSE-SU-2015:0889-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2015:0889-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"kvm", rpm:"kvm~1.4.2~0.22.27.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
