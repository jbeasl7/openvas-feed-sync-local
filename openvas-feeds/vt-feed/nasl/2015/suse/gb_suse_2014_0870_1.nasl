...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for xalan-j2 (SUSE-SU-2014:0870-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2014:0870-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"xalan-j2", rpm:"xalan-j2~2.7.0~217.26.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
