...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for MozillaFirefox (SUSE-SU-2015:0704-1)");
  ...
  * Same-origin bypass through anchor navigation (MFSA 2015-40/CVE-2015-0801)");
  ...
  script_xref(name:"SUSE-SU", value:"2015:0704-1");
...
if(release == "SLES12.0SP0") {
  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox", rpm:"MozillaFirefox~31.6.0esr~30.1", rls:"SLES12.0SP0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-debuginfo", rpm:"MozillaFirefox-debuginfo~31.6.0esr~30.1", rls:"SLES12.0SP0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-debugsource", rpm:"MozillaFirefox-debugsource~31.6.0esr~30.1", rls:"SLES12.0SP0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"MozillaFirefox-translations", rpm:"MozillaFirefox-translations~31.6.0esr~30.1", rls:"SLES12.0SP0"))) {
    report += res;
  }
