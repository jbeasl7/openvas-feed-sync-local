...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for wpa_supplicant (SUSE-SU-2014:1356-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2014:1356-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"wpa_supplicant", rpm:"wpa_supplicant~0.7.1~6.15.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
