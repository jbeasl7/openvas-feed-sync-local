...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for procmail (SUSE-SU-2014:1137-1)");
  ...
  * When formail processed specially crafted e-mail headers a heap
  ...
  script_xref(name:"SUSE-SU", value:"2014:1137-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"procmail", rpm:"procmail~3.22~240.8.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
