...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for puppet (SUSE-SU-2014:0155-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2014:0155-1");
...
if(release == "SLES11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"puppet", rpm:"puppet~2.6.18~0.12.1", rls:"SLES11.0SP3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"puppet-server", rpm:"puppet-server~2.6.18~0.12.1", rls:"SLES11.0SP3"))) {
    report += res;
  }
