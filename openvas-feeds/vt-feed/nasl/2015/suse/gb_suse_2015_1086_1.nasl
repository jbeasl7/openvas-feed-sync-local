...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for IBM Java (SUSE-SU-2015:1086-1)");
  ...
  script_tag(name:"affected", value:"IBM Java on SUSE Linux Enterprise Server 11 SP2 LTSS, SUSE Linux Enterprise Server 11 SP1 LTSS");

  script_tag(name:"solution", value:"Please install the updated package(s).");
  script_xref(name:"SUSE-SU", value:"2015:1086-1");
