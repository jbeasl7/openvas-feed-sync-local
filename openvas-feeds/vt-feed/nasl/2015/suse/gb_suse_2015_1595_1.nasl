...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for icedtea-web (openSUSE-SU-2015:1595-1)");
  ...
  * Plugin
  ...
  script_xref(name:"openSUSE-SU", value:"2015:1595-1");
...
if(release == "openSUSE13.2") {
  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-openjdk-plugin", rpm:"java-1_7_0-openjdk-plugin~1.6.1~6.1", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-openjdk-plugin-debuginfo", rpm:"java-1_7_0-openjdk-plugin-debuginfo~1.6.1~6.1", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_7_0-openjdk-plugin-debugsource", rpm:"java-1_7_0-openjdk-plugin-debugsource~1.6.1~6.1", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_8_0-openjdk-plugin", rpm:"java-1_8_0-openjdk-plugin~1.6.1~6.2", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_8_0-openjdk-plugin-debuginfo", rpm:"java-1_8_0-openjdk-plugin-debuginfo~1.6.1~6.2", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"java-1_8_0-openjdk-plugin-debugsource", rpm:"java-1_8_0-openjdk-plugin-debugsource~1.6.1~6.2", rls:"openSUSE13.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icedtea-web-javadoc", rpm:"icedtea-web-javadoc~1.6.1~6.1", rls:"openSUSE13.2"))) {
    report += res;
  }
...
if(release == "openSUSE13.1") {
  if(!isnull(res = isrpmvuln(pkg:"icedtea-web", rpm:"icedtea-web~1.5.3~0.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icedtea-web-debuginfo", rpm:"icedtea-web-debuginfo~1.5.3~0.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icedtea-web-debugsource", rpm:"icedtea-web-debugsource~1.5.3~0.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"icedtea-web-javadoc", rpm:"icedtea-web-javadoc~1.5.3~0.7.1", rls:"openSUSE13.1"))) {
    report += res;
  }
