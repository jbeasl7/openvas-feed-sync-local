...
if(description)
{
  ...
  script_name("SUSE: Security Advisory for rxvt-unicode (SUSE-SU-2014:0838-1)");
  ...
  script_xref(name:"SUSE-SU", value:"2014:0838-1");
...
if(release == "SLED11.0SP3") {
  if(!isnull(res = isrpmvuln(pkg:"xvt-unicode", rpm:"xvt-unicode~9.05~1.19.1", rls:"SLED11.0SP3"))) {
    report += res;
  }
