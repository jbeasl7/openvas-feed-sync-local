...
if (description)
{
  ...
  script_tag(name:"affected", value:"MikroTik RouterOS prior to version 6.44.6 (LTS) and
  6.45.7 (Stable).");

  script_tag(name:"solution", value:"Update to version 6.44.6 (LTS), 6.45.7 (Stable) or later.");

  script_xref(name:"URL", value:"https://mikrotik.com/supportsec/package-validation-and-upgrade-vulnerability/");
  script_xref(name:"URL", value:"https://mikrotik.com/supportsec/dns-cache-poisoning-vulnerability/");
