...
if (description)
{
  ...
  script_tag(name:"affected", value:"MikroTik RouterOS prior to version 6.42.12 and 6.43.x prior to
  6.43.12.");

  script_tag(name:"solution", value:"Update to version 6.42.1, 6.43.12 or later.");

  script_xref(name:"URL", value:"https://mikrotik.com/supportsec/cve-2019-3924-dude-agent-vulnerability/");
