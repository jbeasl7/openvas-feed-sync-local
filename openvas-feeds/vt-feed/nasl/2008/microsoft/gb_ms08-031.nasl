...
if(description)
{
  ...
  script_name("Microsoft Internet Explorer Multiple Vulnerabilities (950759)");
  script_xref(name:"URL", value:"http://www.frsirt.com/english/advisories/2008/0980");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28379");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/29556");
  ...
  script_tag(name:"summary", value:"Microsoft Internet Explorer is prone to HTTP request
  splitting/smuggling and HTML Objects Memory Corruption vulnerabilities.");
