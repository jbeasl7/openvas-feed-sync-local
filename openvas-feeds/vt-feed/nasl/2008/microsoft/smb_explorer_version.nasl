# SPDX-FileCopyrightText: 2008 Montgomery County Maryland
...
if(description)
{
  ...
  script_name("Microsoft Internet Explorer (IE) 4.x - 6.x End of Life (EOL) Detection");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Montgomery County Maryland");
  ...
  script_tag(name:"summary", value:"The remote host is running a version of Internet Explorer which
  is not supported by Microsoft any more.");

  script_tag(name:"vuldetect", value:"Checks if an EOL version is present on the target host.");

  script_tag(name:"insight", value:"Non-supported versions of Internet Explorer may contain critical
  security vulnerabilities as no new security patches will be released for those.");
