...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/26777");
  script_xref(name:"URL", value:"http://securitytracker.com/alerts/2007/Dec/1019072.html");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2007/ms07-063");
