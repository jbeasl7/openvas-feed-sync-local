...
if(description)
{
  ...
  script_name("Apple Safari <= 4.28.17.0 PDF JavaScript Security Bypass Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"Opera Web Browser is prone to a PDF JavaScript security bypass vulnerability.");
