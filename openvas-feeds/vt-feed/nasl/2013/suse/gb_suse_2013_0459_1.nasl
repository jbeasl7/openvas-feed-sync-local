...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2013:0459-1");
  script_name("openSUSE: Security Advisory for flash-player (openSUSE-SU-2013:0459-1)");
...
if(release == "openSUSE12.1") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.275~58.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.275~58.1", rls:"openSUSE12.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.275~58.1", rls:"openSUSE12.1"))) {
    report += res;
  }
