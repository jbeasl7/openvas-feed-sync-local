...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for Fixes (openSUSE-SU-2013:1954-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2013:1954-1");
...
if(release == "openSUSE12.2") {
  if(!isnull(res = isrpmvuln(pkg:"webyast-base", rpm:"webyast-base~0.3.19.1~1.8.1", rls:"openSUSE12.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"webyast-base-branding-default", rpm:"webyast-base-branding-default~0.3.19.1~1.8.1", rls:"openSUSE12.2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"webyast-base-testsuite", rpm:"webyast-base-testsuite~0.3.19.1~1.8.1", rls:"openSUSE12.2"))) {
    report += res;
  }
