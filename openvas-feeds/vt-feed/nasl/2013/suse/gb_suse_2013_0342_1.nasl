...
if(description)
{
  ...
  script_xref(name:"openSUSE-SU", value:"2013:0342-1");
  script_name("openSUSE: Security Advisory for acroread (openSUSE-SU-2013:0342-1)");
  ...
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2013-02/msg00023.html");
...
if(release == "openSUSE11.4") {
  if(!isnull(res = isrpmvuln(pkg:"acroread", rpm:"acroread~9.5.4~14.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"acroread-browser-plugin", rpm:"acroread-browser-plugin~9.5.4~14.1", rls:"openSUSE11.4"))) {
    report += res;
  }
