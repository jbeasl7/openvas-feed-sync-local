...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for flash-player (openSUSE-SU-2013:0675-1)");
  ...
  * APSB13-11, CVE-2013-1378, CVE-2013-1379, CVE-2013-1380,
  ...
  script_xref(name:"openSUSE-SU", value:"2013:0675-1");
...
if(release == "openSUSE11.4") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.280~59.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.280~59.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.280~59.1", rls:"openSUSE11.4"))) {
    report += res;
  }
