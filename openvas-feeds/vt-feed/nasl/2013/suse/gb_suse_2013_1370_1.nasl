...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for puppet (openSUSE-SU-2013:1370-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2013:1370-1");
...
if(release == "openSUSE12.3") {
  if(!isnull(res = isrpmvuln(pkg:"puppet", rpm:"puppet~3.0.2~2.9.1", rls:"openSUSE12.3"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"puppet-server", rpm:"puppet-server~3.0.2~2.9.1", rls:"openSUSE12.3"))) {
    report += res;
  }
