...
if(description)
{
  script_xref(name:"URL", value:"https://lists.opensuse.org/opensuse-security-announce/2012-11/msg00003.html");
  ...
  script_xref(name:"openSUSE-SU", value:"2012:1460-1");
  script_name("openSUSE: Security Advisory for update (openSUSE-SU-2012:1460-1)");
