...
if(description)
{
  ...
  script_name("VMware ESXi/ESX VMCI privilege escalation vulnerability (VMSA-2013-0002)");
  ...
  script_tag(name:"affected", value:"VMware ESXi 5.1 without ESXi510-201212102-SG
  ...
  script_tag(name:"insight", value:"a. VMware VMCI privilege escalation
