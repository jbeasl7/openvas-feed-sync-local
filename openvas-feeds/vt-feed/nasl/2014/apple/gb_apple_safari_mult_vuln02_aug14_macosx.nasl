...
if(description)
{
  ...
  script_name("Apple Safari Multiple Memory Corruption Vulnerabilities-02 (Aug 2014) - Mac OS X");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69223");
