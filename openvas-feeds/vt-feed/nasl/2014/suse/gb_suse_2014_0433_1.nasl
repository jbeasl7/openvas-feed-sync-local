...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for perl-HTTP-Body (openSUSE-SU-2014:0433-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2014:0433-1");
...
if(release == "openSUSE12.3") {
  if(!isnull(res = isrpmvuln(pkg:"perl-HTTP-Body", rpm:"perl-HTTP-Body~1.19~4.4.1", rls:"openSUSE12.3"))) {
    report += res;
  }
...
if(release == "openSUSE13.1") {
  if(!isnull(res = isrpmvuln(pkg:"perl-HTTP-Body", rpm:"perl-HTTP-Body~1.19~2.4.1", rls:"openSUSE13.1"))) {
    report += res;
  }
