...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for flash-player (openSUSE-SU-2014:0128-1)");
  ...
  * APSB14-02, CVE-2014-0491, CVE-2014-0492
  ...
  script_xref(name:"openSUSE-SU", value:"2014:0128-1");
...
if(release == "openSUSE11.4") {
  if(!isnull(res = isrpmvuln(pkg:"flash-player", rpm:"flash-player~11.2.202.335~87.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-gnome", rpm:"flash-player-gnome~11.2.202.335~87.1", rls:"openSUSE11.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"flash-player-kde4", rpm:"flash-player-kde4~11.2.202.335~87.1", rls:"openSUSE11.4"))) {
    report += res;
  }
