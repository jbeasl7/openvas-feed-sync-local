...
if(description)
{
  ...
  script_name("Microsoft Windows Kernel-Mode Drivers Privilege Escalation Vulnerabilities (2984615)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69142");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69143");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69144");
...
if(hotfix_check_sp(win8:1, win8x64:1, win2012:1) > 0)
{
  if(win32SysVer)
  {
    if(version_in_range(version:win32SysVer, test_version:"6.2.9200.17000", test_version2:"6.2.9200.17095") ||
