...
if(description)
{
  ...
  script_name("Microsoft Windows Remote Desktop Protocol Security Feature Bypass Vulnerability (3003743)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/70981");
