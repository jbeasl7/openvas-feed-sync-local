...
if(description)
{
  ...
  script_name("ManageEngine EventLog Analyzer 'j_username' Parameter XSS Vulnerability");

  script_tag(name:"summary", value:"ManageEngine EventLog Analyzer is prone to a cross-site scripting (XSS) vulnerability.");
  ...
  script_tag(name:"affected", value:"ManageEngine EventLog Analyzer version 9.0 build 9000 and probably
  other versions.");
