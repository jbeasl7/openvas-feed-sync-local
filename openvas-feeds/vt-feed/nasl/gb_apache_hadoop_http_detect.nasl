...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://hadoop.apache.org/");
...
foreach url( keys( urls ) ) {
  ...
  if( res =~ "^HTTP/1\.[01] 200" &&
    ...
    set_kb_item( name:"apache/hadoop/detected", value:TRUE );
    set_kb_item( name:"apache/hadoop/http/detected", value:TRUE );
    ...
    if( secureModeDisabled ) {
      ...
      set_kb_item( name:"apache/hadoop/securemode/http/disabled", value:TRUE );
      set_kb_item( name:"apache/hadoop/securemode/http/" + port + "/disabled", value:TRUE );
    }
