...
if (version_in_range(version:vers, test_version:"12.0.4300.0", test_version2:"12.0.4521.0")) {
  report = report_fixed_ver(installed_version:vers, vulnerable_range:"12.0.4300.0 - 12.0.4521.0");
