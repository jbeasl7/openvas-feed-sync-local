...
if(version_is_less(version:vers, test_version:"27.0.0.130")) {
  report = report_fixed_ver(file_checked:path, file_version:vers, vulnerable_range:"Less than 27.0.0.130");
