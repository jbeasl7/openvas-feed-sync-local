...
if (version_in_range(version:vers, test_version:"13.0.1000.0", test_version2:"13.0.1741.0")) {
  report = report_fixed_ver(installed_version:vers, vulnerable_range:"13.0.1000.0 - 13.0.1741.0");
