...
if (description)
{
  ...
  - CVE-2017-8903: x86: 64bit PV guest breakout via pagetable use-after-mode-change

  - CVE-2017-8904: Grant transfer allows PV guest to elevate privileges

  - CVE-2017-8905: Possible memory corruption via failsafe callback");
