...
if (description)
{
  ...
  script_name("Citrix XenServer Multiple Security Updates (CTX222565)");
  ...
  script_tag(name:"insight", value:"The most significant of these issues could, if exploited, allow a malicious
  ...
  - No CVE: Memory leak when destroying guest without PT devices
  ...
  script_xref(name:"URL", value:"https://support.citrix.com/article/CTX222565");
