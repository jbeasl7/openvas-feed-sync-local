...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/1000");
  script_xref(name:"URL", value:"http://www.exploit-db.com/exploits/19759");
  script_xref(name:"URL", value:"https://web.archive.org/web/20121022223439/http://technet.microsoft.com/en-us/security/bulletin/fq00-013");
  script_xref(name:"URL", value:"http://support.microsoft.com/default.aspx?scid=kb;[LN];253943");
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2000/ms00-013");
  ...
  script_tag(name:"summary", value:"Microsoft Windows Media Service is prone to a denial of service (DoS) vulnerability.");
