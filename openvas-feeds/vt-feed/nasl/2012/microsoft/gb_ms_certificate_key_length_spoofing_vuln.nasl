...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2012/2661254");
  ...
  script_tag(name:"summary", value:"Microsoft Windows operating system is prone to digital certificate key length spoofing vulnerability.");
  exit(0);
}
