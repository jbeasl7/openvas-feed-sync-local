...
if(description)
{
  ...
  script_name("ManageEngine Support Center Plus Multiple Fields XSS Vulnerabilities (Apr 2012) - Active Check");
  ...
  script_tag(name:"summary", value:"ManageEngine Support Center Plus is prone to multiple
