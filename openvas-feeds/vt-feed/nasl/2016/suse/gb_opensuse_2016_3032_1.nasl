...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for roundcubemail (openSUSE-SU-2016:3032-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2016:3032-1");
...
if(release == "openSUSE13.2")
{
  ...
  if(!isnull(res = isrpmvuln(pkg:"roundcubemail", rpm:"roundcubemail~1.0.9~23.1", rls:"openSUSE13.2"))) {
    report += res;
  }
