...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for obs-service-source_validator (openSUSE-SU-2016:1659-1)");
  ...
  script_xref(name:"openSUSE-SU", value:"2016:1659-1");
...
if(release == "openSUSE13.2")
{
  ...
  if(!isnull(res = isrpmvuln(pkg:"obs-service-source_validator", rpm:"obs-service-source_validator~0.6+git20160531.fbfe336~9.1", rls:"openSUSE13.2"))) {
    report += res;
  }
