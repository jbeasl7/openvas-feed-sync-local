...
if(description)
{
  ...
  script_name("VMware Player Guest Privilege Escalation Vulnerability (Aug 2016) - Windows");

  script_tag(name:"summary", value:"VMware Player is prone to an important guest privilege escalation vulnerability.");
