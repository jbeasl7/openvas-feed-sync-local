...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.136850");
  ...
  script_tag(name:"severity_date", value:"2023-08-01 12:55:19 +0000 (Tue, 01 Aug 2023)");

  script_tag(name:"qod_type", value:"package");

  script_tag(name:"solution_type", value:"VendorFix");

  script_cve_id("CVE-2023-37903");

  script_name("vm2 Sandbox Escape Vulnerability (GHSA-g644-9gfx-q4q4)");
  ...
  script_tag(name:"insight", value:"Node.js custom inspect function allows attackers to escape the
  ...
  script_tag(name:"affected", value:"vm2 prior to version 3.10.3.");
  ...
  script_xref(name:"URL", value:"https://github.com/patriksimek/vm2/issues/533#issuecomment-1632482080");
  script_xref(name:"URL", value:"https://github.com/patriksimek/vm2/releases/tag/v3.10.3");
